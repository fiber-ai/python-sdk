...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    PostReactionsLiveFetchResponse200
    | PostReactionsLiveFetchResponse400
    | PostReactionsLiveFetchResponse401
    ...
    if response.status_code == 503:
        response_503 = PostReactionsLiveFetchResponse503.from_dict(response.json())
