...
def sync_detailed(
    *,
    ...
    Returns:
        Response[SocialMediaLookupTriggerResponse200 | SocialMediaLookupTriggerResponse400 | SocialMediaLookupTriggerResponse401 | SocialMediaLookupTriggerResponse402 | SocialMediaLookupTriggerResponse403 | SocialMediaLookupTriggerResponse404 | SocialMediaLookupTriggerResponse429 | SocialMediaLookupTriggerResponse500 | SocialMediaLookupTriggerResponse503]
    """
