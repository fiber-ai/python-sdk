...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    KitchenSinkBulkCompanyResponse200
    | KitchenSinkBulkCompanyResponse400
    | KitchenSinkBulkCompanyResponse401
    ...
    if response.status_code == 503:
        response_503 = KitchenSinkBulkCompanyResponse503.from_dict(response.json())
