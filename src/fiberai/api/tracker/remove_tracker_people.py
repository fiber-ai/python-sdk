...
from ...models.remove_tracker_people_response_422 import RemoveTrackerPeopleResponse422
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    | RemoveTrackerPeopleResponse422
    ...
    if response.status_code == 422:
        response_422 = RemoveTrackerPeopleResponse422.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[RemoveTrackerPeopleResponse200 | RemoveTrackerPeopleResponse400 | RemoveTrackerPeopleResponse401 | RemoveTrackerPeopleResponse402 | RemoveTrackerPeopleResponse403 | RemoveTrackerPeopleResponse404 | RemoveTrackerPeopleResponse422 | RemoveTrackerPeopleResponse429 | RemoveTrackerPeopleResponse500 | RemoveTrackerPeopleResponse503]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        RemoveTrackerPeopleResponse200 | RemoveTrackerPeopleResponse400 | RemoveTrackerPeopleResponse401 | RemoveTrackerPeopleResponse402 | RemoveTrackerPeopleResponse403 | RemoveTrackerPeopleResponse404 | RemoveTrackerPeopleResponse422 | RemoveTrackerPeopleResponse429 | RemoveTrackerPeopleResponse500 | RemoveTrackerPeopleResponse503
    """
