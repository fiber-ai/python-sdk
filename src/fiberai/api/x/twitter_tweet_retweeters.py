...
from ...models.twitter_tweet_retweeters_response_422 import TwitterTweetRetweetersResponse422
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    | TwitterTweetRetweetersResponse422
    ...
    if response.status_code == 422:
        response_422 = TwitterTweetRetweetersResponse422.from_dict(response.json())
