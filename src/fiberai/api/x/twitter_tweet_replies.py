...
from ...models.twitter_tweet_replies_response_422 import TwitterTweetRepliesResponse422
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    | TwitterTweetRepliesResponse422
    ...
    if response.status_code == 422:
        response_422 = TwitterTweetRepliesResponse422.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[TwitterTweetRepliesResponse200 | TwitterTweetRepliesResponse400 | TwitterTweetRepliesResponse401 | TwitterTweetRepliesResponse402 | TwitterTweetRepliesResponse403 | TwitterTweetRepliesResponse404 | TwitterTweetRepliesResponse422 | TwitterTweetRepliesResponse429 | TwitterTweetRepliesResponse500 | TwitterTweetRepliesResponse503]
    """
...
def sync(
    *,
    ...
    Returns:
        TwitterTweetRepliesResponse200 | TwitterTweetRepliesResponse400 | TwitterTweetRepliesResponse401 | TwitterTweetRepliesResponse402 | TwitterTweetRepliesResponse403 | TwitterTweetRepliesResponse404 | TwitterTweetRepliesResponse422 | TwitterTweetRepliesResponse429 | TwitterTweetRepliesResponse500 | TwitterTweetRepliesResponse503
    """
