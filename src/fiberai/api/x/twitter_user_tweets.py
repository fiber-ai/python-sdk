...
from ...models.twitter_user_tweets_response_422 import TwitterUserTweetsResponse422
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 422:
        response_422 = TwitterUserTweetsResponse422.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[TwitterUserTweetsResponse200 | TwitterUserTweetsResponse400 | TwitterUserTweetsResponse401 | TwitterUserTweetsResponse402 | TwitterUserTweetsResponse403 | TwitterUserTweetsResponse404 | TwitterUserTweetsResponse422 | TwitterUserTweetsResponse429 | TwitterUserTweetsResponse500 | TwitterUserTweetsResponse503]
    """
...
def sync(
    *,
    ...
    Returns:
        TwitterUserTweetsResponse200 | TwitterUserTweetsResponse400 | TwitterUserTweetsResponse401 | TwitterUserTweetsResponse402 | TwitterUserTweetsResponse403 | TwitterUserTweetsResponse404 | TwitterUserTweetsResponse422 | TwitterUserTweetsResponse429 | TwitterUserTweetsResponse500 | TwitterUserTweetsResponse503
    """
