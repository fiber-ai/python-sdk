...
from ...models.twitter_tweet_details_response_422 import TwitterTweetDetailsResponse422
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    | TwitterTweetDetailsResponse422
    ...
    if response.status_code == 422:
        response_422 = TwitterTweetDetailsResponse422.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[TwitterTweetDetailsResponse200 | TwitterTweetDetailsResponse400 | TwitterTweetDetailsResponse401 | TwitterTweetDetailsResponse402 | TwitterTweetDetailsResponse403 | TwitterTweetDetailsResponse404 | TwitterTweetDetailsResponse422 | TwitterTweetDetailsResponse429 | TwitterTweetDetailsResponse500 | TwitterTweetDetailsResponse503]
    """
...
def sync(
    *,
    ...
    Returns:
        TwitterTweetDetailsResponse200 | TwitterTweetDetailsResponse400 | TwitterTweetDetailsResponse401 | TwitterTweetDetailsResponse402 | TwitterTweetDetailsResponse403 | TwitterTweetDetailsResponse404 | TwitterTweetDetailsResponse422 | TwitterTweetDetailsResponse429 | TwitterTweetDetailsResponse500 | TwitterTweetDetailsResponse503
    """
