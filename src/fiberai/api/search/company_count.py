...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[Union[CompanyCountResponse200, CompanyCountResponse400, CompanyCountResponse401, CompanyCountResponse402, CompanyCountResponse403, CompanyCountResponse404, CompanyCountResponse429, CompanyCountResponse500]]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Response[Union[CompanyCountResponse200, CompanyCountResponse400, CompanyCountResponse401, CompanyCountResponse402, CompanyCountResponse403, CompanyCountResponse404, CompanyCountResponse429, CompanyCountResponse500]]:
    return Response(
...
) -> Response[Union[CompanyCountResponse200, CompanyCountResponse400, CompanyCountResponse401, CompanyCountResponse402, CompanyCountResponse403, CompanyCountResponse404, CompanyCountResponse429, CompanyCountResponse500]]:
    r""" Company count
...
def sync(
    *,
...
) -> Optional[Union[CompanyCountResponse200, CompanyCountResponse400, CompanyCountResponse401, CompanyCountResponse402, CompanyCountResponse403, CompanyCountResponse404, CompanyCountResponse429, CompanyCountResponse500]]:
    r""" Company count
    ...
    Returns:
        Union[CompanyCountResponse200, CompanyCountResponse400, CompanyCountResponse401, CompanyCountResponse402, CompanyCountResponse403, CompanyCountResponse404, CompanyCountResponse429, CompanyCountResponse500]
     """
