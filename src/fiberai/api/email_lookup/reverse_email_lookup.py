...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[Union[ReverseEmailLookupResponse200, ReverseEmailLookupResponse400, ReverseEmailLookupResponse401, ReverseEmailLookupResponse402, ReverseEmailLookupResponse403, ReverseEmailLookupResponse404, ReverseEmailLookupResponse429, ReverseEmailLookupResponse500]]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Response[Union[ReverseEmailLookupResponse200, ReverseEmailLookupResponse400, ReverseEmailLookupResponse401, ReverseEmailLookupResponse402, ReverseEmailLookupResponse403, ReverseEmailLookupResponse404, ReverseEmailLookupResponse429, ReverseEmailLookupResponse500]]:
    return Response(
...
) -> Response[Union[ReverseEmailLookupResponse200, ReverseEmailLookupResponse400, ReverseEmailLookupResponse401, ReverseEmailLookupResponse402, ReverseEmailLookupResponse403, ReverseEmailLookupResponse404, ReverseEmailLookupResponse429, ReverseEmailLookupResponse500]]:
    r""" Find person by email

     Do a reverse lookup: given an email address, find someone's LinkedIn profile and personal details.
    Note: if you also have the person's name, company, etc., you'll get better results with the Kitchen
    Sink endpoint, where you can pass all the information you have.
...
def sync(
    *,
...
) -> Optional[Union[ReverseEmailLookupResponse200, ReverseEmailLookupResponse400, ReverseEmailLookupResponse401, ReverseEmailLookupResponse402, ReverseEmailLookupResponse403, ReverseEmailLookupResponse404, ReverseEmailLookupResponse429, ReverseEmailLookupResponse500]]:
    r""" Find person by email
    ...
    Returns:
        Union[ReverseEmailLookupResponse200, ReverseEmailLookupResponse400, ReverseEmailLookupResponse401, ReverseEmailLookupResponse402, ReverseEmailLookupResponse403, ReverseEmailLookupResponse404, ReverseEmailLookupResponse429, ReverseEmailLookupResponse500]
     """
