...
from ...models.create_prospect_exclusion_list_response_422 import CreateProspectExclusionListResponse422
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    | CreateProspectExclusionListResponse422
    ...
    if response.status_code == 422:
        response_422 = CreateProspectExclusionListResponse422.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[CreateProspectExclusionListResponse200 | CreateProspectExclusionListResponse400 | CreateProspectExclusionListResponse401 | CreateProspectExclusionListResponse402 | CreateProspectExclusionListResponse403 | CreateProspectExclusionListResponse404 | CreateProspectExclusionListResponse422 | CreateProspectExclusionListResponse429 | CreateProspectExclusionListResponse500 | CreateProspectExclusionListResponse503]
    """
