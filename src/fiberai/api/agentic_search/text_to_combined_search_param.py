...
from ...models.text_to_combined_search_param_response_422 import TextToCombinedSearchParamResponse422
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    | TextToCombinedSearchParamResponse422
    ...
    if response.status_code == 422:
        response_422 = TextToCombinedSearchParamResponse422.from_dict(response.json())
