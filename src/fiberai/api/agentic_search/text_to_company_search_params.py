...
from ...models.text_to_company_search_params_response_503 import TextToCompanySearchParamsResponse503
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    TextToCompanySearchParamsResponse200
    | TextToCompanySearchParamsResponse400
    | TextToCompanySearchParamsResponse401
    | TextToCompanySearchParamsResponse402
    | TextToCompanySearchParamsResponse403
    | TextToCompanySearchParamsResponse404
    | TextToCompanySearchParamsResponse429
    | TextToCompanySearchParamsResponse500
    | TextToCompanySearchParamsResponse503
    | None
):
    ...
    if response.status_code == 503:
        response_503 = TextToCompanySearchParamsResponse503.from_dict(response.json())
...
def sync(
    *,
    ...
    Returns:
        TextToCompanySearchParamsResponse200 | TextToCompanySearchParamsResponse400 | TextToCompanySearchParamsResponse401 | TextToCompanySearchParamsResponse402 | TextToCompanySearchParamsResponse403 | TextToCompanySearchParamsResponse404 | TextToCompanySearchParamsResponse429 | TextToCompanySearchParamsResponse500 | TextToCompanySearchParamsResponse503
    """
