...
from ...models.get_current_profiles_in_saved_search_response_422 import GetCurrentProfilesInSavedSearchResponse422
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    | GetCurrentProfilesInSavedSearchResponse422
    ...
    if response.status_code == 422:
        response_422 = GetCurrentProfilesInSavedSearchResponse422.from_dict(response.json())
