...
from ...models.get_saved_search_run_companies_response_422 import GetSavedSearchRunCompaniesResponse422
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    | GetSavedSearchRunCompaniesResponse422
    ...
    if response.status_code == 422:
        response_422 = GetSavedSearchRunCompaniesResponse422.from_dict(response.json())
