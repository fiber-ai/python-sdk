...
from ...models.manually_spawn_saved_search_run_response_422 import ManuallySpawnSavedSearchRunResponse422
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    | ManuallySpawnSavedSearchRunResponse422
    ...
    if response.status_code == 422:
        response_422 = ManuallySpawnSavedSearchRunResponse422.from_dict(response.json())
