...
from ...models.get_saved_search_run_profiles_response_422 import GetSavedSearchRunProfilesResponse422
...
from ...models.get_saved_search_run_profiles_response_503 import GetSavedSearchRunProfilesResponse503
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    GetSavedSearchRunProfilesResponse200
    | GetSavedSearchRunProfilesResponse400
    | GetSavedSearchRunProfilesResponse401
    | GetSavedSearchRunProfilesResponse402
    | GetSavedSearchRunProfilesResponse403
    | GetSavedSearchRunProfilesResponse404
    | GetSavedSearchRunProfilesResponse422
    | GetSavedSearchRunProfilesResponse429
    | GetSavedSearchRunProfilesResponse500
    | GetSavedSearchRunProfilesResponse503
    | None
):
    ...
    if response.status_code == 422:
        response_422 = GetSavedSearchRunProfilesResponse422.from_dict(response.json())
    ...
    if response.status_code == 503:
        response_503 = GetSavedSearchRunProfilesResponse503.from_dict(response.json())
