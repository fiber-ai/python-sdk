...
from ...models.get_saved_search_run_status_response_422 import GetSavedSearchRunStatusResponse422
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    | GetSavedSearchRunStatusResponse422
    ...
    if response.status_code == 422:
        response_422 = GetSavedSearchRunStatusResponse422.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[GetSavedSearchRunStatusResponse200 | GetSavedSearchRunStatusResponse400 | GetSavedSearchRunStatusResponse401 | GetSavedSearchRunStatusResponse402 | GetSavedSearchRunStatusResponse403 | GetSavedSearchRunStatusResponse404 | GetSavedSearchRunStatusResponse422 | GetSavedSearchRunStatusResponse429 | GetSavedSearchRunStatusResponse500 | GetSavedSearchRunStatusResponse503]
    """
