...
from ...models.get_current_companies_in_saved_search_response_422 import GetCurrentCompaniesInSavedSearchResponse422
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    | GetCurrentCompaniesInSavedSearchResponse422
    ...
    if response.status_code == 422:
        response_422 = GetCurrentCompaniesInSavedSearchResponse422.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[GetCurrentCompaniesInSavedSearchResponse200 | GetCurrentCompaniesInSavedSearchResponse400 | GetCurrentCompaniesInSavedSearchResponse401 | GetCurrentCompaniesInSavedSearchResponse402 | GetCurrentCompaniesInSavedSearchResponse403 | GetCurrentCompaniesInSavedSearchResponse404 | GetCurrentCompaniesInSavedSearchResponse422 | GetCurrentCompaniesInSavedSearchResponse429 | GetCurrentCompaniesInSavedSearchResponse500 | GetCurrentCompaniesInSavedSearchResponse503]
    """
...
def sync(
    *,
    ...
    Returns:
        GetCurrentCompaniesInSavedSearchResponse200 | GetCurrentCompaniesInSavedSearchResponse400 | GetCurrentCompaniesInSavedSearchResponse401 | GetCurrentCompaniesInSavedSearchResponse402 | GetCurrentCompaniesInSavedSearchResponse403 | GetCurrentCompaniesInSavedSearchResponse404 | GetCurrentCompaniesInSavedSearchResponse422 | GetCurrentCompaniesInSavedSearchResponse429 | GetCurrentCompaniesInSavedSearchResponse500 | GetCurrentCompaniesInSavedSearchResponse503
    """
