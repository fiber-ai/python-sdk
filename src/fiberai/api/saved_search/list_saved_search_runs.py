...
from ...models.list_saved_search_runs_response_503 import ListSavedSearchRunsResponse503
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    ListSavedSearchRunsResponse200
    | ListSavedSearchRunsResponse400
    | ListSavedSearchRunsResponse401
    | ListSavedSearchRunsResponse402
    | ListSavedSearchRunsResponse403
    | ListSavedSearchRunsResponse404
    | ListSavedSearchRunsResponse429
    ...
    if response.status_code == 503:
        response_503 = ListSavedSearchRunsResponse503.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[ListSavedSearchRunsResponse200 | ListSavedSearchRunsResponse400 | ListSavedSearchRunsResponse401 | ListSavedSearchRunsResponse402 | ListSavedSearchRunsResponse403 | ListSavedSearchRunsResponse404 | ListSavedSearchRunsResponse429 | ListSavedSearchRunsResponse500 | ListSavedSearchRunsResponse503]
    """
...
def sync(
    *,
    ...
    Returns:
        ListSavedSearchRunsResponse200 | ListSavedSearchRunsResponse400 | ListSavedSearchRunsResponse401 | ListSavedSearchRunsResponse402 | ListSavedSearchRunsResponse403 | ListSavedSearchRunsResponse404 | ListSavedSearchRunsResponse429 | ListSavedSearchRunsResponse500 | ListSavedSearchRunsResponse503
    """
