...
from ...models.list_saved_search_runs_response_422 import ListSavedSearchRunsResponse422
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    | ListSavedSearchRunsResponse422
    ...
    if response.status_code == 422:
        response_422 = ListSavedSearchRunsResponse422.from_dict(response.json())
...
def sync(
    *,
    ...
    Returns:
        ListSavedSearchRunsResponse200 | ListSavedSearchRunsResponse400 | ListSavedSearchRunsResponse401 | ListSavedSearchRunsResponse402 | ListSavedSearchRunsResponse403 | ListSavedSearchRunsResponse404 | ListSavedSearchRunsResponse422 | ListSavedSearchRunsResponse429 | ListSavedSearchRunsResponse500 | ListSavedSearchRunsResponse503
    """
