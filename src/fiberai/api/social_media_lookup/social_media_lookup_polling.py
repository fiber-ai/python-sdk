...
from ...models.social_media_lookup_polling_response_422 import SocialMediaLookupPollingResponse422
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    | SocialMediaLookupPollingResponse422
    ...
    if response.status_code == 422:
        response_422 = SocialMediaLookupPollingResponse422.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[SocialMediaLookupPollingResponse200 | SocialMediaLookupPollingResponse400 | SocialMediaLookupPollingResponse401 | SocialMediaLookupPollingResponse402 | SocialMediaLookupPollingResponse403 | SocialMediaLookupPollingResponse404 | SocialMediaLookupPollingResponse422 | SocialMediaLookupPollingResponse429 | SocialMediaLookupPollingResponse500 | SocialMediaLookupPollingResponse503]
    """
