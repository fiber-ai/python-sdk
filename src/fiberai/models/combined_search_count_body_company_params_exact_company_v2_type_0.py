...
T = TypeVar("T", bound="CombinedSearchCountBodyCompanyParamsExactCompanyV2Type0")


@_attrs_define
class CombinedSearchCountBodyCompanyParamsExactCompanyV2Type0:
    """
    Attributes:
        any_of (list[CombinedSearchCountBodyCompanyParamsExactCompanyV2Type0AnyOfType0ItemType0 |
            CombinedSearchCountBodyCompanyParamsExactCompanyV2Type0AnyOfType0ItemType1 |
            CombinedSearchCountBodyCompanyParamsExactCompanyV2Type0AnyOfType0ItemType2 |
            CombinedSearchCountBodyCompanyParamsExactCompanyV2Type0AnyOfType0ItemType3] | None | Unset):
        none_of (list[CombinedSearchCountBodyCompanyParamsExactCompanyV2Type0NoneOfType0ItemType0 |
            CombinedSearchCountBodyCompanyParamsExactCompanyV2Type0NoneOfType0ItemType1 |
            CombinedSearchCountBodyCompanyParamsExactCompanyV2Type0NoneOfType0ItemType2 |
            CombinedSearchCountBodyCompanyParamsExactCompanyV2Type0NoneOfType0ItemType3] | None | Unset):
    """
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.any_of, Unset):
            ...
            for any_of_type_0_item_data in self.any_of:
                ...
                if isinstance(
                    any_of_type_0_item_data, CombinedSearchCountBodyCompanyParamsExactCompanyV2Type0AnyOfType0ItemType0
                ):
                    any_of_type_0_item = any_of_type_0_item_data.to_dict()
                elif isinstance(
                    any_of_type_0_item_data, CombinedSearchCountBodyCompanyParamsExactCompanyV2Type0AnyOfType0ItemType1
                ):
                    any_of_type_0_item = any_of_type_0_item_data.to_dict()
                elif isinstance(
                    any_of_type_0_item_data, CombinedSearchCountBodyCompanyParamsExactCompanyV2Type0AnyOfType0ItemType2
                ):
                    any_of_type_0_item = any_of_type_0_item_data.to_dict()
                else:
                    any_of_type_0_item = any_of_type_0_item_data.to_dict()
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
                    ...
                    def _parse_any_of_type_0_item(
                        ...
                        try:
                            ...
                            any_of_type_0_item_type_0 = (
                                CombinedSearchCountBodyCompanyParamsExactCompanyV2Type0AnyOfType0ItemType0.from_dict(
                                    data
                                )
                            )
                        ...
                        try:
                            ...
                            any_of_type_0_item_type_1 = (
                                CombinedSearchCountBodyCompanyParamsExactCompanyV2Type0AnyOfType0ItemType1.from_dict(
                                    data
                                )
                            )
                        ...
                        try:
                            ...
                            any_of_type_0_item_type_2 = (
                                CombinedSearchCountBodyCompanyParamsExactCompanyV2Type0AnyOfType0ItemType2.from_dict(
                                    data
                                )
                            )
                        ...
                        any_of_type_0_item_type_3 = (
                            CombinedSearchCountBodyCompanyParamsExactCompanyV2Type0AnyOfType0ItemType3.from_dict(data)
                        )
                    ...
                    def _parse_none_of_type_0_item(
                        ...
                        try:
                            ...
                            none_of_type_0_item_type_0 = (
                                CombinedSearchCountBodyCompanyParamsExactCompanyV2Type0NoneOfType0ItemType0.from_dict(
                                    data
                                )
                            )
                        ...
                        try:
                            ...
                            none_of_type_0_item_type_1 = (
                                CombinedSearchCountBodyCompanyParamsExactCompanyV2Type0NoneOfType0ItemType1.from_dict(
                                    data
                                )
                            )
                        ...
                        try:
                            ...
                            none_of_type_0_item_type_2 = (
                                CombinedSearchCountBodyCompanyParamsExactCompanyV2Type0NoneOfType0ItemType2.from_dict(
                                    data
                                )
                            )
                        ...
                        none_of_type_0_item_type_3 = (
                            CombinedSearchCountBodyCompanyParamsExactCompanyV2Type0NoneOfType0ItemType3.from_dict(data)
                        )
        ...
        combined_search_count_body_company_params_exact_company_v2_type_0 = cls(
            any_of=any_of,
            none_of=none_of,
        )

        combined_search_count_body_company_params_exact_company_v2_type_0.additional_properties = d
        return combined_search_count_body_company_params_exact_company_v2_type_0
