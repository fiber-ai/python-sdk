...
T = TypeVar("T", bound="SyncCombinedSearchBodyCompanyParamsTechnologiesV2Type0")


@_attrs_define
class SyncCombinedSearchBodyCompanyParamsTechnologiesV2Type0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sync_combined_search_body_company_params_technologies_v2_type_0 = cls(
            any_of=any_of,
            all_of=all_of,
            none_of=none_of,
        )

        sync_combined_search_body_company_params_technologies_v2_type_0.additional_properties = d
        return sync_combined_search_body_company_params_technologies_v2_type_0
