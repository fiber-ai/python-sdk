...
T = TypeVar("T", bound="PaginatedCombinedSearchResponse200OutputCompaniesItemHistoricalHeadcountType0")


@_attrs_define
class PaginatedCombinedSearchResponse200OutputCompaniesItemHistoricalHeadcountType0:
    """
    Attributes:
        latest_snapshot_date (datetime.date):
        snapshots (list[PaginatedCombinedSearchResponse200OutputCompaniesItemHistoricalHeadcountType0SnapshotsItem]):
        growth (PaginatedCombinedSearchResponse200OutputCompaniesItemHistoricalHeadcountType0Growth):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for snapshots_item_data in _snapshots:
            snapshots_item = (
                PaginatedCombinedSearchResponse200OutputCompaniesItemHistoricalHeadcountType0SnapshotsItem.from_dict(
                    snapshots_item_data
                )
            )
        ...
        growth = PaginatedCombinedSearchResponse200OutputCompaniesItemHistoricalHeadcountType0Growth.from_dict(
            d.pop("growth")
        )

        paginated_combined_search_response_200_output_companies_item_historical_headcount_type_0 = cls(
            latest_snapshot_date=latest_snapshot_date,
            snapshots=snapshots,
            growth=growth,
        )

        paginated_combined_search_response_200_output_companies_item_historical_headcount_type_0.additional_properties = d
        return paginated_combined_search_response_200_output_companies_item_historical_headcount_type_0
