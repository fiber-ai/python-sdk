...
T = TypeVar("T", bound="GithubToLinkedinSingleResponse200OutputGithubProfileType0")


@_attrs_define
class GithubToLinkedinSingleResponse200OutputGithubProfileType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        github_to_linkedin_single_response_200_output_github_profile_type_0 = cls(
            name=name,
            company=company,
            location=location,
            bio=bio,
        ...
        github_to_linkedin_single_response_200_output_github_profile_type_0.additional_properties = d
        return github_to_linkedin_single_response_200_output_github_profile_type_0
