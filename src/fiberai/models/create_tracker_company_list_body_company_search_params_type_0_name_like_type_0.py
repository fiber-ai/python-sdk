...
T = TypeVar("T", bound="CreateTrackerCompanyListBodyCompanySearchParamsType0NameLikeType0")


@_attrs_define
class CreateTrackerCompanyListBodyCompanySearchParamsType0NameLikeType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_tracker_company_list_body_company_search_params_type_0_name_like_type_0 = cls(
            any_of=any_of,
            none_of=none_of,
        )

        create_tracker_company_list_body_company_search_params_type_0_name_like_type_0.additional_properties = d
        return create_tracker_company_list_body_company_search_params_type_0_name_like_type_0
