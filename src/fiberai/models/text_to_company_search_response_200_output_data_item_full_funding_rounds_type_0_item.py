...
if TYPE_CHECKING:
    from ..models.text_to_company_search_response_200_output_data_item_full_funding_rounds_type_0_item_investors_type_0_item import (
        TextToCompanySearchResponse200OutputDataItemFullFundingRoundsType0ItemInvestorsType0Item,
    )
...
class TextToCompanySearchResponse200OutputDataItemFullFundingRoundsType0Item:
    """
    Attributes:
        investors (list[TextToCompanySearchResponse200OutputDataItemFullFundingRoundsType0ItemInvestorsType0Item] | None
            | Unset):
    ...
    investors: (
        list[TextToCompanySearchResponse200OutputDataItemFullFundingRoundsType0ItemInvestorsType0Item] | None | Unset
    ) = UNSET
        ...
        def _parse_investors(
            ...
            try:
                ...
                for investors_type_0_item_data in _investors_type_0:
                    investors_type_0_item = TextToCompanySearchResponse200OutputDataItemFullFundingRoundsType0ItemInvestorsType0Item.from_dict(
