...
if TYPE_CHECKING:
  from ..models.text_to_company_search_response_200_output_data_item_full_funding_rounds_type_0_item_investors_type_0_item import TextToCompanySearchResponse200OutputDataItemFullFundingRoundsType0ItemInvestorsType0Item





T = TypeVar("T", bound="TextToCompanySearchResponse200OutputDataItemFullFundingRoundsType0Item")



@_attrs_define
class TextToCompanySearchResponse200OutputDataItemFullFundingRoundsType0Item:
    """ 
        Attributes:
            investors (Union[None, Unset,
                list['TextToCompanySearchResponse200OutputDataItemFullFundingRoundsType0ItemInvestorsType0Item']]):
    ...
    investors: Union[None, Unset, list['TextToCompanySearchResponse200OutputDataItemFullFundingRoundsType0ItemInvestorsType0Item']] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.text_to_company_search_response_200_output_data_item_full_funding_rounds_type_0_item_investors_type_0_item import TextToCompanySearchResponse200OutputDataItemFullFundingRoundsType0ItemInvestorsType0Item
        d = dict(src_dict)
        def _parse_investors(data: object) -> Union[None, Unset, list['TextToCompanySearchResponse200OutputDataItemFullFundingRoundsType0ItemInvestorsType0Item']]:
            if data is None:
                return data
            ...
            try:
                ...
                for investors_type_0_item_data in (_investors_type_0):
                    investors_type_0_item = TextToCompanySearchResponse200OutputDataItemFullFundingRoundsType0ItemInvestorsType0Item.from_dict(investors_type_0_item_data)
                ...
                pass
            return cast(Union[None, Unset, list['TextToCompanySearchResponse200OutputDataItemFullFundingRoundsType0ItemInvestorsType0Item']], data)
        ...
        text_to_company_search_response_200_output_data_item_full_funding_rounds_type_0_item = cls(
            investors=investors,
        ...
        text_to_company_search_response_200_output_data_item_full_funding_rounds_type_0_item.additional_properties = d
        return text_to_company_search_response_200_output_data_item_full_funding_rounds_type_0_item
