...
T = TypeVar("T", bound="DomainLookupTriggerResponse200ChargeInfoType4LowCreditAlertType0")


@_attrs_define
class DomainLookupTriggerResponse200ChargeInfoType4LowCreditAlertType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        domain_lookup_trigger_response_200_charge_info_type_4_low_credit_alert_type_0 = cls(
            get_more_credits_url=get_more_credits_url,
            message=message,
            available_credits=available_credits,
        )

        domain_lookup_trigger_response_200_charge_info_type_4_low_credit_alert_type_0.additional_properties = d
        return domain_lookup_trigger_response_200_charge_info_type_4_low_credit_alert_type_0
