...
T = TypeVar("T", bound="CombinedSearchBodyProfileParamsLeftStealthAtType0RangeType0")



@_attrs_define
class CombinedSearchBodyProfileParamsLeftStealthAtType0RangeType0:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        combined_search_body_profile_params_left_stealth_at_type_0_range_type_0 = cls(
            lower_bound=lower_bound,
            upper_bound=upper_bound,
        )


        combined_search_body_profile_params_left_stealth_at_type_0_range_type_0.additional_properties = d
        return combined_search_body_profile_params_left_stealth_at_type_0_range_type_0
