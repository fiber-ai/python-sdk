...
T = TypeVar("T", bound="GetSavedSearchRunProfilesResponse200OutputProfilesItemProfileProjectsType0Item")



@_attrs_define
class GetSavedSearchRunProfilesResponse200OutputProfilesItemProfileProjectsType0Item:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_saved_search_run_profiles_response_200_output_profiles_item_profile_projects_type_0_item = cls(
        ...
        get_saved_search_run_profiles_response_200_output_profiles_item_profile_projects_type_0_item.additional_properties = d
        return get_saved_search_run_profiles_response_200_output_profiles_item_profile_projects_type_0_item
