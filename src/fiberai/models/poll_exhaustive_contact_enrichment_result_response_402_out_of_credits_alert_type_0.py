...
T = TypeVar("T", bound="PollExhaustiveContactEnrichmentResultResponse402OutOfCreditsAlertType0")


@_attrs_define
class PollExhaustiveContactEnrichmentResultResponse402OutOfCreditsAlertType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        poll_exhaustive_contact_enrichment_result_response_402_out_of_credits_alert_type_0 = cls(
            get_more_credits_url=get_more_credits_url,
            message=message,
            available_credits=available_credits,
        )

        poll_exhaustive_contact_enrichment_result_response_402_out_of_credits_alert_type_0.additional_properties = d
        return poll_exhaustive_contact_enrichment_result_response_402_out_of_credits_alert_type_0
