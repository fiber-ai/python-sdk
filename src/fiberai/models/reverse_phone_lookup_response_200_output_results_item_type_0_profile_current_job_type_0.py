...
from ..models.reverse_phone_lookup_response_200_output_results_item_type_0_profile_current_job_type_0_academic_qualification_type_0_item import (
    ReversePhoneLookupResponse200OutputResultsItemType0ProfileCurrentJobType0AcademicQualificationType0Item,
)
from ..models.reverse_phone_lookup_response_200_output_results_item_type_0_profile_current_job_type_0_employment_type_type_0_item import (
    ReversePhoneLookupResponse200OutputResultsItemType0ProfileCurrentJobType0EmploymentTypeType0Item,
)
from ..models.reverse_phone_lookup_response_200_output_results_item_type_0_profile_current_job_type_0_job_function_type_0_item import (
    ReversePhoneLookupResponse200OutputResultsItemType0ProfileCurrentJobType0JobFunctionType0Item,
)
from ..models.reverse_phone_lookup_response_200_output_results_item_type_0_profile_current_job_type_0_seniority_type_1 import (
    ReversePhoneLookupResponse200OutputResultsItemType0ProfileCurrentJobType0SeniorityType1,
)
from ..models.reverse_phone_lookup_response_200_output_results_item_type_0_profile_current_job_type_0_seniority_type_2_type_1 import (
    ReversePhoneLookupResponse200OutputResultsItemType0ProfileCurrentJobType0SeniorityType2Type1,
)
from ..models.reverse_phone_lookup_response_200_output_results_item_type_0_profile_current_job_type_0_seniority_type_3_type_1 import (
    ReversePhoneLookupResponse200OutputResultsItemType0ProfileCurrentJobType0SeniorityType3Type1,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ReversePhoneLookupResponse200OutputResultsItemType0ProfileCurrentJobType0")


@_attrs_define
class ReversePhoneLookupResponse200OutputResultsItemType0ProfileCurrentJobType0:
    """
    Attributes:
        ...
        seniority (None | ReversePhoneLookupResponse200OutputResultsItemType0ProfileCurrentJobType0SeniorityType1 |
            ReversePhoneLookupResponse200OutputResultsItemType0ProfileCurrentJobType0SeniorityType2Type1 |
            ReversePhoneLookupResponse200OutputResultsItemType0ProfileCurrentJobType0SeniorityType3Type1 | Unset):
        job_function
            (list[ReversePhoneLookupResponse200OutputResultsItemType0ProfileCurrentJobType0JobFunctionType0Item] | None |
            Unset):
        employment_type
            (list[ReversePhoneLookupResponse200OutputResultsItemType0ProfileCurrentJobType0EmploymentTypeType0Item] | None |
            Unset):
        academic_qualification
            (list[ReversePhoneLookupResponse200OutputResultsItemType0ProfileCurrentJobType0AcademicQualificationType0Item] |
            None | Unset):
    ...
    job_function: (
        list[ReversePhoneLookupResponse200OutputResultsItemType0ProfileCurrentJobType0JobFunctionType0Item]
        | None
        | Unset
    ) = UNSET
    employment_type: (
        list[ReversePhoneLookupResponse200OutputResultsItemType0ProfileCurrentJobType0EmploymentTypeType0Item]
        | None
        | Unset
    ) = UNSET
    academic_qualification: (
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.seniority, Unset):
            ...
            self.seniority, ReversePhoneLookupResponse200OutputResultsItemType0ProfileCurrentJobType0SeniorityType1
        ):
            seniority = self.seniority.value
        elif isinstance(
            self.seniority, ReversePhoneLookupResponse200OutputResultsItemType0ProfileCurrentJobType0SeniorityType2Type1
        ):
            seniority = self.seniority.value
        elif isinstance(
            self.seniority, ReversePhoneLookupResponse200OutputResultsItemType0ProfileCurrentJobType0SeniorityType3Type1
        ):
            seniority = self.seniority.value
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_seniority(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                seniority_type_1 = (
                    ReversePhoneLookupResponse200OutputResultsItemType0ProfileCurrentJobType0SeniorityType1(data)
                )
            ...
            try:
                ...
                seniority_type_2_type_1 = (
                    ReversePhoneLookupResponse200OutputResultsItemType0ProfileCurrentJobType0SeniorityType2Type1(data)
                )
            ...
            try:
                ...
                seniority_type_3_type_1 = (
                    ReversePhoneLookupResponse200OutputResultsItemType0ProfileCurrentJobType0SeniorityType3Type1(data)
                )
        ...
        def _parse_employment_type(
            ...
            try:
                ...
                for employment_type_type_0_item_data in _employment_type_type_0:
                    employment_type_type_0_item = ReversePhoneLookupResponse200OutputResultsItemType0ProfileCurrentJobType0EmploymentTypeType0Item(
        ...
        def _parse_academic_qualification(
            ...
            try:
                ...
                for academic_qualification_type_0_item_data in _academic_qualification_type_0:
                    academic_qualification_type_0_item = ReversePhoneLookupResponse200OutputResultsItemType0ProfileCurrentJobType0AcademicQualificationType0Item(
        ...
        reverse_phone_lookup_response_200_output_results_item_type_0_profile_current_job_type_0 = cls(
        ...
        reverse_phone_lookup_response_200_output_results_item_type_0_profile_current_job_type_0.additional_properties = d
        return reverse_phone_lookup_response_200_output_results_item_type_0_profile_current_job_type_0
