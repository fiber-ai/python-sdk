...
T = TypeVar("T", bound="SyncCombinedSearchBodyCompanyParamsInvestorsType0AllOfType0Item")



@_attrs_define
class SyncCombinedSearchBodyCompanyParamsInvestorsType0AllOfType0Item:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sync_combined_search_body_company_params_investors_type_0_all_of_type_0_item = cls(
        ...
        sync_combined_search_body_company_params_investors_type_0_all_of_type_0_item.additional_properties = d
        return sync_combined_search_body_company_params_investors_type_0_all_of_type_0_item
