...
if TYPE_CHECKING:
  from ..models.reverse_email_lookup_response_200_output_data_item_tenures_type_0_item_date_range import ReverseEmailLookupResponse200OutputDataItemTenuresType0ItemDateRange





T = TypeVar("T", bound="ReverseEmailLookupResponse200OutputDataItemTenuresType0Item")



@_attrs_define
class ReverseEmailLookupResponse200OutputDataItemTenuresType0Item:
    """ 
        Attributes:
            date_range (ReverseEmailLookupResponse200OutputDataItemTenuresType0ItemDateRange):
            titles (list[str]):
            localities (list[str]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.reverse_email_lookup_response_200_output_data_item_tenures_type_0_item_date_range import ReverseEmailLookupResponse200OutputDataItemTenuresType0ItemDateRange
        d = dict(src_dict)
        date_range = ReverseEmailLookupResponse200OutputDataItemTenuresType0ItemDateRange.from_dict(d.pop("date_range"))
        ...
        reverse_email_lookup_response_200_output_data_item_tenures_type_0_item = cls(
            date_range=date_range,
            titles=titles,
            localities=localities,
        ...
        reverse_email_lookup_response_200_output_data_item_tenures_type_0_item.additional_properties = d
        return reverse_email_lookup_response_200_output_data_item_tenures_type_0_item
