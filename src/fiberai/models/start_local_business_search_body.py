...
class StartLocalBusinessSearchBody:
    """ 
        Attributes:
            ...
            data (list[Union['StartLocalBusinessSearchBodyDataItemType0', 'StartLocalBusinessSearchBodyDataItemType1']]):
                Array of businesses to search for
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in (_data):
            def _parse_data_item(data: object) -> Union['StartLocalBusinessSearchBodyDataItemType0', 'StartLocalBusinessSearchBodyDataItemType1']:
                try:
