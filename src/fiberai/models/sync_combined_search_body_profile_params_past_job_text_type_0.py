...
from ..models.sync_combined_search_body_profile_params_past_job_text_type_0_joiner import (
    SyncCombinedSearchBodyProfileParamsPastJobTextType0Joiner,
)

if TYPE_CHECKING:
    from ..models.sync_combined_search_body_profile_params_past_job_text_type_0_criteria_item import (
        SyncCombinedSearchBodyProfileParamsPastJobTextType0CriteriaItem,
    )
...
class SyncCombinedSearchBodyProfileParamsPastJobTextType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for criteria_item_data in _criteria:
            criteria_item = SyncCombinedSearchBodyProfileParamsPastJobTextType0CriteriaItem.from_dict(
                criteria_item_data
            )
