...
T = TypeVar("T", bound="PollBatchContactDetailsBody")


@_attrs_define
class PollBatchContactDetailsBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        poll_batch_contact_details_body = cls(
            api_key=api_key,
            task_id=task_id,
            cursor=cursor,
            take=take,
        ...
        poll_batch_contact_details_body.additional_properties = d
        return poll_batch_contact_details_body
