...
T = TypeVar("T", bound="PollBatchLiveEnrichResponse200OutputResultsItemProfileType0TenuresType0Item")


@_attrs_define
class PollBatchLiveEnrichResponse200OutputResultsItemProfileType0TenuresType0Item:
    """
    Attributes:
        date_range (PollBatchLiveEnrichResponse200OutputResultsItemProfileType0TenuresType0ItemDateRange):
        titles (list[str]):
        localities (list[str]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        date_range = PollBatchLiveEnrichResponse200OutputResultsItemProfileType0TenuresType0ItemDateRange.from_dict(
            d.pop("date_range")
        )
        ...
        poll_batch_live_enrich_response_200_output_results_item_profile_type_0_tenures_type_0_item = cls(
            date_range=date_range,
            titles=titles,
            localities=localities,
        ...
        poll_batch_live_enrich_response_200_output_results_item_profile_type_0_tenures_type_0_item.additional_properties = d
        return poll_batch_live_enrich_response_200_output_results_item_profile_type_0_tenures_type_0_item
