...
from ..models.company_count_body_search_params_office_locations_v2_type_0_all_of_type_0_item_type_2_type import (
    CompanyCountBodySearchParamsOfficeLocationsV2Type0AllOfType0ItemType2Type,
)

if TYPE_CHECKING:
    from ..models.company_count_body_search_params_office_locations_v2_type_0_all_of_type_0_item_type_2_location_type_0 import (
...
@_attrs_define
class CompanyCountBodySearchParamsOfficeLocationsV2Type0AllOfType0ItemType2:
    """
    Attributes:
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.company_count_body_search_params_office_locations_v2_type_0_all_of_type_0_item_type_2_location_type_0 import (
            CompanyCountBodySearchParamsOfficeLocationsV2Type0AllOfType0ItemType2LocationType0,  # noqa: PLC0415
        )
        from ..models.company_count_body_search_params_office_locations_v2_type_0_all_of_type_0_item_type_2_location_type_1 import (
            CompanyCountBodySearchParamsOfficeLocationsV2Type0AllOfType0ItemType2LocationType1,  # noqa: PLC0415
        )
        from ..models.company_count_body_search_params_office_locations_v2_type_0_all_of_type_0_item_type_2_location_type_2 import (
            CompanyCountBodySearchParamsOfficeLocationsV2Type0AllOfType0ItemType2LocationType2,  # noqa: PLC0415
        )
        ...
        if isinstance(
            self.location, CompanyCountBodySearchParamsOfficeLocationsV2Type0AllOfType0ItemType2LocationType0
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.company_count_body_search_params_office_locations_v2_type_0_all_of_type_0_item_type_2_location_type_3 import (
            CompanyCountBodySearchParamsOfficeLocationsV2Type0AllOfType0ItemType2LocationType3,  # noqa: PLC0415
        )
        ...
        def _parse_location(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                location_type_0 = (
                    CompanyCountBodySearchParamsOfficeLocationsV2Type0AllOfType0ItemType2LocationType0.from_dict(data)
                )
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                location_type_1 = (
                    CompanyCountBodySearchParamsOfficeLocationsV2Type0AllOfType0ItemType2LocationType1.from_dict(data)
                )
        ...
        company_count_body_search_params_office_locations_v2_type_0_all_of_type_0_item_type_2 = cls(
            type_=type_,
            location=location,
        )

        company_count_body_search_params_office_locations_v2_type_0_all_of_type_0_item_type_2.additional_properties = d
        return company_count_body_search_params_office_locations_v2_type_0_all_of_type_0_item_type_2
