...
T = TypeVar("T", bound="UpdateAutoTopupSettingsResponse200")


@_attrs_define
class UpdateAutoTopupSettingsResponse200:
    """
    Attributes:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        output: dict[str, Any]
        if isinstance(self.output, UpdateAutoTopupSettingsResponse200OutputType0):
            output = self.output.to_dict()
        else:
            output = self.output.to_dict()

        charge_info: dict[str, Any]
        if isinstance(self.charge_info, UpdateAutoTopupSettingsResponse200ChargeInfoType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_output(
            data: object,
        ) -> UpdateAutoTopupSettingsResponse200OutputType0 | UpdateAutoTopupSettingsResponse200OutputType1:
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                output_type_0 = UpdateAutoTopupSettingsResponse200OutputType0.from_dict(data)
            ...
            if not isinstance(data, dict):
                raise TypeError()
            output_type_1 = UpdateAutoTopupSettingsResponse200OutputType1.from_dict(data)
        ...
        def _parse_charge_info(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_0 = UpdateAutoTopupSettingsResponse200ChargeInfoType0.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_1 = UpdateAutoTopupSettingsResponse200ChargeInfoType1.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_2 = UpdateAutoTopupSettingsResponse200ChargeInfoType2.from_dict(data)
        ...
        def _parse_warnings(data: object) -> list[UpdateAutoTopupSettingsResponse200WarningsType0Item] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for warnings_type_0_item_data in _warnings_type_0:
                    warnings_type_0_item = UpdateAutoTopupSettingsResponse200WarningsType0Item.from_dict(
                ...
                pass
            return cast(list[UpdateAutoTopupSettingsResponse200WarningsType0Item] | None | Unset, data)
        ...
        update_auto_topup_settings_response_200 = cls(
            output=output,
        ...
        return update_auto_topup_settings_response_200
