...
T = TypeVar("T", bound="EstimateEnrichmentCostBodyEnrichmentType")


@_attrs_define
class EstimateEnrichmentCostBodyEnrichmentType:
    """Enrichment types to estimate costs for
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        estimate_enrichment_cost_body_enrichment_type = cls(
            get_work_emails=get_work_emails,
            get_personal_emails=get_personal_emails,
            get_phone_numbers=get_phone_numbers,
        )

        estimate_enrichment_cost_body_enrichment_type.additional_properties = d
        return estimate_enrichment_cost_body_enrichment_type
