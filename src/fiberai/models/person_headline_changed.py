...
T = TypeVar("T", bound="PersonHeadlineChanged")


@_attrs_define
class PersonHeadlineChanged:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        type_ = cast(Literal["person_headline_changed"], d.pop("type"))
        if type_ != "person_headline_changed":
            raise ValueError(f"type must match const 'person_headline_changed', got '{type_}'")
        ...
        person_headline_changed.additional_properties = d
        return person_headline_changed
