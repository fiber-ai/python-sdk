...
T = TypeVar("T", bound="GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyLocationsStatsType0")


@_attrs_define
class GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyLocationsStatsType0:
    """
    Attributes:
        usa (float | Unset):
        gbr (float | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_saved_search_run_companies_response_200_output_companies_item_company_locations_stats_type_0 = cls(
            usa=usa,
            gbr=gbr,
            fra=fra,
            ind=ind,
        ...
        return get_saved_search_run_companies_response_200_output_companies_item_company_locations_stats_type_0
