...
from ..models.get_saved_search_run_profiles_response_200_output_profiles_item_profile_current_job_type_0_academic_qualification_type_0_item import (
    GetSavedSearchRunProfilesResponse200OutputProfilesItemProfileCurrentJobType0AcademicQualificationType0Item,
)
from ..models.get_saved_search_run_profiles_response_200_output_profiles_item_profile_current_job_type_0_employment_type_type_0_item import (
    GetSavedSearchRunProfilesResponse200OutputProfilesItemProfileCurrentJobType0EmploymentTypeType0Item,
)
from ..models.get_saved_search_run_profiles_response_200_output_profiles_item_profile_current_job_type_0_job_function_type_0_item import (
    GetSavedSearchRunProfilesResponse200OutputProfilesItemProfileCurrentJobType0JobFunctionType0Item,
)
from ..models.get_saved_search_run_profiles_response_200_output_profiles_item_profile_current_job_type_0_seniority_type_1 import (
    GetSavedSearchRunProfilesResponse200OutputProfilesItemProfileCurrentJobType0SeniorityType1,
)
from ..models.get_saved_search_run_profiles_response_200_output_profiles_item_profile_current_job_type_0_seniority_type_2_type_1 import (
    GetSavedSearchRunProfilesResponse200OutputProfilesItemProfileCurrentJobType0SeniorityType2Type1,
)
from ..models.get_saved_search_run_profiles_response_200_output_profiles_item_profile_current_job_type_0_seniority_type_3_type_1 import (
...
class GetSavedSearchRunProfilesResponse200OutputProfilesItemProfileCurrentJobType0:
    ...
    Attributes:
        ...
        seniority (GetSavedSearchRunProfilesResponse200OutputProfilesItemProfileCurrentJobType0SeniorityType1 |
            GetSavedSearchRunProfilesResponse200OutputProfilesItemProfileCurrentJobType0SeniorityType2Type1 |
            GetSavedSearchRunProfilesResponse200OutputProfilesItemProfileCurrentJobType0SeniorityType3Type1 | None | Unset):
        job_function
            (list[GetSavedSearchRunProfilesResponse200OutputProfilesItemProfileCurrentJobType0JobFunctionType0Item] | None |
            Unset):
        employment_type
            (list[GetSavedSearchRunProfilesResponse200OutputProfilesItemProfileCurrentJobType0EmploymentTypeType0Item] |
            None | Unset):
        academic_qualification (list[GetSavedSearchRunProfilesResponse200OutputProfilesItemProfileCurrentJobType0Academi
    ...
    academic_qualification: (
        list[GetSavedSearchRunProfilesResponse200OutputProfilesItemProfileCurrentJobType0AcademicQualificationType0Item]
        | None
        | Unset
    ) = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.seniority, Unset):
            ...
            self.seniority, GetSavedSearchRunProfilesResponse200OutputProfilesItemProfileCurrentJobType0SeniorityType1
        ):
        ...
        def _parse_seniority(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                seniority_type_1 = (
                    GetSavedSearchRunProfilesResponse200OutputProfilesItemProfileCurrentJobType0SeniorityType1(data)
                )
        ...
        def _parse_job_function(
            ...
            try:
                ...
                for job_function_type_0_item_data in _job_function_type_0:
                    job_function_type_0_item = GetSavedSearchRunProfilesResponse200OutputProfilesItemProfileCurrentJobType0JobFunctionType0Item(
        ...
        def _parse_employment_type(
            ...
            try:
                ...
                for employment_type_type_0_item_data in _employment_type_type_0:
                    employment_type_type_0_item = GetSavedSearchRunProfilesResponse200OutputProfilesItemProfileCurrentJobType0EmploymentTypeType0Item(
        ...
        def _parse_academic_qualification(
            ...
            try:
                ...
                for academic_qualification_type_0_item_data in _academic_qualification_type_0:
                    academic_qualification_type_0_item = GetSavedSearchRunProfilesResponse200OutputProfilesItemProfileCurrentJobType0AcademicQualificationType0Item(
