...
T = TypeVar("T", bound="LiteReverseEmailLookupResponse200OutputDataItemCertificationsType0Item")


@_attrs_define
class LiteReverseEmailLookupResponse200OutputDataItemCertificationsType0Item:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        lite_reverse_email_lookup_response_200_output_data_item_certifications_type_0_item = cls(
            title=title,
        ...
        lite_reverse_email_lookup_response_200_output_data_item_certifications_type_0_item.additional_properties = d
        return lite_reverse_email_lookup_response_200_output_data_item_certifications_type_0_item
