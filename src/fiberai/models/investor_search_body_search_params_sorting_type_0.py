...
from ..models.investor_search_body_search_params_sorting_type_0_direction import InvestorSearchBodySearchParamsSortingType0Direction
from ..models.investor_search_body_search_params_sorting_type_0_field import InvestorSearchBodySearchParamsSortingType0Field
from ..types import UNSET, Unset
...
class InvestorSearchBodySearchParamsSortingType0:
    """ Sorting configuration. If provided, field is required. Defaults to total_investment_count DESC if not provided.
        ...
        Attributes:
            field (InvestorSearchBodySearchParamsSortingType0Field): Field to sort by. For 'importance', higher values
                ...
                important investors.
            direction (Union[Unset, InvestorSearchBodySearchParamsSortingType0Direction]): Sort order - asc or desc
                (defaults to desc) Default: InvestorSearchBodySearchParamsSortingType0Direction.DESC.
     """

    field: InvestorSearchBodySearchParamsSortingType0Field
    direction: Union[Unset, InvestorSearchBodySearchParamsSortingType0Direction] = InvestorSearchBodySearchParamsSortingType0Direction.DESC
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        direction: Union[Unset, InvestorSearchBodySearchParamsSortingType0Direction]
