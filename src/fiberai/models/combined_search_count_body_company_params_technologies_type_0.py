...
T = TypeVar("T", bound="CombinedSearchCountBodyCompanyParamsTechnologiesType0")


@_attrs_define
class CombinedSearchCountBodyCompanyParamsTechnologiesType0:
    """
    Attributes:
        any_of (list[CombinedSearchCountBodyCompanyParamsTechnologiesType0AnyOfType0ItemType0 |
            CombinedSearchCountBodyCompanyParamsTechnologiesType0AnyOfType0ItemType1] | None | Unset):
        all_of (list[CombinedSearchCountBodyCompanyParamsTechnologiesType0AllOfType0ItemType0 |
            CombinedSearchCountBodyCompanyParamsTechnologiesType0AllOfType0ItemType1] | None | Unset):
        none_of (list[CombinedSearchCountBodyCompanyParamsTechnologiesType0NoneOfType0ItemType0 |
            CombinedSearchCountBodyCompanyParamsTechnologiesType0NoneOfType0ItemType1] | None | Unset):
    """
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.any_of, Unset):
            ...
            for any_of_type_0_item_data in self.any_of:
                ...
                if isinstance(
                    any_of_type_0_item_data, CombinedSearchCountBodyCompanyParamsTechnologiesType0AnyOfType0ItemType0
                ):
        ...
        if isinstance(self.all_of, Unset):
            ...
            for all_of_type_0_item_data in self.all_of:
                ...
                if isinstance(
                    all_of_type_0_item_data, CombinedSearchCountBodyCompanyParamsTechnologiesType0AllOfType0ItemType0
                ):
        ...
        if isinstance(self.none_of, Unset):
            ...
            for none_of_type_0_item_data in self.none_of:
                ...
                if isinstance(
                    none_of_type_0_item_data, CombinedSearchCountBodyCompanyParamsTechnologiesType0NoneOfType0ItemType0
                ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
                    ...
                    def _parse_any_of_type_0_item(
                        ...
                        try:
                            ...
                            any_of_type_0_item_type_0 = (
                                CombinedSearchCountBodyCompanyParamsTechnologiesType0AnyOfType0ItemType0.from_dict(data)
                            )
                        ...
                        any_of_type_0_item_type_1 = (
                            CombinedSearchCountBodyCompanyParamsTechnologiesType0AnyOfType0ItemType1.from_dict(data)
                        )
                    ...
                    def _parse_all_of_type_0_item(
                        ...
                        try:
                            ...
                            all_of_type_0_item_type_0 = (
                                CombinedSearchCountBodyCompanyParamsTechnologiesType0AllOfType0ItemType0.from_dict(data)
                            )
                        ...
                        all_of_type_0_item_type_1 = (
                            CombinedSearchCountBodyCompanyParamsTechnologiesType0AllOfType0ItemType1.from_dict(data)
                        )
                    ...
                    def _parse_none_of_type_0_item(
                        ...
                        try:
                            ...
                            none_of_type_0_item_type_0 = (
                                CombinedSearchCountBodyCompanyParamsTechnologiesType0NoneOfType0ItemType0.from_dict(
                                    data
                                )
                            )
                        ...
                        none_of_type_0_item_type_1 = (
                            CombinedSearchCountBodyCompanyParamsTechnologiesType0NoneOfType0ItemType1.from_dict(data)
                        )
        ...
        combined_search_count_body_company_params_technologies_type_0 = cls(
            any_of=any_of,
            all_of=all_of,
            none_of=none_of,
        )

        combined_search_count_body_company_params_technologies_type_0.additional_properties = d
        return combined_search_count_body_company_params_technologies_type_0
