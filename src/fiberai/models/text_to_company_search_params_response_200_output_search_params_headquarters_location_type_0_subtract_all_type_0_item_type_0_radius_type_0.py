...
from ..models.text_to_company_search_params_response_200_output_search_params_headquarters_location_type_0_subtract_all_type_0_item_type_0_radius_type_0_unit import (
    TextToCompanySearchParamsResponse200OutputSearchParamsHeadquartersLocationType0SubtractAllType0ItemType0RadiusType0Unit,
)

T = TypeVar(
    "T",
    bound="TextToCompanySearchParamsResponse200OutputSearchParamsHeadquartersLocationType0SubtractAllType0ItemType0RadiusType0",
)
