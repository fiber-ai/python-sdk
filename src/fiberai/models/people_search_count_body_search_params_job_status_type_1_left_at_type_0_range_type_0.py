...
T = TypeVar("T", bound="PeopleSearchCountBodySearchParamsJobStatusType1LeftAtType0RangeType0")


@_attrs_define
class PeopleSearchCountBodySearchParamsJobStatusType1LeftAtType0RangeType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        people_search_count_body_search_params_job_status_type_1_left_at_type_0_range_type_0 = cls(
            lower_bound=lower_bound,
            upper_bound=upper_bound,
        )

        people_search_count_body_search_params_job_status_type_1_left_at_type_0_range_type_0.additional_properties = d
        return people_search_count_body_search_params_job_status_type_1_left_at_type_0_range_type_0
