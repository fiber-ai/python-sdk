...
T = TypeVar(
    "T",
    bound="QuickCompanyResolveResponse200OutputDataItemCompanyType0FundingRoundStatsType0IndividualInvestorStatsType0Item",
)


@_attrs_define
class QuickCompanyResolveResponse200OutputDataItemCompanyType0FundingRoundStatsType0IndividualInvestorStatsType0Item:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        quick_company_resolve_response_200_output_data_item_company_type_0_funding_round_stats_type_0_individual_investor_stats_type_0_item = cls(
        ...
        quick_company_resolve_response_200_output_data_item_company_type_0_funding_round_stats_type_0_individual_investor_stats_type_0_item.additional_properties = d
        return quick_company_resolve_response_200_output_data_item_company_type_0_funding_round_stats_type_0_individual_investor_stats_type_0_item
