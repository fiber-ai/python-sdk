...
if TYPE_CHECKING:
    from ..models.get_current_profiles_in_saved_search_response_200_output_profiles_item_tenures_type_0_item_date_range import (
        GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemTenuresType0ItemDateRange,
    )
...
class GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemTenuresType0Item:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.get_current_profiles_in_saved_search_response_200_output_profiles_item_tenures_type_0_item_date_range import (
            GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemTenuresType0ItemDateRange,  # noqa: PLC0415
        )

        d = dict(src_dict)
        date_range = GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemTenuresType0ItemDateRange.from_dict(
            d.pop("date_range")
        )
