...
T = TypeVar("T", bound="JdToProfileSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemCompanyDetailsType0")


@_attrs_define
class JdToProfileSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemCompanyDetailsType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        jd_to_profile_search_response_200_output_data_item_detailed_work_experiences_type_0_item_company_details_type_0 = cls(
        ...
        jd_to_profile_search_response_200_output_data_item_detailed_work_experiences_type_0_item_company_details_type_0.additional_properties = d
        return jd_to_profile_search_response_200_output_data_item_detailed_work_experiences_type_0_item_company_details_type_0
