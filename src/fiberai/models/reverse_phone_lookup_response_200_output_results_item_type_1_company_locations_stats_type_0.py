...
T = TypeVar("T", bound="ReversePhoneLookupResponse200OutputResultsItemType1CompanyLocationsStatsType0")


@_attrs_define
class ReversePhoneLookupResponse200OutputResultsItemType1CompanyLocationsStatsType0:
    """
    Attributes:
        usa (float | Unset):
        gbr (float | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reverse_phone_lookup_response_200_output_results_item_type_1_company_locations_stats_type_0 = cls(
            usa=usa,
            gbr=gbr,
            fra=fra,
            ind=ind,
        ...
        return reverse_phone_lookup_response_200_output_results_item_type_1_company_locations_stats_type_0
