...
if TYPE_CHECKING:
  from ..models.kitchen_sink_profile_response_200_output_data_item_tenures_type_0_item_date_range import KitchenSinkProfileResponse200OutputDataItemTenuresType0ItemDateRange





T = TypeVar("T", bound="KitchenSinkProfileResponse200OutputDataItemTenuresType0Item")



@_attrs_define
class KitchenSinkProfileResponse200OutputDataItemTenuresType0Item:
    """ 
        Attributes:
            date_range (KitchenSinkProfileResponse200OutputDataItemTenuresType0ItemDateRange):
            titles (list[str]):
            localities (list[str]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.kitchen_sink_profile_response_200_output_data_item_tenures_type_0_item_date_range import KitchenSinkProfileResponse200OutputDataItemTenuresType0ItemDateRange
        d = dict(src_dict)
        date_range = KitchenSinkProfileResponse200OutputDataItemTenuresType0ItemDateRange.from_dict(d.pop("date_range"))
        ...
        kitchen_sink_profile_response_200_output_data_item_tenures_type_0_item = cls(
            date_range=date_range,
            titles=titles,
            localities=localities,
        ...
        kitchen_sink_profile_response_200_output_data_item_tenures_type_0_item.additional_properties = d
        return kitchen_sink_profile_response_200_output_data_item_tenures_type_0_item
