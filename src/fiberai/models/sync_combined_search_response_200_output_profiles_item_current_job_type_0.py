...
from ..models.sync_combined_search_response_200_output_profiles_item_current_job_type_0_academic_qualification_type_0_item import SyncCombinedSearchResponse200OutputProfilesItemCurrentJobType0AcademicQualificationType0Item
from ..models.sync_combined_search_response_200_output_profiles_item_current_job_type_0_employment_type_type_0_item import SyncCombinedSearchResponse200OutputProfilesItemCurrentJobType0EmploymentTypeType0Item
from ..models.sync_combined_search_response_200_output_profiles_item_current_job_type_0_job_function_type_0_item import SyncCombinedSearchResponse200OutputProfilesItemCurrentJobType0JobFunctionType0Item
from ..models.sync_combined_search_response_200_output_profiles_item_current_job_type_0_seniority_type_1 import SyncCombinedSearchResponse200OutputProfilesItemCurrentJobType0SeniorityType1
from ..models.sync_combined_search_response_200_output_profiles_item_current_job_type_0_seniority_type_2_type_1 import SyncCombinedSearchResponse200OutputProfilesItemCurrentJobType0SeniorityType2Type1
from ..models.sync_combined_search_response_200_output_profiles_item_current_job_type_0_seniority_type_3_type_1 import SyncCombinedSearchResponse200OutputProfilesItemCurrentJobType0SeniorityType3Type1
from ..types import UNSET, Unset
...
class SyncCombinedSearchResponse200OutputProfilesItemCurrentJobType0:
    """ 
        Attributes:
            ...
            seniority (Union[None, SyncCombinedSearchResponse200OutputProfilesItemCurrentJobType0SeniorityType1,
            ...
            job_function (Union[None, Unset,
                list[SyncCombinedSearchResponse200OutputProfilesItemCurrentJobType0JobFunctionType0Item]]):
    ...
    seniority: Union[None, SyncCombinedSearchResponse200OutputProfilesItemCurrentJobType0SeniorityType1, SyncCombinedSearchResponse200OutputProfilesItemCurrentJobType0SeniorityType2Type1, SyncCombinedSearchResponse200OutputProfilesItemCurrentJobType0SeniorityType3Type1, Unset] = UNSET
    job_function: Union[None, Unset, list[SyncCombinedSearchResponse200OutputProfilesItemCurrentJobType0JobFunctionType0Item]] = UNSET
    employment_type: Union[None, Unset, list[SyncCombinedSearchResponse200OutputProfilesItemCurrentJobType0EmploymentTypeType0Item]] = UNSET
    academic_qualification: Union[None, Unset, list[SyncCombinedSearchResponse200OutputProfilesItemCurrentJobType0AcademicQualificationType0Item]] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.seniority, SyncCombinedSearchResponse200OutputProfilesItemCurrentJobType0SeniorityType2Type1):
            seniority = self.seniority.value
        elif isinstance(self.seniority, SyncCombinedSearchResponse200OutputProfilesItemCurrentJobType0SeniorityType3Type1):
            seniority = self.seniority.value
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_seniority(data: object) -> Union[None, SyncCombinedSearchResponse200OutputProfilesItemCurrentJobType0SeniorityType1, SyncCombinedSearchResponse200OutputProfilesItemCurrentJobType0SeniorityType2Type1, SyncCombinedSearchResponse200OutputProfilesItemCurrentJobType0SeniorityType3Type1, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                seniority_type_2_type_1 = SyncCombinedSearchResponse200OutputProfilesItemCurrentJobType0SeniorityType2Type1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                seniority_type_3_type_1 = SyncCombinedSearchResponse200OutputProfilesItemCurrentJobType0SeniorityType3Type1(data)
                ...
                pass
            return cast(Union[None, SyncCombinedSearchResponse200OutputProfilesItemCurrentJobType0SeniorityType1, SyncCombinedSearchResponse200OutputProfilesItemCurrentJobType0SeniorityType2Type1, SyncCombinedSearchResponse200OutputProfilesItemCurrentJobType0SeniorityType3Type1, Unset], data)

        seniority = _parse_seniority(d.pop("seniority", UNSET))


        def _parse_job_function(data: object) -> Union[None, Unset, list[SyncCombinedSearchResponse200OutputProfilesItemCurrentJobType0JobFunctionType0Item]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for job_function_type_0_item_data in (_job_function_type_0):
                    job_function_type_0_item = SyncCombinedSearchResponse200OutputProfilesItemCurrentJobType0JobFunctionType0Item(job_function_type_0_item_data)
                ...
                pass
            return cast(Union[None, Unset, list[SyncCombinedSearchResponse200OutputProfilesItemCurrentJobType0JobFunctionType0Item]], data)

        job_function = _parse_job_function(d.pop("job_function", UNSET))


        def _parse_employment_type(data: object) -> Union[None, Unset, list[SyncCombinedSearchResponse200OutputProfilesItemCurrentJobType0EmploymentTypeType0Item]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for employment_type_type_0_item_data in (_employment_type_type_0):
                    employment_type_type_0_item = SyncCombinedSearchResponse200OutputProfilesItemCurrentJobType0EmploymentTypeType0Item(employment_type_type_0_item_data)
                ...
                pass
            return cast(Union[None, Unset, list[SyncCombinedSearchResponse200OutputProfilesItemCurrentJobType0EmploymentTypeType0Item]], data)

        employment_type = _parse_employment_type(d.pop("employment_type", UNSET))


        def _parse_academic_qualification(data: object) -> Union[None, Unset, list[SyncCombinedSearchResponse200OutputProfilesItemCurrentJobType0AcademicQualificationType0Item]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for academic_qualification_type_0_item_data in (_academic_qualification_type_0):
                    academic_qualification_type_0_item = SyncCombinedSearchResponse200OutputProfilesItemCurrentJobType0AcademicQualificationType0Item(academic_qualification_type_0_item_data)
                ...
                pass
            return cast(Union[None, Unset, list[SyncCombinedSearchResponse200OutputProfilesItemCurrentJobType0AcademicQualificationType0Item]], data)
