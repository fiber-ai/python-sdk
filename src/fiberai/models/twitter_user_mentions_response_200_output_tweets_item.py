...
T = TypeVar("T", bound="TwitterUserMentionsResponse200OutputTweetsItem")


@_attrs_define
class TwitterUserMentionsResponse200OutputTweetsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        twitter_user_mentions_response_200_output_tweets_item = cls(
            id=id,
            text=text,
            author_id=author_id,
            handle=handle,
        ...
        twitter_user_mentions_response_200_output_tweets_item.additional_properties = d
        return twitter_user_mentions_response_200_output_tweets_item
