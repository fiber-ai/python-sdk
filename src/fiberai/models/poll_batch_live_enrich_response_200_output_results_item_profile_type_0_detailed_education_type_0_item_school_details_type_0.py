...
T = TypeVar(
    "T", bound="PollBatchLiveEnrichResponse200OutputResultsItemProfileType0DetailedEducationType0ItemSchoolDetailsType0"
)


@_attrs_define
class PollBatchLiveEnrichResponse200OutputResultsItemProfileType0DetailedEducationType0ItemSchoolDetailsType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        poll_batch_live_enrich_response_200_output_results_item_profile_type_0_detailed_education_type_0_item_school_details_type_0 = cls(
        ...
        poll_batch_live_enrich_response_200_output_results_item_profile_type_0_detailed_education_type_0_item_school_details_type_0.additional_properties = d
        return poll_batch_live_enrich_response_200_output_results_item_profile_type_0_detailed_education_type_0_item_school_details_type_0
