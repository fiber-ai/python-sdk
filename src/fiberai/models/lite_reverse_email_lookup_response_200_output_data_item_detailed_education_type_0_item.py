...
if TYPE_CHECKING:
    from ..models.lite_reverse_email_lookup_response_200_output_data_item_detailed_education_type_0_item_school_details_type_0 import (
        LiteReverseEmailLookupResponse200OutputDataItemDetailedEducationType0ItemSchoolDetailsType0,
    )


T = TypeVar("T", bound="LiteReverseEmailLookupResponse200OutputDataItemDetailedEducationType0Item")


@_attrs_define
class LiteReverseEmailLookupResponse200OutputDataItemDetailedEducationType0Item:
    """
    Attributes:
        school_details (LiteReverseEmailLookupResponse200OutputDataItemDetailedEducationType0ItemSchoolDetailsType0 |
            None | Unset):
    ...
    school_details: (
        LiteReverseEmailLookupResponse200OutputDataItemDetailedEducationType0ItemSchoolDetailsType0 | None | Unset
    ) = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.lite_reverse_email_lookup_response_200_output_data_item_detailed_education_type_0_item_school_details_type_0 import (
            LiteReverseEmailLookupResponse200OutputDataItemDetailedEducationType0ItemSchoolDetailsType0,  # noqa: PLC0415
        )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_school_details(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                school_details_type_0 = LiteReverseEmailLookupResponse200OutputDataItemDetailedEducationType0ItemSchoolDetailsType0.from_dict(
                    data
                )
        ...
        lite_reverse_email_lookup_response_200_output_data_item_detailed_education_type_0_item = cls(
        ...
        lite_reverse_email_lookup_response_200_output_data_item_detailed_education_type_0_item.additional_properties = d
        return lite_reverse_email_lookup_response_200_output_data_item_detailed_education_type_0_item
