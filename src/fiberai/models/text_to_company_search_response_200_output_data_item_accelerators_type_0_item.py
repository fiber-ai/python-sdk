...
if TYPE_CHECKING:
    from ..models.text_to_company_search_response_200_output_data_item_accelerators_type_0_item_founders_type_0_item import (
        TextToCompanySearchResponse200OutputDataItemAcceleratorsType0ItemFoundersType0Item,
    )
...
class TextToCompanySearchResponse200OutputDataItemAcceleratorsType0Item:
    ...
    Attributes:
        ...
        founders (list[TextToCompanySearchResponse200OutputDataItemAcceleratorsType0ItemFoundersType0Item] | None |
            Unset):
    ...
    founders: (
        list[TextToCompanySearchResponse200OutputDataItemAcceleratorsType0ItemFoundersType0Item] | None | Unset
    ) = UNSET
            ...
            try:
                ...
                for founders_type_0_item_data in _founders_type_0:
                    founders_type_0_item = (
                        TextToCompanySearchResponse200OutputDataItemAcceleratorsType0ItemFoundersType0Item.from_dict(
