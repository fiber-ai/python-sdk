...
T = TypeVar("T", bound="PaginatedCombinedSearchResponse200OutputCompaniesItemEmployeeTrendsType0ItemChangesType0Item")


@_attrs_define
class PaginatedCombinedSearchResponse200OutputCompaniesItemEmployeeTrendsType0ItemChangesType0Item:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        paginated_combined_search_response_200_output_companies_item_employee_trends_type_0_item_changes_type_0_item = (
            cls(
                count_end=count_end,
        ...
        paginated_combined_search_response_200_output_companies_item_employee_trends_type_0_item_changes_type_0_item.additional_properties = d
        return (
            paginated_combined_search_response_200_output_companies_item_employee_trends_type_0_item_changes_type_0_item
        )
