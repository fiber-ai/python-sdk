...
if TYPE_CHECKING:
  from ..models.kitchen_sink_profile_response_200_output_data_item_inferred_location_type_0_coordinates_type_0 import KitchenSinkProfileResponse200OutputDataItemInferredLocationType0CoordinatesType0





T = TypeVar("T", bound="KitchenSinkProfileResponse200OutputDataItemInferredLocationType0")



@_attrs_define
class KitchenSinkProfileResponse200OutputDataItemInferredLocationType0:
    """ 
        Attributes:
            ...
            coordinates (Union['KitchenSinkProfileResponse200OutputDataItemInferredLocationType0CoordinatesType0', None,
                Unset]):
    ...
    coordinates: Union['KitchenSinkProfileResponse200OutputDataItemInferredLocationType0CoordinatesType0', None, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.coordinates, Unset):
            coordinates = UNSET
        elif isinstance(self.coordinates, KitchenSinkProfileResponse200OutputDataItemInferredLocationType0CoordinatesType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_coordinates(data: object) -> Union['KitchenSinkProfileResponse200OutputDataItemInferredLocationType0CoordinatesType0', None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = KitchenSinkProfileResponse200OutputDataItemInferredLocationType0CoordinatesType0.from_dict(data)
                ...
                pass
            return cast(Union['KitchenSinkProfileResponse200OutputDataItemInferredLocationType0CoordinatesType0', None, Unset], data)
        ...
        kitchen_sink_profile_response_200_output_data_item_inferred_location_type_0 = cls(
        ...
        kitchen_sink_profile_response_200_output_data_item_inferred_location_type_0.additional_properties = d
        return kitchen_sink_profile_response_200_output_data_item_inferred_location_type_0
