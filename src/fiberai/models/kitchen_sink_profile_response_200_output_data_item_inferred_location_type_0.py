...
if TYPE_CHECKING:
    from ..models.kitchen_sink_profile_response_200_output_data_item_inferred_location_type_0_coordinates_type_0 import (
        KitchenSinkProfileResponse200OutputDataItemInferredLocationType0CoordinatesType0,
    )
...
class KitchenSinkProfileResponse200OutputDataItemInferredLocationType0:
    ...
    Attributes:
        ...
        coordinates (KitchenSinkProfileResponse200OutputDataItemInferredLocationType0CoordinatesType0 | None | Unset):
    ...
    coordinates: KitchenSinkProfileResponse200OutputDataItemInferredLocationType0CoordinatesType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.kitchen_sink_profile_response_200_output_data_item_inferred_location_type_0_coordinates_type_0 import (
            KitchenSinkProfileResponse200OutputDataItemInferredLocationType0CoordinatesType0,  # noqa: PLC0415
        )
        ...
        if isinstance(self.coordinates, Unset):
            ...
            self.coordinates, KitchenSinkProfileResponse200OutputDataItemInferredLocationType0CoordinatesType0
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_coordinates(
            data: object,
        ) -> KitchenSinkProfileResponse200OutputDataItemInferredLocationType0CoordinatesType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = (
                    KitchenSinkProfileResponse200OutputDataItemInferredLocationType0CoordinatesType0.from_dict(data)
                )
                ...
                pass
            return cast(
                KitchenSinkProfileResponse200OutputDataItemInferredLocationType0CoordinatesType0 | None | Unset, data
            )
