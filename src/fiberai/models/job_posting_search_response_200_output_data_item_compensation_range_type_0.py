...
class JobPostingSearchResponse200OutputDataItemCompensationRangeType0:
    ...
    Attributes:
        lte (JobPostingSearchResponse200OutputDataItemCompensationRangeType0LteType0 | None | Unset):
        gte (JobPostingSearchResponse200OutputDataItemCompensationRangeType0GteType0 | None | Unset):
    """

    lte: JobPostingSearchResponse200OutputDataItemCompensationRangeType0LteType0 | None | Unset = UNSET
    gte: JobPostingSearchResponse200OutputDataItemCompensationRangeType0GteType0 | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_lte(
            data: object,
        ) -> JobPostingSearchResponse200OutputDataItemCompensationRangeType0LteType0 | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                pass
            return cast(JobPostingSearchResponse200OutputDataItemCompensationRangeType0LteType0 | None | Unset, data)

        lte = _parse_lte(d.pop("lte", UNSET))

        def _parse_gte(
            data: object,
        ) -> JobPostingSearchResponse200OutputDataItemCompensationRangeType0GteType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(JobPostingSearchResponse200OutputDataItemCompensationRangeType0GteType0 | None | Unset, data)
