...
if TYPE_CHECKING:
    from ..models.poll_batch_live_enrich_response_200_output_results_item_company_type_0_inferred_location_type_0_coordinates_type_0 import (
        PollBatchLiveEnrichResponse200OutputResultsItemCompanyType0InferredLocationType0CoordinatesType0,
    )


T = TypeVar("T", bound="PollBatchLiveEnrichResponse200OutputResultsItemCompanyType0InferredLocationType0")


@_attrs_define
class PollBatchLiveEnrichResponse200OutputResultsItemCompanyType0InferredLocationType0:
    """
    Attributes:
        ...
        coordinates (None |
            PollBatchLiveEnrichResponse200OutputResultsItemCompanyType0InferredLocationType0CoordinatesType0 | Unset):
    ...
    coordinates: (
        None | PollBatchLiveEnrichResponse200OutputResultsItemCompanyType0InferredLocationType0CoordinatesType0 | Unset
    ) = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.poll_batch_live_enrich_response_200_output_results_item_company_type_0_inferred_location_type_0_coordinates_type_0 import (
            PollBatchLiveEnrichResponse200OutputResultsItemCompanyType0InferredLocationType0CoordinatesType0,  # noqa: PLC0415
        )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_coordinates(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = PollBatchLiveEnrichResponse200OutputResultsItemCompanyType0InferredLocationType0CoordinatesType0.from_dict(
                    data
                )
        ...
        poll_batch_live_enrich_response_200_output_results_item_company_type_0_inferred_location_type_0 = cls(
        ...
        poll_batch_live_enrich_response_200_output_results_item_company_type_0_inferred_location_type_0.additional_properties = d
        return poll_batch_live_enrich_response_200_output_results_item_company_type_0_inferred_location_type_0
