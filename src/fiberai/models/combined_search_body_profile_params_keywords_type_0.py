...
T = TypeVar("T", bound="CombinedSearchBodyProfileParamsKeywordsType0")


@_attrs_define
class CombinedSearchBodyProfileParamsKeywordsType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        combined_search_body_profile_params_keywords_type_0 = cls(
            contains_all=contains_all,
            contains_any=contains_any,
            contains_none=contains_none,
        )

        combined_search_body_profile_params_keywords_type_0.additional_properties = d
        return combined_search_body_profile_params_keywords_type_0
