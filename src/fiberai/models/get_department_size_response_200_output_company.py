...
T = TypeVar("T", bound="GetDepartmentSizeResponse200OutputCompany")


@_attrs_define
class GetDepartmentSizeResponse200OutputCompany:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_department_size_response_200_output_company = cls(
            name=name,
        ...
        get_department_size_response_200_output_company.additional_properties = d
        return get_department_size_response_200_output_company
