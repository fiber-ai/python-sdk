...
T = TypeVar("T", bound="JdToProfileSearchResponse200OutputDataItemProjectsType0Item")


@_attrs_define
class JdToProfileSearchResponse200OutputDataItemProjectsType0Item:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        jd_to_profile_search_response_200_output_data_item_projects_type_0_item = cls(
        ...
        jd_to_profile_search_response_200_output_data_item_projects_type_0_item.additional_properties = d
        return jd_to_profile_search_response_200_output_data_item_projects_type_0_item
