...
T = TypeVar("T", bound="KitchenSinkCompanyResponse200OutputDataItemFullFundingRoundsType0ItemInvestorsType0Item")



@_attrs_define
class KitchenSinkCompanyResponse200OutputDataItemFullFundingRoundsType0ItemInvestorsType0Item:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        kitchen_sink_company_response_200_output_data_item_full_funding_rounds_type_0_item_investors_type_0_item = cls(
            is_lead=is_lead,
        ...
        kitchen_sink_company_response_200_output_data_item_full_funding_rounds_type_0_item_investors_type_0_item.additional_properties = d
        return kitchen_sink_company_response_200_output_data_item_full_funding_rounds_type_0_item_investors_type_0_item
