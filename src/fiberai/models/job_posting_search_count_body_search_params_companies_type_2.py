...
from ..models.job_posting_search_count_body_search_params_companies_type_2_identifier import (
    JobPostingSearchCountBodySearchParamsCompaniesType2Identifier,
)
