...
T = TypeVar("T", bound="TextToCombinedSearchResponse200OutputDataCompaniesItemLocationsStatsType0")


@_attrs_define
class TextToCombinedSearchResponse200OutputDataCompaniesItemLocationsStatsType0:
    """
    Attributes:
        usa (float | Unset):
        gbr (float | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        text_to_combined_search_response_200_output_data_companies_item_locations_stats_type_0 = cls(
            usa=usa,
            gbr=gbr,
            fra=fra,
            ind=ind,
        ...
        return text_to_combined_search_response_200_output_data_companies_item_locations_stats_type_0
