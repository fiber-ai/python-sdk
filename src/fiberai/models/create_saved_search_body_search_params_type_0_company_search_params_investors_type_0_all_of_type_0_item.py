...
T = TypeVar("T", bound="CreateSavedSearchBodySearchParamsType0CompanySearchParamsInvestorsType0AllOfType0Item")



@_attrs_define
class CreateSavedSearchBodySearchParamsType0CompanySearchParamsInvestorsType0AllOfType0Item:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_saved_search_body_search_params_type_0_company_search_params_investors_type_0_all_of_type_0_item = cls(
        ...
        create_saved_search_body_search_params_type_0_company_search_params_investors_type_0_all_of_type_0_item.additional_properties = d
        return create_saved_search_body_search_params_type_0_company_search_params_investors_type_0_all_of_type_0_item
