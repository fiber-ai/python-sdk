...
T = TypeVar("T", bound="YoutubeChannelResponse200")


@_attrs_define
class YoutubeChannelResponse200:
    """
    Attributes:
    ...
    output: YoutubeChannelResponse200Output
    charge_info: (
        YoutubeChannelResponse200ChargeInfoType0
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.youtube_channel_response_200_charge_info_type_0 import (
            YoutubeChannelResponse200ChargeInfoType0,  # noqa: PLC0415
        )
        from ..models.youtube_channel_response_200_charge_info_type_1 import (
            YoutubeChannelResponse200ChargeInfoType1,  # noqa: PLC0415
        )
        from ..models.youtube_channel_response_200_charge_info_type_2 import (
            YoutubeChannelResponse200ChargeInfoType2,  # noqa: PLC0415
        )
        from ..models.youtube_channel_response_200_charge_info_type_3 import (
            YoutubeChannelResponse200ChargeInfoType3,  # noqa: PLC0415
        )

        output = self.output.to_dict()

        charge_info: dict[str, Any]
        if isinstance(self.charge_info, YoutubeChannelResponse200ChargeInfoType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.youtube_channel_response_200_charge_info_type_4 import (
            YoutubeChannelResponse200ChargeInfoType4,  # noqa: PLC0415
        )
        from ..models.youtube_channel_response_200_output import YoutubeChannelResponse200Output  # noqa: PLC0415
        from ..models.youtube_channel_response_200_warnings_type_0_item import (
            YoutubeChannelResponse200WarningsType0Item,  # noqa: PLC0415
        )

        d = dict(src_dict)
        output = YoutubeChannelResponse200Output.from_dict(d.pop("output"))
        ...
        def _parse_charge_info(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_0 = YoutubeChannelResponse200ChargeInfoType0.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_1 = YoutubeChannelResponse200ChargeInfoType1.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_2 = YoutubeChannelResponse200ChargeInfoType2.from_dict(data)
        ...
        def _parse_warnings(data: object) -> list[YoutubeChannelResponse200WarningsType0Item] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for warnings_type_0_item_data in _warnings_type_0:
                    warnings_type_0_item = YoutubeChannelResponse200WarningsType0Item.from_dict(
                ...
                pass
            return cast(list[YoutubeChannelResponse200WarningsType0Item] | None | Unset, data)
        ...
        youtube_channel_response_200 = cls(
            output=output,
        ...
        return youtube_channel_response_200
