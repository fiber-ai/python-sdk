...
if TYPE_CHECKING:
    from ..models.poll_batch_live_enrich_response_200_output_results_item_profile_type_0_detailed_education_type_0_item_school_details_type_0 import (
        PollBatchLiveEnrichResponse200OutputResultsItemProfileType0DetailedEducationType0ItemSchoolDetailsType0,
    )


T = TypeVar("T", bound="PollBatchLiveEnrichResponse200OutputResultsItemProfileType0DetailedEducationType0Item")


@_attrs_define
class PollBatchLiveEnrichResponse200OutputResultsItemProfileType0DetailedEducationType0Item:
    """
    Attributes:
        school_details (None |
            PollBatchLiveEnrichResponse200OutputResultsItemProfileType0DetailedEducationType0ItemSchoolDetailsType0 |
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.poll_batch_live_enrich_response_200_output_results_item_profile_type_0_detailed_education_type_0_item_school_details_type_0 import (
            PollBatchLiveEnrichResponse200OutputResultsItemProfileType0DetailedEducationType0ItemSchoolDetailsType0,  # noqa: PLC0415
        )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_school_details(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                school_details_type_0 = PollBatchLiveEnrichResponse200OutputResultsItemProfileType0DetailedEducationType0ItemSchoolDetailsType0.from_dict(
                    data
                )
        ...
        poll_batch_live_enrich_response_200_output_results_item_profile_type_0_detailed_education_type_0_item = cls(
        ...
        poll_batch_live_enrich_response_200_output_results_item_profile_type_0_detailed_education_type_0_item.additional_properties = d
        return poll_batch_live_enrich_response_200_output_results_item_profile_type_0_detailed_education_type_0_item
