...
from ..models.profile_live_enrich_response_200_profile_found_and_enriched_profile_detailed_work_experiences_type_0_item_company_details_type_0_standard_industries_type_0_item import (
    ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileDetailedWorkExperiencesType0ItemCompanyDetailsType0StandardIndustriesType0Item,
)
from ..types import UNSET, Unset

T = TypeVar(
    "T",
    bound="ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileDetailedWorkExperiencesType0ItemCompanyDetailsType0",
)


@_attrs_define
class ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileDetailedWorkExperiencesType0ItemCompanyDetailsType0:
    """
    Attributes:
        ...
        standard_industries (list[ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileDetailedWorkExperiencesType0
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_standard_industries(
            ...
            try:
                ...
                for standard_industries_type_0_item_data in _standard_industries_type_0:
                    standard_industries_type_0_item = ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileDetailedWorkExperiencesType0ItemCompanyDetailsType0StandardIndustriesType0Item(
        ...
        profile_live_enrich_response_200_profile_found_and_enriched_profile_detailed_work_experiences_type_0_item_company_details_type_0 = cls(
        ...
        profile_live_enrich_response_200_profile_found_and_enriched_profile_detailed_work_experiences_type_0_item_company_details_type_0.additional_properties = d
        return profile_live_enrich_response_200_profile_found_and_enriched_profile_detailed_work_experiences_type_0_item_company_details_type_0
