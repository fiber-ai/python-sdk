...
T = TypeVar("T", bound="HotelPropertyResponse200OutputPropertyOffersItemRatePerNightType0")


@_attrs_define
class HotelPropertyResponse200OutputPropertyOffersItemRatePerNightType0:
    """Nightly rate from this source.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        hotel_property_response_200_output_property_offers_item_rate_per_night_type_0 = cls(
            currency_code=currency_code,
            all_in_cost=all_in_cost,
            base_cost=base_cost,
        )

        hotel_property_response_200_output_property_offers_item_rate_per_night_type_0.additional_properties = d
        return hotel_property_response_200_output_property_offers_item_rate_per_night_type_0
