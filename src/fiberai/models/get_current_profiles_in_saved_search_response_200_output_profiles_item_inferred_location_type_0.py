...
class GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemInferredLocationType0:
    ...
    Attributes:
        ...
        coordinates (GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemInferredLocationType0CoordinatesType0 |
            None | Unset):
    ...
    coordinates: (
        GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemInferredLocationType0CoordinatesType0 | None | Unset
    ) = UNSET
        ...
        def _parse_coordinates(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemInferredLocationType0CoordinatesType0.from_dict(
                    data
                )
