...
if TYPE_CHECKING:
  from ..models.get_current_profiles_in_saved_search_response_200_output_profiles_item_inferred_location_type_0_coordinates_type_0 import GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemInferredLocationType0CoordinatesType0





T = TypeVar("T", bound="GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemInferredLocationType0")



@_attrs_define
class GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemInferredLocationType0:
    """ 
        Attributes:
            ...
            coordinates
                (Union['GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemInferredLocationType0CoordinatesType0',
                None, Unset]):
    ...
    coordinates: Union['GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemInferredLocationType0CoordinatesType0', None, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.coordinates, Unset):
            coordinates = UNSET
        elif isinstance(self.coordinates, GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemInferredLocationType0CoordinatesType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_coordinates(data: object) -> Union['GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemInferredLocationType0CoordinatesType0', None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemInferredLocationType0CoordinatesType0.from_dict(data)
                ...
                pass
            return cast(Union['GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemInferredLocationType0CoordinatesType0', None, Unset], data)
        ...
        get_current_profiles_in_saved_search_response_200_output_profiles_item_inferred_location_type_0 = cls(
        ...
        get_current_profiles_in_saved_search_response_200_output_profiles_item_inferred_location_type_0.additional_properties = d
        return get_current_profiles_in_saved_search_response_200_output_profiles_item_inferred_location_type_0
