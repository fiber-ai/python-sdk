...
T = TypeVar("T", bound="CreateSavedSearchBodySearchParamsType2ProfileSearchParamsJoinedLinkedInAtType0RangeType0")


@_attrs_define
class CreateSavedSearchBodySearchParamsType2ProfileSearchParamsJoinedLinkedInAtType0RangeType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_saved_search_body_search_params_type_2_profile_search_params_joined_linked_in_at_type_0_range_type_0 = (
            cls(
        ...
        create_saved_search_body_search_params_type_2_profile_search_params_joined_linked_in_at_type_0_range_type_0.additional_properties = d
        return (
            create_saved_search_body_search_params_type_2_profile_search_params_joined_linked_in_at_type_0_range_type_0
        )
