...
T = TypeVar("T", bound="JdToProfileSearchResponse200OutputSearchParamsStartedAtCompanyType0RangeType0")


@_attrs_define
class JdToProfileSearchResponse200OutputSearchParamsStartedAtCompanyType0RangeType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        jd_to_profile_search_response_200_output_search_params_started_at_company_type_0_range_type_0 = cls(
            lower_bound=lower_bound,
            upper_bound=upper_bound,
        )

        jd_to_profile_search_response_200_output_search_params_started_at_company_type_0_range_type_0.additional_properties = d
        return jd_to_profile_search_response_200_output_search_params_started_at_company_type_0_range_type_0
