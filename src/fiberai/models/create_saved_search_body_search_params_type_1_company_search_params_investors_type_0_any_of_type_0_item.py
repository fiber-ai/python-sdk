...
T = TypeVar("T", bound="CreateSavedSearchBodySearchParamsType1CompanySearchParamsInvestorsType0AnyOfType0Item")



@_attrs_define
class CreateSavedSearchBodySearchParamsType1CompanySearchParamsInvestorsType0AnyOfType0Item:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_saved_search_body_search_params_type_1_company_search_params_investors_type_0_any_of_type_0_item = cls(
        ...
        create_saved_search_body_search_params_type_1_company_search_params_investors_type_0_any_of_type_0_item.additional_properties = d
        return create_saved_search_body_search_params_type_1_company_search_params_investors_type_0_any_of_type_0_item
