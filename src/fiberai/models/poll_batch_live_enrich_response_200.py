...
T = TypeVar("T", bound="PollBatchLiveEnrichResponse200")


@_attrs_define
class PollBatchLiveEnrichResponse200:
    """
    Attributes:
        output (PollBatchLiveEnrichResponse200Output):
        charge_info (PollBatchLiveEnrichResponse200ChargeInfoType0 | PollBatchLiveEnrichResponse200ChargeInfoType1 |
            PollBatchLiveEnrichResponse200ChargeInfoType2 | PollBatchLiveEnrichResponse200ChargeInfoType3 |
            PollBatchLiveEnrichResponse200ChargeInfoType4):
        warnings (list[PollBatchLiveEnrichResponse200WarningsType0Item] | None | Unset): Warnings about extraneous
            fields in request
    ...
    warnings: list[PollBatchLiveEnrichResponse200WarningsType0Item] | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.charge_info, PollBatchLiveEnrichResponse200ChargeInfoType0):
            charge_info = self.charge_info.to_dict()
        elif isinstance(self.charge_info, PollBatchLiveEnrichResponse200ChargeInfoType1):
            charge_info = self.charge_info.to_dict()
        elif isinstance(self.charge_info, PollBatchLiveEnrichResponse200ChargeInfoType2):
            charge_info = self.charge_info.to_dict()
        elif isinstance(self.charge_info, PollBatchLiveEnrichResponse200ChargeInfoType3):
            charge_info = self.charge_info.to_dict()
        else:
            charge_info = self.charge_info.to_dict()
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        output = PollBatchLiveEnrichResponse200Output.from_dict(d.pop("output"))
        ...
        def _parse_charge_info(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_0 = PollBatchLiveEnrichResponse200ChargeInfoType0.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_1 = PollBatchLiveEnrichResponse200ChargeInfoType1.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_2 = PollBatchLiveEnrichResponse200ChargeInfoType2.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_3 = PollBatchLiveEnrichResponse200ChargeInfoType3.from_dict(data)
            ...
            if not isinstance(data, dict):
                raise TypeError()
            charge_info_type_4 = PollBatchLiveEnrichResponse200ChargeInfoType4.from_dict(data)

            return charge_info_type_4

        charge_info = _parse_charge_info(d.pop("chargeInfo"))

        def _parse_warnings(data: object) -> list[PollBatchLiveEnrichResponse200WarningsType0Item] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for warnings_type_0_item_data in _warnings_type_0:
                    warnings_type_0_item = PollBatchLiveEnrichResponse200WarningsType0Item.from_dict(
                ...
                pass
            return cast(list[PollBatchLiveEnrichResponse200WarningsType0Item] | None | Unset, data)
        ...
        poll_batch_live_enrich_response_200 = cls(
            output=output,
        ...
        return poll_batch_live_enrich_response_200
