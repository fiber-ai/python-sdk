...
T = TypeVar("T", bound="GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemLanguagesType0Item")


@_attrs_define
class GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemLanguagesType0Item:
    """
    Attributes:
        name (None | str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_current_profiles_in_saved_search_response_200_output_profiles_item_languages_type_0_item = cls(
            name=name,
            proficiency_id=proficiency_id,
            proficiency_name=proficiency_name,
        )

        get_current_profiles_in_saved_search_response_200_output_profiles_item_languages_type_0_item.additional_properties = d
        return get_current_profiles_in_saved_search_response_200_output_profiles_item_languages_type_0_item
