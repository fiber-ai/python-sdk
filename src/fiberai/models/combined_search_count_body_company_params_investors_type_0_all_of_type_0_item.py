...
T = TypeVar("T", bound="CombinedSearchCountBodyCompanyParamsInvestorsType0AllOfType0Item")


@_attrs_define
class CombinedSearchCountBodyCompanyParamsInvestorsType0AllOfType0Item:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        combined_search_count_body_company_params_investors_type_0_all_of_type_0_item = cls(
            linkedin_company_id=linkedin_company_id,
            linkedin_url=linkedin_url,
            company_domain=company_domain,
        )

        combined_search_count_body_company_params_investors_type_0_all_of_type_0_item.additional_properties = d
        return combined_search_count_body_company_params_investors_type_0_all_of_type_0_item
