...
class CompanyCountBodySearchParamsTechnologiesType0:
    """
    Attributes:
        any_of (list[CompanyCountBodySearchParamsTechnologiesType0AnyOfType0ItemType0 |
            CompanyCountBodySearchParamsTechnologiesType0AnyOfType0ItemType1] | None | Unset):
        all_of (list[CompanyCountBodySearchParamsTechnologiesType0AllOfType0ItemType0 |
            CompanyCountBodySearchParamsTechnologiesType0AllOfType0ItemType1] | None | Unset):
        none_of (list[CompanyCountBodySearchParamsTechnologiesType0NoneOfType0ItemType0 |
            CompanyCountBodySearchParamsTechnologiesType0NoneOfType0ItemType1] | None | Unset):
    """
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.any_of, Unset):
            ...
            for any_of_type_0_item_data in self.any_of:
                ...
                if isinstance(
                    any_of_type_0_item_data, CompanyCountBodySearchParamsTechnologiesType0AnyOfType0ItemType0
                ):
        ...
        if isinstance(self.all_of, Unset):
            ...
            for all_of_type_0_item_data in self.all_of:
                ...
                if isinstance(
                    all_of_type_0_item_data, CompanyCountBodySearchParamsTechnologiesType0AllOfType0ItemType0
                ):
        ...
        if isinstance(self.none_of, Unset):
            ...
            for none_of_type_0_item_data in self.none_of:
                ...
                if isinstance(
                    none_of_type_0_item_data, CompanyCountBodySearchParamsTechnologiesType0NoneOfType0ItemType0
                ):
                    ...
                    def _parse_any_of_type_0_item(
                        ...
                        try:
                            ...
                            any_of_type_0_item_type_0 = (
                                CompanyCountBodySearchParamsTechnologiesType0AnyOfType0ItemType0.from_dict(data)
                            )
                        ...
                        any_of_type_0_item_type_1 = (
                            CompanyCountBodySearchParamsTechnologiesType0AnyOfType0ItemType1.from_dict(data)
                        )
                    ...
                    def _parse_all_of_type_0_item(
                        ...
                        try:
                            ...
                            all_of_type_0_item_type_0 = (
                                CompanyCountBodySearchParamsTechnologiesType0AllOfType0ItemType0.from_dict(data)
                            )
                        ...
                        all_of_type_0_item_type_1 = (
                            CompanyCountBodySearchParamsTechnologiesType0AllOfType0ItemType1.from_dict(data)
                        )
                    ...
                    def _parse_none_of_type_0_item(
                        ...
                        try:
                            ...
                            none_of_type_0_item_type_0 = (
                                CompanyCountBodySearchParamsTechnologiesType0NoneOfType0ItemType0.from_dict(data)
                            )
                        ...
                        none_of_type_0_item_type_1 = (
                            CompanyCountBodySearchParamsTechnologiesType0NoneOfType0ItemType1.from_dict(data)
                        )
