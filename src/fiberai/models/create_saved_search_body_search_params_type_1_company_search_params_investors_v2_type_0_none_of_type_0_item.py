...
T = TypeVar("T", bound="CreateSavedSearchBodySearchParamsType1CompanySearchParamsInvestorsV2Type0NoneOfType0Item")


@_attrs_define
class CreateSavedSearchBodySearchParamsType1CompanySearchParamsInvestorsV2Type0NoneOfType0Item:
    """
    Attributes:
        investor_identifier
            (CreateSavedSearchBodySearchParamsType1CompanySearchParamsInvestorsV2Type0NoneOfType0ItemInvestorIdentifierType0
            ...
            |
            CreateSavedSearchBodySearchParamsType1CompanySearchParamsInvestorsV2Type0NoneOfType0ItemInvestorIdentifierType2
            | CreateSavedSearchBodySearchParamsType1CompanySearchParamsInvestorsV2Type0NoneOfType0ItemInvestorIdentifierType
            3):
        invested_at
            (CreateSavedSearchBodySearchParamsType1CompanySearchParamsInvestorsV2Type0NoneOfType0ItemInvestedAtType0 |
            CreateSavedSearchBodySearchParamsType1CompanySearchParamsInvestorsV2Type0NoneOfType0ItemInvestedAtType1 | None |
            Unset):
        investment_rounds
            (CreateSavedSearchBodySearchParamsType1CompanySearchParamsInvestorsV2Type0NoneOfType0ItemInvestmentRoundsType0 |
            None | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_investor_identifier(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                investor_identifier_type_0 = CreateSavedSearchBodySearchParamsType1CompanySearchParamsInvestorsV2Type0NoneOfType0ItemInvestorIdentifierType0.from_dict(
                    data
                )
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                investor_identifier_type_1 = CreateSavedSearchBodySearchParamsType1CompanySearchParamsInvestorsV2Type0NoneOfType0ItemInvestorIdentifierType1.from_dict(
                    data
                )
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                investor_identifier_type_2 = CreateSavedSearchBodySearchParamsType1CompanySearchParamsInvestorsV2Type0NoneOfType0ItemInvestorIdentifierType2.from_dict(
                    data
                )
            ...
            if not isinstance(data, dict):
                raise TypeError()
            investor_identifier_type_3 = CreateSavedSearchBodySearchParamsType1CompanySearchParamsInvestorsV2Type0NoneOfType0ItemInvestorIdentifierType3.from_dict(
                data
            )
        ...
        def _parse_invested_at(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                invested_at_type_0 = CreateSavedSearchBodySearchParamsType1CompanySearchParamsInvestorsV2Type0NoneOfType0ItemInvestedAtType0.from_dict(
                    data
                )
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                invested_at_type_1 = CreateSavedSearchBodySearchParamsType1CompanySearchParamsInvestorsV2Type0NoneOfType0ItemInvestedAtType1.from_dict(
                    data
                )
        ...
        def _parse_investment_rounds(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                investment_rounds_type_0 = CreateSavedSearchBodySearchParamsType1CompanySearchParamsInvestorsV2Type0NoneOfType0ItemInvestmentRoundsType0.from_dict(
                    data
                )
        ...
        create_saved_search_body_search_params_type_1_company_search_params_investors_v2_type_0_none_of_type_0_item = (
            cls(
        ...
        create_saved_search_body_search_params_type_1_company_search_params_investors_v2_type_0_none_of_type_0_item.additional_properties = d
        return (
            create_saved_search_body_search_params_type_1_company_search_params_investors_v2_type_0_none_of_type_0_item
        )
