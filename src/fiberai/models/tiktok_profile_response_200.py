...
T = TypeVar("T", bound="TiktokProfileResponse200")


@_attrs_define
class TiktokProfileResponse200:
    """
    Attributes:
        output (TiktokProfileResponse200Output):
    ...
    output: TiktokProfileResponse200Output
    charge_info: (
        TiktokProfileResponse200ChargeInfoType0
        | TiktokProfileResponse200ChargeInfoType1
        | TiktokProfileResponse200ChargeInfoType2
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.charge_info, TiktokProfileResponse200ChargeInfoType0):
            charge_info = self.charge_info.to_dict()
        elif isinstance(self.charge_info, TiktokProfileResponse200ChargeInfoType1):
            charge_info = self.charge_info.to_dict()
        elif isinstance(self.charge_info, TiktokProfileResponse200ChargeInfoType2):
            charge_info = self.charge_info.to_dict()
        elif isinstance(self.charge_info, TiktokProfileResponse200ChargeInfoType3):
            charge_info = self.charge_info.to_dict()
        else:
            charge_info = self.charge_info.to_dict()
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_charge_info(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_0 = TiktokProfileResponse200ChargeInfoType0.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_1 = TiktokProfileResponse200ChargeInfoType1.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_2 = TiktokProfileResponse200ChargeInfoType2.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_3 = TiktokProfileResponse200ChargeInfoType3.from_dict(data)
            ...
            if not isinstance(data, dict):
                raise TypeError()
            charge_info_type_4 = TiktokProfileResponse200ChargeInfoType4.from_dict(data)
        ...
        def _parse_warnings(data: object) -> list[TiktokProfileResponse200WarningsType0Item] | None | Unset:
            ...
            try:
                ...
                for warnings_type_0_item_data in _warnings_type_0:
                    warnings_type_0_item = TiktokProfileResponse200WarningsType0Item.from_dict(
                ...
                pass
            return cast(list[TiktokProfileResponse200WarningsType0Item] | None | Unset, data)
        ...
        return tiktok_profile_response_200
