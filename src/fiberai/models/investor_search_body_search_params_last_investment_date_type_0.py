...
T = TypeVar("T", bound="InvestorSearchBodySearchParamsLastInvestmentDateType0")



@_attrs_define
class InvestorSearchBodySearchParamsLastInvestmentDateType0:
    """ Filter by last investment date (date range)
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        investor_search_body_search_params_last_investment_date_type_0 = cls(
            lower_bound=lower_bound,
            upper_bound=upper_bound,
        )


        investor_search_body_search_params_last_investment_date_type_0.additional_properties = d
        return investor_search_body_search_params_last_investment_date_type_0
