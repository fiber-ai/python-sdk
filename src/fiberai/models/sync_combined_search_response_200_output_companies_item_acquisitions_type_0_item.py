...
T = TypeVar("T", bound="SyncCombinedSearchResponse200OutputCompaniesItemAcquisitionsType0Item")


@_attrs_define
class SyncCombinedSearchResponse200OutputCompaniesItemAcquisitionsType0Item:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sync_combined_search_response_200_output_companies_item_acquisitions_type_0_item = cls(
            price_usd=price_usd,
            acquiree_name=acquiree_name,
            acquisition_date=acquisition_date,
        )

        sync_combined_search_response_200_output_companies_item_acquisitions_type_0_item.additional_properties = d
        return sync_combined_search_response_200_output_companies_item_acquisitions_type_0_item
