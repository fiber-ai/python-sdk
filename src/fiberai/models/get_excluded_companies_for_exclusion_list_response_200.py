...
if TYPE_CHECKING:
    from ..models.get_excluded_companies_for_exclusion_list_response_200_charge_info_type_0 import (
        GetExcludedCompaniesForExclusionListResponse200ChargeInfoType0,
    )
    from ..models.get_excluded_companies_for_exclusion_list_response_200_charge_info_type_1 import (
    ...
    from ..models.get_excluded_companies_for_exclusion_list_response_200_warnings_type_0_item import (
        GetExcludedCompaniesForExclusionListResponse200WarningsType0Item,
    )
...
class GetExcludedCompaniesForExclusionListResponse200:
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.get_excluded_companies_for_exclusion_list_response_200_charge_info_type_0 import (
            GetExcludedCompaniesForExclusionListResponse200ChargeInfoType0,  # noqa: PLC0415
        )
        from ..models.get_excluded_companies_for_exclusion_list_response_200_charge_info_type_1 import (
            GetExcludedCompaniesForExclusionListResponse200ChargeInfoType1,  # noqa: PLC0415
        )
        from ..models.get_excluded_companies_for_exclusion_list_response_200_charge_info_type_2 import (
            GetExcludedCompaniesForExclusionListResponse200ChargeInfoType2,  # noqa: PLC0415
        )
        from ..models.get_excluded_companies_for_exclusion_list_response_200_charge_info_type_3 import (
            GetExcludedCompaniesForExclusionListResponse200ChargeInfoType3,  # noqa: PLC0415
        )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.get_excluded_companies_for_exclusion_list_response_200_charge_info_type_4 import (
            GetExcludedCompaniesForExclusionListResponse200ChargeInfoType4,  # noqa: PLC0415
        )
        from ..models.get_excluded_companies_for_exclusion_list_response_200_output import (
            GetExcludedCompaniesForExclusionListResponse200Output,  # noqa: PLC0415
        )
        from ..models.get_excluded_companies_for_exclusion_list_response_200_warnings_type_0_item import (
            GetExcludedCompaniesForExclusionListResponse200WarningsType0Item,  # noqa: PLC0415
        )
        ...
        def _parse_warnings(
            data: object,
        ) -> list[GetExcludedCompaniesForExclusionListResponse200WarningsType0Item] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for warnings_type_0_item_data in _warnings_type_0:
                    warnings_type_0_item = GetExcludedCompaniesForExclusionListResponse200WarningsType0Item.from_dict(
                ...
                pass
            return cast(list[GetExcludedCompaniesForExclusionListResponse200WarningsType0Item] | None | Unset, data)
