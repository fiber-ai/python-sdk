...
T = TypeVar("T", bound="PeopleSearchBodySearchParamsEducationV2Type0AnyOfType0ItemSchoolType0ExactType0")


@_attrs_define
class PeopleSearchBodySearchParamsEducationV2Type0AnyOfType0ItemSchoolType0ExactType0:
    """
    Attributes:
        any_of (list[PeopleSearchBodySearchParamsEducationV2Type0AnyOfType0ItemSchoolType0ExactType0AnyOfType0ItemType0
            | PeopleSearchBodySearchParamsEducationV2Type0AnyOfType0ItemSchoolType0ExactType0AnyOfType0ItemType1 |
            PeopleSearchBodySearchParamsEducationV2Type0AnyOfType0ItemSchoolType0ExactType0AnyOfType0ItemType2 |
            PeopleSearchBodySearchParamsEducationV2Type0AnyOfType0ItemSchoolType0ExactType0AnyOfType0ItemType3] | None |
            Unset):
        none_of
            (list[PeopleSearchBodySearchParamsEducationV2Type0AnyOfType0ItemSchoolType0ExactType0NoneOfType0ItemType0 |
            PeopleSearchBodySearchParamsEducationV2Type0AnyOfType0ItemSchoolType0ExactType0NoneOfType0ItemType1 |
            PeopleSearchBodySearchParamsEducationV2Type0AnyOfType0ItemSchoolType0ExactType0NoneOfType0ItemType2 |
            PeopleSearchBodySearchParamsEducationV2Type0AnyOfType0ItemSchoolType0ExactType0NoneOfType0ItemType3] | None |
            Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
                    ...
                    def _parse_any_of_type_0_item(
                        ...
                        try:
                            if not isinstance(data, dict):
                                raise TypeError()
                            any_of_type_0_item_type_0 = PeopleSearchBodySearchParamsEducationV2Type0AnyOfType0ItemSchoolType0ExactType0AnyOfType0ItemType0.from_dict(
                                data
                            )
                        ...
                        try:
                            if not isinstance(data, dict):
                                raise TypeError()
                            any_of_type_0_item_type_1 = PeopleSearchBodySearchParamsEducationV2Type0AnyOfType0ItemSchoolType0ExactType0AnyOfType0ItemType1.from_dict(
                                data
                            )
                        ...
                        try:
                            if not isinstance(data, dict):
                                raise TypeError()
                            any_of_type_0_item_type_2 = PeopleSearchBodySearchParamsEducationV2Type0AnyOfType0ItemSchoolType0ExactType0AnyOfType0ItemType2.from_dict(
                                data
                            )
                        ...
                        if not isinstance(data, dict):
                            raise TypeError()
                        any_of_type_0_item_type_3 = PeopleSearchBodySearchParamsEducationV2Type0AnyOfType0ItemSchoolType0ExactType0AnyOfType0ItemType3.from_dict(
                            data
                        )
                ...
                for none_of_type_0_item_data in _none_of_type_0:
                    ...
                    def _parse_none_of_type_0_item(
                        ...
                        try:
                            if not isinstance(data, dict):
                                raise TypeError()
                            none_of_type_0_item_type_0 = PeopleSearchBodySearchParamsEducationV2Type0AnyOfType0ItemSchoolType0ExactType0NoneOfType0ItemType0.from_dict(
                                data
                            )
                        ...
                        try:
                            if not isinstance(data, dict):
                                raise TypeError()
                            none_of_type_0_item_type_1 = PeopleSearchBodySearchParamsEducationV2Type0AnyOfType0ItemSchoolType0ExactType0NoneOfType0ItemType1.from_dict(
                                data
                            )
                        ...
                        try:
                            if not isinstance(data, dict):
                                raise TypeError()
                            none_of_type_0_item_type_2 = PeopleSearchBodySearchParamsEducationV2Type0AnyOfType0ItemSchoolType0ExactType0NoneOfType0ItemType2.from_dict(
                                data
                            )
                        ...
                        if not isinstance(data, dict):
                            raise TypeError()
                        none_of_type_0_item_type_3 = PeopleSearchBodySearchParamsEducationV2Type0AnyOfType0ItemSchoolType0ExactType0NoneOfType0ItemType3.from_dict(
                            data
                        )
        ...
        people_search_body_search_params_education_v2_type_0_any_of_type_0_item_school_type_0_exact_type_0 = cls(
            any_of=any_of,
            none_of=none_of,
        )

        people_search_body_search_params_education_v2_type_0_any_of_type_0_item_school_type_0_exact_type_0.additional_properties = d
        return people_search_body_search_params_education_v2_type_0_any_of_type_0_item_school_type_0_exact_type_0
