...
T = TypeVar("T", bound="QuickPersonResolveResponse200OutputDataItemPersonType0VolunteeringType0Item")


@_attrs_define
class QuickPersonResolveResponse200OutputDataItemPersonType0VolunteeringType0Item:
    """
    Attributes:
        role (None | str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        quick_person_resolve_response_200_output_data_item_person_type_0_volunteering_type_0_item = cls(
            role=role,
        ...
        quick_person_resolve_response_200_output_data_item_person_type_0_volunteering_type_0_item.additional_properties = d
        return quick_person_resolve_response_200_output_data_item_person_type_0_volunteering_type_0_item
