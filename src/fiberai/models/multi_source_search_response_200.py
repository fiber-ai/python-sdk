...
if TYPE_CHECKING:
    from ..models.multi_source_search_response_200_charge_info_type_0 import MultiSourceSearchResponse200ChargeInfoType0
...
T = TypeVar("T", bound="MultiSourceSearchResponse200")


@_attrs_define
class MultiSourceSearchResponse200:
    """
    Attributes:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.charge_info, MultiSourceSearchResponse200ChargeInfoType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        output = MultiSourceSearchResponse200Output.from_dict(d.pop("output"))
        ...
        def _parse_charge_info(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_0 = MultiSourceSearchResponse200ChargeInfoType0.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_1 = MultiSourceSearchResponse200ChargeInfoType1.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_2 = MultiSourceSearchResponse200ChargeInfoType2.from_dict(data)
        ...
        def _parse_warnings(data: object) -> list[MultiSourceSearchResponse200WarningsType0Item] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for warnings_type_0_item_data in _warnings_type_0:
                    warnings_type_0_item = MultiSourceSearchResponse200WarningsType0Item.from_dict(
                ...
                pass
            return cast(list[MultiSourceSearchResponse200WarningsType0Item] | None | Unset, data)
        ...
        multi_source_search_response_200 = cls(
            output=output,
        ...
        return multi_source_search_response_200
