...
T = TypeVar(
    "T",
    bound="PaginatedCombinedSearchResponse200OutputCompaniesItemNumMatchingLocationsType0MatchedOfficesItemLocationType0",
)


@_attrs_define
class PaginatedCombinedSearchResponse200OutputCompaniesItemNumMatchingLocationsType0MatchedOfficesItemLocationType0:
    """
    Attributes:
        ...
        coordinates (None | PaginatedCombinedSearchResponse200OutputCompaniesItemNumMatchingLocationsType0MatchedOffices
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_coordinates(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = PaginatedCombinedSearchResponse200OutputCompaniesItemNumMatchingLocationsType0MatchedOfficesItemLocationType0CoordinatesType0.from_dict(
                    data
                )
        ...
        paginated_combined_search_response_200_output_companies_item_num_matching_locations_type_0_matched_offices_item_location_type_0 = cls(
        ...
        paginated_combined_search_response_200_output_companies_item_num_matching_locations_type_0_matched_offices_item_location_type_0.additional_properties = d
        return paginated_combined_search_response_200_output_companies_item_num_matching_locations_type_0_matched_offices_item_location_type_0
