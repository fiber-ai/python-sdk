...
T = TypeVar("T", bound="InvestorSearchBodySearchParamsNumLeadInvestmentsType0")


@_attrs_define
class InvestorSearchBodySearchParamsNumLeadInvestmentsType0:
    """Filter by number of lead investments (range)
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        investor_search_body_search_params_num_lead_investments_type_0 = cls(
            lower_bound=lower_bound,
            upper_bound=upper_bound,
        )

        investor_search_body_search_params_num_lead_investments_type_0.additional_properties = d
        return investor_search_body_search_params_num_lead_investments_type_0
