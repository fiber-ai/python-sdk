...
if TYPE_CHECKING:
  from ..models.text_to_combined_search_response_200_output_profile_search_params_type_0_time_zone_type_0_any_of_item_strategy_type_0 import TextToCombinedSearchResponse200OutputProfileSearchParamsType0TimeZoneType0AnyOfItemStrategyType0
...
class TextToCombinedSearchResponse200OutputProfileSearchParamsType0TimeZoneType0AnyOfItem:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.strategy, TextToCombinedSearchResponse200OutputProfileSearchParamsType0TimeZoneType0AnyOfItemStrategyType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.text_to_combined_search_response_200_output_profile_search_params_type_0_time_zone_type_0_any_of_item_strategy_type_0 import TextToCombinedSearchResponse200OutputProfileSearchParamsType0TimeZoneType0AnyOfItemStrategyType0
        d = dict(src_dict)
        def _parse_strategy(data: object) -> 'TextToCombinedSearchResponse200OutputProfileSearchParamsType0TimeZoneType0AnyOfItemStrategyType0':
            if not isinstance(data, dict):
                raise TypeError()
            strategy_type_0 = TextToCombinedSearchResponse200OutputProfileSearchParamsType0TimeZoneType0AnyOfItemStrategyType0.from_dict(data)
