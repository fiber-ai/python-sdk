...
if TYPE_CHECKING:
  from ..models.get_current_companies_in_saved_search_response_200_output_companies_item_funding_round_stats_type_0_individual_investor_stats_type_0_item import GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemFundingRoundStatsType0IndividualInvestorStatsType0Item





T = TypeVar("T", bound="GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemFundingRoundStatsType0")



@_attrs_define
class GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemFundingRoundStatsType0:
    """ 
        Attributes:
            ...
            individual_investor_stats (Union[None, Unset, list['GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesIt
                emFundingRoundStatsType0IndividualInvestorStatsType0Item']]):
    ...
    individual_investor_stats: Union[None, Unset, list['GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemFundingRoundStatsType0IndividualInvestorStatsType0Item']] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_individual_investor_stats(data: object) -> Union[None, Unset, list['GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemFundingRoundStatsType0IndividualInvestorStatsType0Item']]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for individual_investor_stats_type_0_item_data in (_individual_investor_stats_type_0):
                    individual_investor_stats_type_0_item = GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemFundingRoundStatsType0IndividualInvestorStatsType0Item.from_dict(individual_investor_stats_type_0_item_data)
                ...
                pass
            return cast(Union[None, Unset, list['GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemFundingRoundStatsType0IndividualInvestorStatsType0Item']], data)
        ...
        get_current_companies_in_saved_search_response_200_output_companies_item_funding_round_stats_type_0 = cls(
        ...
        get_current_companies_in_saved_search_response_200_output_companies_item_funding_round_stats_type_0.additional_properties = d
        return get_current_companies_in_saved_search_response_200_output_companies_item_funding_round_stats_type_0
