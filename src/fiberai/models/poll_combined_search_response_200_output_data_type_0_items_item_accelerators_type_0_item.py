...
if TYPE_CHECKING:
  from ..models.poll_combined_search_response_200_output_data_type_0_items_item_accelerators_type_0_item_founders_type_0_item import PollCombinedSearchResponse200OutputDataType0ItemsItemAcceleratorsType0ItemFoundersType0Item





T = TypeVar("T", bound="PollCombinedSearchResponse200OutputDataType0ItemsItemAcceleratorsType0Item")



@_attrs_define
class PollCombinedSearchResponse200OutputDataType0ItemsItemAcceleratorsType0Item:
    """ 
        Attributes:
            ...
            founders (Union[None, Unset,
                list['PollCombinedSearchResponse200OutputDataType0ItemsItemAcceleratorsType0ItemFoundersType0Item']]):
    ...
    founders: Union[None, Unset, list['PollCombinedSearchResponse200OutputDataType0ItemsItemAcceleratorsType0ItemFoundersType0Item']] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_founders(data: object) -> Union[None, Unset, list['PollCombinedSearchResponse200OutputDataType0ItemsItemAcceleratorsType0ItemFoundersType0Item']]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for founders_type_0_item_data in (_founders_type_0):
                    founders_type_0_item = PollCombinedSearchResponse200OutputDataType0ItemsItemAcceleratorsType0ItemFoundersType0Item.from_dict(founders_type_0_item_data)
                ...
                pass
            return cast(Union[None, Unset, list['PollCombinedSearchResponse200OutputDataType0ItemsItemAcceleratorsType0ItemFoundersType0Item']], data)
        ...
        poll_combined_search_response_200_output_data_type_0_items_item_accelerators_type_0_item = cls(
            id=id,
            slug=slug,
            tags=tags,
            year=year,
        ...
        poll_combined_search_response_200_output_data_type_0_items_item_accelerators_type_0_item.additional_properties = d
        return poll_combined_search_response_200_output_data_type_0_items_item_accelerators_type_0_item
