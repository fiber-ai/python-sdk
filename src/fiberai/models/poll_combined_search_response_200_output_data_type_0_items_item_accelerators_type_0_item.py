...
if TYPE_CHECKING:
    from ..models.poll_combined_search_response_200_output_data_type_0_items_item_accelerators_type_0_item_founders_type_0_item import (
        PollCombinedSearchResponse200OutputDataType0ItemsItemAcceleratorsType0ItemFoundersType0Item,
    )
...
class PollCombinedSearchResponse200OutputDataType0ItemsItemAcceleratorsType0Item:
    ...
    Attributes:
        ...
        founders (list[PollCombinedSearchResponse200OutputDataType0ItemsItemAcceleratorsType0ItemFoundersType0Item] |
            None | Unset):
    ...
    founders: (
        list[PollCombinedSearchResponse200OutputDataType0ItemsItemAcceleratorsType0ItemFoundersType0Item] | None | Unset
    ) = UNSET
        ...
        def _parse_founders(
            ...
            try:
                ...
                for founders_type_0_item_data in _founders_type_0:
                    founders_type_0_item = PollCombinedSearchResponse200OutputDataType0ItemsItemAcceleratorsType0ItemFoundersType0Item.from_dict(
