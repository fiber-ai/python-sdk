...
T = TypeVar("T", bound="InstagramPostDetailsResponse200Output")


@_attrs_define
class InstagramPostDetailsResponse200Output:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        instagram_post_details_response_200_output = cls(
            id=id,
            is_video=is_video,
            shortcode=shortcode,
            caption=caption,
        ...
        instagram_post_details_response_200_output.additional_properties = d
        return instagram_post_details_response_200_output
