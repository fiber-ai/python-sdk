...
T = TypeVar("T", bound="PollContactEnrichmentResultResponse200ChargeInfoType3LowCreditAlertType0")


@_attrs_define
class PollContactEnrichmentResultResponse200ChargeInfoType3LowCreditAlertType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        poll_contact_enrichment_result_response_200_charge_info_type_3_low_credit_alert_type_0 = cls(
            get_more_credits_url=get_more_credits_url,
            message=message,
            available_credits=available_credits,
        )

        poll_contact_enrichment_result_response_200_charge_info_type_3_low_credit_alert_type_0.additional_properties = d
        return poll_contact_enrichment_result_response_200_charge_info_type_3_low_credit_alert_type_0
