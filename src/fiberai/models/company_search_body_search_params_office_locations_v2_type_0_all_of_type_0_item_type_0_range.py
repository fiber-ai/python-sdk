...
T = TypeVar("T", bound="CompanySearchBodySearchParamsOfficeLocationsV2Type0AllOfType0ItemType0Range")



@_attrs_define
class CompanySearchBodySearchParamsOfficeLocationsV2Type0AllOfType0ItemType0Range:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        company_search_body_search_params_office_locations_v2_type_0_all_of_type_0_item_type_0_range = cls(
            lower_bound=lower_bound,
            upper_bound=upper_bound,
        )


        company_search_body_search_params_office_locations_v2_type_0_all_of_type_0_item_type_0_range.additional_properties = d
        return company_search_body_search_params_office_locations_v2_type_0_all_of_type_0_item_type_0_range
