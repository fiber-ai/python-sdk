...
class PeopleSearchCountBodySearchParamsEducationType0AllOfType0ItemSchoolType0:
    """
    Attributes:
        any_of (list[PeopleSearchCountBodySearchParamsEducationType0AllOfType0ItemSchoolType0AnyOfType0Item] | None |
            Unset):
        none_of (list[PeopleSearchCountBodySearchParamsEducationType0AllOfType0ItemSchoolType0NoneOfType0Item] | None |
            Unset):
    """

    any_of: (
        list[PeopleSearchCountBodySearchParamsEducationType0AllOfType0ItemSchoolType0AnyOfType0Item] | None | Unset
    ) = UNSET
    none_of: (
        list[PeopleSearchCountBodySearchParamsEducationType0AllOfType0ItemSchoolType0NoneOfType0Item] | None | Unset
    ) = UNSET
        ...
        def _parse_any_of(
            ...
            try:
                ...
                for any_of_type_0_item_data in _any_of_type_0:
                    any_of_type_0_item = PeopleSearchCountBodySearchParamsEducationType0AllOfType0ItemSchoolType0AnyOfType0Item.from_dict(
        ...
        def _parse_none_of(
            ...
            try:
                ...
                for none_of_type_0_item_data in _none_of_type_0:
                    none_of_type_0_item = PeopleSearchCountBodySearchParamsEducationType0AllOfType0ItemSchoolType0NoneOfType0Item.from_dict(
