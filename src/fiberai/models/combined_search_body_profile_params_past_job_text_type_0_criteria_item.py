...
from ..models.combined_search_body_profile_params_past_job_text_type_0_criteria_item_field import (
    CombinedSearchBodyProfileParamsPastJobTextType0CriteriaItemField,
)
from ..models.combined_search_body_profile_params_past_job_text_type_0_criteria_item_rule import (
    CombinedSearchBodyProfileParamsPastJobTextType0CriteriaItemRule,
)
