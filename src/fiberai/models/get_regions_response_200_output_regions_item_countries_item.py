...
T = TypeVar("T", bound="GetRegionsResponse200OutputRegionsItemCountriesItem")
...
class GetRegionsResponse200OutputRegionsItemCountriesItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_regions_response_200_output_regions_item_countries_item = cls(
            name=name,
            api_code=api_code,
        ...
        get_regions_response_200_output_regions_item_countries_item.additional_properties = d
        return get_regions_response_200_output_regions_item_countries_item
