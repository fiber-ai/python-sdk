...
from ..models.get_current_profiles_in_saved_search_response_200_output_profiles_item_tags_type_0_item import (
    GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemTagsType0Item,
)
...
class GetCurrentProfilesInSavedSearchResponse200OutputProfilesItem:
    ...
    Attributes:
        primary_slug (str):
        articles (list[GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemArticlesType0Item] | None | Unset):
        certifications (list[GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemCertificationsType0Item] | None
            | Unset):
        connection_count (float | None | Unset):
        courses (list[GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemCoursesType0Item] | None | Unset):
        dob (None | str | Unset):
        education (list[GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemEducationType0Item] | None | Unset):
        experiences (list[GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemExperiencesType0Item] | None |
            Unset):
        first_name (None | str | Unset):
        follower_count (float | None | Unset):
        headline (None | str | Unset):
        industry_name (None | str | Unset):
        inferred_location (GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemInferredLocationType0 | None |
            Unset):
        interests (list[str] | None | Unset):
        last_name (None | str | Unset):
        locality (None | str | Unset):
        name (None | str | Unset):
        patents (list[GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemPatentsType0Item] | None | Unset):
        profile_pic (None | str | Unset):
        projects (list[GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemProjectsType0Item] | None | Unset):
        publications (list[GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemPublicationsType0Item] | None |
            Unset):
        ...
        volunteering (list[GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemVolunteeringType0Item] | None |
            Unset):
        tenures (list[GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemTenuresType0Item] | None | Unset):
        career_began_at (None | str | Unset):
        tags (list[GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemTagsType0Item] | None | Unset):
        entity_urn (None | str | Unset):
        open_to_work (bool | None | Unset):
        premium (bool | None | Unset):
        influencer (bool | None | Unset):
        organizations (list[GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemOrganizationsType0Item] | None |
            Unset):
        entity_urns (list[str] | None | Unset):
        is_hiring (bool | None | Unset):
        websites (list[str] | None | Unset):
        is_verified (bool | None | Unset):
        verifications (GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemVerificationsType0 | None | Unset):
        is_top_voice (bool | None | Unset):
        current_job (GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemCurrentJobType0 | None | Unset):
        custom_data (GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemCustomDataType0 | None | Unset):
        relevance_score (float | None | Unset):
        last_sort_key (None | str | Unset):
        languages (list[GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemLanguagesType0Item] | None | Unset):
        detailed_education (list[GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemDetailedEducationType0Item]
            | None | Unset):
        detailed_work_experiences
            (list[GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemDetailedWorkExperiencesType0Item] | None |
            Unset):
    """

    primary_slug: str
    articles: list[GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemArticlesType0Item] | None | Unset = UNSET
    certifications: (
        list[GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemCertificationsType0Item] | None | Unset
    ) = UNSET
    connection_count: float | None | Unset = UNSET
    courses: list[GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemCoursesType0Item] | None | Unset = UNSET
    dob: None | str | Unset = UNSET
    education: list[GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemEducationType0Item] | None | Unset = (
        UNSET
    )
    experiences: (
        list[GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemExperiencesType0Item] | None | Unset
    ) = UNSET
    ...
    inferred_location: (
        GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemInferredLocationType0 | None | Unset
    ) = UNSET
    interests: list[str] | None | Unset = UNSET
    last_name: None | str | Unset = UNSET
    locality: None | str | Unset = UNSET
    name: None | str | Unset = UNSET
    patents: list[GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemPatentsType0Item] | None | Unset = UNSET
    profile_pic: None | str | Unset = UNSET
    projects: list[GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemProjectsType0Item] | None | Unset = UNSET
    publications: (
        list[GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemPublicationsType0Item] | None | Unset
    ) = UNSET
    ...
    volunteering: (
        list[GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemVolunteeringType0Item] | None | Unset
    ) = UNSET
    tenures: list[GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemTenuresType0Item] | None | Unset = UNSET
    career_began_at: None | str | Unset = UNSET
    tags: list[GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemTagsType0Item] | None | Unset = UNSET
    ...
    organizations: (
        list[GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemOrganizationsType0Item] | None | Unset
    ) = UNSET
    ...
    verifications: GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemVerificationsType0 | None | Unset = UNSET
    is_top_voice: bool | None | Unset = UNSET
    current_job: GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemCurrentJobType0 | None | Unset = UNSET
    custom_data: GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemCustomDataType0 | None | Unset = UNSET
    ...
    detailed_education: (
        list[GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemDetailedEducationType0Item] | None | Unset
    ) = UNSET
    detailed_work_experiences: (
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.inferred_location, Unset):
            ...
            self.inferred_location, GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemInferredLocationType0
        ):
        ...
        if isinstance(self.verifications, Unset):
            ...
            self.verifications, GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemVerificationsType0
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_articles(
            data: object,
        ) -> list[GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemArticlesType0Item] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for articles_type_0_item_data in _articles_type_0:
                    articles_type_0_item = (
                        GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemArticlesType0Item.from_dict(
                ...
                pass
            return cast(
                list[GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemArticlesType0Item] | None | Unset, data
            )
            ...
            try:
                ...
                for certifications_type_0_item_data in _certifications_type_0:
                    certifications_type_0_item = (
                        GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemCertificationsType0Item.from_dict(
        ...
        def _parse_courses(
            data: object,
        ) -> list[GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemCoursesType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for courses_type_0_item_data in _courses_type_0:
                    courses_type_0_item = (
                        GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemCoursesType0Item.from_dict(
                ...
                pass
            return cast(
                list[GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemCoursesType0Item] | None | Unset, data
            )
        ...
        def _parse_education(
            data: object,
        ) -> list[GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemEducationType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for education_type_0_item_data in _education_type_0:
                    education_type_0_item = (
                        GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemEducationType0Item.from_dict(
            ...
            try:
                ...
                for experiences_type_0_item_data in _experiences_type_0:
                    experiences_type_0_item = (
                        GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemExperiencesType0Item.from_dict(
        ...
        def _parse_inferred_location(
            ...
            try:
                ...
                inferred_location_type_0 = (
                    GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemInferredLocationType0.from_dict(data)
                )
                ...
                pass
            return cast(
                GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemInferredLocationType0 | None | Unset, data
            )
        ...
        def _parse_patents(
            data: object,
        ) -> list[GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemPatentsType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for patents_type_0_item_data in _patents_type_0:
                    patents_type_0_item = (
                        GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemPatentsType0Item.from_dict(
                ...
                pass
            return cast(
                list[GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemPatentsType0Item] | None | Unset, data
            )
        ...
        def _parse_projects(
            data: object,
        ) -> list[GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemProjectsType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for projects_type_0_item_data in _projects_type_0:
                    projects_type_0_item = (
                        GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemProjectsType0Item.from_dict(
                ...
                pass
            return cast(
                list[GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemProjectsType0Item] | None | Unset, data
            )
            ...
            try:
                ...
                for publications_type_0_item_data in _publications_type_0:
                    publications_type_0_item = (
                        GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemPublicationsType0Item.from_dict(
            ...
            try:
                ...
                for volunteering_type_0_item_data in _volunteering_type_0:
                    volunteering_type_0_item = (
                        GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemVolunteeringType0Item.from_dict(
        ...
        def _parse_tenures(
            data: object,
        ) -> list[GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemTenuresType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for tenures_type_0_item_data in _tenures_type_0:
                    tenures_type_0_item = (
                        GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemTenuresType0Item.from_dict(
                ...
                pass
            return cast(
                list[GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemTenuresType0Item] | None | Unset, data
            )
        ...
        def _parse_tags(
            data: object,
        ) -> list[GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemTagsType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for tags_type_0_item_data in _tags_type_0:
                    tags_type_0_item = GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemTagsType0Item(
                ...
                pass
            return cast(
                list[GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemTagsType0Item] | None | Unset, data
            )
            ...
            try:
                ...
                for organizations_type_0_item_data in _organizations_type_0:
                    organizations_type_0_item = (
                        GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemOrganizationsType0Item.from_dict(
        ...
        def _parse_verifications(
            data: object,
        ) -> GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemVerificationsType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                verifications_type_0 = (
                    GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemVerificationsType0.from_dict(data)
                )
                ...
                pass
            return cast(
                GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemVerificationsType0 | None | Unset, data
            )
        ...
        def _parse_current_job(
            data: object,
        ) -> GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemCurrentJobType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                current_job_type_0 = (
                    GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemCurrentJobType0.from_dict(data)
                )
                ...
                pass
            return cast(
                GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemCurrentJobType0 | None | Unset, data
            )
        ...
        def _parse_custom_data(
            data: object,
        ) -> GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemCustomDataType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                custom_data_type_0 = (
                    GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemCustomDataType0.from_dict(data)
                )
                ...
                pass
            return cast(
                GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemCustomDataType0 | None | Unset, data
            )
        ...
        def _parse_languages(
            data: object,
        ) -> list[GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemLanguagesType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for languages_type_0_item_data in _languages_type_0:
                    languages_type_0_item = (
                        GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemLanguagesType0Item.from_dict(
        ...
        def _parse_detailed_education(
            ...
            try:
                ...
                for detailed_education_type_0_item_data in _detailed_education_type_0:
                    detailed_education_type_0_item = GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemDetailedEducationType0Item.from_dict(
        ...
        def _parse_detailed_work_experiences(
            ...
            try:
                ...
                for detailed_work_experiences_type_0_item_data in _detailed_work_experiences_type_0:
                    detailed_work_experiences_type_0_item = GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemDetailedWorkExperiencesType0Item.from_dict(
