...
T = TypeVar("T", bound="ReverseEmailLookupResponse200OutputDataItemDetailedEducationType0ItemSchoolDetailsType0")


@_attrs_define
class ReverseEmailLookupResponse200OutputDataItemDetailedEducationType0ItemSchoolDetailsType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reverse_email_lookup_response_200_output_data_item_detailed_education_type_0_item_school_details_type_0 = cls(
        ...
        reverse_email_lookup_response_200_output_data_item_detailed_education_type_0_item_school_details_type_0.additional_properties = d
        return reverse_email_lookup_response_200_output_data_item_detailed_education_type_0_item_school_details_type_0
