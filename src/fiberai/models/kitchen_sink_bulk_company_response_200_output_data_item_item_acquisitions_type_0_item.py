...
T = TypeVar("T", bound="KitchenSinkBulkCompanyResponse200OutputDataItemItemAcquisitionsType0Item")


@_attrs_define
class KitchenSinkBulkCompanyResponse200OutputDataItemItemAcquisitionsType0Item:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        kitchen_sink_bulk_company_response_200_output_data_item_item_acquisitions_type_0_item = cls(
            price_usd=price_usd,
            acquiree_name=acquiree_name,
            acquisition_date=acquisition_date,
        )

        kitchen_sink_bulk_company_response_200_output_data_item_item_acquisitions_type_0_item.additional_properties = d
        return kitchen_sink_bulk_company_response_200_output_data_item_item_acquisitions_type_0_item
