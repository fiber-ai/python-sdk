...
from ..models.text_to_company_search_response_200_output_search_params_exact_company_v2_type_0_none_of_type_0_item_type_3_identifier import (
    TextToCompanySearchResponse200OutputSearchParamsExactCompanyV2Type0NoneOfType0ItemType3Identifier,
)
from ..models.text_to_company_search_response_200_output_search_params_exact_company_v2_type_0_none_of_type_0_item_type_3_source_type_1 import (
    TextToCompanySearchResponse200OutputSearchParamsExactCompanyV2Type0NoneOfType0ItemType3SourceType1,
)
from ..models.text_to_company_search_response_200_output_search_params_exact_company_v2_type_0_none_of_type_0_item_type_3_source_type_2_type_1 import (
    TextToCompanySearchResponse200OutputSearchParamsExactCompanyV2Type0NoneOfType0ItemType3SourceType2Type1,
)
from ..models.text_to_company_search_response_200_output_search_params_exact_company_v2_type_0_none_of_type_0_item_type_3_source_type_3_type_1 import (
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_source(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                source_type_2_type_1 = TextToCompanySearchResponse200OutputSearchParamsExactCompanyV2Type0NoneOfType0ItemType3SourceType2Type1(
                    data
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                source_type_3_type_1 = TextToCompanySearchResponse200OutputSearchParamsExactCompanyV2Type0NoneOfType0ItemType3SourceType3Type1(
                    data
                )
        ...
        text_to_company_search_response_200_output_search_params_exact_company_v2_type_0_none_of_type_0_item_type_3 = (
            cls(
                identifier=identifier,
                li_org_id=li_org_id,
