...
T = TypeVar("T", bound="CreateTrackerCompanyListBodyCompanySearchParamsType0LastFundingUSDType0")


@_attrs_define
class CreateTrackerCompanyListBodyCompanySearchParamsType0LastFundingUSDType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_tracker_company_list_body_company_search_params_type_0_last_funding_usd_type_0 = cls(
            lower_bound=lower_bound,
            upper_bound=upper_bound,
        )

        create_tracker_company_list_body_company_search_params_type_0_last_funding_usd_type_0.additional_properties = d
        return create_tracker_company_list_body_company_search_params_type_0_last_funding_usd_type_0
