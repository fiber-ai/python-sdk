...
from ..models.create_saved_search_body_search_params_type_2_profile_search_params_past_job_text_type_0_criteria_item_field import CreateSavedSearchBodySearchParamsType2ProfileSearchParamsPastJobTextType0CriteriaItemField
from ..models.create_saved_search_body_search_params_type_2_profile_search_params_past_job_text_type_0_criteria_item_rule import CreateSavedSearchBodySearchParamsType2ProfileSearchParamsPastJobTextType0CriteriaItemRule
from ..types import UNSET, Unset
...
class CreateSavedSearchBodySearchParamsType2ProfileSearchParamsPastJobTextType0CriteriaItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        field = CreateSavedSearchBodySearchParamsType2ProfileSearchParamsPastJobTextType0CriteriaItemField(d.pop("field"))
