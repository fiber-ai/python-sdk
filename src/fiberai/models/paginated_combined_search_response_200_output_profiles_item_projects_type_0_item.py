...
T = TypeVar("T", bound="PaginatedCombinedSearchResponse200OutputProfilesItemProjectsType0Item")


@_attrs_define
class PaginatedCombinedSearchResponse200OutputProfilesItemProjectsType0Item:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        paginated_combined_search_response_200_output_profiles_item_projects_type_0_item = cls(
        ...
        paginated_combined_search_response_200_output_profiles_item_projects_type_0_item.additional_properties = d
        return paginated_combined_search_response_200_output_profiles_item_projects_type_0_item
