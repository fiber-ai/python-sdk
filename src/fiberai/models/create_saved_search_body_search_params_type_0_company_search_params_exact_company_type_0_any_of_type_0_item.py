...
from ..models.create_saved_search_body_search_params_type_0_company_search_params_exact_company_type_0_any_of_type_0_item_source_type_1 import (
    CreateSavedSearchBodySearchParamsType0CompanySearchParamsExactCompanyType0AnyOfType0ItemSourceType1,
)
from ..models.create_saved_search_body_search_params_type_0_company_search_params_exact_company_type_0_any_of_type_0_item_source_type_2_type_1 import (
    CreateSavedSearchBodySearchParamsType0CompanySearchParamsExactCompanyType0AnyOfType0ItemSourceType2Type1,
)
from ..models.create_saved_search_body_search_params_type_0_company_search_params_exact_company_type_0_any_of_type_0_item_source_type_3_type_1 import (
...
class CreateSavedSearchBodySearchParamsType0CompanySearchParamsExactCompanyType0AnyOfType0Item:
    ...
    Attributes:
        ...
        source (CreateSavedSearchBodySearchParamsType0CompanySearchParamsExactCompanyType0AnyOfType0ItemSourceType1 |
            CreateSavedSearchBodySearchParamsType0CompanySearchParamsExactCompanyType0AnyOfType0ItemSourceType2Type1 |
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_source(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                source_type_2_type_1 = CreateSavedSearchBodySearchParamsType0CompanySearchParamsExactCompanyType0AnyOfType0ItemSourceType2Type1(
                    data
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                source_type_3_type_1 = CreateSavedSearchBodySearchParamsType0CompanySearchParamsExactCompanyType0AnyOfType0ItemSourceType3Type1(
                    data
                )
        ...
        create_saved_search_body_search_params_type_0_company_search_params_exact_company_type_0_any_of_type_0_item = (
            cls(
                li_org_id=li_org_id,
