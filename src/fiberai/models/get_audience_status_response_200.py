...
if TYPE_CHECKING:
    from ..models.get_audience_status_response_200_charge_info_type_0 import GetAudienceStatusResponse200ChargeInfoType0
...
T = TypeVar("T", bound="GetAudienceStatusResponse200")


@_attrs_define
class GetAudienceStatusResponse200:
    """
    Attributes:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.charge_info, GetAudienceStatusResponse200ChargeInfoType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        output = GetAudienceStatusResponse200Output.from_dict(d.pop("output"))
        ...
        def _parse_charge_info(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_0 = GetAudienceStatusResponse200ChargeInfoType0.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_1 = GetAudienceStatusResponse200ChargeInfoType1.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_2 = GetAudienceStatusResponse200ChargeInfoType2.from_dict(data)
        ...
        def _parse_warnings(data: object) -> list[GetAudienceStatusResponse200WarningsType0Item] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for warnings_type_0_item_data in _warnings_type_0:
                    warnings_type_0_item = GetAudienceStatusResponse200WarningsType0Item.from_dict(
                ...
                pass
            return cast(list[GetAudienceStatusResponse200WarningsType0Item] | None | Unset, data)

        warnings = _parse_warnings(d.pop("warnings", UNSET))

        get_audience_status_response_200 = cls(
            output=output,
            charge_info=charge_info,
            warnings=warnings,
        )

        return get_audience_status_response_200
