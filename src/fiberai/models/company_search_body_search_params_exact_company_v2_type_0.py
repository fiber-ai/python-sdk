...
class CompanySearchBodySearchParamsExactCompanyV2Type0:
    """
    Attributes:
        any_of (list[CompanySearchBodySearchParamsExactCompanyV2Type0AnyOfType0ItemType0 |
            CompanySearchBodySearchParamsExactCompanyV2Type0AnyOfType0ItemType1 |
            CompanySearchBodySearchParamsExactCompanyV2Type0AnyOfType0ItemType2 |
            CompanySearchBodySearchParamsExactCompanyV2Type0AnyOfType0ItemType3] | None | Unset):
        none_of (list[CompanySearchBodySearchParamsExactCompanyV2Type0NoneOfType0ItemType0 |
            CompanySearchBodySearchParamsExactCompanyV2Type0NoneOfType0ItemType1 |
            CompanySearchBodySearchParamsExactCompanyV2Type0NoneOfType0ItemType2 |
            CompanySearchBodySearchParamsExactCompanyV2Type0NoneOfType0ItemType3] | None | Unset):
    """
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.any_of, Unset):
            ...
            for any_of_type_0_item_data in self.any_of:
                ...
                if isinstance(
                    any_of_type_0_item_data, CompanySearchBodySearchParamsExactCompanyV2Type0AnyOfType0ItemType0
                ):
                    any_of_type_0_item = any_of_type_0_item_data.to_dict()
                elif isinstance(
                    any_of_type_0_item_data, CompanySearchBodySearchParamsExactCompanyV2Type0AnyOfType0ItemType1
                ):
                    any_of_type_0_item = any_of_type_0_item_data.to_dict()
                elif isinstance(
                    any_of_type_0_item_data, CompanySearchBodySearchParamsExactCompanyV2Type0AnyOfType0ItemType2
                ):
                    any_of_type_0_item = any_of_type_0_item_data.to_dict()
                else:
                    any_of_type_0_item = any_of_type_0_item_data.to_dict()
        ...
        if isinstance(self.none_of, Unset):
            ...
            for none_of_type_0_item_data in self.none_of:
                ...
                if isinstance(
                    none_of_type_0_item_data, CompanySearchBodySearchParamsExactCompanyV2Type0NoneOfType0ItemType0
                ):
                    none_of_type_0_item = none_of_type_0_item_data.to_dict()
                elif isinstance(
                    none_of_type_0_item_data, CompanySearchBodySearchParamsExactCompanyV2Type0NoneOfType0ItemType1
                ):
                    none_of_type_0_item = none_of_type_0_item_data.to_dict()
                elif isinstance(
                    none_of_type_0_item_data, CompanySearchBodySearchParamsExactCompanyV2Type0NoneOfType0ItemType2
                ):
                    none_of_type_0_item = none_of_type_0_item_data.to_dict()
                else:
                    none_of_type_0_item = none_of_type_0_item_data.to_dict()
                    ...
                    def _parse_any_of_type_0_item(
                        ...
                        try:
                            ...
                            any_of_type_0_item_type_0 = (
                                CompanySearchBodySearchParamsExactCompanyV2Type0AnyOfType0ItemType0.from_dict(data)
                            )
                        ...
                        try:
                            ...
                            any_of_type_0_item_type_1 = (
                                CompanySearchBodySearchParamsExactCompanyV2Type0AnyOfType0ItemType1.from_dict(data)
                            )
                        ...
                        try:
                            ...
                            any_of_type_0_item_type_2 = (
                                CompanySearchBodySearchParamsExactCompanyV2Type0AnyOfType0ItemType2.from_dict(data)
                            )
                        ...
                        any_of_type_0_item_type_3 = (
                            CompanySearchBodySearchParamsExactCompanyV2Type0AnyOfType0ItemType3.from_dict(data)
                        )
                    ...
                    def _parse_none_of_type_0_item(
                        ...
                        try:
                            ...
                            none_of_type_0_item_type_0 = (
                                CompanySearchBodySearchParamsExactCompanyV2Type0NoneOfType0ItemType0.from_dict(data)
                            )
                        ...
                        try:
                            ...
                            none_of_type_0_item_type_1 = (
                                CompanySearchBodySearchParamsExactCompanyV2Type0NoneOfType0ItemType1.from_dict(data)
                            )
                        ...
                        try:
                            ...
                            none_of_type_0_item_type_2 = (
                                CompanySearchBodySearchParamsExactCompanyV2Type0NoneOfType0ItemType2.from_dict(data)
                            )
                        ...
                        none_of_type_0_item_type_3 = (
                            CompanySearchBodySearchParamsExactCompanyV2Type0NoneOfType0ItemType3.from_dict(data)
                        )
