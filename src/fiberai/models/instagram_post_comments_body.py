...
T = TypeVar("T", bound="InstagramPostCommentsBody")


@_attrs_define
class InstagramPostCommentsBody:
    """
    Attributes:
        api_key (str): Your Fiber API key
        post_url (str): Full Instagram post URL (e.g. 'https://www.instagram.com/p/DVoDVg5DkXM/') or shortcode (e.g.
            'DVoDVg5DkXM').
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        instagram_post_comments_body = cls(
            api_key=api_key,
            post_url=post_url,
            next_page_token=next_page_token,
        )

        instagram_post_comments_body.additional_properties = d
        return instagram_post_comments_body
