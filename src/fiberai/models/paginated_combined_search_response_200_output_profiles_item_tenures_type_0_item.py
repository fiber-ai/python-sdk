...
T = TypeVar("T", bound="PaginatedCombinedSearchResponse200OutputProfilesItemTenuresType0Item")


@_attrs_define
class PaginatedCombinedSearchResponse200OutputProfilesItemTenuresType0Item:
    """
    Attributes:
        date_range (PaginatedCombinedSearchResponse200OutputProfilesItemTenuresType0ItemDateRange):
        titles (list[str]):
        localities (list[str]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        date_range = PaginatedCombinedSearchResponse200OutputProfilesItemTenuresType0ItemDateRange.from_dict(
            d.pop("date_range")
        )
        ...
        paginated_combined_search_response_200_output_profiles_item_tenures_type_0_item = cls(
            date_range=date_range,
            titles=titles,
            localities=localities,
        ...
        paginated_combined_search_response_200_output_profiles_item_tenures_type_0_item.additional_properties = d
        return paginated_combined_search_response_200_output_profiles_item_tenures_type_0_item
