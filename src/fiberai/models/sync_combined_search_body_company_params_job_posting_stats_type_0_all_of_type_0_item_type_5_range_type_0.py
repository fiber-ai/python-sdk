...
from ..models.sync_combined_search_body_company_params_job_posting_stats_type_0_all_of_type_0_item_type_5_range_type_0_type import (
    SyncCombinedSearchBodyCompanyParamsJobPostingStatsType0AllOfType0ItemType5RangeType0Type,
)

if TYPE_CHECKING:
    from ..models.sync_combined_search_body_company_params_job_posting_stats_type_0_all_of_type_0_item_type_5_range_type_0_range import (
        SyncCombinedSearchBodyCompanyParamsJobPostingStatsType0AllOfType0ItemType5RangeType0Range,
    )
...
class SyncCombinedSearchBodyCompanyParamsJobPostingStatsType0AllOfType0ItemType5RangeType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        range_ = SyncCombinedSearchBodyCompanyParamsJobPostingStatsType0AllOfType0ItemType5RangeType0Range.from_dict(
            d.pop("range")
        )
