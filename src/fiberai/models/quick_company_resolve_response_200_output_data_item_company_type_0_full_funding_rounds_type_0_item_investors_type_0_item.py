...
T = TypeVar(
    "T", bound="QuickCompanyResolveResponse200OutputDataItemCompanyType0FullFundingRoundsType0ItemInvestorsType0Item"
)


@_attrs_define
class QuickCompanyResolveResponse200OutputDataItemCompanyType0FullFundingRoundsType0ItemInvestorsType0Item:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        quick_company_resolve_response_200_output_data_item_company_type_0_full_funding_rounds_type_0_item_investors_type_0_item = cls(
            is_lead=is_lead,
        ...
        quick_company_resolve_response_200_output_data_item_company_type_0_full_funding_rounds_type_0_item_investors_type_0_item.additional_properties = d
        return quick_company_resolve_response_200_output_data_item_company_type_0_full_funding_rounds_type_0_item_investors_type_0_item
