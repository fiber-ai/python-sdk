...
T = TypeVar("T", bound="CompanySearchResponse200OutputDataItemAcquisitionsType0Item")


@_attrs_define
class CompanySearchResponse200OutputDataItemAcquisitionsType0Item:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        company_search_response_200_output_data_item_acquisitions_type_0_item = cls(
            price_usd=price_usd,
            acquiree_name=acquiree_name,
            acquisition_date=acquisition_date,
        )

        company_search_response_200_output_data_item_acquisitions_type_0_item.additional_properties = d
        return company_search_response_200_output_data_item_acquisitions_type_0_item
