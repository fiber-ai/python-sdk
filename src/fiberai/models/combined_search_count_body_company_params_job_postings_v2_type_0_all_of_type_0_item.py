...
class CombinedSearchCountBodyCompanyParamsJobPostingsV2Type0AllOfType0Item:
    ...
    Attributes:
        ...
        years_of_experience (CombinedSearchCountBodyCompanyParamsJobPostingsV2Type0AllOfType0ItemYearsOfExperienceType0
            | None | Unset):
        geo_location (CombinedSearchCountBodyCompanyParamsJobPostingsV2Type0AllOfType0ItemGeoLocationType0 | None |
            Unset):
    ...
    geo_location: (
        CombinedSearchCountBodyCompanyParamsJobPostingsV2Type0AllOfType0ItemGeoLocationType0 | None | Unset
    ) = UNSET
    country_or_region_code: (
