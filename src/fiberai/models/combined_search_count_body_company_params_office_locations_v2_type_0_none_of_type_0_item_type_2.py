...
from ..models.combined_search_count_body_company_params_office_locations_v2_type_0_none_of_type_0_item_type_2_type import (
...
@_attrs_define
class CombinedSearchCountBodyCompanyParamsOfficeLocationsV2Type0NoneOfType0ItemType2:
    """
    Attributes:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(
            ...
            self.location, CombinedSearchCountBodyCompanyParamsOfficeLocationsV2Type0NoneOfType0ItemType2LocationType2
        ):
            location = self.location.to_dict()
        else:
            location = self.location.to_dict()
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_location(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                location_type_2 = CombinedSearchCountBodyCompanyParamsOfficeLocationsV2Type0NoneOfType0ItemType2LocationType2.from_dict(
                    data
                )
            ...
            if not isinstance(data, dict):
                raise TypeError()
            location_type_3 = (
                CombinedSearchCountBodyCompanyParamsOfficeLocationsV2Type0NoneOfType0ItemType2LocationType3.from_dict(
                    data
                )
            )
        ...
        combined_search_count_body_company_params_office_locations_v2_type_0_none_of_type_0_item_type_2 = cls(
            type_=type_,
            location=location,
        )

        combined_search_count_body_company_params_office_locations_v2_type_0_none_of_type_0_item_type_2.additional_properties = d
        return combined_search_count_body_company_params_office_locations_v2_type_0_none_of_type_0_item_type_2
