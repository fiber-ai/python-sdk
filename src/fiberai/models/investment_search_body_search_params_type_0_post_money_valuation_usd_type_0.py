...
T = TypeVar("T", bound="InvestmentSearchBodySearchParamsType0PostMoneyValuationUSDType0")



@_attrs_define
class InvestmentSearchBodySearchParamsType0PostMoneyValuationUSDType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        investment_search_body_search_params_type_0_post_money_valuation_usd_type_0 = cls(
            lower_bound=lower_bound,
            upper_bound=upper_bound,
        )


        investment_search_body_search_params_type_0_post_money_valuation_usd_type_0.additional_properties = d
        return investment_search_body_search_params_type_0_post_money_valuation_usd_type_0
