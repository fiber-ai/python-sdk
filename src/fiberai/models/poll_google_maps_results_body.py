...
class PollGoogleMapsResultsBody:
    """ 
        Attributes:
            ...
            project_id (str): The id of the google maps project. Use this to poll for the search results
            page_size (Union[Unset, int]): The number of results to return per page Default: 25.
            cursor (Union[None, Unset, str]): A pagination cursor returned from a previous search response. Use this to
                fetch the next page of results. If this is null, then the first page of results will be returned.
     """
