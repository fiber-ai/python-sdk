...
class ProfileLiveEnrichResponse200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_output(
            data: object,
        ) -> ProfileLiveEnrichResponse200ProfileFoundAndEnriched | ProfileLiveEnrichResponse200ProfileNotFound:
            try:
        ...
        def _parse_warnings(data: object) -> list[ProfileLiveEnrichResponse200WarningsType0Item] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for warnings_type_0_item_data in _warnings_type_0:
                    warnings_type_0_item = ProfileLiveEnrichResponse200WarningsType0Item.from_dict(
                ...
                pass
            return cast(list[ProfileLiveEnrichResponse200WarningsType0Item] | None | Unset, data)
