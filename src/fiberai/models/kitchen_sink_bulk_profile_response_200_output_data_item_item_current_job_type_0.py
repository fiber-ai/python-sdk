...
from ..models.kitchen_sink_bulk_profile_response_200_output_data_item_item_current_job_type_0_academic_qualification_type_0_item import (
    KitchenSinkBulkProfileResponse200OutputDataItemItemCurrentJobType0AcademicQualificationType0Item,
)
from ..models.kitchen_sink_bulk_profile_response_200_output_data_item_item_current_job_type_0_employment_type_type_0_item import (
    KitchenSinkBulkProfileResponse200OutputDataItemItemCurrentJobType0EmploymentTypeType0Item,
)
from ..models.kitchen_sink_bulk_profile_response_200_output_data_item_item_current_job_type_0_job_function_type_0_item import (
    KitchenSinkBulkProfileResponse200OutputDataItemItemCurrentJobType0JobFunctionType0Item,
)
from ..models.kitchen_sink_bulk_profile_response_200_output_data_item_item_current_job_type_0_seniority_type_1 import (
    KitchenSinkBulkProfileResponse200OutputDataItemItemCurrentJobType0SeniorityType1,
)
from ..models.kitchen_sink_bulk_profile_response_200_output_data_item_item_current_job_type_0_seniority_type_2_type_1 import (
    KitchenSinkBulkProfileResponse200OutputDataItemItemCurrentJobType0SeniorityType2Type1,
)
from ..models.kitchen_sink_bulk_profile_response_200_output_data_item_item_current_job_type_0_seniority_type_3_type_1 import (
...
class KitchenSinkBulkProfileResponse200OutputDataItemItemCurrentJobType0:
    ...
    Attributes:
        ...
        seniority (KitchenSinkBulkProfileResponse200OutputDataItemItemCurrentJobType0SeniorityType1 |
            KitchenSinkBulkProfileResponse200OutputDataItemItemCurrentJobType0SeniorityType2Type1 |
            KitchenSinkBulkProfileResponse200OutputDataItemItemCurrentJobType0SeniorityType3Type1 | None | Unset):
        job_function (list[KitchenSinkBulkProfileResponse200OutputDataItemItemCurrentJobType0JobFunctionType0Item] |
            None | Unset):
        employment_type (list[KitchenSinkBulkProfileResponse200OutputDataItemItemCurrentJobType0EmploymentTypeType0Item]
            | None | Unset):
        academic_qualification
            (list[KitchenSinkBulkProfileResponse200OutputDataItemItemCurrentJobType0AcademicQualificationType0Item] | None |
            Unset):
    ...
    job_function: (
        list[KitchenSinkBulkProfileResponse200OutputDataItemItemCurrentJobType0JobFunctionType0Item] | None | Unset
    ) = UNSET
    employment_type: (
        list[KitchenSinkBulkProfileResponse200OutputDataItemItemCurrentJobType0EmploymentTypeType0Item] | None | Unset
    ) = UNSET
    academic_qualification: (
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.seniority, Unset):
            ...
            self.seniority, KitchenSinkBulkProfileResponse200OutputDataItemItemCurrentJobType0SeniorityType1
        ):
            seniority = self.seniority.value
        elif isinstance(
            self.seniority, KitchenSinkBulkProfileResponse200OutputDataItemItemCurrentJobType0SeniorityType2Type1
        ):
            seniority = self.seniority.value
        elif isinstance(
            self.seniority, KitchenSinkBulkProfileResponse200OutputDataItemItemCurrentJobType0SeniorityType3Type1
        ):
            seniority = self.seniority.value
        else:
        ...
        def _parse_seniority(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                seniority_type_1 = KitchenSinkBulkProfileResponse200OutputDataItemItemCurrentJobType0SeniorityType1(
                    data
                )
            ...
            try:
                ...
                seniority_type_2_type_1 = (
                    KitchenSinkBulkProfileResponse200OutputDataItemItemCurrentJobType0SeniorityType2Type1(data)
                )
            ...
            try:
                ...
                seniority_type_3_type_1 = (
                    KitchenSinkBulkProfileResponse200OutputDataItemItemCurrentJobType0SeniorityType3Type1(data)
                )
        ...
        def _parse_academic_qualification(
            ...
            try:
                ...
                for academic_qualification_type_0_item_data in _academic_qualification_type_0:
                    academic_qualification_type_0_item = KitchenSinkBulkProfileResponse200OutputDataItemItemCurrentJobType0AcademicQualificationType0Item(
