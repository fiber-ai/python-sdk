...
if TYPE_CHECKING:
  from ..models.profile_reactions_live_fetch_response_200_output_reactions_type_0_item_post_type_0_author_type_0 import ProfileReactionsLiveFetchResponse200OutputReactionsType0ItemPostType0AuthorType0
...
class ProfileReactionsLiveFetchResponse200OutputReactionsType0ItemPostType0:
    """ 
        Attributes:
            ...
            author (Union['ProfileReactionsLiveFetchResponse200OutputReactionsType0ItemPostType0AuthorType0', None, Unset]):
            content (Union[None, Unset, str]):
     """

    post_urn: Union[None, Unset, str] = UNSET
    post_url: Union[None, Unset, str] = UNSET
    author: Union['ProfileReactionsLiveFetchResponse200OutputReactionsType0ItemPostType0AuthorType0', None, Unset] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_author(data: object) -> Union['ProfileReactionsLiveFetchResponse200OutputReactionsType0ItemPostType0AuthorType0', None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                author_type_0 = ProfileReactionsLiveFetchResponse200OutputReactionsType0ItemPostType0AuthorType0.from_dict(data)
                ...
                pass
            return cast(Union['ProfileReactionsLiveFetchResponse200OutputReactionsType0ItemPostType0AuthorType0', None, Unset], data)
