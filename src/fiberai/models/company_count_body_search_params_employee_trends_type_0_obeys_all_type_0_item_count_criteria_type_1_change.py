...
T = TypeVar("T", bound="CompanyCountBodySearchParamsEmployeeTrendsType0ObeysAllType0ItemCountCriteriaType1Change")



@_attrs_define
class CompanyCountBodySearchParamsEmployeeTrendsType0ObeysAllType0ItemCountCriteriaType1Change:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        company_count_body_search_params_employee_trends_type_0_obeys_all_type_0_item_count_criteria_type_1_change = cls(
            lower_bound=lower_bound,
            upper_bound=upper_bound,
        )


        company_count_body_search_params_employee_trends_type_0_obeys_all_type_0_item_count_criteria_type_1_change.additional_properties = d
        return company_count_body_search_params_employee_trends_type_0_obeys_all_type_0_item_count_criteria_type_1_change
