...
if TYPE_CHECKING:
  from ..models.kitchen_sink_company_response_200_output_data_item_investment_stats_type_0_investments_by_stage_type_0_item import KitchenSinkCompanyResponse200OutputDataItemInvestmentStatsType0InvestmentsByStageType0Item





T = TypeVar("T", bound="KitchenSinkCompanyResponse200OutputDataItemInvestmentStatsType0")



@_attrs_define
class KitchenSinkCompanyResponse200OutputDataItemInvestmentStatsType0:
    """ 
        Attributes:
            investments_by_stage (Union[None, Unset,
                list['KitchenSinkCompanyResponse200OutputDataItemInvestmentStatsType0InvestmentsByStageType0Item']]):
    ...
    investments_by_stage: Union[None, Unset, list['KitchenSinkCompanyResponse200OutputDataItemInvestmentStatsType0InvestmentsByStageType0Item']] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.kitchen_sink_company_response_200_output_data_item_investment_stats_type_0_investments_by_stage_type_0_item import KitchenSinkCompanyResponse200OutputDataItemInvestmentStatsType0InvestmentsByStageType0Item
        d = dict(src_dict)
        def _parse_investments_by_stage(data: object) -> Union[None, Unset, list['KitchenSinkCompanyResponse200OutputDataItemInvestmentStatsType0InvestmentsByStageType0Item']]:
            if data is None:
                return data
            ...
            try:
                ...
                for investments_by_stage_type_0_item_data in (_investments_by_stage_type_0):
                    investments_by_stage_type_0_item = KitchenSinkCompanyResponse200OutputDataItemInvestmentStatsType0InvestmentsByStageType0Item.from_dict(investments_by_stage_type_0_item_data)
                ...
                pass
            return cast(Union[None, Unset, list['KitchenSinkCompanyResponse200OutputDataItemInvestmentStatsType0InvestmentsByStageType0Item']], data)
        ...
        kitchen_sink_company_response_200_output_data_item_investment_stats_type_0 = cls(
        ...
        kitchen_sink_company_response_200_output_data_item_investment_stats_type_0.additional_properties = d
        return kitchen_sink_company_response_200_output_data_item_investment_stats_type_0
