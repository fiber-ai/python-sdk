...
T = TypeVar("T", bound="CompanyLogoChanged")


@_attrs_define
class CompanyLogoChanged:
    """
    Attributes:
        type_ (Literal['company_logo_changed']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        type_ = cast(Literal["company_logo_changed"], d.pop("type"))
        if type_ != "company_logo_changed":
            raise ValueError(f"type must match const 'company_logo_changed', got '{type_}'")
        ...
        company_logo_changed.additional_properties = d
        return company_logo_changed
