...
T = TypeVar("T", bound="GetTechnologiesResponse200")


@_attrs_define
class GetTechnologiesResponse200:
    """
    Attributes:
    ...
    output: list[GetTechnologiesResponse200OutputItem]
    charge_info: (
        GetTechnologiesResponse200ChargeInfoType0
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.charge_info, GetTechnologiesResponse200ChargeInfoType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for output_item_data in _output:
            output_item = GetTechnologiesResponse200OutputItem.from_dict(output_item_data)
        ...
        def _parse_charge_info(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_0 = GetTechnologiesResponse200ChargeInfoType0.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_1 = GetTechnologiesResponse200ChargeInfoType1.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_2 = GetTechnologiesResponse200ChargeInfoType2.from_dict(data)
        ...
        def _parse_warnings(data: object) -> list[GetTechnologiesResponse200WarningsType0Item] | None | Unset:
            ...
            try:
                ...
                for warnings_type_0_item_data in _warnings_type_0:
                    warnings_type_0_item = GetTechnologiesResponse200WarningsType0Item.from_dict(
                ...
                pass
            return cast(list[GetTechnologiesResponse200WarningsType0Item] | None | Unset, data)
        ...
        return get_technologies_response_200
