...
from ..models.create_saved_search_body_search_params_type_0_company_search_params_revenue_usd_type_0_max_type_0_suffix_type_1 import (
    CreateSavedSearchBodySearchParamsType0CompanySearchParamsRevenueUSDType0MaxType0SuffixType1,
)
from ..models.create_saved_search_body_search_params_type_0_company_search_params_revenue_usd_type_0_max_type_0_suffix_type_2_type_1 import (
    CreateSavedSearchBodySearchParamsType0CompanySearchParamsRevenueUSDType0MaxType0SuffixType2Type1,
)
from ..models.create_saved_search_body_search_params_type_0_company_search_params_revenue_usd_type_0_max_type_0_suffix_type_3_type_1 import (
...
class CreateSavedSearchBodySearchParamsType0CompanySearchParamsRevenueUSDType0MaxType0:
    ...
    Attributes:
        quantity (float):
        suffix (CreateSavedSearchBodySearchParamsType0CompanySearchParamsRevenueUSDType0MaxType0SuffixType1 |
            CreateSavedSearchBodySearchParamsType0CompanySearchParamsRevenueUSDType0MaxType0SuffixType2Type1 |
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        suffix: None | str
        if isinstance(
            self.suffix, CreateSavedSearchBodySearchParamsType0CompanySearchParamsRevenueUSDType0MaxType0SuffixType1
        ):
        ...
        def _parse_suffix(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                suffix_type_1 = (
                    CreateSavedSearchBodySearchParamsType0CompanySearchParamsRevenueUSDType0MaxType0SuffixType1(data)
                )
