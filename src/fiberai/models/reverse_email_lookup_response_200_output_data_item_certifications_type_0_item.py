...
T = TypeVar("T", bound="ReverseEmailLookupResponse200OutputDataItemCertificationsType0Item")


@_attrs_define
class ReverseEmailLookupResponse200OutputDataItemCertificationsType0Item:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reverse_email_lookup_response_200_output_data_item_certifications_type_0_item = cls(
            title=title,
        ...
        reverse_email_lookup_response_200_output_data_item_certifications_type_0_item.additional_properties = d
        return reverse_email_lookup_response_200_output_data_item_certifications_type_0_item
