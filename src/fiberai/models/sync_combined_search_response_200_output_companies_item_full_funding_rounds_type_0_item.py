...
if TYPE_CHECKING:
    from ..models.sync_combined_search_response_200_output_companies_item_full_funding_rounds_type_0_item_investors_type_0_item import (
        SyncCombinedSearchResponse200OutputCompaniesItemFullFundingRoundsType0ItemInvestorsType0Item,
    )
...
class SyncCombinedSearchResponse200OutputCompaniesItemFullFundingRoundsType0Item:
    """
    Attributes:
        investors (list[SyncCombinedSearchResponse200OutputCompaniesItemFullFundingRoundsType0ItemInvestorsType0Item] |
            None | Unset):
        ...
        def _parse_investors(
            ...
            try:
                ...
                for investors_type_0_item_data in _investors_type_0:
                    investors_type_0_item = SyncCombinedSearchResponse200OutputCompaniesItemFullFundingRoundsType0ItemInvestorsType0Item.from_dict(
