...
from ..models.text_to_profile_search_params_response_200_output_search_params_education_type_0_all_of_type_0_item_school_v3_type_0_none_of_type_0_item_source_type_1 import (
...
from ..models.text_to_profile_search_params_response_200_output_search_params_education_type_0_all_of_type_0_item_school_v3_type_0_none_of_type_0_item_source_type_2_type_1 import (
...
from ..models.text_to_profile_search_params_response_200_output_search_params_education_type_0_all_of_type_0_item_school_v3_type_0_none_of_type_0_item_source_type_3_type_1 import (
...
T = TypeVar(
    "T",
    bound="TextToProfileSearchParamsResponse200OutputSearchParamsEducationType0AllOfType0ItemSchoolV3Type0NoneOfType0Item",
)
...
class TextToProfileSearchParamsResponse200OutputSearchParamsEducationType0AllOfType0ItemSchoolV3Type0NoneOfType0Item:
    ...
    Attributes:
        ...
        source (None | TextToProfileSearchParamsResponse200OutputSearchParamsEducationType0AllOfType0ItemSchoolV3Type0No
            neOfType0ItemSourceType1 | TextToProfileSearchParamsResponse200OutputSearchParamsEducationType0AllOfType0ItemSch
            oolV3Type0NoneOfType0ItemSourceType2Type1 | TextToProfileSearchParamsResponse200OutputSearchParamsEducationType0
            AllOfType0ItemSchoolV3Type0NoneOfType0ItemSourceType3Type1 | Unset):
    """
        ...
        def _parse_source(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                source_type_1 = TextToProfileSearchParamsResponse200OutputSearchParamsEducationType0AllOfType0ItemSchoolV3Type0NoneOfType0ItemSourceType1(
                    data
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                source_type_2_type_1 = TextToProfileSearchParamsResponse200OutputSearchParamsEducationType0AllOfType0ItemSchoolV3Type0NoneOfType0ItemSourceType2Type1(
                    data
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                source_type_3_type_1 = TextToProfileSearchParamsResponse200OutputSearchParamsEducationType0AllOfType0ItemSchoolV3Type0NoneOfType0ItemSourceType3Type1(
                    data
                )
