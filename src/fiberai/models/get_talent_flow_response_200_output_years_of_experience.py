...
T = TypeVar("T", bound="GetTalentFlowResponse200OutputYearsOfExperience")


@_attrs_define
class GetTalentFlowResponse200OutputYearsOfExperience:
    """Years of experience at the time of the join or leave event.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_talent_flow_response_200_output_years_of_experience = cls(
            count=count,
            median=median,
            mean=mean,
            std_dev=std_dev,
        ...
        get_talent_flow_response_200_output_years_of_experience.additional_properties = d
        return get_talent_flow_response_200_output_years_of_experience
