...
T = TypeVar("T", bound="GetWebhookEndpointResponse200Output")


@_attrs_define
class GetWebhookEndpointResponse200Output:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_webhook_endpoint_response_200_output = cls(
        ...
        get_webhook_endpoint_response_200_output.additional_properties = d
        return get_webhook_endpoint_response_200_output
