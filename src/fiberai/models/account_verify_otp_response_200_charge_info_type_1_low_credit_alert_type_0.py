...
T = TypeVar("T", bound="AccountVerifyOtpResponse200ChargeInfoType1LowCreditAlertType0")


@_attrs_define
class AccountVerifyOtpResponse200ChargeInfoType1LowCreditAlertType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        account_verify_otp_response_200_charge_info_type_1_low_credit_alert_type_0 = cls(
            get_more_credits_url=get_more_credits_url,
            message=message,
            available_credits=available_credits,
        )

        account_verify_otp_response_200_charge_info_type_1_low_credit_alert_type_0.additional_properties = d
        return account_verify_otp_response_200_charge_info_type_1_low_credit_alert_type_0
