...
from ..models.create_tracker_company_list_body_company_search_params_type_0_accelerators_v2_type_0_any_of_type_0_item_accelerator_name import (
    CreateTrackerCompanyListBodyCompanySearchParamsType0AcceleratorsV2Type0AnyOfType0ItemAcceleratorName,
)
...
T = TypeVar("T", bound="CreateTrackerCompanyListBodyCompanySearchParamsType0AcceleratorsV2Type0AnyOfType0Item")


@_attrs_define
class CreateTrackerCompanyListBodyCompanySearchParamsType0AcceleratorsV2Type0AnyOfType0Item:
    """
    Attributes:
        accelerator_name
            (CreateTrackerCompanyListBodyCompanySearchParamsType0AcceleratorsV2Type0AnyOfType0ItemAcceleratorName):
        batch_selection
            (CreateTrackerCompanyListBodyCompanySearchParamsType0AcceleratorsV2Type0AnyOfType0ItemBatchSelectionType0 |
            CreateTrackerCompanyListBodyCompanySearchParamsType0AcceleratorsV2Type0AnyOfType0ItemBatchSelectionType1 | None
            | Unset):
        years (CreateTrackerCompanyListBodyCompanySearchParamsType0AcceleratorsV2Type0AnyOfType0ItemYearsType0 | None |
            Unset):
    """
    ...
    years: (
        CreateTrackerCompanyListBodyCompanySearchParamsType0AcceleratorsV2Type0AnyOfType0ItemYearsType0 | None | Unset
    ) = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.years, Unset):
            ...
            self.years, CreateTrackerCompanyListBodyCompanySearchParamsType0AcceleratorsV2Type0AnyOfType0ItemYearsType0
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_batch_selection(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                batch_selection_type_0 = CreateTrackerCompanyListBodyCompanySearchParamsType0AcceleratorsV2Type0AnyOfType0ItemBatchSelectionType0.from_dict(
                    data
                )
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                batch_selection_type_1 = CreateTrackerCompanyListBodyCompanySearchParamsType0AcceleratorsV2Type0AnyOfType0ItemBatchSelectionType1.from_dict(
                    data
                )
        ...
        def _parse_years(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                years_type_0 = CreateTrackerCompanyListBodyCompanySearchParamsType0AcceleratorsV2Type0AnyOfType0ItemYearsType0.from_dict(
                    data
                )
        ...
        create_tracker_company_list_body_company_search_params_type_0_accelerators_v2_type_0_any_of_type_0_item = cls(
            accelerator_name=accelerator_name,
            batch_selection=batch_selection,
            years=years,
        )

        create_tracker_company_list_body_company_search_params_type_0_accelerators_v2_type_0_any_of_type_0_item.additional_properties = d
        return create_tracker_company_list_body_company_search_params_type_0_accelerators_v2_type_0_any_of_type_0_item
