...
if TYPE_CHECKING:
    from ..models.kitchen_sink_bulk_company_response_200_output_data_item_item_li_locations_type_0_item_location_type_0_coordinates_type_0 import (
        KitchenSinkBulkCompanyResponse200OutputDataItemItemLiLocationsType0ItemLocationType0CoordinatesType0,
    )
...
class KitchenSinkBulkCompanyResponse200OutputDataItemItemLiLocationsType0ItemLocationType0:
    ...
    Attributes:
        ...
        coordinates
            (KitchenSinkBulkCompanyResponse200OutputDataItemItemLiLocationsType0ItemLocationType0CoordinatesType0 | None |
            Unset):
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.kitchen_sink_bulk_company_response_200_output_data_item_item_li_locations_type_0_item_location_type_0_coordinates_type_0 import (
            KitchenSinkBulkCompanyResponse200OutputDataItemItemLiLocationsType0ItemLocationType0CoordinatesType0,  # noqa: PLC0415
        )
        ...
        def _parse_coordinates(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = KitchenSinkBulkCompanyResponse200OutputDataItemItemLiLocationsType0ItemLocationType0CoordinatesType0.from_dict(
                    data
                )
