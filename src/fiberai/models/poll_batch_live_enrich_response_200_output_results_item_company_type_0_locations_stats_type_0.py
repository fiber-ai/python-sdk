...
T = TypeVar("T", bound="PollBatchLiveEnrichResponse200OutputResultsItemCompanyType0LocationsStatsType0")


@_attrs_define
class PollBatchLiveEnrichResponse200OutputResultsItemCompanyType0LocationsStatsType0:
    """
    Attributes:
        usa (float | Unset):
        gbr (float | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        poll_batch_live_enrich_response_200_output_results_item_company_type_0_locations_stats_type_0 = cls(
            usa=usa,
            gbr=gbr,
            fra=fra,
            ind=ind,
        ...
        return poll_batch_live_enrich_response_200_output_results_item_company_type_0_locations_stats_type_0
