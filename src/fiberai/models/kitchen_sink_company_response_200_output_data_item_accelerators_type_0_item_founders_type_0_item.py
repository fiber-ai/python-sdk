...
T = TypeVar("T", bound="KitchenSinkCompanyResponse200OutputDataItemAcceleratorsType0ItemFoundersType0Item")



@_attrs_define
class KitchenSinkCompanyResponse200OutputDataItemAcceleratorsType0ItemFoundersType0Item:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        kitchen_sink_company_response_200_output_data_item_accelerators_type_0_item_founders_type_0_item = cls(
            full_name=full_name,
            bio=bio,
            job_title=job_title,
            is_active=is_active,
        ...
        kitchen_sink_company_response_200_output_data_item_accelerators_type_0_item_founders_type_0_item.additional_properties = d
        return kitchen_sink_company_response_200_output_data_item_accelerators_type_0_item_founders_type_0_item
