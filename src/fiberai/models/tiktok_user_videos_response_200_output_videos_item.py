...
T = TypeVar("T", bound="TiktokUserVideosResponse200OutputVideosItem")


@_attrs_define
class TiktokUserVideosResponse200OutputVideosItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        tiktok_user_videos_response_200_output_videos_item = cls(
            id=id,
            caption=caption,
        ...
        tiktok_user_videos_response_200_output_videos_item.additional_properties = d
        return tiktok_user_videos_response_200_output_videos_item
