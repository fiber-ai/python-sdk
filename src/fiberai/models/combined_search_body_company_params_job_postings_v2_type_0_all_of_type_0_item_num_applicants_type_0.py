...
T = TypeVar("T", bound="CombinedSearchBodyCompanyParamsJobPostingsV2Type0AllOfType0ItemNumApplicantsType0")


@_attrs_define
class CombinedSearchBodyCompanyParamsJobPostingsV2Type0AllOfType0ItemNumApplicantsType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        combined_search_body_company_params_job_postings_v2_type_0_all_of_type_0_item_num_applicants_type_0 = cls(
            lower_bound=lower_bound,
            upper_bound=upper_bound,
        )

        combined_search_body_company_params_job_postings_v2_type_0_all_of_type_0_item_num_applicants_type_0.additional_properties = d
        return combined_search_body_company_params_job_postings_v2_type_0_all_of_type_0_item_num_applicants_type_0
