...
T = TypeVar("T", bound="SyncCombinedSearchResponse200OutputCompaniesItemFullFundingRoundsType0ItemInvestorsType0Item")



@_attrs_define
class SyncCombinedSearchResponse200OutputCompaniesItemFullFundingRoundsType0ItemInvestorsType0Item:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sync_combined_search_response_200_output_companies_item_full_funding_rounds_type_0_item_investors_type_0_item = cls(
            is_lead=is_lead,
        ...
        sync_combined_search_response_200_output_companies_item_full_funding_rounds_type_0_item_investors_type_0_item.additional_properties = d
        return sync_combined_search_response_200_output_companies_item_full_funding_rounds_type_0_item_investors_type_0_item
