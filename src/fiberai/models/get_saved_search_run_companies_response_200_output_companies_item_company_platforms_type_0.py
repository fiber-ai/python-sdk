...
T = TypeVar("T", bound="GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyPlatformsType0")


@_attrs_define
class GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyPlatformsType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_saved_search_run_companies_response_200_output_companies_item_company_platforms_type_0 = cls(
            ecommerce=ecommerce,
            cms=cms,
            crm=crm,
            marketing=marketing,
        ...
        get_saved_search_run_companies_response_200_output_companies_item_company_platforms_type_0.additional_properties = d
        return get_saved_search_run_companies_response_200_output_companies_item_company_platforms_type_0
