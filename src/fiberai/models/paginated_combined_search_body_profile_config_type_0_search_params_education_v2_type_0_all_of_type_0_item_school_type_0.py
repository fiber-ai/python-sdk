...
T = TypeVar(
    "T", bound="PaginatedCombinedSearchBodyProfileConfigType0SearchParamsEducationV2Type0AllOfType0ItemSchoolType0"
)


@_attrs_define
class PaginatedCombinedSearchBodyProfileConfigType0SearchParamsEducationV2Type0AllOfType0ItemSchoolType0:
    """
    Attributes:
        exact (None |
            PaginatedCombinedSearchBodyProfileConfigType0SearchParamsEducationV2Type0AllOfType0ItemSchoolType0ExactType0 |
            Unset):
        name_keywords (None | PaginatedCombinedSearchBodyProfileConfigType0SearchParamsEducationV2Type0AllOfType0ItemSch
            oolType0NameKeywordsType0 | Unset):
        properties (None | PaginatedCombinedSearchBodyProfileConfigType0SearchParamsEducationV2Type0AllOfType0ItemSchool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_exact(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                exact_type_0 = PaginatedCombinedSearchBodyProfileConfigType0SearchParamsEducationV2Type0AllOfType0ItemSchoolType0ExactType0.from_dict(
                    data
                )
        ...
        def _parse_name_keywords(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                name_keywords_type_0 = PaginatedCombinedSearchBodyProfileConfigType0SearchParamsEducationV2Type0AllOfType0ItemSchoolType0NameKeywordsType0.from_dict(
                    data
                )
        ...
        def _parse_properties(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                properties_type_0 = PaginatedCombinedSearchBodyProfileConfigType0SearchParamsEducationV2Type0AllOfType0ItemSchoolType0PropertiesType0.from_dict(
                    data
                )
        ...
        paginated_combined_search_body_profile_config_type_0_search_params_education_v2_type_0_all_of_type_0_item_school_type_0 = cls(
            exact=exact,
            name_keywords=name_keywords,
            properties=properties,
        )

        paginated_combined_search_body_profile_config_type_0_search_params_education_v2_type_0_all_of_type_0_item_school_type_0.additional_properties = d
        return paginated_combined_search_body_profile_config_type_0_search_params_education_v2_type_0_all_of_type_0_item_school_type_0
