...
from ..models.combined_search_count_body_profile_params_ever_worked_at_type_0_none_of_type_0_item_company_type_0_source_type_1 import (
    CombinedSearchCountBodyProfileParamsEverWorkedAtType0NoneOfType0ItemCompanyType0SourceType1,
)
from ..models.combined_search_count_body_profile_params_ever_worked_at_type_0_none_of_type_0_item_company_type_0_source_type_2_type_1 import (
    CombinedSearchCountBodyProfileParamsEverWorkedAtType0NoneOfType0ItemCompanyType0SourceType2Type1,
)
from ..models.combined_search_count_body_profile_params_ever_worked_at_type_0_none_of_type_0_item_company_type_0_source_type_3_type_1 import (
    CombinedSearchCountBodyProfileParamsEverWorkedAtType0NoneOfType0ItemCompanyType0SourceType3Type1,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="CombinedSearchCountBodyProfileParamsEverWorkedAtType0NoneOfType0ItemCompanyType0")


@_attrs_define
class CombinedSearchCountBodyProfileParamsEverWorkedAtType0NoneOfType0ItemCompanyType0:
    """
    Attributes:
        li_org_id (str):
        ...
        source (CombinedSearchCountBodyProfileParamsEverWorkedAtType0NoneOfType0ItemCompanyType0SourceType1 |
            CombinedSearchCountBodyProfileParamsEverWorkedAtType0NoneOfType0ItemCompanyType0SourceType2Type1 |
            CombinedSearchCountBodyProfileParamsEverWorkedAtType0NoneOfType0ItemCompanyType0SourceType3Type1 | None |
            Unset):
    """
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.source, Unset):
            ...
            self.source, CombinedSearchCountBodyProfileParamsEverWorkedAtType0NoneOfType0ItemCompanyType0SourceType1
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_source(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                source_type_1 = (
                    CombinedSearchCountBodyProfileParamsEverWorkedAtType0NoneOfType0ItemCompanyType0SourceType1(data)
                )
        ...
        combined_search_count_body_profile_params_ever_worked_at_type_0_none_of_type_0_item_company_type_0 = cls(
            li_org_id=li_org_id,
        ...
        combined_search_count_body_profile_params_ever_worked_at_type_0_none_of_type_0_item_company_type_0.additional_properties = d
        return combined_search_count_body_profile_params_ever_worked_at_type_0_none_of_type_0_item_company_type_0
