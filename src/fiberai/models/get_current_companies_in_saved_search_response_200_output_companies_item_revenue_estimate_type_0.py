...
T = TypeVar("T", bound="GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemRevenueEstimateType0")


@_attrs_define
class GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemRevenueEstimateType0:
    """
    Attributes:
        value_usd (GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemRevenueEstimateType0ValueUsd):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        value_usd = (
            GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemRevenueEstimateType0ValueUsd.from_dict(
                d.pop("value_usd")
            )
        )
        ...
        get_current_companies_in_saved_search_response_200_output_companies_item_revenue_estimate_type_0 = cls(
            value_usd=value_usd,
            sources=sources,
            fiscal_year=fiscal_year,
        )

        get_current_companies_in_saved_search_response_200_output_companies_item_revenue_estimate_type_0.additional_properties = d
        return get_current_companies_in_saved_search_response_200_output_companies_item_revenue_estimate_type_0
