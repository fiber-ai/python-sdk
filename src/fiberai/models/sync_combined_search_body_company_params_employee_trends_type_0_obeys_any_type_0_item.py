...
from ..models.sync_combined_search_body_company_params_employee_trends_type_0_obeys_any_type_0_item_job_function import (
    SyncCombinedSearchBodyCompanyParamsEmployeeTrendsType0ObeysAnyType0ItemJobFunction,
)

if TYPE_CHECKING:
    from ..models.sync_combined_search_body_company_params_employee_trends_type_0_obeys_any_type_0_item_count_criteria_type_0 import (
        SyncCombinedSearchBodyCompanyParamsEmployeeTrendsType0ObeysAnyType0ItemCountCriteriaType0,
    )
    from ..models.sync_combined_search_body_company_params_employee_trends_type_0_obeys_any_type_0_item_count_criteria_type_1 import (
        SyncCombinedSearchBodyCompanyParamsEmployeeTrendsType0ObeysAnyType0ItemCountCriteriaType1,
    )
    from ..models.sync_combined_search_body_company_params_employee_trends_type_0_obeys_any_type_0_item_count_criteria_type_2 import (
...
class SyncCombinedSearchBodyCompanyParamsEmployeeTrendsType0ObeysAnyType0Item:
    ...
    Attributes:
        ...
        count_criteria (SyncCombinedSearchBodyCompanyParamsEmployeeTrendsType0ObeysAnyType0ItemCountCriteriaType0 |
            SyncCombinedSearchBodyCompanyParamsEmployeeTrendsType0ObeysAnyType0ItemCountCriteriaType1 |
            SyncCombinedSearchBodyCompanyParamsEmployeeTrendsType0ObeysAnyType0ItemCountCriteriaType2):
    """
        ...
        def _parse_count_criteria(
            ...
            try:
                ...
                count_criteria_type_0 = (
                    SyncCombinedSearchBodyCompanyParamsEmployeeTrendsType0ObeysAnyType0ItemCountCriteriaType0.from_dict(
                        data
                    )
                )
            ...
            try:
                ...
                count_criteria_type_1 = (
                    SyncCombinedSearchBodyCompanyParamsEmployeeTrendsType0ObeysAnyType0ItemCountCriteriaType1.from_dict(
                        data
                    )
                )
            ...
            count_criteria_type_2 = (
                SyncCombinedSearchBodyCompanyParamsEmployeeTrendsType0ObeysAnyType0ItemCountCriteriaType2.from_dict(
                    data
                )
            )
