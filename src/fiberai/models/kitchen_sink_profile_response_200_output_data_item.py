...
from ..models.kitchen_sink_profile_response_200_output_data_item_tags_type_0_item import (
    KitchenSinkProfileResponse200OutputDataItemTagsType0Item,
)
...
class KitchenSinkProfileResponse200OutputDataItem:
    ...
    Attributes:
        primary_slug (str):
        articles (list[KitchenSinkProfileResponse200OutputDataItemArticlesType0Item] | None | Unset):
        certifications (list[KitchenSinkProfileResponse200OutputDataItemCertificationsType0Item] | None | Unset):
        connection_count (float | None | Unset):
        courses (list[KitchenSinkProfileResponse200OutputDataItemCoursesType0Item] | None | Unset):
        dob (None | str | Unset):
        education (list[KitchenSinkProfileResponse200OutputDataItemEducationType0Item] | None | Unset):
        experiences (list[KitchenSinkProfileResponse200OutputDataItemExperiencesType0Item] | None | Unset):
        first_name (None | str | Unset):
        follower_count (float | None | Unset):
        headline (None | str | Unset):
        industry_name (None | str | Unset):
        inferred_location (KitchenSinkProfileResponse200OutputDataItemInferredLocationType0 | None | Unset):
        interests (list[str] | None | Unset):
        last_name (None | str | Unset):
        locality (None | str | Unset):
        name (None | str | Unset):
        patents (list[KitchenSinkProfileResponse200OutputDataItemPatentsType0Item] | None | Unset):
        profile_pic (None | str | Unset):
        projects (list[KitchenSinkProfileResponse200OutputDataItemProjectsType0Item] | None | Unset):
        publications (list[KitchenSinkProfileResponse200OutputDataItemPublicationsType0Item] | None | Unset):
        skills (list[str] | None | Unset):
        slugs (list[str] | None | Unset):
        summary (None | str | Unset):
        url (None | str | Unset):
        user_id (None | str | Unset):
        volunteering (list[KitchenSinkProfileResponse200OutputDataItemVolunteeringType0Item] | None | Unset):
        tenures (list[KitchenSinkProfileResponse200OutputDataItemTenuresType0Item] | None | Unset):
        career_began_at (None | str | Unset):
        tags (list[KitchenSinkProfileResponse200OutputDataItemTagsType0Item] | None | Unset):
        entity_urn (None | str | Unset):
        open_to_work (bool | None | Unset):
        premium (bool | None | Unset):
        influencer (bool | None | Unset):
        organizations (list[KitchenSinkProfileResponse200OutputDataItemOrganizationsType0Item] | None | Unset):
        entity_urns (list[str] | None | Unset):
        is_hiring (bool | None | Unset):
        websites (list[str] | None | Unset):
        is_verified (bool | None | Unset):
        verifications (KitchenSinkProfileResponse200OutputDataItemVerificationsType0 | None | Unset):
        is_top_voice (bool | None | Unset):
        current_job (KitchenSinkProfileResponse200OutputDataItemCurrentJobType0 | None | Unset):
        custom_data (KitchenSinkProfileResponse200OutputDataItemCustomDataType0 | None | Unset):
        relevance_score (float | None | Unset):
        last_sort_key (None | str | Unset):
        last_updated_at (None | str | Unset):
        languages (list[KitchenSinkProfileResponse200OutputDataItemLanguagesType0Item] | None | Unset):
        detailed_education (list[KitchenSinkProfileResponse200OutputDataItemDetailedEducationType0Item] | None | Unset):
        detailed_work_experiences (list[KitchenSinkProfileResponse200OutputDataItemDetailedWorkExperiencesType0Item] |
            None | Unset):
    """

    primary_slug: str
    articles: list[KitchenSinkProfileResponse200OutputDataItemArticlesType0Item] | None | Unset = UNSET
    certifications: list[KitchenSinkProfileResponse200OutputDataItemCertificationsType0Item] | None | Unset = UNSET
    connection_count: float | None | Unset = UNSET
    courses: list[KitchenSinkProfileResponse200OutputDataItemCoursesType0Item] | None | Unset = UNSET
    dob: None | str | Unset = UNSET
    education: list[KitchenSinkProfileResponse200OutputDataItemEducationType0Item] | None | Unset = UNSET
    experiences: list[KitchenSinkProfileResponse200OutputDataItemExperiencesType0Item] | None | Unset = UNSET
    first_name: None | str | Unset = UNSET
    follower_count: float | None | Unset = UNSET
    headline: None | str | Unset = UNSET
    industry_name: None | str | Unset = UNSET
    inferred_location: KitchenSinkProfileResponse200OutputDataItemInferredLocationType0 | None | Unset = UNSET
    interests: list[str] | None | Unset = UNSET
    last_name: None | str | Unset = UNSET
    locality: None | str | Unset = UNSET
    name: None | str | Unset = UNSET
    patents: list[KitchenSinkProfileResponse200OutputDataItemPatentsType0Item] | None | Unset = UNSET
    profile_pic: None | str | Unset = UNSET
    projects: list[KitchenSinkProfileResponse200OutputDataItemProjectsType0Item] | None | Unset = UNSET
    publications: list[KitchenSinkProfileResponse200OutputDataItemPublicationsType0Item] | None | Unset = UNSET
    skills: list[str] | None | Unset = UNSET
    slugs: list[str] | None | Unset = UNSET
    summary: None | str | Unset = UNSET
    url: None | str | Unset = UNSET
    user_id: None | str | Unset = UNSET
    volunteering: list[KitchenSinkProfileResponse200OutputDataItemVolunteeringType0Item] | None | Unset = UNSET
    tenures: list[KitchenSinkProfileResponse200OutputDataItemTenuresType0Item] | None | Unset = UNSET
    career_began_at: None | str | Unset = UNSET
    tags: list[KitchenSinkProfileResponse200OutputDataItemTagsType0Item] | None | Unset = UNSET
    ...
    organizations: list[KitchenSinkProfileResponse200OutputDataItemOrganizationsType0Item] | None | Unset = UNSET
    ...
    verifications: KitchenSinkProfileResponse200OutputDataItemVerificationsType0 | None | Unset = UNSET
    is_top_voice: bool | None | Unset = UNSET
    current_job: KitchenSinkProfileResponse200OutputDataItemCurrentJobType0 | None | Unset = UNSET
    custom_data: KitchenSinkProfileResponse200OutputDataItemCustomDataType0 | None | Unset = UNSET
    relevance_score: float | None | Unset = UNSET
    last_sort_key: None | str | Unset = UNSET
    last_updated_at: None | str | Unset = UNSET
    languages: list[KitchenSinkProfileResponse200OutputDataItemLanguagesType0Item] | None | Unset = UNSET
    detailed_education: list[KitchenSinkProfileResponse200OutputDataItemDetailedEducationType0Item] | None | Unset = (
        UNSET
    )
    detailed_work_experiences: (
        list[KitchenSinkProfileResponse200OutputDataItemDetailedWorkExperiencesType0Item] | None | Unset
    ) = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.verifications, Unset):
            verifications = UNSET
        elif isinstance(self.verifications, KitchenSinkProfileResponse200OutputDataItemVerificationsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_articles(
            data: object,
        ) -> list[KitchenSinkProfileResponse200OutputDataItemArticlesType0Item] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for articles_type_0_item_data in _articles_type_0:
                    articles_type_0_item = KitchenSinkProfileResponse200OutputDataItemArticlesType0Item.from_dict(
                ...
                pass
            return cast(list[KitchenSinkProfileResponse200OutputDataItemArticlesType0Item] | None | Unset, data)

        articles = _parse_articles(d.pop("articles", UNSET))

        def _parse_certifications(
            data: object,
        ) -> list[KitchenSinkProfileResponse200OutputDataItemCertificationsType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for certifications_type_0_item_data in _certifications_type_0:
                    certifications_type_0_item = (
                        KitchenSinkProfileResponse200OutputDataItemCertificationsType0Item.from_dict(
                ...
                pass
            return cast(list[KitchenSinkProfileResponse200OutputDataItemCertificationsType0Item] | None | Unset, data)
        ...
        def _parse_courses(
            data: object,
        ) -> list[KitchenSinkProfileResponse200OutputDataItemCoursesType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for courses_type_0_item_data in _courses_type_0:
                    courses_type_0_item = KitchenSinkProfileResponse200OutputDataItemCoursesType0Item.from_dict(
                ...
                pass
            return cast(list[KitchenSinkProfileResponse200OutputDataItemCoursesType0Item] | None | Unset, data)
        ...
        def _parse_education(
            data: object,
        ) -> list[KitchenSinkProfileResponse200OutputDataItemEducationType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for education_type_0_item_data in _education_type_0:
                    education_type_0_item = KitchenSinkProfileResponse200OutputDataItemEducationType0Item.from_dict(
                ...
                pass
            return cast(list[KitchenSinkProfileResponse200OutputDataItemEducationType0Item] | None | Unset, data)

        education = _parse_education(d.pop("education", UNSET))

        def _parse_experiences(
            data: object,
        ) -> list[KitchenSinkProfileResponse200OutputDataItemExperiencesType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for experiences_type_0_item_data in _experiences_type_0:
                    experiences_type_0_item = KitchenSinkProfileResponse200OutputDataItemExperiencesType0Item.from_dict(
                ...
                pass
            return cast(list[KitchenSinkProfileResponse200OutputDataItemExperiencesType0Item] | None | Unset, data)
        ...
        def _parse_inferred_location(
            data: object,
        ) -> KitchenSinkProfileResponse200OutputDataItemInferredLocationType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                inferred_location_type_0 = KitchenSinkProfileResponse200OutputDataItemInferredLocationType0.from_dict(
                    data
                )
                ...
                pass
            return cast(KitchenSinkProfileResponse200OutputDataItemInferredLocationType0 | None | Unset, data)
        ...
        def _parse_patents(
            data: object,
        ) -> list[KitchenSinkProfileResponse200OutputDataItemPatentsType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for patents_type_0_item_data in _patents_type_0:
                    patents_type_0_item = KitchenSinkProfileResponse200OutputDataItemPatentsType0Item.from_dict(
                ...
                pass
            return cast(list[KitchenSinkProfileResponse200OutputDataItemPatentsType0Item] | None | Unset, data)
        ...
        def _parse_projects(
            data: object,
        ) -> list[KitchenSinkProfileResponse200OutputDataItemProjectsType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for projects_type_0_item_data in _projects_type_0:
                    projects_type_0_item = KitchenSinkProfileResponse200OutputDataItemProjectsType0Item.from_dict(
                ...
                pass
            return cast(list[KitchenSinkProfileResponse200OutputDataItemProjectsType0Item] | None | Unset, data)

        projects = _parse_projects(d.pop("projects", UNSET))

        def _parse_publications(
            data: object,
        ) -> list[KitchenSinkProfileResponse200OutputDataItemPublicationsType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for publications_type_0_item_data in _publications_type_0:
                    publications_type_0_item = (
                        KitchenSinkProfileResponse200OutputDataItemPublicationsType0Item.from_dict(
                ...
                pass
            return cast(list[KitchenSinkProfileResponse200OutputDataItemPublicationsType0Item] | None | Unset, data)
        ...
        def _parse_volunteering(
            data: object,
        ) -> list[KitchenSinkProfileResponse200OutputDataItemVolunteeringType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for volunteering_type_0_item_data in _volunteering_type_0:
                    volunteering_type_0_item = (
                        KitchenSinkProfileResponse200OutputDataItemVolunteeringType0Item.from_dict(
                ...
                pass
            return cast(list[KitchenSinkProfileResponse200OutputDataItemVolunteeringType0Item] | None | Unset, data)

        volunteering = _parse_volunteering(d.pop("volunteering", UNSET))

        def _parse_tenures(
            data: object,
        ) -> list[KitchenSinkProfileResponse200OutputDataItemTenuresType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for tenures_type_0_item_data in _tenures_type_0:
                    tenures_type_0_item = KitchenSinkProfileResponse200OutputDataItemTenuresType0Item.from_dict(
                ...
                pass
            return cast(list[KitchenSinkProfileResponse200OutputDataItemTenuresType0Item] | None | Unset, data)
        ...
        def _parse_tags(data: object) -> list[KitchenSinkProfileResponse200OutputDataItemTagsType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(list[KitchenSinkProfileResponse200OutputDataItemTagsType0Item] | None | Unset, data)
        ...
        def _parse_organizations(
            data: object,
        ) -> list[KitchenSinkProfileResponse200OutputDataItemOrganizationsType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for organizations_type_0_item_data in _organizations_type_0:
                    organizations_type_0_item = (
                        KitchenSinkProfileResponse200OutputDataItemOrganizationsType0Item.from_dict(
                ...
                pass
            return cast(list[KitchenSinkProfileResponse200OutputDataItemOrganizationsType0Item] | None | Unset, data)
        ...
        def _parse_verifications(
            data: object,
        ) -> KitchenSinkProfileResponse200OutputDataItemVerificationsType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                verifications_type_0 = KitchenSinkProfileResponse200OutputDataItemVerificationsType0.from_dict(data)

                return verifications_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(KitchenSinkProfileResponse200OutputDataItemVerificationsType0 | None | Unset, data)
        ...
        def _parse_current_job(
            data: object,
        ) -> KitchenSinkProfileResponse200OutputDataItemCurrentJobType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(KitchenSinkProfileResponse200OutputDataItemCurrentJobType0 | None | Unset, data)

        current_job = _parse_current_job(d.pop("current_job", UNSET))

        def _parse_custom_data(
            data: object,
        ) -> KitchenSinkProfileResponse200OutputDataItemCustomDataType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(KitchenSinkProfileResponse200OutputDataItemCustomDataType0 | None | Unset, data)
        ...
        def _parse_languages(
            data: object,
        ) -> list[KitchenSinkProfileResponse200OutputDataItemLanguagesType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for languages_type_0_item_data in _languages_type_0:
                    languages_type_0_item = KitchenSinkProfileResponse200OutputDataItemLanguagesType0Item.from_dict(
                ...
                pass
            return cast(list[KitchenSinkProfileResponse200OutputDataItemLanguagesType0Item] | None | Unset, data)

        languages = _parse_languages(d.pop("languages", UNSET))

        def _parse_detailed_education(
            data: object,
        ) -> list[KitchenSinkProfileResponse200OutputDataItemDetailedEducationType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for detailed_education_type_0_item_data in _detailed_education_type_0:
                    detailed_education_type_0_item = (
                        KitchenSinkProfileResponse200OutputDataItemDetailedEducationType0Item.from_dict(
                ...
                pass
            return cast(
                list[KitchenSinkProfileResponse200OutputDataItemDetailedEducationType0Item] | None | Unset, data
            )
            ...
            try:
                ...
                for detailed_work_experiences_type_0_item_data in _detailed_work_experiences_type_0:
                    detailed_work_experiences_type_0_item = (
                        KitchenSinkProfileResponse200OutputDataItemDetailedWorkExperiencesType0Item.from_dict(
                ...
                pass
            return cast(
                list[KitchenSinkProfileResponse200OutputDataItemDetailedWorkExperiencesType0Item] | None | Unset, data
            )
