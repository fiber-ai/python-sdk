...
T = TypeVar("T", bound="GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyFullFundingRoundsType0ItemInvestorsType0Item")



@_attrs_define
class GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyFullFundingRoundsType0ItemInvestorsType0Item:
    """ 
        Attributes:
            is_lead (Union[None, Unset, bool]):
            ...
            investor_linkedin_url (Union[None, Unset, str]):
            investor_linkedin_org_id (Union[None, Unset, str]):
     """

    is_lead: Union[None, Unset, bool] = UNSET
    ...
    investor_linkedin_url: Union[None, Unset, str] = UNSET
    investor_linkedin_org_id: Union[None, Unset, str] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        def _parse_is_lead(data: object) -> Union[None, Unset, bool]:
            if data is None:
                return data
        ...
        def _parse_investor_linkedin_url(data: object) -> Union[None, Unset, str]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_investor_linkedin_org_id(data: object) -> Union[None, Unset, str]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        get_saved_search_run_companies_response_200_output_companies_item_company_full_funding_rounds_type_0_item_investors_type_0_item = cls(
            is_lead=is_lead,
        ...
        get_saved_search_run_companies_response_200_output_companies_item_company_full_funding_rounds_type_0_item_investors_type_0_item.additional_properties = d
        return get_saved_search_run_companies_response_200_output_companies_item_company_full_funding_rounds_type_0_item_investors_type_0_item
