...
if TYPE_CHECKING:
    ...
    from ..models.undo_skip_next_saved_search_run_response_200_output import UndoSkipNextSavedSearchRunResponse200Output
...
T = TypeVar("T", bound="UndoSkipNextSavedSearchRunResponse200")


@_attrs_define
class UndoSkipNextSavedSearchRunResponse200:
    """
    Attributes:
        output (UndoSkipNextSavedSearchRunResponse200Output):
        charge_info (UndoSkipNextSavedSearchRunResponse200ChargeInfoType0 |
            UndoSkipNextSavedSearchRunResponse200ChargeInfoType1 | UndoSkipNextSavedSearchRunResponse200ChargeInfoType2 |
            UndoSkipNextSavedSearchRunResponse200ChargeInfoType3 | UndoSkipNextSavedSearchRunResponse200ChargeInfoType4):
        warnings (list[UndoSkipNextSavedSearchRunResponse200WarningsType0Item] | None | Unset): Warnings about
    ...
    warnings: list[UndoSkipNextSavedSearchRunResponse200WarningsType0Item] | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.charge_info, UndoSkipNextSavedSearchRunResponse200ChargeInfoType0):
            charge_info = self.charge_info.to_dict()
        elif isinstance(self.charge_info, UndoSkipNextSavedSearchRunResponse200ChargeInfoType1):
            charge_info = self.charge_info.to_dict()
        elif isinstance(self.charge_info, UndoSkipNextSavedSearchRunResponse200ChargeInfoType2):
            charge_info = self.charge_info.to_dict()
        elif isinstance(self.charge_info, UndoSkipNextSavedSearchRunResponse200ChargeInfoType3):
            charge_info = self.charge_info.to_dict()
        else:
            charge_info = self.charge_info.to_dict()
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        output = UndoSkipNextSavedSearchRunResponse200Output.from_dict(d.pop("output"))
        ...
        def _parse_charge_info(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_0 = UndoSkipNextSavedSearchRunResponse200ChargeInfoType0.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_1 = UndoSkipNextSavedSearchRunResponse200ChargeInfoType1.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_2 = UndoSkipNextSavedSearchRunResponse200ChargeInfoType2.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_3 = UndoSkipNextSavedSearchRunResponse200ChargeInfoType3.from_dict(data)
            ...
            if not isinstance(data, dict):
                raise TypeError()
            charge_info_type_4 = UndoSkipNextSavedSearchRunResponse200ChargeInfoType4.from_dict(data)
        ...
        def _parse_warnings(
            data: object,
        ) -> list[UndoSkipNextSavedSearchRunResponse200WarningsType0Item] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for warnings_type_0_item_data in _warnings_type_0:
                    warnings_type_0_item = UndoSkipNextSavedSearchRunResponse200WarningsType0Item.from_dict(
                ...
                pass
            return cast(list[UndoSkipNextSavedSearchRunResponse200WarningsType0Item] | None | Unset, data)
        ...
        undo_skip_next_saved_search_run_response_200 = cls(
            output=output,
        ...
        return undo_skip_next_saved_search_run_response_200
