...
T = TypeVar("T", bound="RemoveTrackerCompaniesResponse200Output")
...
class RemoveTrackerCompaniesResponse200Output:
    ...
    removed: int
    not_found: int
    failed_identifiers: list[RemoveTrackerCompaniesResponse200OutputFailedIdentifiersItem]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for failed_identifiers_item_data in _failed_identifiers:
            failed_identifiers_item = RemoveTrackerCompaniesResponse200OutputFailedIdentifiersItem.from_dict(
                failed_identifiers_item_data
            )

            failed_identifiers.append(failed_identifiers_item)

        remove_tracker_companies_response_200_output = cls(
            removed=removed,
            not_found=not_found,
            failed_identifiers=failed_identifiers,
        )

        remove_tracker_companies_response_200_output.additional_properties = d
        return remove_tracker_companies_response_200_output
