...
if TYPE_CHECKING:
    from ..models.get_saved_search_run_companies_response_200_output_companies_item_company_investment_stats_type_0_investments_by_stage_type_0_item import (
        GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyInvestmentStatsType0InvestmentsByStageType0Item,
    )
...
class GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyInvestmentStatsType0:
    """
    Attributes:
        investments_by_stage (list[GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyInvestmentStatsType0In
            vestmentsByStageType0Item] | None | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.get_saved_search_run_companies_response_200_output_companies_item_company_investment_stats_type_0_investments_by_stage_type_0_item import (
            GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyInvestmentStatsType0InvestmentsByStageType0Item,  # noqa: PLC0415
        )
        ...
        def _parse_investments_by_stage(
            ...
            try:
                ...
                for investments_by_stage_type_0_item_data in _investments_by_stage_type_0:
                    investments_by_stage_type_0_item = GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyInvestmentStatsType0InvestmentsByStageType0Item.from_dict(
