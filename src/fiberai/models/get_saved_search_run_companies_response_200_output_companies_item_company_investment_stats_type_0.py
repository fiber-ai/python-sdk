...
if TYPE_CHECKING:
  from ..models.get_saved_search_run_companies_response_200_output_companies_item_company_investment_stats_type_0_investments_by_stage_type_0_item import GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyInvestmentStatsType0InvestmentsByStageType0Item





T = TypeVar("T", bound="GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyInvestmentStatsType0")



@_attrs_define
class GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyInvestmentStatsType0:
    """ 
        Attributes:
            investments_by_stage (Union[None, Unset, list['GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyIn
                vestmentStatsType0InvestmentsByStageType0Item']]):
    ...
    investments_by_stage: Union[None, Unset, list['GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyInvestmentStatsType0InvestmentsByStageType0Item']] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.get_saved_search_run_companies_response_200_output_companies_item_company_investment_stats_type_0_investments_by_stage_type_0_item import GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyInvestmentStatsType0InvestmentsByStageType0Item
        d = dict(src_dict)
        def _parse_investments_by_stage(data: object) -> Union[None, Unset, list['GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyInvestmentStatsType0InvestmentsByStageType0Item']]:
            if data is None:
                return data
            ...
            try:
                ...
                for investments_by_stage_type_0_item_data in (_investments_by_stage_type_0):
                    investments_by_stage_type_0_item = GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyInvestmentStatsType0InvestmentsByStageType0Item.from_dict(investments_by_stage_type_0_item_data)
                ...
                pass
            return cast(Union[None, Unset, list['GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyInvestmentStatsType0InvestmentsByStageType0Item']], data)
        ...
        get_saved_search_run_companies_response_200_output_companies_item_company_investment_stats_type_0 = cls(
        ...
        get_saved_search_run_companies_response_200_output_companies_item_company_investment_stats_type_0.additional_properties = d
        return get_saved_search_run_companies_response_200_output_companies_item_company_investment_stats_type_0
