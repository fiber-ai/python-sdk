...
if TYPE_CHECKING:
    from ..models.kitchen_sink_company_response_200_output_data_item_location_consensus_type_0_coordinates_type_0 import (
        KitchenSinkCompanyResponse200OutputDataItemLocationConsensusType0CoordinatesType0,
    )
...
class KitchenSinkCompanyResponse200OutputDataItemLocationConsensusType0:
    ...
    Attributes:
        ...
        coordinates (KitchenSinkCompanyResponse200OutputDataItemLocationConsensusType0CoordinatesType0 | None | Unset):
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.kitchen_sink_company_response_200_output_data_item_location_consensus_type_0_coordinates_type_0 import (
            KitchenSinkCompanyResponse200OutputDataItemLocationConsensusType0CoordinatesType0,  # noqa: PLC0415
        )
        ...
        if isinstance(self.coordinates, Unset):
            ...
            self.coordinates, KitchenSinkCompanyResponse200OutputDataItemLocationConsensusType0CoordinatesType0
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_coordinates(
            data: object,
        ) -> KitchenSinkCompanyResponse200OutputDataItemLocationConsensusType0CoordinatesType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = (
                    KitchenSinkCompanyResponse200OutputDataItemLocationConsensusType0CoordinatesType0.from_dict(data)
                )
                ...
                pass
            return cast(
                KitchenSinkCompanyResponse200OutputDataItemLocationConsensusType0CoordinatesType0 | None | Unset, data
            )
