...
T = TypeVar("T", bound="ReverseEmailLookupResponse200OutputDataItemVolunteeringType0Item")


@_attrs_define
class ReverseEmailLookupResponse200OutputDataItemVolunteeringType0Item:
    """
    Attributes:
        role (None | str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reverse_email_lookup_response_200_output_data_item_volunteering_type_0_item = cls(
            role=role,
        ...
        reverse_email_lookup_response_200_output_data_item_volunteering_type_0_item.additional_properties = d
        return reverse_email_lookup_response_200_output_data_item_volunteering_type_0_item
