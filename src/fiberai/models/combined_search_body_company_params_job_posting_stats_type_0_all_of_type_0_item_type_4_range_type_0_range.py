...
T = TypeVar("T", bound="CombinedSearchBodyCompanyParamsJobPostingStatsType0AllOfType0ItemType4RangeType0Range")



@_attrs_define
class CombinedSearchBodyCompanyParamsJobPostingStatsType0AllOfType0ItemType4RangeType0Range:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        combined_search_body_company_params_job_posting_stats_type_0_all_of_type_0_item_type_4_range_type_0_range = cls(
            lower_bound=lower_bound,
            upper_bound=upper_bound,
        )


        combined_search_body_company_params_job_posting_stats_type_0_all_of_type_0_item_type_4_range_type_0_range.additional_properties = d
        return combined_search_body_company_params_job_posting_stats_type_0_all_of_type_0_item_type_4_range_type_0_range
