...
T = TypeVar("T", bound="PeopleSearchCountBodySearchParamsEducationV2Type0AnyOfType0ItemYearsType0")


@_attrs_define
class PeopleSearchCountBodySearchParamsEducationV2Type0AnyOfType0ItemYearsType0:
    """
    Attributes:
        started_school_at (None |
            PeopleSearchCountBodySearchParamsEducationV2Type0AnyOfType0ItemYearsType0StartedSchoolAtType0 |
            PeopleSearchCountBodySearchParamsEducationV2Type0AnyOfType0ItemYearsType0StartedSchoolAtType1 | Unset):
        finished_school_at (None |
            PeopleSearchCountBodySearchParamsEducationV2Type0AnyOfType0ItemYearsType0FinishedSchoolAtType0 |
            PeopleSearchCountBodySearchParamsEducationV2Type0AnyOfType0ItemYearsType0FinishedSchoolAtType1 | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_started_school_at(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                started_school_at_type_0 = PeopleSearchCountBodySearchParamsEducationV2Type0AnyOfType0ItemYearsType0StartedSchoolAtType0.from_dict(
                    data
                )
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                started_school_at_type_1 = PeopleSearchCountBodySearchParamsEducationV2Type0AnyOfType0ItemYearsType0StartedSchoolAtType1.from_dict(
                    data
                )
        ...
        def _parse_finished_school_at(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                finished_school_at_type_0 = PeopleSearchCountBodySearchParamsEducationV2Type0AnyOfType0ItemYearsType0FinishedSchoolAtType0.from_dict(
                    data
                )
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                finished_school_at_type_1 = PeopleSearchCountBodySearchParamsEducationV2Type0AnyOfType0ItemYearsType0FinishedSchoolAtType1.from_dict(
                    data
                )
        ...
        people_search_count_body_search_params_education_v2_type_0_any_of_type_0_item_years_type_0 = cls(
            started_school_at=started_school_at,
            finished_school_at=finished_school_at,
            is_currently_student=is_currently_student,
        )

        people_search_count_body_search_params_education_v2_type_0_any_of_type_0_item_years_type_0.additional_properties = d
        return people_search_count_body_search_params_education_v2_type_0_any_of_type_0_item_years_type_0
