...
class DomainLookupPollingResponse200:
    ...
    Attributes:
        ...
        charge_info (DomainLookupPollingResponse200ChargeInfoType0 | DomainLookupPollingResponse200ChargeInfoType1 |
            DomainLookupPollingResponse200ChargeInfoType2 | DomainLookupPollingResponse200ChargeInfoType3 |
            DomainLookupPollingResponse200ChargeInfoType4):
        advice (list[str]): Tips, recommendations, and suggestions for using this API effectively.
        warnings (list[DomainLookupPollingResponse200WarningsType0Item] | None | Unset): Warnings about extraneous
            fields in request
    """
    ...
    advice: list[str]
    warnings: list[DomainLookupPollingResponse200WarningsType0Item] | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.charge_info, DomainLookupPollingResponse200ChargeInfoType0):
            ...
            charge_info = self.charge_info.to_dict()
        elif isinstance(self.charge_info, DomainLookupPollingResponse200ChargeInfoType3):
            charge_info = self.charge_info.to_dict()
        else:
            charge_info = self.charge_info.to_dict()
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_charge_info(
            ...
            if not isinstance(data, dict):
                raise TypeError()
            charge_info_type_4 = DomainLookupPollingResponse200ChargeInfoType4.from_dict(data)
        ...
        def _parse_warnings(data: object) -> list[DomainLookupPollingResponse200WarningsType0Item] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for warnings_type_0_item_data in _warnings_type_0:
                    warnings_type_0_item = DomainLookupPollingResponse200WarningsType0Item.from_dict(
                ...
                pass
            return cast(list[DomainLookupPollingResponse200WarningsType0Item] | None | Unset, data)
