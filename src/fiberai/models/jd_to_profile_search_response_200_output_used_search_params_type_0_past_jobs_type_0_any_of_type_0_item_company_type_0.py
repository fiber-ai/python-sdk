...
from ..models.jd_to_profile_search_response_200_output_used_search_params_type_0_past_jobs_type_0_any_of_type_0_item_company_type_0_source_type_1 import (
    JdToProfileSearchResponse200OutputUsedSearchParamsType0PastJobsType0AnyOfType0ItemCompanyType0SourceType1,
)
from ..models.jd_to_profile_search_response_200_output_used_search_params_type_0_past_jobs_type_0_any_of_type_0_item_company_type_0_source_type_2_type_1 import (
    JdToProfileSearchResponse200OutputUsedSearchParamsType0PastJobsType0AnyOfType0ItemCompanyType0SourceType2Type1,
)
from ..models.jd_to_profile_search_response_200_output_used_search_params_type_0_past_jobs_type_0_any_of_type_0_item_company_type_0_source_type_3_type_1 import (
    JdToProfileSearchResponse200OutputUsedSearchParamsType0PastJobsType0AnyOfType0ItemCompanyType0SourceType3Type1,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="JdToProfileSearchResponse200OutputUsedSearchParamsType0PastJobsType0AnyOfType0ItemCompanyType0")


@_attrs_define
class JdToProfileSearchResponse200OutputUsedSearchParamsType0PastJobsType0AnyOfType0ItemCompanyType0:
    """
    Attributes:
        li_org_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_source(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                source_type_1 = JdToProfileSearchResponse200OutputUsedSearchParamsType0PastJobsType0AnyOfType0ItemCompanyType0SourceType1(
                    data
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                source_type_2_type_1 = JdToProfileSearchResponse200OutputUsedSearchParamsType0PastJobsType0AnyOfType0ItemCompanyType0SourceType2Type1(
                    data
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                source_type_3_type_1 = JdToProfileSearchResponse200OutputUsedSearchParamsType0PastJobsType0AnyOfType0ItemCompanyType0SourceType3Type1(
                    data
                )
        ...
        jd_to_profile_search_response_200_output_used_search_params_type_0_past_jobs_type_0_any_of_type_0_item_company_type_0 = cls(
            li_org_id=li_org_id,
        ...
        jd_to_profile_search_response_200_output_used_search_params_type_0_past_jobs_type_0_any_of_type_0_item_company_type_0.additional_properties = d
        return jd_to_profile_search_response_200_output_used_search_params_type_0_past_jobs_type_0_any_of_type_0_item_company_type_0
