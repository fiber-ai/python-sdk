...
from ..models.text_to_combined_search_response_200_output_company_search_params_type_0_office_locations_v2_type_0_none_of_type_0_item_type_2_location_type_0_radius_type_0_unit import TextToCombinedSearchResponse200OutputCompanySearchParamsType0OfficeLocationsV2Type0NoneOfType0ItemType2LocationType0RadiusType0Unit
...
T = TypeVar("T", bound="TextToCombinedSearchResponse200OutputCompanySearchParamsType0OfficeLocationsV2Type0NoneOfType0ItemType2LocationType0RadiusType0")
...
class TextToCombinedSearchResponse200OutputCompanySearchParamsType0OfficeLocationsV2Type0NoneOfType0ItemType2LocationType0RadiusType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        unit = TextToCombinedSearchResponse200OutputCompanySearchParamsType0OfficeLocationsV2Type0NoneOfType0ItemType2LocationType0RadiusType0Unit(d.pop("unit"))
