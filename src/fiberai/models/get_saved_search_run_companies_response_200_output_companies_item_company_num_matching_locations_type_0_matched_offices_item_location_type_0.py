...
if TYPE_CHECKING:
  from ..models.get_saved_search_run_companies_response_200_output_companies_item_company_num_matching_locations_type_0_matched_offices_item_location_type_0_coordinates_type_0 import GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyNumMatchingLocationsType0MatchedOfficesItemLocationType0CoordinatesType0





T = TypeVar("T", bound="GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyNumMatchingLocationsType0MatchedOfficesItemLocationType0")



@_attrs_define
class GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyNumMatchingLocationsType0MatchedOfficesItemLocationType0:
    """ 
        Attributes:
            ...
            coordinates (Union['GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyNumMatchingLocationsType0Matc
                hedOfficesItemLocationType0CoordinatesType0', None, Unset]):
    ...
    coordinates: Union['GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyNumMatchingLocationsType0MatchedOfficesItemLocationType0CoordinatesType0', None, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.coordinates, Unset):
            coordinates = UNSET
        elif isinstance(self.coordinates, GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyNumMatchingLocationsType0MatchedOfficesItemLocationType0CoordinatesType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_coordinates(data: object) -> Union['GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyNumMatchingLocationsType0MatchedOfficesItemLocationType0CoordinatesType0', None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyNumMatchingLocationsType0MatchedOfficesItemLocationType0CoordinatesType0.from_dict(data)
                ...
                pass
            return cast(Union['GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyNumMatchingLocationsType0MatchedOfficesItemLocationType0CoordinatesType0', None, Unset], data)
        ...
        get_saved_search_run_companies_response_200_output_companies_item_company_num_matching_locations_type_0_matched_offices_item_location_type_0 = cls(
        ...
        get_saved_search_run_companies_response_200_output_companies_item_company_num_matching_locations_type_0_matched_offices_item_location_type_0.additional_properties = d
        return get_saved_search_run_companies_response_200_output_companies_item_company_num_matching_locations_type_0_matched_offices_item_location_type_0
