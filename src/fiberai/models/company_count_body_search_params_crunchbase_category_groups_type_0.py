...
class CompanyCountBodySearchParamsCrunchbaseCategoryGroupsType0:
    """
    Attributes:
        any_of (list[CompanyCountBodySearchParamsCrunchbaseCategoryGroupsType0AnyOfType0Item] | None | Unset):
        all_of (list[CompanyCountBodySearchParamsCrunchbaseCategoryGroupsType0AllOfType0Item] | None | Unset):
        none_of (list[CompanyCountBodySearchParamsCrunchbaseCategoryGroupsType0NoneOfType0Item] | None | Unset):
    """

    any_of: list[CompanyCountBodySearchParamsCrunchbaseCategoryGroupsType0AnyOfType0Item] | None | Unset = UNSET
    all_of: list[CompanyCountBodySearchParamsCrunchbaseCategoryGroupsType0AllOfType0Item] | None | Unset = UNSET
    none_of: list[CompanyCountBodySearchParamsCrunchbaseCategoryGroupsType0NoneOfType0Item] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_any_of(
            data: object,
        ) -> list[CompanyCountBodySearchParamsCrunchbaseCategoryGroupsType0AnyOfType0Item] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for any_of_type_0_item_data in _any_of_type_0:
                    any_of_type_0_item = (
                        CompanyCountBodySearchParamsCrunchbaseCategoryGroupsType0AnyOfType0Item.from_dict(
                ...
                pass
            return cast(
                list[CompanyCountBodySearchParamsCrunchbaseCategoryGroupsType0AnyOfType0Item] | None | Unset, data
            )
        ...
        def _parse_all_of(
            data: object,
        ) -> list[CompanyCountBodySearchParamsCrunchbaseCategoryGroupsType0AllOfType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for all_of_type_0_item_data in _all_of_type_0:
                    all_of_type_0_item = (
                        CompanyCountBodySearchParamsCrunchbaseCategoryGroupsType0AllOfType0Item.from_dict(
                ...
                pass
            return cast(
                list[CompanyCountBodySearchParamsCrunchbaseCategoryGroupsType0AllOfType0Item] | None | Unset, data
            )
        ...
        def _parse_none_of(
            data: object,
        ) -> list[CompanyCountBodySearchParamsCrunchbaseCategoryGroupsType0NoneOfType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for none_of_type_0_item_data in _none_of_type_0:
                    none_of_type_0_item = (
                        CompanyCountBodySearchParamsCrunchbaseCategoryGroupsType0NoneOfType0Item.from_dict(
                ...
                pass
            return cast(
                list[CompanyCountBodySearchParamsCrunchbaseCategoryGroupsType0NoneOfType0Item] | None | Unset, data
            )
