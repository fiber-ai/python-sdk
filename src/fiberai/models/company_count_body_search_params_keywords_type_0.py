...
T = TypeVar("T", bound="CompanyCountBodySearchParamsKeywordsType0")


@_attrs_define
class CompanyCountBodySearchParamsKeywordsType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        company_count_body_search_params_keywords_type_0 = cls(
            contains_all=contains_all,
            contains_any=contains_any,
            contains_none=contains_none,
        )

        company_count_body_search_params_keywords_type_0.additional_properties = d
        return company_count_body_search_params_keywords_type_0
