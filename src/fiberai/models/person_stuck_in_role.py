...
T = TypeVar("T", bound="PersonStuckInRole")


@_attrs_define
class PersonStuckInRole:
    """
    Attributes:
        type_ (Literal['person_stuck_in_role']):
        entity_type (Literal['person']):
        threshold_months (int): Alert when the person has been in their current role for at least this many months
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        type_ = cast(Literal["person_stuck_in_role"], d.pop("type"))
        if type_ != "person_stuck_in_role":
            raise ValueError(f"type must match const 'person_stuck_in_role', got '{type_}'")
        ...
        person_stuck_in_role.additional_properties = d
        return person_stuck_in_role
