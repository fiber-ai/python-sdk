...
T = TypeVar("T", bound="CompanySearchBodySearchParamsLinkedinIndustriesType0")


@_attrs_define
class CompanySearchBodySearchParamsLinkedinIndustriesType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        company_search_body_search_params_linkedin_industries_type_0 = cls(
            any_of=any_of,
            none_of=none_of,
        )

        company_search_body_search_params_linkedin_industries_type_0.additional_properties = d
        return company_search_body_search_params_linkedin_industries_type_0
