...
T = TypeVar("T", bound="PostSearchByKeywordsResponse200OutputPostsItemVideoType0")


@_attrs_define
class PostSearchByKeywordsResponse200OutputPostsItemVideoType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_search_by_keywords_response_200_output_posts_item_video_type_0 = cls(
            video_url=video_url,
            thumbnail_url=thumbnail_url,
        )

        post_search_by_keywords_response_200_output_posts_item_video_type_0.additional_properties = d
        return post_search_by_keywords_response_200_output_posts_item_video_type_0
