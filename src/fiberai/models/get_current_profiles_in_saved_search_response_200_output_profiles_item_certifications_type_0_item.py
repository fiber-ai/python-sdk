...
T = TypeVar("T", bound="GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemCertificationsType0Item")



@_attrs_define
class GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemCertificationsType0Item:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_current_profiles_in_saved_search_response_200_output_profiles_item_certifications_type_0_item = cls(
            title=title,
        ...
        get_current_profiles_in_saved_search_response_200_output_profiles_item_certifications_type_0_item.additional_properties = d
        return get_current_profiles_in_saved_search_response_200_output_profiles_item_certifications_type_0_item
