...
T = TypeVar("T", bound="SyncCombinedSearchResponse200OutputCompaniesItemPlatformsType0")


@_attrs_define
class SyncCombinedSearchResponse200OutputCompaniesItemPlatformsType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sync_combined_search_response_200_output_companies_item_platforms_type_0 = cls(
            ecommerce=ecommerce,
            cms=cms,
            crm=crm,
            marketing=marketing,
        ...
        sync_combined_search_response_200_output_companies_item_platforms_type_0.additional_properties = d
        return sync_combined_search_response_200_output_companies_item_platforms_type_0
