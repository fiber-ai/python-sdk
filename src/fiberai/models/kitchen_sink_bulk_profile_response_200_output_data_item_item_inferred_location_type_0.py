...
class KitchenSinkBulkProfileResponse200OutputDataItemItemInferredLocationType0:
    ...
    Attributes:
        ...
        coordinates (KitchenSinkBulkProfileResponse200OutputDataItemItemInferredLocationType0CoordinatesType0 | None |
            Unset):
    ...
    coordinates: (
        KitchenSinkBulkProfileResponse200OutputDataItemItemInferredLocationType0CoordinatesType0 | None | Unset
    ) = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.coordinates, Unset):
            ...
            self.coordinates, KitchenSinkBulkProfileResponse200OutputDataItemItemInferredLocationType0CoordinatesType0
        ):
        ...
        def _parse_coordinates(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = (
                    KitchenSinkBulkProfileResponse200OutputDataItemItemInferredLocationType0CoordinatesType0.from_dict(
                        data
                    )
                )
