...
T = TypeVar("T", bound="ReversePhoneLookupResponse200OutputResultsItemType0ProfileCertificationsType0Item")


@_attrs_define
class ReversePhoneLookupResponse200OutputResultsItemType0ProfileCertificationsType0Item:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reverse_phone_lookup_response_200_output_results_item_type_0_profile_certifications_type_0_item = cls(
            title=title,
        ...
        reverse_phone_lookup_response_200_output_results_item_type_0_profile_certifications_type_0_item.additional_properties = d
        return reverse_phone_lookup_response_200_output_results_item_type_0_profile_certifications_type_0_item
