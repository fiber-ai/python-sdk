...
T = TypeVar("T", bound="InstagramPostCommentsResponse200Output")


@_attrs_define
class InstagramPostCommentsResponse200Output:
    """
    Attributes:
        comments (list[InstagramPostCommentsResponse200OutputCommentsItem]): List of comments for this page.
    ...
    comments: list[InstagramPostCommentsResponse200OutputCommentsItem]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for comments_item_data in _comments:
            comments_item = InstagramPostCommentsResponse200OutputCommentsItem.from_dict(comments_item_data)
        ...
        instagram_post_comments_response_200_output = cls(
            comments=comments,
            next_page_token=next_page_token,
        )

        instagram_post_comments_response_200_output.additional_properties = d
        return instagram_post_comments_response_200_output
