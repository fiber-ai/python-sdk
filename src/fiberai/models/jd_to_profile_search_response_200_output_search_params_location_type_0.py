...
class JdToProfileSearchResponse200OutputSearchParamsLocationType0:
    """
    Attributes:
        union_all (list[JdToProfileSearchResponse200OutputSearchParamsLocationType0UnionAllType0ItemType0] | None |
            Unset):
        subtract_all (list[JdToProfileSearchResponse200OutputSearchParamsLocationType0SubtractAllType0ItemType0] | None
            | Unset):
    """

    union_all: (
        list[JdToProfileSearchResponse200OutputSearchParamsLocationType0UnionAllType0ItemType0] | None | Unset
    ) = UNSET
    subtract_all: (
        list[JdToProfileSearchResponse200OutputSearchParamsLocationType0SubtractAllType0ItemType0] | None | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
                ...
                for union_all_type_0_item_data in _union_all_type_0:
                    ...
                    def _parse_union_all_type_0_item(
                        ...
                        union_all_type_0_item_type_0 = (
                            JdToProfileSearchResponse200OutputSearchParamsLocationType0UnionAllType0ItemType0.from_dict(
                                data
                            )
                        )
        ...
        def _parse_subtract_all(
            ...
            try:
                ...
                pass
            return cast(
                list[JdToProfileSearchResponse200OutputSearchParamsLocationType0SubtractAllType0ItemType0]
                | None
                | Unset,
                data,
            )
