...
if TYPE_CHECKING:
  from ..models.create_saved_search_body_search_params_type_0_profile_search_params_time_zone_type_0_any_of_item import CreateSavedSearchBodySearchParamsType0ProfileSearchParamsTimeZoneType0AnyOfItem
...
class CreateSavedSearchBodySearchParamsType0ProfileSearchParamsTimeZoneType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for any_of_item_data in (_any_of):
            any_of_item = CreateSavedSearchBodySearchParamsType0ProfileSearchParamsTimeZoneType0AnyOfItem.from_dict(any_of_item_data)
