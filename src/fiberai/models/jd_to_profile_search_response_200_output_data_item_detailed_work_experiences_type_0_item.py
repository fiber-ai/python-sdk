...
from ..models.jd_to_profile_search_response_200_output_data_item_detailed_work_experiences_type_0_item_academic_qualification_type_0_item import (
    JdToProfileSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemAcademicQualificationType0Item,
)
from ..models.jd_to_profile_search_response_200_output_data_item_detailed_work_experiences_type_0_item_employment_type_type_0_item import (
    JdToProfileSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemEmploymentTypeType0Item,
)
from ..models.jd_to_profile_search_response_200_output_data_item_detailed_work_experiences_type_0_item_job_function_type_0_item import (
    JdToProfileSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemJobFunctionType0Item,
)
from ..models.jd_to_profile_search_response_200_output_data_item_detailed_work_experiences_type_0_item_seniority_type_1 import (
    JdToProfileSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemSeniorityType1,
)
from ..models.jd_to_profile_search_response_200_output_data_item_detailed_work_experiences_type_0_item_seniority_type_2_type_1 import (
    JdToProfileSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemSeniorityType2Type1,
)
from ..models.jd_to_profile_search_response_200_output_data_item_detailed_work_experiences_type_0_item_seniority_type_3_type_1 import (
    JdToProfileSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemSeniorityType3Type1,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.jd_to_profile_search_response_200_output_data_item_detailed_work_experiences_type_0_item_company_details_type_0 import (
        JdToProfileSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemCompanyDetailsType0,
    )


T = TypeVar("T", bound="JdToProfileSearchResponse200OutputDataItemDetailedWorkExperiencesType0Item")


@_attrs_define
class JdToProfileSearchResponse200OutputDataItemDetailedWorkExperiencesType0Item:
    """
    Attributes:
        company_details (JdToProfileSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemCompanyDetailsType0 |
            None | Unset):
        ...
        seniority (JdToProfileSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemSeniorityType1 |
            JdToProfileSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemSeniorityType2Type1 |
            JdToProfileSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemSeniorityType3Type1 | None | Unset):
        job_function
            (list[JdToProfileSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemJobFunctionType0Item] | None |
            Unset):
        employment_type
            (list[JdToProfileSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemEmploymentTypeType0Item] | None
            | Unset):
        academic_qualification
            (list[JdToProfileSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemAcademicQualificationType0Item]
            | None | Unset):
    ...
    company_details: (
        JdToProfileSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemCompanyDetailsType0 | None | Unset
    ) = UNSET
    ...
    job_function: (
        list[JdToProfileSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemJobFunctionType0Item]
        | None
        | Unset
    ) = UNSET
    employment_type: (
        list[JdToProfileSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemEmploymentTypeType0Item]
        | None
        | Unset
    ) = UNSET
    academic_qualification: (
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.seniority, Unset):
            ...
            self.seniority, JdToProfileSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemSeniorityType1
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_company_details(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                company_details_type_0 = JdToProfileSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemCompanyDetailsType0.from_dict(
                    data
                )
        ...
        def _parse_seniority(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                seniority_type_1 = (
                    JdToProfileSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemSeniorityType1(data)
                )
            ...
            try:
                ...
                seniority_type_2_type_1 = (
                    JdToProfileSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemSeniorityType2Type1(data)
                )
            ...
            try:
                ...
                seniority_type_3_type_1 = (
                    JdToProfileSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemSeniorityType3Type1(data)
                )
        ...
        def _parse_employment_type(
            ...
            try:
                ...
                for employment_type_type_0_item_data in _employment_type_type_0:
                    employment_type_type_0_item = JdToProfileSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemEmploymentTypeType0Item(
        ...
        def _parse_academic_qualification(
            ...
            try:
                ...
                for academic_qualification_type_0_item_data in _academic_qualification_type_0:
                    academic_qualification_type_0_item = JdToProfileSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemAcademicQualificationType0Item(
        ...
        jd_to_profile_search_response_200_output_data_item_detailed_work_experiences_type_0_item = cls(
        ...
        jd_to_profile_search_response_200_output_data_item_detailed_work_experiences_type_0_item.additional_properties = d
        return jd_to_profile_search_response_200_output_data_item_detailed_work_experiences_type_0_item
