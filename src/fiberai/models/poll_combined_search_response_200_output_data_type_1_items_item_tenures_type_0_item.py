...
if TYPE_CHECKING:
    from ..models.poll_combined_search_response_200_output_data_type_1_items_item_tenures_type_0_item_date_range import (
        PollCombinedSearchResponse200OutputDataType1ItemsItemTenuresType0ItemDateRange,
    )
...
class PollCombinedSearchResponse200OutputDataType1ItemsItemTenuresType0Item:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        date_range = PollCombinedSearchResponse200OutputDataType1ItemsItemTenuresType0ItemDateRange.from_dict(
            d.pop("date_range")
        )
