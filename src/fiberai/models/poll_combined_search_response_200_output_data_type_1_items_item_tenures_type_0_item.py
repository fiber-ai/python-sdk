...
if TYPE_CHECKING:
  from ..models.poll_combined_search_response_200_output_data_type_1_items_item_tenures_type_0_item_date_range import PollCombinedSearchResponse200OutputDataType1ItemsItemTenuresType0ItemDateRange





T = TypeVar("T", bound="PollCombinedSearchResponse200OutputDataType1ItemsItemTenuresType0Item")



@_attrs_define
class PollCombinedSearchResponse200OutputDataType1ItemsItemTenuresType0Item:
    """ 
        Attributes:
            date_range (PollCombinedSearchResponse200OutputDataType1ItemsItemTenuresType0ItemDateRange):
            titles (list[str]):
            localities (list[str]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.poll_combined_search_response_200_output_data_type_1_items_item_tenures_type_0_item_date_range import PollCombinedSearchResponse200OutputDataType1ItemsItemTenuresType0ItemDateRange
        d = dict(src_dict)
        date_range = PollCombinedSearchResponse200OutputDataType1ItemsItemTenuresType0ItemDateRange.from_dict(d.pop("date_range"))
        ...
        poll_combined_search_response_200_output_data_type_1_items_item_tenures_type_0_item = cls(
            date_range=date_range,
            titles=titles,
            localities=localities,
        ...
        poll_combined_search_response_200_output_data_type_1_items_item_tenures_type_0_item.additional_properties = d
        return poll_combined_search_response_200_output_data_type_1_items_item_tenures_type_0_item
