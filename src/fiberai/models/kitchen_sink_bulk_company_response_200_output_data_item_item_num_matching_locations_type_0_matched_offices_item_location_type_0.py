...
if TYPE_CHECKING:
    from ..models.kitchen_sink_bulk_company_response_200_output_data_item_item_num_matching_locations_type_0_matched_offices_item_location_type_0_coordinates_type_0 import (
        KitchenSinkBulkCompanyResponse200OutputDataItemItemNumMatchingLocationsType0MatchedOfficesItemLocationType0CoordinatesType0,
    )


T = TypeVar(
    "T",
    bound="KitchenSinkBulkCompanyResponse200OutputDataItemItemNumMatchingLocationsType0MatchedOfficesItemLocationType0",
)
...
class KitchenSinkBulkCompanyResponse200OutputDataItemItemNumMatchingLocationsType0MatchedOfficesItemLocationType0:
    ...
    Attributes:
        ...
        coordinates (KitchenSinkBulkCompanyResponse200OutputDataItemItemNumMatchingLocationsType0MatchedOfficesItemLocat
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.kitchen_sink_bulk_company_response_200_output_data_item_item_num_matching_locations_type_0_matched_offices_item_location_type_0_coordinates_type_0 import (
            KitchenSinkBulkCompanyResponse200OutputDataItemItemNumMatchingLocationsType0MatchedOfficesItemLocationType0CoordinatesType0,  # noqa: PLC0415
        )
        ...
        def _parse_coordinates(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = KitchenSinkBulkCompanyResponse200OutputDataItemItemNumMatchingLocationsType0MatchedOfficesItemLocationType0CoordinatesType0.from_dict(
                    data
                )
