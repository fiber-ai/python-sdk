...
from ..models.paginated_combined_search_response_200_output_profiles_item_detailed_work_experiences_type_0_item_academic_qualification_type_0_item import (
    PaginatedCombinedSearchResponse200OutputProfilesItemDetailedWorkExperiencesType0ItemAcademicQualificationType0Item,
)
from ..models.paginated_combined_search_response_200_output_profiles_item_detailed_work_experiences_type_0_item_employment_type_type_0_item import (
    PaginatedCombinedSearchResponse200OutputProfilesItemDetailedWorkExperiencesType0ItemEmploymentTypeType0Item,
)
from ..models.paginated_combined_search_response_200_output_profiles_item_detailed_work_experiences_type_0_item_job_function_type_0_item import (
    PaginatedCombinedSearchResponse200OutputProfilesItemDetailedWorkExperiencesType0ItemJobFunctionType0Item,
)
from ..models.paginated_combined_search_response_200_output_profiles_item_detailed_work_experiences_type_0_item_seniority_type_1 import (
    PaginatedCombinedSearchResponse200OutputProfilesItemDetailedWorkExperiencesType0ItemSeniorityType1,
)
from ..models.paginated_combined_search_response_200_output_profiles_item_detailed_work_experiences_type_0_item_seniority_type_2_type_1 import (
    PaginatedCombinedSearchResponse200OutputProfilesItemDetailedWorkExperiencesType0ItemSeniorityType2Type1,
)
from ..models.paginated_combined_search_response_200_output_profiles_item_detailed_work_experiences_type_0_item_seniority_type_3_type_1 import (
    PaginatedCombinedSearchResponse200OutputProfilesItemDetailedWorkExperiencesType0ItemSeniorityType3Type1,
)
...
T = TypeVar("T", bound="PaginatedCombinedSearchResponse200OutputProfilesItemDetailedWorkExperiencesType0Item")


@_attrs_define
class PaginatedCombinedSearchResponse200OutputProfilesItemDetailedWorkExperiencesType0Item:
    """
    Attributes:
        ...
        seniority (None |
            ...
            Unset):
        job_function
            (list[PaginatedCombinedSearchResponse200OutputProfilesItemDetailedWorkExperiencesType0ItemJobFunctionType0Item]
            | None | Unset):
        employment_type (list[PaginatedCombinedSearchResponse200OutputProfilesItemDetailedWorkExperiencesType0ItemEmploy
            mentTypeType0Item] | None | Unset):
        academic_qualification (list[PaginatedCombinedSearchResponse200OutputProfilesItemDetailedWorkExperiencesType0Ite
            mAcademicQualificationType0Item] | None | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_company_details(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                company_details_type_0 = PaginatedCombinedSearchResponse200OutputProfilesItemDetailedWorkExperiencesType0ItemCompanyDetailsType0.from_dict(
                    data
                )
        ...
        def _parse_seniority(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                seniority_type_2_type_1 = PaginatedCombinedSearchResponse200OutputProfilesItemDetailedWorkExperiencesType0ItemSeniorityType2Type1(
                    data
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                seniority_type_3_type_1 = PaginatedCombinedSearchResponse200OutputProfilesItemDetailedWorkExperiencesType0ItemSeniorityType3Type1(
                    data
                )
        ...
        def _parse_job_function(
            ...
            try:
                ...
                for job_function_type_0_item_data in _job_function_type_0:
                    job_function_type_0_item = PaginatedCombinedSearchResponse200OutputProfilesItemDetailedWorkExperiencesType0ItemJobFunctionType0Item(
        ...
        def _parse_employment_type(
            ...
            try:
                ...
                for employment_type_type_0_item_data in _employment_type_type_0:
                    employment_type_type_0_item = PaginatedCombinedSearchResponse200OutputProfilesItemDetailedWorkExperiencesType0ItemEmploymentTypeType0Item(
        ...
        def _parse_academic_qualification(
            ...
            try:
                ...
                for academic_qualification_type_0_item_data in _academic_qualification_type_0:
                    academic_qualification_type_0_item = PaginatedCombinedSearchResponse200OutputProfilesItemDetailedWorkExperiencesType0ItemAcademicQualificationType0Item(
        ...
        paginated_combined_search_response_200_output_profiles_item_detailed_work_experiences_type_0_item = cls(
        ...
        paginated_combined_search_response_200_output_profiles_item_detailed_work_experiences_type_0_item.additional_properties = d
        return paginated_combined_search_response_200_output_profiles_item_detailed_work_experiences_type_0_item
