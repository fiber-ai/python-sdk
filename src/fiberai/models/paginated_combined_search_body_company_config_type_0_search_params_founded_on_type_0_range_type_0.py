...
T = TypeVar("T", bound="PaginatedCombinedSearchBodyCompanyConfigType0SearchParamsFoundedOnType0RangeType0")


@_attrs_define
class PaginatedCombinedSearchBodyCompanyConfigType0SearchParamsFoundedOnType0RangeType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        paginated_combined_search_body_company_config_type_0_search_params_founded_on_type_0_range_type_0 = cls(
            lower_bound=lower_bound,
            upper_bound=upper_bound,
        )

        paginated_combined_search_body_company_config_type_0_search_params_founded_on_type_0_range_type_0.additional_properties = d
        return paginated_combined_search_body_company_config_type_0_search_params_founded_on_type_0_range_type_0
