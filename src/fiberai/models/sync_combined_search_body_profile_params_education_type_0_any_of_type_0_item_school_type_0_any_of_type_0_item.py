...
T = TypeVar("T", bound="SyncCombinedSearchBodyProfileParamsEducationType0AnyOfType0ItemSchoolType0AnyOfType0Item")


@_attrs_define
class SyncCombinedSearchBodyProfileParamsEducationType0AnyOfType0ItemSchoolType0AnyOfType0Item:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sync_combined_search_body_profile_params_education_type_0_any_of_type_0_item_school_type_0_any_of_type_0_item = cls(
            linkedin_id=linkedin_id,
            linkedin_url=linkedin_url,
            domain=domain,
        )

        sync_combined_search_body_profile_params_education_type_0_any_of_type_0_item_school_type_0_any_of_type_0_item.additional_properties = d
        return sync_combined_search_body_profile_params_education_type_0_any_of_type_0_item_school_type_0_any_of_type_0_item
