...
if TYPE_CHECKING:
    from ..models.company_search_response_200_output_data_item_li_locations_type_0_item_location_type_0_coordinates_type_0 import (
        CompanySearchResponse200OutputDataItemLiLocationsType0ItemLocationType0CoordinatesType0,
    )
...
class CompanySearchResponse200OutputDataItemLiLocationsType0ItemLocationType0:
    ...
    Attributes:
        ...
        coordinates (CompanySearchResponse200OutputDataItemLiLocationsType0ItemLocationType0CoordinatesType0 | None |
            Unset):
    ...
    coordinates: (
        CompanySearchResponse200OutputDataItemLiLocationsType0ItemLocationType0CoordinatesType0 | None | Unset
    ) = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.company_search_response_200_output_data_item_li_locations_type_0_item_location_type_0_coordinates_type_0 import (
            CompanySearchResponse200OutputDataItemLiLocationsType0ItemLocationType0CoordinatesType0,  # noqa: PLC0415
        )
        ...
        if isinstance(self.coordinates, Unset):
            ...
            self.coordinates, CompanySearchResponse200OutputDataItemLiLocationsType0ItemLocationType0CoordinatesType0
        ):
        ...
        def _parse_coordinates(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = (
                    CompanySearchResponse200OutputDataItemLiLocationsType0ItemLocationType0CoordinatesType0.from_dict(
                        data
                    )
                )
