...
if TYPE_CHECKING:
  from ..models.company_search_response_200_output_data_item_li_locations_type_0_item_location_type_0_coordinates_type_0 import CompanySearchResponse200OutputDataItemLiLocationsType0ItemLocationType0CoordinatesType0





T = TypeVar("T", bound="CompanySearchResponse200OutputDataItemLiLocationsType0ItemLocationType0")



@_attrs_define
class CompanySearchResponse200OutputDataItemLiLocationsType0ItemLocationType0:
    """ 
        Attributes:
            ...
            coordinates (Union['CompanySearchResponse200OutputDataItemLiLocationsType0ItemLocationType0CoordinatesType0',
                None, Unset]):
    ...
    coordinates: Union['CompanySearchResponse200OutputDataItemLiLocationsType0ItemLocationType0CoordinatesType0', None, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.coordinates, Unset):
            coordinates = UNSET
        elif isinstance(self.coordinates, CompanySearchResponse200OutputDataItemLiLocationsType0ItemLocationType0CoordinatesType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_coordinates(data: object) -> Union['CompanySearchResponse200OutputDataItemLiLocationsType0ItemLocationType0CoordinatesType0', None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = CompanySearchResponse200OutputDataItemLiLocationsType0ItemLocationType0CoordinatesType0.from_dict(data)
                ...
                pass
            return cast(Union['CompanySearchResponse200OutputDataItemLiLocationsType0ItemLocationType0CoordinatesType0', None, Unset], data)
        ...
        company_search_response_200_output_data_item_li_locations_type_0_item_location_type_0 = cls(
        ...
        company_search_response_200_output_data_item_li_locations_type_0_item_location_type_0.additional_properties = d
        return company_search_response_200_output_data_item_li_locations_type_0_item_location_type_0
