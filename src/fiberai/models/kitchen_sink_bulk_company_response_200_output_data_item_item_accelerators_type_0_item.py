...
if TYPE_CHECKING:
    from ..models.kitchen_sink_bulk_company_response_200_output_data_item_item_accelerators_type_0_item_founders_type_0_item import (
        KitchenSinkBulkCompanyResponse200OutputDataItemItemAcceleratorsType0ItemFoundersType0Item,
    )
...
class KitchenSinkBulkCompanyResponse200OutputDataItemItemAcceleratorsType0Item:
    ...
    Attributes:
        ...
        founders (list[KitchenSinkBulkCompanyResponse200OutputDataItemItemAcceleratorsType0ItemFoundersType0Item] | None
            | Unset):
    ...
    founders: (
        list[KitchenSinkBulkCompanyResponse200OutputDataItemItemAcceleratorsType0ItemFoundersType0Item] | None | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.kitchen_sink_bulk_company_response_200_output_data_item_item_accelerators_type_0_item_founders_type_0_item import (
            KitchenSinkBulkCompanyResponse200OutputDataItemItemAcceleratorsType0ItemFoundersType0Item,  # noqa: PLC0415
        )
        ...
        def _parse_founders(
            ...
            try:
                ...
                for founders_type_0_item_data in _founders_type_0:
                    founders_type_0_item = KitchenSinkBulkCompanyResponse200OutputDataItemItemAcceleratorsType0ItemFoundersType0Item.from_dict(
