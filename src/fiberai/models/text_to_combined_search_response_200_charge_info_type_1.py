...
from ..models.text_to_combined_search_response_200_charge_info_type_1_method import (
    TextToCombinedSearchResponse200ChargeInfoType1Method,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.text_to_combined_search_response_200_charge_info_type_1_low_credit_alert_type_0 import (
        TextToCombinedSearchResponse200ChargeInfoType1LowCreditAlertType0,
    )
...
class TextToCombinedSearchResponse200ChargeInfoType1:
    ...
    Attributes:
        ...
        message (str):
        low_credit_alert (None | TextToCombinedSearchResponse200ChargeInfoType1LowCreditAlertType0 | Unset): Contains a
            link to get more credits, a warning message, and the remaining credit count.
    """

    method: TextToCombinedSearchResponse200ChargeInfoType1Method
    message: str
    low_credit_alert: None | TextToCombinedSearchResponse200ChargeInfoType1LowCreditAlertType0 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.low_credit_alert, TextToCombinedSearchResponse200ChargeInfoType1LowCreditAlertType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_low_credit_alert(
            data: object,
        ) -> None | TextToCombinedSearchResponse200ChargeInfoType1LowCreditAlertType0 | Unset:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                low_credit_alert_type_0 = TextToCombinedSearchResponse200ChargeInfoType1LowCreditAlertType0.from_dict(
                    data
                )
                ...
                pass
            return cast(None | TextToCombinedSearchResponse200ChargeInfoType1LowCreditAlertType0 | Unset, data)
