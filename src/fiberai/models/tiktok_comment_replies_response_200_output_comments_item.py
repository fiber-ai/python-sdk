...
T = TypeVar("T", bound="TiktokCommentRepliesResponse200OutputCommentsItem")


@_attrs_define
class TiktokCommentRepliesResponse200OutputCommentsItem:
    """
    Attributes:
        ...
        user (None | TiktokCommentRepliesResponse200OutputCommentsItemUserType0 | Unset): The user who posted the
            comment.
    """
    ...
    user: None | TiktokCommentRepliesResponse200OutputCommentsItemUserType0 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.user, Unset):
            user = UNSET
        elif isinstance(self.user, TiktokCommentRepliesResponse200OutputCommentsItemUserType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_user(data: object) -> None | TiktokCommentRepliesResponse200OutputCommentsItemUserType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                user_type_0 = TiktokCommentRepliesResponse200OutputCommentsItemUserType0.from_dict(data)

                return user_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | TiktokCommentRepliesResponse200OutputCommentsItemUserType0 | Unset, data)

        user = _parse_user(d.pop("user", UNSET))

        tiktok_comment_replies_response_200_output_comments_item = cls(
            id=id,
            text=text,
        ...
        tiktok_comment_replies_response_200_output_comments_item.additional_properties = d
        return tiktok_comment_replies_response_200_output_comments_item
