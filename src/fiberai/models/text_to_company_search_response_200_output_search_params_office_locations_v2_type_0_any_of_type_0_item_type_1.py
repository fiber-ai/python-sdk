...
from ..models.text_to_company_search_response_200_output_search_params_office_locations_v2_type_0_any_of_type_0_item_type_1_country_or_region_code import (
    TextToCompanySearchResponse200OutputSearchParamsOfficeLocationsV2Type0AnyOfType0ItemType1CountryOrRegionCode,
)
from ..models.text_to_company_search_response_200_output_search_params_office_locations_v2_type_0_any_of_type_0_item_type_1_type import (
    TextToCompanySearchResponse200OutputSearchParamsOfficeLocationsV2Type0AnyOfType0ItemType1Type,
)

if TYPE_CHECKING:
    from ..models.text_to_company_search_response_200_output_search_params_office_locations_v2_type_0_any_of_type_0_item_type_1_range import (
        TextToCompanySearchResponse200OutputSearchParamsOfficeLocationsV2Type0AnyOfType0ItemType1Range,
    )
...
class TextToCompanySearchResponse200OutputSearchParamsOfficeLocationsV2Type0AnyOfType0ItemType1:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        range_ = (
            TextToCompanySearchResponse200OutputSearchParamsOfficeLocationsV2Type0AnyOfType0ItemType1Range.from_dict(
                d.pop("range")
            )
        )
