...
if TYPE_CHECKING:
    from ..models.combined_search_count_body_company_params_headquarters_location_type_0_subtract_all_type_0_item_type_2_vertices_item import (
        CombinedSearchCountBodyCompanyParamsHeadquartersLocationType0SubtractAllType0ItemType2VerticesItem,
    )
...
class CombinedSearchCountBodyCompanyParamsHeadquartersLocationType0SubtractAllType0ItemType2:
    ...
    Attributes:
        ...
        vertices
            (list[CombinedSearchCountBodyCompanyParamsHeadquartersLocationType0SubtractAllType0ItemType2VerticesItem]):
    """

    strategy: CombinedSearchCountBodyCompanyParamsHeadquartersLocationType0SubtractAllType0ItemType2Strategy
    vertices: list[CombinedSearchCountBodyCompanyParamsHeadquartersLocationType0SubtractAllType0ItemType2VerticesItem]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.combined_search_count_body_company_params_headquarters_location_type_0_subtract_all_type_0_item_type_2_vertices_item import (
            CombinedSearchCountBodyCompanyParamsHeadquartersLocationType0SubtractAllType0ItemType2VerticesItem,  # noqa: PLC0415
        )
        ...
        for vertices_item_data in _vertices:
            vertices_item = CombinedSearchCountBodyCompanyParamsHeadquartersLocationType0SubtractAllType0ItemType2VerticesItem.from_dict(
                vertices_item_data
            )
