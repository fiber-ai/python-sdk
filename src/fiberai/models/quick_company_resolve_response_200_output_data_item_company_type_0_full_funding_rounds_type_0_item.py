...
if TYPE_CHECKING:
    from ..models.quick_company_resolve_response_200_output_data_item_company_type_0_full_funding_rounds_type_0_item_investors_type_0_item import (
        QuickCompanyResolveResponse200OutputDataItemCompanyType0FullFundingRoundsType0ItemInvestorsType0Item,
    )


T = TypeVar("T", bound="QuickCompanyResolveResponse200OutputDataItemCompanyType0FullFundingRoundsType0Item")


@_attrs_define
class QuickCompanyResolveResponse200OutputDataItemCompanyType0FullFundingRoundsType0Item:
    """
    Attributes:
        investors
            (list[QuickCompanyResolveResponse200OutputDataItemCompanyType0FullFundingRoundsType0ItemInvestorsType0Item] |
            None | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.quick_company_resolve_response_200_output_data_item_company_type_0_full_funding_rounds_type_0_item_investors_type_0_item import (
            QuickCompanyResolveResponse200OutputDataItemCompanyType0FullFundingRoundsType0ItemInvestorsType0Item,  # noqa: PLC0415
        )
        ...
        def _parse_investors(
            ...
            try:
                ...
                for investors_type_0_item_data in _investors_type_0:
                    investors_type_0_item = QuickCompanyResolveResponse200OutputDataItemCompanyType0FullFundingRoundsType0ItemInvestorsType0Item.from_dict(
        ...
        quick_company_resolve_response_200_output_data_item_company_type_0_full_funding_rounds_type_0_item = cls(
            investors=investors,
        ...
        quick_company_resolve_response_200_output_data_item_company_type_0_full_funding_rounds_type_0_item.additional_properties = d
        return quick_company_resolve_response_200_output_data_item_company_type_0_full_funding_rounds_type_0_item
