...
from ..models.get_current_companies_in_saved_search_response_200_output_companies_item_fortune_rankings_type_0_item_list import GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemFortuneRankingsType0ItemList
...
class GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemFortuneRankingsType0Item:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        list_ = GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemFortuneRankingsType0ItemList(d.pop("list"))
