...
from ..models.text_to_combined_search_response_200_output_profile_search_params_type_0_job_title_v3_type_0_any_of_type_0_item_type_2_type import (
    TextToCombinedSearchResponse200OutputProfileSearchParamsType0JobTitleV3Type0AnyOfType0ItemType2Type,
)

T = TypeVar(
    "T", bound="TextToCombinedSearchResponse200OutputProfileSearchParamsType0JobTitleV3Type0AnyOfType0ItemType2"
)
