...
from ..models.people_search_response_200_output_data_item_current_job_type_0_academic_qualification_type_0_item import (
    PeopleSearchResponse200OutputDataItemCurrentJobType0AcademicQualificationType0Item,
)
from ..models.people_search_response_200_output_data_item_current_job_type_0_employment_type_type_0_item import (
    PeopleSearchResponse200OutputDataItemCurrentJobType0EmploymentTypeType0Item,
)
from ..models.people_search_response_200_output_data_item_current_job_type_0_job_function_type_0_item import (
    PeopleSearchResponse200OutputDataItemCurrentJobType0JobFunctionType0Item,
)
from ..models.people_search_response_200_output_data_item_current_job_type_0_seniority_type_1 import (
    PeopleSearchResponse200OutputDataItemCurrentJobType0SeniorityType1,
)
from ..models.people_search_response_200_output_data_item_current_job_type_0_seniority_type_2_type_1 import (
    PeopleSearchResponse200OutputDataItemCurrentJobType0SeniorityType2Type1,
)
from ..models.people_search_response_200_output_data_item_current_job_type_0_seniority_type_3_type_1 import (
    PeopleSearchResponse200OutputDataItemCurrentJobType0SeniorityType3Type1,
)
...
class PeopleSearchResponse200OutputDataItemCurrentJobType0:
    ...
    Attributes:
        ...
        seniority (None | PeopleSearchResponse200OutputDataItemCurrentJobType0SeniorityType1 |
            PeopleSearchResponse200OutputDataItemCurrentJobType0SeniorityType2Type1 |
            PeopleSearchResponse200OutputDataItemCurrentJobType0SeniorityType3Type1 | Unset):
        job_function (list[PeopleSearchResponse200OutputDataItemCurrentJobType0JobFunctionType0Item] | None | Unset):
        employment_type (list[PeopleSearchResponse200OutputDataItemCurrentJobType0EmploymentTypeType0Item] | None |
            Unset):
        academic_qualification (list[PeopleSearchResponse200OutputDataItemCurrentJobType0AcademicQualificationType0Item]
            | None | Unset):
    ...
    job_function: list[PeopleSearchResponse200OutputDataItemCurrentJobType0JobFunctionType0Item] | None | Unset = UNSET
    employment_type: (
        list[PeopleSearchResponse200OutputDataItemCurrentJobType0EmploymentTypeType0Item] | None | Unset
    ) = UNSET
    academic_qualification: (
        list[PeopleSearchResponse200OutputDataItemCurrentJobType0AcademicQualificationType0Item] | None | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_job_function(
            data: object,
        ) -> list[PeopleSearchResponse200OutputDataItemCurrentJobType0JobFunctionType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for job_function_type_0_item_data in _job_function_type_0:
                    job_function_type_0_item = PeopleSearchResponse200OutputDataItemCurrentJobType0JobFunctionType0Item(
                ...
                pass
            return cast(
                list[PeopleSearchResponse200OutputDataItemCurrentJobType0JobFunctionType0Item] | None | Unset, data
            )
        ...
        def _parse_employment_type(
            ...
            try:
                ...
                pass
            return cast(
                list[PeopleSearchResponse200OutputDataItemCurrentJobType0EmploymentTypeType0Item] | None | Unset, data
            )
