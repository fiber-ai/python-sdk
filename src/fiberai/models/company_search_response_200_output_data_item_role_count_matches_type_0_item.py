...
class CompanySearchResponse200OutputDataItemRoleCountMatchesType0Item:
    """
    Attributes:
        num_matching_employees (CompanySearchResponse200OutputDataItemRoleCountMatchesType0ItemNumMatchingEmployeesType0
            | CompanySearchResponse200OutputDataItemRoleCountMatchesType0ItemNumMatchingEmployeesType1 |
            CompanySearchResponse200OutputDataItemRoleCountMatchesType0ItemNumMatchingEmployeesType2 |
            CompanySearchResponse200OutputDataItemRoleCountMatchesType0ItemNumMatchingEmployeesType3):
    """
        ...
        def _parse_num_matching_employees(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                num_matching_employees_type_0 = (
                    CompanySearchResponse200OutputDataItemRoleCountMatchesType0ItemNumMatchingEmployeesType0.from_dict(
                        data
                    )
                )
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                num_matching_employees_type_1 = (
                    CompanySearchResponse200OutputDataItemRoleCountMatchesType0ItemNumMatchingEmployeesType1.from_dict(
                        data
                    )
                )
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                num_matching_employees_type_2 = (
                    CompanySearchResponse200OutputDataItemRoleCountMatchesType0ItemNumMatchingEmployeesType2.from_dict(
                        data
                    )
                )
            ...
            if not isinstance(data, dict):
                raise TypeError()
            num_matching_employees_type_3 = (
                CompanySearchResponse200OutputDataItemRoleCountMatchesType0ItemNumMatchingEmployeesType3.from_dict(data)
            )
