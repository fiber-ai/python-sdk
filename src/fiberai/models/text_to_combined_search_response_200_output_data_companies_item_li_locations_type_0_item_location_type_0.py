...
if TYPE_CHECKING:
    from ..models.text_to_combined_search_response_200_output_data_companies_item_li_locations_type_0_item_location_type_0_coordinates_type_0 import (
        TextToCombinedSearchResponse200OutputDataCompaniesItemLiLocationsType0ItemLocationType0CoordinatesType0,
    )
        ...
        def _parse_coordinates(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = TextToCombinedSearchResponse200OutputDataCompaniesItemLiLocationsType0ItemLocationType0CoordinatesType0.from_dict(
                    data
                )
