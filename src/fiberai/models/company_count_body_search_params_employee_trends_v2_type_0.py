...
T = TypeVar("T", bound="CompanyCountBodySearchParamsEmployeeTrendsV2Type0")


@_attrs_define
class CompanyCountBodySearchParamsEmployeeTrendsV2Type0:
    """
    Attributes:
        obeys_all (list[CompanyCountBodySearchParamsEmployeeTrendsV2Type0ObeysAllType0ItemType0 |
            CompanyCountBodySearchParamsEmployeeTrendsV2Type0ObeysAllType0ItemType1] | None | Unset):
        obeys_any (list[CompanyCountBodySearchParamsEmployeeTrendsV2Type0ObeysAnyType0ItemType0 |
            CompanyCountBodySearchParamsEmployeeTrendsV2Type0ObeysAnyType0ItemType1] | None | Unset):
        obeys_none (list[CompanyCountBodySearchParamsEmployeeTrendsV2Type0ObeysNoneType0ItemType0 |
            CompanyCountBodySearchParamsEmployeeTrendsV2Type0ObeysNoneType0ItemType1] | None | Unset):
    """
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.obeys_all, Unset):
            ...
            for obeys_all_type_0_item_data in self.obeys_all:
                ...
                if isinstance(
                    obeys_all_type_0_item_data, CompanyCountBodySearchParamsEmployeeTrendsV2Type0ObeysAllType0ItemType0
                ):
        ...
        if isinstance(self.obeys_any, Unset):
            ...
            for obeys_any_type_0_item_data in self.obeys_any:
                ...
                if isinstance(
                    obeys_any_type_0_item_data, CompanyCountBodySearchParamsEmployeeTrendsV2Type0ObeysAnyType0ItemType0
                ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
                    ...
                    def _parse_obeys_all_type_0_item(
                        ...
                        try:
                            ...
                            obeys_all_type_0_item_type_0 = (
                                CompanyCountBodySearchParamsEmployeeTrendsV2Type0ObeysAllType0ItemType0.from_dict(data)
                            )
                        ...
                        obeys_all_type_0_item_type_1 = (
                            CompanyCountBodySearchParamsEmployeeTrendsV2Type0ObeysAllType0ItemType1.from_dict(data)
                        )
                    ...
                    def _parse_obeys_any_type_0_item(
                        ...
                        try:
                            ...
                            obeys_any_type_0_item_type_0 = (
                                CompanyCountBodySearchParamsEmployeeTrendsV2Type0ObeysAnyType0ItemType0.from_dict(data)
                            )
                        ...
                        obeys_any_type_0_item_type_1 = (
                            CompanyCountBodySearchParamsEmployeeTrendsV2Type0ObeysAnyType0ItemType1.from_dict(data)
                        )
                    ...
                    def _parse_obeys_none_type_0_item(
                        ...
                        try:
                            ...
                            obeys_none_type_0_item_type_0 = (
                                CompanyCountBodySearchParamsEmployeeTrendsV2Type0ObeysNoneType0ItemType0.from_dict(data)
                            )
                        ...
                        obeys_none_type_0_item_type_1 = (
                            CompanyCountBodySearchParamsEmployeeTrendsV2Type0ObeysNoneType0ItemType1.from_dict(data)
                        )
        ...
        company_count_body_search_params_employee_trends_v2_type_0 = cls(
            obeys_all=obeys_all,
            obeys_any=obeys_any,
            obeys_none=obeys_none,
        )

        company_count_body_search_params_employee_trends_v2_type_0.additional_properties = d
        return company_count_body_search_params_employee_trends_v2_type_0
