...
T = TypeVar("T", bound="KitchenSinkProfileResponse200OutputDataItemCertificationsType0Item")


@_attrs_define
class KitchenSinkProfileResponse200OutputDataItemCertificationsType0Item:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        kitchen_sink_profile_response_200_output_data_item_certifications_type_0_item = cls(
            title=title,
        ...
        kitchen_sink_profile_response_200_output_data_item_certifications_type_0_item.additional_properties = d
        return kitchen_sink_profile_response_200_output_data_item_certifications_type_0_item
