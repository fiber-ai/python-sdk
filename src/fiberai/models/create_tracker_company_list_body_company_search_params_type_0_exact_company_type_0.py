...
T = TypeVar("T", bound="CreateTrackerCompanyListBodyCompanySearchParamsType0ExactCompanyType0")


@_attrs_define
class CreateTrackerCompanyListBodyCompanySearchParamsType0ExactCompanyType0:
    """
    Attributes:
        any_of (list[CreateTrackerCompanyListBodyCompanySearchParamsType0ExactCompanyType0AnyOfType0Item] | None |
            Unset):
        none_of (list[CreateTrackerCompanyListBodyCompanySearchParamsType0ExactCompanyType0NoneOfType0Item] | None |
            Unset):
    """

    any_of: list[CreateTrackerCompanyListBodyCompanySearchParamsType0ExactCompanyType0AnyOfType0Item] | None | Unset = (
        UNSET
    )
    none_of: (
        list[CreateTrackerCompanyListBodyCompanySearchParamsType0ExactCompanyType0NoneOfType0Item] | None | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_any_of(
            data: object,
        ) -> list[CreateTrackerCompanyListBodyCompanySearchParamsType0ExactCompanyType0AnyOfType0Item] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for any_of_type_0_item_data in _any_of_type_0:
                    any_of_type_0_item = (
                        CreateTrackerCompanyListBodyCompanySearchParamsType0ExactCompanyType0AnyOfType0Item.from_dict(
                ...
                pass
            return cast(
                list[CreateTrackerCompanyListBodyCompanySearchParamsType0ExactCompanyType0AnyOfType0Item]
                | None
                | Unset,
                data,
            )
        ...
        def _parse_none_of(
            ...
            try:
                ...
                for none_of_type_0_item_data in _none_of_type_0:
                    none_of_type_0_item = (
                        CreateTrackerCompanyListBodyCompanySearchParamsType0ExactCompanyType0NoneOfType0Item.from_dict(
                ...
                pass
            return cast(
                list[CreateTrackerCompanyListBodyCompanySearchParamsType0ExactCompanyType0NoneOfType0Item]
                | None
                | Unset,
                data,
            )
        ...
        create_tracker_company_list_body_company_search_params_type_0_exact_company_type_0 = cls(
            any_of=any_of,
            none_of=none_of,
        )

        create_tracker_company_list_body_company_search_params_type_0_exact_company_type_0.additional_properties = d
        return create_tracker_company_list_body_company_search_params_type_0_exact_company_type_0
