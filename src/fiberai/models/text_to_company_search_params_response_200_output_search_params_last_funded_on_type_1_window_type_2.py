...
from ..models.text_to_company_search_params_response_200_output_search_params_last_funded_on_type_1_window_type_2_method import TextToCompanySearchParamsResponse200OutputSearchParamsLastFundedOnType1WindowType2Method
from ..models.text_to_company_search_params_response_200_output_search_params_last_funded_on_type_1_window_type_2_period import TextToCompanySearchParamsResponse200OutputSearchParamsLastFundedOnType1WindowType2Period
from ..models.text_to_company_search_params_response_200_output_search_params_last_funded_on_type_1_window_type_2_which import TextToCompanySearchParamsResponse200OutputSearchParamsLastFundedOnType1WindowType2Which
...
class TextToCompanySearchParamsResponse200OutputSearchParamsLastFundedOnType1WindowType2:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        method = TextToCompanySearchParamsResponse200OutputSearchParamsLastFundedOnType1WindowType2Method(d.pop("method"))
        ...
        period = TextToCompanySearchParamsResponse200OutputSearchParamsLastFundedOnType1WindowType2Period(d.pop("period"))
