...
T = TypeVar("T", bound="SyncCombinedSearchBodyProfileParamsEducationType0AnyOfType0ItemDegreeV2Type0Criteria")


@_attrs_define
class SyncCombinedSearchBodyProfileParamsEducationType0AnyOfType0ItemDegreeV2Type0Criteria:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sync_combined_search_body_profile_params_education_type_0_any_of_type_0_item_degree_v2_type_0_criteria = cls(
            any_of=any_of,
            none_of=none_of,
        )

        sync_combined_search_body_profile_params_education_type_0_any_of_type_0_item_degree_v2_type_0_criteria.additional_properties = d
        return sync_combined_search_body_profile_params_education_type_0_any_of_type_0_item_degree_v2_type_0_criteria
