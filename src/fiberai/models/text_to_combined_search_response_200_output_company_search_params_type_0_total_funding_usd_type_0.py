...
T = TypeVar("T", bound="TextToCombinedSearchResponse200OutputCompanySearchParamsType0TotalFundingUSDType0")


@_attrs_define
class TextToCombinedSearchResponse200OutputCompanySearchParamsType0TotalFundingUSDType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        text_to_combined_search_response_200_output_company_search_params_type_0_total_funding_usd_type_0 = cls(
            lower_bound=lower_bound,
            upper_bound=upper_bound,
        )

        text_to_combined_search_response_200_output_company_search_params_type_0_total_funding_usd_type_0.additional_properties = d
        return text_to_combined_search_response_200_output_company_search_params_type_0_total_funding_usd_type_0
