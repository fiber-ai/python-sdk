...
T = TypeVar("T", bound="PaginatedCombinedSearchBodyProfileConfigType0SearchParamsJobTitleV3Type0")


@_attrs_define
class PaginatedCombinedSearchBodyProfileConfigType0SearchParamsJobTitleV3Type0:
    """
    Attributes:
        any_of (list[PaginatedCombinedSearchBodyProfileConfigType0SearchParamsJobTitleV3Type0AnyOfType0ItemType0 |
            PaginatedCombinedSearchBodyProfileConfigType0SearchParamsJobTitleV3Type0AnyOfType0ItemType1 |
            PaginatedCombinedSearchBodyProfileConfigType0SearchParamsJobTitleV3Type0AnyOfType0ItemType2] | None | Unset):
        all_of (list[PaginatedCombinedSearchBodyProfileConfigType0SearchParamsJobTitleV3Type0AllOfType0ItemType0 |
            PaginatedCombinedSearchBodyProfileConfigType0SearchParamsJobTitleV3Type0AllOfType0ItemType1 |
            PaginatedCombinedSearchBodyProfileConfigType0SearchParamsJobTitleV3Type0AllOfType0ItemType2] | None | Unset):
        none_of (list[PaginatedCombinedSearchBodyProfileConfigType0SearchParamsJobTitleV3Type0NoneOfType0ItemType0 |
            PaginatedCombinedSearchBodyProfileConfigType0SearchParamsJobTitleV3Type0NoneOfType0ItemType1 |
            PaginatedCombinedSearchBodyProfileConfigType0SearchParamsJobTitleV3Type0NoneOfType0ItemType2] | None | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
                    ...
                    def _parse_any_of_type_0_item(
                        ...
                        try:
                            if not isinstance(data, dict):
                                raise TypeError()
                            any_of_type_0_item_type_0 = PaginatedCombinedSearchBodyProfileConfigType0SearchParamsJobTitleV3Type0AnyOfType0ItemType0.from_dict(
                                data
                            )
                        ...
                        try:
                            if not isinstance(data, dict):
                                raise TypeError()
                            any_of_type_0_item_type_1 = PaginatedCombinedSearchBodyProfileConfigType0SearchParamsJobTitleV3Type0AnyOfType0ItemType1.from_dict(
                                data
                            )
                        ...
                        if not isinstance(data, dict):
                            raise TypeError()
                        any_of_type_0_item_type_2 = PaginatedCombinedSearchBodyProfileConfigType0SearchParamsJobTitleV3Type0AnyOfType0ItemType2.from_dict(
                            data
                        )
                ...
                for all_of_type_0_item_data in _all_of_type_0:
                    ...
                    def _parse_all_of_type_0_item(
                        ...
                        try:
                            if not isinstance(data, dict):
                                raise TypeError()
                            all_of_type_0_item_type_0 = PaginatedCombinedSearchBodyProfileConfigType0SearchParamsJobTitleV3Type0AllOfType0ItemType0.from_dict(
                                data
                            )
                        ...
                        try:
                            if not isinstance(data, dict):
                                raise TypeError()
                            all_of_type_0_item_type_1 = PaginatedCombinedSearchBodyProfileConfigType0SearchParamsJobTitleV3Type0AllOfType0ItemType1.from_dict(
                                data
                            )
                        ...
                        if not isinstance(data, dict):
                            raise TypeError()
                        all_of_type_0_item_type_2 = PaginatedCombinedSearchBodyProfileConfigType0SearchParamsJobTitleV3Type0AllOfType0ItemType2.from_dict(
                            data
                        )
                ...
                for none_of_type_0_item_data in _none_of_type_0:
                    ...
                    def _parse_none_of_type_0_item(
                        ...
                        try:
                            if not isinstance(data, dict):
                                raise TypeError()
                            none_of_type_0_item_type_0 = PaginatedCombinedSearchBodyProfileConfigType0SearchParamsJobTitleV3Type0NoneOfType0ItemType0.from_dict(
                                data
                            )
                        ...
                        try:
                            if not isinstance(data, dict):
                                raise TypeError()
                            none_of_type_0_item_type_1 = PaginatedCombinedSearchBodyProfileConfigType0SearchParamsJobTitleV3Type0NoneOfType0ItemType1.from_dict(
                                data
                            )
                        ...
                        if not isinstance(data, dict):
                            raise TypeError()
                        none_of_type_0_item_type_2 = PaginatedCombinedSearchBodyProfileConfigType0SearchParamsJobTitleV3Type0NoneOfType0ItemType2.from_dict(
                            data
                        )
        ...
        paginated_combined_search_body_profile_config_type_0_search_params_job_title_v3_type_0 = cls(
            any_of=any_of,
            all_of=all_of,
            none_of=none_of,
        )

        paginated_combined_search_body_profile_config_type_0_search_params_job_title_v3_type_0.additional_properties = d
        return paginated_combined_search_body_profile_config_type_0_search_params_job_title_v3_type_0
