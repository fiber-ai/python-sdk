...
from ..models.get_saved_search_run_profiles_body_statuses_type_0_item import GetSavedSearchRunProfilesBodyStatusesType0Item
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="GetSavedSearchRunProfilesBody")



@_attrs_define
class GetSavedSearchRunProfilesBody:
    """ 
        Attributes:
            api_key (str): Your Fiber API key
            saved_search_run_id (str): The ID of the saved search run
            statuses (Union[None, Unset, list[GetSavedSearchRunProfilesBodyStatusesType0Item]]): The statuses of the
                profiles. This is optional and if not provided, all profiles will be returned.
    ...
    statuses: Union[None, Unset, list[GetSavedSearchRunProfilesBodyStatusesType0Item]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_statuses(data: object) -> Union[None, Unset, list[GetSavedSearchRunProfilesBodyStatusesType0Item]]:
            if data is None:
                return data
            ...
            try:
                ...
                for statuses_type_0_item_data in (_statuses_type_0):
                    statuses_type_0_item = GetSavedSearchRunProfilesBodyStatusesType0Item(statuses_type_0_item_data)
                ...
                pass
            return cast(Union[None, Unset, list[GetSavedSearchRunProfilesBodyStatusesType0Item]], data)
        ...
        get_saved_search_run_profiles_body = cls(
            api_key=api_key,
        ...
        get_saved_search_run_profiles_body.additional_properties = d
        return get_saved_search_run_profiles_body
