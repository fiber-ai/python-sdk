...
T = TypeVar("T", bound="GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyInvestmentStatsType0InvestmentsByStageType0Item")



@_attrs_define
class GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyInvestmentStatsType0InvestmentsByStageType0Item:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_saved_search_run_companies_response_200_output_companies_item_company_investment_stats_type_0_investments_by_stage_type_0_item = cls(
            stage=stage,
            lead_rate=lead_rate,
        ...
        get_saved_search_run_companies_response_200_output_companies_item_company_investment_stats_type_0_investments_by_stage_type_0_item.additional_properties = d
        return get_saved_search_run_companies_response_200_output_companies_item_company_investment_stats_type_0_investments_by_stage_type_0_item
