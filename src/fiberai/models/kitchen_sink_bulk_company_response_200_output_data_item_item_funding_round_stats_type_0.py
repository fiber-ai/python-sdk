...
if TYPE_CHECKING:
    from ..models.kitchen_sink_bulk_company_response_200_output_data_item_item_funding_round_stats_type_0_individual_investor_stats_type_0_item import (
        KitchenSinkBulkCompanyResponse200OutputDataItemItemFundingRoundStatsType0IndividualInvestorStatsType0Item,
    )
...
class KitchenSinkBulkCompanyResponse200OutputDataItemItemFundingRoundStatsType0:
    ...
    Attributes:
        ...
        individual_investor_stats
            (list[KitchenSinkBulkCompanyResponse200OutputDataItemItemFundingRoundStatsType0IndividualInvestorStatsType0Item]
            | None | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.kitchen_sink_bulk_company_response_200_output_data_item_item_funding_round_stats_type_0_individual_investor_stats_type_0_item import (
            KitchenSinkBulkCompanyResponse200OutputDataItemItemFundingRoundStatsType0IndividualInvestorStatsType0Item,  # noqa: PLC0415
        )
        ...
        def _parse_individual_investor_stats(
            ...
            try:
                ...
                for individual_investor_stats_type_0_item_data in _individual_investor_stats_type_0:
                    individual_investor_stats_type_0_item = KitchenSinkBulkCompanyResponse200OutputDataItemItemFundingRoundStatsType0IndividualInvestorStatsType0Item.from_dict(
