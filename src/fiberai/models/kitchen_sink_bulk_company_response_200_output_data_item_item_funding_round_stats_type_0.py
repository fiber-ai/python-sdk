...
if TYPE_CHECKING:
  from ..models.kitchen_sink_bulk_company_response_200_output_data_item_item_funding_round_stats_type_0_individual_investor_stats_type_0_item import KitchenSinkBulkCompanyResponse200OutputDataItemItemFundingRoundStatsType0IndividualInvestorStatsType0Item





T = TypeVar("T", bound="KitchenSinkBulkCompanyResponse200OutputDataItemItemFundingRoundStatsType0")



@_attrs_define
class KitchenSinkBulkCompanyResponse200OutputDataItemItemFundingRoundStatsType0:
    """ 
        Attributes:
            ...
            individual_investor_stats (Union[None, Unset, list['KitchenSinkBulkCompanyResponse200OutputDataItemItemFundingRo
                undStatsType0IndividualInvestorStatsType0Item']]):
    ...
    individual_investor_stats: Union[None, Unset, list['KitchenSinkBulkCompanyResponse200OutputDataItemItemFundingRoundStatsType0IndividualInvestorStatsType0Item']] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_individual_investor_stats(data: object) -> Union[None, Unset, list['KitchenSinkBulkCompanyResponse200OutputDataItemItemFundingRoundStatsType0IndividualInvestorStatsType0Item']]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for individual_investor_stats_type_0_item_data in (_individual_investor_stats_type_0):
                    individual_investor_stats_type_0_item = KitchenSinkBulkCompanyResponse200OutputDataItemItemFundingRoundStatsType0IndividualInvestorStatsType0Item.from_dict(individual_investor_stats_type_0_item_data)
                ...
                pass
            return cast(Union[None, Unset, list['KitchenSinkBulkCompanyResponse200OutputDataItemItemFundingRoundStatsType0IndividualInvestorStatsType0Item']], data)
        ...
        kitchen_sink_bulk_company_response_200_output_data_item_item_funding_round_stats_type_0 = cls(
        ...
        kitchen_sink_bulk_company_response_200_output_data_item_item_funding_round_stats_type_0.additional_properties = d
        return kitchen_sink_bulk_company_response_200_output_data_item_item_funding_round_stats_type_0
