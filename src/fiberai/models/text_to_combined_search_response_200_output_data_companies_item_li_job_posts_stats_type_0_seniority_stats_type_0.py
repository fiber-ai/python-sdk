...
if TYPE_CHECKING:
    from ..models.text_to_combined_search_response_200_output_data_companies_item_li_job_posts_stats_type_0_seniority_stats_type_0_associate import (
        TextToCombinedSearchResponse200OutputDataCompaniesItemLiJobPostsStatsType0SeniorityStatsType0Associate,
    )
    from ..models.text_to_combined_search_response_200_output_data_companies_item_li_job_posts_stats_type_0_seniority_stats_type_0_director import (
        TextToCombinedSearchResponse200OutputDataCompaniesItemLiJobPostsStatsType0SeniorityStatsType0Director,
    )
    from ..models.text_to_combined_search_response_200_output_data_companies_item_li_job_posts_stats_type_0_seniority_stats_type_0_entry_level import (
        TextToCombinedSearchResponse200OutputDataCompaniesItemLiJobPostsStatsType0SeniorityStatsType0EntryLevel,
    )
    from ..models.text_to_combined_search_response_200_output_data_companies_item_li_job_posts_stats_type_0_seniority_stats_type_0_executive import (
        TextToCombinedSearchResponse200OutputDataCompaniesItemLiJobPostsStatsType0SeniorityStatsType0Executive,
    )
    from ..models.text_to_combined_search_response_200_output_data_companies_item_li_job_posts_stats_type_0_seniority_stats_type_0_internship import (
        TextToCombinedSearchResponse200OutputDataCompaniesItemLiJobPostsStatsType0SeniorityStatsType0Internship,
    )
    from ..models.text_to_combined_search_response_200_output_data_companies_item_li_job_posts_stats_type_0_seniority_stats_type_0_mid_senior_level import (
        TextToCombinedSearchResponse200OutputDataCompaniesItemLiJobPostsStatsType0SeniorityStatsType0MidSeniorLevel,
    )
    from ..models.text_to_combined_search_response_200_output_data_companies_item_li_job_posts_stats_type_0_seniority_stats_type_0_not_applicable import (
...
class TextToCombinedSearchResponse200OutputDataCompaniesItemLiJobPostsStatsType0SeniorityStatsType0:
    ...
    Attributes:
        entry_level
            (TextToCombinedSearchResponse200OutputDataCompaniesItemLiJobPostsStatsType0SeniorityStatsType0EntryLevel |
            Unset):
        director (TextToCombinedSearchResponse200OutputDataCompaniesItemLiJobPostsStatsType0SeniorityStatsType0Director
            | Unset):
        associate
            (TextToCombinedSearchResponse200OutputDataCompaniesItemLiJobPostsStatsType0SeniorityStatsType0Associate |
            Unset):
    ...
    entry_level: (
        TextToCombinedSearchResponse200OutputDataCompaniesItemLiJobPostsStatsType0SeniorityStatsType0EntryLevel | Unset
    ) = UNSET
    director: (
        TextToCombinedSearchResponse200OutputDataCompaniesItemLiJobPostsStatsType0SeniorityStatsType0Director | Unset
    ) = UNSET
    associate: (
        TextToCombinedSearchResponse200OutputDataCompaniesItemLiJobPostsStatsType0SeniorityStatsType0Associate | Unset
    ) = UNSET
    mid_senior_level: (
        TextToCombinedSearchResponse200OutputDataCompaniesItemLiJobPostsStatsType0SeniorityStatsType0MidSeniorLevel
        | Unset
    ...
    internship: (
        TextToCombinedSearchResponse200OutputDataCompaniesItemLiJobPostsStatsType0SeniorityStatsType0Internship | Unset
    ) = UNSET
    executive: (
        TextToCombinedSearchResponse200OutputDataCompaniesItemLiJobPostsStatsType0SeniorityStatsType0Executive | Unset
    ) = UNSET
    not_applicable: (
        TextToCombinedSearchResponse200OutputDataCompaniesItemLiJobPostsStatsType0SeniorityStatsType0NotApplicable
        | Unset
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_entry_level, Unset):
            ...
            entry_level = TextToCombinedSearchResponse200OutputDataCompaniesItemLiJobPostsStatsType0SeniorityStatsType0EntryLevel.from_dict(
                _entry_level
            )
        ...
        if isinstance(_director, Unset):
            ...
            director = TextToCombinedSearchResponse200OutputDataCompaniesItemLiJobPostsStatsType0SeniorityStatsType0Director.from_dict(
                _director
            )
        ...
        if isinstance(_associate, Unset):
            ...
            associate = TextToCombinedSearchResponse200OutputDataCompaniesItemLiJobPostsStatsType0SeniorityStatsType0Associate.from_dict(
                _associate
            )
        ...
        if isinstance(_mid_senior_level, Unset):
            ...
            mid_senior_level = TextToCombinedSearchResponse200OutputDataCompaniesItemLiJobPostsStatsType0SeniorityStatsType0MidSeniorLevel.from_dict(
                _mid_senior_level
            )
        ...
        if isinstance(_internship, Unset):
            ...
            internship = TextToCombinedSearchResponse200OutputDataCompaniesItemLiJobPostsStatsType0SeniorityStatsType0Internship.from_dict(
                _internship
            )
        ...
        if isinstance(_executive, Unset):
            ...
            executive = TextToCombinedSearchResponse200OutputDataCompaniesItemLiJobPostsStatsType0SeniorityStatsType0Executive.from_dict(
                _executive
            )
        ...
        if isinstance(_not_applicable, Unset):
            ...
            not_applicable = TextToCombinedSearchResponse200OutputDataCompaniesItemLiJobPostsStatsType0SeniorityStatsType0NotApplicable.from_dict(
                _not_applicable
            )
