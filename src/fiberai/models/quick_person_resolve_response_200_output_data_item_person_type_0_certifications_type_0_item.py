...
T = TypeVar("T", bound="QuickPersonResolveResponse200OutputDataItemPersonType0CertificationsType0Item")


@_attrs_define
class QuickPersonResolveResponse200OutputDataItemPersonType0CertificationsType0Item:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        quick_person_resolve_response_200_output_data_item_person_type_0_certifications_type_0_item = cls(
            title=title,
        ...
        quick_person_resolve_response_200_output_data_item_person_type_0_certifications_type_0_item.additional_properties = d
        return quick_person_resolve_response_200_output_data_item_person_type_0_certifications_type_0_item
