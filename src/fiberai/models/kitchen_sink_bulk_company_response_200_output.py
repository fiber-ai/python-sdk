...
if TYPE_CHECKING:
    from ..models.kitchen_sink_bulk_company_response_200_output_data_item_item import (
        KitchenSinkBulkCompanyResponse200OutputDataItemItem,
    )


T = TypeVar("T", bound="KitchenSinkBulkCompanyResponse200Output")
...
class KitchenSinkBulkCompanyResponse200Output:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.kitchen_sink_bulk_company_response_200_output_data_item_item import (
            KitchenSinkBulkCompanyResponse200OutputDataItemItem,  # noqa: PLC0415
        )
        ...
        for data_item_data in _data:
            ...
            for data_item_item_data in _data_item:
                data_item_item = KitchenSinkBulkCompanyResponse200OutputDataItemItem.from_dict(data_item_item_data)
        ...
        kitchen_sink_bulk_company_response_200_output = cls(
            data=data,
            message=message,
        )

        kitchen_sink_bulk_company_response_200_output.additional_properties = d
        return kitchen_sink_bulk_company_response_200_output
