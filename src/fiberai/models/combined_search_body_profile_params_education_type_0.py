...
if TYPE_CHECKING:
    from ..models.combined_search_body_profile_params_education_type_0_all_of_type_0_item import (
        CombinedSearchBodyProfileParamsEducationType0AllOfType0Item,
    )
    from ..models.combined_search_body_profile_params_education_type_0_any_of_type_0_item import (
        CombinedSearchBodyProfileParamsEducationType0AnyOfType0Item,
    )
...
class CombinedSearchBodyProfileParamsEducationType0:
    """
    Attributes:
        any_of (list[CombinedSearchBodyProfileParamsEducationType0AnyOfType0Item] | None | Unset):
        all_of (list[CombinedSearchBodyProfileParamsEducationType0AllOfType0Item] | None | Unset):
    """

    any_of: list[CombinedSearchBodyProfileParamsEducationType0AnyOfType0Item] | None | Unset = UNSET
    all_of: list[CombinedSearchBodyProfileParamsEducationType0AllOfType0Item] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_any_of(
            data: object,
        ) -> list[CombinedSearchBodyProfileParamsEducationType0AnyOfType0Item] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for any_of_type_0_item_data in _any_of_type_0:
                    any_of_type_0_item = CombinedSearchBodyProfileParamsEducationType0AnyOfType0Item.from_dict(
                ...
                pass
            return cast(list[CombinedSearchBodyProfileParamsEducationType0AnyOfType0Item] | None | Unset, data)

        any_of = _parse_any_of(d.pop("anyOf", UNSET))

        def _parse_all_of(
            data: object,
        ) -> list[CombinedSearchBodyProfileParamsEducationType0AllOfType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for all_of_type_0_item_data in _all_of_type_0:
                    all_of_type_0_item = CombinedSearchBodyProfileParamsEducationType0AllOfType0Item.from_dict(
                ...
                pass
            return cast(list[CombinedSearchBodyProfileParamsEducationType0AllOfType0Item] | None | Unset, data)
