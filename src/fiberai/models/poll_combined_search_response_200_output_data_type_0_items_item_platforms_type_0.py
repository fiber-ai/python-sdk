...
T = TypeVar("T", bound="PollCombinedSearchResponse200OutputDataType0ItemsItemPlatformsType0")


@_attrs_define
class PollCombinedSearchResponse200OutputDataType0ItemsItemPlatformsType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        poll_combined_search_response_200_output_data_type_0_items_item_platforms_type_0 = cls(
            ecommerce=ecommerce,
            cms=cms,
            crm=crm,
            marketing=marketing,
        ...
        poll_combined_search_response_200_output_data_type_0_items_item_platforms_type_0.additional_properties = d
        return poll_combined_search_response_200_output_data_type_0_items_item_platforms_type_0
