...
T = TypeVar("T", bound="PollBatchLiveEnrichResponse200OutputResultsItemProfileType0EducationType0Item")


@_attrs_define
class PollBatchLiveEnrichResponse200OutputResultsItemProfileType0EducationType0Item:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        poll_batch_live_enrich_response_200_output_results_item_profile_type_0_education_type_0_item = cls(
            school_id=school_id,
        ...
        poll_batch_live_enrich_response_200_output_results_item_profile_type_0_education_type_0_item.additional_properties = d
        return poll_batch_live_enrich_response_200_output_results_item_profile_type_0_education_type_0_item
