...
if TYPE_CHECKING:
    from ..models.sync_combined_search_response_200_output_profiles_item_inferred_location_type_0_coordinates_type_0 import (
        SyncCombinedSearchResponse200OutputProfilesItemInferredLocationType0CoordinatesType0,
    )
...
class SyncCombinedSearchResponse200OutputProfilesItemInferredLocationType0:
    ...
    Attributes:
        ...
        coordinates (None | SyncCombinedSearchResponse200OutputProfilesItemInferredLocationType0CoordinatesType0 |
            Unset):
    ...
    coordinates: None | SyncCombinedSearchResponse200OutputProfilesItemInferredLocationType0CoordinatesType0 | Unset = (
        UNSET
    )
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.coordinates, Unset):
            ...
            self.coordinates, SyncCombinedSearchResponse200OutputProfilesItemInferredLocationType0CoordinatesType0
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_coordinates(
            data: object,
        ) -> None | SyncCombinedSearchResponse200OutputProfilesItemInferredLocationType0CoordinatesType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = (
                    SyncCombinedSearchResponse200OutputProfilesItemInferredLocationType0CoordinatesType0.from_dict(data)
                )
