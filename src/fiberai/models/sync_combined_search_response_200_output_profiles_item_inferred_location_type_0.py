...
if TYPE_CHECKING:
  from ..models.sync_combined_search_response_200_output_profiles_item_inferred_location_type_0_coordinates_type_0 import SyncCombinedSearchResponse200OutputProfilesItemInferredLocationType0CoordinatesType0





T = TypeVar("T", bound="SyncCombinedSearchResponse200OutputProfilesItemInferredLocationType0")



@_attrs_define
class SyncCombinedSearchResponse200OutputProfilesItemInferredLocationType0:
    """ 
        Attributes:
            ...
            coordinates (Union['SyncCombinedSearchResponse200OutputProfilesItemInferredLocationType0CoordinatesType0', None,
                Unset]):
    ...
    coordinates: Union['SyncCombinedSearchResponse200OutputProfilesItemInferredLocationType0CoordinatesType0', None, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.coordinates, Unset):
            coordinates = UNSET
        elif isinstance(self.coordinates, SyncCombinedSearchResponse200OutputProfilesItemInferredLocationType0CoordinatesType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_coordinates(data: object) -> Union['SyncCombinedSearchResponse200OutputProfilesItemInferredLocationType0CoordinatesType0', None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = SyncCombinedSearchResponse200OutputProfilesItemInferredLocationType0CoordinatesType0.from_dict(data)
                ...
                pass
            return cast(Union['SyncCombinedSearchResponse200OutputProfilesItemInferredLocationType0CoordinatesType0', None, Unset], data)
        ...
        sync_combined_search_response_200_output_profiles_item_inferred_location_type_0 = cls(
        ...
        sync_combined_search_response_200_output_profiles_item_inferred_location_type_0.additional_properties = d
        return sync_combined_search_response_200_output_profiles_item_inferred_location_type_0
