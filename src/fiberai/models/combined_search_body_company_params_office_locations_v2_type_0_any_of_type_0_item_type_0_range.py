...
T = TypeVar("T", bound="CombinedSearchBodyCompanyParamsOfficeLocationsV2Type0AnyOfType0ItemType0Range")


@_attrs_define
class CombinedSearchBodyCompanyParamsOfficeLocationsV2Type0AnyOfType0ItemType0Range:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        combined_search_body_company_params_office_locations_v2_type_0_any_of_type_0_item_type_0_range = cls(
            lower_bound=lower_bound,
            upper_bound=upper_bound,
        )

        combined_search_body_company_params_office_locations_v2_type_0_any_of_type_0_item_type_0_range.additional_properties = d
        return combined_search_body_company_params_office_locations_v2_type_0_any_of_type_0_item_type_0_range
