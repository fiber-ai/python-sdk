...
T = TypeVar("T", bound="CreateTrackerCompanyListBodyCompanySearchParamsType0SpecialFlagsType0")


@_attrs_define
class CreateTrackerCompanyListBodyCompanySearchParamsType0SpecialFlagsType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_tracker_company_list_body_company_search_params_type_0_special_flags_type_0 = cls(
            exclude_yc_companies=exclude_yc_companies,
        )

        create_tracker_company_list_body_company_search_params_type_0_special_flags_type_0.additional_properties = d
        return create_tracker_company_list_body_company_search_params_type_0_special_flags_type_0
