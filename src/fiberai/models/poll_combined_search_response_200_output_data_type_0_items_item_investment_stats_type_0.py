...
if TYPE_CHECKING:
    from ..models.poll_combined_search_response_200_output_data_type_0_items_item_investment_stats_type_0_investments_by_stage_type_0_item import (
        PollCombinedSearchResponse200OutputDataType0ItemsItemInvestmentStatsType0InvestmentsByStageType0Item,
    )
        ...
        def _parse_investments_by_stage(
            ...
            try:
                ...
                for investments_by_stage_type_0_item_data in _investments_by_stage_type_0:
                    investments_by_stage_type_0_item = PollCombinedSearchResponse200OutputDataType0ItemsItemInvestmentStatsType0InvestmentsByStageType0Item.from_dict(
