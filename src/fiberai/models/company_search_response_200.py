...
if TYPE_CHECKING:
    ...
    from ..models.company_search_response_200_charge_info_type_4 import CompanySearchResponse200ChargeInfoType4
...
class CompanySearchResponse200:
    ...
    Attributes:
        ...
        charge_info (CompanySearchResponse200ChargeInfoType0 | CompanySearchResponse200ChargeInfoType1 |
            CompanySearchResponse200ChargeInfoType2 | CompanySearchResponse200ChargeInfoType3 |
            CompanySearchResponse200ChargeInfoType4):
        warnings (list[CompanySearchResponse200WarningsType0Item] | None | Unset): Warnings about extraneous fields in
            request
    ...
    output: CompanySearchResponse200Output
    charge_info: (
        CompanySearchResponse200ChargeInfoType0
        | CompanySearchResponse200ChargeInfoType1
        | CompanySearchResponse200ChargeInfoType2
        | CompanySearchResponse200ChargeInfoType3
        | CompanySearchResponse200ChargeInfoType4
    )
    warnings: list[CompanySearchResponse200WarningsType0Item] | None | Unset = UNSET
    advice: list[str] | None | Unset = UNSET

    def to_dict(self) -> dict[str, Any]:
        from ..models.company_search_response_200_charge_info_type_0 import (
            CompanySearchResponse200ChargeInfoType0,  # noqa: PLC0415
        )
        from ..models.company_search_response_200_charge_info_type_1 import (
            CompanySearchResponse200ChargeInfoType1,  # noqa: PLC0415
        )
        from ..models.company_search_response_200_charge_info_type_2 import (
            CompanySearchResponse200ChargeInfoType2,  # noqa: PLC0415
        )
        from ..models.company_search_response_200_charge_info_type_3 import (
            CompanySearchResponse200ChargeInfoType3,  # noqa: PLC0415
        )
        ...
        if isinstance(self.charge_info, CompanySearchResponse200ChargeInfoType0):
            ...
            charge_info = self.charge_info.to_dict()
        elif isinstance(self.charge_info, CompanySearchResponse200ChargeInfoType3):
            charge_info = self.charge_info.to_dict()
        else:
            charge_info = self.charge_info.to_dict()
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.company_search_response_200_charge_info_type_4 import (
            CompanySearchResponse200ChargeInfoType4,  # noqa: PLC0415
        )
        from ..models.company_search_response_200_output import CompanySearchResponse200Output  # noqa: PLC0415
        from ..models.company_search_response_200_warnings_type_0_item import (
            CompanySearchResponse200WarningsType0Item,  # noqa: PLC0415
        )
        ...
        def _parse_charge_info(
            ...
            if not isinstance(data, dict):
                raise TypeError()
            charge_info_type_4 = CompanySearchResponse200ChargeInfoType4.from_dict(data)

            return charge_info_type_4

        charge_info = _parse_charge_info(d.pop("chargeInfo"))

        def _parse_warnings(data: object) -> list[CompanySearchResponse200WarningsType0Item] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for warnings_type_0_item_data in _warnings_type_0:
                    warnings_type_0_item = CompanySearchResponse200WarningsType0Item.from_dict(
                ...
                pass
            return cast(list[CompanySearchResponse200WarningsType0Item] | None | Unset, data)
