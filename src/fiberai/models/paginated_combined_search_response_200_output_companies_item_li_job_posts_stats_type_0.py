...
T = TypeVar("T", bound="PaginatedCombinedSearchResponse200OutputCompaniesItemLiJobPostsStatsType0")


@_attrs_define
class PaginatedCombinedSearchResponse200OutputCompaniesItemLiJobPostsStatsType0:
    """
    Attributes:
        total_count (float):
        seniority_stats (None |
            PaginatedCombinedSearchResponse200OutputCompaniesItemLiJobPostsStatsType0SeniorityStatsType0 | Unset):
        employment_type_stats (None |
            PaginatedCombinedSearchResponse200OutputCompaniesItemLiJobPostsStatsType0EmploymentTypeStatsType0 | Unset):
        country_location_stats (None |
            PaginatedCombinedSearchResponse200OutputCompaniesItemLiJobPostsStatsType0CountryLocationStatsType0 | Unset):
        puree_job_functions_stats (None |
            PaginatedCombinedSearchResponse200OutputCompaniesItemLiJobPostsStatsType0PureeJobFunctionsStatsType0 | Unset):
        standard_industries_stats (None |
            PaginatedCombinedSearchResponse200OutputCompaniesItemLiJobPostsStatsType0StandardIndustriesStatsType0 | Unset):
        job_location_type_stats (None |
            PaginatedCombinedSearchResponse200OutputCompaniesItemLiJobPostsStatsType0JobLocationTypeStatsType0 | Unset):
    """

    total_count: float
    seniority_stats: (
        None | PaginatedCombinedSearchResponse200OutputCompaniesItemLiJobPostsStatsType0SeniorityStatsType0 | Unset
    ) = UNSET
    employment_type_stats: (
        None | PaginatedCombinedSearchResponse200OutputCompaniesItemLiJobPostsStatsType0EmploymentTypeStatsType0 | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_seniority_stats(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                seniority_stats_type_0 = PaginatedCombinedSearchResponse200OutputCompaniesItemLiJobPostsStatsType0SeniorityStatsType0.from_dict(
                    data
                )
        ...
        def _parse_employment_type_stats(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                employment_type_stats_type_0 = PaginatedCombinedSearchResponse200OutputCompaniesItemLiJobPostsStatsType0EmploymentTypeStatsType0.from_dict(
                    data
                )
        ...
        def _parse_country_location_stats(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                country_location_stats_type_0 = PaginatedCombinedSearchResponse200OutputCompaniesItemLiJobPostsStatsType0CountryLocationStatsType0.from_dict(
                    data
                )
        ...
        def _parse_puree_job_functions_stats(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                puree_job_functions_stats_type_0 = PaginatedCombinedSearchResponse200OutputCompaniesItemLiJobPostsStatsType0PureeJobFunctionsStatsType0.from_dict(
                    data
                )
        ...
        def _parse_standard_industries_stats(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                standard_industries_stats_type_0 = PaginatedCombinedSearchResponse200OutputCompaniesItemLiJobPostsStatsType0StandardIndustriesStatsType0.from_dict(
                    data
                )
        ...
        def _parse_job_location_type_stats(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                job_location_type_stats_type_0 = PaginatedCombinedSearchResponse200OutputCompaniesItemLiJobPostsStatsType0JobLocationTypeStatsType0.from_dict(
                    data
                )
        ...
        paginated_combined_search_response_200_output_companies_item_li_job_posts_stats_type_0 = cls(
            total_count=total_count,
        ...
        paginated_combined_search_response_200_output_companies_item_li_job_posts_stats_type_0.additional_properties = d
        return paginated_combined_search_response_200_output_companies_item_li_job_posts_stats_type_0
