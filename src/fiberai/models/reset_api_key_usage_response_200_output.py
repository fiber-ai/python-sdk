...
T = TypeVar("T", bound="ResetApiKeyUsageResponse200Output")


@_attrs_define
class ResetApiKeyUsageResponse200Output:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reset_api_key_usage_response_200_output = cls(
            id=id,
            name=name,
            prefix=prefix,
        ...
        reset_api_key_usage_response_200_output.additional_properties = d
        return reset_api_key_usage_response_200_output
