...
if TYPE_CHECKING:
  from ..models.post_comments_live_fetch_response_200_output_data_item_commenter_type_0 import PostCommentsLiveFetchResponse200OutputDataItemCommenterType0
  from ..models.post_comments_live_fetch_response_200_output_data_item_reactions_by_type_type_0_item import PostCommentsLiveFetchResponse200OutputDataItemReactionsByTypeType0Item
  from ..models.post_comments_live_fetch_response_200_output_data_item_comments_type_0_item import PostCommentsLiveFetchResponse200OutputDataItemCommentsType0Item
...
class PostCommentsLiveFetchResponse200OutputDataItem:
    """ 
        Attributes:
            ...
            commenter (Union['PostCommentsLiveFetchResponse200OutputDataItemCommenterType0', None, Unset]):
            num_reactions (Union[None, Unset, float]):
            num_comments (Union[None, Unset, float]):
            reactions_by_type (Union[None, Unset,
                list['PostCommentsLiveFetchResponse200OutputDataItemReactionsByTypeType0Item']]):
            created_at (Union[None, Unset, str]):
            comments (Union[None, Unset, list['PostCommentsLiveFetchResponse200OutputDataItemCommentsType0Item']]):
     """

    commentary: Union[None, Unset, str] = UNSET
    commenter: Union['PostCommentsLiveFetchResponse200OutputDataItemCommenterType0', None, Unset] = UNSET
    num_reactions: Union[None, Unset, float] = UNSET
    num_comments: Union[None, Unset, float] = UNSET
    reactions_by_type: Union[None, Unset, list['PostCommentsLiveFetchResponse200OutputDataItemReactionsByTypeType0Item']] = UNSET
    created_at: Union[None, Unset, str] = UNSET
    comments: Union[None, Unset, list['PostCommentsLiveFetchResponse200OutputDataItemCommentsType0Item']] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_commenter(data: object) -> Union['PostCommentsLiveFetchResponse200OutputDataItemCommenterType0', None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(Union['PostCommentsLiveFetchResponse200OutputDataItemCommenterType0', None, Unset], data)
        ...
        def _parse_reactions_by_type(data: object) -> Union[None, Unset, list['PostCommentsLiveFetchResponse200OutputDataItemReactionsByTypeType0Item']]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for reactions_by_type_type_0_item_data in (_reactions_by_type_type_0):
                    reactions_by_type_type_0_item = PostCommentsLiveFetchResponse200OutputDataItemReactionsByTypeType0Item.from_dict(reactions_by_type_type_0_item_data)
                ...
                pass
            return cast(Union[None, Unset, list['PostCommentsLiveFetchResponse200OutputDataItemReactionsByTypeType0Item']], data)
        ...
        def _parse_comments(data: object) -> Union[None, Unset, list['PostCommentsLiveFetchResponse200OutputDataItemCommentsType0Item']]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for comments_type_0_item_data in (_comments_type_0):
                    comments_type_0_item = PostCommentsLiveFetchResponse200OutputDataItemCommentsType0Item.from_dict(comments_type_0_item_data)
                ...
                pass
            return cast(Union[None, Unset, list['PostCommentsLiveFetchResponse200OutputDataItemCommentsType0Item']], data)
