...
T = TypeVar("T", bound="GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyAcquisitionsType0Item")



@_attrs_define
class GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyAcquisitionsType0Item:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_saved_search_run_companies_response_200_output_companies_item_company_acquisitions_type_0_item = cls(
            price_usd=price_usd,
        ...
        get_saved_search_run_companies_response_200_output_companies_item_company_acquisitions_type_0_item.additional_properties = d
        return get_saved_search_run_companies_response_200_output_companies_item_company_acquisitions_type_0_item
