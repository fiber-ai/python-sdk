...
T = TypeVar("T", bound="YoutubeTranscriptResponse200ChargeInfoType2LowCreditAlertType0")


@_attrs_define
class YoutubeTranscriptResponse200ChargeInfoType2LowCreditAlertType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        youtube_transcript_response_200_charge_info_type_2_low_credit_alert_type_0 = cls(
            get_more_credits_url=get_more_credits_url,
            message=message,
            available_credits=available_credits,
        )

        youtube_transcript_response_200_charge_info_type_2_low_credit_alert_type_0.additional_properties = d
        return youtube_transcript_response_200_charge_info_type_2_low_credit_alert_type_0
