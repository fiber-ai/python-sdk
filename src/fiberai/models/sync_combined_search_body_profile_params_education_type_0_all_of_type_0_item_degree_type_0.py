...
T = TypeVar("T", bound="SyncCombinedSearchBodyProfileParamsEducationType0AllOfType0ItemDegreeType0")



@_attrs_define
class SyncCombinedSearchBodyProfileParamsEducationType0AllOfType0ItemDegreeType0:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sync_combined_search_body_profile_params_education_type_0_all_of_type_0_item_degree_type_0 = cls(
            any_of=any_of,
            none_of=none_of,
        )


        sync_combined_search_body_profile_params_education_type_0_all_of_type_0_item_degree_type_0.additional_properties = d
        return sync_combined_search_body_profile_params_education_type_0_all_of_type_0_item_degree_type_0
