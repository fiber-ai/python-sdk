...
if TYPE_CHECKING:
    ...
    from ..models.get_auto_topup_settings_response_200_charge_info_type_1 import (
        GetAutoTopupSettingsResponse200ChargeInfoType1,
    )
    from ..models.get_auto_topup_settings_response_200_charge_info_type_2 import (
        GetAutoTopupSettingsResponse200ChargeInfoType2,
    )
...
T = TypeVar("T", bound="GetAutoTopupSettingsResponse200")
...
class GetAutoTopupSettingsResponse200:
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.get_auto_topup_settings_response_200_charge_info_type_0 import (
            GetAutoTopupSettingsResponse200ChargeInfoType0,  # noqa: PLC0415
        )
        from ..models.get_auto_topup_settings_response_200_charge_info_type_1 import (
            GetAutoTopupSettingsResponse200ChargeInfoType1,  # noqa: PLC0415
        )
        from ..models.get_auto_topup_settings_response_200_charge_info_type_2 import (
            GetAutoTopupSettingsResponse200ChargeInfoType2,  # noqa: PLC0415
        )
        from ..models.get_auto_topup_settings_response_200_charge_info_type_3 import (
            GetAutoTopupSettingsResponse200ChargeInfoType3,  # noqa: PLC0415
        )
        ...
        elif isinstance(self.charge_info, GetAutoTopupSettingsResponse200ChargeInfoType1):
            charge_info = self.charge_info.to_dict()
        elif isinstance(self.charge_info, GetAutoTopupSettingsResponse200ChargeInfoType2):
            charge_info = self.charge_info.to_dict()
        elif isinstance(self.charge_info, GetAutoTopupSettingsResponse200ChargeInfoType3):
            charge_info = self.charge_info.to_dict()
        else:
            charge_info = self.charge_info.to_dict()
        ...
        def _parse_charge_info(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_0 = GetAutoTopupSettingsResponse200ChargeInfoType0.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_1 = GetAutoTopupSettingsResponse200ChargeInfoType1.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_2 = GetAutoTopupSettingsResponse200ChargeInfoType2.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_3 = GetAutoTopupSettingsResponse200ChargeInfoType3.from_dict(data)
            ...
            if not isinstance(data, dict):
                raise TypeError()
            charge_info_type_4 = GetAutoTopupSettingsResponse200ChargeInfoType4.from_dict(data)
        ...
        def _parse_warnings(data: object) -> list[GetAutoTopupSettingsResponse200WarningsType0Item] | None | Unset:
            ...
            try:
                ...
                for warnings_type_0_item_data in _warnings_type_0:
                    warnings_type_0_item = GetAutoTopupSettingsResponse200WarningsType0Item.from_dict(
                ...
                pass
            return cast(list[GetAutoTopupSettingsResponse200WarningsType0Item] | None | Unset, data)
