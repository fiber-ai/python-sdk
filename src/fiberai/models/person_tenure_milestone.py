...
T = TypeVar("T", bound="PersonTenureMilestone")


@_attrs_define
class PersonTenureMilestone:
    """
    Attributes:
        type_ (Literal['person_tenure_milestone']):
        entity_type (Literal['person']):
        threshold_months (int): Alert when the person has been at their current company for at least this many months,
            regardless of role changes or promotions.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        type_ = cast(Literal["person_tenure_milestone"], d.pop("type"))
        if type_ != "person_tenure_milestone":
            raise ValueError(f"type must match const 'person_tenure_milestone', got '{type_}'")
        ...
        threshold_months = d.pop("thresholdMonths")
        ...
        person_tenure_milestone.additional_properties = d
        return person_tenure_milestone
