...
T = TypeVar("T", bound="PaginatedCombinedSearchResponse200OutputProfilesItemInferredLocationType0")


@_attrs_define
class PaginatedCombinedSearchResponse200OutputProfilesItemInferredLocationType0:
    """
    Attributes:
        ...
        coordinates (None | PaginatedCombinedSearchResponse200OutputProfilesItemInferredLocationType0CoordinatesType0 |
            Unset):
    ...
    coordinates: (
        None | PaginatedCombinedSearchResponse200OutputProfilesItemInferredLocationType0CoordinatesType0 | Unset
    ) = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.coordinates, Unset):
            ...
            self.coordinates, PaginatedCombinedSearchResponse200OutputProfilesItemInferredLocationType0CoordinatesType0
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_coordinates(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = (
                    PaginatedCombinedSearchResponse200OutputProfilesItemInferredLocationType0CoordinatesType0.from_dict(
                        data
                    )
                )
        ...
        paginated_combined_search_response_200_output_profiles_item_inferred_location_type_0 = cls(
        ...
        paginated_combined_search_response_200_output_profiles_item_inferred_location_type_0.additional_properties = d
        return paginated_combined_search_response_200_output_profiles_item_inferred_location_type_0
