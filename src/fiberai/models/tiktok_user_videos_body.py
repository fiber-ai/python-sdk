...
T = TypeVar("T", bound="TiktokUserVideosBody")


@_attrs_define
class TiktokUserVideosBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        tiktok_user_videos_body = cls(
            api_key=api_key,
            handle=handle,
            next_page_token=next_page_token,
        )

        tiktok_user_videos_body.additional_properties = d
        return tiktok_user_videos_body
