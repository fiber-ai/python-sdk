...
T = TypeVar("T", bound="CombinedSearchCountBodyCompanyParamsSpecialFlagsType0")


@_attrs_define
class CombinedSearchCountBodyCompanyParamsSpecialFlagsType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        combined_search_count_body_company_params_special_flags_type_0 = cls(
            exclude_yc_companies=exclude_yc_companies,
        )

        combined_search_count_body_company_params_special_flags_type_0.additional_properties = d
        return combined_search_count_body_company_params_special_flags_type_0
