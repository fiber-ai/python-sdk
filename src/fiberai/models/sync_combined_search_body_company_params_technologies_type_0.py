...
if TYPE_CHECKING:
    from ..models.sync_combined_search_body_company_params_technologies_type_0_all_of_type_0_item_type_0 import (
        SyncCombinedSearchBodyCompanyParamsTechnologiesType0AllOfType0ItemType0,
    )
    from ..models.sync_combined_search_body_company_params_technologies_type_0_all_of_type_0_item_type_1 import (
        SyncCombinedSearchBodyCompanyParamsTechnologiesType0AllOfType0ItemType1,
    )
    from ..models.sync_combined_search_body_company_params_technologies_type_0_any_of_type_0_item_type_0 import (
        SyncCombinedSearchBodyCompanyParamsTechnologiesType0AnyOfType0ItemType0,
    )
    from ..models.sync_combined_search_body_company_params_technologies_type_0_any_of_type_0_item_type_1 import (
        SyncCombinedSearchBodyCompanyParamsTechnologiesType0AnyOfType0ItemType1,
    )
    from ..models.sync_combined_search_body_company_params_technologies_type_0_none_of_type_0_item_type_0 import (
        SyncCombinedSearchBodyCompanyParamsTechnologiesType0NoneOfType0ItemType0,
    )
    from ..models.sync_combined_search_body_company_params_technologies_type_0_none_of_type_0_item_type_1 import (
...
class SyncCombinedSearchBodyCompanyParamsTechnologiesType0:
    """
    Attributes:
        any_of (list[SyncCombinedSearchBodyCompanyParamsTechnologiesType0AnyOfType0ItemType0 |
            SyncCombinedSearchBodyCompanyParamsTechnologiesType0AnyOfType0ItemType1] | None | Unset):
        all_of (list[SyncCombinedSearchBodyCompanyParamsTechnologiesType0AllOfType0ItemType0 |
            SyncCombinedSearchBodyCompanyParamsTechnologiesType0AllOfType0ItemType1] | None | Unset):
        none_of (list[SyncCombinedSearchBodyCompanyParamsTechnologiesType0NoneOfType0ItemType0 |
            SyncCombinedSearchBodyCompanyParamsTechnologiesType0NoneOfType0ItemType1] | None | Unset):
    """
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.any_of, Unset):
            ...
            for any_of_type_0_item_data in self.any_of:
                ...
                if isinstance(
                    any_of_type_0_item_data, SyncCombinedSearchBodyCompanyParamsTechnologiesType0AnyOfType0ItemType0
                ):
        ...
        if isinstance(self.all_of, Unset):
            ...
            for all_of_type_0_item_data in self.all_of:
                ...
                if isinstance(
                    all_of_type_0_item_data, SyncCombinedSearchBodyCompanyParamsTechnologiesType0AllOfType0ItemType0
                ):
        ...
        if isinstance(self.none_of, Unset):
            ...
            for none_of_type_0_item_data in self.none_of:
                ...
                if isinstance(
                    none_of_type_0_item_data, SyncCombinedSearchBodyCompanyParamsTechnologiesType0NoneOfType0ItemType0
                ):
                    ...
                    def _parse_any_of_type_0_item(
                        ...
                        try:
                            ...
                            any_of_type_0_item_type_0 = (
                                SyncCombinedSearchBodyCompanyParamsTechnologiesType0AnyOfType0ItemType0.from_dict(data)
                            )
                        ...
                        any_of_type_0_item_type_1 = (
                            SyncCombinedSearchBodyCompanyParamsTechnologiesType0AnyOfType0ItemType1.from_dict(data)
                        )
                    ...
                    def _parse_all_of_type_0_item(
                        ...
                        try:
                            ...
                            all_of_type_0_item_type_0 = (
                                SyncCombinedSearchBodyCompanyParamsTechnologiesType0AllOfType0ItemType0.from_dict(data)
                            )
                        ...
                        all_of_type_0_item_type_1 = (
                            SyncCombinedSearchBodyCompanyParamsTechnologiesType0AllOfType0ItemType1.from_dict(data)
                        )
                    ...
                    def _parse_none_of_type_0_item(
                        ...
                        try:
                            ...
                            none_of_type_0_item_type_0 = (
                                SyncCombinedSearchBodyCompanyParamsTechnologiesType0NoneOfType0ItemType0.from_dict(data)
                            )
                        ...
                        none_of_type_0_item_type_1 = (
                            SyncCombinedSearchBodyCompanyParamsTechnologiesType0NoneOfType0ItemType1.from_dict(data)
                        )
