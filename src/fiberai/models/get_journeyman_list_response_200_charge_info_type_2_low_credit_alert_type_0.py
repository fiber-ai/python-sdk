...
T = TypeVar("T", bound="GetJourneymanListResponse200ChargeInfoType2LowCreditAlertType0")


@_attrs_define
class GetJourneymanListResponse200ChargeInfoType2LowCreditAlertType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_journeyman_list_response_200_charge_info_type_2_low_credit_alert_type_0 = cls(
            get_more_credits_url=get_more_credits_url,
            message=message,
            available_credits=available_credits,
        )

        get_journeyman_list_response_200_charge_info_type_2_low_credit_alert_type_0.additional_properties = d
        return get_journeyman_list_response_200_charge_info_type_2_low_credit_alert_type_0
