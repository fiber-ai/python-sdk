...
if TYPE_CHECKING:
    from ..models.kitchen_sink_company_response_200_output_data_item_full_funding_rounds_type_0_item_investors_type_0_item import (
        KitchenSinkCompanyResponse200OutputDataItemFullFundingRoundsType0ItemInvestorsType0Item,
    )
...
class KitchenSinkCompanyResponse200OutputDataItemFullFundingRoundsType0Item:
    """
    Attributes:
        investors (list[KitchenSinkCompanyResponse200OutputDataItemFullFundingRoundsType0ItemInvestorsType0Item] | None
            | Unset):
    ...
    investors: (
        list[KitchenSinkCompanyResponse200OutputDataItemFullFundingRoundsType0ItemInvestorsType0Item] | None | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.kitchen_sink_company_response_200_output_data_item_full_funding_rounds_type_0_item_investors_type_0_item import (
            KitchenSinkCompanyResponse200OutputDataItemFullFundingRoundsType0ItemInvestorsType0Item,  # noqa: PLC0415
        )
        ...
        def _parse_investors(
            ...
            try:
                ...
                for investors_type_0_item_data in _investors_type_0:
                    investors_type_0_item = KitchenSinkCompanyResponse200OutputDataItemFullFundingRoundsType0ItemInvestorsType0Item.from_dict(
