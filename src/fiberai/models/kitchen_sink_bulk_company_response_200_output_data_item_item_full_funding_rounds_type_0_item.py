...
if TYPE_CHECKING:
  from ..models.kitchen_sink_bulk_company_response_200_output_data_item_item_full_funding_rounds_type_0_item_investors_type_0_item import KitchenSinkBulkCompanyResponse200OutputDataItemItemFullFundingRoundsType0ItemInvestorsType0Item





T = TypeVar("T", bound="KitchenSinkBulkCompanyResponse200OutputDataItemItemFullFundingRoundsType0Item")



@_attrs_define
class KitchenSinkBulkCompanyResponse200OutputDataItemItemFullFundingRoundsType0Item:
    """ 
        Attributes:
            investors (Union[None, Unset,
                list['KitchenSinkBulkCompanyResponse200OutputDataItemItemFullFundingRoundsType0ItemInvestorsType0Item']]):
    ...
    investors: Union[None, Unset, list['KitchenSinkBulkCompanyResponse200OutputDataItemItemFullFundingRoundsType0ItemInvestorsType0Item']] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.kitchen_sink_bulk_company_response_200_output_data_item_item_full_funding_rounds_type_0_item_investors_type_0_item import KitchenSinkBulkCompanyResponse200OutputDataItemItemFullFundingRoundsType0ItemInvestorsType0Item
        d = dict(src_dict)
        def _parse_investors(data: object) -> Union[None, Unset, list['KitchenSinkBulkCompanyResponse200OutputDataItemItemFullFundingRoundsType0ItemInvestorsType0Item']]:
            if data is None:
                return data
            ...
            try:
                ...
                for investors_type_0_item_data in (_investors_type_0):
                    investors_type_0_item = KitchenSinkBulkCompanyResponse200OutputDataItemItemFullFundingRoundsType0ItemInvestorsType0Item.from_dict(investors_type_0_item_data)
                ...
                pass
            return cast(Union[None, Unset, list['KitchenSinkBulkCompanyResponse200OutputDataItemItemFullFundingRoundsType0ItemInvestorsType0Item']], data)
        ...
        kitchen_sink_bulk_company_response_200_output_data_item_item_full_funding_rounds_type_0_item = cls(
            investors=investors,
        ...
        kitchen_sink_bulk_company_response_200_output_data_item_item_full_funding_rounds_type_0_item.additional_properties = d
        return kitchen_sink_bulk_company_response_200_output_data_item_item_full_funding_rounds_type_0_item
