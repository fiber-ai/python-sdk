...
T = TypeVar("T", bound="PostCommentsLiveFetchResponse200OutputDataItemCommenterType0")



@_attrs_define
class PostCommentsLiveFetchResponse200OutputDataItemCommenterType0:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_comments_live_fetch_response_200_output_data_item_commenter_type_0 = cls(
        ...
        post_comments_live_fetch_response_200_output_data_item_commenter_type_0.additional_properties = d
        return post_comments_live_fetch_response_200_output_data_item_commenter_type_0
