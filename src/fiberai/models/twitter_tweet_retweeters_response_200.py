...
T = TypeVar("T", bound="TwitterTweetRetweetersResponse200")


@_attrs_define
class TwitterTweetRetweetersResponse200:
    """
    Attributes:
        output (TwitterTweetRetweetersResponse200Output):
        charge_info (TwitterTweetRetweetersResponse200ChargeInfoType0 | TwitterTweetRetweetersResponse200ChargeInfoType1
            | TwitterTweetRetweetersResponse200ChargeInfoType2 | TwitterTweetRetweetersResponse200ChargeInfoType3 |
            TwitterTweetRetweetersResponse200ChargeInfoType4):
        warnings (list[TwitterTweetRetweetersResponse200WarningsType0Item] | None | Unset): Warnings about extraneous
            fields in request
    ...
    warnings: list[TwitterTweetRetweetersResponse200WarningsType0Item] | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.charge_info, TwitterTweetRetweetersResponse200ChargeInfoType0):
            charge_info = self.charge_info.to_dict()
        elif isinstance(self.charge_info, TwitterTweetRetweetersResponse200ChargeInfoType1):
            charge_info = self.charge_info.to_dict()
        elif isinstance(self.charge_info, TwitterTweetRetweetersResponse200ChargeInfoType2):
            charge_info = self.charge_info.to_dict()
        elif isinstance(self.charge_info, TwitterTweetRetweetersResponse200ChargeInfoType3):
            charge_info = self.charge_info.to_dict()
        else:
            charge_info = self.charge_info.to_dict()
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        output = TwitterTweetRetweetersResponse200Output.from_dict(d.pop("output"))
        ...
        def _parse_charge_info(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_0 = TwitterTweetRetweetersResponse200ChargeInfoType0.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_1 = TwitterTweetRetweetersResponse200ChargeInfoType1.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_2 = TwitterTweetRetweetersResponse200ChargeInfoType2.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_3 = TwitterTweetRetweetersResponse200ChargeInfoType3.from_dict(data)
            ...
            if not isinstance(data, dict):
                raise TypeError()
            charge_info_type_4 = TwitterTweetRetweetersResponse200ChargeInfoType4.from_dict(data)

            return charge_info_type_4

        charge_info = _parse_charge_info(d.pop("chargeInfo"))

        def _parse_warnings(data: object) -> list[TwitterTweetRetweetersResponse200WarningsType0Item] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for warnings_type_0_item_data in _warnings_type_0:
                    warnings_type_0_item = TwitterTweetRetweetersResponse200WarningsType0Item.from_dict(
                ...
                pass
            return cast(list[TwitterTweetRetweetersResponse200WarningsType0Item] | None | Unset, data)
        ...
        twitter_tweet_retweeters_response_200 = cls(
            output=output,
        ...
        return twitter_tweet_retweeters_response_200
