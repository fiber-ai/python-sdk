...
T = TypeVar(
    "T",
    bound="JdToProfileSearchResponse200OutputUsedSearchParamsType0KeywordsV2Type0OptionsType0FieldsToSearchOverType0",
)


@_attrs_define
class JdToProfileSearchResponse200OutputUsedSearchParamsType0KeywordsV2Type0OptionsType0FieldsToSearchOverType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        jd_to_profile_search_response_200_output_used_search_params_type_0_keywords_v2_type_0_options_type_0_fields_to_search_over_type_0 = cls(
            summary=summary,
            headline=headline,
        ...
        jd_to_profile_search_response_200_output_used_search_params_type_0_keywords_v2_type_0_options_type_0_fields_to_search_over_type_0.additional_properties = d
        return jd_to_profile_search_response_200_output_used_search_params_type_0_keywords_v2_type_0_options_type_0_fields_to_search_over_type_0
