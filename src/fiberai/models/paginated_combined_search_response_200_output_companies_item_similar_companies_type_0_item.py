...
T = TypeVar("T", bound="PaginatedCombinedSearchResponse200OutputCompaniesItemSimilarCompaniesType0Item")


@_attrs_define
class PaginatedCombinedSearchResponse200OutputCompaniesItemSimilarCompaniesType0Item:
    """
    Attributes:
        name (None | str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        paginated_combined_search_response_200_output_companies_item_similar_companies_type_0_item = cls(
            name=name,
        ...
        paginated_combined_search_response_200_output_companies_item_similar_companies_type_0_item.additional_properties = d
        return paginated_combined_search_response_200_output_companies_item_similar_companies_type_0_item
