...
T = TypeVar("T", bound="PollExhaustiveContactEnrichmentResultResponse200")


@_attrs_define
class PollExhaustiveContactEnrichmentResultResponse200:
    """
    Attributes:
        output (PollExhaustiveContactEnrichmentResultResponse200Output):
        charge_info (PollExhaustiveContactEnrichmentResultResponse200ChargeInfoType0 |
            PollExhaustiveContactEnrichmentResultResponse200ChargeInfoType1 |
            PollExhaustiveContactEnrichmentResultResponse200ChargeInfoType2 |
            PollExhaustiveContactEnrichmentResultResponse200ChargeInfoType3 |
            PollExhaustiveContactEnrichmentResultResponse200ChargeInfoType4):
        warnings (list[PollExhaustiveContactEnrichmentResultResponse200WarningsType0Item] | None | Unset): Warnings
    ...
    warnings: list[PollExhaustiveContactEnrichmentResultResponse200WarningsType0Item] | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.charge_info, PollExhaustiveContactEnrichmentResultResponse200ChargeInfoType0):
            charge_info = self.charge_info.to_dict()
        elif isinstance(self.charge_info, PollExhaustiveContactEnrichmentResultResponse200ChargeInfoType1):
            charge_info = self.charge_info.to_dict()
        elif isinstance(self.charge_info, PollExhaustiveContactEnrichmentResultResponse200ChargeInfoType2):
            charge_info = self.charge_info.to_dict()
        elif isinstance(self.charge_info, PollExhaustiveContactEnrichmentResultResponse200ChargeInfoType3):
            charge_info = self.charge_info.to_dict()
        else:
            charge_info = self.charge_info.to_dict()
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        output = PollExhaustiveContactEnrichmentResultResponse200Output.from_dict(d.pop("output"))
        ...
        def _parse_charge_info(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_0 = PollExhaustiveContactEnrichmentResultResponse200ChargeInfoType0.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_1 = PollExhaustiveContactEnrichmentResultResponse200ChargeInfoType1.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_2 = PollExhaustiveContactEnrichmentResultResponse200ChargeInfoType2.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_3 = PollExhaustiveContactEnrichmentResultResponse200ChargeInfoType3.from_dict(data)
            ...
            if not isinstance(data, dict):
                raise TypeError()
            charge_info_type_4 = PollExhaustiveContactEnrichmentResultResponse200ChargeInfoType4.from_dict(data)
        ...
        def _parse_warnings(
            data: object,
        ) -> list[PollExhaustiveContactEnrichmentResultResponse200WarningsType0Item] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for warnings_type_0_item_data in _warnings_type_0:
                    warnings_type_0_item = PollExhaustiveContactEnrichmentResultResponse200WarningsType0Item.from_dict(
                ...
                pass
            return cast(list[PollExhaustiveContactEnrichmentResultResponse200WarningsType0Item] | None | Unset, data)
        ...
        poll_exhaustive_contact_enrichment_result_response_200 = cls(
            output=output,
        ...
        return poll_exhaustive_contact_enrichment_result_response_200
