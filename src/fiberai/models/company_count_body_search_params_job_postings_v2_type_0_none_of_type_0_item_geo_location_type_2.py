...
from ..models.company_count_body_search_params_job_postings_v2_type_0_none_of_type_0_item_geo_location_type_2_region import (
    CompanyCountBodySearchParamsJobPostingsV2Type0NoneOfType0ItemGeoLocationType2Region,
)
...
class CompanyCountBodySearchParamsJobPostingsV2Type0NoneOfType0ItemGeoLocationType2:
    ...
    Attributes:
        ...
        region (CompanyCountBodySearchParamsJobPostingsV2Type0NoneOfType0ItemGeoLocationType2Region):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        region = CompanyCountBodySearchParamsJobPostingsV2Type0NoneOfType0ItemGeoLocationType2Region(d.pop("region"))
