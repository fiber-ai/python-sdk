...
T = TypeVar("T", bound="SyncCombinedSearchBodyCompanyParamsSpecialFlagsType0")



@_attrs_define
class SyncCombinedSearchBodyCompanyParamsSpecialFlagsType0:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sync_combined_search_body_company_params_special_flags_type_0 = cls(
            exclude_yc_companies=exclude_yc_companies,
        )


        sync_combined_search_body_company_params_special_flags_type_0.additional_properties = d
        return sync_combined_search_body_company_params_special_flags_type_0
