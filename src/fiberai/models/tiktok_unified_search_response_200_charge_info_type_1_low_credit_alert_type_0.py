...
T = TypeVar("T", bound="TiktokUnifiedSearchResponse200ChargeInfoType1LowCreditAlertType0")


@_attrs_define
class TiktokUnifiedSearchResponse200ChargeInfoType1LowCreditAlertType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        tiktok_unified_search_response_200_charge_info_type_1_low_credit_alert_type_0 = cls(
            get_more_credits_url=get_more_credits_url,
            message=message,
            available_credits=available_credits,
        )

        tiktok_unified_search_response_200_charge_info_type_1_low_credit_alert_type_0.additional_properties = d
        return tiktok_unified_search_response_200_charge_info_type_1_low_credit_alert_type_0
