...
class CompanySearchResponse200OutputDataItemLiJobPostsStatsType0:
    ...
    Attributes:
        total_count (float):
        seniority_stats (CompanySearchResponse200OutputDataItemLiJobPostsStatsType0SeniorityStatsType0 | None | Unset):
        employment_type_stats (CompanySearchResponse200OutputDataItemLiJobPostsStatsType0EmploymentTypeStatsType0 | None
            | Unset):
        country_location_stats (CompanySearchResponse200OutputDataItemLiJobPostsStatsType0CountryLocationStatsType0 |
            None | Unset):
        puree_job_functions_stats (CompanySearchResponse200OutputDataItemLiJobPostsStatsType0PureeJobFunctionsStatsType0
            | None | Unset):
        standard_industries_stats
            (CompanySearchResponse200OutputDataItemLiJobPostsStatsType0StandardIndustriesStatsType0 | None | Unset):
        job_location_type_stats (CompanySearchResponse200OutputDataItemLiJobPostsStatsType0JobLocationTypeStatsType0 |
            None | Unset):
    """
    ...
    employment_type_stats: (
        CompanySearchResponse200OutputDataItemLiJobPostsStatsType0EmploymentTypeStatsType0 | None | Unset
    ) = UNSET
    country_location_stats: (
        CompanySearchResponse200OutputDataItemLiJobPostsStatsType0CountryLocationStatsType0 | None | Unset
    ) = UNSET
    puree_job_functions_stats: (
        CompanySearchResponse200OutputDataItemLiJobPostsStatsType0PureeJobFunctionsStatsType0 | None | Unset
    ) = UNSET
    standard_industries_stats: (
        CompanySearchResponse200OutputDataItemLiJobPostsStatsType0StandardIndustriesStatsType0 | None | Unset
    ) = UNSET
    job_location_type_stats: (
        CompanySearchResponse200OutputDataItemLiJobPostsStatsType0JobLocationTypeStatsType0 | None | Unset
    ) = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.seniority_stats, Unset):
            ...
            self.seniority_stats, CompanySearchResponse200OutputDataItemLiJobPostsStatsType0SeniorityStatsType0
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_seniority_stats(
            data: object,
        ) -> CompanySearchResponse200OutputDataItemLiJobPostsStatsType0SeniorityStatsType0 | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                seniority_stats_type_0 = (
                    CompanySearchResponse200OutputDataItemLiJobPostsStatsType0SeniorityStatsType0.from_dict(data)
                )
                ...
                pass
            return cast(
                CompanySearchResponse200OutputDataItemLiJobPostsStatsType0SeniorityStatsType0 | None | Unset, data
            )
        ...
        def _parse_employment_type_stats(
            ...
            try:
                ...
                employment_type_stats_type_0 = (
                    CompanySearchResponse200OutputDataItemLiJobPostsStatsType0EmploymentTypeStatsType0.from_dict(data)
                )
                ...
                pass
            return cast(
                CompanySearchResponse200OutputDataItemLiJobPostsStatsType0EmploymentTypeStatsType0 | None | Unset, data
            )
        ...
        def _parse_country_location_stats(
            ...
            try:
                ...
                country_location_stats_type_0 = (
                    CompanySearchResponse200OutputDataItemLiJobPostsStatsType0CountryLocationStatsType0.from_dict(data)
                )
                ...
                pass
            return cast(
                CompanySearchResponse200OutputDataItemLiJobPostsStatsType0CountryLocationStatsType0 | None | Unset, data
            )
        ...
        def _parse_puree_job_functions_stats(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                puree_job_functions_stats_type_0 = (
                    CompanySearchResponse200OutputDataItemLiJobPostsStatsType0PureeJobFunctionsStatsType0.from_dict(
                        data
                    )
                )
        ...
        def _parse_standard_industries_stats(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                standard_industries_stats_type_0 = (
                    CompanySearchResponse200OutputDataItemLiJobPostsStatsType0StandardIndustriesStatsType0.from_dict(
                        data
                    )
                )
        ...
        def _parse_job_location_type_stats(
            ...
            try:
                ...
                job_location_type_stats_type_0 = (
                    CompanySearchResponse200OutputDataItemLiJobPostsStatsType0JobLocationTypeStatsType0.from_dict(data)
                )
                ...
                pass
            return cast(
                CompanySearchResponse200OutputDataItemLiJobPostsStatsType0JobLocationTypeStatsType0 | None | Unset, data
            )
