...
if TYPE_CHECKING:
    from ..models.people_search_body_search_params_keyword_search_options_type_0_fields_to_search_over_type_0 import (
        PeopleSearchBodySearchParamsKeywordSearchOptionsType0FieldsToSearchOverType0,
    )
...
class PeopleSearchBodySearchParamsKeywordSearchOptionsType0:
    """
    Attributes:
        fields_to_search_over (None | PeopleSearchBodySearchParamsKeywordSearchOptionsType0FieldsToSearchOverType0 |
            Unset):
    """

    fields_to_search_over: (
        None | PeopleSearchBodySearchParamsKeywordSearchOptionsType0FieldsToSearchOverType0 | Unset
    ) = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        from ..models.people_search_body_search_params_keyword_search_options_type_0_fields_to_search_over_type_0 import (
            PeopleSearchBodySearchParamsKeywordSearchOptionsType0FieldsToSearchOverType0,  # noqa: PLC0415
        )
        ...
        if isinstance(self.fields_to_search_over, Unset):
            ...
            self.fields_to_search_over, PeopleSearchBodySearchParamsKeywordSearchOptionsType0FieldsToSearchOverType0
        ):
        ...
        def _parse_fields_to_search_over(
            ...
            try:
                ...
                fields_to_search_over_type_0 = (
                    PeopleSearchBodySearchParamsKeywordSearchOptionsType0FieldsToSearchOverType0.from_dict(data)
                )
                ...
                pass
            return cast(
                None | PeopleSearchBodySearchParamsKeywordSearchOptionsType0FieldsToSearchOverType0 | Unset, data
            )
