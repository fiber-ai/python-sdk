...
T = TypeVar("T", bound="CreateSavedSearchBodySearchParamsType2ProfileSearchParamsLeftStealthAtType0RangeType0")



@_attrs_define
class CreateSavedSearchBodySearchParamsType2ProfileSearchParamsLeftStealthAtType0RangeType0:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_saved_search_body_search_params_type_2_profile_search_params_left_stealth_at_type_0_range_type_0 = cls(
            lower_bound=lower_bound,
            upper_bound=upper_bound,
        )


        create_saved_search_body_search_params_type_2_profile_search_params_left_stealth_at_type_0_range_type_0.additional_properties = d
        return create_saved_search_body_search_params_type_2_profile_search_params_left_stealth_at_type_0_range_type_0
