...
T = TypeVar("T", bound="TiktokVideoCommentsBody")


@_attrs_define
class TiktokVideoCommentsBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        tiktok_video_comments_body = cls(
            api_key=api_key,
            video_url=video_url,
            next_page_token=next_page_token,
        )

        tiktok_video_comments_body.additional_properties = d
        return tiktok_video_comments_body
