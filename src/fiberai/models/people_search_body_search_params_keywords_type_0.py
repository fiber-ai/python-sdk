...
T = TypeVar("T", bound="PeopleSearchBodySearchParamsKeywordsType0")



@_attrs_define
class PeopleSearchBodySearchParamsKeywordsType0:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        people_search_body_search_params_keywords_type_0 = cls(
        ...
        people_search_body_search_params_keywords_type_0.additional_properties = d
        return people_search_body_search_params_keywords_type_0
