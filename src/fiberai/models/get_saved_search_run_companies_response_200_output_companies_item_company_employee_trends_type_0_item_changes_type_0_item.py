...
T = TypeVar("T", bound="GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyEmployeeTrendsType0ItemChangesType0Item")



@_attrs_define
class GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyEmployeeTrendsType0ItemChangesType0Item:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_saved_search_run_companies_response_200_output_companies_item_company_employee_trends_type_0_item_changes_type_0_item = cls(
            count_end=count_end,
        ...
        get_saved_search_run_companies_response_200_output_companies_item_company_employee_trends_type_0_item_changes_type_0_item.additional_properties = d
        return get_saved_search_run_companies_response_200_output_companies_item_company_employee_trends_type_0_item_changes_type_0_item
