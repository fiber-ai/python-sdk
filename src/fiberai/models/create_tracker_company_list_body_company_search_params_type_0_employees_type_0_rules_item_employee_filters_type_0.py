...
if TYPE_CHECKING:
    from ..models.create_tracker_company_list_body_company_search_params_type_0_employees_type_0_rules_item_employee_filters_type_0_recently_hired_type_0_item import (
        CreateTrackerCompanyListBodyCompanySearchParamsType0EmployeesType0RulesItemEmployeeFiltersType0RecentlyHiredType0Item,
    )


T = TypeVar(
    "T", bound="CreateTrackerCompanyListBodyCompanySearchParamsType0EmployeesType0RulesItemEmployeeFiltersType0"
)


@_attrs_define
class CreateTrackerCompanyListBodyCompanySearchParamsType0EmployeesType0RulesItemEmployeeFiltersType0:
    """
    Attributes:
        country_code (list[str] | None | Unset):
        job_title (list[str] | None | Unset):
        recently_hired (list[CreateTrackerCompanyListBodyCompanySearchParamsType0EmployeesType0RulesItemEmployeeFiltersT
            ype0RecentlyHiredType0Item] | None | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.create_tracker_company_list_body_company_search_params_type_0_employees_type_0_rules_item_employee_filters_type_0_recently_hired_type_0_item import (
            CreateTrackerCompanyListBodyCompanySearchParamsType0EmployeesType0RulesItemEmployeeFiltersType0RecentlyHiredType0Item,  # noqa: PLC0415
        )
        ...
        def _parse_recently_hired(
            ...
            try:
                ...
                for recently_hired_type_0_item_data in _recently_hired_type_0:
                    recently_hired_type_0_item = CreateTrackerCompanyListBodyCompanySearchParamsType0EmployeesType0RulesItemEmployeeFiltersType0RecentlyHiredType0Item.from_dict(
        ...
        create_tracker_company_list_body_company_search_params_type_0_employees_type_0_rules_item_employee_filters_type_0 = cls(
            country_code=country_code,
            job_title=job_title,
            recently_hired=recently_hired,
        )

        create_tracker_company_list_body_company_search_params_type_0_employees_type_0_rules_item_employee_filters_type_0.additional_properties = d
        return create_tracker_company_list_body_company_search_params_type_0_employees_type_0_rules_item_employee_filters_type_0
