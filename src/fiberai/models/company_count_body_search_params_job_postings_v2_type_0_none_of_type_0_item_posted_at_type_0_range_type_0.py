...
T = TypeVar("T", bound="CompanyCountBodySearchParamsJobPostingsV2Type0NoneOfType0ItemPostedAtType0RangeType0")



@_attrs_define
class CompanyCountBodySearchParamsJobPostingsV2Type0NoneOfType0ItemPostedAtType0RangeType0:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        company_count_body_search_params_job_postings_v2_type_0_none_of_type_0_item_posted_at_type_0_range_type_0 = cls(
            lower_bound=lower_bound,
            upper_bound=upper_bound,
        )


        company_count_body_search_params_job_postings_v2_type_0_none_of_type_0_item_posted_at_type_0_range_type_0.additional_properties = d
        return company_count_body_search_params_job_postings_v2_type_0_none_of_type_0_item_posted_at_type_0_range_type_0
