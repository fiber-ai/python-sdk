...
from ..models.poll_combined_search_response_200_output_data_type_1_items_item_experiences_type_0_item_academic_qualification_type_0_item import (
    PollCombinedSearchResponse200OutputDataType1ItemsItemExperiencesType0ItemAcademicQualificationType0Item,
)
from ..models.poll_combined_search_response_200_output_data_type_1_items_item_experiences_type_0_item_employment_type_type_0_item import (
    PollCombinedSearchResponse200OutputDataType1ItemsItemExperiencesType0ItemEmploymentTypeType0Item,
)
from ..models.poll_combined_search_response_200_output_data_type_1_items_item_experiences_type_0_item_job_function_type_0_item import (
    PollCombinedSearchResponse200OutputDataType1ItemsItemExperiencesType0ItemJobFunctionType0Item,
)
from ..models.poll_combined_search_response_200_output_data_type_1_items_item_experiences_type_0_item_seniority_type_1 import (
    PollCombinedSearchResponse200OutputDataType1ItemsItemExperiencesType0ItemSeniorityType1,
)
from ..models.poll_combined_search_response_200_output_data_type_1_items_item_experiences_type_0_item_seniority_type_2_type_1 import (
    PollCombinedSearchResponse200OutputDataType1ItemsItemExperiencesType0ItemSeniorityType2Type1,
)
from ..models.poll_combined_search_response_200_output_data_type_1_items_item_experiences_type_0_item_seniority_type_3_type_1 import (
...
class PollCombinedSearchResponse200OutputDataType1ItemsItemExperiencesType0Item:
    ...
    Attributes:
        ...
        seniority (None | PollCombinedSearchResponse200OutputDataType1ItemsItemExperiencesType0ItemSeniorityType1 |
            PollCombinedSearchResponse200OutputDataType1ItemsItemExperiencesType0ItemSeniorityType2Type1 |
            PollCombinedSearchResponse200OutputDataType1ItemsItemExperiencesType0ItemSeniorityType3Type1 | Unset):
        job_function
            (list[PollCombinedSearchResponse200OutputDataType1ItemsItemExperiencesType0ItemJobFunctionType0Item] | None |
            Unset):
        employment_type
            (list[PollCombinedSearchResponse200OutputDataType1ItemsItemExperiencesType0ItemEmploymentTypeType0Item] | None |
            Unset):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.seniority, Unset):
            ...
            self.seniority, PollCombinedSearchResponse200OutputDataType1ItemsItemExperiencesType0ItemSeniorityType1
        ):
            seniority = self.seniority.value
        elif isinstance(
            self.seniority, PollCombinedSearchResponse200OutputDataType1ItemsItemExperiencesType0ItemSeniorityType2Type1
        ):
            seniority = self.seniority.value
        elif isinstance(
            self.seniority, PollCombinedSearchResponse200OutputDataType1ItemsItemExperiencesType0ItemSeniorityType3Type1
        ):
            seniority = self.seniority.value
        else:
        ...
        def _parse_seniority(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                seniority_type_1 = (
                    PollCombinedSearchResponse200OutputDataType1ItemsItemExperiencesType0ItemSeniorityType1(data)
                )
            ...
            try:
                ...
                seniority_type_2_type_1 = (
                    PollCombinedSearchResponse200OutputDataType1ItemsItemExperiencesType0ItemSeniorityType2Type1(data)
                )
            ...
            try:
                ...
                seniority_type_3_type_1 = (
                    PollCombinedSearchResponse200OutputDataType1ItemsItemExperiencesType0ItemSeniorityType3Type1(data)
                )
        ...
        def _parse_employment_type(
            ...
            try:
                ...
                for employment_type_type_0_item_data in _employment_type_type_0:
                    employment_type_type_0_item = PollCombinedSearchResponse200OutputDataType1ItemsItemExperiencesType0ItemEmploymentTypeType0Item(
        ...
        def _parse_academic_qualification(
            ...
            try:
                ...
                for academic_qualification_type_0_item_data in _academic_qualification_type_0:
                    academic_qualification_type_0_item = PollCombinedSearchResponse200OutputDataType1ItemsItemExperiencesType0ItemAcademicQualificationType0Item(
