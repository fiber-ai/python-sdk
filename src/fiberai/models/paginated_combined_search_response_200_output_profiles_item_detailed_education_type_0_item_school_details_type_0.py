...
T = TypeVar(
    "T", bound="PaginatedCombinedSearchResponse200OutputProfilesItemDetailedEducationType0ItemSchoolDetailsType0"
)


@_attrs_define
class PaginatedCombinedSearchResponse200OutputProfilesItemDetailedEducationType0ItemSchoolDetailsType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        paginated_combined_search_response_200_output_profiles_item_detailed_education_type_0_item_school_details_type_0 = cls(
        ...
        paginated_combined_search_response_200_output_profiles_item_detailed_education_type_0_item_school_details_type_0.additional_properties = d
        return paginated_combined_search_response_200_output_profiles_item_detailed_education_type_0_item_school_details_type_0
