...
class CompanyCountBodySearchParamsLastFundedOnType1:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.window, CompanyCountBodySearchParamsLastFundedOnType1WindowType1):
            window = self.window.to_dict()
        elif isinstance(self.window, CompanyCountBodySearchParamsLastFundedOnType1WindowType2):
            window = self.window.to_dict()
        else:
            window = self.window
