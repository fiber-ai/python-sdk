...
T = TypeVar("T", bound="PeopleSearchCountBodySearchParamsExactProfileType0AnyOfType0Item")



@_attrs_define
class PeopleSearchCountBodySearchParamsExactProfileType0AnyOfType0Item:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        people_search_count_body_search_params_exact_profile_type_0_any_of_type_0_item = cls(
            profile_id=profile_id,
            primary_slug=primary_slug,
        )


        people_search_count_body_search_params_exact_profile_type_0_any_of_type_0_item.additional_properties = d
        return people_search_count_body_search_params_exact_profile_type_0_any_of_type_0_item
