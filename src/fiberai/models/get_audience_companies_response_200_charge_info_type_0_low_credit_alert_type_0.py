...
T = TypeVar("T", bound="GetAudienceCompaniesResponse200ChargeInfoType0LowCreditAlertType0")


@_attrs_define
class GetAudienceCompaniesResponse200ChargeInfoType0LowCreditAlertType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_audience_companies_response_200_charge_info_type_0_low_credit_alert_type_0 = cls(
            get_more_credits_url=get_more_credits_url,
            message=message,
            available_credits=available_credits,
        )

        get_audience_companies_response_200_charge_info_type_0_low_credit_alert_type_0.additional_properties = d
        return get_audience_companies_response_200_charge_info_type_0_low_credit_alert_type_0
