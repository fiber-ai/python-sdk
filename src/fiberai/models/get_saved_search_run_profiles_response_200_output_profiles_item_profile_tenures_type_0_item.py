...
if TYPE_CHECKING:
  from ..models.get_saved_search_run_profiles_response_200_output_profiles_item_profile_tenures_type_0_item_date_range import GetSavedSearchRunProfilesResponse200OutputProfilesItemProfileTenuresType0ItemDateRange





T = TypeVar("T", bound="GetSavedSearchRunProfilesResponse200OutputProfilesItemProfileTenuresType0Item")



@_attrs_define
class GetSavedSearchRunProfilesResponse200OutputProfilesItemProfileTenuresType0Item:
    """ 
        Attributes:
            date_range (GetSavedSearchRunProfilesResponse200OutputProfilesItemProfileTenuresType0ItemDateRange):
            titles (list[str]):
            localities (list[str]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.get_saved_search_run_profiles_response_200_output_profiles_item_profile_tenures_type_0_item_date_range import GetSavedSearchRunProfilesResponse200OutputProfilesItemProfileTenuresType0ItemDateRange
        d = dict(src_dict)
        date_range = GetSavedSearchRunProfilesResponse200OutputProfilesItemProfileTenuresType0ItemDateRange.from_dict(d.pop("date_range"))
        ...
        get_saved_search_run_profiles_response_200_output_profiles_item_profile_tenures_type_0_item = cls(
            date_range=date_range,
            titles=titles,
            localities=localities,
        ...
        get_saved_search_run_profiles_response_200_output_profiles_item_profile_tenures_type_0_item.additional_properties = d
        return get_saved_search_run_profiles_response_200_output_profiles_item_profile_tenures_type_0_item
