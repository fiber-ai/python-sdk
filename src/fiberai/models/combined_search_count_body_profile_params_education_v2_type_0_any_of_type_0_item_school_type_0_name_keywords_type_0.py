...
T = TypeVar("T", bound="CombinedSearchCountBodyProfileParamsEducationV2Type0AnyOfType0ItemSchoolType0NameKeywordsType0")


@_attrs_define
class CombinedSearchCountBodyProfileParamsEducationV2Type0AnyOfType0ItemSchoolType0NameKeywordsType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        combined_search_count_body_profile_params_education_v2_type_0_any_of_type_0_item_school_type_0_name_keywords_type_0 = cls(
            any_of=any_of,
            none_of=none_of,
        )

        combined_search_count_body_profile_params_education_v2_type_0_any_of_type_0_item_school_type_0_name_keywords_type_0.additional_properties = d
        return combined_search_count_body_profile_params_education_v2_type_0_any_of_type_0_item_school_type_0_name_keywords_type_0
