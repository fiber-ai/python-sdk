...
T = TypeVar("T", bound="CreateProspectExclusionListFromAudienceBody")



@_attrs_define
class CreateProspectExclusionListFromAudienceBody:
    """ 
        Attributes:
            api_key (str): Your Fiber API key
            audience_id (str): Id of the audience to create exclusion list from
            name (Union[None, Unset, str]): Name of the prospect exclusion list. If not provided, defaults to 'Exclusion
                list from {audienceName}'
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_prospect_exclusion_list_from_audience_body = cls(
            api_key=api_key,
        ...
        create_prospect_exclusion_list_from_audience_body.additional_properties = d
        return create_prospect_exclusion_list_from_audience_body
