...
T = TypeVar("T", bound="AddTrackerPeopleBodyPeopleItem")


@_attrs_define
class AddTrackerPeopleBodyPeopleItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        add_tracker_people_body_people_item = cls(
            linkedin_url=linkedin_url,
            linkedin_user_id=linkedin_user_id,
            linkedin_slug=linkedin_slug,
        )

        add_tracker_people_body_people_item.additional_properties = d
        return add_tracker_people_body_people_item
