...
T = TypeVar("T", bound="CompanyPosted")
...
class CompanyPosted:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        type_ = cast(Literal["company_posted"], d.pop("type"))
        if type_ != "company_posted":
            raise ValueError(f"type must match const 'company_posted', got '{type_}'")
        ...
        company_posted.additional_properties = d
