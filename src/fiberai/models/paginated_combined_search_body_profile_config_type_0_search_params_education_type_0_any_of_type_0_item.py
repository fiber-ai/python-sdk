...
T = TypeVar("T", bound="PaginatedCombinedSearchBodyProfileConfigType0SearchParamsEducationType0AnyOfType0Item")


@_attrs_define
class PaginatedCombinedSearchBodyProfileConfigType0SearchParamsEducationType0AnyOfType0Item:
    """
    Attributes:
        school (None | PaginatedCombinedSearchBodyProfileConfigType0SearchParamsEducationType0AnyOfType0ItemSchoolType0
            | Unset):
        school_v2 (None |
            PaginatedCombinedSearchBodyProfileConfigType0SearchParamsEducationType0AnyOfType0ItemSchoolV2Type0 | Unset):
        keywords (None |
            PaginatedCombinedSearchBodyProfileConfigType0SearchParamsEducationType0AnyOfType0ItemKeywordsType0 | Unset):
        degree (None | PaginatedCombinedSearchBodyProfileConfigType0SearchParamsEducationType0AnyOfType0ItemDegreeType0
            | Unset):
        degree_v2 (None |
            PaginatedCombinedSearchBodyProfileConfigType0SearchParamsEducationType0AnyOfType0ItemDegreeV2Type0 |
            PaginatedCombinedSearchBodyProfileConfigType0SearchParamsEducationType0AnyOfType0ItemDegreeV2Type1 | Unset):
    ...
    school: (
        None | PaginatedCombinedSearchBodyProfileConfigType0SearchParamsEducationType0AnyOfType0ItemSchoolType0 | Unset
    ) = UNSET
    school_v2: (
        None
        | PaginatedCombinedSearchBodyProfileConfigType0SearchParamsEducationType0AnyOfType0ItemSchoolV2Type0
    ...
    degree: (
        None | PaginatedCombinedSearchBodyProfileConfigType0SearchParamsEducationType0AnyOfType0ItemDegreeType0 | Unset
    ) = UNSET
    degree_v2: (
        None
        | PaginatedCombinedSearchBodyProfileConfigType0SearchParamsEducationType0AnyOfType0ItemDegreeV2Type0
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_school(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                school_type_0 = PaginatedCombinedSearchBodyProfileConfigType0SearchParamsEducationType0AnyOfType0ItemSchoolType0.from_dict(
                    data
                )
        ...
        def _parse_school_v2(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                school_v2_type_0 = PaginatedCombinedSearchBodyProfileConfigType0SearchParamsEducationType0AnyOfType0ItemSchoolV2Type0.from_dict(
                    data
                )
        ...
        def _parse_keywords(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                keywords_type_0 = PaginatedCombinedSearchBodyProfileConfigType0SearchParamsEducationType0AnyOfType0ItemKeywordsType0.from_dict(
                    data
                )
        ...
        def _parse_degree(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                degree_type_0 = PaginatedCombinedSearchBodyProfileConfigType0SearchParamsEducationType0AnyOfType0ItemDegreeType0.from_dict(
                    data
                )
        ...
        def _parse_degree_v2(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                degree_v2_type_0 = PaginatedCombinedSearchBodyProfileConfigType0SearchParamsEducationType0AnyOfType0ItemDegreeV2Type0.from_dict(
                    data
                )
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                degree_v2_type_1 = PaginatedCombinedSearchBodyProfileConfigType0SearchParamsEducationType0AnyOfType0ItemDegreeV2Type1.from_dict(
                    data
                )
        ...
        def _parse_school_name_keywords(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                school_name_keywords_type_0 = PaginatedCombinedSearchBodyProfileConfigType0SearchParamsEducationType0AnyOfType0ItemSchoolNameKeywordsType0.from_dict(
                    data
                )
        ...
        def _parse_finished_school_at(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                finished_school_at_type_0 = PaginatedCombinedSearchBodyProfileConfigType0SearchParamsEducationType0AnyOfType0ItemFinishedSchoolAtType0.from_dict(
                    data
                )
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                finished_school_at_type_1 = PaginatedCombinedSearchBodyProfileConfigType0SearchParamsEducationType0AnyOfType0ItemFinishedSchoolAtType1.from_dict(
                    data
                )
        ...
        def _parse_started_school_at(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                started_school_at_type_0 = PaginatedCombinedSearchBodyProfileConfigType0SearchParamsEducationType0AnyOfType0ItemStartedSchoolAtType0.from_dict(
                    data
                )
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                started_school_at_type_1 = PaginatedCombinedSearchBodyProfileConfigType0SearchParamsEducationType0AnyOfType0ItemStartedSchoolAtType1.from_dict(
                    data
                )
        ...
        paginated_combined_search_body_profile_config_type_0_search_params_education_type_0_any_of_type_0_item = cls(
            school=school,
            school_v2=school_v2,
            keywords=keywords,
            degree=degree,
        ...
        paginated_combined_search_body_profile_config_type_0_search_params_education_type_0_any_of_type_0_item.additional_properties = d
        return paginated_combined_search_body_profile_config_type_0_search_params_education_type_0_any_of_type_0_item
