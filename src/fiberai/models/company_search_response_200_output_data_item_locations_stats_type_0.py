...
T = TypeVar("T", bound="CompanySearchResponse200OutputDataItemLocationsStatsType0")


@_attrs_define
class CompanySearchResponse200OutputDataItemLocationsStatsType0:
    """
    Attributes:
        usa (float | Unset):
        gbr (float | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        company_search_response_200_output_data_item_locations_stats_type_0 = cls(
            usa=usa,
            gbr=gbr,
            fra=fra,
            ind=ind,
        ...
        return company_search_response_200_output_data_item_locations_stats_type_0
