...
T = TypeVar("T", bound="KitchenSinkBulkProfileResponse200OutputDataItemItemVolunteeringType0Item")


@_attrs_define
class KitchenSinkBulkProfileResponse200OutputDataItemItemVolunteeringType0Item:
    """
    Attributes:
        role (None | str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        kitchen_sink_bulk_profile_response_200_output_data_item_item_volunteering_type_0_item = cls(
            role=role,
        ...
        kitchen_sink_bulk_profile_response_200_output_data_item_item_volunteering_type_0_item.additional_properties = d
        return kitchen_sink_bulk_profile_response_200_output_data_item_item_volunteering_type_0_item
