...
if TYPE_CHECKING:
  from ..models.combined_search_body_company_params_fortune_rankings_type_0_any_of_type_0_item import CombinedSearchBodyCompanyParamsFortuneRankingsType0AnyOfType0Item
...
class CombinedSearchBodyCompanyParamsFortuneRankingsType0:
    """ 
        Attributes:
            any_of (Union[None, Unset, list['CombinedSearchBodyCompanyParamsFortuneRankingsType0AnyOfType0Item']]):
     """

    any_of: Union[None, Unset, list['CombinedSearchBodyCompanyParamsFortuneRankingsType0AnyOfType0Item']] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.combined_search_body_company_params_fortune_rankings_type_0_any_of_type_0_item import CombinedSearchBodyCompanyParamsFortuneRankingsType0AnyOfType0Item
        d = dict(src_dict)
        def _parse_any_of(data: object) -> Union[None, Unset, list['CombinedSearchBodyCompanyParamsFortuneRankingsType0AnyOfType0Item']]:
            if data is None:
                return data
            ...
            try:
                ...
                for any_of_type_0_item_data in (_any_of_type_0):
                    any_of_type_0_item = CombinedSearchBodyCompanyParamsFortuneRankingsType0AnyOfType0Item.from_dict(any_of_type_0_item_data)
                ...
                pass
            return cast(Union[None, Unset, list['CombinedSearchBodyCompanyParamsFortuneRankingsType0AnyOfType0Item']], data)
