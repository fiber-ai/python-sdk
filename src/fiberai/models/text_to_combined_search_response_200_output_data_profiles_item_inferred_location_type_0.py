...
if TYPE_CHECKING:
    from ..models.text_to_combined_search_response_200_output_data_profiles_item_inferred_location_type_0_coordinates_type_0 import (
        TextToCombinedSearchResponse200OutputDataProfilesItemInferredLocationType0CoordinatesType0,
    )
...
class TextToCombinedSearchResponse200OutputDataProfilesItemInferredLocationType0:
    ...
    Attributes:
        ...
        coordinates (None | TextToCombinedSearchResponse200OutputDataProfilesItemInferredLocationType0CoordinatesType0 |
            Unset):
    ...
    coordinates: (
        None | TextToCombinedSearchResponse200OutputDataProfilesItemInferredLocationType0CoordinatesType0 | Unset
    ) = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.coordinates, Unset):
            ...
            self.coordinates, TextToCombinedSearchResponse200OutputDataProfilesItemInferredLocationType0CoordinatesType0
        ):
        ...
        def _parse_coordinates(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = TextToCombinedSearchResponse200OutputDataProfilesItemInferredLocationType0CoordinatesType0.from_dict(
                    data
                )
