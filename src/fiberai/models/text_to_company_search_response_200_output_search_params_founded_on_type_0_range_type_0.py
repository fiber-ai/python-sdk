...
T = TypeVar("T", bound="TextToCompanySearchResponse200OutputSearchParamsFoundedOnType0RangeType0")


@_attrs_define
class TextToCompanySearchResponse200OutputSearchParamsFoundedOnType0RangeType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        text_to_company_search_response_200_output_search_params_founded_on_type_0_range_type_0 = cls(
            lower_bound=lower_bound,
            upper_bound=upper_bound,
        )

        text_to_company_search_response_200_output_search_params_founded_on_type_0_range_type_0.additional_properties = d
        return text_to_company_search_response_200_output_search_params_founded_on_type_0_range_type_0
