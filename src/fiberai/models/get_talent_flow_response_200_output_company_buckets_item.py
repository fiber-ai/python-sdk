...
T = TypeVar("T", bound="GetTalentFlowResponse200OutputCompanyBucketsItem")


@_attrs_define
class GetTalentFlowResponse200OutputCompanyBucketsItem:
    """
    Attributes:
        company_name (str): Company name.
        count (int): Number of people who came from this company (joiners) or went to this company (leavers).
        percent (float): Percentage of total people (0-100, one decimal place).
        domain (None | str | Unset): Company website domain (e.g. 'amazon.com').
        linkedin_url (None | str | Unset): LinkedIn company URL.
        linkedin_org_id (None | str | Unset): LinkedIn organization ID.
        stage (None | str | Unset): Funding stage (e.g. 'Series A', 'Acquired', 'IPO').
        total_funding_usd (float | None | Unset): Total funding raised in USD, if available.
        valuation_usd (float | None | Unset): Latest known valuation in USD, if available.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_talent_flow_response_200_output_company_buckets_item = cls(
        ...
        get_talent_flow_response_200_output_company_buckets_item.additional_properties = d
        return get_talent_flow_response_200_output_company_buckets_item
