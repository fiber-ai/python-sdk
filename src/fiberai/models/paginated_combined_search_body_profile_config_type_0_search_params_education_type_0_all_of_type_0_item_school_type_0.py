...
T = TypeVar(
    "T", bound="PaginatedCombinedSearchBodyProfileConfigType0SearchParamsEducationType0AllOfType0ItemSchoolType0"
)


@_attrs_define
class PaginatedCombinedSearchBodyProfileConfigType0SearchParamsEducationType0AllOfType0ItemSchoolType0:
    """
    Attributes:
        any_of (list[PaginatedCombinedSearchBodyProfileConfigType0SearchParamsEducationType0AllOfType0ItemSchoolType0Any
            OfType0Item] | None | Unset):
        none_of (list[PaginatedCombinedSearchBodyProfileConfigType0SearchParamsEducationType0AllOfType0ItemSchoolType0No
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_any_of(
            ...
            try:
                ...
                for any_of_type_0_item_data in _any_of_type_0:
                    any_of_type_0_item = PaginatedCombinedSearchBodyProfileConfigType0SearchParamsEducationType0AllOfType0ItemSchoolType0AnyOfType0Item.from_dict(
        ...
        def _parse_none_of(
            ...
            try:
                ...
                for none_of_type_0_item_data in _none_of_type_0:
                    none_of_type_0_item = PaginatedCombinedSearchBodyProfileConfigType0SearchParamsEducationType0AllOfType0ItemSchoolType0NoneOfType0Item.from_dict(
        ...
        paginated_combined_search_body_profile_config_type_0_search_params_education_type_0_all_of_type_0_item_school_type_0 = cls(
            any_of=any_of,
            none_of=none_of,
        )

        paginated_combined_search_body_profile_config_type_0_search_params_education_type_0_all_of_type_0_item_school_type_0.additional_properties = d
        return paginated_combined_search_body_profile_config_type_0_search_params_education_type_0_all_of_type_0_item_school_type_0
