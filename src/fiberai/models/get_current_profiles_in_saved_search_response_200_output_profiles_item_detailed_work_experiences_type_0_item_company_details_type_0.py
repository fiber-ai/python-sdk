...
from ..models.get_current_profiles_in_saved_search_response_200_output_profiles_item_detailed_work_experiences_type_0_item_company_details_type_0_standard_industries_type_0_item import (
    GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemDetailedWorkExperiencesType0ItemCompanyDetailsType0StandardIndustriesType0Item,
)
from ..types import UNSET, Unset

T = TypeVar(
    "T",
    bound="GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemDetailedWorkExperiencesType0ItemCompanyDetailsType0",
)


@_attrs_define
class GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemDetailedWorkExperiencesType0ItemCompanyDetailsType0:
    """
    Attributes:
        ...
        standard_industries (list[GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemDetailedWorkExperiencesTyp
            e0ItemCompanyDetailsType0StandardIndustriesType0Item] | None | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_standard_industries(
            ...
            try:
                ...
                for standard_industries_type_0_item_data in _standard_industries_type_0:
                    standard_industries_type_0_item = GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemDetailedWorkExperiencesType0ItemCompanyDetailsType0StandardIndustriesType0Item(
        ...
        get_current_profiles_in_saved_search_response_200_output_profiles_item_detailed_work_experiences_type_0_item_company_details_type_0 = cls(
        ...
        get_current_profiles_in_saved_search_response_200_output_profiles_item_detailed_work_experiences_type_0_item_company_details_type_0.additional_properties = d
        return get_current_profiles_in_saved_search_response_200_output_profiles_item_detailed_work_experiences_type_0_item_company_details_type_0
