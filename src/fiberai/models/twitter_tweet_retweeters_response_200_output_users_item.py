...
T = TypeVar("T", bound="TwitterTweetRetweetersResponse200OutputUsersItem")


@_attrs_define
class TwitterTweetRetweetersResponse200OutputUsersItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        twitter_tweet_retweeters_response_200_output_users_item = cls(
            id=id,
            handle=handle,
        ...
        twitter_tweet_retweeters_response_200_output_users_item.additional_properties = d
        return twitter_tweet_retweeters_response_200_output_users_item
