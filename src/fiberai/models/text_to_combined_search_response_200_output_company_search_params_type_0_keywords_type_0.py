...
T = TypeVar("T", bound="TextToCombinedSearchResponse200OutputCompanySearchParamsType0KeywordsType0")


@_attrs_define
class TextToCombinedSearchResponse200OutputCompanySearchParamsType0KeywordsType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        text_to_combined_search_response_200_output_company_search_params_type_0_keywords_type_0 = cls(
            contains_all=contains_all,
            contains_any=contains_any,
            contains_none=contains_none,
        )

        text_to_combined_search_response_200_output_company_search_params_type_0_keywords_type_0.additional_properties = d
        return text_to_combined_search_response_200_output_company_search_params_type_0_keywords_type_0
