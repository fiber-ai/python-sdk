...
class CompanyCountResponse200:
    """ 
        Attributes:
            ...
            charge_info (Union['CompanyCountResponse200ChargeInfoType0', 'CompanyCountResponse200ChargeInfoType1',
                'CompanyCountResponse200ChargeInfoType2', 'CompanyCountResponse200ChargeInfoType3']):
            warnings (Union[None, Unset, list['CompanyCountResponse200WarningsType0Item']]): Warnings about extraneous
                fields in request
     """

    output: 'CompanyCountResponse200Output'
    charge_info: Union['CompanyCountResponse200ChargeInfoType0', 'CompanyCountResponse200ChargeInfoType1', 'CompanyCountResponse200ChargeInfoType2', 'CompanyCountResponse200ChargeInfoType3']
    warnings: Union[None, Unset, list['CompanyCountResponse200WarningsType0Item']] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_charge_info(data: object) -> Union['CompanyCountResponse200ChargeInfoType0', 'CompanyCountResponse200ChargeInfoType1', 'CompanyCountResponse200ChargeInfoType2', 'CompanyCountResponse200ChargeInfoType3']:
            try:
        ...
        def _parse_warnings(data: object) -> Union[None, Unset, list['CompanyCountResponse200WarningsType0Item']]:
            if data is None:
                return data
            ...
            try:
                ...
                pass
            return cast(Union[None, Unset, list['CompanyCountResponse200WarningsType0Item']], data)
