...
T = TypeVar("T", bound="PeopleSearchCountBodySearchParamsEducationV2Type0AllOfType0ItemDegreeType0Criteria")


@_attrs_define
class PeopleSearchCountBodySearchParamsEducationV2Type0AllOfType0ItemDegreeType0Criteria:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        people_search_count_body_search_params_education_v2_type_0_all_of_type_0_item_degree_type_0_criteria = cls(
            any_of=any_of,
            none_of=none_of,
        )

        people_search_count_body_search_params_education_v2_type_0_all_of_type_0_item_degree_type_0_criteria.additional_properties = d
        return people_search_count_body_search_params_education_v2_type_0_all_of_type_0_item_degree_type_0_criteria
