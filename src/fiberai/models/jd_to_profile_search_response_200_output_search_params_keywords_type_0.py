...
T = TypeVar("T", bound="JdToProfileSearchResponse200OutputSearchParamsKeywordsType0")


@_attrs_define
class JdToProfileSearchResponse200OutputSearchParamsKeywordsType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        jd_to_profile_search_response_200_output_search_params_keywords_type_0 = cls(
            contains_all=contains_all,
            contains_any=contains_any,
            contains_none=contains_none,
        )

        jd_to_profile_search_response_200_output_search_params_keywords_type_0.additional_properties = d
        return jd_to_profile_search_response_200_output_search_params_keywords_type_0
