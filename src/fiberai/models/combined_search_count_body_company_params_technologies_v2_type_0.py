...
T = TypeVar("T", bound="CombinedSearchCountBodyCompanyParamsTechnologiesV2Type0")


@_attrs_define
class CombinedSearchCountBodyCompanyParamsTechnologiesV2Type0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        combined_search_count_body_company_params_technologies_v2_type_0 = cls(
            any_of=any_of,
            all_of=all_of,
            none_of=none_of,
        )

        combined_search_count_body_company_params_technologies_v2_type_0.additional_properties = d
        return combined_search_count_body_company_params_technologies_v2_type_0
