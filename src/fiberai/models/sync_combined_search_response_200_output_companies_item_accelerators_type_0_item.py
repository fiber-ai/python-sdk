...
if TYPE_CHECKING:
  from ..models.sync_combined_search_response_200_output_companies_item_accelerators_type_0_item_founders_type_0_item import SyncCombinedSearchResponse200OutputCompaniesItemAcceleratorsType0ItemFoundersType0Item





T = TypeVar("T", bound="SyncCombinedSearchResponse200OutputCompaniesItemAcceleratorsType0Item")



@_attrs_define
class SyncCombinedSearchResponse200OutputCompaniesItemAcceleratorsType0Item:
    """ 
        Attributes:
            ...
            founders (Union[None, Unset,
                list['SyncCombinedSearchResponse200OutputCompaniesItemAcceleratorsType0ItemFoundersType0Item']]):
    ...
    founders: Union[None, Unset, list['SyncCombinedSearchResponse200OutputCompaniesItemAcceleratorsType0ItemFoundersType0Item']] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_founders(data: object) -> Union[None, Unset, list['SyncCombinedSearchResponse200OutputCompaniesItemAcceleratorsType0ItemFoundersType0Item']]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for founders_type_0_item_data in (_founders_type_0):
                    founders_type_0_item = SyncCombinedSearchResponse200OutputCompaniesItemAcceleratorsType0ItemFoundersType0Item.from_dict(founders_type_0_item_data)
                ...
                pass
            return cast(Union[None, Unset, list['SyncCombinedSearchResponse200OutputCompaniesItemAcceleratorsType0ItemFoundersType0Item']], data)
        ...
        sync_combined_search_response_200_output_companies_item_accelerators_type_0_item = cls(
            id=id,
            slug=slug,
            tags=tags,
            year=year,
        ...
        sync_combined_search_response_200_output_companies_item_accelerators_type_0_item.additional_properties = d
        return sync_combined_search_response_200_output_companies_item_accelerators_type_0_item
