...
if TYPE_CHECKING:
    from ..models.sync_combined_search_response_200_output_companies_item_accelerators_type_0_item_founders_type_0_item import (
        SyncCombinedSearchResponse200OutputCompaniesItemAcceleratorsType0ItemFoundersType0Item,
    )
...
class SyncCombinedSearchResponse200OutputCompaniesItemAcceleratorsType0Item:
    ...
    Attributes:
        ...
        founders (list[SyncCombinedSearchResponse200OutputCompaniesItemAcceleratorsType0ItemFoundersType0Item] | None |
            Unset):
    ...
    founders: (
        list[SyncCombinedSearchResponse200OutputCompaniesItemAcceleratorsType0ItemFoundersType0Item] | None | Unset
    ) = UNSET
        ...
        def _parse_founders(
            ...
            try:
                ...
                for founders_type_0_item_data in _founders_type_0:
                    founders_type_0_item = SyncCombinedSearchResponse200OutputCompaniesItemAcceleratorsType0ItemFoundersType0Item.from_dict(
