...
T = TypeVar("T", bound="TextToCompanySearchResponse200OutputSearchParamsKeywordsType0")



@_attrs_define
class TextToCompanySearchResponse200OutputSearchParamsKeywordsType0:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        text_to_company_search_response_200_output_search_params_keywords_type_0 = cls(
        ...
        text_to_company_search_response_200_output_search_params_keywords_type_0.additional_properties = d
        return text_to_company_search_response_200_output_search_params_keywords_type_0
