...
class GetOrgCreditsResponse200:
    ...
    charge_info: (
        ...
        | GetOrgCreditsResponse200ChargeInfoType2
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.charge_info, GetOrgCreditsResponse200ChargeInfoType0):
            ...
            charge_info = self.charge_info.to_dict()
        elif isinstance(self.charge_info, GetOrgCreditsResponse200ChargeInfoType3):
            charge_info = self.charge_info.to_dict()
        else:
            charge_info = self.charge_info.to_dict()
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_charge_info(
            ...
            if not isinstance(data, dict):
                raise TypeError()
            charge_info_type_4 = GetOrgCreditsResponse200ChargeInfoType4.from_dict(data)
        ...
        def _parse_warnings(data: object) -> list[GetOrgCreditsResponse200WarningsType0Item] | None | Unset:
            ...
            try:
                ...
                for warnings_type_0_item_data in _warnings_type_0:
                    warnings_type_0_item = GetOrgCreditsResponse200WarningsType0Item.from_dict(
                ...
                pass
            return cast(list[GetOrgCreditsResponse200WarningsType0Item] | None | Unset, data)
