...
T = TypeVar("T", bound="GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemSimilarCompaniesType0Item")



@_attrs_define
class GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemSimilarCompaniesType0Item:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_current_companies_in_saved_search_response_200_output_companies_item_similar_companies_type_0_item = cls(
            name=name,
        ...
        get_current_companies_in_saved_search_response_200_output_companies_item_similar_companies_type_0_item.additional_properties = d
        return get_current_companies_in_saved_search_response_200_output_companies_item_similar_companies_type_0_item
