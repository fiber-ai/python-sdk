...
from ..models.quick_company_resolve_response_200_output_data_item_company_type_0_best_funding_round_type_0_round_type_type_1 import (
    QuickCompanyResolveResponse200OutputDataItemCompanyType0BestFundingRoundType0RoundTypeType1,
)
from ..models.quick_company_resolve_response_200_output_data_item_company_type_0_best_funding_round_type_0_round_type_type_2_type_1 import (
    QuickCompanyResolveResponse200OutputDataItemCompanyType0BestFundingRoundType0RoundTypeType2Type1,
)
from ..models.quick_company_resolve_response_200_output_data_item_company_type_0_best_funding_round_type_0_round_type_type_3_type_1 import (
    QuickCompanyResolveResponse200OutputDataItemCompanyType0BestFundingRoundType0RoundTypeType3Type1,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="QuickCompanyResolveResponse200OutputDataItemCompanyType0BestFundingRoundType0")


@_attrs_define
class QuickCompanyResolveResponse200OutputDataItemCompanyType0BestFundingRoundType0:
    """
    Attributes:
        round_type (None | QuickCompanyResolveResponse200OutputDataItemCompanyType0BestFundingRoundType0RoundTypeType1 |
            QuickCompanyResolveResponse200OutputDataItemCompanyType0BestFundingRoundType0RoundTypeType2Type1 |
            QuickCompanyResolveResponse200OutputDataItemCompanyType0BestFundingRoundType0RoundTypeType3Type1 | Unset):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.round_type, Unset):
            ...
            self.round_type, QuickCompanyResolveResponse200OutputDataItemCompanyType0BestFundingRoundType0RoundTypeType1
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_round_type(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                round_type_type_1 = (
                    QuickCompanyResolveResponse200OutputDataItemCompanyType0BestFundingRoundType0RoundTypeType1(data)
                )
        ...
        quick_company_resolve_response_200_output_data_item_company_type_0_best_funding_round_type_0 = cls(
        ...
        quick_company_resolve_response_200_output_data_item_company_type_0_best_funding_round_type_0.additional_properties = d
        return quick_company_resolve_response_200_output_data_item_company_type_0_best_funding_round_type_0
