...
T = TypeVar("T", bound="PollLocalBusinessSearchResponse200OutputDataObservationsItemEmployeesItemPhoneNumberType0")


@_attrs_define
class PollLocalBusinessSearchResponse200OutputDataObservationsItemEmployeesItemPhoneNumberType0:
    """
    Attributes:
        phone_number (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        poll_local_business_search_response_200_output_data_observations_item_employees_item_phone_number_type_0 = cls(
            phone_number=phone_number,
            country_code=country_code,
            country_calling_code=country_calling_code,
        )

        poll_local_business_search_response_200_output_data_observations_item_employees_item_phone_number_type_0.additional_properties = d
        return poll_local_business_search_response_200_output_data_observations_item_employees_item_phone_number_type_0
