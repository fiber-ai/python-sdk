...
T = TypeVar("T", bound="SyncCombinedSearchResponse200OutputCompaniesItemInvestorsType0Item")



@_attrs_define
class SyncCombinedSearchResponse200OutputCompaniesItemInvestorsType0Item:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sync_combined_search_response_200_output_companies_item_investors_type_0_item = cls(
            logo_url=logo_url,
        ...
        sync_combined_search_response_200_output_companies_item_investors_type_0_item.additional_properties = d
        return sync_combined_search_response_200_output_companies_item_investors_type_0_item
