...
T = TypeVar("T", bound="QuickPersonResolveResponse200OutputDataItemPersonType0TenuresType0Item")


@_attrs_define
class QuickPersonResolveResponse200OutputDataItemPersonType0TenuresType0Item:
    """
    Attributes:
        date_range (QuickPersonResolveResponse200OutputDataItemPersonType0TenuresType0ItemDateRange):
        titles (list[str]):
        localities (list[str]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        date_range = QuickPersonResolveResponse200OutputDataItemPersonType0TenuresType0ItemDateRange.from_dict(
            d.pop("date_range")
        )
        ...
        quick_person_resolve_response_200_output_data_item_person_type_0_tenures_type_0_item = cls(
            date_range=date_range,
            titles=titles,
            localities=localities,
        ...
        quick_person_resolve_response_200_output_data_item_person_type_0_tenures_type_0_item.additional_properties = d
        return quick_person_resolve_response_200_output_data_item_person_type_0_tenures_type_0_item
