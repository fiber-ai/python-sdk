...
from ..models.paginated_combined_search_response_200_output_companies_item_li_category_type_1 import (
    PaginatedCombinedSearchResponse200OutputCompaniesItemLiCategoryType1,
)
from ..models.paginated_combined_search_response_200_output_companies_item_li_category_type_2_type_1 import (
    PaginatedCombinedSearchResponse200OutputCompaniesItemLiCategoryType2Type1,
)
from ..models.paginated_combined_search_response_200_output_companies_item_li_category_type_3_type_1 import (
    PaginatedCombinedSearchResponse200OutputCompaniesItemLiCategoryType3Type1,
)
from ..models.paginated_combined_search_response_200_output_companies_item_standard_industries_type_0_item import (
    PaginatedCombinedSearchResponse200OutputCompaniesItemStandardIndustriesType0Item,
)
from ..models.paginated_combined_search_response_200_output_companies_item_tags_type_0_item import (
    PaginatedCombinedSearchResponse200OutputCompaniesItemTagsType0Item,
)
...
T = TypeVar("T", bound="PaginatedCombinedSearchResponse200OutputCompaniesItem")


@_attrs_define
class PaginatedCombinedSearchResponse200OutputCompaniesItem:
    """
    Attributes:
        linkedin_id (None | str | Unset):
        accelerator_statuses (list[str] | None | Unset):
        accelerators (list[PaginatedCombinedSearchResponse200OutputCompaniesItemAcceleratorsType0Item] | None | Unset):
        blog_urls (list[str] | None | Unset):
        custom_data (None | PaginatedCombinedSearchResponse200OutputCompaniesItemCustomDataType0 | Unset):
        domains (list[str] | None | Unset):
        emails (list[str] | None | Unset):
        phone_numbers (list[str] | None | Unset):
        employee_count_consensus (None |
            PaginatedCombinedSearchResponse200OutputCompaniesItemEmployeeCountConsensusType0 | Unset):
        facebook_urls (list[str] | None | Unset):
        fortune_rankings (list[PaginatedCombinedSearchResponse200OutputCompaniesItemFortuneRankingsType0Item] | None |
            Unset):
        ...
        li_category (None | PaginatedCombinedSearchResponse200OutputCompaniesItemLiCategoryType1 |
            PaginatedCombinedSearchResponse200OutputCompaniesItemLiCategoryType2Type1 |
            PaginatedCombinedSearchResponse200OutputCompaniesItemLiCategoryType3Type1 | Unset):
        li_job_posts_stats (None | PaginatedCombinedSearchResponse200OutputCompaniesItemLiJobPostsStatsType0 | Unset):
        li_description (None | str | Unset):
        li_follower_count (float | None | Unset):
        li_headline (None | str | Unset):
        li_industries (list[PaginatedCombinedSearchResponse200OutputCompaniesItemLiIndustriesType0Item] | None | Unset):
        li_locations (list[PaginatedCombinedSearchResponse200OutputCompaniesItemLiLocationsType0Item] | None | Unset):
        li_specialties (list[str] | None | Unset):
        location_consensus (None | PaginatedCombinedSearchResponse200OutputCompaniesItemLocationConsensusType0 | Unset):
        locations_stats (None | PaginatedCombinedSearchResponse200OutputCompaniesItemLocationsStatsType0 | Unset):
        ...
        revenue_estimate (None | PaginatedCombinedSearchResponse200OutputCompaniesItemRevenueEstimateType0 | Unset):
        standard_industries (list[PaginatedCombinedSearchResponse200OutputCompaniesItemStandardIndustriesType0Item] |
            None | Unset):
        status_consensus (None | str | Unset):
        stock_info_consensus (None | PaginatedCombinedSearchResponse200OutputCompaniesItemStockInfoConsensusType0 |
            Unset):
        tags (list[PaginatedCombinedSearchResponse200OutputCompaniesItemTagsType0Item] | None | Unset):
        ...
        role_count_matches (list[PaginatedCombinedSearchResponse200OutputCompaniesItemRoleCountMatchesType0Item] | None
            | Unset):
        num_matching_locations (None | PaginatedCombinedSearchResponse200OutputCompaniesItemNumMatchingLocationsType0 |
            Unset):
        ...
        historical_headcount (None | PaginatedCombinedSearchResponse200OutputCompaniesItemHistoricalHeadcountType0 |
            Unset):
        ...
        funding_rounds (list[PaginatedCombinedSearchResponse200OutputCompaniesItemFundingRoundsType0Item] | None |
            Unset):
        num_exits (float | None | Unset):
        investors (list[PaginatedCombinedSearchResponse200OutputCompaniesItemInvestorsType0Item] | None | Unset):
        acquisitions (list[PaginatedCombinedSearchResponse200OutputCompaniesItemAcquisitionsType0Item] | None | Unset):
        best_funding_round (None | PaginatedCombinedSearchResponse200OutputCompaniesItemBestFundingRoundType0 | Unset):
        ...
        employee_trends (list[PaginatedCombinedSearchResponse200OutputCompaniesItemEmployeeTrendsType0Item] | None |
            Unset):
        logo_url (None | str | Unset):
        similar_companies (list[PaginatedCombinedSearchResponse200OutputCompaniesItemSimilarCompaniesType0Item] | None |
            Unset):
        full_funding_rounds (list[PaginatedCombinedSearchResponse200OutputCompaniesItemFullFundingRoundsType0Item] |
            None | Unset):
        funding_round_stats (None | PaginatedCombinedSearchResponse200OutputCompaniesItemFundingRoundStatsType0 |
            Unset):
        investment_stats (None | PaginatedCombinedSearchResponse200OutputCompaniesItemInvestmentStatsType0 | Unset):
        is_investor (bool | None | Unset):
        investor_type (None | str | Unset):
        investor_categories (list[str] | None | Unset):
        technologies_used (list[PaginatedCombinedSearchResponse200OutputCompaniesItemTechnologiesUsedType0Item] | None |
            Unset):
        platforms (None | PaginatedCombinedSearchResponse200OutputCompaniesItemPlatformsType0 | Unset):
    """
    ...
    custom_data: None | PaginatedCombinedSearchResponse200OutputCompaniesItemCustomDataType0 | Unset = UNSET
    ...
    employee_count_consensus: (
        None | PaginatedCombinedSearchResponse200OutputCompaniesItemEmployeeCountConsensusType0 | Unset
    ) = UNSET
    facebook_urls: list[str] | None | Unset = UNSET
    fortune_rankings: (
        list[PaginatedCombinedSearchResponse200OutputCompaniesItemFortuneRankingsType0Item] | None | Unset
    ) = UNSET
    ...
    li_job_posts_stats: None | PaginatedCombinedSearchResponse200OutputCompaniesItemLiJobPostsStatsType0 | Unset = UNSET
    ...
    li_locations: list[PaginatedCombinedSearchResponse200OutputCompaniesItemLiLocationsType0Item] | None | Unset = UNSET
    li_specialties: list[str] | None | Unset = UNSET
    location_consensus: None | PaginatedCombinedSearchResponse200OutputCompaniesItemLocationConsensusType0 | Unset = (
        UNSET
    )
    locations_stats: None | PaginatedCombinedSearchResponse200OutputCompaniesItemLocationsStatsType0 | Unset = UNSET
    ...
    revenue_estimate: None | PaginatedCombinedSearchResponse200OutputCompaniesItemRevenueEstimateType0 | Unset = UNSET
    standard_industries: (
        list[PaginatedCombinedSearchResponse200OutputCompaniesItemStandardIndustriesType0Item] | None | Unset
    ) = UNSET
    status_consensus: None | str | Unset = UNSET
    stock_info_consensus: (
        None | PaginatedCombinedSearchResponse200OutputCompaniesItemStockInfoConsensusType0 | Unset
    ) = UNSET
    tags: list[PaginatedCombinedSearchResponse200OutputCompaniesItemTagsType0Item] | None | Unset = UNSET
    ...
    role_count_matches: (
        list[PaginatedCombinedSearchResponse200OutputCompaniesItemRoleCountMatchesType0Item] | None | Unset
    ) = UNSET
    num_matching_locations: (
        None | PaginatedCombinedSearchResponse200OutputCompaniesItemNumMatchingLocationsType0 | Unset
    ) = UNSET
    ...
    historical_headcount: (
        None | PaginatedCombinedSearchResponse200OutputCompaniesItemHistoricalHeadcountType0 | Unset
    ) = UNSET
    ...
    funding_rounds: list[PaginatedCombinedSearchResponse200OutputCompaniesItemFundingRoundsType0Item] | None | Unset = (
        UNSET
    )
    num_exits: float | None | Unset = UNSET
    investors: list[PaginatedCombinedSearchResponse200OutputCompaniesItemInvestorsType0Item] | None | Unset = UNSET
    acquisitions: list[PaginatedCombinedSearchResponse200OutputCompaniesItemAcquisitionsType0Item] | None | Unset = (
        UNSET
    )
    best_funding_round: None | PaginatedCombinedSearchResponse200OutputCompaniesItemBestFundingRoundType0 | Unset = (
    ...
    employee_trends: (
        list[PaginatedCombinedSearchResponse200OutputCompaniesItemEmployeeTrendsType0Item] | None | Unset
    ) = UNSET
    logo_url: None | str | Unset = UNSET
    similar_companies: (
        list[PaginatedCombinedSearchResponse200OutputCompaniesItemSimilarCompaniesType0Item] | None | Unset
    ) = UNSET
    full_funding_rounds: (
        list[PaginatedCombinedSearchResponse200OutputCompaniesItemFullFundingRoundsType0Item] | None | Unset
    ) = UNSET
    funding_round_stats: None | PaginatedCombinedSearchResponse200OutputCompaniesItemFundingRoundStatsType0 | Unset = (
        UNSET
    )
    investment_stats: None | PaginatedCombinedSearchResponse200OutputCompaniesItemInvestmentStatsType0 | Unset = UNSET
    is_investor: bool | None | Unset = UNSET
    investor_type: None | str | Unset = UNSET
    investor_categories: list[str] | None | Unset = UNSET
    technologies_used: (
        list[PaginatedCombinedSearchResponse200OutputCompaniesItemTechnologiesUsedType0Item] | None | Unset
    ) = UNSET
    platforms: None | PaginatedCombinedSearchResponse200OutputCompaniesItemPlatformsType0 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.custom_data, Unset):
            custom_data = UNSET
        elif isinstance(self.custom_data, PaginatedCombinedSearchResponse200OutputCompaniesItemCustomDataType0):
        ...
        if isinstance(self.li_category, Unset):
            li_category = UNSET
        elif isinstance(self.li_category, PaginatedCombinedSearchResponse200OutputCompaniesItemLiCategoryType1):
            li_category = self.li_category.value
        elif isinstance(self.li_category, PaginatedCombinedSearchResponse200OutputCompaniesItemLiCategoryType2Type1):
            li_category = self.li_category.value
        elif isinstance(self.li_category, PaginatedCombinedSearchResponse200OutputCompaniesItemLiCategoryType3Type1):
            li_category = self.li_category.value
        else:
        ...
        if isinstance(self.li_job_posts_stats, Unset):
            ...
            self.li_job_posts_stats, PaginatedCombinedSearchResponse200OutputCompaniesItemLiJobPostsStatsType0
        ):
        ...
        if isinstance(self.location_consensus, Unset):
            ...
            self.location_consensus, PaginatedCombinedSearchResponse200OutputCompaniesItemLocationConsensusType0
        ):
        ...
        elif isinstance(self.locations_stats, PaginatedCombinedSearchResponse200OutputCompaniesItemLocationsStatsType0):
        ...
        if isinstance(self.revenue_estimate, Unset):
            ...
            self.revenue_estimate, PaginatedCombinedSearchResponse200OutputCompaniesItemRevenueEstimateType0
        ):
        ...
        if isinstance(self.stock_info_consensus, Unset):
            ...
            self.stock_info_consensus, PaginatedCombinedSearchResponse200OutputCompaniesItemStockInfoConsensusType0
        ):
        ...
        if isinstance(self.num_matching_locations, Unset):
            ...
            self.num_matching_locations, PaginatedCombinedSearchResponse200OutputCompaniesItemNumMatchingLocationsType0
        ):
        ...
        if isinstance(self.historical_headcount, Unset):
            ...
            self.historical_headcount, PaginatedCombinedSearchResponse200OutputCompaniesItemHistoricalHeadcountType0
        ):
        ...
        if isinstance(self.best_funding_round, Unset):
            ...
            self.best_funding_round, PaginatedCombinedSearchResponse200OutputCompaniesItemBestFundingRoundType0
        ):
        ...
        if isinstance(self.funding_round_stats, Unset):
            ...
            self.funding_round_stats, PaginatedCombinedSearchResponse200OutputCompaniesItemFundingRoundStatsType0
        ):
        ...
        if isinstance(self.investment_stats, Unset):
            ...
            self.investment_stats, PaginatedCombinedSearchResponse200OutputCompaniesItemInvestmentStatsType0
        ):
        ...
        if isinstance(self.platforms, Unset):
            platforms = UNSET
        elif isinstance(self.platforms, PaginatedCombinedSearchResponse200OutputCompaniesItemPlatformsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_accelerators(
            data: object,
        ) -> list[PaginatedCombinedSearchResponse200OutputCompaniesItemAcceleratorsType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for accelerators_type_0_item_data in _accelerators_type_0:
                    accelerators_type_0_item = (
                        PaginatedCombinedSearchResponse200OutputCompaniesItemAcceleratorsType0Item.from_dict(
                ...
                pass
            return cast(
                list[PaginatedCombinedSearchResponse200OutputCompaniesItemAcceleratorsType0Item] | None | Unset, data
            )
        ...
        def _parse_custom_data(
            data: object,
        ) -> None | PaginatedCombinedSearchResponse200OutputCompaniesItemCustomDataType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                custom_data_type_0 = PaginatedCombinedSearchResponse200OutputCompaniesItemCustomDataType0.from_dict(
                    data
                )
                ...
                pass
            return cast(None | PaginatedCombinedSearchResponse200OutputCompaniesItemCustomDataType0 | Unset, data)
        ...
        def _parse_employee_count_consensus(
            ...
            try:
                ...
                employee_count_consensus_type_0 = (
                    PaginatedCombinedSearchResponse200OutputCompaniesItemEmployeeCountConsensusType0.from_dict(data)
                )
                ...
                pass
            return cast(
                None | PaginatedCombinedSearchResponse200OutputCompaniesItemEmployeeCountConsensusType0 | Unset, data
            )
            ...
            try:
                ...
                for fortune_rankings_type_0_item_data in _fortune_rankings_type_0:
                    fortune_rankings_type_0_item = (
                        PaginatedCombinedSearchResponse200OutputCompaniesItemFortuneRankingsType0Item.from_dict(
                ...
                pass
            return cast(
                list[PaginatedCombinedSearchResponse200OutputCompaniesItemFortuneRankingsType0Item] | None | Unset, data
            )
        ...
        def _parse_li_category(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                li_category_type_1 = PaginatedCombinedSearchResponse200OutputCompaniesItemLiCategoryType1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                li_category_type_2_type_1 = PaginatedCombinedSearchResponse200OutputCompaniesItemLiCategoryType2Type1(
                    data
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                li_category_type_3_type_1 = PaginatedCombinedSearchResponse200OutputCompaniesItemLiCategoryType3Type1(
                    data
                )
        ...
        def _parse_li_job_posts_stats(
            data: object,
        ) -> None | PaginatedCombinedSearchResponse200OutputCompaniesItemLiJobPostsStatsType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                li_job_posts_stats_type_0 = (
                    PaginatedCombinedSearchResponse200OutputCompaniesItemLiJobPostsStatsType0.from_dict(data)
                )

                return li_job_posts_stats_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PaginatedCombinedSearchResponse200OutputCompaniesItemLiJobPostsStatsType0 | Unset, data)
        ...
        def _parse_li_industries(
            data: object,
        ) -> list[PaginatedCombinedSearchResponse200OutputCompaniesItemLiIndustriesType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for li_industries_type_0_item_data in _li_industries_type_0:
                    li_industries_type_0_item = (
                        PaginatedCombinedSearchResponse200OutputCompaniesItemLiIndustriesType0Item.from_dict(
                ...
                pass
            return cast(
                list[PaginatedCombinedSearchResponse200OutputCompaniesItemLiIndustriesType0Item] | None | Unset, data
            )
        ...
        def _parse_li_locations(
            data: object,
        ) -> list[PaginatedCombinedSearchResponse200OutputCompaniesItemLiLocationsType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for li_locations_type_0_item_data in _li_locations_type_0:
                    li_locations_type_0_item = (
                        PaginatedCombinedSearchResponse200OutputCompaniesItemLiLocationsType0Item.from_dict(
                ...
                pass
            return cast(
                list[PaginatedCombinedSearchResponse200OutputCompaniesItemLiLocationsType0Item] | None | Unset, data
            )
        ...
        def _parse_location_consensus(
            data: object,
        ) -> None | PaginatedCombinedSearchResponse200OutputCompaniesItemLocationConsensusType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                location_consensus_type_0 = (
                    PaginatedCombinedSearchResponse200OutputCompaniesItemLocationConsensusType0.from_dict(data)
                )
                ...
                pass
            return cast(
                None | PaginatedCombinedSearchResponse200OutputCompaniesItemLocationConsensusType0 | Unset, data
            )
        ...
        def _parse_locations_stats(
            data: object,
        ) -> None | PaginatedCombinedSearchResponse200OutputCompaniesItemLocationsStatsType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                locations_stats_type_0 = (
                    PaginatedCombinedSearchResponse200OutputCompaniesItemLocationsStatsType0.from_dict(data)
                )

                return locations_stats_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PaginatedCombinedSearchResponse200OutputCompaniesItemLocationsStatsType0 | Unset, data)
        ...
        def _parse_revenue_estimate(
            data: object,
        ) -> None | PaginatedCombinedSearchResponse200OutputCompaniesItemRevenueEstimateType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                revenue_estimate_type_0 = (
                    PaginatedCombinedSearchResponse200OutputCompaniesItemRevenueEstimateType0.from_dict(data)
                )

                return revenue_estimate_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PaginatedCombinedSearchResponse200OutputCompaniesItemRevenueEstimateType0 | Unset, data)
        ...
        def _parse_stock_info_consensus(
            ...
            try:
                ...
                stock_info_consensus_type_0 = (
                    PaginatedCombinedSearchResponse200OutputCompaniesItemStockInfoConsensusType0.from_dict(data)
                )
                ...
                pass
            return cast(
                None | PaginatedCombinedSearchResponse200OutputCompaniesItemStockInfoConsensusType0 | Unset, data
            )
        ...
        def _parse_tags(
            data: object,
        ) -> list[PaginatedCombinedSearchResponse200OutputCompaniesItemTagsType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for tags_type_0_item_data in _tags_type_0:
                    tags_type_0_item = PaginatedCombinedSearchResponse200OutputCompaniesItemTagsType0Item(
                ...
                pass
            return cast(list[PaginatedCombinedSearchResponse200OutputCompaniesItemTagsType0Item] | None | Unset, data)
            ...
            try:
                ...
                for role_count_matches_type_0_item_data in _role_count_matches_type_0:
                    role_count_matches_type_0_item = (
                        PaginatedCombinedSearchResponse200OutputCompaniesItemRoleCountMatchesType0Item.from_dict(
        ...
        def _parse_num_matching_locations(
            ...
            try:
                ...
                num_matching_locations_type_0 = (
                    PaginatedCombinedSearchResponse200OutputCompaniesItemNumMatchingLocationsType0.from_dict(data)
                )
                ...
                pass
            return cast(
                None | PaginatedCombinedSearchResponse200OutputCompaniesItemNumMatchingLocationsType0 | Unset, data
            )
        ...
        def _parse_historical_headcount(
            ...
            try:
                ...
                historical_headcount_type_0 = (
                    PaginatedCombinedSearchResponse200OutputCompaniesItemHistoricalHeadcountType0.from_dict(data)
                )
                ...
                pass
            return cast(
                None | PaginatedCombinedSearchResponse200OutputCompaniesItemHistoricalHeadcountType0 | Unset, data
            )
        ...
        def _parse_funding_rounds(
            data: object,
        ) -> list[PaginatedCombinedSearchResponse200OutputCompaniesItemFundingRoundsType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for funding_rounds_type_0_item_data in _funding_rounds_type_0:
                    funding_rounds_type_0_item = (
                        PaginatedCombinedSearchResponse200OutputCompaniesItemFundingRoundsType0Item.from_dict(
                ...
                pass
            return cast(
                list[PaginatedCombinedSearchResponse200OutputCompaniesItemFundingRoundsType0Item] | None | Unset, data
            )
        ...
        def _parse_investors(
            data: object,
        ) -> list[PaginatedCombinedSearchResponse200OutputCompaniesItemInvestorsType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for investors_type_0_item_data in _investors_type_0:
                    investors_type_0_item = (
                        PaginatedCombinedSearchResponse200OutputCompaniesItemInvestorsType0Item.from_dict(
                ...
                pass
            return cast(
                list[PaginatedCombinedSearchResponse200OutputCompaniesItemInvestorsType0Item] | None | Unset, data
            )
        ...
        def _parse_acquisitions(
            data: object,
        ) -> list[PaginatedCombinedSearchResponse200OutputCompaniesItemAcquisitionsType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for acquisitions_type_0_item_data in _acquisitions_type_0:
                    acquisitions_type_0_item = (
                        PaginatedCombinedSearchResponse200OutputCompaniesItemAcquisitionsType0Item.from_dict(
                ...
                pass
            return cast(
                list[PaginatedCombinedSearchResponse200OutputCompaniesItemAcquisitionsType0Item] | None | Unset, data
            )
        ...
        def _parse_best_funding_round(
            data: object,
        ) -> None | PaginatedCombinedSearchResponse200OutputCompaniesItemBestFundingRoundType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                best_funding_round_type_0 = (
                    PaginatedCombinedSearchResponse200OutputCompaniesItemBestFundingRoundType0.from_dict(data)
                )

                return best_funding_round_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PaginatedCombinedSearchResponse200OutputCompaniesItemBestFundingRoundType0 | Unset, data)
            ...
            try:
                ...
                for employee_trends_type_0_item_data in _employee_trends_type_0:
                    employee_trends_type_0_item = (
                        PaginatedCombinedSearchResponse200OutputCompaniesItemEmployeeTrendsType0Item.from_dict(
                ...
                pass
            return cast(
                list[PaginatedCombinedSearchResponse200OutputCompaniesItemEmployeeTrendsType0Item] | None | Unset, data
            )
            ...
            try:
                ...
                for similar_companies_type_0_item_data in _similar_companies_type_0:
                    similar_companies_type_0_item = (
                        PaginatedCombinedSearchResponse200OutputCompaniesItemSimilarCompaniesType0Item.from_dict(
            ...
            try:
                ...
                for full_funding_rounds_type_0_item_data in _full_funding_rounds_type_0:
                    full_funding_rounds_type_0_item = (
                        PaginatedCombinedSearchResponse200OutputCompaniesItemFullFundingRoundsType0Item.from_dict(
        ...
        def _parse_funding_round_stats(
            data: object,
        ) -> None | PaginatedCombinedSearchResponse200OutputCompaniesItemFundingRoundStatsType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                funding_round_stats_type_0 = (
                    PaginatedCombinedSearchResponse200OutputCompaniesItemFundingRoundStatsType0.from_dict(data)
                )
                ...
                pass
            return cast(
                None | PaginatedCombinedSearchResponse200OutputCompaniesItemFundingRoundStatsType0 | Unset, data
            )
        ...
        def _parse_investment_stats(
            data: object,
        ) -> None | PaginatedCombinedSearchResponse200OutputCompaniesItemInvestmentStatsType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                investment_stats_type_0 = (
                    PaginatedCombinedSearchResponse200OutputCompaniesItemInvestmentStatsType0.from_dict(data)
                )

                return investment_stats_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PaginatedCombinedSearchResponse200OutputCompaniesItemInvestmentStatsType0 | Unset, data)
            ...
            try:
                ...
                for technologies_used_type_0_item_data in _technologies_used_type_0:
                    technologies_used_type_0_item = (
                        PaginatedCombinedSearchResponse200OutputCompaniesItemTechnologiesUsedType0Item.from_dict(
        ...
        def _parse_platforms(
            data: object,
        ) -> None | PaginatedCombinedSearchResponse200OutputCompaniesItemPlatformsType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                platforms_type_0 = PaginatedCombinedSearchResponse200OutputCompaniesItemPlatformsType0.from_dict(data)

                return platforms_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PaginatedCombinedSearchResponse200OutputCompaniesItemPlatformsType0 | Unset, data)

        platforms = _parse_platforms(d.pop("platforms", UNSET))

        paginated_combined_search_response_200_output_companies_item = cls(
        ...
        paginated_combined_search_response_200_output_companies_item.additional_properties = d
        return paginated_combined_search_response_200_output_companies_item
