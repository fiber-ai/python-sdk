...
from ..models.poll_combined_search_response_200_output_data_type_0_items_item_best_funding_round_type_0_round_type_type_1 import PollCombinedSearchResponse200OutputDataType0ItemsItemBestFundingRoundType0RoundTypeType1
from ..models.poll_combined_search_response_200_output_data_type_0_items_item_best_funding_round_type_0_round_type_type_2_type_1 import PollCombinedSearchResponse200OutputDataType0ItemsItemBestFundingRoundType0RoundTypeType2Type1
from ..models.poll_combined_search_response_200_output_data_type_0_items_item_best_funding_round_type_0_round_type_type_3_type_1 import PollCombinedSearchResponse200OutputDataType0ItemsItemBestFundingRoundType0RoundTypeType3Type1
from ..types import UNSET, Unset
...
class PollCombinedSearchResponse200OutputDataType0ItemsItemBestFundingRoundType0:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.round_type, Unset):
            round_type = UNSET
        elif isinstance(self.round_type, PollCombinedSearchResponse200OutputDataType0ItemsItemBestFundingRoundType0RoundTypeType1):
            round_type = self.round_type.value
        elif isinstance(self.round_type, PollCombinedSearchResponse200OutputDataType0ItemsItemBestFundingRoundType0RoundTypeType2Type1):
            round_type = self.round_type.value
        elif isinstance(self.round_type, PollCombinedSearchResponse200OutputDataType0ItemsItemBestFundingRoundType0RoundTypeType3Type1):
            round_type = self.round_type.value
        else:
        ...
        def _parse_round_type(data: object) -> Union[None, PollCombinedSearchResponse200OutputDataType0ItemsItemBestFundingRoundType0RoundTypeType1, PollCombinedSearchResponse200OutputDataType0ItemsItemBestFundingRoundType0RoundTypeType2Type1, PollCombinedSearchResponse200OutputDataType0ItemsItemBestFundingRoundType0RoundTypeType3Type1, Unset]:
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                round_type_type_1 = PollCombinedSearchResponse200OutputDataType0ItemsItemBestFundingRoundType0RoundTypeType1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                round_type_type_2_type_1 = PollCombinedSearchResponse200OutputDataType0ItemsItemBestFundingRoundType0RoundTypeType2Type1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                round_type_type_3_type_1 = PollCombinedSearchResponse200OutputDataType0ItemsItemBestFundingRoundType0RoundTypeType3Type1(data)
