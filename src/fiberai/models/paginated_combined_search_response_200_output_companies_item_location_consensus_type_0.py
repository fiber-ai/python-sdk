...
if TYPE_CHECKING:
    from ..models.paginated_combined_search_response_200_output_companies_item_location_consensus_type_0_coordinates_type_0 import (
        PaginatedCombinedSearchResponse200OutputCompaniesItemLocationConsensusType0CoordinatesType0,
    )


T = TypeVar("T", bound="PaginatedCombinedSearchResponse200OutputCompaniesItemLocationConsensusType0")


@_attrs_define
class PaginatedCombinedSearchResponse200OutputCompaniesItemLocationConsensusType0:
    """
    Attributes:
        ...
        coordinates (None | PaginatedCombinedSearchResponse200OutputCompaniesItemLocationConsensusType0CoordinatesType0
            | Unset):
    ...
    coordinates: (
        None | PaginatedCombinedSearchResponse200OutputCompaniesItemLocationConsensusType0CoordinatesType0 | Unset
    ) = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.paginated_combined_search_response_200_output_companies_item_location_consensus_type_0_coordinates_type_0 import (
            PaginatedCombinedSearchResponse200OutputCompaniesItemLocationConsensusType0CoordinatesType0,  # noqa: PLC0415
        )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_coordinates(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = PaginatedCombinedSearchResponse200OutputCompaniesItemLocationConsensusType0CoordinatesType0.from_dict(
                    data
                )
        ...
        paginated_combined_search_response_200_output_companies_item_location_consensus_type_0 = cls(
        ...
        paginated_combined_search_response_200_output_companies_item_location_consensus_type_0.additional_properties = d
        return paginated_combined_search_response_200_output_companies_item_location_consensus_type_0
