...
class GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyRoleCountMatchesType0Item:
    """
    Attributes:
        num_matching_employees (GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyRoleCountMatchesType0Item
            NumMatchingEmployeesType0 | GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyRoleCountMatchesType0
            ItemNumMatchingEmployeesType1 | GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyRoleCountMatchesT
            ype0ItemNumMatchingEmployeesType2 | GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyRoleCountMatc
            hesType0ItemNumMatchingEmployeesType3):
    """
        ...
        def _parse_num_matching_employees(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                num_matching_employees_type_0 = GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyRoleCountMatchesType0ItemNumMatchingEmployeesType0.from_dict(
                    data
                )
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                num_matching_employees_type_1 = GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyRoleCountMatchesType0ItemNumMatchingEmployeesType1.from_dict(
                    data
                )
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                num_matching_employees_type_2 = GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyRoleCountMatchesType0ItemNumMatchingEmployeesType2.from_dict(
                    data
                )
            ...
            if not isinstance(data, dict):
                raise TypeError()
            num_matching_employees_type_3 = GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyRoleCountMatchesType0ItemNumMatchingEmployeesType3.from_dict(
                data
            )
