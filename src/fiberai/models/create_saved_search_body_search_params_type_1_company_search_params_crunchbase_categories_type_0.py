...
class CreateSavedSearchBodySearchParamsType1CompanySearchParamsCrunchbaseCategoriesType0:
    """
    Attributes:
        any_of (list[CreateSavedSearchBodySearchParamsType1CompanySearchParamsCrunchbaseCategoriesType0AnyOfType0Item] |
            None | Unset):
        all_of (list[CreateSavedSearchBodySearchParamsType1CompanySearchParamsCrunchbaseCategoriesType0AllOfType0Item] |
            None | Unset):
        none_of (list[CreateSavedSearchBodySearchParamsType1CompanySearchParamsCrunchbaseCategoriesType0NoneOfType0Item]
            | None | Unset):
    """
        ...
        def _parse_any_of(
            ...
            try:
                ...
                for any_of_type_0_item_data in _any_of_type_0:
                    any_of_type_0_item = CreateSavedSearchBodySearchParamsType1CompanySearchParamsCrunchbaseCategoriesType0AnyOfType0Item.from_dict(
        ...
        def _parse_all_of(
            ...
            try:
                ...
                for all_of_type_0_item_data in _all_of_type_0:
                    all_of_type_0_item = CreateSavedSearchBodySearchParamsType1CompanySearchParamsCrunchbaseCategoriesType0AllOfType0Item.from_dict(
        ...
        def _parse_none_of(
            ...
            try:
                ...
                for none_of_type_0_item_data in _none_of_type_0:
                    none_of_type_0_item = CreateSavedSearchBodySearchParamsType1CompanySearchParamsCrunchbaseCategoriesType0NoneOfType0Item.from_dict(
