...
T = TypeVar("T", bound="PeopleSearchCountBodySearchParamsNumConnectionsType0")


@_attrs_define
class PeopleSearchCountBodySearchParamsNumConnectionsType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        people_search_count_body_search_params_num_connections_type_0 = cls(
            lower_bound=lower_bound,
            upper_bound=upper_bound,
        )

        people_search_count_body_search_params_num_connections_type_0.additional_properties = d
        return people_search_count_body_search_params_num_connections_type_0
