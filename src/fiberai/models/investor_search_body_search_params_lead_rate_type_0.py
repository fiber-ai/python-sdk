...
T = TypeVar("T", bound="InvestorSearchBodySearchParamsLeadRateType0")


@_attrs_define
class InvestorSearchBodySearchParamsLeadRateType0:
    """Filter by lead investment rate (0.0 - 1.0). Values outside [0,1] will be clamped to this range
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        investor_search_body_search_params_lead_rate_type_0 = cls(
            lower_bound=lower_bound,
            upper_bound=upper_bound,
        )

        investor_search_body_search_params_lead_rate_type_0.additional_properties = d
        return investor_search_body_search_params_lead_rate_type_0
