...
T = TypeVar("T", bound="TwitterUserFollowersBody")


@_attrs_define
class TwitterUserFollowersBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        twitter_user_followers_body = cls(
            api_key=api_key,
            handle=handle,
            cursor=cursor,
        )

        twitter_user_followers_body.additional_properties = d
        return twitter_user_followers_body
