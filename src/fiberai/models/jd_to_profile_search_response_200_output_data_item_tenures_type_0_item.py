...
if TYPE_CHECKING:
    from ..models.jd_to_profile_search_response_200_output_data_item_tenures_type_0_item_date_range import (
        JdToProfileSearchResponse200OutputDataItemTenuresType0ItemDateRange,
    )


T = TypeVar("T", bound="JdToProfileSearchResponse200OutputDataItemTenuresType0Item")


@_attrs_define
class JdToProfileSearchResponse200OutputDataItemTenuresType0Item:
    """
    Attributes:
        date_range (JdToProfileSearchResponse200OutputDataItemTenuresType0ItemDateRange):
        titles (list[str]):
        localities (list[str]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        date_range = JdToProfileSearchResponse200OutputDataItemTenuresType0ItemDateRange.from_dict(d.pop("date_range"))
        ...
        jd_to_profile_search_response_200_output_data_item_tenures_type_0_item = cls(
            date_range=date_range,
            titles=titles,
            localities=localities,
        ...
        jd_to_profile_search_response_200_output_data_item_tenures_type_0_item.additional_properties = d
        return jd_to_profile_search_response_200_output_data_item_tenures_type_0_item
