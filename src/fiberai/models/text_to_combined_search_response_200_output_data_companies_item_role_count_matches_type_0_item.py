...
if TYPE_CHECKING:
    from ..models.text_to_combined_search_response_200_output_data_companies_item_role_count_matches_type_0_item_num_matching_employees_type_0 import (
        TextToCombinedSearchResponse200OutputDataCompaniesItemRoleCountMatchesType0ItemNumMatchingEmployeesType0,
    )
    from ..models.text_to_combined_search_response_200_output_data_companies_item_role_count_matches_type_0_item_num_matching_employees_type_1 import (
        TextToCombinedSearchResponse200OutputDataCompaniesItemRoleCountMatchesType0ItemNumMatchingEmployeesType1,
    )
    from ..models.text_to_combined_search_response_200_output_data_companies_item_role_count_matches_type_0_item_num_matching_employees_type_2 import (
        TextToCombinedSearchResponse200OutputDataCompaniesItemRoleCountMatchesType0ItemNumMatchingEmployeesType2,
    )
    from ..models.text_to_combined_search_response_200_output_data_companies_item_role_count_matches_type_0_item_num_matching_employees_type_3 import (
        ...
        def _parse_num_matching_employees(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                num_matching_employees_type_0 = TextToCombinedSearchResponse200OutputDataCompaniesItemRoleCountMatchesType0ItemNumMatchingEmployeesType0.from_dict(
                    data
                )
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                num_matching_employees_type_1 = TextToCombinedSearchResponse200OutputDataCompaniesItemRoleCountMatchesType0ItemNumMatchingEmployeesType1.from_dict(
                    data
                )
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                num_matching_employees_type_2 = TextToCombinedSearchResponse200OutputDataCompaniesItemRoleCountMatchesType0ItemNumMatchingEmployeesType2.from_dict(
                    data
                )
            ...
            if not isinstance(data, dict):
                raise TypeError()
            num_matching_employees_type_3 = TextToCombinedSearchResponse200OutputDataCompaniesItemRoleCountMatchesType0ItemNumMatchingEmployeesType3.from_dict(
                data
            )
