...
T = TypeVar("T", bound="KitchenSinkCompanyBodyCompanyLocationType0")


@_attrs_define
class KitchenSinkCompanyBodyCompanyLocationType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        kitchen_sink_company_body_company_location_type_0 = cls(
            country_code=country_code,
            state_name=state_name,
            locality=locality,
        )

        kitchen_sink_company_body_company_location_type_0.additional_properties = d
        return kitchen_sink_company_body_company_location_type_0
