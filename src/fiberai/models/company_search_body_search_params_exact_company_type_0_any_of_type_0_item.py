...
from ..models.company_search_body_search_params_exact_company_type_0_any_of_type_0_item_source_type_1 import (
    CompanySearchBodySearchParamsExactCompanyType0AnyOfType0ItemSourceType1,
)
from ..models.company_search_body_search_params_exact_company_type_0_any_of_type_0_item_source_type_2_type_1 import (
    CompanySearchBodySearchParamsExactCompanyType0AnyOfType0ItemSourceType2Type1,
)
from ..models.company_search_body_search_params_exact_company_type_0_any_of_type_0_item_source_type_3_type_1 import (
    CompanySearchBodySearchParamsExactCompanyType0AnyOfType0ItemSourceType3Type1,
)
...
class CompanySearchBodySearchParamsExactCompanyType0AnyOfType0Item:
    ...
    Attributes:
        ...
        source (CompanySearchBodySearchParamsExactCompanyType0AnyOfType0ItemSourceType1 |
            CompanySearchBodySearchParamsExactCompanyType0AnyOfType0ItemSourceType2Type1 |
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_source(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                source_type_2_type_1 = CompanySearchBodySearchParamsExactCompanyType0AnyOfType0ItemSourceType2Type1(
                    data
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                source_type_3_type_1 = CompanySearchBodySearchParamsExactCompanyType0AnyOfType0ItemSourceType3Type1(
                    data
                )
