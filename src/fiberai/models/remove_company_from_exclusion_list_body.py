...
if TYPE_CHECKING:
  from ..models.remove_company_from_exclusion_list_body_excluded_company_details import RemoveCompanyFromExclusionListBodyExcludedCompanyDetails
...
class RemoveCompanyFromExclusionListBody:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        excluded_company_details = RemoveCompanyFromExclusionListBodyExcludedCompanyDetails.from_dict(d.pop("excludedCompanyDetails"))
