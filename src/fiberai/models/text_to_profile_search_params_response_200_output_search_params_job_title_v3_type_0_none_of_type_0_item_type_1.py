...
from ..models.text_to_profile_search_params_response_200_output_search_params_job_title_v3_type_0_none_of_type_0_item_type_1_seniority_item import TextToProfileSearchParamsResponse200OutputSearchParamsJobTitleV3Type0NoneOfType0ItemType1SeniorityItem
from ..models.text_to_profile_search_params_response_200_output_search_params_job_title_v3_type_0_none_of_type_0_item_type_1_type import TextToProfileSearchParamsResponse200OutputSearchParamsJobTitleV3Type0NoneOfType0ItemType1Type
from ..types import UNSET, Unset
...
class TextToProfileSearchParamsResponse200OutputSearchParamsJobTitleV3Type0NoneOfType0ItemType1:
    ...
    type_: TextToProfileSearchParamsResponse200OutputSearchParamsJobTitleV3Type0NoneOfType0ItemType1Type
    seniority: list[TextToProfileSearchParamsResponse200OutputSearchParamsJobTitleV3Type0NoneOfType0ItemType1SeniorityItem]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        type_ = TextToProfileSearchParamsResponse200OutputSearchParamsJobTitleV3Type0NoneOfType0ItemType1Type(d.pop("type"))
        ...
        for seniority_item_data in (_seniority):
            seniority_item = TextToProfileSearchParamsResponse200OutputSearchParamsJobTitleV3Type0NoneOfType0ItemType1SeniorityItem(seniority_item_data)
