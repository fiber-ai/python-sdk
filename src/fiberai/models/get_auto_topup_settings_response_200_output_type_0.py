...
T = TypeVar("T", bound="GetAutoTopupSettingsResponse200OutputType0")


@_attrs_define
class GetAutoTopupSettingsResponse200OutputType0:
    """
    Attributes:
        configured (bool):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_auto_topup_settings_response_200_output_type_0 = cls(
            configured=configured,
        ...
        get_auto_topup_settings_response_200_output_type_0.additional_properties = d
        return get_auto_topup_settings_response_200_output_type_0
