...
T = TypeVar("T", bound="CreateTrackerCompanyListBodyCompanySearchParamsType0EmployeeCountV2Type0")


@_attrs_define
class CreateTrackerCompanyListBodyCompanySearchParamsType0EmployeeCountV2Type0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_tracker_company_list_body_company_search_params_type_0_employee_count_v2_type_0 = cls(
            lower_bound_exclusive=lower_bound_exclusive,
            upper_bound_inclusive=upper_bound_inclusive,
        )

        create_tracker_company_list_body_company_search_params_type_0_employee_count_v2_type_0.additional_properties = d
        return create_tracker_company_list_body_company_search_params_type_0_employee_count_v2_type_0
