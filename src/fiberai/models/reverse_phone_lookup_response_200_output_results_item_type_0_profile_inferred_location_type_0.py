...
if TYPE_CHECKING:
    from ..models.reverse_phone_lookup_response_200_output_results_item_type_0_profile_inferred_location_type_0_coordinates_type_0 import (
        ReversePhoneLookupResponse200OutputResultsItemType0ProfileInferredLocationType0CoordinatesType0,
    )


T = TypeVar("T", bound="ReversePhoneLookupResponse200OutputResultsItemType0ProfileInferredLocationType0")


@_attrs_define
class ReversePhoneLookupResponse200OutputResultsItemType0ProfileInferredLocationType0:
    """
    Attributes:
        ...
        coordinates (None |
            ReversePhoneLookupResponse200OutputResultsItemType0ProfileInferredLocationType0CoordinatesType0 | Unset):
    ...
    coordinates: (
        None | ReversePhoneLookupResponse200OutputResultsItemType0ProfileInferredLocationType0CoordinatesType0 | Unset
    ) = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.reverse_phone_lookup_response_200_output_results_item_type_0_profile_inferred_location_type_0_coordinates_type_0 import (
            ReversePhoneLookupResponse200OutputResultsItemType0ProfileInferredLocationType0CoordinatesType0,  # noqa: PLC0415
        )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_coordinates(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = ReversePhoneLookupResponse200OutputResultsItemType0ProfileInferredLocationType0CoordinatesType0.from_dict(
                    data
                )
        ...
        reverse_phone_lookup_response_200_output_results_item_type_0_profile_inferred_location_type_0 = cls(
        ...
        reverse_phone_lookup_response_200_output_results_item_type_0_profile_inferred_location_type_0.additional_properties = d
        return reverse_phone_lookup_response_200_output_results_item_type_0_profile_inferred_location_type_0
