...
@_attrs_define
class PaginatedCombinedSearchBodyCompanyConfigType0SearchParamsFortuneRankingsType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_any_of(
            ...
            list[PaginatedCombinedSearchBodyCompanyConfigType0SearchParamsFortuneRankingsType0AnyOfType0Item]
            | None
            | Unset
        ):
            if data is None:
            ...
            try:
                ...
                for any_of_type_0_item_data in _any_of_type_0:
                    any_of_type_0_item = PaginatedCombinedSearchBodyCompanyConfigType0SearchParamsFortuneRankingsType0AnyOfType0Item.from_dict(
        ...
        return paginated_combined_search_body_company_config_type_0_search_params_fortune_rankings_type_0
