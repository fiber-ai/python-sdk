...
T = TypeVar("T", bound="RefreshTrackerPersonListResponse200Output")


@_attrs_define
class RefreshTrackerPersonListResponse200Output:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        refresh_tracker_person_list_response_200_output = cls(
            entity_count=entity_count,
            estimated_credits=estimated_credits,
            message=message,
        )

        refresh_tracker_person_list_response_200_output.additional_properties = d
        return refresh_tracker_person_list_response_200_output
