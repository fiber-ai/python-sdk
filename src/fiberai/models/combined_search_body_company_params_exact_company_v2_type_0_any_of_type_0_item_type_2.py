...
from ..models.combined_search_body_company_params_exact_company_v2_type_0_any_of_type_0_item_type_2_identifier import CombinedSearchBodyCompanyParamsExactCompanyV2Type0AnyOfType0ItemType2Identifier
...
class CombinedSearchBodyCompanyParamsExactCompanyV2Type0AnyOfType0ItemType2:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        identifier = CombinedSearchBodyCompanyParamsExactCompanyV2Type0AnyOfType0ItemType2Identifier(d.pop("identifier"))
