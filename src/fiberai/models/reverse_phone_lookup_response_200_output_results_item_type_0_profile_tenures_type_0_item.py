...
if TYPE_CHECKING:
    from ..models.reverse_phone_lookup_response_200_output_results_item_type_0_profile_tenures_type_0_item_date_range import (
        ReversePhoneLookupResponse200OutputResultsItemType0ProfileTenuresType0ItemDateRange,
    )


T = TypeVar("T", bound="ReversePhoneLookupResponse200OutputResultsItemType0ProfileTenuresType0Item")


@_attrs_define
class ReversePhoneLookupResponse200OutputResultsItemType0ProfileTenuresType0Item:
    """
    Attributes:
        date_range (ReversePhoneLookupResponse200OutputResultsItemType0ProfileTenuresType0ItemDateRange):
        titles (list[str]):
        localities (list[str]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.reverse_phone_lookup_response_200_output_results_item_type_0_profile_tenures_type_0_item_date_range import (
            ReversePhoneLookupResponse200OutputResultsItemType0ProfileTenuresType0ItemDateRange,  # noqa: PLC0415
        )

        d = dict(src_dict)
        date_range = ReversePhoneLookupResponse200OutputResultsItemType0ProfileTenuresType0ItemDateRange.from_dict(
            d.pop("date_range")
        )
        ...
        reverse_phone_lookup_response_200_output_results_item_type_0_profile_tenures_type_0_item = cls(
            date_range=date_range,
            titles=titles,
            localities=localities,
        ...
        reverse_phone_lookup_response_200_output_results_item_type_0_profile_tenures_type_0_item.additional_properties = d
        return reverse_phone_lookup_response_200_output_results_item_type_0_profile_tenures_type_0_item
