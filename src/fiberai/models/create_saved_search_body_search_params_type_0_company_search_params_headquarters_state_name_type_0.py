...
T = TypeVar("T", bound="CreateSavedSearchBodySearchParamsType0CompanySearchParamsHeadquartersStateNameType0")


@_attrs_define
class CreateSavedSearchBodySearchParamsType0CompanySearchParamsHeadquartersStateNameType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_saved_search_body_search_params_type_0_company_search_params_headquarters_state_name_type_0 = cls(
            any_of=any_of,
            none_of=none_of,
        )

        create_saved_search_body_search_params_type_0_company_search_params_headquarters_state_name_type_0.additional_properties = d
        return create_saved_search_body_search_params_type_0_company_search_params_headquarters_state_name_type_0
