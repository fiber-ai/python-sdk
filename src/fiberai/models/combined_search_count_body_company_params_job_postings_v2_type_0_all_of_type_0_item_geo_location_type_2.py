...
if TYPE_CHECKING:
    from ..models.combined_search_count_body_company_params_job_postings_v2_type_0_all_of_type_0_item_geo_location_type_2_vertices_item import (
        CombinedSearchCountBodyCompanyParamsJobPostingsV2Type0AllOfType0ItemGeoLocationType2VerticesItem,
    )
...
class CombinedSearchCountBodyCompanyParamsJobPostingsV2Type0AllOfType0ItemGeoLocationType2:
    ...
    Attributes:
        ...
        vertices
            (list[CombinedSearchCountBodyCompanyParamsJobPostingsV2Type0AllOfType0ItemGeoLocationType2VerticesItem]):
    """

    strategy: CombinedSearchCountBodyCompanyParamsJobPostingsV2Type0AllOfType0ItemGeoLocationType2Strategy
    vertices: list[CombinedSearchCountBodyCompanyParamsJobPostingsV2Type0AllOfType0ItemGeoLocationType2VerticesItem]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.combined_search_count_body_company_params_job_postings_v2_type_0_all_of_type_0_item_geo_location_type_2_vertices_item import (
            CombinedSearchCountBodyCompanyParamsJobPostingsV2Type0AllOfType0ItemGeoLocationType2VerticesItem,  # noqa: PLC0415
        )
        ...
        for vertices_item_data in _vertices:
            vertices_item = CombinedSearchCountBodyCompanyParamsJobPostingsV2Type0AllOfType0ItemGeoLocationType2VerticesItem.from_dict(
                vertices_item_data
            )
