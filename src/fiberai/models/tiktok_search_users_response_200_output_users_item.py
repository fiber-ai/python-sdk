...
T = TypeVar("T", bound="TiktokSearchUsersResponse200OutputUsersItem")


@_attrs_define
class TiktokSearchUsersResponse200OutputUsersItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        tiktok_search_users_response_200_output_users_item = cls(
            id=id,
            handle=handle,
        ...
        tiktok_search_users_response_200_output_users_item.additional_properties = d
        return tiktok_search_users_response_200_output_users_item
