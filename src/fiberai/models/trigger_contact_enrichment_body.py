...
class TriggerContactEnrichmentBody:
    """ 
        Attributes:
            ...
            enrichment_type (Union[Unset, TriggerContactEnrichmentBodyEnrichmentType]): Enrichment types to be requested.
    ...
    api_key: str
    linkedin_url: 'TriggerContactEnrichmentBodyLinkedinUrl'
    enrichment_type: Union[Unset, 'TriggerContactEnrichmentBodyEnrichmentType'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        enrichment_type: Union[Unset, TriggerContactEnrichmentBodyEnrichmentType]
