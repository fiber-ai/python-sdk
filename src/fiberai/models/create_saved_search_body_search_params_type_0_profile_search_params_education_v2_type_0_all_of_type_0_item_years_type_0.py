...
T = TypeVar(
    "T", bound="CreateSavedSearchBodySearchParamsType0ProfileSearchParamsEducationV2Type0AllOfType0ItemYearsType0"
)


@_attrs_define
class CreateSavedSearchBodySearchParamsType0ProfileSearchParamsEducationV2Type0AllOfType0ItemYearsType0:
    """
    Attributes:
        started_school_at (CreateSavedSearchBodySearchParamsType0ProfileSearchParamsEducationV2Type0AllOfType0ItemYearsT
            ype0StartedSchoolAtType0 | CreateSavedSearchBodySearchParamsType0ProfileSearchParamsEducationV2Type0AllOfType0It
            emYearsType0StartedSchoolAtType1 | None | Unset):
        finished_school_at (CreateSavedSearchBodySearchParamsType0ProfileSearchParamsEducationV2Type0AllOfType0ItemYears
            Type0FinishedSchoolAtType0 | CreateSavedSearchBodySearchParamsType0ProfileSearchParamsEducationV2Type0AllOfType0
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_started_school_at(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                started_school_at_type_0 = CreateSavedSearchBodySearchParamsType0ProfileSearchParamsEducationV2Type0AllOfType0ItemYearsType0StartedSchoolAtType0.from_dict(
                    data
                )
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                started_school_at_type_1 = CreateSavedSearchBodySearchParamsType0ProfileSearchParamsEducationV2Type0AllOfType0ItemYearsType0StartedSchoolAtType1.from_dict(
                    data
                )
        ...
        def _parse_finished_school_at(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                finished_school_at_type_0 = CreateSavedSearchBodySearchParamsType0ProfileSearchParamsEducationV2Type0AllOfType0ItemYearsType0FinishedSchoolAtType0.from_dict(
                    data
                )
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                finished_school_at_type_1 = CreateSavedSearchBodySearchParamsType0ProfileSearchParamsEducationV2Type0AllOfType0ItemYearsType0FinishedSchoolAtType1.from_dict(
                    data
                )
        ...
        create_saved_search_body_search_params_type_0_profile_search_params_education_v2_type_0_all_of_type_0_item_years_type_0 = cls(
            started_school_at=started_school_at,
            finished_school_at=finished_school_at,
            is_currently_student=is_currently_student,
        )

        create_saved_search_body_search_params_type_0_profile_search_params_education_v2_type_0_all_of_type_0_item_years_type_0.additional_properties = d
        return create_saved_search_body_search_params_type_0_profile_search_params_education_v2_type_0_all_of_type_0_item_years_type_0
