...
T = TypeVar("T", bound="ReversePhoneLookupResponse200OutputResultsItemType1CompanyLocationsType0ItemLocationType0")


@_attrs_define
class ReversePhoneLookupResponse200OutputResultsItemType1CompanyLocationsType0ItemLocationType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_coordinates(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = ReversePhoneLookupResponse200OutputResultsItemType1CompanyLocationsType0ItemLocationType0CoordinatesType0.from_dict(
                    data
                )
        ...
        reverse_phone_lookup_response_200_output_results_item_type_1_company_locations_type_0_item_location_type_0 = (
            cls(
        ...
        reverse_phone_lookup_response_200_output_results_item_type_1_company_locations_type_0_item_location_type_0.additional_properties = d
        return (
            reverse_phone_lookup_response_200_output_results_item_type_1_company_locations_type_0_item_location_type_0
        )
