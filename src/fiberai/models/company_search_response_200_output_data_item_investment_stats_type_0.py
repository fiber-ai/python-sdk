...
if TYPE_CHECKING:
    from ..models.company_search_response_200_output_data_item_investment_stats_type_0_investments_by_stage_type_0_item import (
        CompanySearchResponse200OutputDataItemInvestmentStatsType0InvestmentsByStageType0Item,
    )
...
class CompanySearchResponse200OutputDataItemInvestmentStatsType0:
    ...
    Attributes:
        investments_by_stage
            (list[CompanySearchResponse200OutputDataItemInvestmentStatsType0InvestmentsByStageType0Item] | None | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.company_search_response_200_output_data_item_investment_stats_type_0_investments_by_stage_type_0_item import (
            CompanySearchResponse200OutputDataItemInvestmentStatsType0InvestmentsByStageType0Item,  # noqa: PLC0415
        )
            ...
            try:
                ...
                for investments_by_stage_type_0_item_data in _investments_by_stage_type_0:
                    investments_by_stage_type_0_item = (
                        CompanySearchResponse200OutputDataItemInvestmentStatsType0InvestmentsByStageType0Item.from_dict(
