...
from ..models.social_media_lookup_trigger_body_person_type_0_input_type import (
    SocialMediaLookupTriggerBodyPersonType0InputType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="SocialMediaLookupTriggerBodyPersonType0")


@_attrs_define
class SocialMediaLookupTriggerBodyPersonType0:
    """
    Attributes:
        input_type (SocialMediaLookupTriggerBodyPersonType0InputType):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        input_type = SocialMediaLookupTriggerBodyPersonType0InputType(d.pop("inputType"))
        ...
        social_media_lookup_trigger_body_person_type_0 = cls(
            input_type=input_type,
            linkedin_url=linkedin_url,
            customer_provided_id=customer_provided_id,
        )

        social_media_lookup_trigger_body_person_type_0.additional_properties = d
        return social_media_lookup_trigger_body_person_type_0
