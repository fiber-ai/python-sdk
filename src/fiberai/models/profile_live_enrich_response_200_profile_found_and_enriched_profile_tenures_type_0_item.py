...
if TYPE_CHECKING:
    from ..models.profile_live_enrich_response_200_profile_found_and_enriched_profile_tenures_type_0_item_date_range import (
        ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileTenuresType0ItemDateRange,
    )


T = TypeVar("T", bound="ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileTenuresType0Item")


@_attrs_define
class ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileTenuresType0Item:
    """
    Attributes:
        date_range (ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileTenuresType0ItemDateRange):
        titles (list[str]):
        localities (list[str]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.profile_live_enrich_response_200_profile_found_and_enriched_profile_tenures_type_0_item_date_range import (
            ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileTenuresType0ItemDateRange,  # noqa: PLC0415
        )

        d = dict(src_dict)
        date_range = ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileTenuresType0ItemDateRange.from_dict(
            d.pop("date_range")
        )
        ...
        profile_live_enrich_response_200_profile_found_and_enriched_profile_tenures_type_0_item = cls(
            date_range=date_range,
            titles=titles,
            localities=localities,
        ...
        profile_live_enrich_response_200_profile_found_and_enriched_profile_tenures_type_0_item.additional_properties = d
        return profile_live_enrich_response_200_profile_found_and_enriched_profile_tenures_type_0_item
