...
if TYPE_CHECKING:
  from ..models.profile_live_enrich_response_200_profile_found_and_enriched_profile_tenures_type_0_item_date_range import ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileTenuresType0ItemDateRange
...
class ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileTenuresType0Item:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.profile_live_enrich_response_200_profile_found_and_enriched_profile_tenures_type_0_item_date_range import ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileTenuresType0ItemDateRange
        d = dict(src_dict)
        date_range = ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileTenuresType0ItemDateRange.from_dict(d.pop("date_range"))
