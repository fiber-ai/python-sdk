...
T = TypeVar("T", bound="CompanySearchBodySearchParamsEmployeeTrendsV2Type0ObeysAnyType0ItemType0Change")


@_attrs_define
class CompanySearchBodySearchParamsEmployeeTrendsV2Type0ObeysAnyType0ItemType0Change:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        company_search_body_search_params_employee_trends_v2_type_0_obeys_any_type_0_item_type_0_change = cls(
            lower_bound=lower_bound,
            upper_bound=upper_bound,
        )

        company_search_body_search_params_employee_trends_v2_type_0_obeys_any_type_0_item_type_0_change.additional_properties = d
        return company_search_body_search_params_employee_trends_v2_type_0_obeys_any_type_0_item_type_0_change
