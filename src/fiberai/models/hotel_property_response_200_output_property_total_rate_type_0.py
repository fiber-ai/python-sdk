...
T = TypeVar("T", bound="HotelPropertyResponse200OutputPropertyTotalRateType0")


@_attrs_define
class HotelPropertyResponse200OutputPropertyTotalRateType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        hotel_property_response_200_output_property_total_rate_type_0 = cls(
            currency_code=currency_code,
            all_in_cost=all_in_cost,
            base_cost=base_cost,
        )

        hotel_property_response_200_output_property_total_rate_type_0.additional_properties = d
        return hotel_property_response_200_output_property_total_rate_type_0
