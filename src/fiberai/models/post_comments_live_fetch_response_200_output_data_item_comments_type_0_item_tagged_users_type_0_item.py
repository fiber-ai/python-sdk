...
T = TypeVar("T", bound="PostCommentsLiveFetchResponse200OutputDataItemCommentsType0ItemTaggedUsersType0Item")


@_attrs_define
class PostCommentsLiveFetchResponse200OutputDataItemCommentsType0ItemTaggedUsersType0Item:
    """
    Attributes:
        name (None | str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        return post_comments_live_fetch_response_200_output_data_item_comments_type_0_item_tagged_users_type_0_item
