...
@_attrs_define
class CombinedSearchCountBodyCompanyParamsOfficeLocationsV2Type0AllOfType0ItemType2LocationType2:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.combined_search_count_body_company_params_office_locations_v2_type_0_all_of_type_0_item_type_2_location_type_2_vertices_item import (
            CombinedSearchCountBodyCompanyParamsOfficeLocationsV2Type0AllOfType0ItemType2LocationType2VerticesItem,  # noqa: PLC0415
        )
        ...
        return combined_search_count_body_company_params_office_locations_v2_type_0_all_of_type_0_item_type_2_location_type_2
