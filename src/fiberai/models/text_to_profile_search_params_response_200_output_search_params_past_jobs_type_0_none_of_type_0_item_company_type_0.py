...
from ..models.text_to_profile_search_params_response_200_output_search_params_past_jobs_type_0_none_of_type_0_item_company_type_0_source_type_1 import (
    TextToProfileSearchParamsResponse200OutputSearchParamsPastJobsType0NoneOfType0ItemCompanyType0SourceType1,
)
from ..models.text_to_profile_search_params_response_200_output_search_params_past_jobs_type_0_none_of_type_0_item_company_type_0_source_type_2_type_1 import (
    TextToProfileSearchParamsResponse200OutputSearchParamsPastJobsType0NoneOfType0ItemCompanyType0SourceType2Type1,
)
from ..models.text_to_profile_search_params_response_200_output_search_params_past_jobs_type_0_none_of_type_0_item_company_type_0_source_type_3_type_1 import (
        ...
        def _parse_source(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                source_type_1 = TextToProfileSearchParamsResponse200OutputSearchParamsPastJobsType0NoneOfType0ItemCompanyType0SourceType1(
                    data
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                source_type_2_type_1 = TextToProfileSearchParamsResponse200OutputSearchParamsPastJobsType0NoneOfType0ItemCompanyType0SourceType2Type1(
                    data
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                source_type_3_type_1 = TextToProfileSearchParamsResponse200OutputSearchParamsPastJobsType0NoneOfType0ItemCompanyType0SourceType3Type1(
                    data
                )
