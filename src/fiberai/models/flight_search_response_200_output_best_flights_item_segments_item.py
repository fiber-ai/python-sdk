...
if TYPE_CHECKING:
    from ..models.flight_search_response_200_output_best_flights_item_segments_item_arrival_airport import (
        FlightSearchResponse200OutputBestFlightsItemSegmentsItemArrivalAirport,
    )
    from ..models.flight_search_response_200_output_best_flights_item_segments_item_departure_airport import (
        FlightSearchResponse200OutputBestFlightsItemSegmentsItemDepartureAirport,
    )


T = TypeVar("T", bound="FlightSearchResponse200OutputBestFlightsItemSegmentsItem")


@_attrs_define
class FlightSearchResponse200OutputBestFlightsItemSegmentsItem:
    """
    Attributes:
        departure_airport (FlightSearchResponse200OutputBestFlightsItemSegmentsItemDepartureAirport): Departure airport.
        arrival_airport (FlightSearchResponse200OutputBestFlightsItemSegmentsItemArrivalAirport): Arrival airport.
    ...
    departure_airport: FlightSearchResponse200OutputBestFlightsItemSegmentsItemDepartureAirport
    arrival_airport: FlightSearchResponse200OutputBestFlightsItemSegmentsItemArrivalAirport
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.flight_search_response_200_output_best_flights_item_segments_item_arrival_airport import (
            FlightSearchResponse200OutputBestFlightsItemSegmentsItemArrivalAirport,  # noqa: PLC0415
        )
        from ..models.flight_search_response_200_output_best_flights_item_segments_item_departure_airport import (
            FlightSearchResponse200OutputBestFlightsItemSegmentsItemDepartureAirport,  # noqa: PLC0415
        )

        d = dict(src_dict)
        departure_airport = FlightSearchResponse200OutputBestFlightsItemSegmentsItemDepartureAirport.from_dict(
            d.pop("departureAirport")
        )

        arrival_airport = FlightSearchResponse200OutputBestFlightsItemSegmentsItemArrivalAirport.from_dict(
        ...
        flight_search_response_200_output_best_flights_item_segments_item = cls(
        ...
        flight_search_response_200_output_best_flights_item_segments_item.additional_properties = d
        return flight_search_response_200_output_best_flights_item_segments_item
