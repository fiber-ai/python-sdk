...
T = TypeVar("T", bound="TextToCombinedSearchResponse200OutputCompanySearchParamsType0NameLikeType0")



@_attrs_define
class TextToCombinedSearchResponse200OutputCompanySearchParamsType0NameLikeType0:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        text_to_combined_search_response_200_output_company_search_params_type_0_name_like_type_0 = cls(
            any_of=any_of,
            none_of=none_of,
        )


        text_to_combined_search_response_200_output_company_search_params_type_0_name_like_type_0.additional_properties = d
        return text_to_combined_search_response_200_output_company_search_params_type_0_name_like_type_0
