...
T = TypeVar("T", bound="CreateSavedSearchBodySearchParamsType1CompanySearchParamsInvestorsType0NoneOfType0Item")


@_attrs_define
class CreateSavedSearchBodySearchParamsType1CompanySearchParamsInvestorsType0NoneOfType0Item:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_saved_search_body_search_params_type_1_company_search_params_investors_type_0_none_of_type_0_item = cls(
            linkedin_company_id=linkedin_company_id,
            linkedin_url=linkedin_url,
            company_domain=company_domain,
        )

        create_saved_search_body_search_params_type_1_company_search_params_investors_type_0_none_of_type_0_item.additional_properties = d
        return create_saved_search_body_search_params_type_1_company_search_params_investors_type_0_none_of_type_0_item
