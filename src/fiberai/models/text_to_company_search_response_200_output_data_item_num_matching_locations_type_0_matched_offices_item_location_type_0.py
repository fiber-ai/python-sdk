...
if TYPE_CHECKING:
    from ..models.text_to_company_search_response_200_output_data_item_num_matching_locations_type_0_matched_offices_item_location_type_0_coordinates_type_0 import (
        TextToCompanySearchResponse200OutputDataItemNumMatchingLocationsType0MatchedOfficesItemLocationType0CoordinatesType0,
    )


T = TypeVar(
    "T", bound="TextToCompanySearchResponse200OutputDataItemNumMatchingLocationsType0MatchedOfficesItemLocationType0"
)
...
class TextToCompanySearchResponse200OutputDataItemNumMatchingLocationsType0MatchedOfficesItemLocationType0:
    ...
    Attributes:
        ...
        coordinates (None | TextToCompanySearchResponse200OutputDataItemNumMatchingLocationsType0MatchedOfficesItemLocat
            ionType0CoordinatesType0 | Unset):
        ...
        def _parse_coordinates(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = TextToCompanySearchResponse200OutputDataItemNumMatchingLocationsType0MatchedOfficesItemLocationType0CoordinatesType0.from_dict(
                    data
                )
