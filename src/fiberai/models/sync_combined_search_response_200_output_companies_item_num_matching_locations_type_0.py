...
if TYPE_CHECKING:
    from ..models.sync_combined_search_response_200_output_companies_item_num_matching_locations_type_0_matched_offices_item import (
        SyncCombinedSearchResponse200OutputCompaniesItemNumMatchingLocationsType0MatchedOfficesItem,
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for matched_offices_item_data in _matched_offices:
            matched_offices_item = (
                SyncCombinedSearchResponse200OutputCompaniesItemNumMatchingLocationsType0MatchedOfficesItem.from_dict(
