...
from ..models.combined_search_body_company_params_exact_company_v2_type_0_none_of_type_0_item_type_1_identifier import CombinedSearchBodyCompanyParamsExactCompanyV2Type0NoneOfType0ItemType1Identifier
...
class CombinedSearchBodyCompanyParamsExactCompanyV2Type0NoneOfType0ItemType1:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        identifier = CombinedSearchBodyCompanyParamsExactCompanyV2Type0NoneOfType0ItemType1Identifier(d.pop("identifier"))
