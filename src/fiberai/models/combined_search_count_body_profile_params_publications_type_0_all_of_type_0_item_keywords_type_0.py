...
T = TypeVar("T", bound="CombinedSearchCountBodyProfileParamsPublicationsType0AllOfType0ItemKeywordsType0")


@_attrs_define
class CombinedSearchCountBodyProfileParamsPublicationsType0AllOfType0ItemKeywordsType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        combined_search_count_body_profile_params_publications_type_0_all_of_type_0_item_keywords_type_0 = cls(
            any_of=any_of,
            none_of=none_of,
        )

        combined_search_count_body_profile_params_publications_type_0_all_of_type_0_item_keywords_type_0.additional_properties = d
        return combined_search_count_body_profile_params_publications_type_0_all_of_type_0_item_keywords_type_0
