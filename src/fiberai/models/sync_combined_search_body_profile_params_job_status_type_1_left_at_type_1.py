...
from ..models.sync_combined_search_body_profile_params_job_status_type_1_left_at_type_1_strategy import (
    SyncCombinedSearchBodyProfileParamsJobStatusType1LeftAtType1Strategy,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.sync_combined_search_body_profile_params_job_status_type_1_left_at_type_1_window_type_0 import (
        SyncCombinedSearchBodyProfileParamsJobStatusType1LeftAtType1WindowType0,
    )
    from ..models.sync_combined_search_body_profile_params_job_status_type_1_left_at_type_1_window_type_1 import (
        SyncCombinedSearchBodyProfileParamsJobStatusType1LeftAtType1WindowType1,
    )
    from ..models.sync_combined_search_body_profile_params_job_status_type_1_left_at_type_1_window_type_2 import (
        SyncCombinedSearchBodyProfileParamsJobStatusType1LeftAtType1WindowType2,
    )
...
class SyncCombinedSearchBodyProfileParamsJobStatusType1LeftAtType1:
    ...
    Attributes:
        ...
        window (None | SyncCombinedSearchBodyProfileParamsJobStatusType1LeftAtType1WindowType0 |
            SyncCombinedSearchBodyProfileParamsJobStatusType1LeftAtType1WindowType1 |
            SyncCombinedSearchBodyProfileParamsJobStatusType1LeftAtType1WindowType2 | Unset):
    """
