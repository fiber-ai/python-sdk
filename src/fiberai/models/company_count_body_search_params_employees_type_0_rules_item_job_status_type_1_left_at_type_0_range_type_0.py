...
T = TypeVar("T", bound="CompanyCountBodySearchParamsEmployeesType0RulesItemJobStatusType1LeftAtType0RangeType0")


@_attrs_define
class CompanyCountBodySearchParamsEmployeesType0RulesItemJobStatusType1LeftAtType0RangeType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        company_count_body_search_params_employees_type_0_rules_item_job_status_type_1_left_at_type_0_range_type_0 = (
            cls(
        ...
        company_count_body_search_params_employees_type_0_rules_item_job_status_type_1_left_at_type_0_range_type_0.additional_properties = d
        return (
            company_count_body_search_params_employees_type_0_rules_item_job_status_type_1_left_at_type_0_range_type_0
        )
