...
if TYPE_CHECKING:
    from ..models.sync_combined_search_response_200_output_companies_item_location_consensus_type_0_coordinates_type_0 import (
        SyncCombinedSearchResponse200OutputCompaniesItemLocationConsensusType0CoordinatesType0,
    )
...
class SyncCombinedSearchResponse200OutputCompaniesItemLocationConsensusType0:
    ...
    Attributes:
        ...
        coordinates (None | SyncCombinedSearchResponse200OutputCompaniesItemLocationConsensusType0CoordinatesType0 |
            Unset):
    ...
    coordinates: (
        None | SyncCombinedSearchResponse200OutputCompaniesItemLocationConsensusType0CoordinatesType0 | Unset
    ) = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.coordinates, Unset):
            ...
            self.coordinates, SyncCombinedSearchResponse200OutputCompaniesItemLocationConsensusType0CoordinatesType0
        ):
        ...
        def _parse_coordinates(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = (
                    SyncCombinedSearchResponse200OutputCompaniesItemLocationConsensusType0CoordinatesType0.from_dict(
                        data
                    )
                )
