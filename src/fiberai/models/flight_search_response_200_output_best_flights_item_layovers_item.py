...
T = TypeVar("T", bound="FlightSearchResponse200OutputBestFlightsItemLayoversItem")


@_attrs_define
class FlightSearchResponse200OutputBestFlightsItemLayoversItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        flight_search_response_200_output_best_flights_item_layovers_item = cls(
            iata_code=iata_code,
        ...
        flight_search_response_200_output_best_flights_item_layovers_item.additional_properties = d
        return flight_search_response_200_output_best_flights_item_layovers_item
