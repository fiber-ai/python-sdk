...
T = TypeVar("T", bound="CompanySearchResponse200OutputDataItemFullFundingRoundsType0ItemInvestorsType0Item")



@_attrs_define
class CompanySearchResponse200OutputDataItemFullFundingRoundsType0ItemInvestorsType0Item:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        company_search_response_200_output_data_item_full_funding_rounds_type_0_item_investors_type_0_item = cls(
            is_lead=is_lead,
        ...
        company_search_response_200_output_data_item_full_funding_rounds_type_0_item_investors_type_0_item.additional_properties = d
        return company_search_response_200_output_data_item_full_funding_rounds_type_0_item_investors_type_0_item
