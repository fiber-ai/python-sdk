...
if TYPE_CHECKING:
    from ..models.poll_combined_search_response_200_output_data_type_1_items_item_detailed_education_type_0_item_school_details_type_0 import (
        PollCombinedSearchResponse200OutputDataType1ItemsItemDetailedEducationType0ItemSchoolDetailsType0,
    )
...
class PollCombinedSearchResponse200OutputDataType1ItemsItemDetailedEducationType0Item:
    ...
    Attributes:
        school_details (None |
            PollCombinedSearchResponse200OutputDataType1ItemsItemDetailedEducationType0ItemSchoolDetailsType0 | Unset):
    ...
    school_details: (
        None | PollCombinedSearchResponse200OutputDataType1ItemsItemDetailedEducationType0ItemSchoolDetailsType0 | Unset
    ) = UNSET
        ...
        def _parse_school_details(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                school_details_type_0 = PollCombinedSearchResponse200OutputDataType1ItemsItemDetailedEducationType0ItemSchoolDetailsType0.from_dict(
                    data
                )
