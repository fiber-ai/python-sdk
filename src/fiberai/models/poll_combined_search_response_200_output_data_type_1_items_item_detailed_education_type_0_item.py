...
if TYPE_CHECKING:
  from ..models.poll_combined_search_response_200_output_data_type_1_items_item_detailed_education_type_0_item_school_details_type_0 import PollCombinedSearchResponse200OutputDataType1ItemsItemDetailedEducationType0ItemSchoolDetailsType0





T = TypeVar("T", bound="PollCombinedSearchResponse200OutputDataType1ItemsItemDetailedEducationType0Item")



@_attrs_define
class PollCombinedSearchResponse200OutputDataType1ItemsItemDetailedEducationType0Item:
    """ 
        Attributes:
            school_details
                (Union['PollCombinedSearchResponse200OutputDataType1ItemsItemDetailedEducationType0ItemSchoolDetailsType0',
                None, Unset]):
    ...
    school_details: Union['PollCombinedSearchResponse200OutputDataType1ItemsItemDetailedEducationType0ItemSchoolDetailsType0', None, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.school_details, PollCombinedSearchResponse200OutputDataType1ItemsItemDetailedEducationType0ItemSchoolDetailsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.poll_combined_search_response_200_output_data_type_1_items_item_detailed_education_type_0_item_school_details_type_0 import PollCombinedSearchResponse200OutputDataType1ItemsItemDetailedEducationType0ItemSchoolDetailsType0
        d = dict(src_dict)
        def _parse_school_details(data: object) -> Union['PollCombinedSearchResponse200OutputDataType1ItemsItemDetailedEducationType0ItemSchoolDetailsType0', None, Unset]:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                school_details_type_0 = PollCombinedSearchResponse200OutputDataType1ItemsItemDetailedEducationType0ItemSchoolDetailsType0.from_dict(data)
                ...
                pass
            return cast(Union['PollCombinedSearchResponse200OutputDataType1ItemsItemDetailedEducationType0ItemSchoolDetailsType0', None, Unset], data)
        ...
        poll_combined_search_response_200_output_data_type_1_items_item_detailed_education_type_0_item = cls(
        ...
        poll_combined_search_response_200_output_data_type_1_items_item_detailed_education_type_0_item.additional_properties = d
        return poll_combined_search_response_200_output_data_type_1_items_item_detailed_education_type_0_item
