...
from ..models.lite_reverse_email_lookup_response_200_output_data_item_experiences_type_0_item_academic_qualification_type_0_item import (
    LiteReverseEmailLookupResponse200OutputDataItemExperiencesType0ItemAcademicQualificationType0Item,
)
from ..models.lite_reverse_email_lookup_response_200_output_data_item_experiences_type_0_item_employment_type_type_0_item import (
    LiteReverseEmailLookupResponse200OutputDataItemExperiencesType0ItemEmploymentTypeType0Item,
)
from ..models.lite_reverse_email_lookup_response_200_output_data_item_experiences_type_0_item_job_function_type_0_item import (
    LiteReverseEmailLookupResponse200OutputDataItemExperiencesType0ItemJobFunctionType0Item,
)
from ..models.lite_reverse_email_lookup_response_200_output_data_item_experiences_type_0_item_seniority_type_1 import (
    LiteReverseEmailLookupResponse200OutputDataItemExperiencesType0ItemSeniorityType1,
)
from ..models.lite_reverse_email_lookup_response_200_output_data_item_experiences_type_0_item_seniority_type_2_type_1 import (
    LiteReverseEmailLookupResponse200OutputDataItemExperiencesType0ItemSeniorityType2Type1,
)
from ..models.lite_reverse_email_lookup_response_200_output_data_item_experiences_type_0_item_seniority_type_3_type_1 import (
    LiteReverseEmailLookupResponse200OutputDataItemExperiencesType0ItemSeniorityType3Type1,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="LiteReverseEmailLookupResponse200OutputDataItemExperiencesType0Item")


@_attrs_define
class LiteReverseEmailLookupResponse200OutputDataItemExperiencesType0Item:
    """
    Attributes:
        ...
        seniority (LiteReverseEmailLookupResponse200OutputDataItemExperiencesType0ItemSeniorityType1 |
            LiteReverseEmailLookupResponse200OutputDataItemExperiencesType0ItemSeniorityType2Type1 |
            LiteReverseEmailLookupResponse200OutputDataItemExperiencesType0ItemSeniorityType3Type1 | None | Unset):
        job_function (list[LiteReverseEmailLookupResponse200OutputDataItemExperiencesType0ItemJobFunctionType0Item] |
            None | Unset):
        employment_type
            (list[LiteReverseEmailLookupResponse200OutputDataItemExperiencesType0ItemEmploymentTypeType0Item] | None |
            Unset):
        academic_qualification
            (list[LiteReverseEmailLookupResponse200OutputDataItemExperiencesType0ItemAcademicQualificationType0Item] | None
            | Unset):
    ...
    job_function: (
        list[LiteReverseEmailLookupResponse200OutputDataItemExperiencesType0ItemJobFunctionType0Item] | None | Unset
    ) = UNSET
    employment_type: (
        list[LiteReverseEmailLookupResponse200OutputDataItemExperiencesType0ItemEmploymentTypeType0Item] | None | Unset
    ) = UNSET
    academic_qualification: (
        list[LiteReverseEmailLookupResponse200OutputDataItemExperiencesType0ItemAcademicQualificationType0Item]
        | None
        | Unset
    ) = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.seniority, Unset):
            ...
            self.seniority, LiteReverseEmailLookupResponse200OutputDataItemExperiencesType0ItemSeniorityType1
        ):
            seniority = self.seniority.value
        elif isinstance(
            self.seniority, LiteReverseEmailLookupResponse200OutputDataItemExperiencesType0ItemSeniorityType2Type1
        ):
            seniority = self.seniority.value
        elif isinstance(
            self.seniority, LiteReverseEmailLookupResponse200OutputDataItemExperiencesType0ItemSeniorityType3Type1
        ):
            seniority = self.seniority.value
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_seniority(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                seniority_type_1 = LiteReverseEmailLookupResponse200OutputDataItemExperiencesType0ItemSeniorityType1(
                    data
                )
            ...
            try:
                ...
                seniority_type_2_type_1 = (
                    LiteReverseEmailLookupResponse200OutputDataItemExperiencesType0ItemSeniorityType2Type1(data)
                )
            ...
            try:
                ...
                seniority_type_3_type_1 = (
                    LiteReverseEmailLookupResponse200OutputDataItemExperiencesType0ItemSeniorityType3Type1(data)
                )
        ...
        def _parse_job_function(
            ...
            try:
                ...
                pass
            return cast(
                list[LiteReverseEmailLookupResponse200OutputDataItemExperiencesType0ItemJobFunctionType0Item]
                | None
                | Unset,
                data,
            )
        ...
        def _parse_employment_type(
            ...
            list[LiteReverseEmailLookupResponse200OutputDataItemExperiencesType0ItemEmploymentTypeType0Item]
            | None
            | Unset
        ):
            if data is None:
        ...
        def _parse_academic_qualification(
            ...
            try:
                ...
                for academic_qualification_type_0_item_data in _academic_qualification_type_0:
                    academic_qualification_type_0_item = LiteReverseEmailLookupResponse200OutputDataItemExperiencesType0ItemAcademicQualificationType0Item(
        ...
        lite_reverse_email_lookup_response_200_output_data_item_experiences_type_0_item = cls(
        ...
        lite_reverse_email_lookup_response_200_output_data_item_experiences_type_0_item.additional_properties = d
        return lite_reverse_email_lookup_response_200_output_data_item_experiences_type_0_item
