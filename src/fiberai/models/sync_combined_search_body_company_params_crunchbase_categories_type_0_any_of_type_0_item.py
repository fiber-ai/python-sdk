...
from ..models.sync_combined_search_body_company_params_crunchbase_categories_type_0_any_of_type_0_item_type import (
    SyncCombinedSearchBodyCompanyParamsCrunchbaseCategoriesType0AnyOfType0ItemType,
)
