...
T = TypeVar("T", bound="TiktokTrendingFeedResponse200OutputVideosItem")


@_attrs_define
class TiktokTrendingFeedResponse200OutputVideosItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        tiktok_trending_feed_response_200_output_videos_item = cls(
            id=id,
            caption=caption,
        ...
        tiktok_trending_feed_response_200_output_videos_item.additional_properties = d
        return tiktok_trending_feed_response_200_output_videos_item
