...
T = TypeVar("T", bound="SyncCombinedSearchBodyCompanyParamsKeywordsType0")



@_attrs_define
class SyncCombinedSearchBodyCompanyParamsKeywordsType0:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sync_combined_search_body_company_params_keywords_type_0 = cls(
        ...
        sync_combined_search_body_company_params_keywords_type_0.additional_properties = d
        return sync_combined_search_body_company_params_keywords_type_0
