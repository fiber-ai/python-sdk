...
if TYPE_CHECKING:
  from ..models.people_search_response_200_output_data_item_tenures_type_0_item_date_range import PeopleSearchResponse200OutputDataItemTenuresType0ItemDateRange





T = TypeVar("T", bound="PeopleSearchResponse200OutputDataItemTenuresType0Item")



@_attrs_define
class PeopleSearchResponse200OutputDataItemTenuresType0Item:
    """ 
        Attributes:
            date_range (PeopleSearchResponse200OutputDataItemTenuresType0ItemDateRange):
            titles (list[str]):
            localities (list[str]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.people_search_response_200_output_data_item_tenures_type_0_item_date_range import PeopleSearchResponse200OutputDataItemTenuresType0ItemDateRange
        d = dict(src_dict)
        date_range = PeopleSearchResponse200OutputDataItemTenuresType0ItemDateRange.from_dict(d.pop("date_range"))
        ...
        people_search_response_200_output_data_item_tenures_type_0_item = cls(
            date_range=date_range,
            titles=titles,
            localities=localities,
        ...
        people_search_response_200_output_data_item_tenures_type_0_item.additional_properties = d
        return people_search_response_200_output_data_item_tenures_type_0_item
