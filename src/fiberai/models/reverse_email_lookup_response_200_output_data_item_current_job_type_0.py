...
from ..models.reverse_email_lookup_response_200_output_data_item_current_job_type_0_academic_qualification_type_0_item import (
    ReverseEmailLookupResponse200OutputDataItemCurrentJobType0AcademicQualificationType0Item,
)
from ..models.reverse_email_lookup_response_200_output_data_item_current_job_type_0_employment_type_type_0_item import (
    ReverseEmailLookupResponse200OutputDataItemCurrentJobType0EmploymentTypeType0Item,
)
from ..models.reverse_email_lookup_response_200_output_data_item_current_job_type_0_job_function_type_0_item import (
    ReverseEmailLookupResponse200OutputDataItemCurrentJobType0JobFunctionType0Item,
)
from ..models.reverse_email_lookup_response_200_output_data_item_current_job_type_0_seniority_type_1 import (
    ReverseEmailLookupResponse200OutputDataItemCurrentJobType0SeniorityType1,
)
from ..models.reverse_email_lookup_response_200_output_data_item_current_job_type_0_seniority_type_2_type_1 import (
    ReverseEmailLookupResponse200OutputDataItemCurrentJobType0SeniorityType2Type1,
)
from ..models.reverse_email_lookup_response_200_output_data_item_current_job_type_0_seniority_type_3_type_1 import (
    ReverseEmailLookupResponse200OutputDataItemCurrentJobType0SeniorityType3Type1,
)
...
class ReverseEmailLookupResponse200OutputDataItemCurrentJobType0:
    ...
    Attributes:
        ...
        seniority (None | ReverseEmailLookupResponse200OutputDataItemCurrentJobType0SeniorityType1 |
            ReverseEmailLookupResponse200OutputDataItemCurrentJobType0SeniorityType2Type1 |
            ReverseEmailLookupResponse200OutputDataItemCurrentJobType0SeniorityType3Type1 | Unset):
        job_function (list[ReverseEmailLookupResponse200OutputDataItemCurrentJobType0JobFunctionType0Item] | None |
            Unset):
        employment_type (list[ReverseEmailLookupResponse200OutputDataItemCurrentJobType0EmploymentTypeType0Item] | None
            | Unset):
        academic_qualification
            (list[ReverseEmailLookupResponse200OutputDataItemCurrentJobType0AcademicQualificationType0Item] | None | Unset):
    ...
    job_function: (
        list[ReverseEmailLookupResponse200OutputDataItemCurrentJobType0JobFunctionType0Item] | None | Unset
    ) = UNSET
    employment_type: (
        list[ReverseEmailLookupResponse200OutputDataItemCurrentJobType0EmploymentTypeType0Item] | None | Unset
    ) = UNSET
    academic_qualification: (
        list[ReverseEmailLookupResponse200OutputDataItemCurrentJobType0AcademicQualificationType0Item] | None | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_seniority(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                seniority_type_2_type_1 = ReverseEmailLookupResponse200OutputDataItemCurrentJobType0SeniorityType2Type1(
                    data
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                seniority_type_3_type_1 = ReverseEmailLookupResponse200OutputDataItemCurrentJobType0SeniorityType3Type1(
                    data
                )
