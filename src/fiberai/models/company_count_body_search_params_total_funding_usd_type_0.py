...
T = TypeVar("T", bound="CompanyCountBodySearchParamsTotalFundingUSDType0")



@_attrs_define
class CompanyCountBodySearchParamsTotalFundingUSDType0:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        company_count_body_search_params_total_funding_usd_type_0 = cls(
            lower_bound=lower_bound,
            upper_bound=upper_bound,
        )


        company_count_body_search_params_total_funding_usd_type_0.additional_properties = d
        return company_count_body_search_params_total_funding_usd_type_0
