...
if TYPE_CHECKING:
  from ..models.reverse_email_lookup_response_200_output_data_item_detailed_education_type_0_item_school_details_type_0 import ReverseEmailLookupResponse200OutputDataItemDetailedEducationType0ItemSchoolDetailsType0





T = TypeVar("T", bound="ReverseEmailLookupResponse200OutputDataItemDetailedEducationType0Item")



@_attrs_define
class ReverseEmailLookupResponse200OutputDataItemDetailedEducationType0Item:
    """ 
        Attributes:
            school_details (Union['ReverseEmailLookupResponse200OutputDataItemDetailedEducationType0ItemSchoolDetailsType0',
                None, Unset]):
    ...
    school_details: Union['ReverseEmailLookupResponse200OutputDataItemDetailedEducationType0ItemSchoolDetailsType0', None, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.school_details, ReverseEmailLookupResponse200OutputDataItemDetailedEducationType0ItemSchoolDetailsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.reverse_email_lookup_response_200_output_data_item_detailed_education_type_0_item_school_details_type_0 import ReverseEmailLookupResponse200OutputDataItemDetailedEducationType0ItemSchoolDetailsType0
        d = dict(src_dict)
        def _parse_school_details(data: object) -> Union['ReverseEmailLookupResponse200OutputDataItemDetailedEducationType0ItemSchoolDetailsType0', None, Unset]:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                school_details_type_0 = ReverseEmailLookupResponse200OutputDataItemDetailedEducationType0ItemSchoolDetailsType0.from_dict(data)
                ...
                pass
            return cast(Union['ReverseEmailLookupResponse200OutputDataItemDetailedEducationType0ItemSchoolDetailsType0', None, Unset], data)
        ...
        reverse_email_lookup_response_200_output_data_item_detailed_education_type_0_item = cls(
        ...
        reverse_email_lookup_response_200_output_data_item_detailed_education_type_0_item.additional_properties = d
        return reverse_email_lookup_response_200_output_data_item_detailed_education_type_0_item
