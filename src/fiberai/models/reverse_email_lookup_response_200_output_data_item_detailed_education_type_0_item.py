...
if TYPE_CHECKING:
    from ..models.reverse_email_lookup_response_200_output_data_item_detailed_education_type_0_item_school_details_type_0 import (
        ReverseEmailLookupResponse200OutputDataItemDetailedEducationType0ItemSchoolDetailsType0,
    )
...
class ReverseEmailLookupResponse200OutputDataItemDetailedEducationType0Item:
    """
    Attributes:
        school_details (None | ReverseEmailLookupResponse200OutputDataItemDetailedEducationType0ItemSchoolDetailsType0 |
            Unset):
    ...
    school_details: (
        None | ReverseEmailLookupResponse200OutputDataItemDetailedEducationType0ItemSchoolDetailsType0 | Unset
    ) = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.reverse_email_lookup_response_200_output_data_item_detailed_education_type_0_item_school_details_type_0 import (
            ReverseEmailLookupResponse200OutputDataItemDetailedEducationType0ItemSchoolDetailsType0,  # noqa: PLC0415
        )
        ...
        if isinstance(self.school_details, Unset):
            ...
            self.school_details, ReverseEmailLookupResponse200OutputDataItemDetailedEducationType0ItemSchoolDetailsType0
        ):
        ...
        def _parse_school_details(
            ...
            try:
                ...
                school_details_type_0 = (
                    ReverseEmailLookupResponse200OutputDataItemDetailedEducationType0ItemSchoolDetailsType0.from_dict(
                        data
                    )
                )
