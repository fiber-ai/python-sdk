...
if TYPE_CHECKING:
    from ..models.tiktok_song_videos_response_200_output_videos_item import TiktokSongVideosResponse200OutputVideosItem


T = TypeVar("T", bound="TiktokSongVideosResponse200Output")


@_attrs_define
class TiktokSongVideosResponse200Output:
    """
    Attributes:
        videos (list[TiktokSongVideosResponse200OutputVideosItem]): List of videos using this song, for this page.
    ...
    videos: list[TiktokSongVideosResponse200OutputVideosItem]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for videos_item_data in _videos:
            videos_item = TiktokSongVideosResponse200OutputVideosItem.from_dict(videos_item_data)
        ...
        tiktok_song_videos_response_200_output = cls(
            videos=videos,
            next_page_token=next_page_token,
        )

        tiktok_song_videos_response_200_output.additional_properties = d
        return tiktok_song_videos_response_200_output
