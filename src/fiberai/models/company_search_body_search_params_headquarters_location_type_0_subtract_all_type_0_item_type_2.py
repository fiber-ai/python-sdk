...
from ..models.company_search_body_search_params_headquarters_location_type_0_subtract_all_type_0_item_type_2_region import (
    CompanySearchBodySearchParamsHeadquartersLocationType0SubtractAllType0ItemType2Region,
)
...
class CompanySearchBodySearchParamsHeadquartersLocationType0SubtractAllType0ItemType2:
    ...
    Attributes:
        ...
        region (CompanySearchBodySearchParamsHeadquartersLocationType0SubtractAllType0ItemType2Region):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        region = CompanySearchBodySearchParamsHeadquartersLocationType0SubtractAllType0ItemType2Region(d.pop("region"))
