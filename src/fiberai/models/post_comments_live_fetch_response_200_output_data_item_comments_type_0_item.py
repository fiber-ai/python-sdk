...
class PostCommentsLiveFetchResponse200OutputDataItemCommentsType0Item:
    ...
    Attributes:
        ...
        commenter (None | PostCommentsLiveFetchResponse200OutputDataItemCommentsType0ItemCommenterType0 | Unset):
        num_reactions (float | None | Unset):
        num_comments (float | None | Unset):
        reactions_by_type (list[PostCommentsLiveFetchResponse200OutputDataItemCommentsType0ItemReactionsByTypeType0Item]
            | None | Unset):
        created_at (None | str | Unset):
        tagged_users (list[PostCommentsLiveFetchResponse200OutputDataItemCommentsType0ItemTaggedUsersType0Item] | None |
            Unset):
    """

    commentary: None | str | Unset = UNSET
    commenter: None | PostCommentsLiveFetchResponse200OutputDataItemCommentsType0ItemCommenterType0 | Unset = UNSET
    num_reactions: float | None | Unset = UNSET
    num_comments: float | None | Unset = UNSET
    reactions_by_type: (
        list[PostCommentsLiveFetchResponse200OutputDataItemCommentsType0ItemReactionsByTypeType0Item] | None | Unset
    ) = UNSET
    created_at: None | str | Unset = UNSET
    tagged_users: (
        list[PostCommentsLiveFetchResponse200OutputDataItemCommentsType0ItemTaggedUsersType0Item] | None | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_commenter(
            data: object,
        ) -> None | PostCommentsLiveFetchResponse200OutputDataItemCommentsType0ItemCommenterType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                commenter_type_0 = (
                    PostCommentsLiveFetchResponse200OutputDataItemCommentsType0ItemCommenterType0.from_dict(data)
                )
                ...
                pass
            return cast(
                None | PostCommentsLiveFetchResponse200OutputDataItemCommentsType0ItemCommenterType0 | Unset, data
            )
        ...
        def _parse_reactions_by_type(
            ...
            try:
                ...
                for reactions_by_type_type_0_item_data in _reactions_by_type_type_0:
                    reactions_by_type_type_0_item = PostCommentsLiveFetchResponse200OutputDataItemCommentsType0ItemReactionsByTypeType0Item.from_dict(
            ...
            try:
                ...
                for tagged_users_type_0_item_data in _tagged_users_type_0:
                    tagged_users_type_0_item = (
                        PostCommentsLiveFetchResponse200OutputDataItemCommentsType0ItemTaggedUsersType0Item.from_dict(
                ...
                pass
            return cast(
                list[PostCommentsLiveFetchResponse200OutputDataItemCommentsType0ItemTaggedUsersType0Item]
                | None
                | Unset,
                data,
            )
