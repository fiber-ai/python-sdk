...
T = TypeVar("T", bound="PaginatedCombinedSearchBodyCompanyConfigType0SearchParamsHeadquartersStateNameType0")


@_attrs_define
class PaginatedCombinedSearchBodyCompanyConfigType0SearchParamsHeadquartersStateNameType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        paginated_combined_search_body_company_config_type_0_search_params_headquarters_state_name_type_0 = cls(
            any_of=any_of,
            none_of=none_of,
        )

        paginated_combined_search_body_company_config_type_0_search_params_headquarters_state_name_type_0.additional_properties = d
        return paginated_combined_search_body_company_config_type_0_search_params_headquarters_state_name_type_0
