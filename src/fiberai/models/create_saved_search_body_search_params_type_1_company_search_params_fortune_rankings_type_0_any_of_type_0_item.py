...
from ..models.create_saved_search_body_search_params_type_1_company_search_params_fortune_rankings_type_0_any_of_type_0_item_list import (
    CreateSavedSearchBodySearchParamsType1CompanySearchParamsFortuneRankingsType0AnyOfType0ItemList,
)

if TYPE_CHECKING:
    from ..models.create_saved_search_body_search_params_type_1_company_search_params_fortune_rankings_type_0_any_of_type_0_item_range import (
        CreateSavedSearchBodySearchParamsType1CompanySearchParamsFortuneRankingsType0AnyOfType0ItemRange,
    )
...
class CreateSavedSearchBodySearchParamsType1CompanySearchParamsFortuneRankingsType0AnyOfType0Item:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.create_saved_search_body_search_params_type_1_company_search_params_fortune_rankings_type_0_any_of_type_0_item_range import (
            CreateSavedSearchBodySearchParamsType1CompanySearchParamsFortuneRankingsType0AnyOfType0ItemRange,  # noqa: PLC0415
        )
        ...
        range_ = (
            CreateSavedSearchBodySearchParamsType1CompanySearchParamsFortuneRankingsType0AnyOfType0ItemRange.from_dict(
                d.pop("range")
            )
        )
