...
T = TypeVar("T", bound="CreateTrackerCompanyListBodyCompanySearchParamsType0HeadquartersLocationType0")


@_attrs_define
class CreateTrackerCompanyListBodyCompanySearchParamsType0HeadquartersLocationType0:
    """
    Attributes:
        union_all
            (list[CreateTrackerCompanyListBodyCompanySearchParamsType0HeadquartersLocationType0UnionAllType0ItemType0 |
            CreateTrackerCompanyListBodyCompanySearchParamsType0HeadquartersLocationType0UnionAllType0ItemType1 |
            CreateTrackerCompanyListBodyCompanySearchParamsType0HeadquartersLocationType0UnionAllType0ItemType2 |
            CreateTrackerCompanyListBodyCompanySearchParamsType0HeadquartersLocationType0UnionAllType0ItemType3] | None |
            Unset):
        subtract_all
            (list[CreateTrackerCompanyListBodyCompanySearchParamsType0HeadquartersLocationType0SubtractAllType0ItemType0 |
            CreateTrackerCompanyListBodyCompanySearchParamsType0HeadquartersLocationType0SubtractAllType0ItemType1 |
            CreateTrackerCompanyListBodyCompanySearchParamsType0HeadquartersLocationType0SubtractAllType0ItemType2 |
            CreateTrackerCompanyListBodyCompanySearchParamsType0HeadquartersLocationType0SubtractAllType0ItemType3] | None |
            Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
                    ...
                    def _parse_union_all_type_0_item(
                        ...
                        try:
                            if not isinstance(data, dict):
                                raise TypeError()
                            union_all_type_0_item_type_0 = CreateTrackerCompanyListBodyCompanySearchParamsType0HeadquartersLocationType0UnionAllType0ItemType0.from_dict(
                                data
                            )
                        ...
                        try:
                            if not isinstance(data, dict):
                                raise TypeError()
                            union_all_type_0_item_type_1 = CreateTrackerCompanyListBodyCompanySearchParamsType0HeadquartersLocationType0UnionAllType0ItemType1.from_dict(
                                data
                            )
                        ...
                        try:
                            if not isinstance(data, dict):
                                raise TypeError()
                            union_all_type_0_item_type_2 = CreateTrackerCompanyListBodyCompanySearchParamsType0HeadquartersLocationType0UnionAllType0ItemType2.from_dict(
                                data
                            )
                        ...
                        if not isinstance(data, dict):
                            raise TypeError()
                        union_all_type_0_item_type_3 = CreateTrackerCompanyListBodyCompanySearchParamsType0HeadquartersLocationType0UnionAllType0ItemType3.from_dict(
                            data
                        )
                ...
                for subtract_all_type_0_item_data in _subtract_all_type_0:
                    ...
                    def _parse_subtract_all_type_0_item(
                        ...
                        try:
                            if not isinstance(data, dict):
                                raise TypeError()
                            subtract_all_type_0_item_type_0 = CreateTrackerCompanyListBodyCompanySearchParamsType0HeadquartersLocationType0SubtractAllType0ItemType0.from_dict(
                                data
                            )
                        ...
                        try:
                            if not isinstance(data, dict):
                                raise TypeError()
                            subtract_all_type_0_item_type_1 = CreateTrackerCompanyListBodyCompanySearchParamsType0HeadquartersLocationType0SubtractAllType0ItemType1.from_dict(
                                data
                            )
                        ...
                        try:
                            if not isinstance(data, dict):
                                raise TypeError()
                            subtract_all_type_0_item_type_2 = CreateTrackerCompanyListBodyCompanySearchParamsType0HeadquartersLocationType0SubtractAllType0ItemType2.from_dict(
                                data
                            )
                        ...
                        if not isinstance(data, dict):
                            raise TypeError()
                        subtract_all_type_0_item_type_3 = CreateTrackerCompanyListBodyCompanySearchParamsType0HeadquartersLocationType0SubtractAllType0ItemType3.from_dict(
                            data
                        )
        ...
        create_tracker_company_list_body_company_search_params_type_0_headquarters_location_type_0 = cls(
            union_all=union_all,
            subtract_all=subtract_all,
        )

        create_tracker_company_list_body_company_search_params_type_0_headquarters_location_type_0.additional_properties = d
        return create_tracker_company_list_body_company_search_params_type_0_headquarters_location_type_0
