...
from ..models.text_to_profile_search_response_200_output_data_item_detailed_work_experiences_type_0_item_academic_qualification_type_0_item import (
    TextToProfileSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemAcademicQualificationType0Item,
)
from ..models.text_to_profile_search_response_200_output_data_item_detailed_work_experiences_type_0_item_employment_type_type_0_item import (
    TextToProfileSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemEmploymentTypeType0Item,
)
from ..models.text_to_profile_search_response_200_output_data_item_detailed_work_experiences_type_0_item_job_function_type_0_item import (
    TextToProfileSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemJobFunctionType0Item,
)
from ..models.text_to_profile_search_response_200_output_data_item_detailed_work_experiences_type_0_item_seniority_type_1 import (
    TextToProfileSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemSeniorityType1,
)
from ..models.text_to_profile_search_response_200_output_data_item_detailed_work_experiences_type_0_item_seniority_type_2_type_1 import (
    TextToProfileSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemSeniorityType2Type1,
)
from ..models.text_to_profile_search_response_200_output_data_item_detailed_work_experiences_type_0_item_seniority_type_3_type_1 import (
    TextToProfileSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemSeniorityType3Type1,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.text_to_profile_search_response_200_output_data_item_detailed_work_experiences_type_0_item_company_details_type_0 import (
        TextToProfileSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemCompanyDetailsType0,
    )
...
class TextToProfileSearchResponse200OutputDataItemDetailedWorkExperiencesType0Item:
    ...
    Attributes:
        company_details (None |
            TextToProfileSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemCompanyDetailsType0 | Unset):
        ...
        seniority (None | TextToProfileSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemSeniorityType1 |
            TextToProfileSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemSeniorityType2Type1 |
            TextToProfileSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemSeniorityType3Type1 | Unset):
        job_function
            (list[TextToProfileSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemJobFunctionType0Item] | None |
            Unset):
        employment_type
            (list[TextToProfileSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemEmploymentTypeType0Item] |
            None | Unset):
        academic_qualification (list[TextToProfileSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemAcademi
            cQualificationType0Item] | None | Unset):
        company_start_date (None | str | Unset):
        company_end_date (None | str | Unset):
    """

    company_details: (
        None | TextToProfileSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemCompanyDetailsType0 | Unset
    ) = UNSET
    ...
    academic_qualification: (
        list[TextToProfileSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemAcademicQualificationType0Item]
        | None
        | Unset
    ) = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.seniority, Unset):
            ...
            self.seniority, TextToProfileSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemSeniorityType1
        ):
        ...
        def _parse_company_details(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                company_details_type_0 = TextToProfileSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemCompanyDetailsType0.from_dict(
                    data
                )
        ...
        def _parse_seniority(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                seniority_type_1 = (
                    TextToProfileSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemSeniorityType1(data)
                )
        ...
        def _parse_job_function(
            ...
            try:
                ...
                for job_function_type_0_item_data in _job_function_type_0:
                    job_function_type_0_item = TextToProfileSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemJobFunctionType0Item(
        ...
        def _parse_employment_type(
            ...
            try:
                ...
                for employment_type_type_0_item_data in _employment_type_type_0:
                    employment_type_type_0_item = TextToProfileSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemEmploymentTypeType0Item(
        ...
        def _parse_academic_qualification(
            ...
            try:
                ...
                for academic_qualification_type_0_item_data in _academic_qualification_type_0:
                    academic_qualification_type_0_item = TextToProfileSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemAcademicQualificationType0Item(
