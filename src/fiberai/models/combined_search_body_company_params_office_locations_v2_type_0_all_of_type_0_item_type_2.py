...
from ..models.combined_search_body_company_params_office_locations_v2_type_0_all_of_type_0_item_type_2_type import (
    CombinedSearchBodyCompanyParamsOfficeLocationsV2Type0AllOfType0ItemType2Type,
)

if TYPE_CHECKING:
    from ..models.combined_search_body_company_params_office_locations_v2_type_0_all_of_type_0_item_type_2_location_type_0 import (
        CombinedSearchBodyCompanyParamsOfficeLocationsV2Type0AllOfType0ItemType2LocationType0,
    )
...
class CombinedSearchBodyCompanyParamsOfficeLocationsV2Type0AllOfType0ItemType2:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(
            self.location, CombinedSearchBodyCompanyParamsOfficeLocationsV2Type0AllOfType0ItemType2LocationType0
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_location(
            ...
            if not isinstance(data, dict):
                raise TypeError()
            location_type_0 = (
                CombinedSearchBodyCompanyParamsOfficeLocationsV2Type0AllOfType0ItemType2LocationType0.from_dict(data)
            )
