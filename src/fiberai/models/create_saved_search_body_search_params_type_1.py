...
if TYPE_CHECKING:
  from ..models.create_saved_search_body_search_params_type_1_company_search_params import CreateSavedSearchBodySearchParamsType1CompanySearchParams
...
class CreateSavedSearchBodySearchParamsType1:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        company_search_params = CreateSavedSearchBodySearchParamsType1CompanySearchParams.from_dict(d.pop("companySearchParams"))
