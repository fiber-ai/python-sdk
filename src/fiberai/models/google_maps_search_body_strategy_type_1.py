...
if TYPE_CHECKING:
  from ..models.google_maps_search_body_strategy_type_1_union_all_item_type_1 import GoogleMapsSearchBodyStrategyType1UnionAllItemType1
  from ..models.google_maps_search_body_strategy_type_1_union_all_item_type_0 import GoogleMapsSearchBodyStrategyType1UnionAllItemType0
...
class GoogleMapsSearchBodyStrategyType1:
    """ 
        Attributes:
            strategy (GoogleMapsSearchBodyStrategyType1Strategy): Use 'specific-areas' to search for places in specific
                areas
            union_all (list[Union['GoogleMapsSearchBodyStrategyType1UnionAllItemType0',
    ...
    union_all: list[Union['GoogleMapsSearchBodyStrategyType1UnionAllItemType0', 'GoogleMapsSearchBodyStrategyType1UnionAllItemType1']]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for union_all_item_data in (_union_all):
            def _parse_union_all_item(data: object) -> Union['GoogleMapsSearchBodyStrategyType1UnionAllItemType0', 'GoogleMapsSearchBodyStrategyType1UnionAllItemType1']:
                try:
