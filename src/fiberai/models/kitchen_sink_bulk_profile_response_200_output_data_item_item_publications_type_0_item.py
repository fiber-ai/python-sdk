...
class KitchenSinkBulkProfileResponse200OutputDataItemItemPublicationsType0Item:
    ...
    Attributes:
        collaborators
            (list[KitchenSinkBulkProfileResponse200OutputDataItemItemPublicationsType0ItemCollaboratorsType0Item] | None |
            Unset):
        date (None | str | Unset):
        id (None | str | Unset):
        ...
        def _parse_collaborators(
            ...
            try:
                ...
                for collaborators_type_0_item_data in _collaborators_type_0:
                    collaborators_type_0_item = KitchenSinkBulkProfileResponse200OutputDataItemItemPublicationsType0ItemCollaboratorsType0Item.from_dict(
