...
T = TypeVar("T", bound="ProfilePostsLiveFetchResponse200OutputDataItemAuthorType0")



@_attrs_define
class ProfilePostsLiveFetchResponse200OutputDataItemAuthorType0:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        profile_posts_live_fetch_response_200_output_data_item_author_type_0 = cls(
        ...
        profile_posts_live_fetch_response_200_output_data_item_author_type_0.additional_properties = d
        return profile_posts_live_fetch_response_200_output_data_item_author_type_0
