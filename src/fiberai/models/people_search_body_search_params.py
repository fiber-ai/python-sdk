...
if TYPE_CHECKING:
    ...
    from ..models.people_search_body_search_params_keywords_v2_type_0 import PeopleSearchBodySearchParamsKeywordsV2Type0
...
class PeopleSearchBodySearchParams:
    ...
    Attributes:
        ...
        stealth_v2 (None | PeopleSearchBodySearchParamsStealthV2Type0 | PeopleSearchBodySearchParamsStealthV2Type1 |
            Unset):
        education_v2 (None | PeopleSearchBodySearchParamsEducationV2Type0 | Unset):
        ...
        unemployment (None | PeopleSearchBodySearchParamsUnemploymentType0 | Unset):
        ...
        jobs (None | PeopleSearchBodySearchParamsJobsType0 | Unset): Filter by work experience: named companies
        ...
        past_jobs (None | PeopleSearchBodySearchParamsPastJobsType0 | Unset): Deprecated. Use jobs with status: 'past'
            instead.
        current_jobs (None | PeopleSearchBodySearchParamsCurrentJobsType0 | Unset): Deprecated. Use jobs with status:
            'current' instead.
        sort (list[PeopleSearchBodySearchParamsSortType0Item] | None | Unset): Sort order for people results. Clauses
    ...
    education_v2: None | PeopleSearchBodySearchParamsEducationV2Type0 | Unset = UNSET
    job_status: (
        None
    ...
    unemployment: None | PeopleSearchBodySearchParamsUnemploymentType0 | Unset = UNSET
    ...
    jobs: None | PeopleSearchBodySearchParamsJobsType0 | Unset = UNSET
    ...
    sort: list[PeopleSearchBodySearchParamsSortType0Item] | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.keywords_v2, Unset):
            keywords_v2 = UNSET
        elif isinstance(self.keywords_v2, PeopleSearchBodySearchParamsKeywordsV2Type0):
        ...
        elif isinstance(self.exact_profile_v2, PeopleSearchBodySearchParamsExactProfileV2Type0):
        ...
        if isinstance(self.education_v2, Unset):
            education_v2 = UNSET
        elif isinstance(self.education_v2, PeopleSearchBodySearchParamsEducationV2Type0):
        ...
        elif isinstance(self.certifications, PeopleSearchBodySearchParamsCertificationsType0):
        ...
        if isinstance(self.publications, Unset):
            publications = UNSET
        elif isinstance(self.publications, PeopleSearchBodySearchParamsPublicationsType0):
        ...
        if isinstance(self.unemployment, Unset):
            unemployment = UNSET
        elif isinstance(self.unemployment, PeopleSearchBodySearchParamsUnemploymentType0):
        ...
        if isinstance(self.jobs, Unset):
            jobs = UNSET
        elif isinstance(self.jobs, PeopleSearchBodySearchParamsJobsType0):
        ...
        if isinstance(self.current_jobs, Unset):
            current_jobs = UNSET
        elif isinstance(self.current_jobs, PeopleSearchBodySearchParamsCurrentJobsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_keywords_v2(data: object) -> None | PeopleSearchBodySearchParamsKeywordsV2Type0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                keywords_v2_type_0 = PeopleSearchBodySearchParamsKeywordsV2Type0.from_dict(data)

                return keywords_v2_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PeopleSearchBodySearchParamsKeywordsV2Type0 | Unset, data)
        ...
        def _parse_exact_profile_v2(data: object) -> None | PeopleSearchBodySearchParamsExactProfileV2Type0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                exact_profile_v2_type_0 = PeopleSearchBodySearchParamsExactProfileV2Type0.from_dict(data)

                return exact_profile_v2_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PeopleSearchBodySearchParamsExactProfileV2Type0 | Unset, data)
        ...
        def _parse_education_v2(data: object) -> None | PeopleSearchBodySearchParamsEducationV2Type0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                education_v2_type_0 = PeopleSearchBodySearchParamsEducationV2Type0.from_dict(data)

                return education_v2_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PeopleSearchBodySearchParamsEducationV2Type0 | Unset, data)
        ...
        def _parse_certifications(data: object) -> None | PeopleSearchBodySearchParamsCertificationsType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                certifications_type_0 = PeopleSearchBodySearchParamsCertificationsType0.from_dict(data)

                return certifications_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PeopleSearchBodySearchParamsCertificationsType0 | Unset, data)

        certifications = _parse_certifications(d.pop("certifications", UNSET))

        def _parse_publications(data: object) -> None | PeopleSearchBodySearchParamsPublicationsType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                publications_type_0 = PeopleSearchBodySearchParamsPublicationsType0.from_dict(data)

                return publications_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PeopleSearchBodySearchParamsPublicationsType0 | Unset, data)
        ...
        def _parse_unemployment(data: object) -> None | PeopleSearchBodySearchParamsUnemploymentType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                unemployment_type_0 = PeopleSearchBodySearchParamsUnemploymentType0.from_dict(data)

                return unemployment_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PeopleSearchBodySearchParamsUnemploymentType0 | Unset, data)
        ...
        def _parse_jobs(data: object) -> None | PeopleSearchBodySearchParamsJobsType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                jobs_type_0 = PeopleSearchBodySearchParamsJobsType0.from_dict(data)

                return jobs_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PeopleSearchBodySearchParamsJobsType0 | Unset, data)
        ...
        def _parse_current_jobs(data: object) -> None | PeopleSearchBodySearchParamsCurrentJobsType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                current_jobs_type_0 = PeopleSearchBodySearchParamsCurrentJobsType0.from_dict(data)
        ...
        def _parse_sort(data: object) -> list[PeopleSearchBodySearchParamsSortType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for sort_type_0_item_data in _sort_type_0:
                    sort_type_0_item = PeopleSearchBodySearchParamsSortType0Item.from_dict(sort_type_0_item_data)
                ...
                pass
            return cast(list[PeopleSearchBodySearchParamsSortType0Item] | None | Unset, data)
