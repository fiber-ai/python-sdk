...
T = TypeVar("T", bound="InvestmentSearchBodySearchParamsType0RaisedAmountUSDType0")



@_attrs_define
class InvestmentSearchBodySearchParamsType0RaisedAmountUSDType0:
    """ Filter by amount raised in USD (range). For example, min: 5000000 to find rounds with at least $5M raised
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        investment_search_body_search_params_type_0_raised_amount_usd_type_0 = cls(
            lower_bound=lower_bound,
            upper_bound=upper_bound,
        )


        investment_search_body_search_params_type_0_raised_amount_usd_type_0.additional_properties = d
        return investment_search_body_search_params_type_0_raised_amount_usd_type_0
