...
T = TypeVar("T", bound="PaginatedCombinedSearchResponse200OutputProfilesItemVerificationsType0")


@_attrs_define
class PaginatedCombinedSearchResponse200OutputProfilesItemVerificationsType0:
    """
    Attributes:
        is_verified (bool | None | Unset):
        joined_date (None | str | Unset):
        verification_types
            (list[PaginatedCombinedSearchResponse200OutputProfilesItemVerificationsType0VerificationTypesType0Item] | None |
            Unset):
    """
    ...
    verification_types: (
        list[PaginatedCombinedSearchResponse200OutputProfilesItemVerificationsType0VerificationTypesType0Item]
        | None
        | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_verification_types(
            ...
            try:
                ...
                for verification_types_type_0_item_data in _verification_types_type_0:
                    verification_types_type_0_item = PaginatedCombinedSearchResponse200OutputProfilesItemVerificationsType0VerificationTypesType0Item.from_dict(
        ...
        paginated_combined_search_response_200_output_profiles_item_verifications_type_0 = cls(
            is_verified=is_verified,
            joined_date=joined_date,
            verification_types=verification_types,
        )

        paginated_combined_search_response_200_output_profiles_item_verifications_type_0.additional_properties = d
        return paginated_combined_search_response_200_output_profiles_item_verifications_type_0
