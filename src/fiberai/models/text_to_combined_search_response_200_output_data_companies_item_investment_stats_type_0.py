...
if TYPE_CHECKING:
    from ..models.text_to_combined_search_response_200_output_data_companies_item_investment_stats_type_0_investments_by_stage_type_0_item import (
        TextToCombinedSearchResponse200OutputDataCompaniesItemInvestmentStatsType0InvestmentsByStageType0Item,
    )
        ...
        def _parse_investments_by_stage(
            ...
            try:
                ...
                for investments_by_stage_type_0_item_data in _investments_by_stage_type_0:
                    investments_by_stage_type_0_item = TextToCombinedSearchResponse200OutputDataCompaniesItemInvestmentStatsType0InvestmentsByStageType0Item.from_dict(
