...
T = TypeVar("T", bound="PaginatedCombinedSearchBodyCompanyConfigType0SearchParamsAcceleratorsV2Type0")


@_attrs_define
class PaginatedCombinedSearchBodyCompanyConfigType0SearchParamsAcceleratorsV2Type0:
    """
    Attributes:
        any_of (list[PaginatedCombinedSearchBodyCompanyConfigType0SearchParamsAcceleratorsV2Type0AnyOfType0Item] | None
            | Unset):
        none_of (list[PaginatedCombinedSearchBodyCompanyConfigType0SearchParamsAcceleratorsV2Type0NoneOfType0Item] |
            None | Unset):
    """

    any_of: (
        list[PaginatedCombinedSearchBodyCompanyConfigType0SearchParamsAcceleratorsV2Type0AnyOfType0Item] | None | Unset
    ) = UNSET
    none_of: (
        list[PaginatedCombinedSearchBodyCompanyConfigType0SearchParamsAcceleratorsV2Type0NoneOfType0Item] | None | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_any_of(
            ...
            list[PaginatedCombinedSearchBodyCompanyConfigType0SearchParamsAcceleratorsV2Type0AnyOfType0Item]
            | None
            | Unset
        ):
            if data is None:
            ...
            try:
                ...
                for any_of_type_0_item_data in _any_of_type_0:
                    any_of_type_0_item = PaginatedCombinedSearchBodyCompanyConfigType0SearchParamsAcceleratorsV2Type0AnyOfType0Item.from_dict(
        ...
        def _parse_none_of(
            ...
            list[PaginatedCombinedSearchBodyCompanyConfigType0SearchParamsAcceleratorsV2Type0NoneOfType0Item]
            | None
            | Unset
        ):
            if data is None:
            ...
            try:
                ...
                for none_of_type_0_item_data in _none_of_type_0:
                    none_of_type_0_item = PaginatedCombinedSearchBodyCompanyConfigType0SearchParamsAcceleratorsV2Type0NoneOfType0Item.from_dict(
        ...
        paginated_combined_search_body_company_config_type_0_search_params_accelerators_v2_type_0 = cls(
            any_of=any_of,
            none_of=none_of,
        )

        paginated_combined_search_body_company_config_type_0_search_params_accelerators_v2_type_0.additional_properties = d
        return paginated_combined_search_body_company_config_type_0_search_params_accelerators_v2_type_0
