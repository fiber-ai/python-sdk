...
T = TypeVar("T", bound="PaginatedCombinedSearchResponse200OutputCompaniesItemRoleCountMatchesType0Item")


@_attrs_define
class PaginatedCombinedSearchResponse200OutputCompaniesItemRoleCountMatchesType0Item:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_num_matching_employees(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                num_matching_employees_type_0 = PaginatedCombinedSearchResponse200OutputCompaniesItemRoleCountMatchesType0ItemNumMatchingEmployeesType0.from_dict(
                    data
                )
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                num_matching_employees_type_1 = PaginatedCombinedSearchResponse200OutputCompaniesItemRoleCountMatchesType0ItemNumMatchingEmployeesType1.from_dict(
                    data
                )
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                num_matching_employees_type_2 = PaginatedCombinedSearchResponse200OutputCompaniesItemRoleCountMatchesType0ItemNumMatchingEmployeesType2.from_dict(
                    data
                )
            ...
            if not isinstance(data, dict):
                raise TypeError()
            num_matching_employees_type_3 = PaginatedCombinedSearchResponse200OutputCompaniesItemRoleCountMatchesType0ItemNumMatchingEmployeesType3.from_dict(
                data
            )
        ...
        paginated_combined_search_response_200_output_companies_item_role_count_matches_type_0_item = cls(
            num_matching_employees=num_matching_employees,
        )

        paginated_combined_search_response_200_output_companies_item_role_count_matches_type_0_item.additional_properties = d
        return paginated_combined_search_response_200_output_companies_item_role_count_matches_type_0_item
