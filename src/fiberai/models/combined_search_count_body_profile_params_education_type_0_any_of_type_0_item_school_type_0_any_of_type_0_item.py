...
T = TypeVar("T", bound="CombinedSearchCountBodyProfileParamsEducationType0AnyOfType0ItemSchoolType0AnyOfType0Item")


@_attrs_define
class CombinedSearchCountBodyProfileParamsEducationType0AnyOfType0ItemSchoolType0AnyOfType0Item:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        combined_search_count_body_profile_params_education_type_0_any_of_type_0_item_school_type_0_any_of_type_0_item = cls(
            linkedin_id=linkedin_id,
            linkedin_url=linkedin_url,
            domain=domain,
        )

        combined_search_count_body_profile_params_education_type_0_any_of_type_0_item_school_type_0_any_of_type_0_item.additional_properties = d
        return combined_search_count_body_profile_params_education_type_0_any_of_type_0_item_school_type_0_any_of_type_0_item
