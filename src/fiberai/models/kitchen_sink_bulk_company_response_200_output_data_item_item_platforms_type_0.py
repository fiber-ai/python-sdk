...
T = TypeVar("T", bound="KitchenSinkBulkCompanyResponse200OutputDataItemItemPlatformsType0")


@_attrs_define
class KitchenSinkBulkCompanyResponse200OutputDataItemItemPlatformsType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        kitchen_sink_bulk_company_response_200_output_data_item_item_platforms_type_0 = cls(
            ecommerce=ecommerce,
            cms=cms,
            crm=crm,
            marketing=marketing,
        ...
        kitchen_sink_bulk_company_response_200_output_data_item_item_platforms_type_0.additional_properties = d
        return kitchen_sink_bulk_company_response_200_output_data_item_item_platforms_type_0
