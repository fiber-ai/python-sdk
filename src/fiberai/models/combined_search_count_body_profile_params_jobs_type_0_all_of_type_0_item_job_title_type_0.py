...
T = TypeVar("T", bound="CombinedSearchCountBodyProfileParamsJobsType0AllOfType0ItemJobTitleType0")


@_attrs_define
class CombinedSearchCountBodyProfileParamsJobsType0AllOfType0ItemJobTitleType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        combined_search_count_body_profile_params_jobs_type_0_all_of_type_0_item_job_title_type_0 = cls(
            any_of=any_of,
            none_of=none_of,
        )

        combined_search_count_body_profile_params_jobs_type_0_all_of_type_0_item_job_title_type_0.additional_properties = d
        return combined_search_count_body_profile_params_jobs_type_0_all_of_type_0_item_job_title_type_0
