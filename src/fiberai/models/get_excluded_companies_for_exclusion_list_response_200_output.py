...
if TYPE_CHECKING:
  from ..models.get_excluded_companies_for_exclusion_list_response_200_output_companies_item import GetExcludedCompaniesForExclusionListResponse200OutputCompaniesItem
...
class GetExcludedCompaniesForExclusionListResponse200Output:
    """ 
        Attributes:
            companies (list['GetExcludedCompaniesForExclusionListResponse200OutputCompaniesItem']): List of excluded
                companies
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for companies_item_data in (_companies):
            companies_item = GetExcludedCompaniesForExclusionListResponse200OutputCompaniesItem.from_dict(companies_item_data)
