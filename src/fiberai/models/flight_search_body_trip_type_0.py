...
from ..models.flight_search_body_trip_type_0_flight_type import FlightSearchBodyTripType0FlightType

T = TypeVar("T", bound="FlightSearchBodyTripType0")


@_attrs_define
class FlightSearchBodyTripType0:
    """
    Attributes:
        flight_type (FlightSearchBodyTripType0FlightType):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        flight_type = FlightSearchBodyTripType0FlightType(d.pop("flightType"))
        ...
        flight_search_body_trip_type_0 = cls(
        ...
        flight_search_body_trip_type_0.additional_properties = d
        return flight_search_body_trip_type_0
