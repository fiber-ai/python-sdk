...
T = TypeVar("T", bound="UpdateWebhookEndpointResponse200ChargeInfoType3LowCreditAlertType0")


@_attrs_define
class UpdateWebhookEndpointResponse200ChargeInfoType3LowCreditAlertType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_webhook_endpoint_response_200_charge_info_type_3_low_credit_alert_type_0 = cls(
            get_more_credits_url=get_more_credits_url,
            message=message,
            available_credits=available_credits,
        )

        update_webhook_endpoint_response_200_charge_info_type_3_low_credit_alert_type_0.additional_properties = d
        return update_webhook_endpoint_response_200_charge_info_type_3_low_credit_alert_type_0
