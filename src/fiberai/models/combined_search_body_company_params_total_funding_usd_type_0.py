...
T = TypeVar("T", bound="CombinedSearchBodyCompanyParamsTotalFundingUSDType0")



@_attrs_define
class CombinedSearchBodyCompanyParamsTotalFundingUSDType0:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        combined_search_body_company_params_total_funding_usd_type_0 = cls(
            lower_bound=lower_bound,
            upper_bound=upper_bound,
        )


        combined_search_body_company_params_total_funding_usd_type_0.additional_properties = d
        return combined_search_body_company_params_total_funding_usd_type_0
