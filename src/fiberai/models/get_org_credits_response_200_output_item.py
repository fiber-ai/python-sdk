...
T = TypeVar("T", bound="GetOrgCreditsResponse200OutputItem")


@_attrs_define
class GetOrgCreditsResponse200OutputItem:
    """
    Attributes:
        organization_id (str):
        subscription_id (str):
        ...
        credits_per_operation (GetOrgCreditsResponse200OutputItemCreditsPerOperationType0 | None | Unset):
    """
    ...
    available: float
    usage_period_resets_on: str
    credits_per_operation: GetOrgCreditsResponse200OutputItemCreditsPerOperationType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.credits_per_operation, GetOrgCreditsResponse200OutputItemCreditsPerOperationType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_credits_per_operation(
            data: object,
        ) -> GetOrgCreditsResponse200OutputItemCreditsPerOperationType0 | None | Unset:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                credits_per_operation_type_0 = GetOrgCreditsResponse200OutputItemCreditsPerOperationType0.from_dict(
                    data
                )
                ...
                pass
            return cast(GetOrgCreditsResponse200OutputItemCreditsPerOperationType0 | None | Unset, data)

        credits_per_operation = _parse_credits_per_operation(d.pop("creditsPerOperation", UNSET))

        get_org_credits_response_200_output_item = cls(
        ...
        get_org_credits_response_200_output_item.additional_properties = d
        return get_org_credits_response_200_output_item
