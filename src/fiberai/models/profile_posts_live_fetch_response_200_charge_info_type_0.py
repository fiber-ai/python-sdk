...
from ..models.profile_posts_live_fetch_response_200_charge_info_type_0_method import (
    ProfilePostsLiveFetchResponse200ChargeInfoType0Method,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.profile_posts_live_fetch_response_200_charge_info_type_0_low_credit_alert_type_0 import (
        ProfilePostsLiveFetchResponse200ChargeInfoType0LowCreditAlertType0,
    )
...
class ProfilePostsLiveFetchResponse200ChargeInfoType0:
    ...
    Attributes:
        ...
        low_credit_alert (None | ProfilePostsLiveFetchResponse200ChargeInfoType0LowCreditAlertType0 | Unset): Contains a
            link to get more credits, a warning message, and the remaining credit count.
    """

    method: ProfilePostsLiveFetchResponse200ChargeInfoType0Method
    credits_charged: float
    low_credit_alert: None | ProfilePostsLiveFetchResponse200ChargeInfoType0LowCreditAlertType0 | Unset = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        from ..models.profile_posts_live_fetch_response_200_charge_info_type_0_low_credit_alert_type_0 import (
            ProfilePostsLiveFetchResponse200ChargeInfoType0LowCreditAlertType0,  # noqa: PLC0415
        )
        ...
        elif isinstance(self.low_credit_alert, ProfilePostsLiveFetchResponse200ChargeInfoType0LowCreditAlertType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_low_credit_alert(
            data: object,
        ) -> None | ProfilePostsLiveFetchResponse200ChargeInfoType0LowCreditAlertType0 | Unset:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                low_credit_alert_type_0 = ProfilePostsLiveFetchResponse200ChargeInfoType0LowCreditAlertType0.from_dict(
                    data
                )
                ...
                pass
            return cast(None | ProfilePostsLiveFetchResponse200ChargeInfoType0LowCreditAlertType0 | Unset, data)
