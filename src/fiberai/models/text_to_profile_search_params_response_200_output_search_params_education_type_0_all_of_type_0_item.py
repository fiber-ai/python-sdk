...
if TYPE_CHECKING:
    ...
    from ..models.text_to_profile_search_params_response_200_output_search_params_education_type_0_all_of_type_0_item_degree_v3_type_0 import (
        TextToProfileSearchParamsResponse200OutputSearchParamsEducationType0AllOfType0ItemDegreeV3Type0,
    )
    from ..models.text_to_profile_search_params_response_200_output_search_params_education_type_0_all_of_type_0_item_degree_v3_type_1 import (
        TextToProfileSearchParamsResponse200OutputSearchParamsEducationType0AllOfType0ItemDegreeV3Type1,
    )
    ...
    from ..models.text_to_profile_search_params_response_200_output_search_params_education_type_0_all_of_type_0_item_school_v4_type_0 import (
        TextToProfileSearchParamsResponse200OutputSearchParamsEducationType0AllOfType0ItemSchoolV4Type0,
    )
...
class TextToProfileSearchParamsResponse200OutputSearchParamsEducationType0AllOfType0Item:
    ...
    Attributes:
        ...
        school_v4 (None |
            TextToProfileSearchParamsResponse200OutputSearchParamsEducationType0AllOfType0ItemSchoolV4Type0 | Unset):
        school_name_keywords (None |
            TextToProfileSearchParamsResponse200OutputSearchParamsEducationType0AllOfType0ItemSchoolNameKeywordsType0 |
            Unset):
        degree_v3 (None |
            TextToProfileSearchParamsResponse200OutputSearchParamsEducationType0AllOfType0ItemDegreeV3Type0 |
            TextToProfileSearchParamsResponse200OutputSearchParamsEducationType0AllOfType0ItemDegreeV3Type1 | Unset):
    ...
    school_v4: (
        None | TextToProfileSearchParamsResponse200OutputSearchParamsEducationType0AllOfType0ItemSchoolV4Type0 | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_school_v4(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                school_v4_type_0 = TextToProfileSearchParamsResponse200OutputSearchParamsEducationType0AllOfType0ItemSchoolV4Type0.from_dict(
                    data
                )
        ...
        def _parse_degree_v3(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                degree_v3_type_0 = TextToProfileSearchParamsResponse200OutputSearchParamsEducationType0AllOfType0ItemDegreeV3Type0.from_dict(
                    data
                )
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                degree_v3_type_1 = TextToProfileSearchParamsResponse200OutputSearchParamsEducationType0AllOfType0ItemDegreeV3Type1.from_dict(
                    data
                )
