...
T = TypeVar("T", bound="JobTitleRewriteResponse200")


@_attrs_define
class JobTitleRewriteResponse200:
    """
    Attributes:
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.job_title_rewrite_response_200_charge_info_type_0 import (
            JobTitleRewriteResponse200ChargeInfoType0,  # noqa: PLC0415
        )
        from ..models.job_title_rewrite_response_200_charge_info_type_1 import (
            JobTitleRewriteResponse200ChargeInfoType1,  # noqa: PLC0415
        )
        from ..models.job_title_rewrite_response_200_charge_info_type_2 import (
            JobTitleRewriteResponse200ChargeInfoType2,  # noqa: PLC0415
        )
        from ..models.job_title_rewrite_response_200_charge_info_type_3 import (
            JobTitleRewriteResponse200ChargeInfoType3,  # noqa: PLC0415
        )

        output = self.output.to_dict()

        charge_info: dict[str, Any]
        if isinstance(self.charge_info, JobTitleRewriteResponse200ChargeInfoType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.job_title_rewrite_response_200_charge_info_type_4 import (
            JobTitleRewriteResponse200ChargeInfoType4,  # noqa: PLC0415
        )
        from ..models.job_title_rewrite_response_200_output import JobTitleRewriteResponse200Output  # noqa: PLC0415
        from ..models.job_title_rewrite_response_200_warnings_type_0_item import (
            JobTitleRewriteResponse200WarningsType0Item,  # noqa: PLC0415
        )

        d = dict(src_dict)
        output = JobTitleRewriteResponse200Output.from_dict(d.pop("output"))
        ...
        def _parse_charge_info(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_0 = JobTitleRewriteResponse200ChargeInfoType0.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_1 = JobTitleRewriteResponse200ChargeInfoType1.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_2 = JobTitleRewriteResponse200ChargeInfoType2.from_dict(data)
        ...
        def _parse_warnings(data: object) -> list[JobTitleRewriteResponse200WarningsType0Item] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for warnings_type_0_item_data in _warnings_type_0:
                    warnings_type_0_item = JobTitleRewriteResponse200WarningsType0Item.from_dict(
                ...
                pass
            return cast(list[JobTitleRewriteResponse200WarningsType0Item] | None | Unset, data)
        ...
        job_title_rewrite_response_200 = cls(
            output=output,
        ...
        return job_title_rewrite_response_200
