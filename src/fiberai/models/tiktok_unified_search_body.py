...
T = TypeVar("T", bound="TiktokUnifiedSearchBody")


@_attrs_define
class TiktokUnifiedSearchBody:
    """
    Attributes:
        api_key (str): Your Fiber API key
        query (str): Query string for a unified search returning both videos and users (e.g. 'cooking').
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        tiktok_unified_search_body = cls(
            api_key=api_key,
            query=query,
            next_page_token=next_page_token,
        )

        tiktok_unified_search_body.additional_properties = d
        return tiktok_unified_search_body
