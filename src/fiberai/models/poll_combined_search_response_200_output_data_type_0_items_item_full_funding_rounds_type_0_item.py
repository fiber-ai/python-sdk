...
if TYPE_CHECKING:
    from ..models.poll_combined_search_response_200_output_data_type_0_items_item_full_funding_rounds_type_0_item_investors_type_0_item import (
        PollCombinedSearchResponse200OutputDataType0ItemsItemFullFundingRoundsType0ItemInvestorsType0Item,
    )
...
class PollCombinedSearchResponse200OutputDataType0ItemsItemFullFundingRoundsType0Item:
    ...
    Attributes:
        investors
            (list[PollCombinedSearchResponse200OutputDataType0ItemsItemFullFundingRoundsType0ItemInvestorsType0Item] | None
            | Unset):
        ...
        def _parse_investors(
            ...
            try:
                ...
                for investors_type_0_item_data in _investors_type_0:
                    investors_type_0_item = PollCombinedSearchResponse200OutputDataType0ItemsItemFullFundingRoundsType0ItemInvestorsType0Item.from_dict(
