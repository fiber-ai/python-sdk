...
if TYPE_CHECKING:
    ...
    from ..models.get_time_zones_response_200_charge_info_type_4 import GetTimeZonesResponse200ChargeInfoType4
...
class GetTimeZonesResponse200:
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.get_time_zones_response_200_charge_info_type_0 import (
            GetTimeZonesResponse200ChargeInfoType0,  # noqa: PLC0415
        )
        from ..models.get_time_zones_response_200_charge_info_type_1 import (
            GetTimeZonesResponse200ChargeInfoType1,  # noqa: PLC0415
        )
        from ..models.get_time_zones_response_200_charge_info_type_2 import (
            GetTimeZonesResponse200ChargeInfoType2,  # noqa: PLC0415
        )
        from ..models.get_time_zones_response_200_charge_info_type_3 import (
            GetTimeZonesResponse200ChargeInfoType3,  # noqa: PLC0415
        )
        ...
        if isinstance(self.charge_info, GetTimeZonesResponse200ChargeInfoType0):
            ...
            charge_info = self.charge_info.to_dict()
        elif isinstance(self.charge_info, GetTimeZonesResponse200ChargeInfoType3):
            charge_info = self.charge_info.to_dict()
        else:
            charge_info = self.charge_info.to_dict()
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.get_time_zones_response_200_charge_info_type_4 import (
            GetTimeZonesResponse200ChargeInfoType4,  # noqa: PLC0415
        )
        from ..models.get_time_zones_response_200_output_item import GetTimeZonesResponse200OutputItem  # noqa: PLC0415
        from ..models.get_time_zones_response_200_warnings_type_0_item import (
            GetTimeZonesResponse200WarningsType0Item,  # noqa: PLC0415
        )
        ...
        def _parse_charge_info(
            ...
            if not isinstance(data, dict):
                raise TypeError()
            charge_info_type_4 = GetTimeZonesResponse200ChargeInfoType4.from_dict(data)
