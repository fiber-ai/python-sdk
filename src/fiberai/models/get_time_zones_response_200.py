...
class GetTimeZonesResponse200:
    """ 
        Attributes:
            output (list['GetTimeZonesResponse200OutputItem']): List of all available timezones with comprehensive
                information
            charge_info (Union['GetTimeZonesResponse200ChargeInfoType0', 'GetTimeZonesResponse200ChargeInfoType1',
                'GetTimeZonesResponse200ChargeInfoType2', 'GetTimeZonesResponse200ChargeInfoType3']):
            warnings (Union[None, Unset, list['GetTimeZonesResponse200WarningsType0Item']]): Warnings about extraneous
                fields in request
     """

    output: list['GetTimeZonesResponse200OutputItem']
    charge_info: Union['GetTimeZonesResponse200ChargeInfoType0', 'GetTimeZonesResponse200ChargeInfoType1', 'GetTimeZonesResponse200ChargeInfoType2', 'GetTimeZonesResponse200ChargeInfoType3']
    warnings: Union[None, Unset, list['GetTimeZonesResponse200WarningsType0Item']] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_charge_info(data: object) -> Union['GetTimeZonesResponse200ChargeInfoType0', 'GetTimeZonesResponse200ChargeInfoType1', 'GetTimeZonesResponse200ChargeInfoType2', 'GetTimeZonesResponse200ChargeInfoType3']:
            try:
        ...
        def _parse_warnings(data: object) -> Union[None, Unset, list['GetTimeZonesResponse200WarningsType0Item']]:
            if data is None:
                return data
            ...
            try:
                ...
                pass
            return cast(Union[None, Unset, list['GetTimeZonesResponse200WarningsType0Item']], data)
