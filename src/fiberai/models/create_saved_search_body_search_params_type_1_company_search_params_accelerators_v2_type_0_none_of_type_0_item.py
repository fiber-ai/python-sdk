...
from ..models.create_saved_search_body_search_params_type_1_company_search_params_accelerators_v2_type_0_none_of_type_0_item_accelerator_name import (
...
class CreateSavedSearchBodySearchParamsType1CompanySearchParamsAcceleratorsV2Type0NoneOfType0Item:
    ...
    Attributes:
        ...
        batch_selection
            ...
            | CreateSavedSearchBodySearchParamsType1CompanySearchParamsAcceleratorsV2Type0NoneOfType0ItemBatchSelectionType1
            | None | Unset):
        years (CreateSavedSearchBodySearchParamsType1CompanySearchParamsAcceleratorsV2Type0NoneOfType0ItemYearsType0 |
            None | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_batch_selection(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                batch_selection_type_0 = CreateSavedSearchBodySearchParamsType1CompanySearchParamsAcceleratorsV2Type0NoneOfType0ItemBatchSelectionType0.from_dict(
                    data
                )
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                batch_selection_type_1 = CreateSavedSearchBodySearchParamsType1CompanySearchParamsAcceleratorsV2Type0NoneOfType0ItemBatchSelectionType1.from_dict(
                    data
                )
        ...
        def _parse_years(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                years_type_0 = CreateSavedSearchBodySearchParamsType1CompanySearchParamsAcceleratorsV2Type0NoneOfType0ItemYearsType0.from_dict(
                    data
                )
