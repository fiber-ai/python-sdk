...
T = TypeVar("T", bound="CreateSavedSearchBodySearchParamsType1CompanySearchParamsKeywordsType0")


@_attrs_define
class CreateSavedSearchBodySearchParamsType1CompanySearchParamsKeywordsType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_saved_search_body_search_params_type_1_company_search_params_keywords_type_0 = cls(
            contains_all=contains_all,
            contains_any=contains_any,
            contains_none=contains_none,
        )

        create_saved_search_body_search_params_type_1_company_search_params_keywords_type_0.additional_properties = d
        return create_saved_search_body_search_params_type_1_company_search_params_keywords_type_0
