...
T = TypeVar("T", bound="TextToCombinedSearchResponse200OutputDataProfilesItemDetailedEducationType0ItemSchoolDetailsType0")



@_attrs_define
class TextToCombinedSearchResponse200OutputDataProfilesItemDetailedEducationType0ItemSchoolDetailsType0:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        text_to_combined_search_response_200_output_data_profiles_item_detailed_education_type_0_item_school_details_type_0 = cls(
        ...
        text_to_combined_search_response_200_output_data_profiles_item_detailed_education_type_0_item_school_details_type_0.additional_properties = d
        return text_to_combined_search_response_200_output_data_profiles_item_detailed_education_type_0_item_school_details_type_0
