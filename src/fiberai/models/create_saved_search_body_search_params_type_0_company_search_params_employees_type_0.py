...
from ..models.create_saved_search_body_search_params_type_0_company_search_params_employees_type_0_joiner import CreateSavedSearchBodySearchParamsType0CompanySearchParamsEmployeesType0Joiner
from typing import cast

if TYPE_CHECKING:
  from ..models.create_saved_search_body_search_params_type_0_company_search_params_employees_type_0_rules_item import CreateSavedSearchBodySearchParamsType0CompanySearchParamsEmployeesType0RulesItem
...
class CreateSavedSearchBodySearchParamsType0CompanySearchParamsEmployeesType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for rules_item_data in (_rules):
            rules_item = CreateSavedSearchBodySearchParamsType0CompanySearchParamsEmployeesType0RulesItem.from_dict(rules_item_data)
