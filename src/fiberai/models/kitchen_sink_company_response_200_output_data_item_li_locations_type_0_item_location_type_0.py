...
class KitchenSinkCompanyResponse200OutputDataItemLiLocationsType0ItemLocationType0:
    ...
    Attributes:
        ...
        coordinates (KitchenSinkCompanyResponse200OutputDataItemLiLocationsType0ItemLocationType0CoordinatesType0 | None
            | Unset):
    ...
    coordinates: (
        KitchenSinkCompanyResponse200OutputDataItemLiLocationsType0ItemLocationType0CoordinatesType0 | None | Unset
    ) = UNSET
        ...
        def _parse_coordinates(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = KitchenSinkCompanyResponse200OutputDataItemLiLocationsType0ItemLocationType0CoordinatesType0.from_dict(
                    data
                )
