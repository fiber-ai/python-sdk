...
from ..models.poll_batch_contact_enrichment_response_200_output_page_results_item_outputs_type_0_emails_item_status import (
    PollBatchContactEnrichmentResponse200OutputPageResultsItemOutputsType0EmailsItemStatus,
)
from ..models.poll_batch_contact_enrichment_response_200_output_page_results_item_outputs_type_0_emails_item_type import (
    PollBatchContactEnrichmentResponse200OutputPageResultsItemOutputsType0EmailsItemType,
)
...
class PollBatchContactEnrichmentResponse200OutputPageResultsItemOutputsType0EmailsItem:
    ...
    Attributes:
        ...
        status (PollBatchContactEnrichmentResponse200OutputPageResultsItemOutputsType0EmailsItemStatus | Unset):
    """

    email: str
    type_: PollBatchContactEnrichmentResponse200OutputPageResultsItemOutputsType0EmailsItemType
    status: PollBatchContactEnrichmentResponse200OutputPageResultsItemOutputsType0EmailsItemStatus | Unset = UNSET
