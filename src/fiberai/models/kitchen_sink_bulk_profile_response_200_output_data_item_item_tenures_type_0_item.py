...
if TYPE_CHECKING:
  from ..models.kitchen_sink_bulk_profile_response_200_output_data_item_item_tenures_type_0_item_date_range import KitchenSinkBulkProfileResponse200OutputDataItemItemTenuresType0ItemDateRange
...
class KitchenSinkBulkProfileResponse200OutputDataItemItemTenuresType0Item:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.kitchen_sink_bulk_profile_response_200_output_data_item_item_tenures_type_0_item_date_range import KitchenSinkBulkProfileResponse200OutputDataItemItemTenuresType0ItemDateRange
        d = dict(src_dict)
        date_range = KitchenSinkBulkProfileResponse200OutputDataItemItemTenuresType0ItemDateRange.from_dict(d.pop("date_range"))
