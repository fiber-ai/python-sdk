...
if TYPE_CHECKING:
    from ..models.kitchen_sink_bulk_profile_response_200_output_data_item_item_tenures_type_0_item_date_range import (
        KitchenSinkBulkProfileResponse200OutputDataItemItemTenuresType0ItemDateRange,
    )


T = TypeVar("T", bound="KitchenSinkBulkProfileResponse200OutputDataItemItemTenuresType0Item")


@_attrs_define
class KitchenSinkBulkProfileResponse200OutputDataItemItemTenuresType0Item:
    """
    Attributes:
        date_range (KitchenSinkBulkProfileResponse200OutputDataItemItemTenuresType0ItemDateRange):
        titles (list[str]):
        localities (list[str]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.kitchen_sink_bulk_profile_response_200_output_data_item_item_tenures_type_0_item_date_range import (
            KitchenSinkBulkProfileResponse200OutputDataItemItemTenuresType0ItemDateRange,  # noqa: PLC0415
        )

        d = dict(src_dict)
        date_range = KitchenSinkBulkProfileResponse200OutputDataItemItemTenuresType0ItemDateRange.from_dict(
            d.pop("date_range")
        )
        ...
        kitchen_sink_bulk_profile_response_200_output_data_item_item_tenures_type_0_item = cls(
            date_range=date_range,
            titles=titles,
            localities=localities,
        ...
        kitchen_sink_bulk_profile_response_200_output_data_item_item_tenures_type_0_item.additional_properties = d
        return kitchen_sink_bulk_profile_response_200_output_data_item_item_tenures_type_0_item
