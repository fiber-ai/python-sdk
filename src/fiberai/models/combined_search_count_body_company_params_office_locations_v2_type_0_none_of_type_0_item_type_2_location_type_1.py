...
if TYPE_CHECKING:
    from ..models.combined_search_count_body_company_params_office_locations_v2_type_0_none_of_type_0_item_type_2_location_type_1_radius_type_0 import (
        CombinedSearchCountBodyCompanyParamsOfficeLocationsV2Type0NoneOfType0ItemType2LocationType1RadiusType0,
    )
    from ..models.combined_search_count_body_company_params_office_locations_v2_type_0_none_of_type_0_item_type_2_location_type_1_radius_type_1 import (
        CombinedSearchCountBodyCompanyParamsOfficeLocationsV2Type0NoneOfType0ItemType2LocationType1RadiusType1,
    )
...
class CombinedSearchCountBodyCompanyParamsOfficeLocationsV2Type0NoneOfType0ItemType2LocationType1:
    ...
    Attributes:
        ...
        city (str):
        radius (CombinedSearchCountBodyCompanyParamsOfficeLocationsV2Type0NoneOfType0ItemType2LocationType1RadiusType0 |
            CombinedSearchCountBodyCompanyParamsOfficeLocationsV2Type0NoneOfType0ItemType2LocationType1RadiusType1):
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.combined_search_count_body_company_params_office_locations_v2_type_0_none_of_type_0_item_type_2_location_type_1_radius_type_0 import (
            CombinedSearchCountBodyCompanyParamsOfficeLocationsV2Type0NoneOfType0ItemType2LocationType1RadiusType0,  # noqa: PLC0415
        )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.combined_search_count_body_company_params_office_locations_v2_type_0_none_of_type_0_item_type_2_location_type_1_radius_type_1 import (
            CombinedSearchCountBodyCompanyParamsOfficeLocationsV2Type0NoneOfType0ItemType2LocationType1RadiusType1,  # noqa: PLC0415
        )
        ...
        def _parse_radius(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                radius_type_0 = CombinedSearchCountBodyCompanyParamsOfficeLocationsV2Type0NoneOfType0ItemType2LocationType1RadiusType0.from_dict(
                    data
                )
            ...
            if not isinstance(data, dict):
                raise TypeError()
            radius_type_1 = CombinedSearchCountBodyCompanyParamsOfficeLocationsV2Type0NoneOfType0ItemType2LocationType1RadiusType1.from_dict(
                data
            )
