...
from ..models.sync_combined_search_body_company_params_employee_trends_type_0_obeys_any_type_0_item_count_criteria_type_1_type import (
    SyncCombinedSearchBodyCompanyParamsEmployeeTrendsType0ObeysAnyType0ItemCountCriteriaType1Type,
)

if TYPE_CHECKING:
    from ..models.sync_combined_search_body_company_params_employee_trends_type_0_obeys_any_type_0_item_count_criteria_type_1_change import (
        SyncCombinedSearchBodyCompanyParamsEmployeeTrendsType0ObeysAnyType0ItemCountCriteriaType1Change,
    )
...
class SyncCombinedSearchBodyCompanyParamsEmployeeTrendsType0ObeysAnyType0ItemCountCriteriaType1:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        change = (
            SyncCombinedSearchBodyCompanyParamsEmployeeTrendsType0ObeysAnyType0ItemCountCriteriaType1Change.from_dict(
                d.pop("change")
            )
        )
        ...
        sync_combined_search_body_company_params_employee_trends_type_0_obeys_any_type_0_item_count_criteria_type_1 = (
            cls(
                type_=type_,
                change=change,
