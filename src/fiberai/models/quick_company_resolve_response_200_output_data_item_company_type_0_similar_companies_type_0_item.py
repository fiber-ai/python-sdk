...
T = TypeVar("T", bound="QuickCompanyResolveResponse200OutputDataItemCompanyType0SimilarCompaniesType0Item")


@_attrs_define
class QuickCompanyResolveResponse200OutputDataItemCompanyType0SimilarCompaniesType0Item:
    """
    Attributes:
        name (None | str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        quick_company_resolve_response_200_output_data_item_company_type_0_similar_companies_type_0_item = cls(
            name=name,
        ...
        quick_company_resolve_response_200_output_data_item_company_type_0_similar_companies_type_0_item.additional_properties = d
        return quick_company_resolve_response_200_output_data_item_company_type_0_similar_companies_type_0_item
