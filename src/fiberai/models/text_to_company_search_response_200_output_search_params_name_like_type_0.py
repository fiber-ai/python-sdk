...
T = TypeVar("T", bound="TextToCompanySearchResponse200OutputSearchParamsNameLikeType0")


@_attrs_define
class TextToCompanySearchResponse200OutputSearchParamsNameLikeType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        text_to_company_search_response_200_output_search_params_name_like_type_0 = cls(
            any_of=any_of,
            none_of=none_of,
        )

        text_to_company_search_response_200_output_search_params_name_like_type_0.additional_properties = d
        return text_to_company_search_response_200_output_search_params_name_like_type_0
