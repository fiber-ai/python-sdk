...
T = TypeVar("T", bound="TextToProfileSearchParamsResponse200OutputSearchParamsKeywordSearchOptionsType0FieldsToSearchOverType0")



@_attrs_define
class TextToProfileSearchParamsResponse200OutputSearchParamsKeywordSearchOptionsType0FieldsToSearchOverType0:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        text_to_profile_search_params_response_200_output_search_params_keyword_search_options_type_0_fields_to_search_over_type_0 = cls(
            summary=summary,
            headline=headline,
        ...
        text_to_profile_search_params_response_200_output_search_params_keyword_search_options_type_0_fields_to_search_over_type_0.additional_properties = d
        return text_to_profile_search_params_response_200_output_search_params_keyword_search_options_type_0_fields_to_search_over_type_0
