...
from ..models.get_saved_search_run_companies_body_statuses_type_0_item import (
    GetSavedSearchRunCompaniesBodyStatusesType0Item,
)
...
class GetSavedSearchRunCompaniesBody:
    ...
    Attributes:
        ...
        statuses (list[GetSavedSearchRunCompaniesBodyStatusesType0Item] | None | Unset): The statuses of the companies.
            This is optional and if not provided, all companies will be returned.
    ...
    statuses: list[GetSavedSearchRunCompaniesBodyStatusesType0Item] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_statuses(data: object) -> list[GetSavedSearchRunCompaniesBodyStatusesType0Item] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                pass
            return cast(list[GetSavedSearchRunCompaniesBodyStatusesType0Item] | None | Unset, data)
