...
if TYPE_CHECKING:
    from ..models.quick_company_resolve_response_200_output_data_item_company_type_0_investment_stats_type_0_investments_by_stage_type_0_item import (
        QuickCompanyResolveResponse200OutputDataItemCompanyType0InvestmentStatsType0InvestmentsByStageType0Item,
    )


T = TypeVar("T", bound="QuickCompanyResolveResponse200OutputDataItemCompanyType0InvestmentStatsType0")


@_attrs_define
class QuickCompanyResolveResponse200OutputDataItemCompanyType0InvestmentStatsType0:
    """
    Attributes:
        investments_by_stage
            (list[QuickCompanyResolveResponse200OutputDataItemCompanyType0InvestmentStatsType0InvestmentsByStageType0Item] |
            None | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.quick_company_resolve_response_200_output_data_item_company_type_0_investment_stats_type_0_investments_by_stage_type_0_item import (
            QuickCompanyResolveResponse200OutputDataItemCompanyType0InvestmentStatsType0InvestmentsByStageType0Item,  # noqa: PLC0415
        )
        ...
        def _parse_investments_by_stage(
            ...
            try:
                ...
                for investments_by_stage_type_0_item_data in _investments_by_stage_type_0:
                    investments_by_stage_type_0_item = QuickCompanyResolveResponse200OutputDataItemCompanyType0InvestmentStatsType0InvestmentsByStageType0Item.from_dict(
        ...
        quick_company_resolve_response_200_output_data_item_company_type_0_investment_stats_type_0 = cls(
        ...
        quick_company_resolve_response_200_output_data_item_company_type_0_investment_stats_type_0.additional_properties = d
        return quick_company_resolve_response_200_output_data_item_company_type_0_investment_stats_type_0
