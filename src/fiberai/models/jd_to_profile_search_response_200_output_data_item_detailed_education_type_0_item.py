...
if TYPE_CHECKING:
    from ..models.jd_to_profile_search_response_200_output_data_item_detailed_education_type_0_item_school_details_type_0 import (
        JdToProfileSearchResponse200OutputDataItemDetailedEducationType0ItemSchoolDetailsType0,
    )


T = TypeVar("T", bound="JdToProfileSearchResponse200OutputDataItemDetailedEducationType0Item")


@_attrs_define
class JdToProfileSearchResponse200OutputDataItemDetailedEducationType0Item:
    """
    Attributes:
        school_details (JdToProfileSearchResponse200OutputDataItemDetailedEducationType0ItemSchoolDetailsType0 | None |
            Unset):
    ...
    school_details: (
        JdToProfileSearchResponse200OutputDataItemDetailedEducationType0ItemSchoolDetailsType0 | None | Unset
    ) = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.school_details, Unset):
            ...
            self.school_details, JdToProfileSearchResponse200OutputDataItemDetailedEducationType0ItemSchoolDetailsType0
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_school_details(
            ...
            try:
                ...
                school_details_type_0 = (
                    JdToProfileSearchResponse200OutputDataItemDetailedEducationType0ItemSchoolDetailsType0.from_dict(
                        data
                    )
                )
        ...
        jd_to_profile_search_response_200_output_data_item_detailed_education_type_0_item = cls(
        ...
        jd_to_profile_search_response_200_output_data_item_detailed_education_type_0_item.additional_properties = d
        return jd_to_profile_search_response_200_output_data_item_detailed_education_type_0_item
