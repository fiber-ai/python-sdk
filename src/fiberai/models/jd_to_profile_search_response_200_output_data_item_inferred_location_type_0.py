...
if TYPE_CHECKING:
    from ..models.jd_to_profile_search_response_200_output_data_item_inferred_location_type_0_coordinates_type_0 import (
        JdToProfileSearchResponse200OutputDataItemInferredLocationType0CoordinatesType0,
    )


T = TypeVar("T", bound="JdToProfileSearchResponse200OutputDataItemInferredLocationType0")


@_attrs_define
class JdToProfileSearchResponse200OutputDataItemInferredLocationType0:
    """
    Attributes:
        ...
        coordinates (JdToProfileSearchResponse200OutputDataItemInferredLocationType0CoordinatesType0 | None | Unset):
    ...
    coordinates: JdToProfileSearchResponse200OutputDataItemInferredLocationType0CoordinatesType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.coordinates, Unset):
            ...
            self.coordinates, JdToProfileSearchResponse200OutputDataItemInferredLocationType0CoordinatesType0
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_coordinates(
            data: object,
        ) -> JdToProfileSearchResponse200OutputDataItemInferredLocationType0CoordinatesType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = (
                    JdToProfileSearchResponse200OutputDataItemInferredLocationType0CoordinatesType0.from_dict(data)
                )
                ...
                pass
            return cast(
                JdToProfileSearchResponse200OutputDataItemInferredLocationType0CoordinatesType0 | None | Unset, data
            )
        ...
        jd_to_profile_search_response_200_output_data_item_inferred_location_type_0 = cls(
        ...
        jd_to_profile_search_response_200_output_data_item_inferred_location_type_0.additional_properties = d
        return jd_to_profile_search_response_200_output_data_item_inferred_location_type_0
