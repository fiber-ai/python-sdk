...
T = TypeVar("T", bound="SyncCombinedSearchBodyProfileParamsEducationType0AllOfType0ItemSchoolType0NoneOfType0Item")



@_attrs_define
class SyncCombinedSearchBodyProfileParamsEducationType0AllOfType0ItemSchoolType0NoneOfType0Item:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sync_combined_search_body_profile_params_education_type_0_all_of_type_0_item_school_type_0_none_of_type_0_item = cls(
        ...
        sync_combined_search_body_profile_params_education_type_0_all_of_type_0_item_school_type_0_none_of_type_0_item.additional_properties = d
        return sync_combined_search_body_profile_params_education_type_0_all_of_type_0_item_school_type_0_none_of_type_0_item
