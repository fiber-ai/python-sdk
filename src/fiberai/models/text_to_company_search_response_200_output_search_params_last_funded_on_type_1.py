...
class TextToCompanySearchResponse200OutputSearchParamsLastFundedOnType1:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.window, TextToCompanySearchResponse200OutputSearchParamsLastFundedOnType1WindowType1):
            window = self.window.to_dict()
        elif isinstance(self.window, TextToCompanySearchResponse200OutputSearchParamsLastFundedOnType1WindowType2):
            window = self.window.to_dict()
        else:
            window = self.window
