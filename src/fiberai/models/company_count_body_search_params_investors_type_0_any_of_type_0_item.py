...
T = TypeVar("T", bound="CompanyCountBodySearchParamsInvestorsType0AnyOfType0Item")



@_attrs_define
class CompanyCountBodySearchParamsInvestorsType0AnyOfType0Item:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        company_count_body_search_params_investors_type_0_any_of_type_0_item = cls(
        ...
        company_count_body_search_params_investors_type_0_any_of_type_0_item.additional_properties = d
        return company_count_body_search_params_investors_type_0_any_of_type_0_item
