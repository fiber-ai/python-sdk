...
T = TypeVar("T", bound="TextToCompanySearchParamsResponse200OutputSearchParamsLastFundingUSDType0")



@_attrs_define
class TextToCompanySearchParamsResponse200OutputSearchParamsLastFundingUSDType0:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        text_to_company_search_params_response_200_output_search_params_last_funding_usd_type_0 = cls(
            lower_bound=lower_bound,
            upper_bound=upper_bound,
        )


        text_to_company_search_params_response_200_output_search_params_last_funding_usd_type_0.additional_properties = d
        return text_to_company_search_params_response_200_output_search_params_last_funding_usd_type_0
