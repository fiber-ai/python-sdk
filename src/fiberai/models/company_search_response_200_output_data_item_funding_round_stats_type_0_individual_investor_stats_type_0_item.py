...
T = TypeVar("T", bound="CompanySearchResponse200OutputDataItemFundingRoundStatsType0IndividualInvestorStatsType0Item")


@_attrs_define
class CompanySearchResponse200OutputDataItemFundingRoundStatsType0IndividualInvestorStatsType0Item:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        company_search_response_200_output_data_item_funding_round_stats_type_0_individual_investor_stats_type_0_item = cls(
        ...
        company_search_response_200_output_data_item_funding_round_stats_type_0_individual_investor_stats_type_0_item.additional_properties = d
        return company_search_response_200_output_data_item_funding_round_stats_type_0_individual_investor_stats_type_0_item
