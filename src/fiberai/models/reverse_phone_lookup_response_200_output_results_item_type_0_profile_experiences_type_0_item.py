...
from ..models.reverse_phone_lookup_response_200_output_results_item_type_0_profile_experiences_type_0_item_academic_qualification_type_0_item import (
    ReversePhoneLookupResponse200OutputResultsItemType0ProfileExperiencesType0ItemAcademicQualificationType0Item,
)
from ..models.reverse_phone_lookup_response_200_output_results_item_type_0_profile_experiences_type_0_item_employment_type_type_0_item import (
    ReversePhoneLookupResponse200OutputResultsItemType0ProfileExperiencesType0ItemEmploymentTypeType0Item,
)
from ..models.reverse_phone_lookup_response_200_output_results_item_type_0_profile_experiences_type_0_item_job_function_type_0_item import (
    ReversePhoneLookupResponse200OutputResultsItemType0ProfileExperiencesType0ItemJobFunctionType0Item,
)
from ..models.reverse_phone_lookup_response_200_output_results_item_type_0_profile_experiences_type_0_item_seniority_type_1 import (
    ReversePhoneLookupResponse200OutputResultsItemType0ProfileExperiencesType0ItemSeniorityType1,
)
from ..models.reverse_phone_lookup_response_200_output_results_item_type_0_profile_experiences_type_0_item_seniority_type_2_type_1 import (
    ReversePhoneLookupResponse200OutputResultsItemType0ProfileExperiencesType0ItemSeniorityType2Type1,
)
from ..models.reverse_phone_lookup_response_200_output_results_item_type_0_profile_experiences_type_0_item_seniority_type_3_type_1 import (
    ReversePhoneLookupResponse200OutputResultsItemType0ProfileExperiencesType0ItemSeniorityType3Type1,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ReversePhoneLookupResponse200OutputResultsItemType0ProfileExperiencesType0Item")


@_attrs_define
class ReversePhoneLookupResponse200OutputResultsItemType0ProfileExperiencesType0Item:
    """
    Attributes:
        ...
        seniority (None | ReversePhoneLookupResponse200OutputResultsItemType0ProfileExperiencesType0ItemSeniorityType1 |
            ReversePhoneLookupResponse200OutputResultsItemType0ProfileExperiencesType0ItemSeniorityType2Type1 |
            ReversePhoneLookupResponse200OutputResultsItemType0ProfileExperiencesType0ItemSeniorityType3Type1 | Unset):
        job_function
            (list[ReversePhoneLookupResponse200OutputResultsItemType0ProfileExperiencesType0ItemJobFunctionType0Item] | None
            | Unset):
        employment_type
            (list[ReversePhoneLookupResponse200OutputResultsItemType0ProfileExperiencesType0ItemEmploymentTypeType0Item] |
            None | Unset):
        academic_qualification (list[ReversePhoneLookupResponse200OutputResultsItemType0ProfileExperiencesType0ItemAcade
            micQualificationType0Item] | None | Unset):
    ...
    job_function: (
        list[ReversePhoneLookupResponse200OutputResultsItemType0ProfileExperiencesType0ItemJobFunctionType0Item]
        | None
        | Unset
    ) = UNSET
    employment_type: (
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.seniority, Unset):
            ...
            self.seniority, ReversePhoneLookupResponse200OutputResultsItemType0ProfileExperiencesType0ItemSeniorityType1
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_seniority(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                seniority_type_1 = (
                    ReversePhoneLookupResponse200OutputResultsItemType0ProfileExperiencesType0ItemSeniorityType1(data)
                )
        ...
        def _parse_job_function(
            ...
            try:
                ...
                for job_function_type_0_item_data in _job_function_type_0:
                    job_function_type_0_item = ReversePhoneLookupResponse200OutputResultsItemType0ProfileExperiencesType0ItemJobFunctionType0Item(
        ...
        def _parse_employment_type(
            ...
            try:
                ...
                for employment_type_type_0_item_data in _employment_type_type_0:
                    employment_type_type_0_item = ReversePhoneLookupResponse200OutputResultsItemType0ProfileExperiencesType0ItemEmploymentTypeType0Item(
        ...
        def _parse_academic_qualification(
            ...
            try:
                ...
                for academic_qualification_type_0_item_data in _academic_qualification_type_0:
                    academic_qualification_type_0_item = ReversePhoneLookupResponse200OutputResultsItemType0ProfileExperiencesType0ItemAcademicQualificationType0Item(
        ...
        reverse_phone_lookup_response_200_output_results_item_type_0_profile_experiences_type_0_item = cls(
        ...
        reverse_phone_lookup_response_200_output_results_item_type_0_profile_experiences_type_0_item.additional_properties = d
        return reverse_phone_lookup_response_200_output_results_item_type_0_profile_experiences_type_0_item
