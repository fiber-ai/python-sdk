...
from ..models.poll_batch_live_enrich_response_200_output_results_item_profile_type_0_detailed_work_experiences_type_0_item_academic_qualification_type_0_item import (
    PollBatchLiveEnrichResponse200OutputResultsItemProfileType0DetailedWorkExperiencesType0ItemAcademicQualificationType0Item,
)
from ..models.poll_batch_live_enrich_response_200_output_results_item_profile_type_0_detailed_work_experiences_type_0_item_employment_type_type_0_item import (
    PollBatchLiveEnrichResponse200OutputResultsItemProfileType0DetailedWorkExperiencesType0ItemEmploymentTypeType0Item,
)
from ..models.poll_batch_live_enrich_response_200_output_results_item_profile_type_0_detailed_work_experiences_type_0_item_job_function_type_0_item import (
    PollBatchLiveEnrichResponse200OutputResultsItemProfileType0DetailedWorkExperiencesType0ItemJobFunctionType0Item,
)
from ..models.poll_batch_live_enrich_response_200_output_results_item_profile_type_0_detailed_work_experiences_type_0_item_seniority_type_1 import (
    PollBatchLiveEnrichResponse200OutputResultsItemProfileType0DetailedWorkExperiencesType0ItemSeniorityType1,
)
from ..models.poll_batch_live_enrich_response_200_output_results_item_profile_type_0_detailed_work_experiences_type_0_item_seniority_type_2_type_1 import (
    PollBatchLiveEnrichResponse200OutputResultsItemProfileType0DetailedWorkExperiencesType0ItemSeniorityType2Type1,
)
from ..models.poll_batch_live_enrich_response_200_output_results_item_profile_type_0_detailed_work_experiences_type_0_item_seniority_type_3_type_1 import (
    PollBatchLiveEnrichResponse200OutputResultsItemProfileType0DetailedWorkExperiencesType0ItemSeniorityType3Type1,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.poll_batch_live_enrich_response_200_output_results_item_profile_type_0_detailed_work_experiences_type_0_item_company_details_type_0 import (
        PollBatchLiveEnrichResponse200OutputResultsItemProfileType0DetailedWorkExperiencesType0ItemCompanyDetailsType0,
    )


T = TypeVar("T", bound="PollBatchLiveEnrichResponse200OutputResultsItemProfileType0DetailedWorkExperiencesType0Item")


@_attrs_define
class PollBatchLiveEnrichResponse200OutputResultsItemProfileType0DetailedWorkExperiencesType0Item:
    """
    Attributes:
        ...
        seniority (None |
            ...
            PollBatchLiveEnrichResponse200OutputResultsItemProfileType0DetailedWorkExperiencesType0ItemSeniorityType3Type1 |
            Unset):
        job_function (list[PollBatchLiveEnrichResponse200OutputResultsItemProfileType0DetailedWorkExperiencesType0ItemJo
            bFunctionType0Item] | None | Unset):
        employment_type (list[PollBatchLiveEnrichResponse200OutputResultsItemProfileType0DetailedWorkExperiencesType0Ite
            mEmploymentTypeType0Item] | None | Unset):
        academic_qualification (list[PollBatchLiveEnrichResponse200OutputResultsItemProfileType0DetailedWorkExperiencesT
            ype0ItemAcademicQualificationType0Item] | None | Unset):
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.poll_batch_live_enrich_response_200_output_results_item_profile_type_0_detailed_work_experiences_type_0_item_company_details_type_0 import (
            PollBatchLiveEnrichResponse200OutputResultsItemProfileType0DetailedWorkExperiencesType0ItemCompanyDetailsType0,  # noqa: PLC0415
        )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_company_details(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                company_details_type_0 = PollBatchLiveEnrichResponse200OutputResultsItemProfileType0DetailedWorkExperiencesType0ItemCompanyDetailsType0.from_dict(
                    data
                )
        ...
        def _parse_seniority(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                seniority_type_1 = PollBatchLiveEnrichResponse200OutputResultsItemProfileType0DetailedWorkExperiencesType0ItemSeniorityType1(
                    data
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                seniority_type_2_type_1 = PollBatchLiveEnrichResponse200OutputResultsItemProfileType0DetailedWorkExperiencesType0ItemSeniorityType2Type1(
                    data
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                seniority_type_3_type_1 = PollBatchLiveEnrichResponse200OutputResultsItemProfileType0DetailedWorkExperiencesType0ItemSeniorityType3Type1(
                    data
                )
        ...
        def _parse_job_function(
            ...
            try:
                ...
                for job_function_type_0_item_data in _job_function_type_0:
                    job_function_type_0_item = PollBatchLiveEnrichResponse200OutputResultsItemProfileType0DetailedWorkExperiencesType0ItemJobFunctionType0Item(
        ...
        def _parse_employment_type(
            ...
            try:
                ...
                for employment_type_type_0_item_data in _employment_type_type_0:
                    employment_type_type_0_item = PollBatchLiveEnrichResponse200OutputResultsItemProfileType0DetailedWorkExperiencesType0ItemEmploymentTypeType0Item(
        ...
        def _parse_academic_qualification(
            ...
            try:
                ...
                for academic_qualification_type_0_item_data in _academic_qualification_type_0:
                    academic_qualification_type_0_item = PollBatchLiveEnrichResponse200OutputResultsItemProfileType0DetailedWorkExperiencesType0ItemAcademicQualificationType0Item(
        ...
        poll_batch_live_enrich_response_200_output_results_item_profile_type_0_detailed_work_experiences_type_0_item = (
            cls(
        ...
        poll_batch_live_enrich_response_200_output_results_item_profile_type_0_detailed_work_experiences_type_0_item.additional_properties = d
        return (
            poll_batch_live_enrich_response_200_output_results_item_profile_type_0_detailed_work_experiences_type_0_item
        )
