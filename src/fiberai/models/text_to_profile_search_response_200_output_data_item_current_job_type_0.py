...
from ..models.text_to_profile_search_response_200_output_data_item_current_job_type_0_academic_qualification_type_0_item import (
    TextToProfileSearchResponse200OutputDataItemCurrentJobType0AcademicQualificationType0Item,
)
from ..models.text_to_profile_search_response_200_output_data_item_current_job_type_0_employment_type_type_0_item import (
    TextToProfileSearchResponse200OutputDataItemCurrentJobType0EmploymentTypeType0Item,
)
from ..models.text_to_profile_search_response_200_output_data_item_current_job_type_0_job_function_type_0_item import (
    TextToProfileSearchResponse200OutputDataItemCurrentJobType0JobFunctionType0Item,
)
from ..models.text_to_profile_search_response_200_output_data_item_current_job_type_0_seniority_type_1 import (
    TextToProfileSearchResponse200OutputDataItemCurrentJobType0SeniorityType1,
)
from ..models.text_to_profile_search_response_200_output_data_item_current_job_type_0_seniority_type_2_type_1 import (
    TextToProfileSearchResponse200OutputDataItemCurrentJobType0SeniorityType2Type1,
)
from ..models.text_to_profile_search_response_200_output_data_item_current_job_type_0_seniority_type_3_type_1 import (
    TextToProfileSearchResponse200OutputDataItemCurrentJobType0SeniorityType3Type1,
)
...
class TextToProfileSearchResponse200OutputDataItemCurrentJobType0:
    ...
    Attributes:
        ...
        seniority (None | TextToProfileSearchResponse200OutputDataItemCurrentJobType0SeniorityType1 |
            TextToProfileSearchResponse200OutputDataItemCurrentJobType0SeniorityType2Type1 |
            TextToProfileSearchResponse200OutputDataItemCurrentJobType0SeniorityType3Type1 | Unset):
        job_function (list[TextToProfileSearchResponse200OutputDataItemCurrentJobType0JobFunctionType0Item] | None |
            Unset):
        employment_type (list[TextToProfileSearchResponse200OutputDataItemCurrentJobType0EmploymentTypeType0Item] | None
            | Unset):
        academic_qualification
            (list[TextToProfileSearchResponse200OutputDataItemCurrentJobType0AcademicQualificationType0Item] | None |
            Unset):
    ...
    job_function: (
        list[TextToProfileSearchResponse200OutputDataItemCurrentJobType0JobFunctionType0Item] | None | Unset
    ) = UNSET
    employment_type: (
        list[TextToProfileSearchResponse200OutputDataItemCurrentJobType0EmploymentTypeType0Item] | None | Unset
    ) = UNSET
    academic_qualification: (
        list[TextToProfileSearchResponse200OutputDataItemCurrentJobType0AcademicQualificationType0Item] | None | Unset
    ) = UNSET
        ...
        def _parse_seniority(
            ...
            try:
                ...
                seniority_type_2_type_1 = (
                    TextToProfileSearchResponse200OutputDataItemCurrentJobType0SeniorityType2Type1(data)
                )
            ...
            try:
                ...
                seniority_type_3_type_1 = (
                    TextToProfileSearchResponse200OutputDataItemCurrentJobType0SeniorityType3Type1(data)
                )
