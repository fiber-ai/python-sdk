...
T = TypeVar("T", bound="PeopleSearchResponse200OutputDataItemEducationType0Item")


@_attrs_define
class PeopleSearchResponse200OutputDataItemEducationType0Item:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        people_search_response_200_output_data_item_education_type_0_item = cls(
            school_id=school_id,
        ...
        people_search_response_200_output_data_item_education_type_0_item.additional_properties = d
        return people_search_response_200_output_data_item_education_type_0_item
