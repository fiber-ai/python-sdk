...
T = TypeVar("T", bound="PeopleSearchCountBodySearchParamsApproxAgeType0")


@_attrs_define
class PeopleSearchCountBodySearchParamsApproxAgeType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        people_search_count_body_search_params_approx_age_type_0 = cls(
            lower_bound=lower_bound,
            upper_bound=upper_bound,
        )

        people_search_count_body_search_params_approx_age_type_0.additional_properties = d
        return people_search_count_body_search_params_approx_age_type_0
