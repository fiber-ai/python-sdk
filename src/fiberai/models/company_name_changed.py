...
T = TypeVar("T", bound="CompanyNameChanged")
...
class CompanyNameChanged:
    """
    Attributes:
        type_ (Literal['company_name_changed']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        type_ = cast(Literal["company_name_changed"], d.pop("type"))
        if type_ != "company_name_changed":
            raise ValueError(f"type must match const 'company_name_changed', got '{type_}'")
        ...
        company_name_changed.additional_properties = d
        return company_name_changed
