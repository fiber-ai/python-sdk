...
T = TypeVar("T", bound="GetTalentFlowRivalsBodyDateRange")


@_attrs_define
class GetTalentFlowRivalsBodyDateRange:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_talent_flow_rivals_body_date_range = cls(
            lower_bound=lower_bound,
            upper_bound=upper_bound,
        )

        get_talent_flow_rivals_body_date_range.additional_properties = d
        return get_talent_flow_rivals_body_date_range
