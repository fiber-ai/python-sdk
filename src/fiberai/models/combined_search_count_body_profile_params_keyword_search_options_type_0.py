...
T = TypeVar("T", bound="CombinedSearchCountBodyProfileParamsKeywordSearchOptionsType0")


@_attrs_define
class CombinedSearchCountBodyProfileParamsKeywordSearchOptionsType0:
    """
    Attributes:
        fields_to_search_over (CombinedSearchCountBodyProfileParamsKeywordSearchOptionsType0FieldsToSearchOverType0 |
            None | Unset):
    """

    fields_to_search_over: (
        CombinedSearchCountBodyProfileParamsKeywordSearchOptionsType0FieldsToSearchOverType0 | None | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_fields_to_search_over(
            ...
            try:
                ...
                fields_to_search_over_type_0 = (
                    CombinedSearchCountBodyProfileParamsKeywordSearchOptionsType0FieldsToSearchOverType0.from_dict(data)
                )
        ...
        combined_search_count_body_profile_params_keyword_search_options_type_0 = cls(
            fields_to_search_over=fields_to_search_over,
        )

        combined_search_count_body_profile_params_keyword_search_options_type_0.additional_properties = d
        return combined_search_count_body_profile_params_keyword_search_options_type_0
