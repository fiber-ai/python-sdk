...
T = TypeVar("T", bound="CombinedSearchCountBodyCompanyParamsAcceleratorsV2Type0")


@_attrs_define
class CombinedSearchCountBodyCompanyParamsAcceleratorsV2Type0:
    """
    Attributes:
        any_of (list[CombinedSearchCountBodyCompanyParamsAcceleratorsV2Type0AnyOfType0Item] | None | Unset):
        none_of (list[CombinedSearchCountBodyCompanyParamsAcceleratorsV2Type0NoneOfType0Item] | None | Unset):
    """

    any_of: list[CombinedSearchCountBodyCompanyParamsAcceleratorsV2Type0AnyOfType0Item] | None | Unset = UNSET
    none_of: list[CombinedSearchCountBodyCompanyParamsAcceleratorsV2Type0NoneOfType0Item] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_any_of(
            data: object,
        ) -> list[CombinedSearchCountBodyCompanyParamsAcceleratorsV2Type0AnyOfType0Item] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for any_of_type_0_item_data in _any_of_type_0:
                    any_of_type_0_item = (
                        CombinedSearchCountBodyCompanyParamsAcceleratorsV2Type0AnyOfType0Item.from_dict(
                ...
                pass
            return cast(
                list[CombinedSearchCountBodyCompanyParamsAcceleratorsV2Type0AnyOfType0Item] | None | Unset, data
            )
        ...
        def _parse_none_of(
            data: object,
        ) -> list[CombinedSearchCountBodyCompanyParamsAcceleratorsV2Type0NoneOfType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for none_of_type_0_item_data in _none_of_type_0:
                    none_of_type_0_item = (
                        CombinedSearchCountBodyCompanyParamsAcceleratorsV2Type0NoneOfType0Item.from_dict(
                ...
                pass
            return cast(
                list[CombinedSearchCountBodyCompanyParamsAcceleratorsV2Type0NoneOfType0Item] | None | Unset, data
            )

        none_of = _parse_none_of(d.pop("noneOf", UNSET))

        combined_search_count_body_company_params_accelerators_v2_type_0 = cls(
            any_of=any_of,
            none_of=none_of,
        )

        combined_search_count_body_company_params_accelerators_v2_type_0.additional_properties = d
        return combined_search_count_body_company_params_accelerators_v2_type_0
