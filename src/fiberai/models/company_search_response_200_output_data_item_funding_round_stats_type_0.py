...
if TYPE_CHECKING:
  from ..models.company_search_response_200_output_data_item_funding_round_stats_type_0_individual_investor_stats_type_0_item import CompanySearchResponse200OutputDataItemFundingRoundStatsType0IndividualInvestorStatsType0Item





T = TypeVar("T", bound="CompanySearchResponse200OutputDataItemFundingRoundStatsType0")



@_attrs_define
class CompanySearchResponse200OutputDataItemFundingRoundStatsType0:
    """ 
        Attributes:
            ...
            individual_investor_stats (Union[None, Unset,
                list['CompanySearchResponse200OutputDataItemFundingRoundStatsType0IndividualInvestorStatsType0Item']]):
    ...
    individual_investor_stats: Union[None, Unset, list['CompanySearchResponse200OutputDataItemFundingRoundStatsType0IndividualInvestorStatsType0Item']] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_individual_investor_stats(data: object) -> Union[None, Unset, list['CompanySearchResponse200OutputDataItemFundingRoundStatsType0IndividualInvestorStatsType0Item']]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for individual_investor_stats_type_0_item_data in (_individual_investor_stats_type_0):
                    individual_investor_stats_type_0_item = CompanySearchResponse200OutputDataItemFundingRoundStatsType0IndividualInvestorStatsType0Item.from_dict(individual_investor_stats_type_0_item_data)
                ...
                pass
            return cast(Union[None, Unset, list['CompanySearchResponse200OutputDataItemFundingRoundStatsType0IndividualInvestorStatsType0Item']], data)
        ...
        company_search_response_200_output_data_item_funding_round_stats_type_0 = cls(
        ...
        company_search_response_200_output_data_item_funding_round_stats_type_0.additional_properties = d
        return company_search_response_200_output_data_item_funding_round_stats_type_0
