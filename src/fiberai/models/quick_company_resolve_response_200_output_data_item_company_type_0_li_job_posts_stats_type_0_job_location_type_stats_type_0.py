...
T = TypeVar(
    "T", bound="QuickCompanyResolveResponse200OutputDataItemCompanyType0LiJobPostsStatsType0JobLocationTypeStatsType0"
)


@_attrs_define
class QuickCompanyResolveResponse200OutputDataItemCompanyType0LiJobPostsStatsType0JobLocationTypeStatsType0:
    """
    Attributes:
        on_site
            (QuickCompanyResolveResponse200OutputDataItemCompanyType0LiJobPostsStatsType0JobLocationTypeStatsType0OnSite |
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_on_site, Unset):
            ...
            on_site = QuickCompanyResolveResponse200OutputDataItemCompanyType0LiJobPostsStatsType0JobLocationTypeStatsType0OnSite.from_dict(
                _on_site
            )
        ...
        if isinstance(_remote, Unset):
            ...
            remote = QuickCompanyResolveResponse200OutputDataItemCompanyType0LiJobPostsStatsType0JobLocationTypeStatsType0Remote.from_dict(
                _remote
            )
        ...
        if isinstance(_hybrid, Unset):
            ...
            hybrid = QuickCompanyResolveResponse200OutputDataItemCompanyType0LiJobPostsStatsType0JobLocationTypeStatsType0Hybrid.from_dict(
                _hybrid
            )

        quick_company_resolve_response_200_output_data_item_company_type_0_li_job_posts_stats_type_0_job_location_type_stats_type_0 = cls(
            on_site=on_site,
            remote=remote,
            hybrid=hybrid,
        )

        return quick_company_resolve_response_200_output_data_item_company_type_0_li_job_posts_stats_type_0_job_location_type_stats_type_0
