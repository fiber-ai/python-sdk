...
if TYPE_CHECKING:
    from ..models.sync_combined_search_response_200_output_companies_item_role_count_matches_type_0_item_num_matching_employees_type_0 import (
        SyncCombinedSearchResponse200OutputCompaniesItemRoleCountMatchesType0ItemNumMatchingEmployeesType0,
    )
    from ..models.sync_combined_search_response_200_output_companies_item_role_count_matches_type_0_item_num_matching_employees_type_1 import (
        SyncCombinedSearchResponse200OutputCompaniesItemRoleCountMatchesType0ItemNumMatchingEmployeesType1,
    )
    from ..models.sync_combined_search_response_200_output_companies_item_role_count_matches_type_0_item_num_matching_employees_type_2 import (
        SyncCombinedSearchResponse200OutputCompaniesItemRoleCountMatchesType0ItemNumMatchingEmployeesType2,
    )
    from ..models.sync_combined_search_response_200_output_companies_item_role_count_matches_type_0_item_num_matching_employees_type_3 import (
        ...
        def _parse_num_matching_employees(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                num_matching_employees_type_0 = SyncCombinedSearchResponse200OutputCompaniesItemRoleCountMatchesType0ItemNumMatchingEmployeesType0.from_dict(
                    data
                )
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                num_matching_employees_type_1 = SyncCombinedSearchResponse200OutputCompaniesItemRoleCountMatchesType0ItemNumMatchingEmployeesType1.from_dict(
                    data
                )
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                num_matching_employees_type_2 = SyncCombinedSearchResponse200OutputCompaniesItemRoleCountMatchesType0ItemNumMatchingEmployeesType2.from_dict(
                    data
                )
            ...
            if not isinstance(data, dict):
                raise TypeError()
            num_matching_employees_type_3 = SyncCombinedSearchResponse200OutputCompaniesItemRoleCountMatchesType0ItemNumMatchingEmployeesType3.from_dict(
                data
            )
