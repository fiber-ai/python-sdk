...
class KitchenSinkBulkCompanyBodyCompaniesItem:
    ...
    Attributes:
        ...
        company_location (KitchenSinkBulkCompanyBodyCompaniesItemCompanyLocationType0 | None | Unset): Company
            headquarters location. Helps disambiguate companies with similar names or domains by boosting matches in the
            specified location.
    ...
    company_name: KitchenSinkBulkCompanyBodyCompaniesItemCompanyNameType0 | None | Unset = UNSET
    company_domain: KitchenSinkBulkCompanyBodyCompaniesItemCompanyDomainType0 | None | Unset = UNSET
    company_location: KitchenSinkBulkCompanyBodyCompaniesItemCompanyLocationType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.company_location, KitchenSinkBulkCompanyBodyCompaniesItemCompanyLocationType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_company_identifier(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                company_identifier_type_0 = KitchenSinkBulkCompanyBodyCompaniesItemCompanyIdentifierType0.from_dict(
                    data
                )
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                company_identifier_type_1 = KitchenSinkBulkCompanyBodyCompaniesItemCompanyIdentifierType1.from_dict(
                    data
                )
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                company_identifier_type_2 = KitchenSinkBulkCompanyBodyCompaniesItemCompanyIdentifierType2.from_dict(
                    data
                )
        ...
        def _parse_company_name(data: object) -> KitchenSinkBulkCompanyBodyCompaniesItemCompanyNameType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(KitchenSinkBulkCompanyBodyCompaniesItemCompanyNameType0 | None | Unset, data)

        company_name = _parse_company_name(d.pop("companyName", UNSET))

        def _parse_company_domain(
            data: object,
        ) -> KitchenSinkBulkCompanyBodyCompaniesItemCompanyDomainType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(KitchenSinkBulkCompanyBodyCompaniesItemCompanyDomainType0 | None | Unset, data)

        company_domain = _parse_company_domain(d.pop("companyDomain", UNSET))

        def _parse_company_location(
            data: object,
        ) -> KitchenSinkBulkCompanyBodyCompaniesItemCompanyLocationType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                company_location_type_0 = KitchenSinkBulkCompanyBodyCompaniesItemCompanyLocationType0.from_dict(data)

                return company_location_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(KitchenSinkBulkCompanyBodyCompaniesItemCompanyLocationType0 | None | Unset, data)
