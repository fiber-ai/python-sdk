...
T = TypeVar("T", bound="KitchenSinkProfileResponse200OutputDataItemVolunteeringType0Item")


@_attrs_define
class KitchenSinkProfileResponse200OutputDataItemVolunteeringType0Item:
    """
    Attributes:
        role (None | str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        kitchen_sink_profile_response_200_output_data_item_volunteering_type_0_item = cls(
            role=role,
        ...
        kitchen_sink_profile_response_200_output_data_item_volunteering_type_0_item.additional_properties = d
        return kitchen_sink_profile_response_200_output_data_item_volunteering_type_0_item
