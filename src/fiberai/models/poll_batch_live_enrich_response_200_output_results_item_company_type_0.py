...
T = TypeVar("T", bound="PollBatchLiveEnrichResponse200OutputResultsItemCompanyType0")


@_attrs_define
class PollBatchLiveEnrichResponse200OutputResultsItemCompanyType0:
    ...
    Attributes:
        ...
        industries (list[PollBatchLiveEnrichResponse200OutputResultsItemCompanyType0IndustriesType0Item] | None |
            Unset):
        inferred_location (None | PollBatchLiveEnrichResponse200OutputResultsItemCompanyType0InferredLocationType0 |
            Unset):
        linkedin_url (None | str | Unset):
        locations (list[PollBatchLiveEnrichResponse200OutputResultsItemCompanyType0LocationsType0Item] | None | Unset):
        ...
        locations_stats (None | PollBatchLiveEnrichResponse200OutputResultsItemCompanyType0LocationsStatsType0 | Unset):
        logo_url (None | str | Unset):
        historical_headcount (None | PollBatchLiveEnrichResponse200OutputResultsItemCompanyType0HistoricalHeadcountType0
            | Unset):
    ...
    industries: list[PollBatchLiveEnrichResponse200OutputResultsItemCompanyType0IndustriesType0Item] | None | Unset = (
        UNSET
    )
    inferred_location: (
        None | PollBatchLiveEnrichResponse200OutputResultsItemCompanyType0InferredLocationType0 | Unset
    ) = UNSET
    ...
    historical_headcount: (
        None | PollBatchLiveEnrichResponse200OutputResultsItemCompanyType0HistoricalHeadcountType0 | Unset
    ) = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.inferred_location, Unset):
            ...
            self.inferred_location, PollBatchLiveEnrichResponse200OutputResultsItemCompanyType0InferredLocationType0
        ):
        ...
        if isinstance(self.locations_stats, Unset):
            ...
            self.locations_stats, PollBatchLiveEnrichResponse200OutputResultsItemCompanyType0LocationsStatsType0
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_industries(
            data: object,
        ) -> list[PollBatchLiveEnrichResponse200OutputResultsItemCompanyType0IndustriesType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for industries_type_0_item_data in _industries_type_0:
                    industries_type_0_item = (
                        PollBatchLiveEnrichResponse200OutputResultsItemCompanyType0IndustriesType0Item.from_dict(
        ...
        def _parse_inferred_location(
            ...
            try:
                ...
                inferred_location_type_0 = (
                    PollBatchLiveEnrichResponse200OutputResultsItemCompanyType0InferredLocationType0.from_dict(data)
                )
                ...
                pass
            return cast(
                None | PollBatchLiveEnrichResponse200OutputResultsItemCompanyType0InferredLocationType0 | Unset, data
            )
        ...
        def _parse_locations(
            data: object,
        ) -> list[PollBatchLiveEnrichResponse200OutputResultsItemCompanyType0LocationsType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for locations_type_0_item_data in _locations_type_0:
                    locations_type_0_item = (
                        PollBatchLiveEnrichResponse200OutputResultsItemCompanyType0LocationsType0Item.from_dict(
                ...
                pass
            return cast(
                list[PollBatchLiveEnrichResponse200OutputResultsItemCompanyType0LocationsType0Item] | None | Unset, data
            )
        ...
        def _parse_locations_stats(
            data: object,
        ) -> None | PollBatchLiveEnrichResponse200OutputResultsItemCompanyType0LocationsStatsType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                locations_stats_type_0 = (
                    PollBatchLiveEnrichResponse200OutputResultsItemCompanyType0LocationsStatsType0.from_dict(data)
                )
                ...
                pass
            return cast(
                None | PollBatchLiveEnrichResponse200OutputResultsItemCompanyType0LocationsStatsType0 | Unset, data
            )
        ...
        def _parse_historical_headcount(
            ...
            try:
                ...
                historical_headcount_type_0 = (
                    PollBatchLiveEnrichResponse200OutputResultsItemCompanyType0HistoricalHeadcountType0.from_dict(data)
                )
                ...
                pass
            return cast(
                None | PollBatchLiveEnrichResponse200OutputResultsItemCompanyType0HistoricalHeadcountType0 | Unset, data
            )
        ...
        poll_batch_live_enrich_response_200_output_results_item_company_type_0 = cls(
            slug=slug,
            headline=headline,
        ...
        poll_batch_live_enrich_response_200_output_results_item_company_type_0.additional_properties = d
        return poll_batch_live_enrich_response_200_output_results_item_company_type_0
