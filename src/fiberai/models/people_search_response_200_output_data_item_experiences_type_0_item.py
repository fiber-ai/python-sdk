...
from ..models.people_search_response_200_output_data_item_experiences_type_0_item_academic_qualification_type_0_item import (
    PeopleSearchResponse200OutputDataItemExperiencesType0ItemAcademicQualificationType0Item,
)
from ..models.people_search_response_200_output_data_item_experiences_type_0_item_employment_type_type_0_item import (
    PeopleSearchResponse200OutputDataItemExperiencesType0ItemEmploymentTypeType0Item,
)
from ..models.people_search_response_200_output_data_item_experiences_type_0_item_job_function_type_0_item import (
    PeopleSearchResponse200OutputDataItemExperiencesType0ItemJobFunctionType0Item,
)
from ..models.people_search_response_200_output_data_item_experiences_type_0_item_seniority_type_1 import (
    PeopleSearchResponse200OutputDataItemExperiencesType0ItemSeniorityType1,
)
from ..models.people_search_response_200_output_data_item_experiences_type_0_item_seniority_type_2_type_1 import (
    PeopleSearchResponse200OutputDataItemExperiencesType0ItemSeniorityType2Type1,
)
from ..models.people_search_response_200_output_data_item_experiences_type_0_item_seniority_type_3_type_1 import (
    PeopleSearchResponse200OutputDataItemExperiencesType0ItemSeniorityType3Type1,
)
...
class PeopleSearchResponse200OutputDataItemExperiencesType0Item:
    ...
    Attributes:
        ...
        seniority (None | PeopleSearchResponse200OutputDataItemExperiencesType0ItemSeniorityType1 |
            PeopleSearchResponse200OutputDataItemExperiencesType0ItemSeniorityType2Type1 |
            PeopleSearchResponse200OutputDataItemExperiencesType0ItemSeniorityType3Type1 | Unset):
        job_function (list[PeopleSearchResponse200OutputDataItemExperiencesType0ItemJobFunctionType0Item] | None |
            Unset):
        employment_type (list[PeopleSearchResponse200OutputDataItemExperiencesType0ItemEmploymentTypeType0Item] | None |
            Unset):
        academic_qualification
            (list[PeopleSearchResponse200OutputDataItemExperiencesType0ItemAcademicQualificationType0Item] | None | Unset):
    ...
    job_function: list[PeopleSearchResponse200OutputDataItemExperiencesType0ItemJobFunctionType0Item] | None | Unset = (
        UNSET
    )
    employment_type: (
        list[PeopleSearchResponse200OutputDataItemExperiencesType0ItemEmploymentTypeType0Item] | None | Unset
    ) = UNSET
    academic_qualification: (
        list[PeopleSearchResponse200OutputDataItemExperiencesType0ItemAcademicQualificationType0Item] | None | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_seniority(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                seniority_type_2_type_1 = PeopleSearchResponse200OutputDataItemExperiencesType0ItemSeniorityType2Type1(
                    data
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                seniority_type_3_type_1 = PeopleSearchResponse200OutputDataItemExperiencesType0ItemSeniorityType3Type1(
                    data
                )
        ...
        def _parse_job_function(
            data: object,
        ) -> list[PeopleSearchResponse200OutputDataItemExperiencesType0ItemJobFunctionType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(
                list[PeopleSearchResponse200OutputDataItemExperiencesType0ItemJobFunctionType0Item] | None | Unset, data
            )
