...
T = TypeVar("T", bound="CombinedSearchCountBodyCompanyParamsEmployeeTrendsV2Type0")


@_attrs_define
class CombinedSearchCountBodyCompanyParamsEmployeeTrendsV2Type0:
    """
    Attributes:
        obeys_all (list[CombinedSearchCountBodyCompanyParamsEmployeeTrendsV2Type0ObeysAllType0ItemType0 |
            CombinedSearchCountBodyCompanyParamsEmployeeTrendsV2Type0ObeysAllType0ItemType1] | None | Unset):
        obeys_any (list[CombinedSearchCountBodyCompanyParamsEmployeeTrendsV2Type0ObeysAnyType0ItemType0 |
            CombinedSearchCountBodyCompanyParamsEmployeeTrendsV2Type0ObeysAnyType0ItemType1] | None | Unset):
        obeys_none (list[CombinedSearchCountBodyCompanyParamsEmployeeTrendsV2Type0ObeysNoneType0ItemType0 |
            CombinedSearchCountBodyCompanyParamsEmployeeTrendsV2Type0ObeysNoneType0ItemType1] | None | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
                    ...
                    def _parse_obeys_all_type_0_item(
                        ...
                        try:
                            if not isinstance(data, dict):
                                raise TypeError()
                            obeys_all_type_0_item_type_0 = CombinedSearchCountBodyCompanyParamsEmployeeTrendsV2Type0ObeysAllType0ItemType0.from_dict(
                                data
                            )
                        ...
                        obeys_all_type_0_item_type_1 = (
                            CombinedSearchCountBodyCompanyParamsEmployeeTrendsV2Type0ObeysAllType0ItemType1.from_dict(
                                data
                            )
                        )
                ...
                for obeys_any_type_0_item_data in _obeys_any_type_0:
                    ...
                    def _parse_obeys_any_type_0_item(
                        ...
                        try:
                            if not isinstance(data, dict):
                                raise TypeError()
                            obeys_any_type_0_item_type_0 = CombinedSearchCountBodyCompanyParamsEmployeeTrendsV2Type0ObeysAnyType0ItemType0.from_dict(
                                data
                            )
                        ...
                        obeys_any_type_0_item_type_1 = (
                            CombinedSearchCountBodyCompanyParamsEmployeeTrendsV2Type0ObeysAnyType0ItemType1.from_dict(
                                data
                            )
                        )
                ...
                for obeys_none_type_0_item_data in _obeys_none_type_0:
                    ...
                    def _parse_obeys_none_type_0_item(
                        ...
                        try:
                            if not isinstance(data, dict):
                                raise TypeError()
                            obeys_none_type_0_item_type_0 = CombinedSearchCountBodyCompanyParamsEmployeeTrendsV2Type0ObeysNoneType0ItemType0.from_dict(
                                data
                            )
                        ...
                        obeys_none_type_0_item_type_1 = (
                            CombinedSearchCountBodyCompanyParamsEmployeeTrendsV2Type0ObeysNoneType0ItemType1.from_dict(
                                data
                            )
                        )
        ...
        combined_search_count_body_company_params_employee_trends_v2_type_0 = cls(
            obeys_all=obeys_all,
            obeys_any=obeys_any,
            obeys_none=obeys_none,
        )

        combined_search_count_body_company_params_employee_trends_v2_type_0.additional_properties = d
        return combined_search_count_body_company_params_employee_trends_v2_type_0
