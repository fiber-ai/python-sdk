...
T = TypeVar("T", bound="CombinedSearchBodyProfileParamsCertificationsType0AnyOfType0ItemKeywordsType0")


@_attrs_define
class CombinedSearchBodyProfileParamsCertificationsType0AnyOfType0ItemKeywordsType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        combined_search_body_profile_params_certifications_type_0_any_of_type_0_item_keywords_type_0 = cls(
            any_of=any_of,
            none_of=none_of,
        )

        combined_search_body_profile_params_certifications_type_0_any_of_type_0_item_keywords_type_0.additional_properties = d
        return combined_search_body_profile_params_certifications_type_0_any_of_type_0_item_keywords_type_0
