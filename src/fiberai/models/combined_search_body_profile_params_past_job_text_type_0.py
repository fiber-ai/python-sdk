...
from ..models.combined_search_body_profile_params_past_job_text_type_0_joiner import (
    CombinedSearchBodyProfileParamsPastJobTextType0Joiner,
)

if TYPE_CHECKING:
    from ..models.combined_search_body_profile_params_past_job_text_type_0_criteria_item import (
        CombinedSearchBodyProfileParamsPastJobTextType0CriteriaItem,
    )
