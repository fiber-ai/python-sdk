...
if TYPE_CHECKING:
    ...
    from ..models.sync_combined_search_body_profile_params_education_type_0_all_of_type_0_item_degree_v2_type_0 import (
        SyncCombinedSearchBodyProfileParamsEducationType0AllOfType0ItemDegreeV2Type0,
    )
    from ..models.sync_combined_search_body_profile_params_education_type_0_all_of_type_0_item_degree_v2_type_1 import (
        SyncCombinedSearchBodyProfileParamsEducationType0AllOfType0ItemDegreeV2Type1,
    )
    ...
    from ..models.sync_combined_search_body_profile_params_education_type_0_all_of_type_0_item_school_v2_type_0 import (
        SyncCombinedSearchBodyProfileParamsEducationType0AllOfType0ItemSchoolV2Type0,
    )
...
class SyncCombinedSearchBodyProfileParamsEducationType0AllOfType0Item:
    ...
    Attributes:
        ...
        school_v2 (None | SyncCombinedSearchBodyProfileParamsEducationType0AllOfType0ItemSchoolV2Type0 | Unset):
        ...
        degree_v2 (None | SyncCombinedSearchBodyProfileParamsEducationType0AllOfType0ItemDegreeV2Type0 |
            SyncCombinedSearchBodyProfileParamsEducationType0AllOfType0ItemDegreeV2Type1 | Unset):
    ...
    school_v2: None | SyncCombinedSearchBodyProfileParamsEducationType0AllOfType0ItemSchoolV2Type0 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.school_v2, Unset):
            school_v2 = UNSET
        elif isinstance(self.school_v2, SyncCombinedSearchBodyProfileParamsEducationType0AllOfType0ItemSchoolV2Type0):
        ...
        if isinstance(self.degree_v2, Unset):
            degree_v2 = UNSET
        elif isinstance(self.degree_v2, SyncCombinedSearchBodyProfileParamsEducationType0AllOfType0ItemDegreeV2Type0):
            degree_v2 = self.degree_v2.to_dict()
        elif isinstance(self.degree_v2, SyncCombinedSearchBodyProfileParamsEducationType0AllOfType0ItemDegreeV2Type1):
            degree_v2 = self.degree_v2.to_dict()
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_school_v2(
            data: object,
        ) -> None | SyncCombinedSearchBodyProfileParamsEducationType0AllOfType0ItemSchoolV2Type0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                school_v2_type_0 = (
                    SyncCombinedSearchBodyProfileParamsEducationType0AllOfType0ItemSchoolV2Type0.from_dict(data)
                )
                ...
                pass
            return cast(
                None | SyncCombinedSearchBodyProfileParamsEducationType0AllOfType0ItemSchoolV2Type0 | Unset, data
            )
        ...
        def _parse_degree_v2(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                degree_v2_type_0 = (
                    SyncCombinedSearchBodyProfileParamsEducationType0AllOfType0ItemDegreeV2Type0.from_dict(data)
                )
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                degree_v2_type_1 = (
                    SyncCombinedSearchBodyProfileParamsEducationType0AllOfType0ItemDegreeV2Type1.from_dict(data)
                )
