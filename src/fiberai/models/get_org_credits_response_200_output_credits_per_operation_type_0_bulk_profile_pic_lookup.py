...
if TYPE_CHECKING:
  from ..models.get_org_credits_response_200_output_credits_per_operation_type_0_bulk_profile_pic_lookup_levels_item import GetOrgCreditsResponse200OutputCreditsPerOperationType0BulkProfilePicLookupLevelsItem
...
class GetOrgCreditsResponse200OutputCreditsPerOperationType0BulkProfilePicLookup:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for levels_item_data in (_levels):
            levels_item = GetOrgCreditsResponse200OutputCreditsPerOperationType0BulkProfilePicLookupLevelsItem.from_dict(levels_item_data)
