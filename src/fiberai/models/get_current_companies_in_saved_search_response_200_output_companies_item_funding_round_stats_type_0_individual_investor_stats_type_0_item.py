...
T = TypeVar("T", bound="GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemFundingRoundStatsType0IndividualInvestorStatsType0Item")



@_attrs_define
class GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemFundingRoundStatsType0IndividualInvestorStatsType0Item:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_current_companies_in_saved_search_response_200_output_companies_item_funding_round_stats_type_0_individual_investor_stats_type_0_item = cls(
        ...
        get_current_companies_in_saved_search_response_200_output_companies_item_funding_round_stats_type_0_individual_investor_stats_type_0_item.additional_properties = d
        return get_current_companies_in_saved_search_response_200_output_companies_item_funding_round_stats_type_0_individual_investor_stats_type_0_item
