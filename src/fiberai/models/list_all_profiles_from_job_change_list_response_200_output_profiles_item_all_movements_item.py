...
from ..models.list_all_profiles_from_job_change_list_response_200_output_profiles_item_all_movements_item_movement import (
    ListAllProfilesFromJobChangeListResponse200OutputProfilesItemAllMovementsItemMovement,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ListAllProfilesFromJobChangeListResponse200OutputProfilesItemAllMovementsItem")


@_attrs_define
class ListAllProfilesFromJobChangeListResponse200OutputProfilesItemAllMovementsItem:
    """
    Attributes:
        discovered_at (str):
        movement (ListAllProfilesFromJobChangeListResponse200OutputProfilesItemAllMovementsItemMovement):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_all_profiles_from_job_change_list_response_200_output_profiles_item_all_movements_item = cls(
        ...
        list_all_profiles_from_job_change_list_response_200_output_profiles_item_all_movements_item.additional_properties = d
        return list_all_profiles_from_job_change_list_response_200_output_profiles_item_all_movements_item
