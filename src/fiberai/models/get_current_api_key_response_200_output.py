...
T = TypeVar("T", bound="GetCurrentApiKeyResponse200Output")


@_attrs_define
class GetCurrentApiKeyResponse200Output:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_current_api_key_response_200_output = cls(
            id=id,
            name=name,
            prefix=prefix,
        ...
        get_current_api_key_response_200_output.additional_properties = d
        return get_current_api_key_response_200_output
