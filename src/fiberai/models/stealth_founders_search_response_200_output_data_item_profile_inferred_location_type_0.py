...
if TYPE_CHECKING:
    from ..models.stealth_founders_search_response_200_output_data_item_profile_inferred_location_type_0_coordinates_type_0 import (
        StealthFoundersSearchResponse200OutputDataItemProfileInferredLocationType0CoordinatesType0,
    )


T = TypeVar("T", bound="StealthFoundersSearchResponse200OutputDataItemProfileInferredLocationType0")


@_attrs_define
class StealthFoundersSearchResponse200OutputDataItemProfileInferredLocationType0:
    """
    Attributes:
        ...
        coordinates (None | StealthFoundersSearchResponse200OutputDataItemProfileInferredLocationType0CoordinatesType0 |
            Unset):
    ...
    coordinates: (
        None | StealthFoundersSearchResponse200OutputDataItemProfileInferredLocationType0CoordinatesType0 | Unset
    ) = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.stealth_founders_search_response_200_output_data_item_profile_inferred_location_type_0_coordinates_type_0 import (
            StealthFoundersSearchResponse200OutputDataItemProfileInferredLocationType0CoordinatesType0,  # noqa: PLC0415
        )
        ...
        if isinstance(self.coordinates, Unset):
            ...
            self.coordinates, StealthFoundersSearchResponse200OutputDataItemProfileInferredLocationType0CoordinatesType0
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_coordinates(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = StealthFoundersSearchResponse200OutputDataItemProfileInferredLocationType0CoordinatesType0.from_dict(
                    data
                )
        ...
        stealth_founders_search_response_200_output_data_item_profile_inferred_location_type_0 = cls(
        ...
        stealth_founders_search_response_200_output_data_item_profile_inferred_location_type_0.additional_properties = d
        return stealth_founders_search_response_200_output_data_item_profile_inferred_location_type_0
