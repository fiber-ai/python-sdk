...
from ..models.text_to_combined_search_response_200_output_profile_search_params_type_0_time_zone_type_0_any_of_item_strategy_type_0_mode import TextToCombinedSearchResponse200OutputProfileSearchParamsType0TimeZoneType0AnyOfItemStrategyType0Mode
...
T = TypeVar("T", bound="TextToCombinedSearchResponse200OutputProfileSearchParamsType0TimeZoneType0AnyOfItemStrategyType0")
...
class TextToCombinedSearchResponse200OutputProfileSearchParamsType0TimeZoneType0AnyOfItemStrategyType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        mode = TextToCombinedSearchResponse200OutputProfileSearchParamsType0TimeZoneType0AnyOfItemStrategyType0Mode(d.pop("mode"))
