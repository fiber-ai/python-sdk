...
T = TypeVar("T", bound="GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyInvestorsType0Item")



@_attrs_define
class GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyInvestorsType0Item:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_saved_search_run_companies_response_200_output_companies_item_company_investors_type_0_item = cls(
            logo_url=logo_url,
        ...
        get_saved_search_run_companies_response_200_output_companies_item_company_investors_type_0_item.additional_properties = d
        return get_saved_search_run_companies_response_200_output_companies_item_company_investors_type_0_item
