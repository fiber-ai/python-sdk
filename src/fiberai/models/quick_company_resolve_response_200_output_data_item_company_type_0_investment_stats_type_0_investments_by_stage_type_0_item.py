...
T = TypeVar(
    "T", bound="QuickCompanyResolveResponse200OutputDataItemCompanyType0InvestmentStatsType0InvestmentsByStageType0Item"
)


@_attrs_define
class QuickCompanyResolveResponse200OutputDataItemCompanyType0InvestmentStatsType0InvestmentsByStageType0Item:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        quick_company_resolve_response_200_output_data_item_company_type_0_investment_stats_type_0_investments_by_stage_type_0_item = cls(
            stage=stage,
            lead_rate=lead_rate,
        ...
        quick_company_resolve_response_200_output_data_item_company_type_0_investment_stats_type_0_investments_by_stage_type_0_item.additional_properties = d
        return quick_company_resolve_response_200_output_data_item_company_type_0_investment_stats_type_0_investments_by_stage_type_0_item
