...
T = TypeVar("T", bound="CombinedSearchBodyProfileParamsEducationType0AnyOfType0ItemSchoolType0NoneOfType0Item")



@_attrs_define
class CombinedSearchBodyProfileParamsEducationType0AnyOfType0ItemSchoolType0NoneOfType0Item:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        combined_search_body_profile_params_education_type_0_any_of_type_0_item_school_type_0_none_of_type_0_item = cls(
        ...
        combined_search_body_profile_params_education_type_0_any_of_type_0_item_school_type_0_none_of_type_0_item.additional_properties = d
        return combined_search_body_profile_params_education_type_0_any_of_type_0_item_school_type_0_none_of_type_0_item
