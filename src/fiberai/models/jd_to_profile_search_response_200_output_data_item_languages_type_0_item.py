...
T = TypeVar("T", bound="JdToProfileSearchResponse200OutputDataItemLanguagesType0Item")


@_attrs_define
class JdToProfileSearchResponse200OutputDataItemLanguagesType0Item:
    """
    Attributes:
        name (None | str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        jd_to_profile_search_response_200_output_data_item_languages_type_0_item = cls(
            name=name,
            proficiency_id=proficiency_id,
            proficiency_name=proficiency_name,
        )

        jd_to_profile_search_response_200_output_data_item_languages_type_0_item.additional_properties = d
        return jd_to_profile_search_response_200_output_data_item_languages_type_0_item
