...
T = TypeVar("T", bound="SyncCombinedSearchBodyCompanyParamsTldsType0")



@_attrs_define
class SyncCombinedSearchBodyCompanyParamsTldsType0:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sync_combined_search_body_company_params_tlds_type_0 = cls(
            any_of=any_of,
            none_of=none_of,
        )


        sync_combined_search_body_company_params_tlds_type_0.additional_properties = d
        return sync_combined_search_body_company_params_tlds_type_0
