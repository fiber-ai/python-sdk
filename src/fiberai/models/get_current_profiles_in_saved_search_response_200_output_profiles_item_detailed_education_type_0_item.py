...
if TYPE_CHECKING:
    from ..models.get_current_profiles_in_saved_search_response_200_output_profiles_item_detailed_education_type_0_item_school_details_type_0 import (
        GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemDetailedEducationType0ItemSchoolDetailsType0,
    )
...
class GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemDetailedEducationType0Item:
    ...
    Attributes:
        school_details
            (GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemDetailedEducationType0ItemSchoolDetailsType0 | None
            | Unset):
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.get_current_profiles_in_saved_search_response_200_output_profiles_item_detailed_education_type_0_item_school_details_type_0 import (
            GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemDetailedEducationType0ItemSchoolDetailsType0,  # noqa: PLC0415
        )
        ...
        def _parse_school_details(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                school_details_type_0 = GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemDetailedEducationType0ItemSchoolDetailsType0.from_dict(
                    data
                )
