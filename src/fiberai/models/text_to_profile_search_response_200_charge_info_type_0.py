...
from ..models.text_to_profile_search_response_200_charge_info_type_0_method import (
    TextToProfileSearchResponse200ChargeInfoType0Method,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.text_to_profile_search_response_200_charge_info_type_0_low_credit_alert_type_0 import (
        TextToProfileSearchResponse200ChargeInfoType0LowCreditAlertType0,
    )
...
class TextToProfileSearchResponse200ChargeInfoType0:
    ...
    Attributes:
        ...
        low_credit_alert (None | TextToProfileSearchResponse200ChargeInfoType0LowCreditAlertType0 | Unset): Contains a
            link to get more credits, a warning message, and the remaining credit count.
    """

    method: TextToProfileSearchResponse200ChargeInfoType0Method
    credits_charged: float
    low_credit_alert: None | TextToProfileSearchResponse200ChargeInfoType0LowCreditAlertType0 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.low_credit_alert, TextToProfileSearchResponse200ChargeInfoType0LowCreditAlertType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_low_credit_alert(
            data: object,
        ) -> None | TextToProfileSearchResponse200ChargeInfoType0LowCreditAlertType0 | Unset:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                low_credit_alert_type_0 = TextToProfileSearchResponse200ChargeInfoType0LowCreditAlertType0.from_dict(
                    data
                )
                ...
                pass
            return cast(None | TextToProfileSearchResponse200ChargeInfoType0LowCreditAlertType0 | Unset, data)
