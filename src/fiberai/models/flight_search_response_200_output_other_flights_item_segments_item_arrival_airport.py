...
T = TypeVar("T", bound="FlightSearchResponse200OutputOtherFlightsItemSegmentsItemArrivalAirport")


@_attrs_define
class FlightSearchResponse200OutputOtherFlightsItemSegmentsItemArrivalAirport:
    """Arrival airport.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        flight_search_response_200_output_other_flights_item_segments_item_arrival_airport = cls(
            iata_code=iata_code,
            name=name,
            local_date_time=local_date_time,
        )

        flight_search_response_200_output_other_flights_item_segments_item_arrival_airport.additional_properties = d
        return flight_search_response_200_output_other_flights_item_segments_item_arrival_airport
