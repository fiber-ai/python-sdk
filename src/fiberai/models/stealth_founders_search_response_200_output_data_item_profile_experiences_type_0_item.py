...
from ..models.stealth_founders_search_response_200_output_data_item_profile_experiences_type_0_item_academic_qualification_type_0_item import (
    StealthFoundersSearchResponse200OutputDataItemProfileExperiencesType0ItemAcademicQualificationType0Item,
)
from ..models.stealth_founders_search_response_200_output_data_item_profile_experiences_type_0_item_employment_type_type_0_item import (
    StealthFoundersSearchResponse200OutputDataItemProfileExperiencesType0ItemEmploymentTypeType0Item,
)
from ..models.stealth_founders_search_response_200_output_data_item_profile_experiences_type_0_item_job_function_type_0_item import (
    StealthFoundersSearchResponse200OutputDataItemProfileExperiencesType0ItemJobFunctionType0Item,
)
from ..models.stealth_founders_search_response_200_output_data_item_profile_experiences_type_0_item_seniority_type_1 import (
    StealthFoundersSearchResponse200OutputDataItemProfileExperiencesType0ItemSeniorityType1,
)
from ..models.stealth_founders_search_response_200_output_data_item_profile_experiences_type_0_item_seniority_type_2_type_1 import (
    StealthFoundersSearchResponse200OutputDataItemProfileExperiencesType0ItemSeniorityType2Type1,
)
from ..models.stealth_founders_search_response_200_output_data_item_profile_experiences_type_0_item_seniority_type_3_type_1 import (
    StealthFoundersSearchResponse200OutputDataItemProfileExperiencesType0ItemSeniorityType3Type1,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="StealthFoundersSearchResponse200OutputDataItemProfileExperiencesType0Item")


@_attrs_define
class StealthFoundersSearchResponse200OutputDataItemProfileExperiencesType0Item:
    """
    Attributes:
        ...
        seniority (None | StealthFoundersSearchResponse200OutputDataItemProfileExperiencesType0ItemSeniorityType1 |
            StealthFoundersSearchResponse200OutputDataItemProfileExperiencesType0ItemSeniorityType2Type1 |
            StealthFoundersSearchResponse200OutputDataItemProfileExperiencesType0ItemSeniorityType3Type1 | Unset):
        job_function
            (list[StealthFoundersSearchResponse200OutputDataItemProfileExperiencesType0ItemJobFunctionType0Item] | None |
            Unset):
        employment_type
            (list[StealthFoundersSearchResponse200OutputDataItemProfileExperiencesType0ItemEmploymentTypeType0Item] | None |
            Unset):
        academic_qualification
            (list[StealthFoundersSearchResponse200OutputDataItemProfileExperiencesType0ItemAcademicQualificationType0Item] |
            None | Unset):
    ...
    job_function: (
        list[StealthFoundersSearchResponse200OutputDataItemProfileExperiencesType0ItemJobFunctionType0Item]
        | None
        | Unset
    ) = UNSET
    employment_type: (
        list[StealthFoundersSearchResponse200OutputDataItemProfileExperiencesType0ItemEmploymentTypeType0Item]
        | None
        | Unset
    ) = UNSET
    academic_qualification: (
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.seniority, Unset):
            ...
            self.seniority, StealthFoundersSearchResponse200OutputDataItemProfileExperiencesType0ItemSeniorityType1
        ):
            seniority = self.seniority.value
        elif isinstance(
            self.seniority, StealthFoundersSearchResponse200OutputDataItemProfileExperiencesType0ItemSeniorityType2Type1
        ):
            seniority = self.seniority.value
        elif isinstance(
            self.seniority, StealthFoundersSearchResponse200OutputDataItemProfileExperiencesType0ItemSeniorityType3Type1
        ):
            seniority = self.seniority.value
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_seniority(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                seniority_type_1 = (
                    StealthFoundersSearchResponse200OutputDataItemProfileExperiencesType0ItemSeniorityType1(data)
                )
            ...
            try:
                ...
                seniority_type_2_type_1 = (
                    StealthFoundersSearchResponse200OutputDataItemProfileExperiencesType0ItemSeniorityType2Type1(data)
                )
            ...
            try:
                ...
                seniority_type_3_type_1 = (
                    StealthFoundersSearchResponse200OutputDataItemProfileExperiencesType0ItemSeniorityType3Type1(data)
                )
        ...
        def _parse_employment_type(
            ...
            try:
                ...
                for employment_type_type_0_item_data in _employment_type_type_0:
                    employment_type_type_0_item = StealthFoundersSearchResponse200OutputDataItemProfileExperiencesType0ItemEmploymentTypeType0Item(
        ...
        def _parse_academic_qualification(
            ...
            try:
                ...
                for academic_qualification_type_0_item_data in _academic_qualification_type_0:
                    academic_qualification_type_0_item = StealthFoundersSearchResponse200OutputDataItemProfileExperiencesType0ItemAcademicQualificationType0Item(
        ...
        stealth_founders_search_response_200_output_data_item_profile_experiences_type_0_item = cls(
        ...
        stealth_founders_search_response_200_output_data_item_profile_experiences_type_0_item.additional_properties = d
        return stealth_founders_search_response_200_output_data_item_profile_experiences_type_0_item
