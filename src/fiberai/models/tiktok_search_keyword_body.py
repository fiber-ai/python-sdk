...
T = TypeVar("T", bound="TiktokSearchKeywordBody")


@_attrs_define
class TiktokSearchKeywordBody:
    """
    Attributes:
        api_key (str): Your Fiber API key
        query (str): Keyword or phrase to search for TikTok videos (e.g. 'fitness motivation').
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        tiktok_search_keyword_body = cls(
            api_key=api_key,
            query=query,
            next_page_token=next_page_token,
        )

        tiktok_search_keyword_body.additional_properties = d
        return tiktok_search_keyword_body
