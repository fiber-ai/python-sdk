...
class KitchenSinkBulkProfileResponse200:
    ...
    Attributes:
        ...
        charge_info (KitchenSinkBulkProfileResponse200ChargeInfoType0 | KitchenSinkBulkProfileResponse200ChargeInfoType1
            | KitchenSinkBulkProfileResponse200ChargeInfoType2 | KitchenSinkBulkProfileResponse200ChargeInfoType3 |
            KitchenSinkBulkProfileResponse200ChargeInfoType4):
        warnings (list[KitchenSinkBulkProfileResponse200WarningsType0Item] | None | Unset): Warnings about extraneous
            fields in request
    ...
    warnings: list[KitchenSinkBulkProfileResponse200WarningsType0Item] | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.charge_info, KitchenSinkBulkProfileResponse200ChargeInfoType0):
            ...
            charge_info = self.charge_info.to_dict()
        elif isinstance(self.charge_info, KitchenSinkBulkProfileResponse200ChargeInfoType3):
            charge_info = self.charge_info.to_dict()
        else:
            charge_info = self.charge_info.to_dict()
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_charge_info(
            ...
            if not isinstance(data, dict):
                raise TypeError()
            charge_info_type_4 = KitchenSinkBulkProfileResponse200ChargeInfoType4.from_dict(data)

            return charge_info_type_4

        charge_info = _parse_charge_info(d.pop("chargeInfo"))

        def _parse_warnings(data: object) -> list[KitchenSinkBulkProfileResponse200WarningsType0Item] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for warnings_type_0_item_data in _warnings_type_0:
                    warnings_type_0_item = KitchenSinkBulkProfileResponse200WarningsType0Item.from_dict(
                ...
                pass
            return cast(list[KitchenSinkBulkProfileResponse200WarningsType0Item] | None | Unset, data)
