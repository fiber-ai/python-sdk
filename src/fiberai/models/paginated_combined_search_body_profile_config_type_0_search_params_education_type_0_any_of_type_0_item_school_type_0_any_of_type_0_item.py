...
T = TypeVar(
    "T",
    bound="PaginatedCombinedSearchBodyProfileConfigType0SearchParamsEducationType0AnyOfType0ItemSchoolType0AnyOfType0Item",
)


@_attrs_define
class PaginatedCombinedSearchBodyProfileConfigType0SearchParamsEducationType0AnyOfType0ItemSchoolType0AnyOfType0Item:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        paginated_combined_search_body_profile_config_type_0_search_params_education_type_0_any_of_type_0_item_school_type_0_any_of_type_0_item = cls(
            linkedin_id=linkedin_id,
            linkedin_url=linkedin_url,
            domain=domain,
        )

        paginated_combined_search_body_profile_config_type_0_search_params_education_type_0_any_of_type_0_item_school_type_0_any_of_type_0_item.additional_properties = d
        return paginated_combined_search_body_profile_config_type_0_search_params_education_type_0_any_of_type_0_item_school_type_0_any_of_type_0_item
