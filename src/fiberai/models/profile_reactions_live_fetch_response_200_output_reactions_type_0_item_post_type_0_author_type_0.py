...
T = TypeVar("T", bound="ProfileReactionsLiveFetchResponse200OutputReactionsType0ItemPostType0AuthorType0")


@_attrs_define
class ProfileReactionsLiveFetchResponse200OutputReactionsType0ItemPostType0AuthorType0:
    """
    Attributes:
        name (None | str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        profile_reactions_live_fetch_response_200_output_reactions_type_0_item_post_type_0_author_type_0 = cls(
            name=name,
            linkedin_url=linkedin_url,
            entity_urn=entity_urn,
        )

        profile_reactions_live_fetch_response_200_output_reactions_type_0_item_post_type_0_author_type_0.additional_properties = d
        return profile_reactions_live_fetch_response_200_output_reactions_type_0_item_post_type_0_author_type_0
