...
T = TypeVar("T", bound="HotelPropertyResponse200OutputPropertyReviewsBreakdownItem")


@_attrs_define
class HotelPropertyResponse200OutputPropertyReviewsBreakdownItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        hotel_property_response_200_output_property_reviews_breakdown_item = cls(
            name=name,
        ...
        hotel_property_response_200_output_property_reviews_breakdown_item.additional_properties = d
        return hotel_property_response_200_output_property_reviews_breakdown_item
