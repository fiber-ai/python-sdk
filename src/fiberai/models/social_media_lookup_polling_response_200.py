...
if TYPE_CHECKING:
    from ..models.social_media_lookup_polling_response_200_charge_info_type_0 import (
        SocialMediaLookupPollingResponse200ChargeInfoType0,
    )
    from ..models.social_media_lookup_polling_response_200_charge_info_type_1 import (
...
T = TypeVar("T", bound="SocialMediaLookupPollingResponse200")


@_attrs_define
class SocialMediaLookupPollingResponse200:
    """
    Attributes:
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.social_media_lookup_polling_response_200_charge_info_type_0 import (
            SocialMediaLookupPollingResponse200ChargeInfoType0,  # noqa: PLC0415
        )
        from ..models.social_media_lookup_polling_response_200_charge_info_type_1 import (
            SocialMediaLookupPollingResponse200ChargeInfoType1,  # noqa: PLC0415
        )
        from ..models.social_media_lookup_polling_response_200_charge_info_type_2 import (
            SocialMediaLookupPollingResponse200ChargeInfoType2,  # noqa: PLC0415
        )
        from ..models.social_media_lookup_polling_response_200_charge_info_type_3 import (
            SocialMediaLookupPollingResponse200ChargeInfoType3,  # noqa: PLC0415
        )

        output = self.output.to_dict()

        charge_info: dict[str, Any]
        if isinstance(self.charge_info, SocialMediaLookupPollingResponse200ChargeInfoType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        output = SocialMediaLookupPollingResponse200Output.from_dict(d.pop("output"))
        ...
        def _parse_charge_info(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_0 = SocialMediaLookupPollingResponse200ChargeInfoType0.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_1 = SocialMediaLookupPollingResponse200ChargeInfoType1.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_2 = SocialMediaLookupPollingResponse200ChargeInfoType2.from_dict(data)
        ...
        def _parse_warnings(data: object) -> list[SocialMediaLookupPollingResponse200WarningsType0Item] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for warnings_type_0_item_data in _warnings_type_0:
                    warnings_type_0_item = SocialMediaLookupPollingResponse200WarningsType0Item.from_dict(
                ...
                pass
            return cast(list[SocialMediaLookupPollingResponse200WarningsType0Item] | None | Unset, data)
        ...
        social_media_lookup_polling_response_200 = cls(
            output=output,
        ...
        return social_media_lookup_polling_response_200
