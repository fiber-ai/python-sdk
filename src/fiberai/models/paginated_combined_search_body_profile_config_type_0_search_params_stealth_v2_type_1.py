...
from ..models.paginated_combined_search_body_profile_config_type_0_search_params_stealth_v2_type_1_status import (
    PaginatedCombinedSearchBodyProfileConfigType0SearchParamsStealthV2Type1Status,
)
...
T = TypeVar("T", bound="PaginatedCombinedSearchBodyProfileConfigType0SearchParamsStealthV2Type1")


@_attrs_define
class PaginatedCombinedSearchBodyProfileConfigType0SearchParamsStealthV2Type1:
    """
    Attributes:
        status (PaginatedCombinedSearchBodyProfileConfigType0SearchParamsStealthV2Type1Status):
        left_stealth_at (None |
            PaginatedCombinedSearchBodyProfileConfigType0SearchParamsStealthV2Type1LeftStealthAtType0 |
            PaginatedCombinedSearchBodyProfileConfigType0SearchParamsStealthV2Type1LeftStealthAtType1 | Unset):
        entered_stealth_at (None |
            PaginatedCombinedSearchBodyProfileConfigType0SearchParamsStealthV2Type1EnteredStealthAtType0 |
            PaginatedCombinedSearchBodyProfileConfigType0SearchParamsStealthV2Type1EnteredStealthAtType1 | Unset):
        stealth_duration (None |
            PaginatedCombinedSearchBodyProfileConfigType0SearchParamsStealthV2Type1StealthDurationType0 | Unset):
    """
    ...
    stealth_duration: (
        None | PaginatedCombinedSearchBodyProfileConfigType0SearchParamsStealthV2Type1StealthDurationType0 | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        status = PaginatedCombinedSearchBodyProfileConfigType0SearchParamsStealthV2Type1Status(d.pop("status"))
        ...
        def _parse_left_stealth_at(
            ...
            try:
                ...
                left_stealth_at_type_0 = (
                    PaginatedCombinedSearchBodyProfileConfigType0SearchParamsStealthV2Type1LeftStealthAtType0.from_dict(
                        data
                    )
                )
            ...
            try:
                ...
                left_stealth_at_type_1 = (
                    PaginatedCombinedSearchBodyProfileConfigType0SearchParamsStealthV2Type1LeftStealthAtType1.from_dict(
                        data
                    )
                )
        ...
        def _parse_entered_stealth_at(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                entered_stealth_at_type_0 = PaginatedCombinedSearchBodyProfileConfigType0SearchParamsStealthV2Type1EnteredStealthAtType0.from_dict(
                    data
                )
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                entered_stealth_at_type_1 = PaginatedCombinedSearchBodyProfileConfigType0SearchParamsStealthV2Type1EnteredStealthAtType1.from_dict(
                    data
                )
        ...
        def _parse_stealth_duration(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                stealth_duration_type_0 = PaginatedCombinedSearchBodyProfileConfigType0SearchParamsStealthV2Type1StealthDurationType0.from_dict(
                    data
                )
        ...
        paginated_combined_search_body_profile_config_type_0_search_params_stealth_v2_type_1 = cls(
            status=status,
        ...
        paginated_combined_search_body_profile_config_type_0_search_params_stealth_v2_type_1.additional_properties = d
        return paginated_combined_search_body_profile_config_type_0_search_params_stealth_v2_type_1
