...
T = TypeVar("T", bound="PersonPostedWithKeyword")


@_attrs_define
class PersonPostedWithKeyword:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        type_ = cast(Literal["person_posted_with_keyword"], d.pop("type"))
        if type_ != "person_posted_with_keyword":
            raise ValueError(f"type must match const 'person_posted_with_keyword', got '{type_}'")
        ...
        return person_posted_with_keyword
