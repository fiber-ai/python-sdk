...
T = TypeVar("T", bound="ReversePhoneLookupResponse200OutputResultsItemType0ProfileEducationType0Item")


@_attrs_define
class ReversePhoneLookupResponse200OutputResultsItemType0ProfileEducationType0Item:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reverse_phone_lookup_response_200_output_results_item_type_0_profile_education_type_0_item = cls(
            school_id=school_id,
        ...
        reverse_phone_lookup_response_200_output_results_item_type_0_profile_education_type_0_item.additional_properties = d
        return reverse_phone_lookup_response_200_output_results_item_type_0_profile_education_type_0_item
