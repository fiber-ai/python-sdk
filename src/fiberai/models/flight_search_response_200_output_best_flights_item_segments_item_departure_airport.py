...
T = TypeVar("T", bound="FlightSearchResponse200OutputBestFlightsItemSegmentsItemDepartureAirport")


@_attrs_define
class FlightSearchResponse200OutputBestFlightsItemSegmentsItemDepartureAirport:
    """Departure airport.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        flight_search_response_200_output_best_flights_item_segments_item_departure_airport = cls(
            iata_code=iata_code,
            name=name,
            local_date_time=local_date_time,
        )

        flight_search_response_200_output_best_flights_item_segments_item_departure_airport.additional_properties = d
        return flight_search_response_200_output_best_flights_item_segments_item_departure_airport
