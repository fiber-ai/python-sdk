...
T = TypeVar("T", bound="QuickCompanyResolveResponse200OutputDataItemCompanyType0LocationsStatsType0")


@_attrs_define
class QuickCompanyResolveResponse200OutputDataItemCompanyType0LocationsStatsType0:
    """
    Attributes:
        usa (float | Unset):
        gbr (float | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        quick_company_resolve_response_200_output_data_item_company_type_0_locations_stats_type_0 = cls(
            usa=usa,
            gbr=gbr,
            fra=fra,
            ind=ind,
        ...
        return quick_company_resolve_response_200_output_data_item_company_type_0_locations_stats_type_0
