...
T = TypeVar("T", bound="ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileDetailedEducationType0ItemSchoolDetailsType0")



@_attrs_define
class ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileDetailedEducationType0ItemSchoolDetailsType0:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        profile_live_enrich_response_200_profile_found_and_enriched_profile_detailed_education_type_0_item_school_details_type_0 = cls(
        ...
        profile_live_enrich_response_200_profile_found_and_enriched_profile_detailed_education_type_0_item_school_details_type_0.additional_properties = d
        return profile_live_enrich_response_200_profile_found_and_enriched_profile_detailed_education_type_0_item_school_details_type_0
