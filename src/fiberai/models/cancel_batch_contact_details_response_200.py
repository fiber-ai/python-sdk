...
T = TypeVar("T", bound="CancelBatchContactDetailsResponse200")


@_attrs_define
class CancelBatchContactDetailsResponse200:
    """
    Attributes:
        output (CancelBatchContactDetailsResponse200Output):
        charge_info (CancelBatchContactDetailsResponse200ChargeInfoType0 |
            CancelBatchContactDetailsResponse200ChargeInfoType1 | CancelBatchContactDetailsResponse200ChargeInfoType2 |
            CancelBatchContactDetailsResponse200ChargeInfoType3 | CancelBatchContactDetailsResponse200ChargeInfoType4):
        warnings (list[CancelBatchContactDetailsResponse200WarningsType0Item] | None | Unset): Warnings about extraneous
            fields in request
    ...
    warnings: list[CancelBatchContactDetailsResponse200WarningsType0Item] | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.charge_info, CancelBatchContactDetailsResponse200ChargeInfoType0):
            charge_info = self.charge_info.to_dict()
        elif isinstance(self.charge_info, CancelBatchContactDetailsResponse200ChargeInfoType1):
            charge_info = self.charge_info.to_dict()
        elif isinstance(self.charge_info, CancelBatchContactDetailsResponse200ChargeInfoType2):
            charge_info = self.charge_info.to_dict()
        elif isinstance(self.charge_info, CancelBatchContactDetailsResponse200ChargeInfoType3):
            charge_info = self.charge_info.to_dict()
        else:
            charge_info = self.charge_info.to_dict()
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        output = CancelBatchContactDetailsResponse200Output.from_dict(d.pop("output"))
        ...
        def _parse_charge_info(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_0 = CancelBatchContactDetailsResponse200ChargeInfoType0.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_1 = CancelBatchContactDetailsResponse200ChargeInfoType1.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_2 = CancelBatchContactDetailsResponse200ChargeInfoType2.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_3 = CancelBatchContactDetailsResponse200ChargeInfoType3.from_dict(data)
            ...
            if not isinstance(data, dict):
                raise TypeError()
            charge_info_type_4 = CancelBatchContactDetailsResponse200ChargeInfoType4.from_dict(data)

            return charge_info_type_4

        charge_info = _parse_charge_info(d.pop("chargeInfo"))

        def _parse_warnings(data: object) -> list[CancelBatchContactDetailsResponse200WarningsType0Item] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for warnings_type_0_item_data in _warnings_type_0:
                    warnings_type_0_item = CancelBatchContactDetailsResponse200WarningsType0Item.from_dict(
                ...
                pass
            return cast(list[CancelBatchContactDetailsResponse200WarningsType0Item] | None | Unset, data)
        ...
        cancel_batch_contact_details_response_200 = cls(
            output=output,
        ...
        return cancel_batch_contact_details_response_200
