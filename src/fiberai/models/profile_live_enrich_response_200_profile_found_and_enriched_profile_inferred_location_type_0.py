...
class ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileInferredLocationType0:
    ...
    Attributes:
        ...
        coordinates (None |
            ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileInferredLocationType0CoordinatesType0 | Unset):
    ...
    coordinates: (
        None | ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileInferredLocationType0CoordinatesType0 | Unset
    ) = UNSET
        ...
        def _parse_coordinates(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileInferredLocationType0CoordinatesType0.from_dict(
                    data
                )
