...
if TYPE_CHECKING:
  from ..models.profile_live_enrich_response_200_profile_found_and_enriched_profile_inferred_location_type_0_coordinates_type_0 import ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileInferredLocationType0CoordinatesType0





T = TypeVar("T", bound="ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileInferredLocationType0")



@_attrs_define
class ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileInferredLocationType0:
    """ 
        Attributes:
            ...
            coordinates
                (Union['ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileInferredLocationType0CoordinatesType0', None,
                Unset]):
    ...
    coordinates: Union['ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileInferredLocationType0CoordinatesType0', None, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.coordinates, Unset):
            coordinates = UNSET
        elif isinstance(self.coordinates, ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileInferredLocationType0CoordinatesType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_coordinates(data: object) -> Union['ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileInferredLocationType0CoordinatesType0', None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileInferredLocationType0CoordinatesType0.from_dict(data)
                ...
                pass
            return cast(Union['ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileInferredLocationType0CoordinatesType0', None, Unset], data)
        ...
        profile_live_enrich_response_200_profile_found_and_enriched_profile_inferred_location_type_0 = cls(
        ...
        profile_live_enrich_response_200_profile_found_and_enriched_profile_inferred_location_type_0.additional_properties = d
        return profile_live_enrich_response_200_profile_found_and_enriched_profile_inferred_location_type_0
