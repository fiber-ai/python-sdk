...
if TYPE_CHECKING:
    from ..models.kitchen_sink_bulk_company_response_200_output_data_item_item_location_consensus_type_0_coordinates_type_0 import (
        KitchenSinkBulkCompanyResponse200OutputDataItemItemLocationConsensusType0CoordinatesType0,
    )
...
class KitchenSinkBulkCompanyResponse200OutputDataItemItemLocationConsensusType0:
    ...
    Attributes:
        ...
        coordinates (KitchenSinkBulkCompanyResponse200OutputDataItemItemLocationConsensusType0CoordinatesType0 | None |
            Unset):
    ...
    coordinates: (
        KitchenSinkBulkCompanyResponse200OutputDataItemItemLocationConsensusType0CoordinatesType0 | None | Unset
    ) = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.kitchen_sink_bulk_company_response_200_output_data_item_item_location_consensus_type_0_coordinates_type_0 import (
            KitchenSinkBulkCompanyResponse200OutputDataItemItemLocationConsensusType0CoordinatesType0,  # noqa: PLC0415
        )
        ...
        if isinstance(self.coordinates, Unset):
            ...
            self.coordinates, KitchenSinkBulkCompanyResponse200OutputDataItemItemLocationConsensusType0CoordinatesType0
        ):
        ...
        def _parse_coordinates(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = (
                    KitchenSinkBulkCompanyResponse200OutputDataItemItemLocationConsensusType0CoordinatesType0.from_dict(
                        data
                    )
                )
