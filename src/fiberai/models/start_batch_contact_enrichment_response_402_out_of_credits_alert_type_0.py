...
T = TypeVar("T", bound="StartBatchContactEnrichmentResponse402OutOfCreditsAlertType0")


@_attrs_define
class StartBatchContactEnrichmentResponse402OutOfCreditsAlertType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        start_batch_contact_enrichment_response_402_out_of_credits_alert_type_0 = cls(
            get_more_credits_url=get_more_credits_url,
            message=message,
            available_credits=available_credits,
        )

        start_batch_contact_enrichment_response_402_out_of_credits_alert_type_0.additional_properties = d
        return start_batch_contact_enrichment_response_402_out_of_credits_alert_type_0
