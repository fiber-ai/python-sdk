...
class InvestorSearchResponse200:
    """ 
        Attributes:
            ...
            charge_info (Union['InvestorSearchResponse200ChargeInfoType0', 'InvestorSearchResponse200ChargeInfoType1',
                'InvestorSearchResponse200ChargeInfoType2', 'InvestorSearchResponse200ChargeInfoType3']):
            warnings (Union[None, Unset, list['InvestorSearchResponse200WarningsType0Item']]): Warnings about extraneous
                fields in request
     """

    output: 'InvestorSearchResponse200Output'
    charge_info: Union['InvestorSearchResponse200ChargeInfoType0', 'InvestorSearchResponse200ChargeInfoType1', 'InvestorSearchResponse200ChargeInfoType2', 'InvestorSearchResponse200ChargeInfoType3']
    warnings: Union[None, Unset, list['InvestorSearchResponse200WarningsType0Item']] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_charge_info(data: object) -> Union['InvestorSearchResponse200ChargeInfoType0', 'InvestorSearchResponse200ChargeInfoType1', 'InvestorSearchResponse200ChargeInfoType2', 'InvestorSearchResponse200ChargeInfoType3']:
            try:
        ...
        def _parse_warnings(data: object) -> Union[None, Unset, list['InvestorSearchResponse200WarningsType0Item']]:
            if data is None:
                return data
            ...
            try:
                ...
                for warnings_type_0_item_data in (_warnings_type_0):
                    warnings_type_0_item = InvestorSearchResponse200WarningsType0Item.from_dict(warnings_type_0_item_data)
                ...
                pass
            return cast(Union[None, Unset, list['InvestorSearchResponse200WarningsType0Item']], data)
