...
T = TypeVar("T", bound="PollBatchLiveEnrichResponse200OutputResultsItemProfileType0VolunteeringType0Item")


@_attrs_define
class PollBatchLiveEnrichResponse200OutputResultsItemProfileType0VolunteeringType0Item:
    """
    Attributes:
        role (None | str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        poll_batch_live_enrich_response_200_output_results_item_profile_type_0_volunteering_type_0_item = cls(
            role=role,
        ...
        poll_batch_live_enrich_response_200_output_results_item_profile_type_0_volunteering_type_0_item.additional_properties = d
        return poll_batch_live_enrich_response_200_output_results_item_profile_type_0_volunteering_type_0_item
