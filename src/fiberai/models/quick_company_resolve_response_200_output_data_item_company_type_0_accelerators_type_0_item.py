...
if TYPE_CHECKING:
    from ..models.quick_company_resolve_response_200_output_data_item_company_type_0_accelerators_type_0_item_founders_type_0_item import (
        QuickCompanyResolveResponse200OutputDataItemCompanyType0AcceleratorsType0ItemFoundersType0Item,
    )


T = TypeVar("T", bound="QuickCompanyResolveResponse200OutputDataItemCompanyType0AcceleratorsType0Item")


@_attrs_define
class QuickCompanyResolveResponse200OutputDataItemCompanyType0AcceleratorsType0Item:
    """
    Attributes:
        id (None | str | Unset):
        slug (None | str | Unset):
        ...
        founders (list[QuickCompanyResolveResponse200OutputDataItemCompanyType0AcceleratorsType0ItemFoundersType0Item] |
            None | Unset):
    ...
    founders: (
        list[QuickCompanyResolveResponse200OutputDataItemCompanyType0AcceleratorsType0ItemFoundersType0Item]
        | None
        | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.quick_company_resolve_response_200_output_data_item_company_type_0_accelerators_type_0_item_founders_type_0_item import (
            QuickCompanyResolveResponse200OutputDataItemCompanyType0AcceleratorsType0ItemFoundersType0Item,  # noqa: PLC0415
        )
        ...
        def _parse_founders(
            ...
            try:
                ...
                for founders_type_0_item_data in _founders_type_0:
                    founders_type_0_item = QuickCompanyResolveResponse200OutputDataItemCompanyType0AcceleratorsType0ItemFoundersType0Item.from_dict(
        ...
        quick_company_resolve_response_200_output_data_item_company_type_0_accelerators_type_0_item = cls(
            id=id,
            slug=slug,
            tags=tags,
            year=year,
        ...
        quick_company_resolve_response_200_output_data_item_company_type_0_accelerators_type_0_item.additional_properties = d
        return quick_company_resolve_response_200_output_data_item_company_type_0_accelerators_type_0_item
