...
T = TypeVar("T", bound="SocialMediaLookupTriggerResponse200")


@_attrs_define
class SocialMediaLookupTriggerResponse200:
    """
    Attributes:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.charge_info, SocialMediaLookupTriggerResponse200ChargeInfoType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        output = SocialMediaLookupTriggerResponse200Output.from_dict(d.pop("output"))
        ...
        def _parse_charge_info(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_0 = SocialMediaLookupTriggerResponse200ChargeInfoType0.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_1 = SocialMediaLookupTriggerResponse200ChargeInfoType1.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_2 = SocialMediaLookupTriggerResponse200ChargeInfoType2.from_dict(data)
        ...
        def _parse_warnings(data: object) -> list[SocialMediaLookupTriggerResponse200WarningsType0Item] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for warnings_type_0_item_data in _warnings_type_0:
                    warnings_type_0_item = SocialMediaLookupTriggerResponse200WarningsType0Item.from_dict(
                ...
                pass
            return cast(list[SocialMediaLookupTriggerResponse200WarningsType0Item] | None | Unset, data)
        ...
        social_media_lookup_trigger_response_200 = cls(
            output=output,
        ...
        return social_media_lookup_trigger_response_200
