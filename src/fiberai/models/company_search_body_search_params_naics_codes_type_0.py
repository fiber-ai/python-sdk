...
class CompanySearchBodySearchParamsNaicsCodesType0:
    """
    Attributes:
        any_of (list[CompanySearchBodySearchParamsNaicsCodesType0AnyOfType0Item] | None | Unset):
        all_of (list[CompanySearchBodySearchParamsNaicsCodesType0AllOfType0Item] | None | Unset):
        none_of (list[CompanySearchBodySearchParamsNaicsCodesType0NoneOfType0Item] | None | Unset):
    """

    any_of: list[CompanySearchBodySearchParamsNaicsCodesType0AnyOfType0Item] | None | Unset = UNSET
    all_of: list[CompanySearchBodySearchParamsNaicsCodesType0AllOfType0Item] | None | Unset = UNSET
    none_of: list[CompanySearchBodySearchParamsNaicsCodesType0NoneOfType0Item] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_any_of(
            data: object,
        ) -> list[CompanySearchBodySearchParamsNaicsCodesType0AnyOfType0Item] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for any_of_type_0_item_data in _any_of_type_0:
                    any_of_type_0_item = CompanySearchBodySearchParamsNaicsCodesType0AnyOfType0Item.from_dict(
                ...
                pass
            return cast(list[CompanySearchBodySearchParamsNaicsCodesType0AnyOfType0Item] | None | Unset, data)

        any_of = _parse_any_of(d.pop("anyOf", UNSET))

        def _parse_all_of(
            data: object,
        ) -> list[CompanySearchBodySearchParamsNaicsCodesType0AllOfType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for all_of_type_0_item_data in _all_of_type_0:
                    all_of_type_0_item = CompanySearchBodySearchParamsNaicsCodesType0AllOfType0Item.from_dict(
                ...
                pass
            return cast(list[CompanySearchBodySearchParamsNaicsCodesType0AllOfType0Item] | None | Unset, data)

        all_of = _parse_all_of(d.pop("allOf", UNSET))

        def _parse_none_of(
            data: object,
        ) -> list[CompanySearchBodySearchParamsNaicsCodesType0NoneOfType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for none_of_type_0_item_data in _none_of_type_0:
                    none_of_type_0_item = CompanySearchBodySearchParamsNaicsCodesType0NoneOfType0Item.from_dict(
                ...
                pass
            return cast(list[CompanySearchBodySearchParamsNaicsCodesType0NoneOfType0Item] | None | Unset, data)
