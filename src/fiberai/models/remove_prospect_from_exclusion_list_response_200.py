...
class RemoveProspectFromExclusionListResponse200:
    ...
    Attributes:
        ...
        charge_info (RemoveProspectFromExclusionListResponse200ChargeInfoType0 |
            RemoveProspectFromExclusionListResponse200ChargeInfoType1 |
            RemoveProspectFromExclusionListResponse200ChargeInfoType2 |
            RemoveProspectFromExclusionListResponse200ChargeInfoType3 |
            RemoveProspectFromExclusionListResponse200ChargeInfoType4):
        warnings (list[RemoveProspectFromExclusionListResponse200WarningsType0Item] | None | Unset): Warnings about
    ...
    warnings: list[RemoveProspectFromExclusionListResponse200WarningsType0Item] | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.charge_info, RemoveProspectFromExclusionListResponse200ChargeInfoType0):
            ...
            charge_info = self.charge_info.to_dict()
        elif isinstance(self.charge_info, RemoveProspectFromExclusionListResponse200ChargeInfoType3):
            charge_info = self.charge_info.to_dict()
        else:
            charge_info = self.charge_info.to_dict()
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_charge_info(
            ...
            if not isinstance(data, dict):
                raise TypeError()
            charge_info_type_4 = RemoveProspectFromExclusionListResponse200ChargeInfoType4.from_dict(data)
        ...
        def _parse_warnings(
            data: object,
        ) -> list[RemoveProspectFromExclusionListResponse200WarningsType0Item] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for warnings_type_0_item_data in _warnings_type_0:
                    warnings_type_0_item = RemoveProspectFromExclusionListResponse200WarningsType0Item.from_dict(
                ...
                pass
            return cast(list[RemoveProspectFromExclusionListResponse200WarningsType0Item] | None | Unset, data)
