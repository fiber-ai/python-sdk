...
T = TypeVar("T", bound="BulkProfilePicResponse200")


@_attrs_define
class BulkProfilePicResponse200:
    """
    Attributes:
    ...
    output: BulkProfilePicResponse200Output
    charge_info: (
        BulkProfilePicResponse200ChargeInfoType0
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.bulk_profile_pic_response_200_charge_info_type_0 import (
            BulkProfilePicResponse200ChargeInfoType0,  # noqa: PLC0415
        )
        from ..models.bulk_profile_pic_response_200_charge_info_type_1 import (
            BulkProfilePicResponse200ChargeInfoType1,  # noqa: PLC0415
        )
        from ..models.bulk_profile_pic_response_200_charge_info_type_2 import (
            BulkProfilePicResponse200ChargeInfoType2,  # noqa: PLC0415
        )
        from ..models.bulk_profile_pic_response_200_charge_info_type_3 import (
            BulkProfilePicResponse200ChargeInfoType3,  # noqa: PLC0415
        )

        output = self.output.to_dict()

        charge_info: dict[str, Any]
        if isinstance(self.charge_info, BulkProfilePicResponse200ChargeInfoType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.bulk_profile_pic_response_200_charge_info_type_4 import (
            BulkProfilePicResponse200ChargeInfoType4,  # noqa: PLC0415
        )
        from ..models.bulk_profile_pic_response_200_output import BulkProfilePicResponse200Output  # noqa: PLC0415
        from ..models.bulk_profile_pic_response_200_warnings_type_0_item import (
            BulkProfilePicResponse200WarningsType0Item,  # noqa: PLC0415
        )

        d = dict(src_dict)
        output = BulkProfilePicResponse200Output.from_dict(d.pop("output"))
        ...
        def _parse_charge_info(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_0 = BulkProfilePicResponse200ChargeInfoType0.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_1 = BulkProfilePicResponse200ChargeInfoType1.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_2 = BulkProfilePicResponse200ChargeInfoType2.from_dict(data)
        ...
        def _parse_warnings(data: object) -> list[BulkProfilePicResponse200WarningsType0Item] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for warnings_type_0_item_data in _warnings_type_0:
                    warnings_type_0_item = BulkProfilePicResponse200WarningsType0Item.from_dict(
                ...
                pass
            return cast(list[BulkProfilePicResponse200WarningsType0Item] | None | Unset, data)
        ...
        bulk_profile_pic_response_200 = cls(
            output=output,
        ...
        return bulk_profile_pic_response_200
