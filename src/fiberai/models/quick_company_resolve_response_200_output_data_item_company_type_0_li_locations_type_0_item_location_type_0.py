...
if TYPE_CHECKING:
    from ..models.quick_company_resolve_response_200_output_data_item_company_type_0_li_locations_type_0_item_location_type_0_coordinates_type_0 import (
        QuickCompanyResolveResponse200OutputDataItemCompanyType0LiLocationsType0ItemLocationType0CoordinatesType0,
    )


T = TypeVar("T", bound="QuickCompanyResolveResponse200OutputDataItemCompanyType0LiLocationsType0ItemLocationType0")


@_attrs_define
class QuickCompanyResolveResponse200OutputDataItemCompanyType0LiLocationsType0ItemLocationType0:
    """
    Attributes:
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.quick_company_resolve_response_200_output_data_item_company_type_0_li_locations_type_0_item_location_type_0_coordinates_type_0 import (
            QuickCompanyResolveResponse200OutputDataItemCompanyType0LiLocationsType0ItemLocationType0CoordinatesType0,  # noqa: PLC0415
        )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_coordinates(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = QuickCompanyResolveResponse200OutputDataItemCompanyType0LiLocationsType0ItemLocationType0CoordinatesType0.from_dict(
                    data
                )
        ...
        quick_company_resolve_response_200_output_data_item_company_type_0_li_locations_type_0_item_location_type_0 = (
            cls(
        ...
        quick_company_resolve_response_200_output_data_item_company_type_0_li_locations_type_0_item_location_type_0.additional_properties = d
        return (
            quick_company_resolve_response_200_output_data_item_company_type_0_li_locations_type_0_item_location_type_0
        )
