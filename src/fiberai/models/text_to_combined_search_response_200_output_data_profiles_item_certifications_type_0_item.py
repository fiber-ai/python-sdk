...
T = TypeVar("T", bound="TextToCombinedSearchResponse200OutputDataProfilesItemCertificationsType0Item")


@_attrs_define
class TextToCombinedSearchResponse200OutputDataProfilesItemCertificationsType0Item:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        text_to_combined_search_response_200_output_data_profiles_item_certifications_type_0_item = cls(
            title=title,
        ...
        text_to_combined_search_response_200_output_data_profiles_item_certifications_type_0_item.additional_properties = d
        return text_to_combined_search_response_200_output_data_profiles_item_certifications_type_0_item
