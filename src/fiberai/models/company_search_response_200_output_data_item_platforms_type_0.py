...
T = TypeVar("T", bound="CompanySearchResponse200OutputDataItemPlatformsType0")


@_attrs_define
class CompanySearchResponse200OutputDataItemPlatformsType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        company_search_response_200_output_data_item_platforms_type_0 = cls(
            ecommerce=ecommerce,
            cms=cms,
            crm=crm,
            marketing=marketing,
        ...
        company_search_response_200_output_data_item_platforms_type_0.additional_properties = d
        return company_search_response_200_output_data_item_platforms_type_0
