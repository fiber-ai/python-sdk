...
T = TypeVar("T", bound="SyncCombinedSearchBodyCompanyParamsJobPostingsV2Type0AllOfType0ItemNumApplicantsType0")



@_attrs_define
class SyncCombinedSearchBodyCompanyParamsJobPostingsV2Type0AllOfType0ItemNumApplicantsType0:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sync_combined_search_body_company_params_job_postings_v2_type_0_all_of_type_0_item_num_applicants_type_0 = cls(
            lower_bound=lower_bound,
            upper_bound=upper_bound,
        )


        sync_combined_search_body_company_params_job_postings_v2_type_0_all_of_type_0_item_num_applicants_type_0.additional_properties = d
        return sync_combined_search_body_company_params_job_postings_v2_type_0_all_of_type_0_item_num_applicants_type_0
