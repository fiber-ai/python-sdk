...
T = TypeVar("T", bound="TextToCombinedSearchResponse200OutputDataCompaniesItemAcceleratorsType0ItemFoundersType0Item")


@_attrs_define
class TextToCombinedSearchResponse200OutputDataCompaniesItemAcceleratorsType0ItemFoundersType0Item:
    """
    Attributes:
        full_name (str | Unset):
        bio (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        text_to_combined_search_response_200_output_data_companies_item_accelerators_type_0_item_founders_type_0_item = cls(
            full_name=full_name,
            bio=bio,
            job_title=job_title,
            is_active=is_active,
        ...
        text_to_combined_search_response_200_output_data_companies_item_accelerators_type_0_item_founders_type_0_item.additional_properties = d
        return text_to_combined_search_response_200_output_data_companies_item_accelerators_type_0_item_founders_type_0_item
