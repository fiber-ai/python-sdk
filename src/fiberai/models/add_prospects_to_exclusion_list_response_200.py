...
class AddProspectsToExclusionListResponse200:
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.add_prospects_to_exclusion_list_response_200_charge_info_type_0 import (
            AddProspectsToExclusionListResponse200ChargeInfoType0,  # noqa: PLC0415
        )
        from ..models.add_prospects_to_exclusion_list_response_200_charge_info_type_1 import (
            AddProspectsToExclusionListResponse200ChargeInfoType1,  # noqa: PLC0415
        )
        from ..models.add_prospects_to_exclusion_list_response_200_charge_info_type_2 import (
            AddProspectsToExclusionListResponse200ChargeInfoType2,  # noqa: PLC0415
        )
        from ..models.add_prospects_to_exclusion_list_response_200_charge_info_type_3 import (
            AddProspectsToExclusionListResponse200ChargeInfoType3,  # noqa: PLC0415
        )

        output = self.output.to_dict()

        charge_info: dict[str, Any]
        if isinstance(self.charge_info, AddProspectsToExclusionListResponse200ChargeInfoType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.add_prospects_to_exclusion_list_response_200_charge_info_type_4 import (
            AddProspectsToExclusionListResponse200ChargeInfoType4,  # noqa: PLC0415
        )
        from ..models.add_prospects_to_exclusion_list_response_200_output import (
            AddProspectsToExclusionListResponse200Output,  # noqa: PLC0415
        )
        from ..models.add_prospects_to_exclusion_list_response_200_warnings_type_0_item import (
            AddProspectsToExclusionListResponse200WarningsType0Item,  # noqa: PLC0415
        )
