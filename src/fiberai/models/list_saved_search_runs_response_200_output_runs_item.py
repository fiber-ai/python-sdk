...
from ..models.list_saved_search_runs_response_200_output_runs_item_execution_mode import (
    ListSavedSearchRunsResponse200OutputRunsItemExecutionMode,
)
...
class ListSavedSearchRunsResponse200OutputRunsItem:
    ...
    Attributes:
        ...
        started_at (None | str | Unset): The date and time the saved search run started
        completed_at (None | str | Unset): The date and time the saved search run completed (if completed)
    """
