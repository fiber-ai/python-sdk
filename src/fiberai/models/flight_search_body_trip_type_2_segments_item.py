...
T = TypeVar("T", bound="FlightSearchBodyTripType2SegmentsItem")


@_attrs_define
class FlightSearchBodyTripType2SegmentsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        flight_search_body_trip_type_2_segments_item = cls(
            departure_airports=departure_airports,
            arrival_airports=arrival_airports,
            outbound_date=outbound_date,
        )

        flight_search_body_trip_type_2_segments_item.additional_properties = d
        return flight_search_body_trip_type_2_segments_item
