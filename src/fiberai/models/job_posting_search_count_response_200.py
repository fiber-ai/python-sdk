...
class JobPostingSearchCountResponse200:
    ...
    Attributes:
        ...
        charge_info (JobPostingSearchCountResponse200ChargeInfoType0 | JobPostingSearchCountResponse200ChargeInfoType1 |
            JobPostingSearchCountResponse200ChargeInfoType2 | JobPostingSearchCountResponse200ChargeInfoType3 |
            JobPostingSearchCountResponse200ChargeInfoType4):
        warnings (list[JobPostingSearchCountResponse200WarningsType0Item] | None | Unset): Warnings about extraneous
            fields in request
    ...
    warnings: list[JobPostingSearchCountResponse200WarningsType0Item] | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.charge_info, JobPostingSearchCountResponse200ChargeInfoType0):
            ...
            charge_info = self.charge_info.to_dict()
        elif isinstance(self.charge_info, JobPostingSearchCountResponse200ChargeInfoType3):
            charge_info = self.charge_info.to_dict()
        else:
            charge_info = self.charge_info.to_dict()
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_charge_info(
            ...
            if not isinstance(data, dict):
                raise TypeError()
            charge_info_type_4 = JobPostingSearchCountResponse200ChargeInfoType4.from_dict(data)

            return charge_info_type_4

        charge_info = _parse_charge_info(d.pop("chargeInfo"))

        def _parse_warnings(data: object) -> list[JobPostingSearchCountResponse200WarningsType0Item] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for warnings_type_0_item_data in _warnings_type_0:
                    warnings_type_0_item = JobPostingSearchCountResponse200WarningsType0Item.from_dict(
                ...
                pass
            return cast(list[JobPostingSearchCountResponse200WarningsType0Item] | None | Unset, data)
