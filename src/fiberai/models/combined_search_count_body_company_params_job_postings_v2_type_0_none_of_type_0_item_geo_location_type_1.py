...
if TYPE_CHECKING:
    from ..models.combined_search_count_body_company_params_job_postings_v2_type_0_none_of_type_0_item_geo_location_type_1_vertices_item import (
        CombinedSearchCountBodyCompanyParamsJobPostingsV2Type0NoneOfType0ItemGeoLocationType1VerticesItem,
    )
...
class CombinedSearchCountBodyCompanyParamsJobPostingsV2Type0NoneOfType0ItemGeoLocationType1:
    ...
    Attributes:
        ...
        vertices
            (list[CombinedSearchCountBodyCompanyParamsJobPostingsV2Type0NoneOfType0ItemGeoLocationType1VerticesItem]):
    """

    strategy: CombinedSearchCountBodyCompanyParamsJobPostingsV2Type0NoneOfType0ItemGeoLocationType1Strategy
    vertices: list[CombinedSearchCountBodyCompanyParamsJobPostingsV2Type0NoneOfType0ItemGeoLocationType1VerticesItem]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for vertices_item_data in _vertices:
            vertices_item = CombinedSearchCountBodyCompanyParamsJobPostingsV2Type0NoneOfType0ItemGeoLocationType1VerticesItem.from_dict(
                vertices_item_data
            )
