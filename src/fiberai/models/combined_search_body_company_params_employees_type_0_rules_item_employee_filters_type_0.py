...
if TYPE_CHECKING:
    from ..models.combined_search_body_company_params_employees_type_0_rules_item_employee_filters_type_0_recently_hired_type_0_item import (
        CombinedSearchBodyCompanyParamsEmployeesType0RulesItemEmployeeFiltersType0RecentlyHiredType0Item,
    )
...
class CombinedSearchBodyCompanyParamsEmployeesType0RulesItemEmployeeFiltersType0:
    ...
    Attributes:
        ...
        recently_hired
            (list[CombinedSearchBodyCompanyParamsEmployeesType0RulesItemEmployeeFiltersType0RecentlyHiredType0Item] | None |
            Unset):
    """
        ...
        def _parse_recently_hired(
            ...
            try:
                ...
                for recently_hired_type_0_item_data in _recently_hired_type_0:
                    recently_hired_type_0_item = CombinedSearchBodyCompanyParamsEmployeesType0RulesItemEmployeeFiltersType0RecentlyHiredType0Item.from_dict(
