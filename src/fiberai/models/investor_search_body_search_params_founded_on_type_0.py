...
T = TypeVar("T", bound="InvestorSearchBodySearchParamsFoundedOnType0")



@_attrs_define
class InvestorSearchBodySearchParamsFoundedOnType0:
    """ Filter by founded date (date range). Note: many investors have null founded_on, so this filter may exclude many rows
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        investor_search_body_search_params_founded_on_type_0 = cls(
            lower_bound=lower_bound,
            upper_bound=upper_bound,
        )


        investor_search_body_search_params_founded_on_type_0.additional_properties = d
        return investor_search_body_search_params_founded_on_type_0
