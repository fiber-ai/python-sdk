...
T = TypeVar("T", bound="SyncCombinedSearchBodyProfileParamsStealthV2Type0EnteredStealthAtType0RangeType0")


@_attrs_define
class SyncCombinedSearchBodyProfileParamsStealthV2Type0EnteredStealthAtType0RangeType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sync_combined_search_body_profile_params_stealth_v2_type_0_entered_stealth_at_type_0_range_type_0 = cls(
            lower_bound=lower_bound,
            upper_bound=upper_bound,
        )

        sync_combined_search_body_profile_params_stealth_v2_type_0_entered_stealth_at_type_0_range_type_0.additional_properties = d
        return sync_combined_search_body_profile_params_stealth_v2_type_0_entered_stealth_at_type_0_range_type_0
