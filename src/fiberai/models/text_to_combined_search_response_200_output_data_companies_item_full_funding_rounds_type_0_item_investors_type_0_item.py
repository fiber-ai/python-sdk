...
T = TypeVar("T", bound="TextToCombinedSearchResponse200OutputDataCompaniesItemFullFundingRoundsType0ItemInvestorsType0Item")



@_attrs_define
class TextToCombinedSearchResponse200OutputDataCompaniesItemFullFundingRoundsType0ItemInvestorsType0Item:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        text_to_combined_search_response_200_output_data_companies_item_full_funding_rounds_type_0_item_investors_type_0_item = cls(
            is_lead=is_lead,
        ...
        text_to_combined_search_response_200_output_data_companies_item_full_funding_rounds_type_0_item_investors_type_0_item.additional_properties = d
        return text_to_combined_search_response_200_output_data_companies_item_full_funding_rounds_type_0_item_investors_type_0_item
