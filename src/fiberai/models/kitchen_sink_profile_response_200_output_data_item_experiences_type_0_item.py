...
from ..models.kitchen_sink_profile_response_200_output_data_item_experiences_type_0_item_academic_qualification_type_0_item import (
    KitchenSinkProfileResponse200OutputDataItemExperiencesType0ItemAcademicQualificationType0Item,
)
from ..models.kitchen_sink_profile_response_200_output_data_item_experiences_type_0_item_employment_type_type_0_item import (
    KitchenSinkProfileResponse200OutputDataItemExperiencesType0ItemEmploymentTypeType0Item,
)
from ..models.kitchen_sink_profile_response_200_output_data_item_experiences_type_0_item_job_function_type_0_item import (
    KitchenSinkProfileResponse200OutputDataItemExperiencesType0ItemJobFunctionType0Item,
)
from ..models.kitchen_sink_profile_response_200_output_data_item_experiences_type_0_item_seniority_type_1 import (
    KitchenSinkProfileResponse200OutputDataItemExperiencesType0ItemSeniorityType1,
)
from ..models.kitchen_sink_profile_response_200_output_data_item_experiences_type_0_item_seniority_type_2_type_1 import (
    KitchenSinkProfileResponse200OutputDataItemExperiencesType0ItemSeniorityType2Type1,
)
from ..models.kitchen_sink_profile_response_200_output_data_item_experiences_type_0_item_seniority_type_3_type_1 import (
    KitchenSinkProfileResponse200OutputDataItemExperiencesType0ItemSeniorityType3Type1,
)
...
class KitchenSinkProfileResponse200OutputDataItemExperiencesType0Item:
    ...
    Attributes:
        ...
        seniority (KitchenSinkProfileResponse200OutputDataItemExperiencesType0ItemSeniorityType1 |
            KitchenSinkProfileResponse200OutputDataItemExperiencesType0ItemSeniorityType2Type1 |
            KitchenSinkProfileResponse200OutputDataItemExperiencesType0ItemSeniorityType3Type1 | None | Unset):
        job_function (list[KitchenSinkProfileResponse200OutputDataItemExperiencesType0ItemJobFunctionType0Item] | None |
            Unset):
        employment_type (list[KitchenSinkProfileResponse200OutputDataItemExperiencesType0ItemEmploymentTypeType0Item] |
            None | Unset):
        academic_qualification
            (list[KitchenSinkProfileResponse200OutputDataItemExperiencesType0ItemAcademicQualificationType0Item] | None |
            Unset):
    ...
    job_function: (
        list[KitchenSinkProfileResponse200OutputDataItemExperiencesType0ItemJobFunctionType0Item] | None | Unset
    ) = UNSET
    employment_type: (
        list[KitchenSinkProfileResponse200OutputDataItemExperiencesType0ItemEmploymentTypeType0Item] | None | Unset
    ) = UNSET
    academic_qualification: (
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.seniority, Unset):
            ...
            self.seniority, KitchenSinkProfileResponse200OutputDataItemExperiencesType0ItemSeniorityType2Type1
        ):
            seniority = self.seniority.value
        elif isinstance(
            self.seniority, KitchenSinkProfileResponse200OutputDataItemExperiencesType0ItemSeniorityType3Type1
        ):
            seniority = self.seniority.value
        else:
        ...
        def _parse_seniority(
            ...
            try:
                ...
                seniority_type_2_type_1 = (
                    KitchenSinkProfileResponse200OutputDataItemExperiencesType0ItemSeniorityType2Type1(data)
                )
            ...
            try:
                ...
                seniority_type_3_type_1 = (
                    KitchenSinkProfileResponse200OutputDataItemExperiencesType0ItemSeniorityType3Type1(data)
                )
