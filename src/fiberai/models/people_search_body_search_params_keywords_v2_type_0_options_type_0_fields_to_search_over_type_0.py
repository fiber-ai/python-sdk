...
T = TypeVar("T", bound="PeopleSearchBodySearchParamsKeywordsV2Type0OptionsType0FieldsToSearchOverType0")


@_attrs_define
class PeopleSearchBodySearchParamsKeywordsV2Type0OptionsType0FieldsToSearchOverType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        people_search_body_search_params_keywords_v2_type_0_options_type_0_fields_to_search_over_type_0 = cls(
            summary=summary,
            headline=headline,
        ...
        people_search_body_search_params_keywords_v2_type_0_options_type_0_fields_to_search_over_type_0.additional_properties = d
        return people_search_body_search_params_keywords_v2_type_0_options_type_0_fields_to_search_over_type_0
