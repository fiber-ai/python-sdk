...
T = TypeVar("T", bound="PaginatedCombinedSearchResponse200OutputCompaniesItemAcceleratorsType0ItemFoundersType0Item")


@_attrs_define
class PaginatedCombinedSearchResponse200OutputCompaniesItemAcceleratorsType0ItemFoundersType0Item:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        paginated_combined_search_response_200_output_companies_item_accelerators_type_0_item_founders_type_0_item = (
            cls(
                full_name=full_name,
                bio=bio,
                job_title=job_title,
        ...
        paginated_combined_search_response_200_output_companies_item_accelerators_type_0_item_founders_type_0_item.additional_properties = d
        return (
            paginated_combined_search_response_200_output_companies_item_accelerators_type_0_item_founders_type_0_item
        )
