...
from ..models.people_search_response_200_output_data_item_detailed_work_experiences_type_0_item_academic_qualification_type_0_item import (
    PeopleSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemAcademicQualificationType0Item,
)
from ..models.people_search_response_200_output_data_item_detailed_work_experiences_type_0_item_employment_type_type_0_item import (
    PeopleSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemEmploymentTypeType0Item,
)
from ..models.people_search_response_200_output_data_item_detailed_work_experiences_type_0_item_job_function_type_0_item import (
    PeopleSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemJobFunctionType0Item,
)
from ..models.people_search_response_200_output_data_item_detailed_work_experiences_type_0_item_seniority_type_1 import (
    PeopleSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemSeniorityType1,
)
from ..models.people_search_response_200_output_data_item_detailed_work_experiences_type_0_item_seniority_type_2_type_1 import (
    PeopleSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemSeniorityType2Type1,
)
from ..models.people_search_response_200_output_data_item_detailed_work_experiences_type_0_item_seniority_type_3_type_1 import (
    PeopleSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemSeniorityType3Type1,
)
...
class PeopleSearchResponse200OutputDataItemDetailedWorkExperiencesType0Item:
    """
    Attributes:
        company_details (None | PeopleSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemCompanyDetailsType0
            | Unset):
        ...
        seniority (None | PeopleSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemSeniorityType1 |
            PeopleSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemSeniorityType2Type1 |
            PeopleSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemSeniorityType3Type1 | Unset):
        job_function (list[PeopleSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemJobFunctionType0Item] |
            None | Unset):
        employment_type
            (list[PeopleSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemEmploymentTypeType0Item] | None |
            Unset):
    ...
    company_details: (
        None | PeopleSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemCompanyDetailsType0 | Unset
    ) = UNSET
    ...
    job_function: (
        list[PeopleSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemJobFunctionType0Item] | None | Unset
    ) = UNSET
    employment_type: (
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.seniority, Unset):
            ...
            self.seniority, PeopleSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemSeniorityType1
        ):
            seniority = self.seniority.value
        elif isinstance(
            self.seniority, PeopleSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemSeniorityType2Type1
        ):
            seniority = self.seniority.value
        elif isinstance(
            self.seniority, PeopleSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemSeniorityType3Type1
        ):
            seniority = self.seniority.value
        else:
        ...
        def _parse_company_details(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                company_details_type_0 = (
                    PeopleSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemCompanyDetailsType0.from_dict(
                        data
                    )
                )
        ...
        def _parse_seniority(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                seniority_type_1 = PeopleSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemSeniorityType1(
                    data
                )
            ...
            try:
                ...
                seniority_type_2_type_1 = (
                    PeopleSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemSeniorityType2Type1(data)
                )
            ...
            try:
                ...
                seniority_type_3_type_1 = (
                    PeopleSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemSeniorityType3Type1(data)
                )
        ...
        def _parse_academic_qualification(
            ...
            try:
                ...
                for academic_qualification_type_0_item_data in _academic_qualification_type_0:
                    academic_qualification_type_0_item = PeopleSearchResponse200OutputDataItemDetailedWorkExperiencesType0ItemAcademicQualificationType0Item(
