...
if TYPE_CHECKING:
    from ..models.sync_combined_search_response_200_output_profiles_item_detailed_education_type_0_item_school_details_type_0 import (
        SyncCombinedSearchResponse200OutputProfilesItemDetailedEducationType0ItemSchoolDetailsType0,
    )
...
class SyncCombinedSearchResponse200OutputProfilesItemDetailedEducationType0Item:
    ...
    Attributes:
        school_details (None |
            SyncCombinedSearchResponse200OutputProfilesItemDetailedEducationType0ItemSchoolDetailsType0 | Unset):
    ...
    school_details: (
        None | SyncCombinedSearchResponse200OutputProfilesItemDetailedEducationType0ItemSchoolDetailsType0 | Unset
    ) = UNSET
        ...
        def _parse_school_details(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                school_details_type_0 = SyncCombinedSearchResponse200OutputProfilesItemDetailedEducationType0ItemSchoolDetailsType0.from_dict(
                    data
                )
