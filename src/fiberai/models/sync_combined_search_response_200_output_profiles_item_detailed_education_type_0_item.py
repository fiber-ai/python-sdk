...
if TYPE_CHECKING:
  from ..models.sync_combined_search_response_200_output_profiles_item_detailed_education_type_0_item_school_details_type_0 import SyncCombinedSearchResponse200OutputProfilesItemDetailedEducationType0ItemSchoolDetailsType0





T = TypeVar("T", bound="SyncCombinedSearchResponse200OutputProfilesItemDetailedEducationType0Item")



@_attrs_define
class SyncCombinedSearchResponse200OutputProfilesItemDetailedEducationType0Item:
    """ 
        Attributes:
            school_details
                (Union['SyncCombinedSearchResponse200OutputProfilesItemDetailedEducationType0ItemSchoolDetailsType0', None,
                Unset]):
    ...
    school_details: Union['SyncCombinedSearchResponse200OutputProfilesItemDetailedEducationType0ItemSchoolDetailsType0', None, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.school_details, SyncCombinedSearchResponse200OutputProfilesItemDetailedEducationType0ItemSchoolDetailsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.sync_combined_search_response_200_output_profiles_item_detailed_education_type_0_item_school_details_type_0 import SyncCombinedSearchResponse200OutputProfilesItemDetailedEducationType0ItemSchoolDetailsType0
        d = dict(src_dict)
        def _parse_school_details(data: object) -> Union['SyncCombinedSearchResponse200OutputProfilesItemDetailedEducationType0ItemSchoolDetailsType0', None, Unset]:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                school_details_type_0 = SyncCombinedSearchResponse200OutputProfilesItemDetailedEducationType0ItemSchoolDetailsType0.from_dict(data)
                ...
                pass
            return cast(Union['SyncCombinedSearchResponse200OutputProfilesItemDetailedEducationType0ItemSchoolDetailsType0', None, Unset], data)
        ...
        sync_combined_search_response_200_output_profiles_item_detailed_education_type_0_item = cls(
        ...
        sync_combined_search_response_200_output_profiles_item_detailed_education_type_0_item.additional_properties = d
        return sync_combined_search_response_200_output_profiles_item_detailed_education_type_0_item
