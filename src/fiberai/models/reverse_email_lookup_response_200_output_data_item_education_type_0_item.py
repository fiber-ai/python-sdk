...
T = TypeVar("T", bound="ReverseEmailLookupResponse200OutputDataItemEducationType0Item")



@_attrs_define
class ReverseEmailLookupResponse200OutputDataItemEducationType0Item:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reverse_email_lookup_response_200_output_data_item_education_type_0_item = cls(
            school_id=school_id,
        ...
        reverse_email_lookup_response_200_output_data_item_education_type_0_item.additional_properties = d
        return reverse_email_lookup_response_200_output_data_item_education_type_0_item
