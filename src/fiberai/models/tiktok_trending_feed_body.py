...
T = TypeVar("T", bound="TiktokTrendingFeedBody")


@_attrs_define
class TiktokTrendingFeedBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        tiktok_trending_feed_body = cls(
            api_key=api_key,
            next_page_token=next_page_token,
        )

        tiktok_trending_feed_body.additional_properties = d
        return tiktok_trending_feed_body
