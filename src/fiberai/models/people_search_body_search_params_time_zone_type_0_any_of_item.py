...
if TYPE_CHECKING:
    from ..models.people_search_body_search_params_time_zone_type_0_any_of_item_strategy_type_0 import (
        PeopleSearchBodySearchParamsTimeZoneType0AnyOfItemStrategyType0,
    )
...
class PeopleSearchBodySearchParamsTimeZoneType0AnyOfItem:
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.people_search_body_search_params_time_zone_type_0_any_of_item_strategy_type_0 import (
            PeopleSearchBodySearchParamsTimeZoneType0AnyOfItemStrategyType0,  # noqa: PLC0415
        )
