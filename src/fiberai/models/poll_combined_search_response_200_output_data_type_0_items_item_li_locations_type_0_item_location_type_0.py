...
if TYPE_CHECKING:
    from ..models.poll_combined_search_response_200_output_data_type_0_items_item_li_locations_type_0_item_location_type_0_coordinates_type_0 import (
        PollCombinedSearchResponse200OutputDataType0ItemsItemLiLocationsType0ItemLocationType0CoordinatesType0,
    )
...
class PollCombinedSearchResponse200OutputDataType0ItemsItemLiLocationsType0ItemLocationType0:
    ...
    Attributes:
        ...
        coordinates (None |
            PollCombinedSearchResponse200OutputDataType0ItemsItemLiLocationsType0ItemLocationType0CoordinatesType0 | Unset):
        ...
        def _parse_coordinates(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = PollCombinedSearchResponse200OutputDataType0ItemsItemLiLocationsType0ItemLocationType0CoordinatesType0.from_dict(
                    data
                )
