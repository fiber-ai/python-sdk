...
T = TypeVar("T", bound="TriggerExhaustiveContactEnrichmentResponse200")


@_attrs_define
class TriggerExhaustiveContactEnrichmentResponse200:
    """
    Attributes:
        output (TriggerExhaustiveContactEnrichmentResponse200Output):
        charge_info (TriggerExhaustiveContactEnrichmentResponse200ChargeInfoType0 |
            TriggerExhaustiveContactEnrichmentResponse200ChargeInfoType1 |
            TriggerExhaustiveContactEnrichmentResponse200ChargeInfoType2 |
            TriggerExhaustiveContactEnrichmentResponse200ChargeInfoType3 |
            TriggerExhaustiveContactEnrichmentResponse200ChargeInfoType4):
        warnings (list[TriggerExhaustiveContactEnrichmentResponse200WarningsType0Item] | None | Unset): Warnings about
    ...
    warnings: list[TriggerExhaustiveContactEnrichmentResponse200WarningsType0Item] | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.charge_info, TriggerExhaustiveContactEnrichmentResponse200ChargeInfoType0):
            charge_info = self.charge_info.to_dict()
        elif isinstance(self.charge_info, TriggerExhaustiveContactEnrichmentResponse200ChargeInfoType1):
            charge_info = self.charge_info.to_dict()
        elif isinstance(self.charge_info, TriggerExhaustiveContactEnrichmentResponse200ChargeInfoType2):
            charge_info = self.charge_info.to_dict()
        elif isinstance(self.charge_info, TriggerExhaustiveContactEnrichmentResponse200ChargeInfoType3):
            charge_info = self.charge_info.to_dict()
        else:
            charge_info = self.charge_info.to_dict()
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        output = TriggerExhaustiveContactEnrichmentResponse200Output.from_dict(d.pop("output"))
        ...
        def _parse_charge_info(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_0 = TriggerExhaustiveContactEnrichmentResponse200ChargeInfoType0.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_1 = TriggerExhaustiveContactEnrichmentResponse200ChargeInfoType1.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_2 = TriggerExhaustiveContactEnrichmentResponse200ChargeInfoType2.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_3 = TriggerExhaustiveContactEnrichmentResponse200ChargeInfoType3.from_dict(data)
            ...
            if not isinstance(data, dict):
                raise TypeError()
            charge_info_type_4 = TriggerExhaustiveContactEnrichmentResponse200ChargeInfoType4.from_dict(data)
        ...
        def _parse_warnings(
            data: object,
        ) -> list[TriggerExhaustiveContactEnrichmentResponse200WarningsType0Item] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for warnings_type_0_item_data in _warnings_type_0:
                    warnings_type_0_item = TriggerExhaustiveContactEnrichmentResponse200WarningsType0Item.from_dict(
                ...
                pass
            return cast(list[TriggerExhaustiveContactEnrichmentResponse200WarningsType0Item] | None | Unset, data)
        ...
        trigger_exhaustive_contact_enrichment_response_200 = cls(
            output=output,
        ...
        return trigger_exhaustive_contact_enrichment_response_200
