...
T = TypeVar("T", bound="DeleteTrackerPersonListResponse402OutOfCreditsAlertType0")


@_attrs_define
class DeleteTrackerPersonListResponse402OutOfCreditsAlertType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_tracker_person_list_response_402_out_of_credits_alert_type_0 = cls(
            get_more_credits_url=get_more_credits_url,
            message=message,
            available_credits=available_credits,
        )

        delete_tracker_person_list_response_402_out_of_credits_alert_type_0.additional_properties = d
        return delete_tracker_person_list_response_402_out_of_credits_alert_type_0
