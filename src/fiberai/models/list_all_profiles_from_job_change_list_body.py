...
from ..models.list_all_profiles_from_job_change_list_body_movements_type_0_item import (
    ListAllProfilesFromJobChangeListBodyMovementsType0Item,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ListAllProfilesFromJobChangeListBody")


@_attrs_define
class ListAllProfilesFromJobChangeListBody:
    """
    Attributes:
        api_key (str): Your Fiber API key
        job_change_list_id (str): The job change list id.
        movements (list[ListAllProfilesFromJobChangeListBodyMovementsType0Item] | None | Unset):
    ...
    movements: list[ListAllProfilesFromJobChangeListBodyMovementsType0Item] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_movements(
            data: object,
        ) -> list[ListAllProfilesFromJobChangeListBodyMovementsType0Item] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for movements_type_0_item_data in _movements_type_0:
                    movements_type_0_item = ListAllProfilesFromJobChangeListBodyMovementsType0Item(
                ...
                pass
            return cast(list[ListAllProfilesFromJobChangeListBodyMovementsType0Item] | None | Unset, data)
        ...
        list_all_profiles_from_job_change_list_body = cls(
            api_key=api_key,
        ...
        list_all_profiles_from_job_change_list_body.additional_properties = d
        return list_all_profiles_from_job_change_list_body
