...
T = TypeVar("T", bound="KitchenSinkCompanyResponse200OutputDataItemEmployeeTrendsType0ItemChangesType0Item")



@_attrs_define
class KitchenSinkCompanyResponse200OutputDataItemEmployeeTrendsType0ItemChangesType0Item:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        kitchen_sink_company_response_200_output_data_item_employee_trends_type_0_item_changes_type_0_item = cls(
            count_end=count_end,
        ...
        kitchen_sink_company_response_200_output_data_item_employee_trends_type_0_item_changes_type_0_item.additional_properties = d
        return kitchen_sink_company_response_200_output_data_item_employee_trends_type_0_item_changes_type_0_item
