...
T = TypeVar("T", bound="CreateTrackerCompanyListBodyCompanySearchParamsType0KeywordsType0")


@_attrs_define
class CreateTrackerCompanyListBodyCompanySearchParamsType0KeywordsType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_tracker_company_list_body_company_search_params_type_0_keywords_type_0 = cls(
            contains_all=contains_all,
            contains_any=contains_any,
            contains_none=contains_none,
        )

        create_tracker_company_list_body_company_search_params_type_0_keywords_type_0.additional_properties = d
        return create_tracker_company_list_body_company_search_params_type_0_keywords_type_0
