...
if TYPE_CHECKING:
    from ..models.company_posts_live_fetch_response_200_output_data_item_engagement_type_0_reactions_by_type_type_0_item import (
        CompanyPostsLiveFetchResponse200OutputDataItemEngagementType0ReactionsByTypeType0Item,
    )
...
class CompanyPostsLiveFetchResponse200OutputDataItemEngagementType0:
    ...
    Attributes:
        ...
        reactions_by_type (list[CompanyPostsLiveFetchResponse200OutputDataItemEngagementType0ReactionsByTypeType0Item] |
            None | Unset):
    """
    ...
    reactions_by_type: (
        list[CompanyPostsLiveFetchResponse200OutputDataItemEngagementType0ReactionsByTypeType0Item] | None | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.company_posts_live_fetch_response_200_output_data_item_engagement_type_0_reactions_by_type_type_0_item import (
            CompanyPostsLiveFetchResponse200OutputDataItemEngagementType0ReactionsByTypeType0Item,  # noqa: PLC0415
        )
            ...
            try:
                ...
                for reactions_by_type_type_0_item_data in _reactions_by_type_type_0:
                    reactions_by_type_type_0_item = (
                        CompanyPostsLiveFetchResponse200OutputDataItemEngagementType0ReactionsByTypeType0Item.from_dict(
