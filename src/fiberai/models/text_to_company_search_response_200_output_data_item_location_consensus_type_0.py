...
if TYPE_CHECKING:
    from ..models.text_to_company_search_response_200_output_data_item_location_consensus_type_0_coordinates_type_0 import (
        TextToCompanySearchResponse200OutputDataItemLocationConsensusType0CoordinatesType0,
    )
...
class TextToCompanySearchResponse200OutputDataItemLocationConsensusType0:
    ...
    Attributes:
        ...
        coordinates (None | TextToCompanySearchResponse200OutputDataItemLocationConsensusType0CoordinatesType0 | Unset):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.coordinates, Unset):
            ...
            self.coordinates, TextToCompanySearchResponse200OutputDataItemLocationConsensusType0CoordinatesType0
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_coordinates(
            data: object,
        ) -> None | TextToCompanySearchResponse200OutputDataItemLocationConsensusType0CoordinatesType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = (
                    TextToCompanySearchResponse200OutputDataItemLocationConsensusType0CoordinatesType0.from_dict(data)
                )
                ...
                pass
            return cast(
                None | TextToCompanySearchResponse200OutputDataItemLocationConsensusType0CoordinatesType0 | Unset, data
            )
