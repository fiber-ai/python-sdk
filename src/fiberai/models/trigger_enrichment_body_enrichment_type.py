...
T = TypeVar("T", bound="TriggerEnrichmentBodyEnrichmentType")


@_attrs_define
class TriggerEnrichmentBodyEnrichmentType:
    """Enrichment types to request. Credits are charged only for selected types.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        trigger_enrichment_body_enrichment_type = cls(
            get_work_emails=get_work_emails,
            get_personal_emails=get_personal_emails,
            get_phone_numbers=get_phone_numbers,
        )

        trigger_enrichment_body_enrichment_type.additional_properties = d
        return trigger_enrichment_body_enrichment_type
