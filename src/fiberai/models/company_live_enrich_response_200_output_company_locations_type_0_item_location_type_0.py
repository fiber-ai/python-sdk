...
if TYPE_CHECKING:
  from ..models.company_live_enrich_response_200_output_company_locations_type_0_item_location_type_0_coordinates_type_0 import CompanyLiveEnrichResponse200OutputCompanyLocationsType0ItemLocationType0CoordinatesType0





T = TypeVar("T", bound="CompanyLiveEnrichResponse200OutputCompanyLocationsType0ItemLocationType0")



@_attrs_define
class CompanyLiveEnrichResponse200OutputCompanyLocationsType0ItemLocationType0:
    """ 
        Attributes:
            ...
            coordinates (Union['CompanyLiveEnrichResponse200OutputCompanyLocationsType0ItemLocationType0CoordinatesType0',
                None, Unset]):
    ...
    coordinates: Union['CompanyLiveEnrichResponse200OutputCompanyLocationsType0ItemLocationType0CoordinatesType0', None, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.coordinates, Unset):
            coordinates = UNSET
        elif isinstance(self.coordinates, CompanyLiveEnrichResponse200OutputCompanyLocationsType0ItemLocationType0CoordinatesType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_coordinates(data: object) -> Union['CompanyLiveEnrichResponse200OutputCompanyLocationsType0ItemLocationType0CoordinatesType0', None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = CompanyLiveEnrichResponse200OutputCompanyLocationsType0ItemLocationType0CoordinatesType0.from_dict(data)
                ...
                pass
            return cast(Union['CompanyLiveEnrichResponse200OutputCompanyLocationsType0ItemLocationType0CoordinatesType0', None, Unset], data)
        ...
        company_live_enrich_response_200_output_company_locations_type_0_item_location_type_0 = cls(
        ...
        company_live_enrich_response_200_output_company_locations_type_0_item_location_type_0.additional_properties = d
        return company_live_enrich_response_200_output_company_locations_type_0_item_location_type_0
