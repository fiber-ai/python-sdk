...
class CompanyLiveEnrichResponse200OutputCompanyLocationsType0ItemLocationType0:
    ...
    Attributes:
        ...
        coordinates (CompanyLiveEnrichResponse200OutputCompanyLocationsType0ItemLocationType0CoordinatesType0 | None |
            Unset):
    ...
    coordinates: (
        CompanyLiveEnrichResponse200OutputCompanyLocationsType0ItemLocationType0CoordinatesType0 | None | Unset
    ) = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.coordinates, Unset):
            ...
            self.coordinates, CompanyLiveEnrichResponse200OutputCompanyLocationsType0ItemLocationType0CoordinatesType0
        ):
        ...
        def _parse_coordinates(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = (
                    CompanyLiveEnrichResponse200OutputCompanyLocationsType0ItemLocationType0CoordinatesType0.from_dict(
                        data
                    )
                )
