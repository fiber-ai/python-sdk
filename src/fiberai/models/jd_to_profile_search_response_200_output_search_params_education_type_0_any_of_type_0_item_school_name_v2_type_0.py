...
T = TypeVar("T", bound="JdToProfileSearchResponse200OutputSearchParamsEducationType0AnyOfType0ItemSchoolNameV2Type0")


@_attrs_define
class JdToProfileSearchResponse200OutputSearchParamsEducationType0AnyOfType0ItemSchoolNameV2Type0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        jd_to_profile_search_response_200_output_search_params_education_type_0_any_of_type_0_item_school_name_v2_type_0 = cls(
            any_of=any_of,
            none_of=none_of,
        )

        jd_to_profile_search_response_200_output_search_params_education_type_0_any_of_type_0_item_school_name_v2_type_0.additional_properties = d
        return jd_to_profile_search_response_200_output_search_params_education_type_0_any_of_type_0_item_school_name_v2_type_0
