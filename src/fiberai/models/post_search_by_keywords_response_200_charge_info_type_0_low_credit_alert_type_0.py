...
T = TypeVar("T", bound="PostSearchByKeywordsResponse200ChargeInfoType0LowCreditAlertType0")


@_attrs_define
class PostSearchByKeywordsResponse200ChargeInfoType0LowCreditAlertType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_search_by_keywords_response_200_charge_info_type_0_low_credit_alert_type_0 = cls(
            get_more_credits_url=get_more_credits_url,
            message=message,
            available_credits=available_credits,
        )

        post_search_by_keywords_response_200_charge_info_type_0_low_credit_alert_type_0.additional_properties = d
        return post_search_by_keywords_response_200_charge_info_type_0_low_credit_alert_type_0
