...
T = TypeVar("T", bound="TiktokVideoCommentsResponse200OutputCommentsItemUserType0")


@_attrs_define
class TiktokVideoCommentsResponse200OutputCommentsItemUserType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        tiktok_video_comments_response_200_output_comments_item_user_type_0 = cls(
            id=id,
            handle=handle,
        ...
        tiktok_video_comments_response_200_output_comments_item_user_type_0.additional_properties = d
        return tiktok_video_comments_response_200_output_comments_item_user_type_0
