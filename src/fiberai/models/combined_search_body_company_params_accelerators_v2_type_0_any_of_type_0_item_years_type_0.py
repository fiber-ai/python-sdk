...
T = TypeVar("T", bound="CombinedSearchBodyCompanyParamsAcceleratorsV2Type0AnyOfType0ItemYearsType0")



@_attrs_define
class CombinedSearchBodyCompanyParamsAcceleratorsV2Type0AnyOfType0ItemYearsType0:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        combined_search_body_company_params_accelerators_v2_type_0_any_of_type_0_item_years_type_0 = cls(
            lower_bound=lower_bound,
            upper_bound=upper_bound,
        )


        combined_search_body_company_params_accelerators_v2_type_0_any_of_type_0_item_years_type_0.additional_properties = d
        return combined_search_body_company_params_accelerators_v2_type_0_any_of_type_0_item_years_type_0
