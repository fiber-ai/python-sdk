...
T = TypeVar("T", bound="QuickCompanyResolveResponse200OutputDataItemCompanyType0LiJobPostsStatsType0")


@_attrs_define
class QuickCompanyResolveResponse200OutputDataItemCompanyType0LiJobPostsStatsType0:
    """
    Attributes:
        total_count (float):
        seniority_stats (None |
            QuickCompanyResolveResponse200OutputDataItemCompanyType0LiJobPostsStatsType0SeniorityStatsType0 | Unset):
        employment_type_stats (None |
            QuickCompanyResolveResponse200OutputDataItemCompanyType0LiJobPostsStatsType0EmploymentTypeStatsType0 | Unset):
        country_location_stats (None |
            QuickCompanyResolveResponse200OutputDataItemCompanyType0LiJobPostsStatsType0CountryLocationStatsType0 | Unset):
        ...
        job_location_type_stats (None |
            QuickCompanyResolveResponse200OutputDataItemCompanyType0LiJobPostsStatsType0JobLocationTypeStatsType0 | Unset):
    """

    total_count: float
    seniority_stats: (
        None | QuickCompanyResolveResponse200OutputDataItemCompanyType0LiJobPostsStatsType0SeniorityStatsType0 | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_seniority_stats(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                seniority_stats_type_0 = QuickCompanyResolveResponse200OutputDataItemCompanyType0LiJobPostsStatsType0SeniorityStatsType0.from_dict(
                    data
                )
        ...
        def _parse_employment_type_stats(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                employment_type_stats_type_0 = QuickCompanyResolveResponse200OutputDataItemCompanyType0LiJobPostsStatsType0EmploymentTypeStatsType0.from_dict(
                    data
                )
        ...
        def _parse_country_location_stats(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                country_location_stats_type_0 = QuickCompanyResolveResponse200OutputDataItemCompanyType0LiJobPostsStatsType0CountryLocationStatsType0.from_dict(
                    data
                )
        ...
        def _parse_puree_job_functions_stats(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                puree_job_functions_stats_type_0 = QuickCompanyResolveResponse200OutputDataItemCompanyType0LiJobPostsStatsType0PureeJobFunctionsStatsType0.from_dict(
                    data
                )
        ...
        def _parse_standard_industries_stats(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                standard_industries_stats_type_0 = QuickCompanyResolveResponse200OutputDataItemCompanyType0LiJobPostsStatsType0StandardIndustriesStatsType0.from_dict(
                    data
                )
        ...
        def _parse_job_location_type_stats(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                job_location_type_stats_type_0 = QuickCompanyResolveResponse200OutputDataItemCompanyType0LiJobPostsStatsType0JobLocationTypeStatsType0.from_dict(
                    data
                )
        ...
        quick_company_resolve_response_200_output_data_item_company_type_0_li_job_posts_stats_type_0 = cls(
            total_count=total_count,
        ...
        quick_company_resolve_response_200_output_data_item_company_type_0_li_job_posts_stats_type_0.additional_properties = d
        return quick_company_resolve_response_200_output_data_item_company_type_0_li_job_posts_stats_type_0
