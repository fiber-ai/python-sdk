...
T = TypeVar("T", bound="UpdateTrackerCompanyListBodyInitialSignalsType0")


@_attrs_define
class UpdateTrackerCompanyListBodyInitialSignalsType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_tracker_company_list_body_initial_signals_type_0 = cls(
            lookback_period_days=lookback_period_days,
        )

        update_tracker_company_list_body_initial_signals_type_0.additional_properties = d
        return update_tracker_company_list_body_initial_signals_type_0
