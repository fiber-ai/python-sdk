...
T = TypeVar("T", bound="CompanySearchBodySearchParamsOfficeLocationsV2Type0NoneOfType0ItemType1Range")



@_attrs_define
class CompanySearchBodySearchParamsOfficeLocationsV2Type0NoneOfType0ItemType1Range:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        company_search_body_search_params_office_locations_v2_type_0_none_of_type_0_item_type_1_range = cls(
            lower_bound=lower_bound,
            upper_bound=upper_bound,
        )


        company_search_body_search_params_office_locations_v2_type_0_none_of_type_0_item_type_1_range.additional_properties = d
        return company_search_body_search_params_office_locations_v2_type_0_none_of_type_0_item_type_1_range
