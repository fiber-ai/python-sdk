...
T = TypeVar("T", bound="PaginatedCombinedSearchBodyCompanyConfigType0SearchParamsHeadquartersLocationType0")


@_attrs_define
class PaginatedCombinedSearchBodyCompanyConfigType0SearchParamsHeadquartersLocationType0:
    """
    Attributes:
        union_all
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
                    ...
                    def _parse_union_all_type_0_item(
                        ...
                        try:
                            if not isinstance(data, dict):
                                raise TypeError()
                            union_all_type_0_item_type_0 = PaginatedCombinedSearchBodyCompanyConfigType0SearchParamsHeadquartersLocationType0UnionAllType0ItemType0.from_dict(
                                data
                            )
                        ...
                        try:
                            if not isinstance(data, dict):
                                raise TypeError()
                            union_all_type_0_item_type_1 = PaginatedCombinedSearchBodyCompanyConfigType0SearchParamsHeadquartersLocationType0UnionAllType0ItemType1.from_dict(
                                data
                            )
                ...
                for subtract_all_type_0_item_data in _subtract_all_type_0:
                    ...
                    def _parse_subtract_all_type_0_item(
                        ...
                        try:
                            if not isinstance(data, dict):
                                raise TypeError()
                            subtract_all_type_0_item_type_0 = PaginatedCombinedSearchBodyCompanyConfigType0SearchParamsHeadquartersLocationType0SubtractAllType0ItemType0.from_dict(
                                data
                            )
                        ...
                        try:
                            if not isinstance(data, dict):
                                raise TypeError()
                            subtract_all_type_0_item_type_1 = PaginatedCombinedSearchBodyCompanyConfigType0SearchParamsHeadquartersLocationType0SubtractAllType0ItemType1.from_dict(
                                data
                            )
        ...
        paginated_combined_search_body_company_config_type_0_search_params_headquarters_location_type_0 = cls(
            union_all=union_all,
            subtract_all=subtract_all,
        )

        paginated_combined_search_body_company_config_type_0_search_params_headquarters_location_type_0.additional_properties = d
        return paginated_combined_search_body_company_config_type_0_search_params_headquarters_location_type_0
