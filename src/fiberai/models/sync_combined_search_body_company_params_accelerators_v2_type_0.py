...
if TYPE_CHECKING:
    from ..models.sync_combined_search_body_company_params_accelerators_v2_type_0_any_of_type_0_item import (
        SyncCombinedSearchBodyCompanyParamsAcceleratorsV2Type0AnyOfType0Item,
    )
    from ..models.sync_combined_search_body_company_params_accelerators_v2_type_0_none_of_type_0_item import (
        SyncCombinedSearchBodyCompanyParamsAcceleratorsV2Type0NoneOfType0Item,
    )
...
class SyncCombinedSearchBodyCompanyParamsAcceleratorsV2Type0:
    """
    Attributes:
        any_of (list[SyncCombinedSearchBodyCompanyParamsAcceleratorsV2Type0AnyOfType0Item] | None | Unset):
        none_of (list[SyncCombinedSearchBodyCompanyParamsAcceleratorsV2Type0NoneOfType0Item] | None | Unset):
    """

    any_of: list[SyncCombinedSearchBodyCompanyParamsAcceleratorsV2Type0AnyOfType0Item] | None | Unset = UNSET
    none_of: list[SyncCombinedSearchBodyCompanyParamsAcceleratorsV2Type0NoneOfType0Item] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_any_of(
            data: object,
        ) -> list[SyncCombinedSearchBodyCompanyParamsAcceleratorsV2Type0AnyOfType0Item] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for any_of_type_0_item_data in _any_of_type_0:
                    any_of_type_0_item = SyncCombinedSearchBodyCompanyParamsAcceleratorsV2Type0AnyOfType0Item.from_dict(
                ...
                pass
            return cast(list[SyncCombinedSearchBodyCompanyParamsAcceleratorsV2Type0AnyOfType0Item] | None | Unset, data)

        any_of = _parse_any_of(d.pop("anyOf", UNSET))

        def _parse_none_of(
            data: object,
        ) -> list[SyncCombinedSearchBodyCompanyParamsAcceleratorsV2Type0NoneOfType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for none_of_type_0_item_data in _none_of_type_0:
                    none_of_type_0_item = (
                        SyncCombinedSearchBodyCompanyParamsAcceleratorsV2Type0NoneOfType0Item.from_dict(
                ...
                pass
            return cast(
                list[SyncCombinedSearchBodyCompanyParamsAcceleratorsV2Type0NoneOfType0Item] | None | Unset, data
            )
