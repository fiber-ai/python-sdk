...
T = TypeVar("T", bound="TextToCompanySearchParamsResponse200OutputSearchParamsInvestorsType0AnyOfType0Item")



@_attrs_define
class TextToCompanySearchParamsResponse200OutputSearchParamsInvestorsType0AnyOfType0Item:
    """ 
        Attributes:
            choco_uuid (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        text_to_company_search_params_response_200_output_search_params_investors_type_0_any_of_type_0_item = cls(
            choco_uuid=choco_uuid,
            id=id,
        ...
        text_to_company_search_params_response_200_output_search_params_investors_type_0_any_of_type_0_item.additional_properties = d
        return text_to_company_search_params_response_200_output_search_params_investors_type_0_any_of_type_0_item
