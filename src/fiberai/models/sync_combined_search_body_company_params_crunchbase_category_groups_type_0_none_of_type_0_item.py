...
from ..models.sync_combined_search_body_company_params_crunchbase_category_groups_type_0_none_of_type_0_item_type import (
    SyncCombinedSearchBodyCompanyParamsCrunchbaseCategoryGroupsType0NoneOfType0ItemType,
)
