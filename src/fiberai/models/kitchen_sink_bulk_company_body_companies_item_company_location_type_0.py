...
T = TypeVar("T", bound="KitchenSinkBulkCompanyBodyCompaniesItemCompanyLocationType0")


@_attrs_define
class KitchenSinkBulkCompanyBodyCompaniesItemCompanyLocationType0:
    """Company headquarters location. Helps disambiguate companies with similar names or domains by boosting matches in the
    specified location.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        kitchen_sink_bulk_company_body_companies_item_company_location_type_0 = cls(
            country_code=country_code,
            state_name=state_name,
            locality=locality,
        )

        kitchen_sink_bulk_company_body_companies_item_company_location_type_0.additional_properties = d
        return kitchen_sink_bulk_company_body_companies_item_company_location_type_0
