...
T = TypeVar("T", bound="CompanyCountBodySearchParamsLinkedinIndustriesType0")


@_attrs_define
class CompanyCountBodySearchParamsLinkedinIndustriesType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        company_count_body_search_params_linkedin_industries_type_0 = cls(
            any_of=any_of,
            none_of=none_of,
        )

        company_count_body_search_params_linkedin_industries_type_0.additional_properties = d
        return company_count_body_search_params_linkedin_industries_type_0
