...
T = TypeVar(
    "T",
    bound="TextToCombinedSearchParamResponse200OutputProfileSearchParamsType0KeywordsV2Type0OptionsType0FieldsToSearchOverType0",
)


@_attrs_define
class TextToCombinedSearchParamResponse200OutputProfileSearchParamsType0KeywordsV2Type0OptionsType0FieldsToSearchOverType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        text_to_combined_search_param_response_200_output_profile_search_params_type_0_keywords_v2_type_0_options_type_0_fields_to_search_over_type_0 = cls(
            summary=summary,
            headline=headline,
        ...
        text_to_combined_search_param_response_200_output_profile_search_params_type_0_keywords_v2_type_0_options_type_0_fields_to_search_over_type_0.additional_properties = d
        return text_to_combined_search_param_response_200_output_profile_search_params_type_0_keywords_v2_type_0_options_type_0_fields_to_search_over_type_0
