...
from ..models.create_saved_search_body_search_params_type_1_company_search_params_office_locations_v2_type_0_any_of_type_0_item_type_1_country_or_region_code import (
    CreateSavedSearchBodySearchParamsType1CompanySearchParamsOfficeLocationsV2Type0AnyOfType0ItemType1CountryOrRegionCode,
)
from ..models.create_saved_search_body_search_params_type_1_company_search_params_office_locations_v2_type_0_any_of_type_0_item_type_1_type import (
    CreateSavedSearchBodySearchParamsType1CompanySearchParamsOfficeLocationsV2Type0AnyOfType0ItemType1Type,
)

if TYPE_CHECKING:
    from ..models.create_saved_search_body_search_params_type_1_company_search_params_office_locations_v2_type_0_any_of_type_0_item_type_1_range import (
        CreateSavedSearchBodySearchParamsType1CompanySearchParamsOfficeLocationsV2Type0AnyOfType0ItemType1Range,
    )


T = TypeVar(
    "T", bound="CreateSavedSearchBodySearchParamsType1CompanySearchParamsOfficeLocationsV2Type0AnyOfType0ItemType1"
)
...
class CreateSavedSearchBodySearchParamsType1CompanySearchParamsOfficeLocationsV2Type0AnyOfType0ItemType1:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.create_saved_search_body_search_params_type_1_company_search_params_office_locations_v2_type_0_any_of_type_0_item_type_1_range import (
            CreateSavedSearchBodySearchParamsType1CompanySearchParamsOfficeLocationsV2Type0AnyOfType0ItemType1Range,  # noqa: PLC0415
        )
        ...
        range_ = CreateSavedSearchBodySearchParamsType1CompanySearchParamsOfficeLocationsV2Type0AnyOfType0ItemType1Range.from_dict(
            d.pop("range")
        )
