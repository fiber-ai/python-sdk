...
T = TypeVar("T", bound="KitchenSinkProfileBodyLinkedinHeadlineType0")
...
class KitchenSinkProfileBodyLinkedinHeadlineType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        kitchen_sink_profile_body_linkedin_headline_type_0 = cls(
            value=value,
            loose_match=loose_match,
        )


        kitchen_sink_profile_body_linkedin_headline_type_0.additional_properties = d
        return kitchen_sink_profile_body_linkedin_headline_type_0
