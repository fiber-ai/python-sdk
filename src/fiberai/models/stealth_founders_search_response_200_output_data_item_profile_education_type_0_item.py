...
T = TypeVar("T", bound="StealthFoundersSearchResponse200OutputDataItemProfileEducationType0Item")


@_attrs_define
class StealthFoundersSearchResponse200OutputDataItemProfileEducationType0Item:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        stealth_founders_search_response_200_output_data_item_profile_education_type_0_item = cls(
            school_id=school_id,
        ...
        stealth_founders_search_response_200_output_data_item_profile_education_type_0_item.additional_properties = d
        return stealth_founders_search_response_200_output_data_item_profile_education_type_0_item
