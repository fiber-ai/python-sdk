...
if TYPE_CHECKING:
    ...
    from ..models.rotate_webhook_endpoint_secret_response_200_output import RotateWebhookEndpointSecretResponse200Output
...
class RotateWebhookEndpointSecretResponse200:
    """
    Attributes:
        output (RotateWebhookEndpointSecretResponse200Output):
        charge_info (RotateWebhookEndpointSecretResponse200ChargeInfoType0 |
            RotateWebhookEndpointSecretResponse200ChargeInfoType1 | RotateWebhookEndpointSecretResponse200ChargeInfoType2 |
            RotateWebhookEndpointSecretResponse200ChargeInfoType3 | RotateWebhookEndpointSecretResponse200ChargeInfoType4):
        warnings (list[RotateWebhookEndpointSecretResponse200WarningsType0Item] | None | Unset): Warnings about
    ...
    warnings: list[RotateWebhookEndpointSecretResponse200WarningsType0Item] | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.charge_info, RotateWebhookEndpointSecretResponse200ChargeInfoType0):
            charge_info = self.charge_info.to_dict()
        elif isinstance(self.charge_info, RotateWebhookEndpointSecretResponse200ChargeInfoType1):
            charge_info = self.charge_info.to_dict()
        elif isinstance(self.charge_info, RotateWebhookEndpointSecretResponse200ChargeInfoType2):
            charge_info = self.charge_info.to_dict()
        elif isinstance(self.charge_info, RotateWebhookEndpointSecretResponse200ChargeInfoType3):
            charge_info = self.charge_info.to_dict()
        else:
            charge_info = self.charge_info.to_dict()
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        output = RotateWebhookEndpointSecretResponse200Output.from_dict(d.pop("output"))
        ...
        def _parse_charge_info(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_0 = RotateWebhookEndpointSecretResponse200ChargeInfoType0.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_1 = RotateWebhookEndpointSecretResponse200ChargeInfoType1.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_2 = RotateWebhookEndpointSecretResponse200ChargeInfoType2.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_3 = RotateWebhookEndpointSecretResponse200ChargeInfoType3.from_dict(data)
            ...
            if not isinstance(data, dict):
                raise TypeError()
            charge_info_type_4 = RotateWebhookEndpointSecretResponse200ChargeInfoType4.from_dict(data)
        ...
        def _parse_warnings(
            data: object,
        ) -> list[RotateWebhookEndpointSecretResponse200WarningsType0Item] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for warnings_type_0_item_data in _warnings_type_0:
                    warnings_type_0_item = RotateWebhookEndpointSecretResponse200WarningsType0Item.from_dict(
                ...
                pass
            return cast(list[RotateWebhookEndpointSecretResponse200WarningsType0Item] | None | Unset, data)
