...
if TYPE_CHECKING:
    from ..models.people_search_response_200_output_data_item_inferred_location_type_0_coordinates_type_0 import (
        PeopleSearchResponse200OutputDataItemInferredLocationType0CoordinatesType0,
    )


T = TypeVar("T", bound="PeopleSearchResponse200OutputDataItemInferredLocationType0")


@_attrs_define
class PeopleSearchResponse200OutputDataItemInferredLocationType0:
    """
    Attributes:
        ...
        coordinates (None | PeopleSearchResponse200OutputDataItemInferredLocationType0CoordinatesType0 | Unset):
    ...
    coordinates: None | PeopleSearchResponse200OutputDataItemInferredLocationType0CoordinatesType0 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.people_search_response_200_output_data_item_inferred_location_type_0_coordinates_type_0 import (
            PeopleSearchResponse200OutputDataItemInferredLocationType0CoordinatesType0,  # noqa: PLC0415
        )
        ...
        if isinstance(self.coordinates, Unset):
            coordinates = UNSET
        elif isinstance(self.coordinates, PeopleSearchResponse200OutputDataItemInferredLocationType0CoordinatesType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_coordinates(
            data: object,
        ) -> None | PeopleSearchResponse200OutputDataItemInferredLocationType0CoordinatesType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = (
                    PeopleSearchResponse200OutputDataItemInferredLocationType0CoordinatesType0.from_dict(data)
                )

                return coordinates_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PeopleSearchResponse200OutputDataItemInferredLocationType0CoordinatesType0 | Unset, data)
        ...
        people_search_response_200_output_data_item_inferred_location_type_0 = cls(
        ...
        people_search_response_200_output_data_item_inferred_location_type_0.additional_properties = d
        return people_search_response_200_output_data_item_inferred_location_type_0
