...
if TYPE_CHECKING:
  from ..models.people_search_response_200_output_data_item_inferred_location_type_0_coordinates_type_0 import PeopleSearchResponse200OutputDataItemInferredLocationType0CoordinatesType0
...
class PeopleSearchResponse200OutputDataItemInferredLocationType0:
    """ 
        Attributes:
            ...
            coordinates (Union['PeopleSearchResponse200OutputDataItemInferredLocationType0CoordinatesType0', None, Unset]):
    ...
    coordinates: Union['PeopleSearchResponse200OutputDataItemInferredLocationType0CoordinatesType0', None, Unset] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_coordinates(data: object) -> Union['PeopleSearchResponse200OutputDataItemInferredLocationType0CoordinatesType0', None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = PeopleSearchResponse200OutputDataItemInferredLocationType0CoordinatesType0.from_dict(data)
                ...
                pass
            return cast(Union['PeopleSearchResponse200OutputDataItemInferredLocationType0CoordinatesType0', None, Unset], data)
