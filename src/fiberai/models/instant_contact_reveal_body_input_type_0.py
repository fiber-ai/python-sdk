...
from ..models.instant_contact_reveal_body_input_type_0_mode import InstantContactRevealBodyInputType0Mode
from ..types import UNSET, Unset

T = TypeVar("T", bound="InstantContactRevealBodyInputType0")


@_attrs_define
class InstantContactRevealBodyInputType0:
    """
    Attributes:
        mode (InstantContactRevealBodyInputType0Mode):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        mode = InstantContactRevealBodyInputType0Mode(d.pop("mode"))
        ...
        instant_contact_reveal_body_input_type_0 = cls(
            mode=mode,
            linkedin_identifier=linkedin_identifier,
            full_name=full_name,
        )

        instant_contact_reveal_body_input_type_0.additional_properties = d
        return instant_contact_reveal_body_input_type_0
