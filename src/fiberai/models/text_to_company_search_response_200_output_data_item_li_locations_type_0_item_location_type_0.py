...
if TYPE_CHECKING:
    from ..models.text_to_company_search_response_200_output_data_item_li_locations_type_0_item_location_type_0_coordinates_type_0 import (
        TextToCompanySearchResponse200OutputDataItemLiLocationsType0ItemLocationType0CoordinatesType0,
    )
...
class TextToCompanySearchResponse200OutputDataItemLiLocationsType0ItemLocationType0:
    ...
    Attributes:
        ...
        coordinates (None |
            TextToCompanySearchResponse200OutputDataItemLiLocationsType0ItemLocationType0CoordinatesType0 | Unset):
    ...
    coordinates: (
        None | TextToCompanySearchResponse200OutputDataItemLiLocationsType0ItemLocationType0CoordinatesType0 | Unset
    ) = UNSET
        ...
        def _parse_coordinates(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = TextToCompanySearchResponse200OutputDataItemLiLocationsType0ItemLocationType0CoordinatesType0.from_dict(
                    data
                )
