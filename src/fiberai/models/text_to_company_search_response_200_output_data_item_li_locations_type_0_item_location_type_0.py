...
if TYPE_CHECKING:
  from ..models.text_to_company_search_response_200_output_data_item_li_locations_type_0_item_location_type_0_coordinates_type_0 import TextToCompanySearchResponse200OutputDataItemLiLocationsType0ItemLocationType0CoordinatesType0





T = TypeVar("T", bound="TextToCompanySearchResponse200OutputDataItemLiLocationsType0ItemLocationType0")



@_attrs_define
class TextToCompanySearchResponse200OutputDataItemLiLocationsType0ItemLocationType0:
    """ 
        Attributes:
            ...
            coordinates
                (Union['TextToCompanySearchResponse200OutputDataItemLiLocationsType0ItemLocationType0CoordinatesType0', None,
                Unset]):
    ...
    coordinates: Union['TextToCompanySearchResponse200OutputDataItemLiLocationsType0ItemLocationType0CoordinatesType0', None, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.coordinates, Unset):
            coordinates = UNSET
        elif isinstance(self.coordinates, TextToCompanySearchResponse200OutputDataItemLiLocationsType0ItemLocationType0CoordinatesType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_coordinates(data: object) -> Union['TextToCompanySearchResponse200OutputDataItemLiLocationsType0ItemLocationType0CoordinatesType0', None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = TextToCompanySearchResponse200OutputDataItemLiLocationsType0ItemLocationType0CoordinatesType0.from_dict(data)
                ...
                pass
            return cast(Union['TextToCompanySearchResponse200OutputDataItemLiLocationsType0ItemLocationType0CoordinatesType0', None, Unset], data)
        ...
        text_to_company_search_response_200_output_data_item_li_locations_type_0_item_location_type_0 = cls(
        ...
        text_to_company_search_response_200_output_data_item_li_locations_type_0_item_location_type_0.additional_properties = d
        return text_to_company_search_response_200_output_data_item_li_locations_type_0_item_location_type_0
