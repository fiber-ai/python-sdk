...
T = TypeVar("T", bound="CreateSavedSearchBodySearchParamsType0CompanySearchParamsInvestorsV2Type0")


@_attrs_define
class CreateSavedSearchBodySearchParamsType0CompanySearchParamsInvestorsV2Type0:
    """
    Attributes:
        any_of (list[CreateSavedSearchBodySearchParamsType0CompanySearchParamsInvestorsV2Type0AnyOfType0Item] | None |
            Unset):
        all_of (list[CreateSavedSearchBodySearchParamsType0CompanySearchParamsInvestorsV2Type0AllOfType0Item] | None |
            Unset):
        none_of (list[CreateSavedSearchBodySearchParamsType0CompanySearchParamsInvestorsV2Type0NoneOfType0Item] | None |
            Unset):
    """

    any_of: (
        list[CreateSavedSearchBodySearchParamsType0CompanySearchParamsInvestorsV2Type0AnyOfType0Item] | None | Unset
    ) = UNSET
    all_of: (
        list[CreateSavedSearchBodySearchParamsType0CompanySearchParamsInvestorsV2Type0AllOfType0Item] | None | Unset
    ) = UNSET
    none_of: (
        list[CreateSavedSearchBodySearchParamsType0CompanySearchParamsInvestorsV2Type0NoneOfType0Item] | None | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_any_of(
            ...
            try:
                ...
                for any_of_type_0_item_data in _any_of_type_0:
                    any_of_type_0_item = CreateSavedSearchBodySearchParamsType0CompanySearchParamsInvestorsV2Type0AnyOfType0Item.from_dict(
                ...
                pass
            return cast(
                list[CreateSavedSearchBodySearchParamsType0CompanySearchParamsInvestorsV2Type0AnyOfType0Item]
                | None
                | Unset,
                data,
            )
        ...
        def _parse_all_of(
            ...
            try:
                ...
                for all_of_type_0_item_data in _all_of_type_0:
                    all_of_type_0_item = CreateSavedSearchBodySearchParamsType0CompanySearchParamsInvestorsV2Type0AllOfType0Item.from_dict(
                ...
                pass
            return cast(
                list[CreateSavedSearchBodySearchParamsType0CompanySearchParamsInvestorsV2Type0AllOfType0Item]
                | None
                | Unset,
                data,
            )
        ...
        def _parse_none_of(
            ...
            list[CreateSavedSearchBodySearchParamsType0CompanySearchParamsInvestorsV2Type0NoneOfType0Item]
            | None
            | Unset
        ):
            if data is None:
            ...
            try:
                ...
                for none_of_type_0_item_data in _none_of_type_0:
                    none_of_type_0_item = CreateSavedSearchBodySearchParamsType0CompanySearchParamsInvestorsV2Type0NoneOfType0Item.from_dict(
        ...
        create_saved_search_body_search_params_type_0_company_search_params_investors_v2_type_0 = cls(
            any_of=any_of,
            all_of=all_of,
            none_of=none_of,
        )

        create_saved_search_body_search_params_type_0_company_search_params_investors_v2_type_0.additional_properties = d
        return create_saved_search_body_search_params_type_0_company_search_params_investors_v2_type_0
