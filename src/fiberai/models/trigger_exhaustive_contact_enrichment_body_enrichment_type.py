...
T = TypeVar("T", bound="TriggerExhaustiveContactEnrichmentBodyEnrichmentType")


@_attrs_define
class TriggerExhaustiveContactEnrichmentBodyEnrichmentType:
    """Enrichment types to be requested. Include the ones you want to look for. For example, { getWorkEmails: true,
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        trigger_exhaustive_contact_enrichment_body_enrichment_type = cls(
            get_work_emails=get_work_emails,
            get_personal_emails=get_personal_emails,
            get_phone_numbers=get_phone_numbers,
        )

        trigger_exhaustive_contact_enrichment_body_enrichment_type.additional_properties = d
        return trigger_exhaustive_contact_enrichment_body_enrichment_type
