...
T = TypeVar("T", bound="SyncCombinedSearchBodyCompanyParamsAcceleratorsV2Type0AnyOfType0ItemYearsType0")



@_attrs_define
class SyncCombinedSearchBodyCompanyParamsAcceleratorsV2Type0AnyOfType0ItemYearsType0:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sync_combined_search_body_company_params_accelerators_v2_type_0_any_of_type_0_item_years_type_0 = cls(
            lower_bound=lower_bound,
            upper_bound=upper_bound,
        )


        sync_combined_search_body_company_params_accelerators_v2_type_0_any_of_type_0_item_years_type_0.additional_properties = d
        return sync_combined_search_body_company_params_accelerators_v2_type_0_any_of_type_0_item_years_type_0
