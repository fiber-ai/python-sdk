...
from ..models.create_saved_search_body_search_params_type_0_company_search_params_crunchbase_category_groups_type_0_all_of_type_0_item_type import (
    CreateSavedSearchBodySearchParamsType0CompanySearchParamsCrunchbaseCategoryGroupsType0AllOfType0ItemType,
)

T = TypeVar(
    "T", bound="CreateSavedSearchBodySearchParamsType0CompanySearchParamsCrunchbaseCategoryGroupsType0AllOfType0Item"
)
