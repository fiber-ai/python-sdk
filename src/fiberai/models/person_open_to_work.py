...
from ..models.person_open_to_work_direction import PersonOpenToWorkDirection
from ..types import UNSET, Unset

T = TypeVar("T", bound="PersonOpenToWork")


@_attrs_define
class PersonOpenToWork:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        type_ = cast(Literal["person_open_to_work"], d.pop("type"))
        if type_ != "person_open_to_work":
            raise ValueError(f"type must match const 'person_open_to_work', got '{type_}'")
        ...
        direction = PersonOpenToWorkDirection(d.pop("direction"))
