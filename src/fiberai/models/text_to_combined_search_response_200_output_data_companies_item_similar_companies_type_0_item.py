...
T = TypeVar("T", bound="TextToCombinedSearchResponse200OutputDataCompaniesItemSimilarCompaniesType0Item")



@_attrs_define
class TextToCombinedSearchResponse200OutputDataCompaniesItemSimilarCompaniesType0Item:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        text_to_combined_search_response_200_output_data_companies_item_similar_companies_type_0_item = cls(
            name=name,
        ...
        text_to_combined_search_response_200_output_data_companies_item_similar_companies_type_0_item.additional_properties = d
        return text_to_combined_search_response_200_output_data_companies_item_similar_companies_type_0_item
