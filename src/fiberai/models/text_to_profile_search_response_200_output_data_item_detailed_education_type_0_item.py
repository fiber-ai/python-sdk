...
if TYPE_CHECKING:
    from ..models.text_to_profile_search_response_200_output_data_item_detailed_education_type_0_item_school_details_type_0 import (
        TextToProfileSearchResponse200OutputDataItemDetailedEducationType0ItemSchoolDetailsType0,
    )
...
class TextToProfileSearchResponse200OutputDataItemDetailedEducationType0Item:
    """
    Attributes:
        school_details (None | TextToProfileSearchResponse200OutputDataItemDetailedEducationType0ItemSchoolDetailsType0
            | Unset):
    ...
    school_details: (
        None | TextToProfileSearchResponse200OutputDataItemDetailedEducationType0ItemSchoolDetailsType0 | Unset
    ) = UNSET
        ...
        def _parse_school_details(
            ...
            try:
                ...
                school_details_type_0 = (
                    TextToProfileSearchResponse200OutputDataItemDetailedEducationType0ItemSchoolDetailsType0.from_dict(
                        data
                    )
                )
