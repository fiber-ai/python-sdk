...
T = TypeVar("T", bound="PollCombinedSearchResponse200OutputDataType1ItemsItemProjectsType0Item")


@_attrs_define
class PollCombinedSearchResponse200OutputDataType1ItemsItemProjectsType0Item:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        poll_combined_search_response_200_output_data_type_1_items_item_projects_type_0_item = cls(
        ...
        poll_combined_search_response_200_output_data_type_1_items_item_projects_type_0_item.additional_properties = d
        return poll_combined_search_response_200_output_data_type_1_items_item_projects_type_0_item
