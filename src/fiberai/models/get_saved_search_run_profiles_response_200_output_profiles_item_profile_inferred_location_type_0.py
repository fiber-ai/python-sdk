...
if TYPE_CHECKING:
  from ..models.get_saved_search_run_profiles_response_200_output_profiles_item_profile_inferred_location_type_0_coordinates_type_0 import GetSavedSearchRunProfilesResponse200OutputProfilesItemProfileInferredLocationType0CoordinatesType0





T = TypeVar("T", bound="GetSavedSearchRunProfilesResponse200OutputProfilesItemProfileInferredLocationType0")



@_attrs_define
class GetSavedSearchRunProfilesResponse200OutputProfilesItemProfileInferredLocationType0:
    """ 
        Attributes:
            ...
            coordinates
                (Union['GetSavedSearchRunProfilesResponse200OutputProfilesItemProfileInferredLocationType0CoordinatesType0',
                None, Unset]):
    ...
    coordinates: Union['GetSavedSearchRunProfilesResponse200OutputProfilesItemProfileInferredLocationType0CoordinatesType0', None, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.coordinates, Unset):
            coordinates = UNSET
        elif isinstance(self.coordinates, GetSavedSearchRunProfilesResponse200OutputProfilesItemProfileInferredLocationType0CoordinatesType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_coordinates(data: object) -> Union['GetSavedSearchRunProfilesResponse200OutputProfilesItemProfileInferredLocationType0CoordinatesType0', None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = GetSavedSearchRunProfilesResponse200OutputProfilesItemProfileInferredLocationType0CoordinatesType0.from_dict(data)
                ...
                pass
            return cast(Union['GetSavedSearchRunProfilesResponse200OutputProfilesItemProfileInferredLocationType0CoordinatesType0', None, Unset], data)
        ...
        get_saved_search_run_profiles_response_200_output_profiles_item_profile_inferred_location_type_0 = cls(
        ...
        get_saved_search_run_profiles_response_200_output_profiles_item_profile_inferred_location_type_0.additional_properties = d
        return get_saved_search_run_profiles_response_200_output_profiles_item_profile_inferred_location_type_0
