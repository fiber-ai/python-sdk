...
if TYPE_CHECKING:
    from ..models.get_saved_search_run_profiles_response_200_output_profiles_item_profile_inferred_location_type_0_coordinates_type_0 import (
        GetSavedSearchRunProfilesResponse200OutputProfilesItemProfileInferredLocationType0CoordinatesType0,
    )
...
class GetSavedSearchRunProfilesResponse200OutputProfilesItemProfileInferredLocationType0:
    ...
    Attributes:
        ...
        coordinates (GetSavedSearchRunProfilesResponse200OutputProfilesItemProfileInferredLocationType0CoordinatesType0
            | None | Unset):
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.get_saved_search_run_profiles_response_200_output_profiles_item_profile_inferred_location_type_0_coordinates_type_0 import (
            GetSavedSearchRunProfilesResponse200OutputProfilesItemProfileInferredLocationType0CoordinatesType0,  # noqa: PLC0415
        )
        ...
        def _parse_coordinates(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = GetSavedSearchRunProfilesResponse200OutputProfilesItemProfileInferredLocationType0CoordinatesType0.from_dict(
                    data
                )
