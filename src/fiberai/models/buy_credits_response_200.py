...
T = TypeVar("T", bound="BuyCreditsResponse200")


@_attrs_define
class BuyCreditsResponse200:
    """
    Attributes:
        output (BuyCreditsResponse200Output):
        charge_info (BuyCreditsResponse200ChargeInfoType0 | BuyCreditsResponse200ChargeInfoType1 |
            BuyCreditsResponse200ChargeInfoType2 | BuyCreditsResponse200ChargeInfoType3 |
            BuyCreditsResponse200ChargeInfoType4):
        warnings (list[BuyCreditsResponse200WarningsType0Item] | None | Unset): Warnings about extraneous fields in
            request
    ...
    output: BuyCreditsResponse200Output
    charge_info: (
        BuyCreditsResponse200ChargeInfoType0
        | BuyCreditsResponse200ChargeInfoType1
        | BuyCreditsResponse200ChargeInfoType2
        | BuyCreditsResponse200ChargeInfoType3
        | BuyCreditsResponse200ChargeInfoType4
    )
    warnings: list[BuyCreditsResponse200WarningsType0Item] | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.charge_info, BuyCreditsResponse200ChargeInfoType0):
            charge_info = self.charge_info.to_dict()
        elif isinstance(self.charge_info, BuyCreditsResponse200ChargeInfoType1):
            charge_info = self.charge_info.to_dict()
        elif isinstance(self.charge_info, BuyCreditsResponse200ChargeInfoType2):
            charge_info = self.charge_info.to_dict()
        elif isinstance(self.charge_info, BuyCreditsResponse200ChargeInfoType3):
            charge_info = self.charge_info.to_dict()
        else:
            charge_info = self.charge_info.to_dict()
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_charge_info(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_0 = BuyCreditsResponse200ChargeInfoType0.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_1 = BuyCreditsResponse200ChargeInfoType1.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_2 = BuyCreditsResponse200ChargeInfoType2.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_3 = BuyCreditsResponse200ChargeInfoType3.from_dict(data)
            ...
            if not isinstance(data, dict):
                raise TypeError()
            charge_info_type_4 = BuyCreditsResponse200ChargeInfoType4.from_dict(data)

            return charge_info_type_4

        charge_info = _parse_charge_info(d.pop("chargeInfo"))

        def _parse_warnings(data: object) -> list[BuyCreditsResponse200WarningsType0Item] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for warnings_type_0_item_data in _warnings_type_0:
                    warnings_type_0_item = BuyCreditsResponse200WarningsType0Item.from_dict(warnings_type_0_item_data)
                ...
                pass
            return cast(list[BuyCreditsResponse200WarningsType0Item] | None | Unset, data)
        ...
        return buy_credits_response_200
