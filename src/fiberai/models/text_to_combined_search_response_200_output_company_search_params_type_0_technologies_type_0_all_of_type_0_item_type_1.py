...
from ..models.text_to_combined_search_response_200_output_company_search_params_type_0_technologies_type_0_all_of_type_0_item_type_1_type import TextToCombinedSearchResponse200OutputCompanySearchParamsType0TechnologiesType0AllOfType0ItemType1Type
...
T = TypeVar("T", bound="TextToCombinedSearchResponse200OutputCompanySearchParamsType0TechnologiesType0AllOfType0ItemType1")
...
class TextToCombinedSearchResponse200OutputCompanySearchParamsType0TechnologiesType0AllOfType0ItemType1:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        type_ = TextToCombinedSearchResponse200OutputCompanySearchParamsType0TechnologiesType0AllOfType0ItemType1Type(d.pop("type"))
