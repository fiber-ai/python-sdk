...
T = TypeVar("T", bound="PaginatedCombinedSearchBodyProfileConfigType0SearchParamsApproxAgeType0")


@_attrs_define
class PaginatedCombinedSearchBodyProfileConfigType0SearchParamsApproxAgeType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        paginated_combined_search_body_profile_config_type_0_search_params_approx_age_type_0 = cls(
            lower_bound=lower_bound,
            upper_bound=upper_bound,
        )

        paginated_combined_search_body_profile_config_type_0_search_params_approx_age_type_0.additional_properties = d
        return paginated_combined_search_body_profile_config_type_0_search_params_approx_age_type_0
