...
if TYPE_CHECKING:
    from ..models.kitchen_sink_profile_response_200_output_data_item_detailed_education_type_0_item_school_details_type_0 import (
        KitchenSinkProfileResponse200OutputDataItemDetailedEducationType0ItemSchoolDetailsType0,
    )
...
class KitchenSinkProfileResponse200OutputDataItemDetailedEducationType0Item:
    """
    Attributes:
        school_details (KitchenSinkProfileResponse200OutputDataItemDetailedEducationType0ItemSchoolDetailsType0 | None |
            Unset):
    ...
    school_details: (
        KitchenSinkProfileResponse200OutputDataItemDetailedEducationType0ItemSchoolDetailsType0 | None | Unset
    ) = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.kitchen_sink_profile_response_200_output_data_item_detailed_education_type_0_item_school_details_type_0 import (
            KitchenSinkProfileResponse200OutputDataItemDetailedEducationType0ItemSchoolDetailsType0,  # noqa: PLC0415
        )
        ...
        if isinstance(self.school_details, Unset):
            ...
            self.school_details, KitchenSinkProfileResponse200OutputDataItemDetailedEducationType0ItemSchoolDetailsType0
        ):
        ...
        def _parse_school_details(
            ...
            try:
                ...
                school_details_type_0 = (
                    KitchenSinkProfileResponse200OutputDataItemDetailedEducationType0ItemSchoolDetailsType0.from_dict(
                        data
                    )
                )
