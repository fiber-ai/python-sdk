...
from ..models.poll_combined_search_response_200_output_data_type_1_items_item_current_job_type_0_academic_qualification_type_0_item import (
    PollCombinedSearchResponse200OutputDataType1ItemsItemCurrentJobType0AcademicQualificationType0Item,
)
from ..models.poll_combined_search_response_200_output_data_type_1_items_item_current_job_type_0_employment_type_type_0_item import (
    PollCombinedSearchResponse200OutputDataType1ItemsItemCurrentJobType0EmploymentTypeType0Item,
)
from ..models.poll_combined_search_response_200_output_data_type_1_items_item_current_job_type_0_job_function_type_0_item import (
    PollCombinedSearchResponse200OutputDataType1ItemsItemCurrentJobType0JobFunctionType0Item,
)
from ..models.poll_combined_search_response_200_output_data_type_1_items_item_current_job_type_0_seniority_type_1 import (
    PollCombinedSearchResponse200OutputDataType1ItemsItemCurrentJobType0SeniorityType1,
)
from ..models.poll_combined_search_response_200_output_data_type_1_items_item_current_job_type_0_seniority_type_2_type_1 import (
    PollCombinedSearchResponse200OutputDataType1ItemsItemCurrentJobType0SeniorityType2Type1,
)
from ..models.poll_combined_search_response_200_output_data_type_1_items_item_current_job_type_0_seniority_type_3_type_1 import (
...
class PollCombinedSearchResponse200OutputDataType1ItemsItemCurrentJobType0:
    ...
    Attributes:
        ...
        seniority (None | PollCombinedSearchResponse200OutputDataType1ItemsItemCurrentJobType0SeniorityType1 |
            PollCombinedSearchResponse200OutputDataType1ItemsItemCurrentJobType0SeniorityType2Type1 |
            PollCombinedSearchResponse200OutputDataType1ItemsItemCurrentJobType0SeniorityType3Type1 | Unset):
        job_function (list[PollCombinedSearchResponse200OutputDataType1ItemsItemCurrentJobType0JobFunctionType0Item] |
            None | Unset):
        employment_type
            (list[PollCombinedSearchResponse200OutputDataType1ItemsItemCurrentJobType0EmploymentTypeType0Item] | None |
            Unset):
        academic_qualification
            (list[PollCombinedSearchResponse200OutputDataType1ItemsItemCurrentJobType0AcademicQualificationType0Item] | None
            | Unset):
    ...
    job_function: (
        list[PollCombinedSearchResponse200OutputDataType1ItemsItemCurrentJobType0JobFunctionType0Item] | None | Unset
    ) = UNSET
    employment_type: (
        list[PollCombinedSearchResponse200OutputDataType1ItemsItemCurrentJobType0EmploymentTypeType0Item] | None | Unset
    ) = UNSET
    academic_qualification: (
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.seniority, Unset):
            ...
            self.seniority, PollCombinedSearchResponse200OutputDataType1ItemsItemCurrentJobType0SeniorityType1
        ):
            seniority = self.seniority.value
        elif isinstance(
            self.seniority, PollCombinedSearchResponse200OutputDataType1ItemsItemCurrentJobType0SeniorityType2Type1
        ):
            seniority = self.seniority.value
        elif isinstance(
            self.seniority, PollCombinedSearchResponse200OutputDataType1ItemsItemCurrentJobType0SeniorityType3Type1
        ):
            seniority = self.seniority.value
        else:
        ...
        def _parse_seniority(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                seniority_type_1 = PollCombinedSearchResponse200OutputDataType1ItemsItemCurrentJobType0SeniorityType1(
                    data
                )
            ...
            try:
                ...
                seniority_type_2_type_1 = (
                    PollCombinedSearchResponse200OutputDataType1ItemsItemCurrentJobType0SeniorityType2Type1(data)
                )
            ...
            try:
                ...
                seniority_type_3_type_1 = (
                    PollCombinedSearchResponse200OutputDataType1ItemsItemCurrentJobType0SeniorityType3Type1(data)
                )
        ...
        def _parse_academic_qualification(
            ...
            try:
                ...
                for academic_qualification_type_0_item_data in _academic_qualification_type_0:
                    academic_qualification_type_0_item = PollCombinedSearchResponse200OutputDataType1ItemsItemCurrentJobType0AcademicQualificationType0Item(
