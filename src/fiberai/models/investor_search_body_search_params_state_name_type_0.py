...
T = TypeVar("T", bound="InvestorSearchBodySearchParamsStateNameType0")



@_attrs_define
class InvestorSearchBodySearchParamsStateNameType0:
    """ State name filter with include/exclude pattern. Use full state names (e.g., 'California', 'England', 'New York').
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        investor_search_body_search_params_state_name_type_0 = cls(
            any_of=any_of,
            none_of=none_of,
        )


        investor_search_body_search_params_state_name_type_0.additional_properties = d
        return investor_search_body_search_params_state_name_type_0
