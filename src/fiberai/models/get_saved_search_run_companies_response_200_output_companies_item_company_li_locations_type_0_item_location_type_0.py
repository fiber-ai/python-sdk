...
if TYPE_CHECKING:
    from ..models.get_saved_search_run_companies_response_200_output_companies_item_company_li_locations_type_0_item_location_type_0_coordinates_type_0 import (
        GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyLiLocationsType0ItemLocationType0CoordinatesType0,
    )


T = TypeVar(
    "T", bound="GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyLiLocationsType0ItemLocationType0"
)
...
class GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyLiLocationsType0ItemLocationType0:
    ...
    Attributes:
        ...
        coordinates (GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyLiLocationsType0ItemLocationType0Coo
            rdinatesType0 | None | Unset):
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.get_saved_search_run_companies_response_200_output_companies_item_company_li_locations_type_0_item_location_type_0_coordinates_type_0 import (
            GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyLiLocationsType0ItemLocationType0CoordinatesType0,  # noqa: PLC0415
        )
        ...
        def _parse_coordinates(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyLiLocationsType0ItemLocationType0CoordinatesType0.from_dict(
                    data
                )
