...
from ..models.sync_combined_search_body_company_params_office_locations_v2_type_0_none_of_type_0_item_type_0_type import SyncCombinedSearchBodyCompanyParamsOfficeLocationsV2Type0NoneOfType0ItemType0Type
from typing import cast

if TYPE_CHECKING:
  from ..models.sync_combined_search_body_company_params_office_locations_v2_type_0_none_of_type_0_item_type_0_range import SyncCombinedSearchBodyCompanyParamsOfficeLocationsV2Type0NoneOfType0ItemType0Range
...
class SyncCombinedSearchBodyCompanyParamsOfficeLocationsV2Type0NoneOfType0ItemType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        range_ = SyncCombinedSearchBodyCompanyParamsOfficeLocationsV2Type0NoneOfType0ItemType0Range.from_dict(d.pop("range"))
