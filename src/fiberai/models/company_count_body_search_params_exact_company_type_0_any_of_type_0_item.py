...
from ..models.company_count_body_search_params_exact_company_type_0_any_of_type_0_item_source_type_1 import (
    CompanyCountBodySearchParamsExactCompanyType0AnyOfType0ItemSourceType1,
)
from ..models.company_count_body_search_params_exact_company_type_0_any_of_type_0_item_source_type_2_type_1 import (
    CompanyCountBodySearchParamsExactCompanyType0AnyOfType0ItemSourceType2Type1,
)
from ..models.company_count_body_search_params_exact_company_type_0_any_of_type_0_item_source_type_3_type_1 import (
    CompanyCountBodySearchParamsExactCompanyType0AnyOfType0ItemSourceType3Type1,
)
...
class CompanyCountBodySearchParamsExactCompanyType0AnyOfType0Item:
    ...
    Attributes:
        ...
        source (CompanyCountBodySearchParamsExactCompanyType0AnyOfType0ItemSourceType1 |
            CompanyCountBodySearchParamsExactCompanyType0AnyOfType0ItemSourceType2Type1 |
