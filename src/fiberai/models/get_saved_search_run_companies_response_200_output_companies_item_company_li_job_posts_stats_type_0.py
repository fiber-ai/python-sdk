...
class GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyLiJobPostsStatsType0:
    ...
    Attributes:
        total_count (float):
        seniority_stats
            (GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyLiJobPostsStatsType0SeniorityStatsType0 | None |
            Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_seniority_stats(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                seniority_stats_type_0 = GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyLiJobPostsStatsType0SeniorityStatsType0.from_dict(
                    data
                )
        ...
        def _parse_employment_type_stats(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                employment_type_stats_type_0 = GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyLiJobPostsStatsType0EmploymentTypeStatsType0.from_dict(
                    data
                )
        ...
        def _parse_country_location_stats(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                country_location_stats_type_0 = GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyLiJobPostsStatsType0CountryLocationStatsType0.from_dict(
                    data
                )
        ...
        def _parse_puree_job_functions_stats(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                puree_job_functions_stats_type_0 = GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyLiJobPostsStatsType0PureeJobFunctionsStatsType0.from_dict(
                    data
                )
        ...
        def _parse_standard_industries_stats(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                standard_industries_stats_type_0 = GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyLiJobPostsStatsType0StandardIndustriesStatsType0.from_dict(
                    data
                )
        ...
        def _parse_job_location_type_stats(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                job_location_type_stats_type_0 = GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyLiJobPostsStatsType0JobLocationTypeStatsType0.from_dict(
                    data
                )
