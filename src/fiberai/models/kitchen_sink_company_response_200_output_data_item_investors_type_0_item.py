...
T = TypeVar("T", bound="KitchenSinkCompanyResponse200OutputDataItemInvestorsType0Item")


@_attrs_define
class KitchenSinkCompanyResponse200OutputDataItemInvestorsType0Item:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        kitchen_sink_company_response_200_output_data_item_investors_type_0_item = cls(
            logo_url=logo_url,
        ...
        kitchen_sink_company_response_200_output_data_item_investors_type_0_item.additional_properties = d
        return kitchen_sink_company_response_200_output_data_item_investors_type_0_item
