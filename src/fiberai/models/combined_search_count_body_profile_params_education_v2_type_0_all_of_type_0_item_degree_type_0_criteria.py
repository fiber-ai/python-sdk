...
T = TypeVar("T", bound="CombinedSearchCountBodyProfileParamsEducationV2Type0AllOfType0ItemDegreeType0Criteria")


@_attrs_define
class CombinedSearchCountBodyProfileParamsEducationV2Type0AllOfType0ItemDegreeType0Criteria:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        combined_search_count_body_profile_params_education_v2_type_0_all_of_type_0_item_degree_type_0_criteria = cls(
            any_of=any_of,
            none_of=none_of,
        )

        combined_search_count_body_profile_params_education_v2_type_0_all_of_type_0_item_degree_type_0_criteria.additional_properties = d
        return combined_search_count_body_profile_params_education_v2_type_0_all_of_type_0_item_degree_type_0_criteria
