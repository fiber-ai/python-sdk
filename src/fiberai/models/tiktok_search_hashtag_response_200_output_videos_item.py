...
T = TypeVar("T", bound="TiktokSearchHashtagResponse200OutputVideosItem")


@_attrs_define
class TiktokSearchHashtagResponse200OutputVideosItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        tiktok_search_hashtag_response_200_output_videos_item = cls(
            id=id,
            caption=caption,
        ...
        tiktok_search_hashtag_response_200_output_videos_item.additional_properties = d
        return tiktok_search_hashtag_response_200_output_videos_item
