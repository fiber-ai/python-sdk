...
T = TypeVar("T", bound="KitchenSinkCompanyResponse200OutputDataItemLocationsStatsType0")


@_attrs_define
class KitchenSinkCompanyResponse200OutputDataItemLocationsStatsType0:
    """
    Attributes:
        usa (float | Unset):
        gbr (float | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        kitchen_sink_company_response_200_output_data_item_locations_stats_type_0 = cls(
            usa=usa,
            gbr=gbr,
            fra=fra,
            ind=ind,
        ...
        return kitchen_sink_company_response_200_output_data_item_locations_stats_type_0
