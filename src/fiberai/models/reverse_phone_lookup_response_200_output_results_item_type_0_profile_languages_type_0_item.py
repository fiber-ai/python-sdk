...
T = TypeVar("T", bound="ReversePhoneLookupResponse200OutputResultsItemType0ProfileLanguagesType0Item")


@_attrs_define
class ReversePhoneLookupResponse200OutputResultsItemType0ProfileLanguagesType0Item:
    """
    Attributes:
        name (None | str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reverse_phone_lookup_response_200_output_results_item_type_0_profile_languages_type_0_item = cls(
            name=name,
            proficiency_id=proficiency_id,
            proficiency_name=proficiency_name,
        )

        reverse_phone_lookup_response_200_output_results_item_type_0_profile_languages_type_0_item.additional_properties = d
        return reverse_phone_lookup_response_200_output_results_item_type_0_profile_languages_type_0_item
