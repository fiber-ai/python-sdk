...
T = TypeVar("T", bound="FlightSearchResponse200OutputAirportsItemArrivalItem")


@_attrs_define
class FlightSearchResponse200OutputAirportsItemArrivalItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        flight_search_response_200_output_airports_item_arrival_item = cls(
            iata_code=iata_code,
            name=name,
            city=city,
        ...
        flight_search_response_200_output_airports_item_arrival_item.additional_properties = d
        return flight_search_response_200_output_airports_item_arrival_item
