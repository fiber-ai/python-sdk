...
T = TypeVar("T", bound="SyncCombinedSearchBodyProfileParamsKeywordsType0")


@_attrs_define
class SyncCombinedSearchBodyProfileParamsKeywordsType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sync_combined_search_body_profile_params_keywords_type_0 = cls(
            contains_all=contains_all,
            contains_any=contains_any,
            contains_none=contains_none,
        )

        sync_combined_search_body_profile_params_keywords_type_0.additional_properties = d
        return sync_combined_search_body_profile_params_keywords_type_0
