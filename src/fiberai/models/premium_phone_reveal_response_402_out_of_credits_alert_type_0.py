...
T = TypeVar("T", bound="PremiumPhoneRevealResponse402OutOfCreditsAlertType0")


@_attrs_define
class PremiumPhoneRevealResponse402OutOfCreditsAlertType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        premium_phone_reveal_response_402_out_of_credits_alert_type_0 = cls(
            get_more_credits_url=get_more_credits_url,
            message=message,
            available_credits=available_credits,
        )

        premium_phone_reveal_response_402_out_of_credits_alert_type_0.additional_properties = d
        return premium_phone_reveal_response_402_out_of_credits_alert_type_0
