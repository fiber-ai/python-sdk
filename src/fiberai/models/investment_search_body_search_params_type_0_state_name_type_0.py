...
T = TypeVar("T", bound="InvestmentSearchBodySearchParamsType0StateNameType0")


@_attrs_define
class InvestmentSearchBodySearchParamsType0StateNameType0:
    """Round location state name filter with include/exclude pattern. Use full state names (e.g., 'California', 'England',
    'New York'). State codes like 'CA' or 'NY' are not accepted.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        investment_search_body_search_params_type_0_state_name_type_0 = cls(
            any_of=any_of,
            none_of=none_of,
        )

        investment_search_body_search_params_type_0_state_name_type_0.additional_properties = d
        return investment_search_body_search_params_type_0_state_name_type_0
