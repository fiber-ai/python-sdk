...
from ..models.text_to_profile_search_params_response_200_output_search_params_tags_type_0_any_of_type_0_item_slug import (
    TextToProfileSearchParamsResponse200OutputSearchParamsTagsType0AnyOfType0ItemSlug,
)
