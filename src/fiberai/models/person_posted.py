...
T = TypeVar("T", bound="PersonPosted")
...
class PersonPosted:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        type_ = cast(Literal["person_posted"], d.pop("type"))
        if type_ != "person_posted":
            raise ValueError(f"type must match const 'person_posted', got '{type_}'")
        ...
        person_posted.additional_properties = d
        return person_posted
