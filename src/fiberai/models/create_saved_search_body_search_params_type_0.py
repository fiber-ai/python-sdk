...
if TYPE_CHECKING:
  from ..models.create_saved_search_body_search_params_type_0_company_search_params import CreateSavedSearchBodySearchParamsType0CompanySearchParams
  from ..models.create_saved_search_body_search_params_type_0_profile_search_params import CreateSavedSearchBodySearchParamsType0ProfileSearchParams
...
class CreateSavedSearchBodySearchParamsType0:
    """ combined
        ...
        Attributes:
            ...
            max_companies (Union[None, Unset, int]): Max companies to find. Defaults to 10000 if not provided. Default:
                10000.
            profile_search_params (Union[Unset, CreateSavedSearchBodySearchParamsType0ProfileSearchParams]): The profile
    ...
    max_companies: Union[None, Unset, int] = 10000
    profile_search_params: Union[Unset, 'CreateSavedSearchBodySearchParamsType0ProfileSearchParams'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        company_search_params = CreateSavedSearchBodySearchParamsType0CompanySearchParams.from_dict(d.pop("companySearchParams"))
        ...
        profile_search_params: Union[Unset, CreateSavedSearchBodySearchParamsType0ProfileSearchParams]
        if isinstance(_profile_search_params,  Unset):
            profile_search_params = UNSET
        else:
            profile_search_params = CreateSavedSearchBodySearchParamsType0ProfileSearchParams.from_dict(_profile_search_params)
