...
T = TypeVar("T", bound="TextToProfileSearchResponse200OutputSearchParamsJobStatusType1LeftAtType0RangeType0")



@_attrs_define
class TextToProfileSearchResponse200OutputSearchParamsJobStatusType1LeftAtType0RangeType0:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        text_to_profile_search_response_200_output_search_params_job_status_type_1_left_at_type_0_range_type_0 = cls(
            lower_bound=lower_bound,
            upper_bound=upper_bound,
        )


        text_to_profile_search_response_200_output_search_params_job_status_type_1_left_at_type_0_range_type_0.additional_properties = d
        return text_to_profile_search_response_200_output_search_params_job_status_type_1_left_at_type_0_range_type_0
