...
from ..models.kitchen_sink_bulk_profile_response_200_output_data_item_item_detailed_work_experiences_type_0_item_academic_qualification_type_0_item import (
    KitchenSinkBulkProfileResponse200OutputDataItemItemDetailedWorkExperiencesType0ItemAcademicQualificationType0Item,
)
from ..models.kitchen_sink_bulk_profile_response_200_output_data_item_item_detailed_work_experiences_type_0_item_employment_type_type_0_item import (
    KitchenSinkBulkProfileResponse200OutputDataItemItemDetailedWorkExperiencesType0ItemEmploymentTypeType0Item,
)
from ..models.kitchen_sink_bulk_profile_response_200_output_data_item_item_detailed_work_experiences_type_0_item_job_function_type_0_item import (
    KitchenSinkBulkProfileResponse200OutputDataItemItemDetailedWorkExperiencesType0ItemJobFunctionType0Item,
)
from ..models.kitchen_sink_bulk_profile_response_200_output_data_item_item_detailed_work_experiences_type_0_item_seniority_type_1 import (
    KitchenSinkBulkProfileResponse200OutputDataItemItemDetailedWorkExperiencesType0ItemSeniorityType1,
)
from ..models.kitchen_sink_bulk_profile_response_200_output_data_item_item_detailed_work_experiences_type_0_item_seniority_type_2_type_1 import (
    KitchenSinkBulkProfileResponse200OutputDataItemItemDetailedWorkExperiencesType0ItemSeniorityType2Type1,
)
from ..models.kitchen_sink_bulk_profile_response_200_output_data_item_item_detailed_work_experiences_type_0_item_seniority_type_3_type_1 import (
    KitchenSinkBulkProfileResponse200OutputDataItemItemDetailedWorkExperiencesType0ItemSeniorityType3Type1,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.kitchen_sink_bulk_profile_response_200_output_data_item_item_detailed_work_experiences_type_0_item_company_details_type_0 import (
        KitchenSinkBulkProfileResponse200OutputDataItemItemDetailedWorkExperiencesType0ItemCompanyDetailsType0,
    )
...
class KitchenSinkBulkProfileResponse200OutputDataItemItemDetailedWorkExperiencesType0Item:
    ...
    Attributes:
        ...
        seniority (KitchenSinkBulkProfileResponse200OutputDataItemItemDetailedWorkExperiencesType0ItemSeniorityType1 |
            KitchenSinkBulkProfileResponse200OutputDataItemItemDetailedWorkExperiencesType0ItemSeniorityType2Type1 |
        ...
        job_function
            ...
            None | Unset):
        employment_type (list[KitchenSinkBulkProfileResponse200OutputDataItemItemDetailedWorkExperiencesType0ItemEmploym
            entTypeType0Item] | None | Unset):
        academic_qualification (list[KitchenSinkBulkProfileResponse200OutputDataItemItemDetailedWorkExperiencesType0Item
            AcademicQualificationType0Item] | None | Unset):
    ...
    employment_type: (
        list[KitchenSinkBulkProfileResponse200OutputDataItemItemDetailedWorkExperiencesType0ItemEmploymentTypeType0Item]
        | None
        | Unset
    ) = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.kitchen_sink_bulk_profile_response_200_output_data_item_item_detailed_work_experiences_type_0_item_company_details_type_0 import (
            KitchenSinkBulkProfileResponse200OutputDataItemItemDetailedWorkExperiencesType0ItemCompanyDetailsType0,  # noqa: PLC0415
        )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_company_details(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                company_details_type_0 = KitchenSinkBulkProfileResponse200OutputDataItemItemDetailedWorkExperiencesType0ItemCompanyDetailsType0.from_dict(
                    data
                )
        ...
        def _parse_seniority(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                seniority_type_2_type_1 = KitchenSinkBulkProfileResponse200OutputDataItemItemDetailedWorkExperiencesType0ItemSeniorityType2Type1(
                    data
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                seniority_type_3_type_1 = KitchenSinkBulkProfileResponse200OutputDataItemItemDetailedWorkExperiencesType0ItemSeniorityType3Type1(
                    data
                )
        ...
        def _parse_job_function(
            ...
            try:
                ...
                for job_function_type_0_item_data in _job_function_type_0:
                    job_function_type_0_item = KitchenSinkBulkProfileResponse200OutputDataItemItemDetailedWorkExperiencesType0ItemJobFunctionType0Item(
        ...
        def _parse_employment_type(
            ...
            try:
                ...
                for employment_type_type_0_item_data in _employment_type_type_0:
                    employment_type_type_0_item = KitchenSinkBulkProfileResponse200OutputDataItemItemDetailedWorkExperiencesType0ItemEmploymentTypeType0Item(
        ...
        def _parse_academic_qualification(
            ...
            try:
                ...
                for academic_qualification_type_0_item_data in _academic_qualification_type_0:
                    academic_qualification_type_0_item = KitchenSinkBulkProfileResponse200OutputDataItemItemDetailedWorkExperiencesType0ItemAcademicQualificationType0Item(
