...
class CompanySearchBodySearchParamsEmployeesType0RulesItem:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(
            self.employees_to_match, CompanySearchBodySearchParamsEmployeesType0RulesItemEmployeesToMatchType0
        ):
        ...
        if isinstance(self.employee_filters, Unset):
            ...
            self.employee_filters, CompanySearchBodySearchParamsEmployeesType0RulesItemEmployeeFiltersType0
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_employees_to_match(
            ...
            try:
                ...
                employees_to_match_type_0 = (
                    CompanySearchBodySearchParamsEmployeesType0RulesItemEmployeesToMatchType0.from_dict(data)
                )
            ...
            employees_to_match_type_1 = (
                CompanySearchBodySearchParamsEmployeesType0RulesItemEmployeesToMatchType1.from_dict(data)
            )
        ...
        def _parse_employee_filters(
            data: object,
        ) -> CompanySearchBodySearchParamsEmployeesType0RulesItemEmployeeFiltersType0 | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                employee_filters_type_0 = (
                    CompanySearchBodySearchParamsEmployeesType0RulesItemEmployeeFiltersType0.from_dict(data)
                )

                return employee_filters_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(CompanySearchBodySearchParamsEmployeesType0RulesItemEmployeeFiltersType0 | None | Unset, data)
