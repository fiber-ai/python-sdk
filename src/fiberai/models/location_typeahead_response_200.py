...
if TYPE_CHECKING:
    ...
    from ..models.location_typeahead_response_200_charge_info_type_4 import LocationTypeaheadResponse200ChargeInfoType4
...
class LocationTypeaheadResponse200:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.charge_info, LocationTypeaheadResponse200ChargeInfoType0):
            ...
            charge_info = self.charge_info.to_dict()
        elif isinstance(self.charge_info, LocationTypeaheadResponse200ChargeInfoType3):
            charge_info = self.charge_info.to_dict()
        else:
            charge_info = self.charge_info.to_dict()
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_charge_info(
            ...
            if not isinstance(data, dict):
                raise TypeError()
            charge_info_type_4 = LocationTypeaheadResponse200ChargeInfoType4.from_dict(data)
        ...
        def _parse_warnings(data: object) -> list[LocationTypeaheadResponse200WarningsType0Item] | None | Unset:
            ...
            try:
                ...
                for warnings_type_0_item_data in _warnings_type_0:
                    warnings_type_0_item = LocationTypeaheadResponse200WarningsType0Item.from_dict(
                ...
                pass
            return cast(list[LocationTypeaheadResponse200WarningsType0Item] | None | Unset, data)
