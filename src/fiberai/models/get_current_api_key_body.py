...
from ..models.get_current_api_key_body_target import GetCurrentApiKeyBodyTarget
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetCurrentApiKeyBody")


@_attrs_define
class GetCurrentApiKeyBody:
    """
    Attributes:
        api_key (str): Your Fiber API key
        target (GetCurrentApiKeyBodyTarget | Unset): Which key to act on. SELF acts on the key that authenticates this
            request. OTHER acts on a different key in your organization, supplied in targetApiKey. Default:
            GetCurrentApiKeyBodyTarget.SELF.
    ...
    api_key: str
    target: GetCurrentApiKeyBodyTarget | Unset = GetCurrentApiKeyBodyTarget.SELF
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        target: GetCurrentApiKeyBodyTarget | Unset
        if isinstance(_target, Unset):
            target = UNSET
        else:
            target = GetCurrentApiKeyBodyTarget(_target)
        ...
        get_current_api_key_body = cls(
            api_key=api_key,
            target=target,
            target_api_key=target_api_key,
        )

        get_current_api_key_body.additional_properties = d
        return get_current_api_key_body
