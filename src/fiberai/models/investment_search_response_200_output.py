...
if TYPE_CHECKING:
    from ..models.investment_search_response_200_output_investments_item import (
        InvestmentSearchResponse200OutputInvestmentsItem,
    )
...
class InvestmentSearchResponse200Output:
    ...
    Attributes:
        ...
        next_cursor (None | str): Pagination cursor for the next page. Null if there are no more results.
    """
