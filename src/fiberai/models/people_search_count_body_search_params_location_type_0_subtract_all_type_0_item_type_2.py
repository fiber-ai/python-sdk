...
if TYPE_CHECKING:
    from ..models.people_search_count_body_search_params_location_type_0_subtract_all_type_0_item_type_2_vertices_item import (
        PeopleSearchCountBodySearchParamsLocationType0SubtractAllType0ItemType2VerticesItem,
    )
...
class PeopleSearchCountBodySearchParamsLocationType0SubtractAllType0ItemType2:
    ...
    Attributes:
        ...
        vertices (list[PeopleSearchCountBodySearchParamsLocationType0SubtractAllType0ItemType2VerticesItem]):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.people_search_count_body_search_params_location_type_0_subtract_all_type_0_item_type_2_vertices_item import (
            PeopleSearchCountBodySearchParamsLocationType0SubtractAllType0ItemType2VerticesItem,  # noqa: PLC0415
        )
        ...
        for vertices_item_data in _vertices:
            vertices_item = (
                PeopleSearchCountBodySearchParamsLocationType0SubtractAllType0ItemType2VerticesItem.from_dict(
                    vertices_item_data
                )
            )
