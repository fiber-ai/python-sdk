...
from ..models.create_saved_search_body_search_params_type_0_profile_search_params_stealth_v2_type_1_stealth_duration_type_0_period import (
    CreateSavedSearchBodySearchParamsType0ProfileSearchParamsStealthV2Type1StealthDurationType0Period,
)

if TYPE_CHECKING:
    from ..models.create_saved_search_body_search_params_type_0_profile_search_params_stealth_v2_type_1_stealth_duration_type_0_range import (
        CreateSavedSearchBodySearchParamsType0ProfileSearchParamsStealthV2Type1StealthDurationType0Range,
    )
...
class CreateSavedSearchBodySearchParamsType0ProfileSearchParamsStealthV2Type1StealthDurationType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.create_saved_search_body_search_params_type_0_profile_search_params_stealth_v2_type_1_stealth_duration_type_0_range import (
            CreateSavedSearchBodySearchParamsType0ProfileSearchParamsStealthV2Type1StealthDurationType0Range,  # noqa: PLC0415
        )

        d = dict(src_dict)
        range_ = (
            CreateSavedSearchBodySearchParamsType0ProfileSearchParamsStealthV2Type1StealthDurationType0Range.from_dict(
                d.pop("range")
            )
        )
