...
T = TypeVar("T", bound="TextToCombinedSearchResponse200OutputCompanySearchParamsType0InvestorsType0AnyOfType0Item")



@_attrs_define
class TextToCombinedSearchResponse200OutputCompanySearchParamsType0InvestorsType0AnyOfType0Item:
    """ 
        Attributes:
            choco_uuid (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        text_to_combined_search_response_200_output_company_search_params_type_0_investors_type_0_any_of_type_0_item = cls(
            choco_uuid=choco_uuid,
            id=id,
        ...
        text_to_combined_search_response_200_output_company_search_params_type_0_investors_type_0_any_of_type_0_item.additional_properties = d
        return text_to_combined_search_response_200_output_company_search_params_type_0_investors_type_0_any_of_type_0_item
