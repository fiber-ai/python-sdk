...
T = TypeVar("T", bound="StartBatchContactDetailsBodyEnrichmentTypes")


@_attrs_define
class StartBatchContactDetailsBodyEnrichmentTypes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        start_batch_contact_details_body_enrichment_types = cls(
            get_work_emails=get_work_emails,
            get_personal_emails=get_personal_emails,
            get_phone_numbers=get_phone_numbers,
        )

        start_batch_contact_details_body_enrichment_types.additional_properties = d
        return start_batch_contact_details_body_enrichment_types
