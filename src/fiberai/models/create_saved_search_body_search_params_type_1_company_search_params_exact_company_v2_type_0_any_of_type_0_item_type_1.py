...
from ..models.create_saved_search_body_search_params_type_1_company_search_params_exact_company_v2_type_0_any_of_type_0_item_type_1_identifier import (
    CreateSavedSearchBodySearchParamsType1CompanySearchParamsExactCompanyV2Type0AnyOfType0ItemType1Identifier,
)

T = TypeVar(
    "T", bound="CreateSavedSearchBodySearchParamsType1CompanySearchParamsExactCompanyV2Type0AnyOfType0ItemType1"
)
