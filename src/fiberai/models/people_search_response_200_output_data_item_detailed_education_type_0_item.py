...
if TYPE_CHECKING:
    from ..models.people_search_response_200_output_data_item_detailed_education_type_0_item_school_details_type_0 import (
        PeopleSearchResponse200OutputDataItemDetailedEducationType0ItemSchoolDetailsType0,
    )
...
class PeopleSearchResponse200OutputDataItemDetailedEducationType0Item:
    """
    Attributes:
        school_details (None | PeopleSearchResponse200OutputDataItemDetailedEducationType0ItemSchoolDetailsType0 |
            Unset):
    ...
    school_details: None | PeopleSearchResponse200OutputDataItemDetailedEducationType0ItemSchoolDetailsType0 | Unset = (
        UNSET
    )
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.people_search_response_200_output_data_item_detailed_education_type_0_item_school_details_type_0 import (
            PeopleSearchResponse200OutputDataItemDetailedEducationType0ItemSchoolDetailsType0,  # noqa: PLC0415
        )
        ...
        if isinstance(self.school_details, Unset):
            ...
            self.school_details, PeopleSearchResponse200OutputDataItemDetailedEducationType0ItemSchoolDetailsType0
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_school_details(
            data: object,
        ) -> None | PeopleSearchResponse200OutputDataItemDetailedEducationType0ItemSchoolDetailsType0 | Unset:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                school_details_type_0 = (
                    PeopleSearchResponse200OutputDataItemDetailedEducationType0ItemSchoolDetailsType0.from_dict(data)
                )
                ...
                pass
            return cast(
                None | PeopleSearchResponse200OutputDataItemDetailedEducationType0ItemSchoolDetailsType0 | Unset, data
            )
