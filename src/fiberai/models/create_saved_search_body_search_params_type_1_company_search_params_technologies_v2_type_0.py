...
T = TypeVar("T", bound="CreateSavedSearchBodySearchParamsType1CompanySearchParamsTechnologiesV2Type0")


@_attrs_define
class CreateSavedSearchBodySearchParamsType1CompanySearchParamsTechnologiesV2Type0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_saved_search_body_search_params_type_1_company_search_params_technologies_v2_type_0 = cls(
            any_of=any_of,
            all_of=all_of,
            none_of=none_of,
        )

        create_saved_search_body_search_params_type_1_company_search_params_technologies_v2_type_0.additional_properties = d
        return create_saved_search_body_search_params_type_1_company_search_params_technologies_v2_type_0
