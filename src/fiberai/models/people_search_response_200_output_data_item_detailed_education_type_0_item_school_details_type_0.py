...
T = TypeVar("T", bound="PeopleSearchResponse200OutputDataItemDetailedEducationType0ItemSchoolDetailsType0")


@_attrs_define
class PeopleSearchResponse200OutputDataItemDetailedEducationType0ItemSchoolDetailsType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        people_search_response_200_output_data_item_detailed_education_type_0_item_school_details_type_0 = cls(
        ...
        people_search_response_200_output_data_item_detailed_education_type_0_item_school_details_type_0.additional_properties = d
        return people_search_response_200_output_data_item_detailed_education_type_0_item_school_details_type_0
