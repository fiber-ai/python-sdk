...
from ..models.people_search_body_search_params_time_zone_type_0_any_of_item_strategy_type_0_mode import PeopleSearchBodySearchParamsTimeZoneType0AnyOfItemStrategyType0Mode
...
T = TypeVar("T", bound="PeopleSearchBodySearchParamsTimeZoneType0AnyOfItemStrategyType0")



@_attrs_define
class PeopleSearchBodySearchParamsTimeZoneType0AnyOfItemStrategyType0:
    """ 
        Attributes:
            mode (PeopleSearchBodySearchParamsTimeZoneType0AnyOfItemStrategyType0Mode):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        mode = PeopleSearchBodySearchParamsTimeZoneType0AnyOfItemStrategyType0Mode(d.pop("mode"))
        ...
        people_search_body_search_params_time_zone_type_0_any_of_item_strategy_type_0 = cls(
            mode=mode,
        ...
        people_search_body_search_params_time_zone_type_0_any_of_item_strategy_type_0.additional_properties = d
        return people_search_body_search_params_time_zone_type_0_any_of_item_strategy_type_0
