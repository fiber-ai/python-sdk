...
from ..models.quick_company_resolve_response_200_output_data_item_company_type_0_funding_rounds_type_0_item_round_type_type_1 import (
    QuickCompanyResolveResponse200OutputDataItemCompanyType0FundingRoundsType0ItemRoundTypeType1,
)
from ..models.quick_company_resolve_response_200_output_data_item_company_type_0_funding_rounds_type_0_item_round_type_type_2_type_1 import (
    QuickCompanyResolveResponse200OutputDataItemCompanyType0FundingRoundsType0ItemRoundTypeType2Type1,
)
from ..models.quick_company_resolve_response_200_output_data_item_company_type_0_funding_rounds_type_0_item_round_type_type_3_type_1 import (
    QuickCompanyResolveResponse200OutputDataItemCompanyType0FundingRoundsType0ItemRoundTypeType3Type1,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="QuickCompanyResolveResponse200OutputDataItemCompanyType0FundingRoundsType0Item")


@_attrs_define
class QuickCompanyResolveResponse200OutputDataItemCompanyType0FundingRoundsType0Item:
    """
    Attributes:
        round_type (None | QuickCompanyResolveResponse200OutputDataItemCompanyType0FundingRoundsType0ItemRoundTypeType1
            | QuickCompanyResolveResponse200OutputDataItemCompanyType0FundingRoundsType0ItemRoundTypeType2Type1 |
            QuickCompanyResolveResponse200OutputDataItemCompanyType0FundingRoundsType0ItemRoundTypeType3Type1 | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_round_type(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                round_type_type_1 = (
                    QuickCompanyResolveResponse200OutputDataItemCompanyType0FundingRoundsType0ItemRoundTypeType1(data)
                )
        ...
        quick_company_resolve_response_200_output_data_item_company_type_0_funding_rounds_type_0_item = cls(
        ...
        quick_company_resolve_response_200_output_data_item_company_type_0_funding_rounds_type_0_item.additional_properties = d
        return quick_company_resolve_response_200_output_data_item_company_type_0_funding_rounds_type_0_item
