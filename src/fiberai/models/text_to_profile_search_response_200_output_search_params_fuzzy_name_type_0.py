...
if TYPE_CHECKING:
    from ..models.text_to_profile_search_response_200_output_search_params_fuzzy_name_type_0_any_of_item import (
        TextToProfileSearchResponse200OutputSearchParamsFuzzyNameType0AnyOfItem,
    )
...
class TextToProfileSearchResponse200OutputSearchParamsFuzzyNameType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for any_of_item_data in _any_of:
            any_of_item = TextToProfileSearchResponse200OutputSearchParamsFuzzyNameType0AnyOfItem.from_dict(
                any_of_item_data
            )
