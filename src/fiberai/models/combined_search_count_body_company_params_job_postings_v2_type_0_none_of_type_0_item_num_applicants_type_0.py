...
T = TypeVar("T", bound="CombinedSearchCountBodyCompanyParamsJobPostingsV2Type0NoneOfType0ItemNumApplicantsType0")


@_attrs_define
class CombinedSearchCountBodyCompanyParamsJobPostingsV2Type0NoneOfType0ItemNumApplicantsType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        combined_search_count_body_company_params_job_postings_v2_type_0_none_of_type_0_item_num_applicants_type_0 = (
            cls(
        ...
        combined_search_count_body_company_params_job_postings_v2_type_0_none_of_type_0_item_num_applicants_type_0.additional_properties = d
        return (
            combined_search_count_body_company_params_job_postings_v2_type_0_none_of_type_0_item_num_applicants_type_0
        )
