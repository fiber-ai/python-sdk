...
if TYPE_CHECKING:
    from ..models.poll_combined_search_response_200_output_data_type_0_items_item_num_matching_locations_type_0_matched_offices_item_location_type_0_coordinates_type_0 import (
        PollCombinedSearchResponse200OutputDataType0ItemsItemNumMatchingLocationsType0MatchedOfficesItemLocationType0CoordinatesType0,
    )


T = TypeVar(
    "T",
    bound="PollCombinedSearchResponse200OutputDataType0ItemsItemNumMatchingLocationsType0MatchedOfficesItemLocationType0",
)
...
class PollCombinedSearchResponse200OutputDataType0ItemsItemNumMatchingLocationsType0MatchedOfficesItemLocationType0:
    ...
    Attributes:
        ...
        coordinates (None | PollCombinedSearchResponse200OutputDataType0ItemsItemNumMatchingLocationsType0MatchedOffices
            ItemLocationType0CoordinatesType0 | Unset):
        ...
        def _parse_coordinates(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = PollCombinedSearchResponse200OutputDataType0ItemsItemNumMatchingLocationsType0MatchedOfficesItemLocationType0CoordinatesType0.from_dict(
                    data
                )
