...
if TYPE_CHECKING:
  from ..models.poll_combined_search_response_200_output_data_type_0_items_item_num_matching_locations_type_0_matched_offices_item_location_type_0_coordinates_type_0 import PollCombinedSearchResponse200OutputDataType0ItemsItemNumMatchingLocationsType0MatchedOfficesItemLocationType0CoordinatesType0





T = TypeVar("T", bound="PollCombinedSearchResponse200OutputDataType0ItemsItemNumMatchingLocationsType0MatchedOfficesItemLocationType0")



@_attrs_define
class PollCombinedSearchResponse200OutputDataType0ItemsItemNumMatchingLocationsType0MatchedOfficesItemLocationType0:
    """ 
        Attributes:
            ...
            coordinates (Union['PollCombinedSearchResponse200OutputDataType0ItemsItemNumMatchingLocationsType0MatchedOffices
                ItemLocationType0CoordinatesType0', None, Unset]):
    ...
    coordinates: Union['PollCombinedSearchResponse200OutputDataType0ItemsItemNumMatchingLocationsType0MatchedOfficesItemLocationType0CoordinatesType0', None, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.coordinates, Unset):
            coordinates = UNSET
        elif isinstance(self.coordinates, PollCombinedSearchResponse200OutputDataType0ItemsItemNumMatchingLocationsType0MatchedOfficesItemLocationType0CoordinatesType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_coordinates(data: object) -> Union['PollCombinedSearchResponse200OutputDataType0ItemsItemNumMatchingLocationsType0MatchedOfficesItemLocationType0CoordinatesType0', None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = PollCombinedSearchResponse200OutputDataType0ItemsItemNumMatchingLocationsType0MatchedOfficesItemLocationType0CoordinatesType0.from_dict(data)
                ...
                pass
            return cast(Union['PollCombinedSearchResponse200OutputDataType0ItemsItemNumMatchingLocationsType0MatchedOfficesItemLocationType0CoordinatesType0', None, Unset], data)
        ...
        poll_combined_search_response_200_output_data_type_0_items_item_num_matching_locations_type_0_matched_offices_item_location_type_0 = cls(
        ...
        poll_combined_search_response_200_output_data_type_0_items_item_num_matching_locations_type_0_matched_offices_item_location_type_0.additional_properties = d
        return poll_combined_search_response_200_output_data_type_0_items_item_num_matching_locations_type_0_matched_offices_item_location_type_0
