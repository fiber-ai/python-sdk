...
if TYPE_CHECKING:
    from ..models.poll_combined_search_response_200_output_data_type_0_items_item_location_consensus_type_0_coordinates_type_0 import (
        PollCombinedSearchResponse200OutputDataType0ItemsItemLocationConsensusType0CoordinatesType0,
    )
...
class PollCombinedSearchResponse200OutputDataType0ItemsItemLocationConsensusType0:
    ...
    Attributes:
        ...
        coordinates (None | PollCombinedSearchResponse200OutputDataType0ItemsItemLocationConsensusType0CoordinatesType0
            | Unset):
    ...
    coordinates: (
        None | PollCombinedSearchResponse200OutputDataType0ItemsItemLocationConsensusType0CoordinatesType0 | Unset
    ) = UNSET
        ...
        def _parse_coordinates(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = PollCombinedSearchResponse200OutputDataType0ItemsItemLocationConsensusType0CoordinatesType0.from_dict(
                    data
                )
