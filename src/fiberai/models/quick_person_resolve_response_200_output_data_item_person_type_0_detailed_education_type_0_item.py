...
T = TypeVar("T", bound="QuickPersonResolveResponse200OutputDataItemPersonType0DetailedEducationType0Item")


@_attrs_define
class QuickPersonResolveResponse200OutputDataItemPersonType0DetailedEducationType0Item:
    """
    Attributes:
        school_details (None |
            QuickPersonResolveResponse200OutputDataItemPersonType0DetailedEducationType0ItemSchoolDetailsType0 | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_school_details(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                school_details_type_0 = QuickPersonResolveResponse200OutputDataItemPersonType0DetailedEducationType0ItemSchoolDetailsType0.from_dict(
                    data
                )
        ...
        quick_person_resolve_response_200_output_data_item_person_type_0_detailed_education_type_0_item = cls(
        ...
        quick_person_resolve_response_200_output_data_item_person_type_0_detailed_education_type_0_item.additional_properties = d
        return quick_person_resolve_response_200_output_data_item_person_type_0_detailed_education_type_0_item
