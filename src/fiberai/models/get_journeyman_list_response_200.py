...
if TYPE_CHECKING:
    from ..models.get_journeyman_list_response_200_charge_info_type_0 import GetJourneymanListResponse200ChargeInfoType0
...
T = TypeVar("T", bound="GetJourneymanListResponse200")


@_attrs_define
class GetJourneymanListResponse200:
    """
    Attributes:
    ...
    output: GetJourneymanListResponse200Output
    charge_info: (
        GetJourneymanListResponse200ChargeInfoType0
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.get_journeyman_list_response_200_charge_info_type_0 import (
            GetJourneymanListResponse200ChargeInfoType0,
        )
        from ..models.get_journeyman_list_response_200_charge_info_type_1 import (
            GetJourneymanListResponse200ChargeInfoType1,
        )
        ...
        if isinstance(self.charge_info, GetJourneymanListResponse200ChargeInfoType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        output = GetJourneymanListResponse200Output.from_dict(d.pop("output"))
        ...
        def _parse_charge_info(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_0 = GetJourneymanListResponse200ChargeInfoType0.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_1 = GetJourneymanListResponse200ChargeInfoType1.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_2 = GetJourneymanListResponse200ChargeInfoType2.from_dict(data)
        ...
        def _parse_warnings(data: object) -> list[GetJourneymanListResponse200WarningsType0Item] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for warnings_type_0_item_data in _warnings_type_0:
                    warnings_type_0_item = GetJourneymanListResponse200WarningsType0Item.from_dict(
                ...
                pass
            return cast(list[GetJourneymanListResponse200WarningsType0Item] | None | Unset, data)

        warnings = _parse_warnings(d.pop("warnings", UNSET))

        get_journeyman_list_response_200 = cls(
            output=output,
            charge_info=charge_info,
            warnings=warnings,
        )

        return get_journeyman_list_response_200
