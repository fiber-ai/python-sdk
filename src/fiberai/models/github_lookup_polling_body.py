...
T = TypeVar("T", bound="GithubLookupPollingBody")


@_attrs_define
class GithubLookupPollingBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        github_lookup_polling_body = cls(
            api_key=api_key,
        ...
        github_lookup_polling_body.additional_properties = d
        return github_lookup_polling_body
