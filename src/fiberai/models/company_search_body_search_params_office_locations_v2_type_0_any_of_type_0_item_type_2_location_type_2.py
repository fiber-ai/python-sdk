...
if TYPE_CHECKING:
    from ..models.company_search_body_search_params_office_locations_v2_type_0_any_of_type_0_item_type_2_location_type_2_vertices_item import (
        CompanySearchBodySearchParamsOfficeLocationsV2Type0AnyOfType0ItemType2LocationType2VerticesItem,
    )
...
class CompanySearchBodySearchParamsOfficeLocationsV2Type0AnyOfType0ItemType2LocationType2:
    ...
    Attributes:
        ...
        vertices
            (list[CompanySearchBodySearchParamsOfficeLocationsV2Type0AnyOfType0ItemType2LocationType2VerticesItem]):
    """

    strategy: CompanySearchBodySearchParamsOfficeLocationsV2Type0AnyOfType0ItemType2LocationType2Strategy
    vertices: list[CompanySearchBodySearchParamsOfficeLocationsV2Type0AnyOfType0ItemType2LocationType2VerticesItem]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.company_search_body_search_params_office_locations_v2_type_0_any_of_type_0_item_type_2_location_type_2_vertices_item import (
            CompanySearchBodySearchParamsOfficeLocationsV2Type0AnyOfType0ItemType2LocationType2VerticesItem,  # noqa: PLC0415
        )
        ...
        for vertices_item_data in _vertices:
            vertices_item = CompanySearchBodySearchParamsOfficeLocationsV2Type0AnyOfType0ItemType2LocationType2VerticesItem.from_dict(
                vertices_item_data
            )
