...
T = TypeVar("T", bound="CompanyWentInactive")


@_attrs_define
class CompanyWentInactive:
    """Fires when a company becomes inactive.

    Attributes:
        type_ (Literal['company_went_inactive']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        type_ = cast(Literal["company_went_inactive"], d.pop("type"))
        if type_ != "company_went_inactive":
            raise ValueError(f"type must match const 'company_went_inactive', got '{type_}'")
        ...
        company_went_inactive.additional_properties = d
        return company_went_inactive
