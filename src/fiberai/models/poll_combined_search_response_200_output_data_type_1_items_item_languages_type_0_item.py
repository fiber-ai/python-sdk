...
T = TypeVar("T", bound="PollCombinedSearchResponse200OutputDataType1ItemsItemLanguagesType0Item")


@_attrs_define
class PollCombinedSearchResponse200OutputDataType1ItemsItemLanguagesType0Item:
    """
    Attributes:
        name (None | str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        poll_combined_search_response_200_output_data_type_1_items_item_languages_type_0_item = cls(
            name=name,
            proficiency_id=proficiency_id,
            proficiency_name=proficiency_name,
        )

        poll_combined_search_response_200_output_data_type_1_items_item_languages_type_0_item.additional_properties = d
        return poll_combined_search_response_200_output_data_type_1_items_item_languages_type_0_item
