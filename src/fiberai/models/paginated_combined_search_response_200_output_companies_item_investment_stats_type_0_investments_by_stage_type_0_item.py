...
T = TypeVar(
    "T", bound="PaginatedCombinedSearchResponse200OutputCompaniesItemInvestmentStatsType0InvestmentsByStageType0Item"
)


@_attrs_define
class PaginatedCombinedSearchResponse200OutputCompaniesItemInvestmentStatsType0InvestmentsByStageType0Item:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        paginated_combined_search_response_200_output_companies_item_investment_stats_type_0_investments_by_stage_type_0_item = cls(
            stage=stage,
            lead_rate=lead_rate,
        ...
        paginated_combined_search_response_200_output_companies_item_investment_stats_type_0_investments_by_stage_type_0_item.additional_properties = d
        return paginated_combined_search_response_200_output_companies_item_investment_stats_type_0_investments_by_stage_type_0_item
