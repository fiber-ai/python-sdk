...
T = TypeVar("T", bound="TwitterTweetDetailsResponse200Output")


@_attrs_define
class TwitterTweetDetailsResponse200Output:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        twitter_tweet_details_response_200_output = cls(
            id=id,
            text=text,
        ...
        twitter_tweet_details_response_200_output.additional_properties = d
        return twitter_tweet_details_response_200_output
