...
from ..models.create_tracker_company_list_body_company_search_params_type_0_exact_company_type_0_any_of_type_0_item_source_type_1 import (
    CreateTrackerCompanyListBodyCompanySearchParamsType0ExactCompanyType0AnyOfType0ItemSourceType1,
)
from ..models.create_tracker_company_list_body_company_search_params_type_0_exact_company_type_0_any_of_type_0_item_source_type_2_type_1 import (
    CreateTrackerCompanyListBodyCompanySearchParamsType0ExactCompanyType0AnyOfType0ItemSourceType2Type1,
)
from ..models.create_tracker_company_list_body_company_search_params_type_0_exact_company_type_0_any_of_type_0_item_source_type_3_type_1 import (
    CreateTrackerCompanyListBodyCompanySearchParamsType0ExactCompanyType0AnyOfType0ItemSourceType3Type1,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="CreateTrackerCompanyListBodyCompanySearchParamsType0ExactCompanyType0AnyOfType0Item")


@_attrs_define
class CreateTrackerCompanyListBodyCompanySearchParamsType0ExactCompanyType0AnyOfType0Item:
    """
    Attributes:
        li_org_id (str):
        ...
        source (CreateTrackerCompanyListBodyCompanySearchParamsType0ExactCompanyType0AnyOfType0ItemSourceType1 |
            CreateTrackerCompanyListBodyCompanySearchParamsType0ExactCompanyType0AnyOfType0ItemSourceType2Type1 |
            CreateTrackerCompanyListBodyCompanySearchParamsType0ExactCompanyType0AnyOfType0ItemSourceType3Type1 | None |
            Unset):
    """
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.source, Unset):
            ...
            self.source, CreateTrackerCompanyListBodyCompanySearchParamsType0ExactCompanyType0AnyOfType0ItemSourceType1
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_source(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                source_type_1 = (
                    CreateTrackerCompanyListBodyCompanySearchParamsType0ExactCompanyType0AnyOfType0ItemSourceType1(data)
                )
        ...
        create_tracker_company_list_body_company_search_params_type_0_exact_company_type_0_any_of_type_0_item = cls(
            li_org_id=li_org_id,
        ...
        create_tracker_company_list_body_company_search_params_type_0_exact_company_type_0_any_of_type_0_item.additional_properties = d
        return create_tracker_company_list_body_company_search_params_type_0_exact_company_type_0_any_of_type_0_item
