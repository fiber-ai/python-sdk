...
T = TypeVar("T", bound="LiteReverseEmailLookupResponse200OutputDataItemInferredLocationType0")


@_attrs_define
class LiteReverseEmailLookupResponse200OutputDataItemInferredLocationType0:
    """
    Attributes:
        ...
        coordinates (LiteReverseEmailLookupResponse200OutputDataItemInferredLocationType0CoordinatesType0 | None |
            Unset):
    ...
    coordinates: LiteReverseEmailLookupResponse200OutputDataItemInferredLocationType0CoordinatesType0 | None | Unset = (
        UNSET
    )
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.coordinates, Unset):
            ...
            self.coordinates, LiteReverseEmailLookupResponse200OutputDataItemInferredLocationType0CoordinatesType0
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_coordinates(
            data: object,
        ) -> LiteReverseEmailLookupResponse200OutputDataItemInferredLocationType0CoordinatesType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = (
                    LiteReverseEmailLookupResponse200OutputDataItemInferredLocationType0CoordinatesType0.from_dict(data)
                )
        ...
        lite_reverse_email_lookup_response_200_output_data_item_inferred_location_type_0 = cls(
        ...
        lite_reverse_email_lookup_response_200_output_data_item_inferred_location_type_0.additional_properties = d
        return lite_reverse_email_lookup_response_200_output_data_item_inferred_location_type_0
