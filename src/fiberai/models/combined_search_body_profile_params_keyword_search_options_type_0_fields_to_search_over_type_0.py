...
T = TypeVar("T", bound="CombinedSearchBodyProfileParamsKeywordSearchOptionsType0FieldsToSearchOverType0")


@_attrs_define
class CombinedSearchBodyProfileParamsKeywordSearchOptionsType0FieldsToSearchOverType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        combined_search_body_profile_params_keyword_search_options_type_0_fields_to_search_over_type_0 = cls(
            summary=summary,
            headline=headline,
        ...
        combined_search_body_profile_params_keyword_search_options_type_0_fields_to_search_over_type_0.additional_properties = d
        return combined_search_body_profile_params_keyword_search_options_type_0_fields_to_search_over_type_0
