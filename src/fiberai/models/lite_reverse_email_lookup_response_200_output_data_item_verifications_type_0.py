...
T = TypeVar("T", bound="LiteReverseEmailLookupResponse200OutputDataItemVerificationsType0")


@_attrs_define
class LiteReverseEmailLookupResponse200OutputDataItemVerificationsType0:
    """
    Attributes:
        is_verified (bool | None | Unset):
        joined_date (None | str | Unset):
        verification_types
            (list[LiteReverseEmailLookupResponse200OutputDataItemVerificationsType0VerificationTypesType0Item] | None |
            Unset):
    """
    ...
    verification_types: (
        list[LiteReverseEmailLookupResponse200OutputDataItemVerificationsType0VerificationTypesType0Item] | None | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_verification_types(
            ...
            list[LiteReverseEmailLookupResponse200OutputDataItemVerificationsType0VerificationTypesType0Item]
            | None
            | Unset
        ):
            if data is None:
            ...
            try:
                ...
                for verification_types_type_0_item_data in _verification_types_type_0:
                    verification_types_type_0_item = LiteReverseEmailLookupResponse200OutputDataItemVerificationsType0VerificationTypesType0Item.from_dict(
        ...
        lite_reverse_email_lookup_response_200_output_data_item_verifications_type_0 = cls(
            is_verified=is_verified,
            joined_date=joined_date,
            verification_types=verification_types,
        )

        lite_reverse_email_lookup_response_200_output_data_item_verifications_type_0.additional_properties = d
        return lite_reverse_email_lookup_response_200_output_data_item_verifications_type_0
