...
from ..models.text_to_profile_search_params_response_200_output_search_params_stealth_v2_type_1_entered_stealth_at_type_1_window_type_0_method import TextToProfileSearchParamsResponse200OutputSearchParamsStealthV2Type1EnteredStealthAtType1WindowType0Method
from ..models.text_to_profile_search_params_response_200_output_search_params_stealth_v2_type_1_entered_stealth_at_type_1_window_type_0_period import TextToProfileSearchParamsResponse200OutputSearchParamsStealthV2Type1EnteredStealthAtType1WindowType0Period
...
T = TypeVar("T", bound="TextToProfileSearchParamsResponse200OutputSearchParamsStealthV2Type1EnteredStealthAtType1WindowType0")
...
class TextToProfileSearchParamsResponse200OutputSearchParamsStealthV2Type1EnteredStealthAtType1WindowType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        method = TextToProfileSearchParamsResponse200OutputSearchParamsStealthV2Type1EnteredStealthAtType1WindowType0Method(d.pop("method"))




        period = TextToProfileSearchParamsResponse200OutputSearchParamsStealthV2Type1EnteredStealthAtType1WindowType0Period(d.pop("period"))
