...
T = TypeVar("T", bound="TwitterTweetQuotesResponse200OutputTweetsItem")


@_attrs_define
class TwitterTweetQuotesResponse200OutputTweetsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        twitter_tweet_quotes_response_200_output_tweets_item = cls(
            id=id,
            text=text,
        ...
        twitter_tweet_quotes_response_200_output_tweets_item.additional_properties = d
        return twitter_tweet_quotes_response_200_output_tweets_item
