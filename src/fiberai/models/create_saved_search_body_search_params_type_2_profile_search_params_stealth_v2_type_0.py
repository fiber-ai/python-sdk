...
from ..models.create_saved_search_body_search_params_type_2_profile_search_params_stealth_v2_type_0_status import (
    CreateSavedSearchBodySearchParamsType2ProfileSearchParamsStealthV2Type0Status,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.create_saved_search_body_search_params_type_2_profile_search_params_stealth_v2_type_0_entered_stealth_at_type_0 import (
        CreateSavedSearchBodySearchParamsType2ProfileSearchParamsStealthV2Type0EnteredStealthAtType0,
    )
    from ..models.create_saved_search_body_search_params_type_2_profile_search_params_stealth_v2_type_0_entered_stealth_at_type_1 import (
        CreateSavedSearchBodySearchParamsType2ProfileSearchParamsStealthV2Type0EnteredStealthAtType1,
    )
...
class CreateSavedSearchBodySearchParamsType2ProfileSearchParamsStealthV2Type0:
    ...
    Attributes:
        ...
        entered_stealth_at (CreateSavedSearchBodySearchParamsType2ProfileSearchParamsStealthV2Type0EnteredStealthAtType0
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.create_saved_search_body_search_params_type_2_profile_search_params_stealth_v2_type_0_entered_stealth_at_type_0 import (
            CreateSavedSearchBodySearchParamsType2ProfileSearchParamsStealthV2Type0EnteredStealthAtType0,  # noqa: PLC0415
        )
        from ..models.create_saved_search_body_search_params_type_2_profile_search_params_stealth_v2_type_0_entered_stealth_at_type_1 import (
            CreateSavedSearchBodySearchParamsType2ProfileSearchParamsStealthV2Type0EnteredStealthAtType1,  # noqa: PLC0415
        )
        ...
        def _parse_entered_stealth_at(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                entered_stealth_at_type_0 = CreateSavedSearchBodySearchParamsType2ProfileSearchParamsStealthV2Type0EnteredStealthAtType0.from_dict(
                    data
                )
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                entered_stealth_at_type_1 = CreateSavedSearchBodySearchParamsType2ProfileSearchParamsStealthV2Type0EnteredStealthAtType1.from_dict(
                    data
                )
