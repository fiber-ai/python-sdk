...
T = TypeVar("T", bound="KitchenSinkBulkProfileResponse200OutputDataItemItemEducationType0Item")


@_attrs_define
class KitchenSinkBulkProfileResponse200OutputDataItemItemEducationType0Item:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        kitchen_sink_bulk_profile_response_200_output_data_item_item_education_type_0_item = cls(
            school_id=school_id,
        ...
        kitchen_sink_bulk_profile_response_200_output_data_item_item_education_type_0_item.additional_properties = d
        return kitchen_sink_bulk_profile_response_200_output_data_item_item_education_type_0_item
