...
from ..models.paginated_combined_search_body_company_config_type_0_search_params_exact_company_type_0_none_of_type_0_item_source_type_1 import (
    PaginatedCombinedSearchBodyCompanyConfigType0SearchParamsExactCompanyType0NoneOfType0ItemSourceType1,
)
from ..models.paginated_combined_search_body_company_config_type_0_search_params_exact_company_type_0_none_of_type_0_item_source_type_2_type_1 import (
    PaginatedCombinedSearchBodyCompanyConfigType0SearchParamsExactCompanyType0NoneOfType0ItemSourceType2Type1,
)
from ..models.paginated_combined_search_body_company_config_type_0_search_params_exact_company_type_0_none_of_type_0_item_source_type_3_type_1 import (
    PaginatedCombinedSearchBodyCompanyConfigType0SearchParamsExactCompanyType0NoneOfType0ItemSourceType3Type1,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PaginatedCombinedSearchBodyCompanyConfigType0SearchParamsExactCompanyType0NoneOfType0Item")


@_attrs_define
class PaginatedCombinedSearchBodyCompanyConfigType0SearchParamsExactCompanyType0NoneOfType0Item:
    """
    Attributes:
        li_org_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_source(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                source_type_1 = PaginatedCombinedSearchBodyCompanyConfigType0SearchParamsExactCompanyType0NoneOfType0ItemSourceType1(
                    data
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                source_type_2_type_1 = PaginatedCombinedSearchBodyCompanyConfigType0SearchParamsExactCompanyType0NoneOfType0ItemSourceType2Type1(
                    data
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                source_type_3_type_1 = PaginatedCombinedSearchBodyCompanyConfigType0SearchParamsExactCompanyType0NoneOfType0ItemSourceType3Type1(
                    data
                )
        ...
        paginated_combined_search_body_company_config_type_0_search_params_exact_company_type_0_none_of_type_0_item = (
            cls(
                li_org_id=li_org_id,
        ...
        paginated_combined_search_body_company_config_type_0_search_params_exact_company_type_0_none_of_type_0_item.additional_properties = d
        return (
            paginated_combined_search_body_company_config_type_0_search_params_exact_company_type_0_none_of_type_0_item
        )
