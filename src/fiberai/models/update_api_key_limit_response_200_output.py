...
T = TypeVar("T", bound="UpdateApiKeyLimitResponse200Output")


@_attrs_define
class UpdateApiKeyLimitResponse200Output:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_api_key_limit_response_200_output = cls(
            id=id,
            name=name,
            prefix=prefix,
        ...
        update_api_key_limit_response_200_output.additional_properties = d
        return update_api_key_limit_response_200_output
