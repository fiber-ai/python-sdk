...
T = TypeVar(
    "T", bound="PaginatedCombinedSearchResponse200OutputCompaniesItemLiJobPostsStatsType0EmploymentTypeStatsType0"
)


@_attrs_define
class PaginatedCombinedSearchResponse200OutputCompaniesItemLiJobPostsStatsType0EmploymentTypeStatsType0:
    """
    Attributes:
        full_time
            (PaginatedCombinedSearchResponse200OutputCompaniesItemLiJobPostsStatsType0EmploymentTypeStatsType0FullTime |
        ...
        volunteer
            (PaginatedCombinedSearchResponse200OutputCompaniesItemLiJobPostsStatsType0EmploymentTypeStatsType0Volunteer |
            Unset):
        other (PaginatedCombinedSearchResponse200OutputCompaniesItemLiJobPostsStatsType0EmploymentTypeStatsType0Other |
            Unset):
    """
    ...
    other: (
        PaginatedCombinedSearchResponse200OutputCompaniesItemLiJobPostsStatsType0EmploymentTypeStatsType0Other | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_full_time, Unset):
            ...
            full_time = PaginatedCombinedSearchResponse200OutputCompaniesItemLiJobPostsStatsType0EmploymentTypeStatsType0FullTime.from_dict(
                _full_time
            )
        ...
        if isinstance(_temporary, Unset):
            ...
            temporary = PaginatedCombinedSearchResponse200OutputCompaniesItemLiJobPostsStatsType0EmploymentTypeStatsType0Temporary.from_dict(
                _temporary
            )
        ...
        if isinstance(_internship, Unset):
            ...
            internship = PaginatedCombinedSearchResponse200OutputCompaniesItemLiJobPostsStatsType0EmploymentTypeStatsType0Internship.from_dict(
                _internship
            )
        ...
        if isinstance(_contract, Unset):
            ...
            contract = PaginatedCombinedSearchResponse200OutputCompaniesItemLiJobPostsStatsType0EmploymentTypeStatsType0Contract.from_dict(
                _contract
            )
        ...
        if isinstance(_part_time, Unset):
            ...
            part_time = PaginatedCombinedSearchResponse200OutputCompaniesItemLiJobPostsStatsType0EmploymentTypeStatsType0PartTime.from_dict(
                _part_time
            )
        ...
        if isinstance(_volunteer, Unset):
            ...
            volunteer = PaginatedCombinedSearchResponse200OutputCompaniesItemLiJobPostsStatsType0EmploymentTypeStatsType0Volunteer.from_dict(
                _volunteer
            )
        ...
        if isinstance(_other, Unset):
            ...
            other = PaginatedCombinedSearchResponse200OutputCompaniesItemLiJobPostsStatsType0EmploymentTypeStatsType0Other.from_dict(
                _other
            )

        paginated_combined_search_response_200_output_companies_item_li_job_posts_stats_type_0_employment_type_stats_type_0 = cls(
            full_time=full_time,
            temporary=temporary,
        ...
        return paginated_combined_search_response_200_output_companies_item_li_job_posts_stats_type_0_employment_type_stats_type_0
