...
T = TypeVar("T", bound="KitchenSinkCompanyResponse200OutputDataItemStockInfoConsensusType0")



@_attrs_define
class KitchenSinkCompanyResponse200OutputDataItemStockInfoConsensusType0:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        kitchen_sink_company_response_200_output_data_item_stock_info_consensus_type_0 = cls(
            ticker=ticker,
            exchange=exchange,
        )


        kitchen_sink_company_response_200_output_data_item_stock_info_consensus_type_0.additional_properties = d
        return kitchen_sink_company_response_200_output_data_item_stock_info_consensus_type_0
