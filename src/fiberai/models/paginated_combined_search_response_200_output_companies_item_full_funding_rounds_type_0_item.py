...
T = TypeVar("T", bound="PaginatedCombinedSearchResponse200OutputCompaniesItemFullFundingRoundsType0Item")


@_attrs_define
class PaginatedCombinedSearchResponse200OutputCompaniesItemFullFundingRoundsType0Item:
    """
    Attributes:
        investors
            (list[PaginatedCombinedSearchResponse200OutputCompaniesItemFullFundingRoundsType0ItemInvestorsType0Item] | None
            | Unset):
    ...
    investors: (
        list[PaginatedCombinedSearchResponse200OutputCompaniesItemFullFundingRoundsType0ItemInvestorsType0Item]
        | None
        | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_investors(
            ...
            try:
                ...
                for investors_type_0_item_data in _investors_type_0:
                    investors_type_0_item = PaginatedCombinedSearchResponse200OutputCompaniesItemFullFundingRoundsType0ItemInvestorsType0Item.from_dict(
        ...
        paginated_combined_search_response_200_output_companies_item_full_funding_rounds_type_0_item = cls(
            investors=investors,
        ...
        paginated_combined_search_response_200_output_companies_item_full_funding_rounds_type_0_item.additional_properties = d
        return paginated_combined_search_response_200_output_companies_item_full_funding_rounds_type_0_item
