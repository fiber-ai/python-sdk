...
if TYPE_CHECKING:
    from ..models.reverse_email_lookup_response_200_output_data_item_verifications_type_0_verification_types_type_0_item import (
        ReverseEmailLookupResponse200OutputDataItemVerificationsType0VerificationTypesType0Item,
    )


T = TypeVar("T", bound="ReverseEmailLookupResponse200OutputDataItemVerificationsType0")


@_attrs_define
class ReverseEmailLookupResponse200OutputDataItemVerificationsType0:
    """
    Attributes:
        is_verified (bool | None | Unset):
        joined_date (None | str | Unset):
        verification_types
            (list[ReverseEmailLookupResponse200OutputDataItemVerificationsType0VerificationTypesType0Item] | None | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.reverse_email_lookup_response_200_output_data_item_verifications_type_0_verification_types_type_0_item import (
            ReverseEmailLookupResponse200OutputDataItemVerificationsType0VerificationTypesType0Item,  # noqa: PLC0415
        )
        ...
        def _parse_verification_types(
            ...
            try:
                ...
                for verification_types_type_0_item_data in _verification_types_type_0:
                    verification_types_type_0_item = ReverseEmailLookupResponse200OutputDataItemVerificationsType0VerificationTypesType0Item.from_dict(
                ...
                pass
            return cast(
                list[ReverseEmailLookupResponse200OutputDataItemVerificationsType0VerificationTypesType0Item]
                | None
                | Unset,
                data,
            )
        ...
        reverse_email_lookup_response_200_output_data_item_verifications_type_0 = cls(
            is_verified=is_verified,
            joined_date=joined_date,
            verification_types=verification_types,
        )

        reverse_email_lookup_response_200_output_data_item_verifications_type_0.additional_properties = d
        return reverse_email_lookup_response_200_output_data_item_verifications_type_0
