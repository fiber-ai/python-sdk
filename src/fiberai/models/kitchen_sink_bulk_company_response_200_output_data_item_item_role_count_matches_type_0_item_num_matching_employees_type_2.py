...
from ..models.kitchen_sink_bulk_company_response_200_output_data_item_item_role_count_matches_type_0_item_num_matching_employees_type_2_type import (
    KitchenSinkBulkCompanyResponse200OutputDataItemItemRoleCountMatchesType0ItemNumMatchingEmployeesType2Type,
)

T = TypeVar(
    "T", bound="KitchenSinkBulkCompanyResponse200OutputDataItemItemRoleCountMatchesType0ItemNumMatchingEmployeesType2"
)
