...
if TYPE_CHECKING:
    ...
    from ..models.text_to_combined_search_param_response_200_output_company_search_params_type_0_revenue_usd_type_0 import (
        TextToCombinedSearchParamResponse200OutputCompanySearchParamsType0RevenueUSDType0,
    )
...
class TextToCombinedSearchParamResponse200OutputCompanySearchParamsType0:
    ...
    Attributes:
        ...
        revenue_usd (None | TextToCombinedSearchParamResponse200OutputCompanySearchParamsType0RevenueUSDType0 | Unset):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.revenue_usd, Unset):
            ...
            self.revenue_usd, TextToCombinedSearchParamResponse200OutputCompanySearchParamsType0RevenueUSDType0
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_revenue_usd(
            data: object,
        ) -> None | TextToCombinedSearchParamResponse200OutputCompanySearchParamsType0RevenueUSDType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                revenue_usd_type_0 = (
                    TextToCombinedSearchParamResponse200OutputCompanySearchParamsType0RevenueUSDType0.from_dict(data)
                )
                ...
                pass
            return cast(
                None | TextToCombinedSearchParamResponse200OutputCompanySearchParamsType0RevenueUSDType0 | Unset, data
            )
