...
T = TypeVar("T", bound="AddTrackerPeopleBodyInitialSignalsType0")


@_attrs_define
class AddTrackerPeopleBodyInitialSignalsType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        add_tracker_people_body_initial_signals_type_0 = cls(
            lookback_period_days=lookback_period_days,
        )

        add_tracker_people_body_initial_signals_type_0.additional_properties = d
        return add_tracker_people_body_initial_signals_type_0
