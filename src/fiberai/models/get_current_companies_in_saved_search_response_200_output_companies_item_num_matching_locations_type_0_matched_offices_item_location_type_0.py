...
if TYPE_CHECKING:
    from ..models.get_current_companies_in_saved_search_response_200_output_companies_item_num_matching_locations_type_0_matched_offices_item_location_type_0_coordinates_type_0 import (
        GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemNumMatchingLocationsType0MatchedOfficesItemLocationType0CoordinatesType0,
    )


T = TypeVar(
    "T",
    bound="GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemNumMatchingLocationsType0MatchedOfficesItemLocationType0",
)
...
class GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemNumMatchingLocationsType0MatchedOfficesItemLocationType0:
    ...
    Attributes:
        ...
        coordinates (GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemNumMatchingLocationsType0MatchedOffic
            esItemLocationType0CoordinatesType0 | None | Unset):
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.get_current_companies_in_saved_search_response_200_output_companies_item_num_matching_locations_type_0_matched_offices_item_location_type_0_coordinates_type_0 import (
            GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemNumMatchingLocationsType0MatchedOfficesItemLocationType0CoordinatesType0,  # noqa: PLC0415
        )
        ...
        def _parse_coordinates(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemNumMatchingLocationsType0MatchedOfficesItemLocationType0CoordinatesType0.from_dict(
                    data
                )
