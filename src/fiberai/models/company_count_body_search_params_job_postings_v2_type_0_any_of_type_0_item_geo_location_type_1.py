...
if TYPE_CHECKING:
    from ..models.company_count_body_search_params_job_postings_v2_type_0_any_of_type_0_item_geo_location_type_1_radius_type_0 import (
        CompanyCountBodySearchParamsJobPostingsV2Type0AnyOfType0ItemGeoLocationType1RadiusType0,
    )
    from ..models.company_count_body_search_params_job_postings_v2_type_0_any_of_type_0_item_geo_location_type_1_radius_type_1 import (
        CompanyCountBodySearchParamsJobPostingsV2Type0AnyOfType0ItemGeoLocationType1RadiusType1,
    )
...
class CompanyCountBodySearchParamsJobPostingsV2Type0AnyOfType0ItemGeoLocationType1:
    ...
    Attributes:
        ...
        city (str):
        radius (CompanyCountBodySearchParamsJobPostingsV2Type0AnyOfType0ItemGeoLocationType1RadiusType0 |
            CompanyCountBodySearchParamsJobPostingsV2Type0AnyOfType0ItemGeoLocationType1RadiusType1):
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.company_count_body_search_params_job_postings_v2_type_0_any_of_type_0_item_geo_location_type_1_radius_type_0 import (
            CompanyCountBodySearchParamsJobPostingsV2Type0AnyOfType0ItemGeoLocationType1RadiusType0,  # noqa: PLC0415
        )
        ...
        radius: dict[str, Any]
        if isinstance(
            self.radius, CompanyCountBodySearchParamsJobPostingsV2Type0AnyOfType0ItemGeoLocationType1RadiusType0
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.company_count_body_search_params_job_postings_v2_type_0_any_of_type_0_item_geo_location_type_1_radius_type_1 import (
            CompanyCountBodySearchParamsJobPostingsV2Type0AnyOfType0ItemGeoLocationType1RadiusType1,  # noqa: PLC0415
        )
        ...
        def _parse_radius(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                radius_type_0 = (
                    CompanyCountBodySearchParamsJobPostingsV2Type0AnyOfType0ItemGeoLocationType1RadiusType0.from_dict(
                        data
                    )
                )
            ...
            if not isinstance(data, dict):
                raise TypeError()
            radius_type_1 = (
                CompanyCountBodySearchParamsJobPostingsV2Type0AnyOfType0ItemGeoLocationType1RadiusType1.from_dict(data)
            )
