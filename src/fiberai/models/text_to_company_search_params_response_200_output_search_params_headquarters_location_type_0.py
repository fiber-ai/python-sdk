...
if TYPE_CHECKING:
    from ..models.text_to_company_search_params_response_200_output_search_params_headquarters_location_type_0_subtract_all_type_0_item_type_0 import (
        TextToCompanySearchParamsResponse200OutputSearchParamsHeadquartersLocationType0SubtractAllType0ItemType0,
    )
    from ..models.text_to_company_search_params_response_200_output_search_params_headquarters_location_type_0_union_all_type_0_item_type_0 import (
        TextToCompanySearchParamsResponse200OutputSearchParamsHeadquartersLocationType0UnionAllType0ItemType0,
    )
...
class TextToCompanySearchParamsResponse200OutputSearchParamsHeadquartersLocationType0:
    ...
    Attributes:
        union_all
            ...
            None | Unset):
        subtract_all
            (list[TextToCompanySearchParamsResponse200OutputSearchParamsHeadquartersLocationType0SubtractAllType0ItemType0]
            | None | Unset):
    """
                ...
                for union_all_type_0_item_data in _union_all_type_0:
                    ...
                    def _parse_union_all_type_0_item(
                        ...
                        if not isinstance(data, dict):
                            raise TypeError()
                        union_all_type_0_item_type_0 = TextToCompanySearchParamsResponse200OutputSearchParamsHeadquartersLocationType0UnionAllType0ItemType0.from_dict(
                            data
                        )
            ...
            try:
                ...
                for subtract_all_type_0_item_data in _subtract_all_type_0:
                    ...
                    def _parse_subtract_all_type_0_item(
                        ...
                        if not isinstance(data, dict):
                            raise TypeError()
                        subtract_all_type_0_item_type_0 = TextToCompanySearchParamsResponse200OutputSearchParamsHeadquartersLocationType0SubtractAllType0ItemType0.from_dict(
                            data
                        )
