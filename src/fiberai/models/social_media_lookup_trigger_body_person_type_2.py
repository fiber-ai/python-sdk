...
from ..models.social_media_lookup_trigger_body_person_type_2_input_type import (
    SocialMediaLookupTriggerBodyPersonType2InputType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="SocialMediaLookupTriggerBodyPersonType2")


@_attrs_define
class SocialMediaLookupTriggerBodyPersonType2:
    """
    Attributes:
        input_type (SocialMediaLookupTriggerBodyPersonType2InputType):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        input_type = SocialMediaLookupTriggerBodyPersonType2InputType(d.pop("inputType"))
        ...
        social_media_lookup_trigger_body_person_type_2 = cls(
        ...
        social_media_lookup_trigger_body_person_type_2.additional_properties = d
        return social_media_lookup_trigger_body_person_type_2
