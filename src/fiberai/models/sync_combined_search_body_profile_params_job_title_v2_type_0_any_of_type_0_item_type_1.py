...
from ..models.sync_combined_search_body_profile_params_job_title_v2_type_0_any_of_type_0_item_type_1_groups_item import (
    SyncCombinedSearchBodyProfileParamsJobTitleV2Type0AnyOfType0ItemType1GroupsItem,
)
from ..models.sync_combined_search_body_profile_params_job_title_v2_type_0_any_of_type_0_item_type_1_type import (
    SyncCombinedSearchBodyProfileParamsJobTitleV2Type0AnyOfType0ItemType1Type,
)
...
class SyncCombinedSearchBodyProfileParamsJobTitleV2Type0AnyOfType0ItemType1:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for groups_item_data in _groups:
            groups_item = SyncCombinedSearchBodyProfileParamsJobTitleV2Type0AnyOfType0ItemType1GroupsItem(
                groups_item_data
            )
