...
T = TypeVar("T", bound="GetJobChangeListBody")


@_attrs_define
class GetJobChangeListBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_job_change_list_body = cls(
            api_key=api_key,
            job_change_list_id=job_change_list_id,
        )

        get_job_change_list_body.additional_properties = d
        return get_job_change_list_body
