...
T = TypeVar("T", bound="CreateSavedSearchBodySearchParamsType0ProfileSearchParamsEducationType0AnyOfType0ItemDegreeType0")



@_attrs_define
class CreateSavedSearchBodySearchParamsType0ProfileSearchParamsEducationType0AnyOfType0ItemDegreeType0:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_saved_search_body_search_params_type_0_profile_search_params_education_type_0_any_of_type_0_item_degree_type_0 = cls(
            any_of=any_of,
            none_of=none_of,
        )


        create_saved_search_body_search_params_type_0_profile_search_params_education_type_0_any_of_type_0_item_degree_type_0.additional_properties = d
        return create_saved_search_body_search_params_type_0_profile_search_params_education_type_0_any_of_type_0_item_degree_type_0
