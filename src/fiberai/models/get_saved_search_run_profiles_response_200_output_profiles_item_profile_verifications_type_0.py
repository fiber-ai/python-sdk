...
if TYPE_CHECKING:
    from ..models.get_saved_search_run_profiles_response_200_output_profiles_item_profile_verifications_type_0_verification_types_type_0_item import (
        GetSavedSearchRunProfilesResponse200OutputProfilesItemProfileVerificationsType0VerificationTypesType0Item,
    )


T = TypeVar("T", bound="GetSavedSearchRunProfilesResponse200OutputProfilesItemProfileVerificationsType0")


@_attrs_define
class GetSavedSearchRunProfilesResponse200OutputProfilesItemProfileVerificationsType0:
    """
    Attributes:
        is_verified (bool | None | Unset):
        joined_date (None | str | Unset):
        verification_types
            (list[GetSavedSearchRunProfilesResponse200OutputProfilesItemProfileVerificationsType0VerificationTypesType0Item]
            | None | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.get_saved_search_run_profiles_response_200_output_profiles_item_profile_verifications_type_0_verification_types_type_0_item import (
            GetSavedSearchRunProfilesResponse200OutputProfilesItemProfileVerificationsType0VerificationTypesType0Item,  # noqa: PLC0415
        )
        ...
        def _parse_verification_types(
            ...
            try:
                ...
                for verification_types_type_0_item_data in _verification_types_type_0:
                    verification_types_type_0_item = GetSavedSearchRunProfilesResponse200OutputProfilesItemProfileVerificationsType0VerificationTypesType0Item.from_dict(
        ...
        get_saved_search_run_profiles_response_200_output_profiles_item_profile_verifications_type_0 = cls(
            is_verified=is_verified,
            joined_date=joined_date,
            verification_types=verification_types,
        )

        get_saved_search_run_profiles_response_200_output_profiles_item_profile_verifications_type_0.additional_properties = d
        return get_saved_search_run_profiles_response_200_output_profiles_item_profile_verifications_type_0
