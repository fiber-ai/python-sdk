...
from ..models.company_search_body_search_params_job_posting_stats_type_0_all_of_type_0_item_type_3_range_type_1_type import (
    CompanySearchBodySearchParamsJobPostingStatsType0AllOfType0ItemType3RangeType1Type,
)

if TYPE_CHECKING:
    from ..models.company_search_body_search_params_job_posting_stats_type_0_all_of_type_0_item_type_3_range_type_1_range_in_hundredths import (
...
class CompanySearchBodySearchParamsJobPostingStatsType0AllOfType0ItemType3RangeType1:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.company_search_body_search_params_job_posting_stats_type_0_all_of_type_0_item_type_3_range_type_1_range_in_hundredths import (
            CompanySearchBodySearchParamsJobPostingStatsType0AllOfType0ItemType3RangeType1RangeInHundredths,  # noqa: PLC0415
        )
        ...
        range_in_hundredths = (
            CompanySearchBodySearchParamsJobPostingStatsType0AllOfType0ItemType3RangeType1RangeInHundredths.from_dict(
