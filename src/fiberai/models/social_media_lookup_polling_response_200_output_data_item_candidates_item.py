...
from ..models.social_media_lookup_polling_response_200_output_data_item_candidates_item_platform import (
    SocialMediaLookupPollingResponse200OutputDataItemCandidatesItemPlatform,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="SocialMediaLookupPollingResponse200OutputDataItemCandidatesItem")


@_attrs_define
class SocialMediaLookupPollingResponse200OutputDataItemCandidatesItem:
    """
    Attributes:
        platform (SocialMediaLookupPollingResponse200OutputDataItemCandidatesItemPlatform): The social media platform
    ...
    platform: SocialMediaLookupPollingResponse200OutputDataItemCandidatesItemPlatform
    handle: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        platform = SocialMediaLookupPollingResponse200OutputDataItemCandidatesItemPlatform(d.pop("platform"))
        ...
        social_media_lookup_polling_response_200_output_data_item_candidates_item = cls(
            platform=platform,
            handle=handle,
        ...
        social_media_lookup_polling_response_200_output_data_item_candidates_item.additional_properties = d
        return social_media_lookup_polling_response_200_output_data_item_candidates_item
