...
from ..models.text_to_company_search_params_response_200_output_search_params_accelerators_v2_type_0_any_of_type_0_item_accelerator_name import (
    TextToCompanySearchParamsResponse200OutputSearchParamsAcceleratorsV2Type0AnyOfType0ItemAcceleratorName,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.text_to_company_search_params_response_200_output_search_params_accelerators_v2_type_0_any_of_type_0_item_batch_selection_type_0 import (
        TextToCompanySearchParamsResponse200OutputSearchParamsAcceleratorsV2Type0AnyOfType0ItemBatchSelectionType0,
    )
    from ..models.text_to_company_search_params_response_200_output_search_params_accelerators_v2_type_0_any_of_type_0_item_batch_selection_type_1 import (
        TextToCompanySearchParamsResponse200OutputSearchParamsAcceleratorsV2Type0AnyOfType0ItemBatchSelectionType1,
    )
    from ..models.text_to_company_search_params_response_200_output_search_params_accelerators_v2_type_0_any_of_type_0_item_years_type_0 import (
        TextToCompanySearchParamsResponse200OutputSearchParamsAcceleratorsV2Type0AnyOfType0ItemYearsType0,
    )
...
class TextToCompanySearchParamsResponse200OutputSearchParamsAcceleratorsV2Type0AnyOfType0Item:
    ...
    Attributes:
        ...
        batch_selection (None |
            ...
            TextToCompanySearchParamsResponse200OutputSearchParamsAcceleratorsV2Type0AnyOfType0ItemBatchSelectionType1 |
            Unset):
        years (None | TextToCompanySearchParamsResponse200OutputSearchParamsAcceleratorsV2Type0AnyOfType0ItemYearsType0
            | Unset):
    """
    ...
    years: (
        None | TextToCompanySearchParamsResponse200OutputSearchParamsAcceleratorsV2Type0AnyOfType0ItemYearsType0 | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_batch_selection(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                batch_selection_type_0 = TextToCompanySearchParamsResponse200OutputSearchParamsAcceleratorsV2Type0AnyOfType0ItemBatchSelectionType0.from_dict(
                    data
                )
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                batch_selection_type_1 = TextToCompanySearchParamsResponse200OutputSearchParamsAcceleratorsV2Type0AnyOfType0ItemBatchSelectionType1.from_dict(
                    data
                )
        ...
        def _parse_years(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                years_type_0 = TextToCompanySearchParamsResponse200OutputSearchParamsAcceleratorsV2Type0AnyOfType0ItemYearsType0.from_dict(
                    data
                )
