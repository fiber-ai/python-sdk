...
if TYPE_CHECKING:
    from ..models.poll_combined_search_response_200_output_data_type_1_items_item_inferred_location_type_0_coordinates_type_0 import (
        PollCombinedSearchResponse200OutputDataType1ItemsItemInferredLocationType0CoordinatesType0,
    )
...
class PollCombinedSearchResponse200OutputDataType1ItemsItemInferredLocationType0:
    ...
    Attributes:
        ...
        coordinates (None | PollCombinedSearchResponse200OutputDataType1ItemsItemInferredLocationType0CoordinatesType0 |
            Unset):
    ...
    coordinates: (
        None | PollCombinedSearchResponse200OutputDataType1ItemsItemInferredLocationType0CoordinatesType0 | Unset
    ) = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.coordinates, Unset):
            ...
            self.coordinates, PollCombinedSearchResponse200OutputDataType1ItemsItemInferredLocationType0CoordinatesType0
        ):
        ...
        def _parse_coordinates(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = PollCombinedSearchResponse200OutputDataType1ItemsItemInferredLocationType0CoordinatesType0.from_dict(
                    data
                )
