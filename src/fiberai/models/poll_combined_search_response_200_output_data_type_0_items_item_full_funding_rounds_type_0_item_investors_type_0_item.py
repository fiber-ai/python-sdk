...
T = TypeVar("T", bound="PollCombinedSearchResponse200OutputDataType0ItemsItemFullFundingRoundsType0ItemInvestorsType0Item")



@_attrs_define
class PollCombinedSearchResponse200OutputDataType0ItemsItemFullFundingRoundsType0ItemInvestorsType0Item:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        poll_combined_search_response_200_output_data_type_0_items_item_full_funding_rounds_type_0_item_investors_type_0_item = cls(
            is_lead=is_lead,
        ...
        poll_combined_search_response_200_output_data_type_0_items_item_full_funding_rounds_type_0_item_investors_type_0_item.additional_properties = d
        return poll_combined_search_response_200_output_data_type_0_items_item_full_funding_rounds_type_0_item_investors_type_0_item
