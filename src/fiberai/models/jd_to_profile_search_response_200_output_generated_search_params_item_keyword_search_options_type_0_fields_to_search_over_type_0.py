...
T = TypeVar(
    "T",
    bound="JdToProfileSearchResponse200OutputGeneratedSearchParamsItemKeywordSearchOptionsType0FieldsToSearchOverType0",
)


@_attrs_define
class JdToProfileSearchResponse200OutputGeneratedSearchParamsItemKeywordSearchOptionsType0FieldsToSearchOverType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        jd_to_profile_search_response_200_output_generated_search_params_item_keyword_search_options_type_0_fields_to_search_over_type_0 = cls(
            summary=summary,
            headline=headline,
        ...
        jd_to_profile_search_response_200_output_generated_search_params_item_keyword_search_options_type_0_fields_to_search_over_type_0.additional_properties = d
        return jd_to_profile_search_response_200_output_generated_search_params_item_keyword_search_options_type_0_fields_to_search_over_type_0
