...
T = TypeVar("T", bound="ReversePhoneLookupResponse200OutputResultsItemType1Company")


@_attrs_define
class ReversePhoneLookupResponse200OutputResultsItemType1Company:
    """
    Attributes:
        slug (str):
        ...
        industries (list[ReversePhoneLookupResponse200OutputResultsItemType1CompanyIndustriesType0Item] | None | Unset):
        inferred_location (None | ReversePhoneLookupResponse200OutputResultsItemType1CompanyInferredLocationType0 |
            Unset):
        linkedin_url (None | str | Unset):
        locations (list[ReversePhoneLookupResponse200OutputResultsItemType1CompanyLocationsType0Item] | None | Unset):
        ...
        locations_stats (None | ReversePhoneLookupResponse200OutputResultsItemType1CompanyLocationsStatsType0 | Unset):
        logo_url (None | str | Unset):
        historical_headcount (None | ReversePhoneLookupResponse200OutputResultsItemType1CompanyHistoricalHeadcountType0
            | Unset):
    ...
    inferred_location: (
        None | ReversePhoneLookupResponse200OutputResultsItemType1CompanyInferredLocationType0 | Unset
    ) = UNSET
    linkedin_url: None | str | Unset = UNSET
    locations: list[ReversePhoneLookupResponse200OutputResultsItemType1CompanyLocationsType0Item] | None | Unset = UNSET
    ...
    historical_headcount: (
        None | ReversePhoneLookupResponse200OutputResultsItemType1CompanyHistoricalHeadcountType0 | Unset
    ) = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.inferred_location, Unset):
            ...
            self.inferred_location, ReversePhoneLookupResponse200OutputResultsItemType1CompanyInferredLocationType0
        ):
        ...
        if isinstance(self.locations_stats, Unset):
            ...
            self.locations_stats, ReversePhoneLookupResponse200OutputResultsItemType1CompanyLocationsStatsType0
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_industries(
            data: object,
        ) -> list[ReversePhoneLookupResponse200OutputResultsItemType1CompanyIndustriesType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for industries_type_0_item_data in _industries_type_0:
                    industries_type_0_item = (
                        ReversePhoneLookupResponse200OutputResultsItemType1CompanyIndustriesType0Item.from_dict(
                ...
                pass
            return cast(
                list[ReversePhoneLookupResponse200OutputResultsItemType1CompanyIndustriesType0Item] | None | Unset, data
            )
        ...
        def _parse_inferred_location(
            ...
            try:
                ...
                inferred_location_type_0 = (
                    ReversePhoneLookupResponse200OutputResultsItemType1CompanyInferredLocationType0.from_dict(data)
                )
                ...
                pass
            return cast(
                None | ReversePhoneLookupResponse200OutputResultsItemType1CompanyInferredLocationType0 | Unset, data
            )
        ...
        def _parse_locations(
            data: object,
        ) -> list[ReversePhoneLookupResponse200OutputResultsItemType1CompanyLocationsType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for locations_type_0_item_data in _locations_type_0:
                    locations_type_0_item = (
                        ReversePhoneLookupResponse200OutputResultsItemType1CompanyLocationsType0Item.from_dict(
                ...
                pass
            return cast(
                list[ReversePhoneLookupResponse200OutputResultsItemType1CompanyLocationsType0Item] | None | Unset, data
            )
        ...
        def _parse_locations_stats(
            data: object,
        ) -> None | ReversePhoneLookupResponse200OutputResultsItemType1CompanyLocationsStatsType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                locations_stats_type_0 = (
                    ReversePhoneLookupResponse200OutputResultsItemType1CompanyLocationsStatsType0.from_dict(data)
                )
                ...
                pass
            return cast(
                None | ReversePhoneLookupResponse200OutputResultsItemType1CompanyLocationsStatsType0 | Unset, data
            )
        ...
        def _parse_historical_headcount(
            ...
            try:
                ...
                historical_headcount_type_0 = (
                    ReversePhoneLookupResponse200OutputResultsItemType1CompanyHistoricalHeadcountType0.from_dict(data)
                )
                ...
                pass
            return cast(
                None | ReversePhoneLookupResponse200OutputResultsItemType1CompanyHistoricalHeadcountType0 | Unset, data
            )
        ...
        reverse_phone_lookup_response_200_output_results_item_type_1_company = cls(
            slug=slug,
            headline=headline,
        ...
        reverse_phone_lookup_response_200_output_results_item_type_1_company.additional_properties = d
        return reverse_phone_lookup_response_200_output_results_item_type_1_company
