...
T = TypeVar("T", bound="StartMosaicBodyOptionsType0ContactInfo")


@_attrs_define
class StartMosaicBodyOptionsType0ContactInfo:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        start_mosaic_body_options_type_0_contact_info = cls(
            get_work_emails=get_work_emails,
            get_personal_emails=get_personal_emails,
            get_phone_numbers=get_phone_numbers,
        )

        start_mosaic_body_options_type_0_contact_info.additional_properties = d
        return start_mosaic_body_options_type_0_contact_info
