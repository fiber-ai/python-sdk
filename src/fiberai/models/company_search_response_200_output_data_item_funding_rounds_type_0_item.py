...
from ..models.company_search_response_200_output_data_item_funding_rounds_type_0_item_round_type_type_1 import (
    CompanySearchResponse200OutputDataItemFundingRoundsType0ItemRoundTypeType1,
)
from ..models.company_search_response_200_output_data_item_funding_rounds_type_0_item_round_type_type_2_type_1 import (
    CompanySearchResponse200OutputDataItemFundingRoundsType0ItemRoundTypeType2Type1,
)
from ..models.company_search_response_200_output_data_item_funding_rounds_type_0_item_round_type_type_3_type_1 import (
    CompanySearchResponse200OutputDataItemFundingRoundsType0ItemRoundTypeType3Type1,
)
...
class CompanySearchResponse200OutputDataItemFundingRoundsType0Item:
    """
    Attributes:
        round_type (CompanySearchResponse200OutputDataItemFundingRoundsType0ItemRoundTypeType1 |
            CompanySearchResponse200OutputDataItemFundingRoundsType0ItemRoundTypeType2Type1 |
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.round_type, Unset):
            ...
            self.round_type, CompanySearchResponse200OutputDataItemFundingRoundsType0ItemRoundTypeType2Type1
        ):
            round_type = self.round_type.value
        elif isinstance(
            self.round_type, CompanySearchResponse200OutputDataItemFundingRoundsType0ItemRoundTypeType3Type1
        ):
            round_type = self.round_type.value
        else:
        ...
        def _parse_round_type(
            ...
            try:
                ...
                round_type_type_2_type_1 = (
                    CompanySearchResponse200OutputDataItemFundingRoundsType0ItemRoundTypeType2Type1(data)
                )
            ...
            try:
                ...
                round_type_type_3_type_1 = (
                    CompanySearchResponse200OutputDataItemFundingRoundsType0ItemRoundTypeType3Type1(data)
                )
