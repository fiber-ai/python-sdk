...
from ..models.poll_exhaustive_contact_enrichment_result_response_200_output_profile_status import (
    PollExhaustiveContactEnrichmentResultResponse200OutputProfileStatus,
)
...
T = TypeVar("T", bound="PollExhaustiveContactEnrichmentResultResponse200OutputProfile")


@_attrs_define
class PollExhaustiveContactEnrichmentResultResponse200OutputProfile:
    """
    Attributes:
        emails (list[PollExhaustiveContactEnrichmentResultResponse200OutputProfileEmailsItem]):
        phone_numbers (list[PollExhaustiveContactEnrichmentResultResponse200OutputProfilePhoneNumbersItem]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for emails_item_data in _emails:
            emails_item = PollExhaustiveContactEnrichmentResultResponse200OutputProfileEmailsItem.from_dict(
                emails_item_data
            )
        ...
        for phone_numbers_item_data in _phone_numbers:
            phone_numbers_item = (
                PollExhaustiveContactEnrichmentResultResponse200OutputProfilePhoneNumbersItem.from_dict(
        ...
        status = PollExhaustiveContactEnrichmentResultResponse200OutputProfileStatus(d.pop("status"))
        ...
        return poll_exhaustive_contact_enrichment_result_response_200_output_profile
