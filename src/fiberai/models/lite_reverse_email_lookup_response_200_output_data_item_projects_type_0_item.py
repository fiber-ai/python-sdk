...
T = TypeVar("T", bound="LiteReverseEmailLookupResponse200OutputDataItemProjectsType0Item")


@_attrs_define
class LiteReverseEmailLookupResponse200OutputDataItemProjectsType0Item:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        lite_reverse_email_lookup_response_200_output_data_item_projects_type_0_item = cls(
        ...
        lite_reverse_email_lookup_response_200_output_data_item_projects_type_0_item.additional_properties = d
        return lite_reverse_email_lookup_response_200_output_data_item_projects_type_0_item
