...
T = TypeVar("T", bound="KitchenSinkBulkCompanyResponse200OutputDataItemItemRevenueEstimateType0")


@_attrs_define
class KitchenSinkBulkCompanyResponse200OutputDataItemItemRevenueEstimateType0:
    """
    Attributes:
        value_usd (KitchenSinkBulkCompanyResponse200OutputDataItemItemRevenueEstimateType0ValueUsd):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        value_usd = KitchenSinkBulkCompanyResponse200OutputDataItemItemRevenueEstimateType0ValueUsd.from_dict(
            d.pop("value_usd")
        )
        ...
        kitchen_sink_bulk_company_response_200_output_data_item_item_revenue_estimate_type_0 = cls(
            value_usd=value_usd,
            sources=sources,
            fiscal_year=fiscal_year,
        )

        kitchen_sink_bulk_company_response_200_output_data_item_item_revenue_estimate_type_0.additional_properties = d
        return kitchen_sink_bulk_company_response_200_output_data_item_item_revenue_estimate_type_0
