...
T = TypeVar("T", bound="TwitterUserTweetsResponse200OutputTweetsItem")


@_attrs_define
class TwitterUserTweetsResponse200OutputTweetsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        twitter_user_tweets_response_200_output_tweets_item.additional_properties = d
        return twitter_user_tweets_response_200_output_tweets_item
