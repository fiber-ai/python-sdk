...
T = TypeVar(
    "T", bound="QuickPersonResolveResponse200OutputDataItemPersonType0DetailedEducationType0ItemSchoolDetailsType0"
)


@_attrs_define
class QuickPersonResolveResponse200OutputDataItemPersonType0DetailedEducationType0ItemSchoolDetailsType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        quick_person_resolve_response_200_output_data_item_person_type_0_detailed_education_type_0_item_school_details_type_0 = cls(
        ...
        quick_person_resolve_response_200_output_data_item_person_type_0_detailed_education_type_0_item_school_details_type_0.additional_properties = d
        return quick_person_resolve_response_200_output_data_item_person_type_0_detailed_education_type_0_item_school_details_type_0
