...
T = TypeVar("T", bound="SyncQuickContactRevealBodyEnrichmentType")


@_attrs_define
class SyncQuickContactRevealBodyEnrichmentType:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sync_quick_contact_reveal_body_enrichment_type = cls(
            get_work_emails=get_work_emails,
            get_personal_emails=get_personal_emails,
            get_phone_numbers=get_phone_numbers,
        )

        sync_quick_contact_reveal_body_enrichment_type.additional_properties = d
        return sync_quick_contact_reveal_body_enrichment_type
