...
if TYPE_CHECKING:
  from ..models.get_saved_search_run_companies_response_200_output_companies_item_company_accelerators_type_0_item_founders_type_0_item import GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyAcceleratorsType0ItemFoundersType0Item





T = TypeVar("T", bound="GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyAcceleratorsType0Item")



@_attrs_define
class GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyAcceleratorsType0Item:
    """ 
        Attributes:
            ...
            founders (Union[None, Unset,
                list['GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyAcceleratorsType0ItemFoundersType0Item']]):
    ...
    founders: Union[None, Unset, list['GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyAcceleratorsType0ItemFoundersType0Item']] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_founders(data: object) -> Union[None, Unset, list['GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyAcceleratorsType0ItemFoundersType0Item']]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for founders_type_0_item_data in (_founders_type_0):
                    founders_type_0_item = GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyAcceleratorsType0ItemFoundersType0Item.from_dict(founders_type_0_item_data)
                ...
                pass
            return cast(Union[None, Unset, list['GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyAcceleratorsType0ItemFoundersType0Item']], data)
        ...
        get_saved_search_run_companies_response_200_output_companies_item_company_accelerators_type_0_item = cls(
            id=id,
            slug=slug,
            tags=tags,
            year=year,
        ...
        get_saved_search_run_companies_response_200_output_companies_item_company_accelerators_type_0_item.additional_properties = d
        return get_saved_search_run_companies_response_200_output_companies_item_company_accelerators_type_0_item
