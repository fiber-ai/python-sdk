...
if TYPE_CHECKING:
    ...
    from ..models.get_regions_response_200_charge_info_type_4 import GetRegionsResponse200ChargeInfoType4
...
class GetRegionsResponse200:
    ...
    Attributes:
        ...
        charge_info (GetRegionsResponse200ChargeInfoType0 | GetRegionsResponse200ChargeInfoType1 |
            GetRegionsResponse200ChargeInfoType2 | GetRegionsResponse200ChargeInfoType3 |
            GetRegionsResponse200ChargeInfoType4):
        warnings (list[GetRegionsResponse200WarningsType0Item] | None | Unset): Warnings about extraneous fields in
            request
    ...
    output: GetRegionsResponse200Output
    charge_info: (
        GetRegionsResponse200ChargeInfoType0
        | GetRegionsResponse200ChargeInfoType1
        | GetRegionsResponse200ChargeInfoType2
        | GetRegionsResponse200ChargeInfoType3
        | GetRegionsResponse200ChargeInfoType4
    )
    warnings: list[GetRegionsResponse200WarningsType0Item] | None | Unset = UNSET
    advice: list[str] | None | Unset = UNSET

    def to_dict(self) -> dict[str, Any]:
        from ..models.get_regions_response_200_charge_info_type_0 import (
            GetRegionsResponse200ChargeInfoType0,  # noqa: PLC0415
        )
        from ..models.get_regions_response_200_charge_info_type_1 import (
            GetRegionsResponse200ChargeInfoType1,  # noqa: PLC0415
        )
        from ..models.get_regions_response_200_charge_info_type_2 import (
            GetRegionsResponse200ChargeInfoType2,  # noqa: PLC0415
        )
        from ..models.get_regions_response_200_charge_info_type_3 import (
            GetRegionsResponse200ChargeInfoType3,  # noqa: PLC0415
        )
        ...
        if isinstance(self.charge_info, GetRegionsResponse200ChargeInfoType0):
            ...
            charge_info = self.charge_info.to_dict()
        elif isinstance(self.charge_info, GetRegionsResponse200ChargeInfoType3):
            charge_info = self.charge_info.to_dict()
        else:
            charge_info = self.charge_info.to_dict()
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.get_regions_response_200_charge_info_type_4 import (
            GetRegionsResponse200ChargeInfoType4,  # noqa: PLC0415
        )
        from ..models.get_regions_response_200_output import GetRegionsResponse200Output  # noqa: PLC0415
        from ..models.get_regions_response_200_warnings_type_0_item import (
            GetRegionsResponse200WarningsType0Item,  # noqa: PLC0415
        )
        ...
        def _parse_charge_info(
            ...
            if not isinstance(data, dict):
                raise TypeError()
            charge_info_type_4 = GetRegionsResponse200ChargeInfoType4.from_dict(data)

            return charge_info_type_4

        charge_info = _parse_charge_info(d.pop("chargeInfo"))

        def _parse_warnings(data: object) -> list[GetRegionsResponse200WarningsType0Item] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                pass
            return cast(list[GetRegionsResponse200WarningsType0Item] | None | Unset, data)
