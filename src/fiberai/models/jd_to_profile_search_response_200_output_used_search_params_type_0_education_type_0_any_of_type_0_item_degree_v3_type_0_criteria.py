...
T = TypeVar(
    "T",
    bound="JdToProfileSearchResponse200OutputUsedSearchParamsType0EducationType0AnyOfType0ItemDegreeV3Type0Criteria",
)


@_attrs_define
class JdToProfileSearchResponse200OutputUsedSearchParamsType0EducationType0AnyOfType0ItemDegreeV3Type0Criteria:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        jd_to_profile_search_response_200_output_used_search_params_type_0_education_type_0_any_of_type_0_item_degree_v3_type_0_criteria = cls(
            any_of=any_of,
            none_of=none_of,
        )

        jd_to_profile_search_response_200_output_used_search_params_type_0_education_type_0_any_of_type_0_item_degree_v3_type_0_criteria.additional_properties = d
        return jd_to_profile_search_response_200_output_used_search_params_type_0_education_type_0_any_of_type_0_item_degree_v3_type_0_criteria
