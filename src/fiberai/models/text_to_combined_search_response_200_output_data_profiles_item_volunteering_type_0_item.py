...
T = TypeVar("T", bound="TextToCombinedSearchResponse200OutputDataProfilesItemVolunteeringType0Item")


@_attrs_define
class TextToCombinedSearchResponse200OutputDataProfilesItemVolunteeringType0Item:
    """
    Attributes:
        role (None | str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        text_to_combined_search_response_200_output_data_profiles_item_volunteering_type_0_item = cls(
            role=role,
        ...
        text_to_combined_search_response_200_output_data_profiles_item_volunteering_type_0_item.additional_properties = d
        return text_to_combined_search_response_200_output_data_profiles_item_volunteering_type_0_item
