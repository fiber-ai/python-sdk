...
T = TypeVar("T", bound="CreateTrackerCompanyListBodyCompanySearchParamsType0TechnologiesType0")


@_attrs_define
class CreateTrackerCompanyListBodyCompanySearchParamsType0TechnologiesType0:
    """
    Attributes:
        any_of (list[CreateTrackerCompanyListBodyCompanySearchParamsType0TechnologiesType0AnyOfType0ItemType0 |
            CreateTrackerCompanyListBodyCompanySearchParamsType0TechnologiesType0AnyOfType0ItemType1] | None | Unset):
        all_of (list[CreateTrackerCompanyListBodyCompanySearchParamsType0TechnologiesType0AllOfType0ItemType0 |
            CreateTrackerCompanyListBodyCompanySearchParamsType0TechnologiesType0AllOfType0ItemType1] | None | Unset):
        none_of (list[CreateTrackerCompanyListBodyCompanySearchParamsType0TechnologiesType0NoneOfType0ItemType0 |
            CreateTrackerCompanyListBodyCompanySearchParamsType0TechnologiesType0NoneOfType0ItemType1] | None | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
                    ...
                    def _parse_any_of_type_0_item(
                        ...
                        try:
                            if not isinstance(data, dict):
                                raise TypeError()
                            any_of_type_0_item_type_0 = CreateTrackerCompanyListBodyCompanySearchParamsType0TechnologiesType0AnyOfType0ItemType0.from_dict(
                                data
                            )
                        ...
                        if not isinstance(data, dict):
                            raise TypeError()
                        any_of_type_0_item_type_1 = CreateTrackerCompanyListBodyCompanySearchParamsType0TechnologiesType0AnyOfType0ItemType1.from_dict(
                            data
                        )
                ...
                for all_of_type_0_item_data in _all_of_type_0:
                    ...
                    def _parse_all_of_type_0_item(
                        ...
                        try:
                            if not isinstance(data, dict):
                                raise TypeError()
                            all_of_type_0_item_type_0 = CreateTrackerCompanyListBodyCompanySearchParamsType0TechnologiesType0AllOfType0ItemType0.from_dict(
                                data
                            )
                        ...
                        if not isinstance(data, dict):
                            raise TypeError()
                        all_of_type_0_item_type_1 = CreateTrackerCompanyListBodyCompanySearchParamsType0TechnologiesType0AllOfType0ItemType1.from_dict(
                            data
                        )
                ...
                for none_of_type_0_item_data in _none_of_type_0:
                    ...
                    def _parse_none_of_type_0_item(
                        ...
                        try:
                            if not isinstance(data, dict):
                                raise TypeError()
                            none_of_type_0_item_type_0 = CreateTrackerCompanyListBodyCompanySearchParamsType0TechnologiesType0NoneOfType0ItemType0.from_dict(
                                data
                            )
                        ...
                        if not isinstance(data, dict):
                            raise TypeError()
                        none_of_type_0_item_type_1 = CreateTrackerCompanyListBodyCompanySearchParamsType0TechnologiesType0NoneOfType0ItemType1.from_dict(
                            data
                        )
        ...
        create_tracker_company_list_body_company_search_params_type_0_technologies_type_0 = cls(
            any_of=any_of,
            all_of=all_of,
            none_of=none_of,
        )

        create_tracker_company_list_body_company_search_params_type_0_technologies_type_0.additional_properties = d
        return create_tracker_company_list_body_company_search_params_type_0_technologies_type_0
