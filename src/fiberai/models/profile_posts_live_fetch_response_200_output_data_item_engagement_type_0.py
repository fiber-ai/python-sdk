...
if TYPE_CHECKING:
  from ..models.profile_posts_live_fetch_response_200_output_data_item_engagement_type_0_reactions_by_type_type_0_item import ProfilePostsLiveFetchResponse200OutputDataItemEngagementType0ReactionsByTypeType0Item





T = TypeVar("T", bound="ProfilePostsLiveFetchResponse200OutputDataItemEngagementType0")



@_attrs_define
class ProfilePostsLiveFetchResponse200OutputDataItemEngagementType0:
    """ 
        Attributes:
            ...
            reactions_by_type (Union[None, Unset,
                list['ProfilePostsLiveFetchResponse200OutputDataItemEngagementType0ReactionsByTypeType0Item']]):
     """
    ...
    reactions_by_type: Union[None, Unset, list['ProfilePostsLiveFetchResponse200OutputDataItemEngagementType0ReactionsByTypeType0Item']] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_reactions_by_type(data: object) -> Union[None, Unset, list['ProfilePostsLiveFetchResponse200OutputDataItemEngagementType0ReactionsByTypeType0Item']]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for reactions_by_type_type_0_item_data in (_reactions_by_type_type_0):
                    reactions_by_type_type_0_item = ProfilePostsLiveFetchResponse200OutputDataItemEngagementType0ReactionsByTypeType0Item.from_dict(reactions_by_type_type_0_item_data)
                ...
                pass
            return cast(Union[None, Unset, list['ProfilePostsLiveFetchResponse200OutputDataItemEngagementType0ReactionsByTypeType0Item']], data)

        reactions_by_type = _parse_reactions_by_type(d.pop("reactionsByType", UNSET))


        profile_posts_live_fetch_response_200_output_data_item_engagement_type_0 = cls(
        ...
        profile_posts_live_fetch_response_200_output_data_item_engagement_type_0.additional_properties = d
        return profile_posts_live_fetch_response_200_output_data_item_engagement_type_0
