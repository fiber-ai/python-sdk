...
if TYPE_CHECKING:
    from ..models.profile_posts_live_fetch_response_200_output_data_item_engagement_type_0_reactions_by_type_type_0_item import (
        ProfilePostsLiveFetchResponse200OutputDataItemEngagementType0ReactionsByTypeType0Item,
    )
...
class ProfilePostsLiveFetchResponse200OutputDataItemEngagementType0:
    ...
    Attributes:
        ...
        reactions_by_type (list[ProfilePostsLiveFetchResponse200OutputDataItemEngagementType0ReactionsByTypeType0Item] |
            None | Unset):
    """
    ...
    reactions_by_type: (
        list[ProfilePostsLiveFetchResponse200OutputDataItemEngagementType0ReactionsByTypeType0Item] | None | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.profile_posts_live_fetch_response_200_output_data_item_engagement_type_0_reactions_by_type_type_0_item import (
            ProfilePostsLiveFetchResponse200OutputDataItemEngagementType0ReactionsByTypeType0Item,  # noqa: PLC0415
        )
            ...
            try:
                ...
                for reactions_by_type_type_0_item_data in _reactions_by_type_type_0:
                    reactions_by_type_type_0_item = (
                        ProfilePostsLiveFetchResponse200OutputDataItemEngagementType0ReactionsByTypeType0Item.from_dict(
