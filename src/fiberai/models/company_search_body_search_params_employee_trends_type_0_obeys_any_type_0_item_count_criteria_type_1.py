...
from ..models.company_search_body_search_params_employee_trends_type_0_obeys_any_type_0_item_count_criteria_type_1_type import CompanySearchBodySearchParamsEmployeeTrendsType0ObeysAnyType0ItemCountCriteriaType1Type
from typing import cast

if TYPE_CHECKING:
  from ..models.company_search_body_search_params_employee_trends_type_0_obeys_any_type_0_item_count_criteria_type_1_change import CompanySearchBodySearchParamsEmployeeTrendsType0ObeysAnyType0ItemCountCriteriaType1Change
...
class CompanySearchBodySearchParamsEmployeeTrendsType0ObeysAnyType0ItemCountCriteriaType1:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        change = CompanySearchBodySearchParamsEmployeeTrendsType0ObeysAnyType0ItemCountCriteriaType1Change.from_dict(d.pop("change"))
