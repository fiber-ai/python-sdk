...
T = TypeVar("T", bound="PaginatedCombinedSearchBodyProfileConfigType0SearchParamsJoinedLinkedInAtType0RangeType0")


@_attrs_define
class PaginatedCombinedSearchBodyProfileConfigType0SearchParamsJoinedLinkedInAtType0RangeType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        paginated_combined_search_body_profile_config_type_0_search_params_joined_linked_in_at_type_0_range_type_0 = (
            cls(
        ...
        paginated_combined_search_body_profile_config_type_0_search_params_joined_linked_in_at_type_0_range_type_0.additional_properties = d
        return (
            paginated_combined_search_body_profile_config_type_0_search_params_joined_linked_in_at_type_0_range_type_0
        )
