...
if TYPE_CHECKING:
  from ..models.text_to_combined_search_response_200_output_data_companies_item_location_consensus_type_0_coordinates_type_0 import TextToCombinedSearchResponse200OutputDataCompaniesItemLocationConsensusType0CoordinatesType0





T = TypeVar("T", bound="TextToCombinedSearchResponse200OutputDataCompaniesItemLocationConsensusType0")



@_attrs_define
class TextToCombinedSearchResponse200OutputDataCompaniesItemLocationConsensusType0:
    """ 
        Attributes:
            ...
            coordinates
                (Union['TextToCombinedSearchResponse200OutputDataCompaniesItemLocationConsensusType0CoordinatesType0', None,
                Unset]):
    ...
    coordinates: Union['TextToCombinedSearchResponse200OutputDataCompaniesItemLocationConsensusType0CoordinatesType0', None, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.coordinates, Unset):
            coordinates = UNSET
        elif isinstance(self.coordinates, TextToCombinedSearchResponse200OutputDataCompaniesItemLocationConsensusType0CoordinatesType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_coordinates(data: object) -> Union['TextToCombinedSearchResponse200OutputDataCompaniesItemLocationConsensusType0CoordinatesType0', None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = TextToCombinedSearchResponse200OutputDataCompaniesItemLocationConsensusType0CoordinatesType0.from_dict(data)
                ...
                pass
            return cast(Union['TextToCombinedSearchResponse200OutputDataCompaniesItemLocationConsensusType0CoordinatesType0', None, Unset], data)
        ...
        text_to_combined_search_response_200_output_data_companies_item_location_consensus_type_0 = cls(
        ...
        text_to_combined_search_response_200_output_data_companies_item_location_consensus_type_0.additional_properties = d
        return text_to_combined_search_response_200_output_data_companies_item_location_consensus_type_0
