...
if TYPE_CHECKING:
    from ..models.text_to_combined_search_response_200_output_data_companies_item_location_consensus_type_0_coordinates_type_0 import (
        TextToCombinedSearchResponse200OutputDataCompaniesItemLocationConsensusType0CoordinatesType0,
    )
...
class TextToCombinedSearchResponse200OutputDataCompaniesItemLocationConsensusType0:
    ...
    Attributes:
        ...
        coordinates (None | TextToCombinedSearchResponse200OutputDataCompaniesItemLocationConsensusType0CoordinatesType0
            | Unset):
    ...
    coordinates: (
        None | TextToCombinedSearchResponse200OutputDataCompaniesItemLocationConsensusType0CoordinatesType0 | Unset
    ) = UNSET
        ...
        def _parse_coordinates(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = TextToCombinedSearchResponse200OutputDataCompaniesItemLocationConsensusType0CoordinatesType0.from_dict(
                    data
                )
