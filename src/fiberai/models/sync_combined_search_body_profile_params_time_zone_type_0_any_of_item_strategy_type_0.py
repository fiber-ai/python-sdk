...
from ..models.sync_combined_search_body_profile_params_time_zone_type_0_any_of_item_strategy_type_0_mode import SyncCombinedSearchBodyProfileParamsTimeZoneType0AnyOfItemStrategyType0Mode
...
T = TypeVar("T", bound="SyncCombinedSearchBodyProfileParamsTimeZoneType0AnyOfItemStrategyType0")



@_attrs_define
class SyncCombinedSearchBodyProfileParamsTimeZoneType0AnyOfItemStrategyType0:
    """ 
        Attributes:
            mode (SyncCombinedSearchBodyProfileParamsTimeZoneType0AnyOfItemStrategyType0Mode):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        mode = SyncCombinedSearchBodyProfileParamsTimeZoneType0AnyOfItemStrategyType0Mode(d.pop("mode"))
        ...
        sync_combined_search_body_profile_params_time_zone_type_0_any_of_item_strategy_type_0 = cls(
            mode=mode,
        ...
        sync_combined_search_body_profile_params_time_zone_type_0_any_of_item_strategy_type_0.additional_properties = d
        return sync_combined_search_body_profile_params_time_zone_type_0_any_of_item_strategy_type_0
