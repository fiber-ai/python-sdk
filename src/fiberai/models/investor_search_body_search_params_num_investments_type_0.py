...
T = TypeVar("T", bound="InvestorSearchBodySearchParamsNumInvestmentsType0")


@_attrs_define
class InvestorSearchBodySearchParamsNumInvestmentsType0:
    """Filter by total investment count (range)
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        investor_search_body_search_params_num_investments_type_0 = cls(
            lower_bound=lower_bound,
            upper_bound=upper_bound,
        )

        investor_search_body_search_params_num_investments_type_0.additional_properties = d
        return investor_search_body_search_params_num_investments_type_0
