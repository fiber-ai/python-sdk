...
@_attrs_define
class CombinedSearchCountBodyCompanyParamsJobPostingsV2Type0NoneOfType0ItemGeoLocationType2:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.combined_search_count_body_company_params_job_postings_v2_type_0_none_of_type_0_item_geo_location_type_2_vertices_item import (
            CombinedSearchCountBodyCompanyParamsJobPostingsV2Type0NoneOfType0ItemGeoLocationType2VerticesItem,  # noqa: PLC0415
        )
        ...
        return combined_search_count_body_company_params_job_postings_v2_type_0_none_of_type_0_item_geo_location_type_2
