...
if TYPE_CHECKING:
    from ..models.jd_to_profile_search_response_200_output_data_item_verifications_type_0_verification_types_type_0_item import (
        JdToProfileSearchResponse200OutputDataItemVerificationsType0VerificationTypesType0Item,
    )


T = TypeVar("T", bound="JdToProfileSearchResponse200OutputDataItemVerificationsType0")


@_attrs_define
class JdToProfileSearchResponse200OutputDataItemVerificationsType0:
    """
    Attributes:
        is_verified (bool | None | Unset):
        joined_date (None | str | Unset):
        verification_types (list[JdToProfileSearchResponse200OutputDataItemVerificationsType0VerificationTypesType0Item]
            | None | Unset):
    """
    ...
    verification_types: (
        list[JdToProfileSearchResponse200OutputDataItemVerificationsType0VerificationTypesType0Item] | None | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_verification_types(
            ...
            try:
                ...
                for verification_types_type_0_item_data in _verification_types_type_0:
                    verification_types_type_0_item = JdToProfileSearchResponse200OutputDataItemVerificationsType0VerificationTypesType0Item.from_dict(
                ...
                pass
            return cast(
                list[JdToProfileSearchResponse200OutputDataItemVerificationsType0VerificationTypesType0Item]
                | None
                | Unset,
                data,
            )
        ...
        jd_to_profile_search_response_200_output_data_item_verifications_type_0 = cls(
            is_verified=is_verified,
            joined_date=joined_date,
            verification_types=verification_types,
        )

        jd_to_profile_search_response_200_output_data_item_verifications_type_0.additional_properties = d
        return jd_to_profile_search_response_200_output_data_item_verifications_type_0
