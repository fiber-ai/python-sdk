...
from ..models.combined_search_body_company_params_exact_company_type_0_none_of_type_0_item_source_type_1 import (
    CombinedSearchBodyCompanyParamsExactCompanyType0NoneOfType0ItemSourceType1,
)
from ..models.combined_search_body_company_params_exact_company_type_0_none_of_type_0_item_source_type_2_type_1 import (
    CombinedSearchBodyCompanyParamsExactCompanyType0NoneOfType0ItemSourceType2Type1,
)
from ..models.combined_search_body_company_params_exact_company_type_0_none_of_type_0_item_source_type_3_type_1 import (
    CombinedSearchBodyCompanyParamsExactCompanyType0NoneOfType0ItemSourceType3Type1,
)
...
class CombinedSearchBodyCompanyParamsExactCompanyType0NoneOfType0Item:
    ...
    Attributes:
        ...
        source (CombinedSearchBodyCompanyParamsExactCompanyType0NoneOfType0ItemSourceType1 |
            CombinedSearchBodyCompanyParamsExactCompanyType0NoneOfType0ItemSourceType2Type1 |
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_source(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                source_type_2_type_1 = CombinedSearchBodyCompanyParamsExactCompanyType0NoneOfType0ItemSourceType2Type1(
                    data
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                source_type_3_type_1 = CombinedSearchBodyCompanyParamsExactCompanyType0NoneOfType0ItemSourceType3Type1(
                    data
                )
