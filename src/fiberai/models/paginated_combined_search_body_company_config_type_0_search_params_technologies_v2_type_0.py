...
T = TypeVar("T", bound="PaginatedCombinedSearchBodyCompanyConfigType0SearchParamsTechnologiesV2Type0")


@_attrs_define
class PaginatedCombinedSearchBodyCompanyConfigType0SearchParamsTechnologiesV2Type0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        paginated_combined_search_body_company_config_type_0_search_params_technologies_v2_type_0 = cls(
            any_of=any_of,
            all_of=all_of,
            none_of=none_of,
        )

        paginated_combined_search_body_company_config_type_0_search_params_technologies_v2_type_0.additional_properties = d
        return paginated_combined_search_body_company_config_type_0_search_params_technologies_v2_type_0
