...
if TYPE_CHECKING:
    from ..models.poll_batch_contact_enrichment_response_200_output_overall_stats import (
        PollBatchContactEnrichmentResponse200OutputOverallStats,
    )
    from ..models.poll_batch_contact_enrichment_response_200_output_page_results_item import (
        PollBatchContactEnrichmentResponse200OutputPageResultsItem,
    )
...
class PollBatchContactEnrichmentResponse200Output:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for page_results_item_data in _page_results:
            page_results_item = PollBatchContactEnrichmentResponse200OutputPageResultsItem.from_dict(
