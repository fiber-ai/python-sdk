...
from ..models.combined_search_count_body_profile_params_location_type_0_union_all_type_0_item_type_2_region import (
    CombinedSearchCountBodyProfileParamsLocationType0UnionAllType0ItemType2Region,
)
...
class CombinedSearchCountBodyProfileParamsLocationType0UnionAllType0ItemType2:
    ...
    Attributes:
        ...
        region (CombinedSearchCountBodyProfileParamsLocationType0UnionAllType0ItemType2Region):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        region = CombinedSearchCountBodyProfileParamsLocationType0UnionAllType0ItemType2Region(d.pop("region"))
