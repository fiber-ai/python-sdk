...
if TYPE_CHECKING:
    from ..models.list_tracker_company_lists_response_200_output_lists_item_tracking_rules_type_0_item import (
        ListTrackerCompanyListsResponse200OutputListsItemTrackingRulesType0Item,
    )


T = TypeVar("T", bound="ListTrackerCompanyListsResponse200OutputListsItem")


@_attrs_define
class ListTrackerCompanyListsResponse200OutputListsItem:
    """
    Attributes:
        ...
        tracking_rules (list[ListTrackerCompanyListsResponse200OutputListsItemTrackingRulesType0Item] | None | Unset):
    ...
    tracking_rules: list[ListTrackerCompanyListsResponse200OutputListsItemTrackingRulesType0Item] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_tracking_rules(
            data: object,
        ) -> list[ListTrackerCompanyListsResponse200OutputListsItemTrackingRulesType0Item] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for tracking_rules_type_0_item_data in _tracking_rules_type_0:
                    tracking_rules_type_0_item = (
                        ListTrackerCompanyListsResponse200OutputListsItemTrackingRulesType0Item.from_dict(
                ...
                pass
            return cast(
                list[ListTrackerCompanyListsResponse200OutputListsItemTrackingRulesType0Item] | None | Unset, data
            )

        tracking_rules = _parse_tracking_rules(d.pop("trackingRules", UNSET))

        list_tracker_company_lists_response_200_output_lists_item = cls(
            id=id,
            name=name,
        ...
        list_tracker_company_lists_response_200_output_lists_item.additional_properties = d
        return list_tracker_company_lists_response_200_output_lists_item
