...
T = TypeVar("T", bound="TiktokSearchUsersBody")


@_attrs_define
class TiktokSearchUsersBody:
    """
    Attributes:
        api_key (str): Your Fiber API key
        query (str): Search query to find TikTok users (e.g. 'Dwayne Johnson').
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        tiktok_search_users_body = cls(
            api_key=api_key,
            query=query,
            next_page_token=next_page_token,
        )

        tiktok_search_users_body.additional_properties = d
        return tiktok_search_users_body
