...
from ..models.reverse_email_lookup_response_200_output_data_item_experiences_type_0_item_academic_qualification_type_0_item import (
    ReverseEmailLookupResponse200OutputDataItemExperiencesType0ItemAcademicQualificationType0Item,
)
from ..models.reverse_email_lookup_response_200_output_data_item_experiences_type_0_item_employment_type_type_0_item import (
    ReverseEmailLookupResponse200OutputDataItemExperiencesType0ItemEmploymentTypeType0Item,
)
from ..models.reverse_email_lookup_response_200_output_data_item_experiences_type_0_item_job_function_type_0_item import (
    ReverseEmailLookupResponse200OutputDataItemExperiencesType0ItemJobFunctionType0Item,
)
from ..models.reverse_email_lookup_response_200_output_data_item_experiences_type_0_item_seniority_type_1 import (
    ReverseEmailLookupResponse200OutputDataItemExperiencesType0ItemSeniorityType1,
)
from ..models.reverse_email_lookup_response_200_output_data_item_experiences_type_0_item_seniority_type_2_type_1 import (
    ReverseEmailLookupResponse200OutputDataItemExperiencesType0ItemSeniorityType2Type1,
)
from ..models.reverse_email_lookup_response_200_output_data_item_experiences_type_0_item_seniority_type_3_type_1 import (
    ReverseEmailLookupResponse200OutputDataItemExperiencesType0ItemSeniorityType3Type1,
)
...
class ReverseEmailLookupResponse200OutputDataItemExperiencesType0Item:
    ...
    Attributes:
        ...
        seniority (None | ReverseEmailLookupResponse200OutputDataItemExperiencesType0ItemSeniorityType1 |
            ReverseEmailLookupResponse200OutputDataItemExperiencesType0ItemSeniorityType2Type1 |
            ReverseEmailLookupResponse200OutputDataItemExperiencesType0ItemSeniorityType3Type1 | Unset):
        job_function (list[ReverseEmailLookupResponse200OutputDataItemExperiencesType0ItemJobFunctionType0Item] | None |
            Unset):
        employment_type (list[ReverseEmailLookupResponse200OutputDataItemExperiencesType0ItemEmploymentTypeType0Item] |
            None | Unset):
        academic_qualification
            (list[ReverseEmailLookupResponse200OutputDataItemExperiencesType0ItemAcademicQualificationType0Item] | None |
            Unset):
    ...
    job_function: (
        list[ReverseEmailLookupResponse200OutputDataItemExperiencesType0ItemJobFunctionType0Item] | None | Unset
    ) = UNSET
    employment_type: (
        list[ReverseEmailLookupResponse200OutputDataItemExperiencesType0ItemEmploymentTypeType0Item] | None | Unset
    ) = UNSET
    academic_qualification: (
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.seniority, Unset):
            ...
            self.seniority, ReverseEmailLookupResponse200OutputDataItemExperiencesType0ItemSeniorityType2Type1
        ):
            seniority = self.seniority.value
        elif isinstance(
            self.seniority, ReverseEmailLookupResponse200OutputDataItemExperiencesType0ItemSeniorityType3Type1
        ):
            seniority = self.seniority.value
        else:
        ...
        def _parse_seniority(
            ...
            try:
                ...
                seniority_type_2_type_1 = (
                    ReverseEmailLookupResponse200OutputDataItemExperiencesType0ItemSeniorityType2Type1(data)
                )
            ...
            try:
                ...
                seniority_type_3_type_1 = (
                    ReverseEmailLookupResponse200OutputDataItemExperiencesType0ItemSeniorityType3Type1(data)
                )
