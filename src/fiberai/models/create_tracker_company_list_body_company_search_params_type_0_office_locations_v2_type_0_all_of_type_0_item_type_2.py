...
from ..models.create_tracker_company_list_body_company_search_params_type_0_office_locations_v2_type_0_all_of_type_0_item_type_2_type import (
    CreateTrackerCompanyListBodyCompanySearchParamsType0OfficeLocationsV2Type0AllOfType0ItemType2Type,
)
...
T = TypeVar("T", bound="CreateTrackerCompanyListBodyCompanySearchParamsType0OfficeLocationsV2Type0AllOfType0ItemType2")


@_attrs_define
class CreateTrackerCompanyListBodyCompanySearchParamsType0OfficeLocationsV2Type0AllOfType0ItemType2:
    """
    Attributes:
        type_ (CreateTrackerCompanyListBodyCompanySearchParamsType0OfficeLocationsV2Type0AllOfType0ItemType2Type):
        location
            (CreateTrackerCompanyListBodyCompanySearchParamsType0OfficeLocationsV2Type0AllOfType0ItemType2LocationType0 |
            CreateTrackerCompanyListBodyCompanySearchParamsType0OfficeLocationsV2Type0AllOfType0ItemType2LocationType1 |
            CreateTrackerCompanyListBodyCompanySearchParamsType0OfficeLocationsV2Type0AllOfType0ItemType2LocationType2 |
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_location(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                location_type_0 = CreateTrackerCompanyListBodyCompanySearchParamsType0OfficeLocationsV2Type0AllOfType0ItemType2LocationType0.from_dict(
                    data
                )
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                location_type_1 = CreateTrackerCompanyListBodyCompanySearchParamsType0OfficeLocationsV2Type0AllOfType0ItemType2LocationType1.from_dict(
                    data
                )
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                location_type_2 = CreateTrackerCompanyListBodyCompanySearchParamsType0OfficeLocationsV2Type0AllOfType0ItemType2LocationType2.from_dict(
                    data
                )
            ...
            if not isinstance(data, dict):
                raise TypeError()
            location_type_3 = CreateTrackerCompanyListBodyCompanySearchParamsType0OfficeLocationsV2Type0AllOfType0ItemType2LocationType3.from_dict(
                data
            )
        ...
        create_tracker_company_list_body_company_search_params_type_0_office_locations_v2_type_0_all_of_type_0_item_type_2 = cls(
            type_=type_,
            location=location,
        )

        create_tracker_company_list_body_company_search_params_type_0_office_locations_v2_type_0_all_of_type_0_item_type_2.additional_properties = d
        return create_tracker_company_list_body_company_search_params_type_0_office_locations_v2_type_0_all_of_type_0_item_type_2
