...
from ..models.quick_person_resolve_response_200_output_data_item_person_type_0_current_job_type_0_academic_qualification_type_0_item import (
    QuickPersonResolveResponse200OutputDataItemPersonType0CurrentJobType0AcademicQualificationType0Item,
)
from ..models.quick_person_resolve_response_200_output_data_item_person_type_0_current_job_type_0_employment_type_type_0_item import (
    QuickPersonResolveResponse200OutputDataItemPersonType0CurrentJobType0EmploymentTypeType0Item,
)
from ..models.quick_person_resolve_response_200_output_data_item_person_type_0_current_job_type_0_job_function_type_0_item import (
    QuickPersonResolveResponse200OutputDataItemPersonType0CurrentJobType0JobFunctionType0Item,
)
from ..models.quick_person_resolve_response_200_output_data_item_person_type_0_current_job_type_0_seniority_type_1 import (
    QuickPersonResolveResponse200OutputDataItemPersonType0CurrentJobType0SeniorityType1,
)
from ..models.quick_person_resolve_response_200_output_data_item_person_type_0_current_job_type_0_seniority_type_2_type_1 import (
    QuickPersonResolveResponse200OutputDataItemPersonType0CurrentJobType0SeniorityType2Type1,
)
from ..models.quick_person_resolve_response_200_output_data_item_person_type_0_current_job_type_0_seniority_type_3_type_1 import (
    QuickPersonResolveResponse200OutputDataItemPersonType0CurrentJobType0SeniorityType3Type1,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="QuickPersonResolveResponse200OutputDataItemPersonType0CurrentJobType0")


@_attrs_define
class QuickPersonResolveResponse200OutputDataItemPersonType0CurrentJobType0:
    """
    Attributes:
        ...
        seniority (None | QuickPersonResolveResponse200OutputDataItemPersonType0CurrentJobType0SeniorityType1 |
            QuickPersonResolveResponse200OutputDataItemPersonType0CurrentJobType0SeniorityType2Type1 |
            QuickPersonResolveResponse200OutputDataItemPersonType0CurrentJobType0SeniorityType3Type1 | Unset):
        job_function (list[QuickPersonResolveResponse200OutputDataItemPersonType0CurrentJobType0JobFunctionType0Item] |
            None | Unset):
        employment_type
            (list[QuickPersonResolveResponse200OutputDataItemPersonType0CurrentJobType0EmploymentTypeType0Item] | None |
            Unset):
        academic_qualification
            (list[QuickPersonResolveResponse200OutputDataItemPersonType0CurrentJobType0AcademicQualificationType0Item] |
            None | Unset):
    ...
    job_function: (
        list[QuickPersonResolveResponse200OutputDataItemPersonType0CurrentJobType0JobFunctionType0Item] | None | Unset
    ) = UNSET
    employment_type: (
        list[QuickPersonResolveResponse200OutputDataItemPersonType0CurrentJobType0EmploymentTypeType0Item]
        | None
        | Unset
    ) = UNSET
    academic_qualification: (
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.seniority, Unset):
            ...
            self.seniority, QuickPersonResolveResponse200OutputDataItemPersonType0CurrentJobType0SeniorityType1
        ):
            seniority = self.seniority.value
        elif isinstance(
            self.seniority, QuickPersonResolveResponse200OutputDataItemPersonType0CurrentJobType0SeniorityType2Type1
        ):
            seniority = self.seniority.value
        elif isinstance(
            self.seniority, QuickPersonResolveResponse200OutputDataItemPersonType0CurrentJobType0SeniorityType3Type1
        ):
            seniority = self.seniority.value
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_seniority(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                seniority_type_1 = QuickPersonResolveResponse200OutputDataItemPersonType0CurrentJobType0SeniorityType1(
                    data
                )
            ...
            try:
                ...
                seniority_type_2_type_1 = (
                    QuickPersonResolveResponse200OutputDataItemPersonType0CurrentJobType0SeniorityType2Type1(data)
                )
            ...
            try:
                ...
                seniority_type_3_type_1 = (
                    QuickPersonResolveResponse200OutputDataItemPersonType0CurrentJobType0SeniorityType3Type1(data)
                )
        ...
        def _parse_job_function(
            ...
            list[QuickPersonResolveResponse200OutputDataItemPersonType0CurrentJobType0JobFunctionType0Item]
            | None
            | Unset
        ):
            if data is None:
        ...
        def _parse_academic_qualification(
            ...
            try:
                ...
                for academic_qualification_type_0_item_data in _academic_qualification_type_0:
                    academic_qualification_type_0_item = QuickPersonResolveResponse200OutputDataItemPersonType0CurrentJobType0AcademicQualificationType0Item(
        ...
        quick_person_resolve_response_200_output_data_item_person_type_0_current_job_type_0 = cls(
        ...
        quick_person_resolve_response_200_output_data_item_person_type_0_current_job_type_0.additional_properties = d
        return quick_person_resolve_response_200_output_data_item_person_type_0_current_job_type_0
