...
from ..models.create_saved_search_body_search_params_type_0_profile_search_params_job_title_v3_type_0_any_of_type_0_item_type_1_seniority_item import CreateSavedSearchBodySearchParamsType0ProfileSearchParamsJobTitleV3Type0AnyOfType0ItemType1SeniorityItem
from ..models.create_saved_search_body_search_params_type_0_profile_search_params_job_title_v3_type_0_any_of_type_0_item_type_1_type import CreateSavedSearchBodySearchParamsType0ProfileSearchParamsJobTitleV3Type0AnyOfType0ItemType1Type
from ..types import UNSET, Unset
...
class CreateSavedSearchBodySearchParamsType0ProfileSearchParamsJobTitleV3Type0AnyOfType0ItemType1:
    ...
    type_: CreateSavedSearchBodySearchParamsType0ProfileSearchParamsJobTitleV3Type0AnyOfType0ItemType1Type
    seniority: list[CreateSavedSearchBodySearchParamsType0ProfileSearchParamsJobTitleV3Type0AnyOfType0ItemType1SeniorityItem]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        type_ = CreateSavedSearchBodySearchParamsType0ProfileSearchParamsJobTitleV3Type0AnyOfType0ItemType1Type(d.pop("type"))
        ...
        for seniority_item_data in (_seniority):
            seniority_item = CreateSavedSearchBodySearchParamsType0ProfileSearchParamsJobTitleV3Type0AnyOfType0ItemType1SeniorityItem(seniority_item_data)
