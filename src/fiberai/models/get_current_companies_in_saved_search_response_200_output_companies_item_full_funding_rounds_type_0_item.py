...
if TYPE_CHECKING:
  from ..models.get_current_companies_in_saved_search_response_200_output_companies_item_full_funding_rounds_type_0_item_investors_type_0_item import GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemFullFundingRoundsType0ItemInvestorsType0Item





T = TypeVar("T", bound="GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemFullFundingRoundsType0Item")



@_attrs_define
class GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemFullFundingRoundsType0Item:
    """ 
        Attributes:
            investors (Union[None, Unset, list['GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemFullFundingRou
                ndsType0ItemInvestorsType0Item']]):
    ...
    investors: Union[None, Unset, list['GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemFullFundingRoundsType0ItemInvestorsType0Item']] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.get_current_companies_in_saved_search_response_200_output_companies_item_full_funding_rounds_type_0_item_investors_type_0_item import GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemFullFundingRoundsType0ItemInvestorsType0Item
        d = dict(src_dict)
        def _parse_investors(data: object) -> Union[None, Unset, list['GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemFullFundingRoundsType0ItemInvestorsType0Item']]:
            if data is None:
                return data
            ...
            try:
                ...
                for investors_type_0_item_data in (_investors_type_0):
                    investors_type_0_item = GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemFullFundingRoundsType0ItemInvestorsType0Item.from_dict(investors_type_0_item_data)
                ...
                pass
            return cast(Union[None, Unset, list['GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemFullFundingRoundsType0ItemInvestorsType0Item']], data)
        ...
        get_current_companies_in_saved_search_response_200_output_companies_item_full_funding_rounds_type_0_item = cls(
            investors=investors,
        ...
        get_current_companies_in_saved_search_response_200_output_companies_item_full_funding_rounds_type_0_item.additional_properties = d
        return get_current_companies_in_saved_search_response_200_output_companies_item_full_funding_rounds_type_0_item
