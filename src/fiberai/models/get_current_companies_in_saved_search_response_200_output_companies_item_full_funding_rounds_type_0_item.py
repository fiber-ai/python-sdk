...
if TYPE_CHECKING:
    from ..models.get_current_companies_in_saved_search_response_200_output_companies_item_full_funding_rounds_type_0_item_investors_type_0_item import (
        GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemFullFundingRoundsType0ItemInvestorsType0Item,
    )
...
class GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemFullFundingRoundsType0Item:
    """
    Attributes:
        investors (list[GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemFullFundingRoundsType0ItemInvestor
            sType0Item] | None | Unset):
    ...
    investors: (
        list[GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemFullFundingRoundsType0ItemInvestorsType0Item]
        | None
        | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.get_current_companies_in_saved_search_response_200_output_companies_item_full_funding_rounds_type_0_item_investors_type_0_item import (
            GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemFullFundingRoundsType0ItemInvestorsType0Item,  # noqa: PLC0415
        )
        ...
        def _parse_investors(
            ...
            try:
                ...
                for investors_type_0_item_data in _investors_type_0:
                    investors_type_0_item = GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemFullFundingRoundsType0ItemInvestorsType0Item.from_dict(
