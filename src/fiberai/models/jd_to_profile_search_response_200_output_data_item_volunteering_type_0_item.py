...
T = TypeVar("T", bound="JdToProfileSearchResponse200OutputDataItemVolunteeringType0Item")


@_attrs_define
class JdToProfileSearchResponse200OutputDataItemVolunteeringType0Item:
    """
    Attributes:
        role (None | str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        jd_to_profile_search_response_200_output_data_item_volunteering_type_0_item = cls(
            role=role,
        ...
        jd_to_profile_search_response_200_output_data_item_volunteering_type_0_item.additional_properties = d
        return jd_to_profile_search_response_200_output_data_item_volunteering_type_0_item
