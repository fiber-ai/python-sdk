...
T = TypeVar("T", bound="QuickCompanyResolveResponse200OutputDataItemCompanyType0AcceleratorsType0ItemFoundersType0Item")


@_attrs_define
class QuickCompanyResolveResponse200OutputDataItemCompanyType0AcceleratorsType0ItemFoundersType0Item:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        quick_company_resolve_response_200_output_data_item_company_type_0_accelerators_type_0_item_founders_type_0_item = cls(
            full_name=full_name,
            bio=bio,
            job_title=job_title,
            is_active=is_active,
        ...
        quick_company_resolve_response_200_output_data_item_company_type_0_accelerators_type_0_item_founders_type_0_item.additional_properties = d
        return quick_company_resolve_response_200_output_data_item_company_type_0_accelerators_type_0_item_founders_type_0_item
