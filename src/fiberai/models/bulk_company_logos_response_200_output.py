...
class BulkCompanyLogosResponse200Output:
    """ 
        Attributes:
            data (Union['BulkCompanyLogosResponse200OutputDataType0', 'BulkCompanyLogosResponse200OutputDataType1',
                'BulkCompanyLogosResponse200OutputDataType2']): The list of logo URLs
     """

    data: Union['BulkCompanyLogosResponse200OutputDataType0', 'BulkCompanyLogosResponse200OutputDataType1', 'BulkCompanyLogosResponse200OutputDataType2']
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.bulk_company_logos_response_200_output_data_type_2 import BulkCompanyLogosResponse200OutputDataType2
        d = dict(src_dict)
        def _parse_data(data: object) -> Union['BulkCompanyLogosResponse200OutputDataType0', 'BulkCompanyLogosResponse200OutputDataType1', 'BulkCompanyLogosResponse200OutputDataType2']:
            try:
