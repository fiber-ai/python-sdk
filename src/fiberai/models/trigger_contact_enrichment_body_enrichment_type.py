...
T = TypeVar("T", bound="TriggerContactEnrichmentBodyEnrichmentType")



@_attrs_define
class TriggerContactEnrichmentBodyEnrichmentType:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        trigger_contact_enrichment_body_enrichment_type = cls(
        ...
        trigger_contact_enrichment_body_enrichment_type.additional_properties = d
        return trigger_contact_enrichment_body_enrichment_type
