...
T = TypeVar("T", bound="JobPostingSearchCountBodySearchParamsNumApplicantsType0")


@_attrs_define
class JobPostingSearchCountBodySearchParamsNumApplicantsType0:
    """Filter by number of applicants (range)
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        job_posting_search_count_body_search_params_num_applicants_type_0 = cls(
            lower_bound=lower_bound,
            upper_bound=upper_bound,
        )

        job_posting_search_count_body_search_params_num_applicants_type_0.additional_properties = d
        return job_posting_search_count_body_search_params_num_applicants_type_0
