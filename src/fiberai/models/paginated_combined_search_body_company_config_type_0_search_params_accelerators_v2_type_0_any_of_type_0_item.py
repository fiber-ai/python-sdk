...
from ..models.paginated_combined_search_body_company_config_type_0_search_params_accelerators_v2_type_0_any_of_type_0_item_accelerator_name import (
    PaginatedCombinedSearchBodyCompanyConfigType0SearchParamsAcceleratorsV2Type0AnyOfType0ItemAcceleratorName,
)
...
T = TypeVar("T", bound="PaginatedCombinedSearchBodyCompanyConfigType0SearchParamsAcceleratorsV2Type0AnyOfType0Item")


@_attrs_define
class PaginatedCombinedSearchBodyCompanyConfigType0SearchParamsAcceleratorsV2Type0AnyOfType0Item:
    """
    Attributes:
        accelerator_name
            (PaginatedCombinedSearchBodyCompanyConfigType0SearchParamsAcceleratorsV2Type0AnyOfType0ItemAcceleratorName):
        batch_selection (None |
            ...
            Unset):
        years (None |
            PaginatedCombinedSearchBodyCompanyConfigType0SearchParamsAcceleratorsV2Type0AnyOfType0ItemYearsType0 | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_batch_selection(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                batch_selection_type_0 = PaginatedCombinedSearchBodyCompanyConfigType0SearchParamsAcceleratorsV2Type0AnyOfType0ItemBatchSelectionType0.from_dict(
                    data
                )
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                batch_selection_type_1 = PaginatedCombinedSearchBodyCompanyConfigType0SearchParamsAcceleratorsV2Type0AnyOfType0ItemBatchSelectionType1.from_dict(
                    data
                )
        ...
        def _parse_years(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                years_type_0 = PaginatedCombinedSearchBodyCompanyConfigType0SearchParamsAcceleratorsV2Type0AnyOfType0ItemYearsType0.from_dict(
                    data
                )
        ...
        paginated_combined_search_body_company_config_type_0_search_params_accelerators_v2_type_0_any_of_type_0_item = (
            cls(
        ...
        paginated_combined_search_body_company_config_type_0_search_params_accelerators_v2_type_0_any_of_type_0_item.additional_properties = d
        return (
            paginated_combined_search_body_company_config_type_0_search_params_accelerators_v2_type_0_any_of_type_0_item
        )
