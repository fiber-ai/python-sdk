...
from ..models.text_to_combined_search_response_200_output_data_companies_item_funding_rounds_type_0_item_round_type_type_1 import (
    TextToCombinedSearchResponse200OutputDataCompaniesItemFundingRoundsType0ItemRoundTypeType1,
)
from ..models.text_to_combined_search_response_200_output_data_companies_item_funding_rounds_type_0_item_round_type_type_2_type_1 import (
    TextToCombinedSearchResponse200OutputDataCompaniesItemFundingRoundsType0ItemRoundTypeType2Type1,
)
from ..models.text_to_combined_search_response_200_output_data_companies_item_funding_rounds_type_0_item_round_type_type_3_type_1 import (
...
class TextToCombinedSearchResponse200OutputDataCompaniesItemFundingRoundsType0Item:
    """
    Attributes:
        round_type (None | TextToCombinedSearchResponse200OutputDataCompaniesItemFundingRoundsType0ItemRoundTypeType1 |
            TextToCombinedSearchResponse200OutputDataCompaniesItemFundingRoundsType0ItemRoundTypeType2Type1 |
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.round_type, Unset):
            ...
            self.round_type, TextToCombinedSearchResponse200OutputDataCompaniesItemFundingRoundsType0ItemRoundTypeType1
        ):
        ...
        def _parse_round_type(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                round_type_type_1 = (
                    TextToCombinedSearchResponse200OutputDataCompaniesItemFundingRoundsType0ItemRoundTypeType1(data)
                )
