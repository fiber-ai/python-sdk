...
@_attrs_define
class CombinedSearchCountBodyCompanyParamsFortuneRankingsType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_any_of(
            data: object,
        ) -> list[CombinedSearchCountBodyCompanyParamsFortuneRankingsType0AnyOfType0Item] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for any_of_type_0_item_data in _any_of_type_0:
                    any_of_type_0_item = (
                        CombinedSearchCountBodyCompanyParamsFortuneRankingsType0AnyOfType0Item.from_dict(
                ...
                pass
            return cast(
                list[CombinedSearchCountBodyCompanyParamsFortuneRankingsType0AnyOfType0Item] | None | Unset, data
            )
        ...
        return combined_search_count_body_company_params_fortune_rankings_type_0
