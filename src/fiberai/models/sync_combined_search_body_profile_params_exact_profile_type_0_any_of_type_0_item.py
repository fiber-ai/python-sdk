...
T = TypeVar("T", bound="SyncCombinedSearchBodyProfileParamsExactProfileType0AnyOfType0Item")



@_attrs_define
class SyncCombinedSearchBodyProfileParamsExactProfileType0AnyOfType0Item:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sync_combined_search_body_profile_params_exact_profile_type_0_any_of_type_0_item = cls(
            profile_id=profile_id,
            primary_slug=primary_slug,
        )


        sync_combined_search_body_profile_params_exact_profile_type_0_any_of_type_0_item.additional_properties = d
        return sync_combined_search_body_profile_params_exact_profile_type_0_any_of_type_0_item
