...
T = TypeVar("T", bound="TextToCombinedSearchResponse200OutputDataCompaniesItemPlatformsType0")


@_attrs_define
class TextToCombinedSearchResponse200OutputDataCompaniesItemPlatformsType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        text_to_combined_search_response_200_output_data_companies_item_platforms_type_0 = cls(
            ecommerce=ecommerce,
            cms=cms,
            crm=crm,
            marketing=marketing,
        ...
        text_to_combined_search_response_200_output_data_companies_item_platforms_type_0.additional_properties = d
        return text_to_combined_search_response_200_output_data_companies_item_platforms_type_0
