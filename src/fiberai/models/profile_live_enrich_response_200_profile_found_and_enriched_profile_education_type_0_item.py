...
T = TypeVar("T", bound="ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileEducationType0Item")


@_attrs_define
class ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileEducationType0Item:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        profile_live_enrich_response_200_profile_found_and_enriched_profile_education_type_0_item = cls(
            school_id=school_id,
        ...
        profile_live_enrich_response_200_profile_found_and_enriched_profile_education_type_0_item.additional_properties = d
        return profile_live_enrich_response_200_profile_found_and_enriched_profile_education_type_0_item
