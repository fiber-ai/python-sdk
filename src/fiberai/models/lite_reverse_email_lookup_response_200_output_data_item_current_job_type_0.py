...
from ..models.lite_reverse_email_lookup_response_200_output_data_item_current_job_type_0_academic_qualification_type_0_item import (
    LiteReverseEmailLookupResponse200OutputDataItemCurrentJobType0AcademicQualificationType0Item,
)
from ..models.lite_reverse_email_lookup_response_200_output_data_item_current_job_type_0_employment_type_type_0_item import (
    LiteReverseEmailLookupResponse200OutputDataItemCurrentJobType0EmploymentTypeType0Item,
)
from ..models.lite_reverse_email_lookup_response_200_output_data_item_current_job_type_0_job_function_type_0_item import (
    LiteReverseEmailLookupResponse200OutputDataItemCurrentJobType0JobFunctionType0Item,
)
from ..models.lite_reverse_email_lookup_response_200_output_data_item_current_job_type_0_seniority_type_1 import (
    LiteReverseEmailLookupResponse200OutputDataItemCurrentJobType0SeniorityType1,
)
from ..models.lite_reverse_email_lookup_response_200_output_data_item_current_job_type_0_seniority_type_2_type_1 import (
    LiteReverseEmailLookupResponse200OutputDataItemCurrentJobType0SeniorityType2Type1,
)
from ..models.lite_reverse_email_lookup_response_200_output_data_item_current_job_type_0_seniority_type_3_type_1 import (
    LiteReverseEmailLookupResponse200OutputDataItemCurrentJobType0SeniorityType3Type1,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="LiteReverseEmailLookupResponse200OutputDataItemCurrentJobType0")


@_attrs_define
class LiteReverseEmailLookupResponse200OutputDataItemCurrentJobType0:
    """
    Attributes:
        ...
        seniority (LiteReverseEmailLookupResponse200OutputDataItemCurrentJobType0SeniorityType1 |
            LiteReverseEmailLookupResponse200OutputDataItemCurrentJobType0SeniorityType2Type1 |
            LiteReverseEmailLookupResponse200OutputDataItemCurrentJobType0SeniorityType3Type1 | None | Unset):
        job_function (list[LiteReverseEmailLookupResponse200OutputDataItemCurrentJobType0JobFunctionType0Item] | None |
            Unset):
        employment_type (list[LiteReverseEmailLookupResponse200OutputDataItemCurrentJobType0EmploymentTypeType0Item] |
            None | Unset):
        academic_qualification
            (list[LiteReverseEmailLookupResponse200OutputDataItemCurrentJobType0AcademicQualificationType0Item] | None |
            Unset):
    ...
    job_function: (
        list[LiteReverseEmailLookupResponse200OutputDataItemCurrentJobType0JobFunctionType0Item] | None | Unset
    ) = UNSET
    employment_type: (
        list[LiteReverseEmailLookupResponse200OutputDataItemCurrentJobType0EmploymentTypeType0Item] | None | Unset
    ) = UNSET
    academic_qualification: (
        list[LiteReverseEmailLookupResponse200OutputDataItemCurrentJobType0AcademicQualificationType0Item]
        | None
        | Unset
    ) = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.seniority, Unset):
            seniority = UNSET
        elif isinstance(self.seniority, LiteReverseEmailLookupResponse200OutputDataItemCurrentJobType0SeniorityType1):
            seniority = self.seniority.value
        elif isinstance(
            self.seniority, LiteReverseEmailLookupResponse200OutputDataItemCurrentJobType0SeniorityType2Type1
        ):
            seniority = self.seniority.value
        elif isinstance(
            self.seniority, LiteReverseEmailLookupResponse200OutputDataItemCurrentJobType0SeniorityType3Type1
        ):
            seniority = self.seniority.value
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_seniority(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                seniority_type_1 = LiteReverseEmailLookupResponse200OutputDataItemCurrentJobType0SeniorityType1(data)
            ...
            try:
                ...
                seniority_type_2_type_1 = (
                    LiteReverseEmailLookupResponse200OutputDataItemCurrentJobType0SeniorityType2Type1(data)
                )
            ...
            try:
                ...
                seniority_type_3_type_1 = (
                    LiteReverseEmailLookupResponse200OutputDataItemCurrentJobType0SeniorityType3Type1(data)
                )
        ...
        def _parse_employment_type(
            ...
            try:
                ...
                pass
            return cast(
                list[LiteReverseEmailLookupResponse200OutputDataItemCurrentJobType0EmploymentTypeType0Item]
                | None
                | Unset,
                data,
            )
        ...
        lite_reverse_email_lookup_response_200_output_data_item_current_job_type_0 = cls(
        ...
        lite_reverse_email_lookup_response_200_output_data_item_current_job_type_0.additional_properties = d
        return lite_reverse_email_lookup_response_200_output_data_item_current_job_type_0
