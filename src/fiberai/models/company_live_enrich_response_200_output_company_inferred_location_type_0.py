...
class CompanyLiveEnrichResponse200OutputCompanyInferredLocationType0:
    ...
    Attributes:
        ...
        coordinates (CompanyLiveEnrichResponse200OutputCompanyInferredLocationType0CoordinatesType0 | None | Unset):
    ...
    coordinates: CompanyLiveEnrichResponse200OutputCompanyInferredLocationType0CoordinatesType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.coordinates, Unset):
            ...
            self.coordinates, CompanyLiveEnrichResponse200OutputCompanyInferredLocationType0CoordinatesType0
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_coordinates(
            data: object,
        ) -> CompanyLiveEnrichResponse200OutputCompanyInferredLocationType0CoordinatesType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = (
                    CompanyLiveEnrichResponse200OutputCompanyInferredLocationType0CoordinatesType0.from_dict(data)
                )
                ...
                pass
            return cast(
                CompanyLiveEnrichResponse200OutputCompanyInferredLocationType0CoordinatesType0 | None | Unset, data
            )
