...
if TYPE_CHECKING:
    from ..models.company_search_body_search_params_employees_type_0_rules_item_employee_filters_type_0_recently_hired_type_0_item import (
        CompanySearchBodySearchParamsEmployeesType0RulesItemEmployeeFiltersType0RecentlyHiredType0Item,
    )
...
class CompanySearchBodySearchParamsEmployeesType0RulesItemEmployeeFiltersType0:
    ...
    Attributes:
        ...
        recently_hired
            (list[CompanySearchBodySearchParamsEmployeesType0RulesItemEmployeeFiltersType0RecentlyHiredType0Item] | None |
            Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.company_search_body_search_params_employees_type_0_rules_item_employee_filters_type_0_recently_hired_type_0_item import (
            CompanySearchBodySearchParamsEmployeesType0RulesItemEmployeeFiltersType0RecentlyHiredType0Item,  # noqa: PLC0415
        )
        ...
        def _parse_recently_hired(
            ...
            try:
                ...
                for recently_hired_type_0_item_data in _recently_hired_type_0:
                    recently_hired_type_0_item = CompanySearchBodySearchParamsEmployeesType0RulesItemEmployeeFiltersType0RecentlyHiredType0Item.from_dict(
