...
T = TypeVar("T", bound="GetTalentFlowRivalsResponse200OutputCompany")


@_attrs_define
class GetTalentFlowRivalsResponse200OutputCompany:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_talent_flow_rivals_response_200_output_company = cls(
            name=name,
        ...
        get_talent_flow_rivals_response_200_output_company.additional_properties = d
        return get_talent_flow_rivals_response_200_output_company
