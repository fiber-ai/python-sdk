...
if TYPE_CHECKING:
    from ..models.sync_combined_search_response_200_output_companies_item_li_locations_type_0_item_location_type_0_coordinates_type_0 import (
        SyncCombinedSearchResponse200OutputCompaniesItemLiLocationsType0ItemLocationType0CoordinatesType0,
    )
...
class SyncCombinedSearchResponse200OutputCompaniesItemLiLocationsType0ItemLocationType0:
    ...
    Attributes:
        ...
        coordinates (None |
            SyncCombinedSearchResponse200OutputCompaniesItemLiLocationsType0ItemLocationType0CoordinatesType0 | Unset):
    ...
    coordinates: (
        None | SyncCombinedSearchResponse200OutputCompaniesItemLiLocationsType0ItemLocationType0CoordinatesType0 | Unset
    ) = UNSET
        ...
        def _parse_coordinates(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = SyncCombinedSearchResponse200OutputCompaniesItemLiLocationsType0ItemLocationType0CoordinatesType0.from_dict(
                    data
                )
