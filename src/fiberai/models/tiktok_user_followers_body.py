...
T = TypeVar("T", bound="TiktokUserFollowersBody")


@_attrs_define
class TiktokUserFollowersBody:
    """
    Attributes:
        api_key (str): Your Fiber API key
        handle (str): TikTok handle (with or without leading '@').
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        tiktok_user_followers_body = cls(
            api_key=api_key,
            handle=handle,
            next_page_token=next_page_token,
        )

        tiktok_user_followers_body.additional_properties = d
        return tiktok_user_followers_body
