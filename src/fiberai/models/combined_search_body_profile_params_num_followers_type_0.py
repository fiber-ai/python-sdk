...
T = TypeVar("T", bound="CombinedSearchBodyProfileParamsNumFollowersType0")



@_attrs_define
class CombinedSearchBodyProfileParamsNumFollowersType0:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        combined_search_body_profile_params_num_followers_type_0 = cls(
            lower_bound=lower_bound,
            upper_bound=upper_bound,
        )


        combined_search_body_profile_params_num_followers_type_0.additional_properties = d
        return combined_search_body_profile_params_num_followers_type_0
