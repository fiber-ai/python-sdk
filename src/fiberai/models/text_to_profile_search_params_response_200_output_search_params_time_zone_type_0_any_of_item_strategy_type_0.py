...
from ..models.text_to_profile_search_params_response_200_output_search_params_time_zone_type_0_any_of_item_strategy_type_0_mode import (
    TextToProfileSearchParamsResponse200OutputSearchParamsTimeZoneType0AnyOfItemStrategyType0Mode,
)
...
class TextToProfileSearchParamsResponse200OutputSearchParamsTimeZoneType0AnyOfItemStrategyType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        text_to_profile_search_params_response_200_output_search_params_time_zone_type_0_any_of_item_strategy_type_0 = (
            cls(
                mode=mode,
