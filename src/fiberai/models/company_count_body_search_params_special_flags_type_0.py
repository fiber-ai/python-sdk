...
T = TypeVar("T", bound="CompanyCountBodySearchParamsSpecialFlagsType0")



@_attrs_define
class CompanyCountBodySearchParamsSpecialFlagsType0:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        company_count_body_search_params_special_flags_type_0 = cls(
            exclude_yc_companies=exclude_yc_companies,
        )


        company_count_body_search_params_special_flags_type_0.additional_properties = d
        return company_count_body_search_params_special_flags_type_0
