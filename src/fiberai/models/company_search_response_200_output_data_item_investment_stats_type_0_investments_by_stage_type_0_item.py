...
T = TypeVar("T", bound="CompanySearchResponse200OutputDataItemInvestmentStatsType0InvestmentsByStageType0Item")


@_attrs_define
class CompanySearchResponse200OutputDataItemInvestmentStatsType0InvestmentsByStageType0Item:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        company_search_response_200_output_data_item_investment_stats_type_0_investments_by_stage_type_0_item = cls(
            stage=stage,
            lead_rate=lead_rate,
        ...
        company_search_response_200_output_data_item_investment_stats_type_0_investments_by_stage_type_0_item.additional_properties = d
        return company_search_response_200_output_data_item_investment_stats_type_0_investments_by_stage_type_0_item
