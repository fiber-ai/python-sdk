...
class TextToProfileSearchResponse200OutputSearchParams:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.job_status, TextToProfileSearchResponse200OutputSearchParamsJobStatusType1):
            job_status = self.job_status.to_dict()
        elif isinstance(self.job_status, TextToProfileSearchResponse200OutputSearchParamsJobStatusType2):
            job_status = self.job_status.to_dict()
        else:
        ...
        elif isinstance(self.started_in_role, TextToProfileSearchResponse200OutputSearchParamsStartedInRoleType1):
            started_in_role = self.started_in_role.to_dict()
        else:
        ...
        elif isinstance(self.started_at_company, TextToProfileSearchResponse200OutputSearchParamsStartedAtCompanyType1):
            started_at_company = self.started_at_company.to_dict()
        else:
        ...
        elif isinstance(self.stealth_v2, TextToProfileSearchResponse200OutputSearchParamsStealthV2Type1):
            stealth_v2 = self.stealth_v2.to_dict()
        else:
