...
T = TypeVar("T", bound="SyncCombinedSearchResponse200OutputProfilesItemVolunteeringType0Item")


@_attrs_define
class SyncCombinedSearchResponse200OutputProfilesItemVolunteeringType0Item:
    """
    Attributes:
        role (None | str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sync_combined_search_response_200_output_profiles_item_volunteering_type_0_item = cls(
            role=role,
        ...
        sync_combined_search_response_200_output_profiles_item_volunteering_type_0_item.additional_properties = d
        return sync_combined_search_response_200_output_profiles_item_volunteering_type_0_item
