...
from ..models.reverse_phone_lookup_response_200_output_results_item_type_0_profile_detailed_work_experiences_type_0_item_academic_qualification_type_0_item import (
    ReversePhoneLookupResponse200OutputResultsItemType0ProfileDetailedWorkExperiencesType0ItemAcademicQualificationType0Item,
)
from ..models.reverse_phone_lookup_response_200_output_results_item_type_0_profile_detailed_work_experiences_type_0_item_employment_type_type_0_item import (
    ReversePhoneLookupResponse200OutputResultsItemType0ProfileDetailedWorkExperiencesType0ItemEmploymentTypeType0Item,
)
from ..models.reverse_phone_lookup_response_200_output_results_item_type_0_profile_detailed_work_experiences_type_0_item_job_function_type_0_item import (
    ReversePhoneLookupResponse200OutputResultsItemType0ProfileDetailedWorkExperiencesType0ItemJobFunctionType0Item,
)
from ..models.reverse_phone_lookup_response_200_output_results_item_type_0_profile_detailed_work_experiences_type_0_item_seniority_type_1 import (
    ReversePhoneLookupResponse200OutputResultsItemType0ProfileDetailedWorkExperiencesType0ItemSeniorityType1,
)
from ..models.reverse_phone_lookup_response_200_output_results_item_type_0_profile_detailed_work_experiences_type_0_item_seniority_type_2_type_1 import (
    ReversePhoneLookupResponse200OutputResultsItemType0ProfileDetailedWorkExperiencesType0ItemSeniorityType2Type1,
)
from ..models.reverse_phone_lookup_response_200_output_results_item_type_0_profile_detailed_work_experiences_type_0_item_seniority_type_3_type_1 import (
    ReversePhoneLookupResponse200OutputResultsItemType0ProfileDetailedWorkExperiencesType0ItemSeniorityType3Type1,
)
...
T = TypeVar("T", bound="ReversePhoneLookupResponse200OutputResultsItemType0ProfileDetailedWorkExperiencesType0Item")


@_attrs_define
class ReversePhoneLookupResponse200OutputResultsItemType0ProfileDetailedWorkExperiencesType0Item:
    """
    Attributes:
        ...
        seniority (None |
            ...
            ReversePhoneLookupResponse200OutputResultsItemType0ProfileDetailedWorkExperiencesType0ItemSeniorityType3Type1 |
            Unset):
        job_function (list[ReversePhoneLookupResponse200OutputResultsItemType0ProfileDetailedWorkExperiencesType0ItemJob
            FunctionType0Item] | None | Unset):
        employment_type (list[ReversePhoneLookupResponse200OutputResultsItemType0ProfileDetailedWorkExperiencesType0Item
            EmploymentTypeType0Item] | None | Unset):
        academic_qualification (list[ReversePhoneLookupResponse200OutputResultsItemType0ProfileDetailedWorkExperiencesTy
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_company_details(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                company_details_type_0 = ReversePhoneLookupResponse200OutputResultsItemType0ProfileDetailedWorkExperiencesType0ItemCompanyDetailsType0.from_dict(
                    data
                )
        ...
        def _parse_seniority(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                seniority_type_1 = ReversePhoneLookupResponse200OutputResultsItemType0ProfileDetailedWorkExperiencesType0ItemSeniorityType1(
                    data
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                seniority_type_2_type_1 = ReversePhoneLookupResponse200OutputResultsItemType0ProfileDetailedWorkExperiencesType0ItemSeniorityType2Type1(
                    data
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                seniority_type_3_type_1 = ReversePhoneLookupResponse200OutputResultsItemType0ProfileDetailedWorkExperiencesType0ItemSeniorityType3Type1(
                    data
                )
        ...
        def _parse_job_function(
            ...
            try:
                ...
                for job_function_type_0_item_data in _job_function_type_0:
                    job_function_type_0_item = ReversePhoneLookupResponse200OutputResultsItemType0ProfileDetailedWorkExperiencesType0ItemJobFunctionType0Item(
        ...
        def _parse_employment_type(
            ...
            try:
                ...
                for employment_type_type_0_item_data in _employment_type_type_0:
                    employment_type_type_0_item = ReversePhoneLookupResponse200OutputResultsItemType0ProfileDetailedWorkExperiencesType0ItemEmploymentTypeType0Item(
        ...
        def _parse_academic_qualification(
            ...
            try:
                ...
                for academic_qualification_type_0_item_data in _academic_qualification_type_0:
                    academic_qualification_type_0_item = ReversePhoneLookupResponse200OutputResultsItemType0ProfileDetailedWorkExperiencesType0ItemAcademicQualificationType0Item(
        ...
        reverse_phone_lookup_response_200_output_results_item_type_0_profile_detailed_work_experiences_type_0_item = (
            cls(
        ...
        reverse_phone_lookup_response_200_output_results_item_type_0_profile_detailed_work_experiences_type_0_item.additional_properties = d
        return (
            reverse_phone_lookup_response_200_output_results_item_type_0_profile_detailed_work_experiences_type_0_item
        )
