...
T = TypeVar(
    "T", bound="QuickCompanyResolveResponse200OutputDataItemCompanyType0EmployeeTrendsType0ItemChangesType0Item"
)


@_attrs_define
class QuickCompanyResolveResponse200OutputDataItemCompanyType0EmployeeTrendsType0ItemChangesType0Item:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        quick_company_resolve_response_200_output_data_item_company_type_0_employee_trends_type_0_item_changes_type_0_item = cls(
            count_end=count_end,
        ...
        quick_company_resolve_response_200_output_data_item_company_type_0_employee_trends_type_0_item_changes_type_0_item.additional_properties = d
        return quick_company_resolve_response_200_output_data_item_company_type_0_employee_trends_type_0_item_changes_type_0_item
