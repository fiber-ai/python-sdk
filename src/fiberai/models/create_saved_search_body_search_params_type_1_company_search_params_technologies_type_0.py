...
class CreateSavedSearchBodySearchParamsType1CompanySearchParamsTechnologiesType0:
    """
    Attributes:
        any_of (list[CreateSavedSearchBodySearchParamsType1CompanySearchParamsTechnologiesType0AnyOfType0ItemType0 |
            CreateSavedSearchBodySearchParamsType1CompanySearchParamsTechnologiesType0AnyOfType0ItemType1] | None | Unset):
        all_of (list[CreateSavedSearchBodySearchParamsType1CompanySearchParamsTechnologiesType0AllOfType0ItemType0 |
            CreateSavedSearchBodySearchParamsType1CompanySearchParamsTechnologiesType0AllOfType0ItemType1] | None | Unset):
        none_of (list[CreateSavedSearchBodySearchParamsType1CompanySearchParamsTechnologiesType0NoneOfType0ItemType0 |
            CreateSavedSearchBodySearchParamsType1CompanySearchParamsTechnologiesType0NoneOfType0ItemType1] | None | Unset):
    """
                    ...
                    def _parse_any_of_type_0_item(
                        ...
                        try:
                            if not isinstance(data, dict):
                                raise TypeError()
                            any_of_type_0_item_type_0 = CreateSavedSearchBodySearchParamsType1CompanySearchParamsTechnologiesType0AnyOfType0ItemType0.from_dict(
                                data
                            )
                        ...
                        if not isinstance(data, dict):
                            raise TypeError()
                        any_of_type_0_item_type_1 = CreateSavedSearchBodySearchParamsType1CompanySearchParamsTechnologiesType0AnyOfType0ItemType1.from_dict(
                            data
                        )
                ...
                for all_of_type_0_item_data in _all_of_type_0:
                    ...
                    def _parse_all_of_type_0_item(
                        ...
                        try:
                            if not isinstance(data, dict):
                                raise TypeError()
                            all_of_type_0_item_type_0 = CreateSavedSearchBodySearchParamsType1CompanySearchParamsTechnologiesType0AllOfType0ItemType0.from_dict(
                                data
                            )
                        ...
                        if not isinstance(data, dict):
                            raise TypeError()
                        all_of_type_0_item_type_1 = CreateSavedSearchBodySearchParamsType1CompanySearchParamsTechnologiesType0AllOfType0ItemType1.from_dict(
                            data
                        )
                ...
                for none_of_type_0_item_data in _none_of_type_0:
                    ...
                    def _parse_none_of_type_0_item(
                        ...
                        try:
                            if not isinstance(data, dict):
                                raise TypeError()
                            none_of_type_0_item_type_0 = CreateSavedSearchBodySearchParamsType1CompanySearchParamsTechnologiesType0NoneOfType0ItemType0.from_dict(
                                data
                            )
                        ...
                        if not isinstance(data, dict):
                            raise TypeError()
                        none_of_type_0_item_type_1 = CreateSavedSearchBodySearchParamsType1CompanySearchParamsTechnologiesType0NoneOfType0ItemType1.from_dict(
                            data
                        )
