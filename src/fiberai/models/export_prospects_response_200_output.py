...
T = TypeVar("T", bound="ExportProspectsResponse200Output")
...
class ExportProspectsResponse200Output:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        export_prospects_response_200_output = cls(
            message=message,
            estimated_rows=estimated_rows,
            max_rows_allowed=max_rows_allowed,
        )

        export_prospects_response_200_output.additional_properties = d
        return export_prospects_response_200_output
