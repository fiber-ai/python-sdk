...
from ..models.sync_combined_search_body_company_params_office_locations_v2_type_0_all_of_type_0_item_type_2_type import SyncCombinedSearchBodyCompanyParamsOfficeLocationsV2Type0AllOfType0ItemType2Type
from typing import cast
from typing import cast, Union

if TYPE_CHECKING:
  from ..models.sync_combined_search_body_company_params_office_locations_v2_type_0_all_of_type_0_item_type_2_location_type_0 import SyncCombinedSearchBodyCompanyParamsOfficeLocationsV2Type0AllOfType0ItemType2LocationType0
...
class SyncCombinedSearchBodyCompanyParamsOfficeLocationsV2Type0AllOfType0ItemType2:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.location, SyncCombinedSearchBodyCompanyParamsOfficeLocationsV2Type0AllOfType0ItemType2LocationType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_location(data: object) -> 'SyncCombinedSearchBodyCompanyParamsOfficeLocationsV2Type0AllOfType0ItemType2LocationType0':
            if not isinstance(data, dict):
                raise TypeError()
            location_type_0 = SyncCombinedSearchBodyCompanyParamsOfficeLocationsV2Type0AllOfType0ItemType2LocationType0.from_dict(data)
