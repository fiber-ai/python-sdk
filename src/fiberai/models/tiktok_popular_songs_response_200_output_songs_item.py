...
T = TypeVar("T", bound="TiktokPopularSongsResponse200OutputSongsItem")


@_attrs_define
class TiktokPopularSongsResponse200OutputSongsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        tiktok_popular_songs_response_200_output_songs_item = cls(
            id=id,
            title=title,
            artist=artist,
        ...
        tiktok_popular_songs_response_200_output_songs_item.additional_properties = d
        return tiktok_popular_songs_response_200_output_songs_item
