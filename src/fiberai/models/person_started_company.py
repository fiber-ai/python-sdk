...
T = TypeVar("T", bound="PersonStartedCompany")


@_attrs_define
class PersonStartedCompany:
    """
    Attributes:
        type_ (Literal['person_started_company']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        type_ = cast(Literal["person_started_company"], d.pop("type"))
        if type_ != "person_started_company":
            raise ValueError(f"type must match const 'person_started_company', got '{type_}'")
        ...
        person_started_company.additional_properties = d
        return person_started_company
