...
from ..models.sync_combined_search_body_company_params_technologies_type_0_none_of_type_0_item_type_0_technology import SyncCombinedSearchBodyCompanyParamsTechnologiesType0NoneOfType0ItemType0Technology
from ..models.sync_combined_search_body_company_params_technologies_type_0_none_of_type_0_item_type_0_type import SyncCombinedSearchBodyCompanyParamsTechnologiesType0NoneOfType0ItemType0Type
...
class SyncCombinedSearchBodyCompanyParamsTechnologiesType0NoneOfType0ItemType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        technology = SyncCombinedSearchBodyCompanyParamsTechnologiesType0NoneOfType0ItemType0Technology(d.pop("technology"))
