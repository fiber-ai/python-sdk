...
T = TypeVar("T", bound="PersonGotDemoted")


@_attrs_define
class PersonGotDemoted:
    """
    Attributes:
        type_ (Literal['person_got_demoted']):
        ...
        seniority_keywords (list[str] | None | Unset): Only alert if the previous title contained these seniority
            keywords (e.g. 'VP', 'Director'). Omit for any demotion.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        type_ = cast(Literal["person_got_demoted"], d.pop("type"))
        if type_ != "person_got_demoted":
            raise ValueError(f"type must match const 'person_got_demoted', got '{type_}'")
        ...
        person_got_demoted.additional_properties = d
        return person_got_demoted
