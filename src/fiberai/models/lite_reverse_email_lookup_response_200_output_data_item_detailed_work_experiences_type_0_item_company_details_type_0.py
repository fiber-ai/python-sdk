...
T = TypeVar(
    "T", bound="LiteReverseEmailLookupResponse200OutputDataItemDetailedWorkExperiencesType0ItemCompanyDetailsType0"
)


@_attrs_define
class LiteReverseEmailLookupResponse200OutputDataItemDetailedWorkExperiencesType0ItemCompanyDetailsType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        return lite_reverse_email_lookup_response_200_output_data_item_detailed_work_experiences_type_0_item_company_details_type_0
