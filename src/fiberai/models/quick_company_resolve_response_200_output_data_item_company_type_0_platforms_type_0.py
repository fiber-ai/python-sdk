...
T = TypeVar("T", bound="QuickCompanyResolveResponse200OutputDataItemCompanyType0PlatformsType0")


@_attrs_define
class QuickCompanyResolveResponse200OutputDataItemCompanyType0PlatformsType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        quick_company_resolve_response_200_output_data_item_company_type_0_platforms_type_0 = cls(
            ecommerce=ecommerce,
            cms=cms,
            crm=crm,
            marketing=marketing,
        ...
        quick_company_resolve_response_200_output_data_item_company_type_0_platforms_type_0.additional_properties = d
        return quick_company_resolve_response_200_output_data_item_company_type_0_platforms_type_0
