...
T = TypeVar("T", bound="GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanySimilarCompaniesType0Item")


@_attrs_define
class GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanySimilarCompaniesType0Item:
    """
    Attributes:
        name (None | str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_saved_search_run_companies_response_200_output_companies_item_company_similar_companies_type_0_item = cls(
            name=name,
        ...
        get_saved_search_run_companies_response_200_output_companies_item_company_similar_companies_type_0_item.additional_properties = d
        return get_saved_search_run_companies_response_200_output_companies_item_company_similar_companies_type_0_item
