...
T = TypeVar("T", bound="GetTalentFlowRivalsResponse200OutputWindow")


@_attrs_define
class GetTalentFlowRivalsResponse200OutputWindow:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_talent_flow_rivals_response_200_output_window = cls(
            after=after,
            before=before,
        )

        get_talent_flow_rivals_response_200_output_window.additional_properties = d
        return get_talent_flow_rivals_response_200_output_window
