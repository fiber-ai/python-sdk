...
from ..models.combined_search_count_body_profile_params_time_zone_type_0_any_of_item_strategy_type_0_mode import (
    CombinedSearchCountBodyProfileParamsTimeZoneType0AnyOfItemStrategyType0Mode,
)

T = TypeVar("T", bound="CombinedSearchCountBodyProfileParamsTimeZoneType0AnyOfItemStrategyType0")


@_attrs_define
class CombinedSearchCountBodyProfileParamsTimeZoneType0AnyOfItemStrategyType0:
    """
    Attributes:
        mode (CombinedSearchCountBodyProfileParamsTimeZoneType0AnyOfItemStrategyType0Mode):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        mode = CombinedSearchCountBodyProfileParamsTimeZoneType0AnyOfItemStrategyType0Mode(d.pop("mode"))
        ...
        combined_search_count_body_profile_params_time_zone_type_0_any_of_item_strategy_type_0 = cls(
            mode=mode,
        ...
        combined_search_count_body_profile_params_time_zone_type_0_any_of_item_strategy_type_0.additional_properties = d
        return combined_search_count_body_profile_params_time_zone_type_0_any_of_item_strategy_type_0
