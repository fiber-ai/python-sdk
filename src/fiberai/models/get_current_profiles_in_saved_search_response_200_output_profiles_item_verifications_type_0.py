...
T = TypeVar("T", bound="GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemVerificationsType0")


@_attrs_define
class GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemVerificationsType0:
    """
    Attributes:
        is_verified (bool | None | Unset):
        joined_date (None | str | Unset):
        verification_types
            (list[GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemVerificationsType0VerificationTypesType0Item]
            | None | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_verification_types(
            ...
            try:
                ...
                for verification_types_type_0_item_data in _verification_types_type_0:
                    verification_types_type_0_item = GetCurrentProfilesInSavedSearchResponse200OutputProfilesItemVerificationsType0VerificationTypesType0Item.from_dict(
        ...
        get_current_profiles_in_saved_search_response_200_output_profiles_item_verifications_type_0 = cls(
            is_verified=is_verified,
            joined_date=joined_date,
            verification_types=verification_types,
        )

        get_current_profiles_in_saved_search_response_200_output_profiles_item_verifications_type_0.additional_properties = d
        return get_current_profiles_in_saved_search_response_200_output_profiles_item_verifications_type_0
