...
class ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileDetailedEducationType0Item:
    ...
    Attributes:
        school_details (None |
            ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileDetailedEducationType0ItemSchoolDetailsType0 | Unset):
        ...
        def _parse_school_details(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                school_details_type_0 = ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileDetailedEducationType0ItemSchoolDetailsType0.from_dict(
                    data
                )
