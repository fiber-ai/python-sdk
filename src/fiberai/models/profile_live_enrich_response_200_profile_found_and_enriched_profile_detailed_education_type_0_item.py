...
if TYPE_CHECKING:
  from ..models.profile_live_enrich_response_200_profile_found_and_enriched_profile_detailed_education_type_0_item_school_details_type_0 import ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileDetailedEducationType0ItemSchoolDetailsType0





T = TypeVar("T", bound="ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileDetailedEducationType0Item")



@_attrs_define
class ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileDetailedEducationType0Item:
    """ 
        Attributes:
            school_details
                (Union['ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileDetailedEducationType0ItemSchoolDetailsType0',
                None, Unset]):
    ...
    school_details: Union['ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileDetailedEducationType0ItemSchoolDetailsType0', None, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.school_details, ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileDetailedEducationType0ItemSchoolDetailsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.profile_live_enrich_response_200_profile_found_and_enriched_profile_detailed_education_type_0_item_school_details_type_0 import ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileDetailedEducationType0ItemSchoolDetailsType0
        d = dict(src_dict)
        def _parse_school_details(data: object) -> Union['ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileDetailedEducationType0ItemSchoolDetailsType0', None, Unset]:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                school_details_type_0 = ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileDetailedEducationType0ItemSchoolDetailsType0.from_dict(data)
                ...
                pass
            return cast(Union['ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileDetailedEducationType0ItemSchoolDetailsType0', None, Unset], data)
        ...
        profile_live_enrich_response_200_profile_found_and_enriched_profile_detailed_education_type_0_item = cls(
        ...
        profile_live_enrich_response_200_profile_found_and_enriched_profile_detailed_education_type_0_item.additional_properties = d
        return profile_live_enrich_response_200_profile_found_and_enriched_profile_detailed_education_type_0_item
