...
if TYPE_CHECKING:
    from ..models.paginated_combined_search_response_200_output_companies_item_funding_round_stats_type_0_individual_investor_stats_type_0_item import (
        PaginatedCombinedSearchResponse200OutputCompaniesItemFundingRoundStatsType0IndividualInvestorStatsType0Item,
    )


T = TypeVar("T", bound="PaginatedCombinedSearchResponse200OutputCompaniesItemFundingRoundStatsType0")


@_attrs_define
class PaginatedCombinedSearchResponse200OutputCompaniesItemFundingRoundStatsType0:
    """
    Attributes:
        ...
        individual_investor_stats (list[PaginatedCombinedSearchResponse200OutputCompaniesItemFundingRoundStatsType0Indiv
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.paginated_combined_search_response_200_output_companies_item_funding_round_stats_type_0_individual_investor_stats_type_0_item import (
            PaginatedCombinedSearchResponse200OutputCompaniesItemFundingRoundStatsType0IndividualInvestorStatsType0Item,  # noqa: PLC0415
        )
        ...
        def _parse_individual_investor_stats(
            ...
            try:
                ...
                for individual_investor_stats_type_0_item_data in _individual_investor_stats_type_0:
                    individual_investor_stats_type_0_item = PaginatedCombinedSearchResponse200OutputCompaniesItemFundingRoundStatsType0IndividualInvestorStatsType0Item.from_dict(
        ...
        paginated_combined_search_response_200_output_companies_item_funding_round_stats_type_0 = cls(
        ...
        paginated_combined_search_response_200_output_companies_item_funding_round_stats_type_0.additional_properties = d
        return paginated_combined_search_response_200_output_companies_item_funding_round_stats_type_0
