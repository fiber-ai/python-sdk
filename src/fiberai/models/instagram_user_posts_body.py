...
T = TypeVar("T", bound="InstagramUserPostsBody")


@_attrs_define
class InstagramUserPostsBody:
    """
    Attributes:
        api_key (str): Your Fiber API key
        handle (str): Instagram handle (with or without leading '@').
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        instagram_user_posts_body = cls(
            api_key=api_key,
            handle=handle,
            next_page_token=next_page_token,
        )

        instagram_user_posts_body.additional_properties = d
        return instagram_user_posts_body
