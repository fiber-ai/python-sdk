...
T = TypeVar("T", bound="GetSavedSearchRunStatusBody")



@_attrs_define
class GetSavedSearchRunStatusBody:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_saved_search_run_status_body = cls(
            api_key=api_key,
            saved_search_run_id=saved_search_run_id,
        )


        get_saved_search_run_status_body.additional_properties = d
        return get_saved_search_run_status_body
