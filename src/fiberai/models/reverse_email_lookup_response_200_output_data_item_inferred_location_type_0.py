...
if TYPE_CHECKING:
    from ..models.reverse_email_lookup_response_200_output_data_item_inferred_location_type_0_coordinates_type_0 import (
        ReverseEmailLookupResponse200OutputDataItemInferredLocationType0CoordinatesType0,
    )
...
class ReverseEmailLookupResponse200OutputDataItemInferredLocationType0:
    ...
    Attributes:
        ...
        coordinates (None | ReverseEmailLookupResponse200OutputDataItemInferredLocationType0CoordinatesType0 | Unset):
    ...
    coordinates: None | ReverseEmailLookupResponse200OutputDataItemInferredLocationType0CoordinatesType0 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.reverse_email_lookup_response_200_output_data_item_inferred_location_type_0_coordinates_type_0 import (
            ReverseEmailLookupResponse200OutputDataItemInferredLocationType0CoordinatesType0,  # noqa: PLC0415
        )
        ...
        if isinstance(self.coordinates, Unset):
            ...
            self.coordinates, ReverseEmailLookupResponse200OutputDataItemInferredLocationType0CoordinatesType0
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_coordinates(
            data: object,
        ) -> None | ReverseEmailLookupResponse200OutputDataItemInferredLocationType0CoordinatesType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = (
                    ReverseEmailLookupResponse200OutputDataItemInferredLocationType0CoordinatesType0.from_dict(data)
                )
                ...
                pass
            return cast(
                None | ReverseEmailLookupResponse200OutputDataItemInferredLocationType0CoordinatesType0 | Unset, data
            )
