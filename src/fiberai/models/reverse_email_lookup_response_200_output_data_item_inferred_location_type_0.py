...
if TYPE_CHECKING:
  from ..models.reverse_email_lookup_response_200_output_data_item_inferred_location_type_0_coordinates_type_0 import ReverseEmailLookupResponse200OutputDataItemInferredLocationType0CoordinatesType0





T = TypeVar("T", bound="ReverseEmailLookupResponse200OutputDataItemInferredLocationType0")



@_attrs_define
class ReverseEmailLookupResponse200OutputDataItemInferredLocationType0:
    """ 
        Attributes:
            ...
            coordinates (Union['ReverseEmailLookupResponse200OutputDataItemInferredLocationType0CoordinatesType0', None,
                Unset]):
    ...
    coordinates: Union['ReverseEmailLookupResponse200OutputDataItemInferredLocationType0CoordinatesType0', None, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.coordinates, Unset):
            coordinates = UNSET
        elif isinstance(self.coordinates, ReverseEmailLookupResponse200OutputDataItemInferredLocationType0CoordinatesType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_coordinates(data: object) -> Union['ReverseEmailLookupResponse200OutputDataItemInferredLocationType0CoordinatesType0', None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = ReverseEmailLookupResponse200OutputDataItemInferredLocationType0CoordinatesType0.from_dict(data)
                ...
                pass
            return cast(Union['ReverseEmailLookupResponse200OutputDataItemInferredLocationType0CoordinatesType0', None, Unset], data)
        ...
        reverse_email_lookup_response_200_output_data_item_inferred_location_type_0 = cls(
        ...
        reverse_email_lookup_response_200_output_data_item_inferred_location_type_0.additional_properties = d
        return reverse_email_lookup_response_200_output_data_item_inferred_location_type_0
