...
if TYPE_CHECKING:
    ...
    from ..models.combined_search_count_body_profile_params_past_jobs_type_0_none_of_type_0_item import (
        CombinedSearchCountBodyProfileParamsPastJobsType0NoneOfType0Item,
    )


T = TypeVar("T", bound="CombinedSearchCountBodyProfileParamsPastJobsType0")


@_attrs_define
class CombinedSearchCountBodyProfileParamsPastJobsType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.combined_search_count_body_profile_params_past_jobs_type_0_all_of_type_0_item import (
            CombinedSearchCountBodyProfileParamsPastJobsType0AllOfType0Item,  # noqa: PLC0415
        )
        from ..models.combined_search_count_body_profile_params_past_jobs_type_0_any_of_type_0_item import (
            CombinedSearchCountBodyProfileParamsPastJobsType0AnyOfType0Item,  # noqa: PLC0415
        )
        from ..models.combined_search_count_body_profile_params_past_jobs_type_0_none_of_type_0_item import (
            CombinedSearchCountBodyProfileParamsPastJobsType0NoneOfType0Item,  # noqa: PLC0415
        )
        ...
        def _parse_any_of(
            data: object,
        ) -> list[CombinedSearchCountBodyProfileParamsPastJobsType0AnyOfType0Item] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for any_of_type_0_item_data in _any_of_type_0:
                    any_of_type_0_item = CombinedSearchCountBodyProfileParamsPastJobsType0AnyOfType0Item.from_dict(
                ...
                pass
            return cast(list[CombinedSearchCountBodyProfileParamsPastJobsType0AnyOfType0Item] | None | Unset, data)
        ...
        def _parse_none_of(
            ...
            try:
                ...
                for none_of_type_0_item_data in _none_of_type_0:
                    none_of_type_0_item = CombinedSearchCountBodyProfileParamsPastJobsType0NoneOfType0Item.from_dict(
                ...
                pass
            return cast(list[CombinedSearchCountBodyProfileParamsPastJobsType0NoneOfType0Item] | None | Unset, data)
        ...
        combined_search_count_body_profile_params_past_jobs_type_0.additional_properties = d
        return combined_search_count_body_profile_params_past_jobs_type_0
