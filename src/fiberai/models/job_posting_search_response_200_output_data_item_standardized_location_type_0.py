...
class JobPostingSearchResponse200OutputDataItemStandardizedLocationType0:
    ...
    Attributes:
        ...
        coordinates (JobPostingSearchResponse200OutputDataItemStandardizedLocationType0CoordinatesType0 | None | Unset):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.coordinates, Unset):
            ...
            self.coordinates, JobPostingSearchResponse200OutputDataItemStandardizedLocationType0CoordinatesType0
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_coordinates(
            data: object,
        ) -> JobPostingSearchResponse200OutputDataItemStandardizedLocationType0CoordinatesType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = (
                    JobPostingSearchResponse200OutputDataItemStandardizedLocationType0CoordinatesType0.from_dict(data)
                )
                ...
                pass
            return cast(
                JobPostingSearchResponse200OutputDataItemStandardizedLocationType0CoordinatesType0 | None | Unset, data
            )
