...
if TYPE_CHECKING:
  from ..models.job_posting_search_response_200_output_data_item_standardized_location_type_0_coordinates_type_0 import JobPostingSearchResponse200OutputDataItemStandardizedLocationType0CoordinatesType0





T = TypeVar("T", bound="JobPostingSearchResponse200OutputDataItemStandardizedLocationType0")



@_attrs_define
class JobPostingSearchResponse200OutputDataItemStandardizedLocationType0:
    """ Standardized location with geo data including lat/lon
        ...
        Attributes:
            ...
            coordinates (Union['JobPostingSearchResponse200OutputDataItemStandardizedLocationType0CoordinatesType0', None,
                Unset]):
    ...
    coordinates: Union['JobPostingSearchResponse200OutputDataItemStandardizedLocationType0CoordinatesType0', None, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.coordinates, Unset):
            coordinates = UNSET
        elif isinstance(self.coordinates, JobPostingSearchResponse200OutputDataItemStandardizedLocationType0CoordinatesType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_coordinates(data: object) -> Union['JobPostingSearchResponse200OutputDataItemStandardizedLocationType0CoordinatesType0', None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = JobPostingSearchResponse200OutputDataItemStandardizedLocationType0CoordinatesType0.from_dict(data)
                ...
                pass
            return cast(Union['JobPostingSearchResponse200OutputDataItemStandardizedLocationType0CoordinatesType0', None, Unset], data)
        ...
        job_posting_search_response_200_output_data_item_standardized_location_type_0 = cls(
        ...
        job_posting_search_response_200_output_data_item_standardized_location_type_0.additional_properties = d
        return job_posting_search_response_200_output_data_item_standardized_location_type_0
