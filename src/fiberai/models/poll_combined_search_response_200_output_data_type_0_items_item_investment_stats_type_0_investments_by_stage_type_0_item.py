...
T = TypeVar("T", bound="PollCombinedSearchResponse200OutputDataType0ItemsItemInvestmentStatsType0InvestmentsByStageType0Item")



@_attrs_define
class PollCombinedSearchResponse200OutputDataType0ItemsItemInvestmentStatsType0InvestmentsByStageType0Item:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        poll_combined_search_response_200_output_data_type_0_items_item_investment_stats_type_0_investments_by_stage_type_0_item = cls(
            stage=stage,
            lead_rate=lead_rate,
        ...
        poll_combined_search_response_200_output_data_type_0_items_item_investment_stats_type_0_investments_by_stage_type_0_item.additional_properties = d
        return poll_combined_search_response_200_output_data_type_0_items_item_investment_stats_type_0_investments_by_stage_type_0_item
