...
T = TypeVar("T", bound="QuickPersonResolveResponse402OutOfCreditsAlertType0")


@_attrs_define
class QuickPersonResolveResponse402OutOfCreditsAlertType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        quick_person_resolve_response_402_out_of_credits_alert_type_0 = cls(
            get_more_credits_url=get_more_credits_url,
            message=message,
            available_credits=available_credits,
        )

        quick_person_resolve_response_402_out_of_credits_alert_type_0.additional_properties = d
        return quick_person_resolve_response_402_out_of_credits_alert_type_0
