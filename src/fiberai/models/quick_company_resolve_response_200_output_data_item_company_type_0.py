...
from ..models.quick_company_resolve_response_200_output_data_item_company_type_0_li_category_type_1 import (
    QuickCompanyResolveResponse200OutputDataItemCompanyType0LiCategoryType1,
)
from ..models.quick_company_resolve_response_200_output_data_item_company_type_0_li_category_type_2_type_1 import (
    QuickCompanyResolveResponse200OutputDataItemCompanyType0LiCategoryType2Type1,
)
from ..models.quick_company_resolve_response_200_output_data_item_company_type_0_li_category_type_3_type_1 import (
    QuickCompanyResolveResponse200OutputDataItemCompanyType0LiCategoryType3Type1,
)
from ..models.quick_company_resolve_response_200_output_data_item_company_type_0_standard_industries_type_0_item import (
    QuickCompanyResolveResponse200OutputDataItemCompanyType0StandardIndustriesType0Item,
)
from ..models.quick_company_resolve_response_200_output_data_item_company_type_0_tags_type_0_item import (
    QuickCompanyResolveResponse200OutputDataItemCompanyType0TagsType0Item,
)
...
T = TypeVar("T", bound="QuickCompanyResolveResponse200OutputDataItemCompanyType0")


@_attrs_define
class QuickCompanyResolveResponse200OutputDataItemCompanyType0:
    """
    Attributes:
        linkedin_id (None | str | Unset):
        accelerator_statuses (list[str] | None | Unset):
        accelerators (list[QuickCompanyResolveResponse200OutputDataItemCompanyType0AcceleratorsType0Item] | None |
            Unset):
        blog_urls (list[str] | None | Unset):
        custom_data (None | QuickCompanyResolveResponse200OutputDataItemCompanyType0CustomDataType0 | Unset):
        domains (list[str] | None | Unset):
        emails (list[str] | None | Unset):
        phone_numbers (list[str] | None | Unset):
        employee_count_consensus (None |
            QuickCompanyResolveResponse200OutputDataItemCompanyType0EmployeeCountConsensusType0 | Unset):
        facebook_urls (list[str] | None | Unset):
        fortune_rankings (list[QuickCompanyResolveResponse200OutputDataItemCompanyType0FortuneRankingsType0Item] | None
            | Unset):
        ...
        li_category (None | QuickCompanyResolveResponse200OutputDataItemCompanyType0LiCategoryType1 |
            QuickCompanyResolveResponse200OutputDataItemCompanyType0LiCategoryType2Type1 |
            QuickCompanyResolveResponse200OutputDataItemCompanyType0LiCategoryType3Type1 | Unset):
        li_job_posts_stats (None | QuickCompanyResolveResponse200OutputDataItemCompanyType0LiJobPostsStatsType0 |
            Unset):
        li_description (None | str | Unset):
        li_follower_count (float | None | Unset):
        li_headline (None | str | Unset):
        li_industries (list[QuickCompanyResolveResponse200OutputDataItemCompanyType0LiIndustriesType0Item] | None |
            Unset):
        li_locations (list[QuickCompanyResolveResponse200OutputDataItemCompanyType0LiLocationsType0Item] | None |
            Unset):
        li_specialties (list[str] | None | Unset):
        location_consensus (None | QuickCompanyResolveResponse200OutputDataItemCompanyType0LocationConsensusType0 |
            Unset):
        locations_stats (None | QuickCompanyResolveResponse200OutputDataItemCompanyType0LocationsStatsType0 | Unset):
        ...
        revenue_estimate (None | QuickCompanyResolveResponse200OutputDataItemCompanyType0RevenueEstimateType0 | Unset):
        standard_industries (list[QuickCompanyResolveResponse200OutputDataItemCompanyType0StandardIndustriesType0Item] |
            None | Unset):
        status_consensus (None | str | Unset):
        stock_info_consensus (None | QuickCompanyResolveResponse200OutputDataItemCompanyType0StockInfoConsensusType0 |
            Unset):
        tags (list[QuickCompanyResolveResponse200OutputDataItemCompanyType0TagsType0Item] | None | Unset):
        ...
        role_count_matches (list[QuickCompanyResolveResponse200OutputDataItemCompanyType0RoleCountMatchesType0Item] |
            None | Unset):
        num_matching_locations (None | QuickCompanyResolveResponse200OutputDataItemCompanyType0NumMatchingLocationsType0
            | Unset):
        ...
        historical_headcount (None | QuickCompanyResolveResponse200OutputDataItemCompanyType0HistoricalHeadcountType0 |
            Unset):
        ...
        funding_rounds (list[QuickCompanyResolveResponse200OutputDataItemCompanyType0FundingRoundsType0Item] | None |
            Unset):
        num_exits (float | None | Unset):
        investors (list[QuickCompanyResolveResponse200OutputDataItemCompanyType0InvestorsType0Item] | None | Unset):
        acquisitions (list[QuickCompanyResolveResponse200OutputDataItemCompanyType0AcquisitionsType0Item] | None |
            Unset):
        best_funding_round (None | QuickCompanyResolveResponse200OutputDataItemCompanyType0BestFundingRoundType0 |
            Unset):
        ...
        employee_trends (list[QuickCompanyResolveResponse200OutputDataItemCompanyType0EmployeeTrendsType0Item] | None |
            Unset):
        logo_url (None | str | Unset):
        similar_companies (list[QuickCompanyResolveResponse200OutputDataItemCompanyType0SimilarCompaniesType0Item] |
            None | Unset):
        full_funding_rounds (list[QuickCompanyResolveResponse200OutputDataItemCompanyType0FullFundingRoundsType0Item] |
            None | Unset):
        funding_round_stats (None | QuickCompanyResolveResponse200OutputDataItemCompanyType0FundingRoundStatsType0 |
            Unset):
        investment_stats (None | QuickCompanyResolveResponse200OutputDataItemCompanyType0InvestmentStatsType0 | Unset):
        is_investor (bool | None | Unset):
        investor_type (None | str | Unset):
        investor_categories (list[str] | None | Unset):
        technologies_used (list[QuickCompanyResolveResponse200OutputDataItemCompanyType0TechnologiesUsedType0Item] |
            None | Unset):
        platforms (None | QuickCompanyResolveResponse200OutputDataItemCompanyType0PlatformsType0 | Unset):
    """

    linkedin_id: None | str | Unset = UNSET
    accelerator_statuses: list[str] | None | Unset = UNSET
    accelerators: list[QuickCompanyResolveResponse200OutputDataItemCompanyType0AcceleratorsType0Item] | None | Unset = (
        UNSET
    )
    blog_urls: list[str] | None | Unset = UNSET
    custom_data: None | QuickCompanyResolveResponse200OutputDataItemCompanyType0CustomDataType0 | Unset = UNSET
    ...
    employee_count_consensus: (
        None | QuickCompanyResolveResponse200OutputDataItemCompanyType0EmployeeCountConsensusType0 | Unset
    ) = UNSET
    facebook_urls: list[str] | None | Unset = UNSET
    fortune_rankings: (
        list[QuickCompanyResolveResponse200OutputDataItemCompanyType0FortuneRankingsType0Item] | None | Unset
    ) = UNSET
    ...
    li_job_posts_stats: None | QuickCompanyResolveResponse200OutputDataItemCompanyType0LiJobPostsStatsType0 | Unset = (
        UNSET
    )
    ...
    li_industries: (
        list[QuickCompanyResolveResponse200OutputDataItemCompanyType0LiIndustriesType0Item] | None | Unset
    ) = UNSET
    li_locations: list[QuickCompanyResolveResponse200OutputDataItemCompanyType0LiLocationsType0Item] | None | Unset = (
        UNSET
    )
    li_specialties: list[str] | None | Unset = UNSET
    location_consensus: (
        None | QuickCompanyResolveResponse200OutputDataItemCompanyType0LocationConsensusType0 | Unset
    ) = UNSET
    locations_stats: None | QuickCompanyResolveResponse200OutputDataItemCompanyType0LocationsStatsType0 | Unset = UNSET
    ...
    standard_industries: (
        list[QuickCompanyResolveResponse200OutputDataItemCompanyType0StandardIndustriesType0Item] | None | Unset
    ) = UNSET
    status_consensus: None | str | Unset = UNSET
    stock_info_consensus: (
        None | QuickCompanyResolveResponse200OutputDataItemCompanyType0StockInfoConsensusType0 | Unset
    ) = UNSET
    tags: list[QuickCompanyResolveResponse200OutputDataItemCompanyType0TagsType0Item] | None | Unset = UNSET
    ...
    role_count_matches: (
        list[QuickCompanyResolveResponse200OutputDataItemCompanyType0RoleCountMatchesType0Item] | None | Unset
    ) = UNSET
    num_matching_locations: (
        None | QuickCompanyResolveResponse200OutputDataItemCompanyType0NumMatchingLocationsType0 | Unset
    ) = UNSET
    ...
    historical_headcount: (
        None | QuickCompanyResolveResponse200OutputDataItemCompanyType0HistoricalHeadcountType0 | Unset
    ) = UNSET
    ...
    funding_rounds: (
        list[QuickCompanyResolveResponse200OutputDataItemCompanyType0FundingRoundsType0Item] | None | Unset
    ) = UNSET
    num_exits: float | None | Unset = UNSET
    investors: list[QuickCompanyResolveResponse200OutputDataItemCompanyType0InvestorsType0Item] | None | Unset = UNSET
    acquisitions: list[QuickCompanyResolveResponse200OutputDataItemCompanyType0AcquisitionsType0Item] | None | Unset = (
        UNSET
    )
    best_funding_round: None | QuickCompanyResolveResponse200OutputDataItemCompanyType0BestFundingRoundType0 | Unset = (
        UNSET
    )
    ...
    employee_trends: (
        list[QuickCompanyResolveResponse200OutputDataItemCompanyType0EmployeeTrendsType0Item] | None | Unset
    ) = UNSET
    logo_url: None | str | Unset = UNSET
    similar_companies: (
        list[QuickCompanyResolveResponse200OutputDataItemCompanyType0SimilarCompaniesType0Item] | None | Unset
    ) = UNSET
    full_funding_rounds: (
        list[QuickCompanyResolveResponse200OutputDataItemCompanyType0FullFundingRoundsType0Item] | None | Unset
    ) = UNSET
    funding_round_stats: (
        None | QuickCompanyResolveResponse200OutputDataItemCompanyType0FundingRoundStatsType0 | Unset
    ) = UNSET
    investment_stats: None | QuickCompanyResolveResponse200OutputDataItemCompanyType0InvestmentStatsType0 | Unset = (
        UNSET
    )
    ...
    technologies_used: (
        list[QuickCompanyResolveResponse200OutputDataItemCompanyType0TechnologiesUsedType0Item] | None | Unset
    ) = UNSET
    platforms: None | QuickCompanyResolveResponse200OutputDataItemCompanyType0PlatformsType0 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.custom_data, Unset):
            custom_data = UNSET
        elif isinstance(self.custom_data, QuickCompanyResolveResponse200OutputDataItemCompanyType0CustomDataType0):
        ...
        if isinstance(self.li_category, Unset):
            li_category = UNSET
        elif isinstance(self.li_category, QuickCompanyResolveResponse200OutputDataItemCompanyType0LiCategoryType1):
            li_category = self.li_category.value
        elif isinstance(self.li_category, QuickCompanyResolveResponse200OutputDataItemCompanyType0LiCategoryType2Type1):
            li_category = self.li_category.value
        elif isinstance(self.li_category, QuickCompanyResolveResponse200OutputDataItemCompanyType0LiCategoryType3Type1):
            li_category = self.li_category.value
        else:
        ...
        if isinstance(self.li_job_posts_stats, Unset):
            ...
            self.li_job_posts_stats, QuickCompanyResolveResponse200OutputDataItemCompanyType0LiJobPostsStatsType0
        ):
        ...
        if isinstance(self.location_consensus, Unset):
            ...
            self.location_consensus, QuickCompanyResolveResponse200OutputDataItemCompanyType0LocationConsensusType0
        ):
        ...
        if isinstance(self.locations_stats, Unset):
            ...
            self.locations_stats, QuickCompanyResolveResponse200OutputDataItemCompanyType0LocationsStatsType0
        ):
        ...
        if isinstance(self.revenue_estimate, Unset):
            ...
            self.revenue_estimate, QuickCompanyResolveResponse200OutputDataItemCompanyType0RevenueEstimateType0
        ):
        ...
        if isinstance(self.stock_info_consensus, Unset):
            ...
            self.stock_info_consensus, QuickCompanyResolveResponse200OutputDataItemCompanyType0StockInfoConsensusType0
        ):
        ...
        if isinstance(self.historical_headcount, Unset):
            ...
            self.historical_headcount, QuickCompanyResolveResponse200OutputDataItemCompanyType0HistoricalHeadcountType0
        ):
        ...
        if isinstance(self.best_funding_round, Unset):
            ...
            self.best_funding_round, QuickCompanyResolveResponse200OutputDataItemCompanyType0BestFundingRoundType0
        ):
        ...
        if isinstance(self.funding_round_stats, Unset):
            ...
            self.funding_round_stats, QuickCompanyResolveResponse200OutputDataItemCompanyType0FundingRoundStatsType0
        ):
        ...
        if isinstance(self.investment_stats, Unset):
            ...
            self.investment_stats, QuickCompanyResolveResponse200OutputDataItemCompanyType0InvestmentStatsType0
        ):
        ...
        if isinstance(self.platforms, Unset):
            platforms = UNSET
        elif isinstance(self.platforms, QuickCompanyResolveResponse200OutputDataItemCompanyType0PlatformsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_accelerators(
            data: object,
        ) -> list[QuickCompanyResolveResponse200OutputDataItemCompanyType0AcceleratorsType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for accelerators_type_0_item_data in _accelerators_type_0:
                    accelerators_type_0_item = (
                        QuickCompanyResolveResponse200OutputDataItemCompanyType0AcceleratorsType0Item.from_dict(
                ...
                pass
            return cast(
                list[QuickCompanyResolveResponse200OutputDataItemCompanyType0AcceleratorsType0Item] | None | Unset, data
            )
        ...
        def _parse_custom_data(
            data: object,
        ) -> None | QuickCompanyResolveResponse200OutputDataItemCompanyType0CustomDataType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                custom_data_type_0 = QuickCompanyResolveResponse200OutputDataItemCompanyType0CustomDataType0.from_dict(
                    data
                )
                ...
                pass
            return cast(None | QuickCompanyResolveResponse200OutputDataItemCompanyType0CustomDataType0 | Unset, data)
        ...
        def _parse_employee_count_consensus(
            ...
            try:
                ...
                employee_count_consensus_type_0 = (
                    QuickCompanyResolveResponse200OutputDataItemCompanyType0EmployeeCountConsensusType0.from_dict(data)
                )
                ...
                pass
            return cast(
                None | QuickCompanyResolveResponse200OutputDataItemCompanyType0EmployeeCountConsensusType0 | Unset, data
            )
            ...
            try:
                ...
                for fortune_rankings_type_0_item_data in _fortune_rankings_type_0:
                    fortune_rankings_type_0_item = (
                        QuickCompanyResolveResponse200OutputDataItemCompanyType0FortuneRankingsType0Item.from_dict(
        ...
        def _parse_li_category(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                li_category_type_1 = QuickCompanyResolveResponse200OutputDataItemCompanyType0LiCategoryType1(data)
            ...
            try:
                ...
                li_category_type_2_type_1 = (
                    QuickCompanyResolveResponse200OutputDataItemCompanyType0LiCategoryType2Type1(data)
                )
            ...
            try:
                ...
                li_category_type_3_type_1 = (
                    QuickCompanyResolveResponse200OutputDataItemCompanyType0LiCategoryType3Type1(data)
                )
        ...
        def _parse_li_job_posts_stats(
            data: object,
        ) -> None | QuickCompanyResolveResponse200OutputDataItemCompanyType0LiJobPostsStatsType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                li_job_posts_stats_type_0 = (
                    QuickCompanyResolveResponse200OutputDataItemCompanyType0LiJobPostsStatsType0.from_dict(data)
                )
                ...
                pass
            return cast(
                None | QuickCompanyResolveResponse200OutputDataItemCompanyType0LiJobPostsStatsType0 | Unset, data
            )
            ...
            try:
                ...
                for li_industries_type_0_item_data in _li_industries_type_0:
                    li_industries_type_0_item = (
                        QuickCompanyResolveResponse200OutputDataItemCompanyType0LiIndustriesType0Item.from_dict(
                ...
                pass
            return cast(
                list[QuickCompanyResolveResponse200OutputDataItemCompanyType0LiIndustriesType0Item] | None | Unset, data
            )
        ...
        def _parse_li_locations(
            data: object,
        ) -> list[QuickCompanyResolveResponse200OutputDataItemCompanyType0LiLocationsType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for li_locations_type_0_item_data in _li_locations_type_0:
                    li_locations_type_0_item = (
                        QuickCompanyResolveResponse200OutputDataItemCompanyType0LiLocationsType0Item.from_dict(
                ...
                pass
            return cast(
                list[QuickCompanyResolveResponse200OutputDataItemCompanyType0LiLocationsType0Item] | None | Unset, data
            )
        ...
        def _parse_location_consensus(
            ...
            try:
                ...
                location_consensus_type_0 = (
                    QuickCompanyResolveResponse200OutputDataItemCompanyType0LocationConsensusType0.from_dict(data)
                )
                ...
                pass
            return cast(
                None | QuickCompanyResolveResponse200OutputDataItemCompanyType0LocationConsensusType0 | Unset, data
            )
        ...
        def _parse_locations_stats(
            data: object,
        ) -> None | QuickCompanyResolveResponse200OutputDataItemCompanyType0LocationsStatsType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                locations_stats_type_0 = (
                    QuickCompanyResolveResponse200OutputDataItemCompanyType0LocationsStatsType0.from_dict(data)
                )
                ...
                pass
            return cast(
                None | QuickCompanyResolveResponse200OutputDataItemCompanyType0LocationsStatsType0 | Unset, data
            )
        ...
        def _parse_revenue_estimate(
            data: object,
        ) -> None | QuickCompanyResolveResponse200OutputDataItemCompanyType0RevenueEstimateType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                revenue_estimate_type_0 = (
                    QuickCompanyResolveResponse200OutputDataItemCompanyType0RevenueEstimateType0.from_dict(data)
                )
                ...
                pass
            return cast(
                None | QuickCompanyResolveResponse200OutputDataItemCompanyType0RevenueEstimateType0 | Unset, data
            )
        ...
        def _parse_standard_industries(
            ...
            try:
                ...
                pass
            return cast(
                list[QuickCompanyResolveResponse200OutputDataItemCompanyType0StandardIndustriesType0Item]
                | None
                | Unset,
                data,
            )
        ...
        def _parse_stock_info_consensus(
            ...
            try:
                ...
                stock_info_consensus_type_0 = (
                    QuickCompanyResolveResponse200OutputDataItemCompanyType0StockInfoConsensusType0.from_dict(data)
                )
                ...
                pass
            return cast(
                None | QuickCompanyResolveResponse200OutputDataItemCompanyType0StockInfoConsensusType0 | Unset, data
            )
        ...
        def _parse_tags(
            data: object,
        ) -> list[QuickCompanyResolveResponse200OutputDataItemCompanyType0TagsType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for tags_type_0_item_data in _tags_type_0:
                    tags_type_0_item = QuickCompanyResolveResponse200OutputDataItemCompanyType0TagsType0Item(
                ...
                pass
            return cast(
                list[QuickCompanyResolveResponse200OutputDataItemCompanyType0TagsType0Item] | None | Unset, data
            )
            ...
            try:
                ...
                for role_count_matches_type_0_item_data in _role_count_matches_type_0:
                    role_count_matches_type_0_item = (
                        QuickCompanyResolveResponse200OutputDataItemCompanyType0RoleCountMatchesType0Item.from_dict(
        ...
        def _parse_num_matching_locations(
            ...
            try:
                ...
                num_matching_locations_type_0 = (
                    QuickCompanyResolveResponse200OutputDataItemCompanyType0NumMatchingLocationsType0.from_dict(data)
                )
                ...
                pass
            return cast(
                None | QuickCompanyResolveResponse200OutputDataItemCompanyType0NumMatchingLocationsType0 | Unset, data
            )
        ...
        def _parse_historical_headcount(
            ...
            try:
                ...
                historical_headcount_type_0 = (
                    QuickCompanyResolveResponse200OutputDataItemCompanyType0HistoricalHeadcountType0.from_dict(data)
                )
                ...
                pass
            return cast(
                None | QuickCompanyResolveResponse200OutputDataItemCompanyType0HistoricalHeadcountType0 | Unset, data
            )
            ...
            try:
                ...
                for funding_rounds_type_0_item_data in _funding_rounds_type_0:
                    funding_rounds_type_0_item = (
                        QuickCompanyResolveResponse200OutputDataItemCompanyType0FundingRoundsType0Item.from_dict(
        ...
        def _parse_investors(
            data: object,
        ) -> list[QuickCompanyResolveResponse200OutputDataItemCompanyType0InvestorsType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for investors_type_0_item_data in _investors_type_0:
                    investors_type_0_item = (
                        QuickCompanyResolveResponse200OutputDataItemCompanyType0InvestorsType0Item.from_dict(
                ...
                pass
            return cast(
                list[QuickCompanyResolveResponse200OutputDataItemCompanyType0InvestorsType0Item] | None | Unset, data
            )
        ...
        def _parse_acquisitions(
            data: object,
        ) -> list[QuickCompanyResolveResponse200OutputDataItemCompanyType0AcquisitionsType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for acquisitions_type_0_item_data in _acquisitions_type_0:
                    acquisitions_type_0_item = (
                        QuickCompanyResolveResponse200OutputDataItemCompanyType0AcquisitionsType0Item.from_dict(
                ...
                pass
            return cast(
                list[QuickCompanyResolveResponse200OutputDataItemCompanyType0AcquisitionsType0Item] | None | Unset, data
            )
        ...
        def _parse_best_funding_round(
            data: object,
        ) -> None | QuickCompanyResolveResponse200OutputDataItemCompanyType0BestFundingRoundType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                best_funding_round_type_0 = (
                    QuickCompanyResolveResponse200OutputDataItemCompanyType0BestFundingRoundType0.from_dict(data)
                )
                ...
                pass
            return cast(
                None | QuickCompanyResolveResponse200OutputDataItemCompanyType0BestFundingRoundType0 | Unset, data
            )
            ...
            try:
                ...
                for employee_trends_type_0_item_data in _employee_trends_type_0:
                    employee_trends_type_0_item = (
                        QuickCompanyResolveResponse200OutputDataItemCompanyType0EmployeeTrendsType0Item.from_dict(
            ...
            try:
                ...
                for similar_companies_type_0_item_data in _similar_companies_type_0:
                    similar_companies_type_0_item = (
                        QuickCompanyResolveResponse200OutputDataItemCompanyType0SimilarCompaniesType0Item.from_dict(
            ...
            try:
                ...
                for full_funding_rounds_type_0_item_data in _full_funding_rounds_type_0:
                    full_funding_rounds_type_0_item = (
                        QuickCompanyResolveResponse200OutputDataItemCompanyType0FullFundingRoundsType0Item.from_dict(
        ...
        def _parse_funding_round_stats(
            ...
            try:
                ...
                funding_round_stats_type_0 = (
                    QuickCompanyResolveResponse200OutputDataItemCompanyType0FundingRoundStatsType0.from_dict(data)
                )
                ...
                pass
            return cast(
                None | QuickCompanyResolveResponse200OutputDataItemCompanyType0FundingRoundStatsType0 | Unset, data
            )
        ...
        def _parse_investment_stats(
            data: object,
        ) -> None | QuickCompanyResolveResponse200OutputDataItemCompanyType0InvestmentStatsType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                investment_stats_type_0 = (
                    QuickCompanyResolveResponse200OutputDataItemCompanyType0InvestmentStatsType0.from_dict(data)
                )
                ...
                pass
            return cast(
                None | QuickCompanyResolveResponse200OutputDataItemCompanyType0InvestmentStatsType0 | Unset, data
            )
            ...
            try:
                ...
                for technologies_used_type_0_item_data in _technologies_used_type_0:
                    technologies_used_type_0_item = (
                        QuickCompanyResolveResponse200OutputDataItemCompanyType0TechnologiesUsedType0Item.from_dict(
        ...
        def _parse_platforms(
            data: object,
        ) -> None | QuickCompanyResolveResponse200OutputDataItemCompanyType0PlatformsType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                platforms_type_0 = QuickCompanyResolveResponse200OutputDataItemCompanyType0PlatformsType0.from_dict(
                    data
                )
                ...
                pass
            return cast(None | QuickCompanyResolveResponse200OutputDataItemCompanyType0PlatformsType0 | Unset, data)

        platforms = _parse_platforms(d.pop("platforms", UNSET))

        quick_company_resolve_response_200_output_data_item_company_type_0 = cls(
        ...
        quick_company_resolve_response_200_output_data_item_company_type_0.additional_properties = d
        return quick_company_resolve_response_200_output_data_item_company_type_0
