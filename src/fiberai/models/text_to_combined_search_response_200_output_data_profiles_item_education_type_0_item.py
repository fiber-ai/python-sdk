...
T = TypeVar("T", bound="TextToCombinedSearchResponse200OutputDataProfilesItemEducationType0Item")


@_attrs_define
class TextToCombinedSearchResponse200OutputDataProfilesItemEducationType0Item:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        text_to_combined_search_response_200_output_data_profiles_item_education_type_0_item = cls(
            school_id=school_id,
        ...
        text_to_combined_search_response_200_output_data_profiles_item_education_type_0_item.additional_properties = d
        return text_to_combined_search_response_200_output_data_profiles_item_education_type_0_item
