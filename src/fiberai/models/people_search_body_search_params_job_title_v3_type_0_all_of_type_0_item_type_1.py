...
from ..models.people_search_body_search_params_job_title_v3_type_0_all_of_type_0_item_type_1_seniority_item import (
    PeopleSearchBodySearchParamsJobTitleV3Type0AllOfType0ItemType1SeniorityItem,
)
from ..models.people_search_body_search_params_job_title_v3_type_0_all_of_type_0_item_type_1_type import (
    PeopleSearchBodySearchParamsJobTitleV3Type0AllOfType0ItemType1Type,
)
...
class PeopleSearchBodySearchParamsJobTitleV3Type0AllOfType0ItemType1:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for seniority_item_data in _seniority:
            seniority_item = PeopleSearchBodySearchParamsJobTitleV3Type0AllOfType0ItemType1SeniorityItem(
                seniority_item_data
            )
