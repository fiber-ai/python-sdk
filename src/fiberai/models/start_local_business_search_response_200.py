...
if TYPE_CHECKING:
    from ..models.start_local_business_search_response_200_charge_info_type_0 import (
        StartLocalBusinessSearchResponse200ChargeInfoType0,
    )
    from ..models.start_local_business_search_response_200_charge_info_type_1 import (
...
class StartLocalBusinessSearchResponse200:
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.start_local_business_search_response_200_charge_info_type_0 import (
            StartLocalBusinessSearchResponse200ChargeInfoType0,  # noqa: PLC0415
        )
        from ..models.start_local_business_search_response_200_charge_info_type_1 import (
            StartLocalBusinessSearchResponse200ChargeInfoType1,  # noqa: PLC0415
        )
        from ..models.start_local_business_search_response_200_charge_info_type_2 import (
            StartLocalBusinessSearchResponse200ChargeInfoType2,  # noqa: PLC0415
        )
        from ..models.start_local_business_search_response_200_charge_info_type_3 import (
            StartLocalBusinessSearchResponse200ChargeInfoType3,  # noqa: PLC0415
        )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_warnings(data: object) -> list[StartLocalBusinessSearchResponse200WarningsType0Item] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for warnings_type_0_item_data in _warnings_type_0:
                    warnings_type_0_item = StartLocalBusinessSearchResponse200WarningsType0Item.from_dict(
                ...
                pass
            return cast(list[StartLocalBusinessSearchResponse200WarningsType0Item] | None | Unset, data)
