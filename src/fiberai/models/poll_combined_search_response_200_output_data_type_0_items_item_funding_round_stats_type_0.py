...
if TYPE_CHECKING:
  from ..models.poll_combined_search_response_200_output_data_type_0_items_item_funding_round_stats_type_0_individual_investor_stats_type_0_item import PollCombinedSearchResponse200OutputDataType0ItemsItemFundingRoundStatsType0IndividualInvestorStatsType0Item
...
class PollCombinedSearchResponse200OutputDataType0ItemsItemFundingRoundStatsType0:
    """ 
        Attributes:
            ...
            individual_investor_stats (Union[None, Unset, list['PollCombinedSearchResponse200OutputDataType0ItemsItemFunding
                RoundStatsType0IndividualInvestorStatsType0Item']]):
    ...
    individual_investor_stats: Union[None, Unset, list['PollCombinedSearchResponse200OutputDataType0ItemsItemFundingRoundStatsType0IndividualInvestorStatsType0Item']] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_individual_investor_stats(data: object) -> Union[None, Unset, list['PollCombinedSearchResponse200OutputDataType0ItemsItemFundingRoundStatsType0IndividualInvestorStatsType0Item']]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for individual_investor_stats_type_0_item_data in (_individual_investor_stats_type_0):
                    individual_investor_stats_type_0_item = PollCombinedSearchResponse200OutputDataType0ItemsItemFundingRoundStatsType0IndividualInvestorStatsType0Item.from_dict(individual_investor_stats_type_0_item_data)
                ...
                pass
            return cast(Union[None, Unset, list['PollCombinedSearchResponse200OutputDataType0ItemsItemFundingRoundStatsType0IndividualInvestorStatsType0Item']], data)
