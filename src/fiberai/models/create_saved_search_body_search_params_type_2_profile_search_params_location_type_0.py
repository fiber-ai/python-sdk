...
class CreateSavedSearchBodySearchParamsType2ProfileSearchParamsLocationType0:
    """
    Attributes:
        union_all (list[CreateSavedSearchBodySearchParamsType2ProfileSearchParamsLocationType0UnionAllType0ItemType0 |
            CreateSavedSearchBodySearchParamsType2ProfileSearchParamsLocationType0UnionAllType0ItemType1 |
            CreateSavedSearchBodySearchParamsType2ProfileSearchParamsLocationType0UnionAllType0ItemType2 |
            CreateSavedSearchBodySearchParamsType2ProfileSearchParamsLocationType0UnionAllType0ItemType3] | None | Unset):
        subtract_all
            (list[CreateSavedSearchBodySearchParamsType2ProfileSearchParamsLocationType0SubtractAllType0ItemType0 |
            CreateSavedSearchBodySearchParamsType2ProfileSearchParamsLocationType0SubtractAllType0ItemType1 |
            CreateSavedSearchBodySearchParamsType2ProfileSearchParamsLocationType0SubtractAllType0ItemType2 |
            CreateSavedSearchBodySearchParamsType2ProfileSearchParamsLocationType0SubtractAllType0ItemType3] | None |
            Unset):
    """
                    ...
                    def _parse_union_all_type_0_item(
                        ...
                        try:
                            if not isinstance(data, dict):
                                raise TypeError()
                            union_all_type_0_item_type_0 = CreateSavedSearchBodySearchParamsType2ProfileSearchParamsLocationType0UnionAllType0ItemType0.from_dict(
                                data
                            )
                        ...
                        try:
                            if not isinstance(data, dict):
                                raise TypeError()
                            union_all_type_0_item_type_1 = CreateSavedSearchBodySearchParamsType2ProfileSearchParamsLocationType0UnionAllType0ItemType1.from_dict(
                                data
                            )
                        ...
                        try:
                            if not isinstance(data, dict):
                                raise TypeError()
                            union_all_type_0_item_type_2 = CreateSavedSearchBodySearchParamsType2ProfileSearchParamsLocationType0UnionAllType0ItemType2.from_dict(
                                data
                            )
                        ...
                        if not isinstance(data, dict):
                            raise TypeError()
                        union_all_type_0_item_type_3 = CreateSavedSearchBodySearchParamsType2ProfileSearchParamsLocationType0UnionAllType0ItemType3.from_dict(
                            data
                        )
                ...
                for subtract_all_type_0_item_data in _subtract_all_type_0:
                    ...
                    def _parse_subtract_all_type_0_item(
                        ...
                        try:
                            if not isinstance(data, dict):
                                raise TypeError()
                            subtract_all_type_0_item_type_0 = CreateSavedSearchBodySearchParamsType2ProfileSearchParamsLocationType0SubtractAllType0ItemType0.from_dict(
                                data
                            )
                        ...
                        try:
                            if not isinstance(data, dict):
                                raise TypeError()
                            subtract_all_type_0_item_type_1 = CreateSavedSearchBodySearchParamsType2ProfileSearchParamsLocationType0SubtractAllType0ItemType1.from_dict(
                                data
                            )
                        ...
                        try:
                            if not isinstance(data, dict):
                                raise TypeError()
                            subtract_all_type_0_item_type_2 = CreateSavedSearchBodySearchParamsType2ProfileSearchParamsLocationType0SubtractAllType0ItemType2.from_dict(
                                data
                            )
                        ...
                        if not isinstance(data, dict):
                            raise TypeError()
                        subtract_all_type_0_item_type_3 = CreateSavedSearchBodySearchParamsType2ProfileSearchParamsLocationType0SubtractAllType0ItemType3.from_dict(
                            data
                        )
