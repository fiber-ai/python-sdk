...
class GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemLocationConsensusType0:
    ...
    Attributes:
        ...
        coordinates
            (GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemLocationConsensusType0CoordinatesType0 | None |
            Unset):
        ...
        def _parse_coordinates(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemLocationConsensusType0CoordinatesType0.from_dict(
                    data
                )
