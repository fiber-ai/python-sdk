...
if TYPE_CHECKING:
    from ..models.get_saved_search_run_companies_response_200_output_companies_item_company_funding_round_stats_type_0_individual_investor_stats_type_0_item import (
        GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyFundingRoundStatsType0IndividualInvestorStatsType0Item,
    )
...
class GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyFundingRoundStatsType0:
    ...
    Attributes:
        ...
        individual_investor_stats (list[GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyFundingRoundStats
            Type0IndividualInvestorStatsType0Item] | None | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.get_saved_search_run_companies_response_200_output_companies_item_company_funding_round_stats_type_0_individual_investor_stats_type_0_item import (
            GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyFundingRoundStatsType0IndividualInvestorStatsType0Item,  # noqa: PLC0415
        )
        ...
        def _parse_individual_investor_stats(
            ...
            try:
                ...
                for individual_investor_stats_type_0_item_data in _individual_investor_stats_type_0:
                    individual_investor_stats_type_0_item = GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyFundingRoundStatsType0IndividualInvestorStatsType0Item.from_dict(
