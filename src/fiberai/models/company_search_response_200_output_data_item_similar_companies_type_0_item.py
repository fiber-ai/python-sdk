...
T = TypeVar("T", bound="CompanySearchResponse200OutputDataItemSimilarCompaniesType0Item")


@_attrs_define
class CompanySearchResponse200OutputDataItemSimilarCompaniesType0Item:
    """
    Attributes:
        name (None | str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        company_search_response_200_output_data_item_similar_companies_type_0_item = cls(
            name=name,
        ...
        company_search_response_200_output_data_item_similar_companies_type_0_item.additional_properties = d
        return company_search_response_200_output_data_item_similar_companies_type_0_item
