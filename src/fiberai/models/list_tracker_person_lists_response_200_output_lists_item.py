...
if TYPE_CHECKING:
    from ..models.list_tracker_person_lists_response_200_output_lists_item_tracking_rules_type_0_item import (
        ListTrackerPersonListsResponse200OutputListsItemTrackingRulesType0Item,
    )


T = TypeVar("T", bound="ListTrackerPersonListsResponse200OutputListsItem")


@_attrs_define
class ListTrackerPersonListsResponse200OutputListsItem:
    """
    Attributes:
        ...
        person_count (int): Number of people in this list
        created_at (datetime.datetime): When the list was created
        tracking_rules (list[ListTrackerPersonListsResponse200OutputListsItemTrackingRulesType0Item] | None | Unset):
    ...
    tracking_rules: list[ListTrackerPersonListsResponse200OutputListsItemTrackingRulesType0Item] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        person_count = d.pop("personCount")

        created_at = datetime.datetime.fromisoformat(d.pop("createdAt"))

        def _parse_tracking_rules(
            data: object,
        ) -> list[ListTrackerPersonListsResponse200OutputListsItemTrackingRulesType0Item] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for tracking_rules_type_0_item_data in _tracking_rules_type_0:
                    tracking_rules_type_0_item = (
                        ListTrackerPersonListsResponse200OutputListsItemTrackingRulesType0Item.from_dict(
                ...
                pass
            return cast(
                list[ListTrackerPersonListsResponse200OutputListsItemTrackingRulesType0Item] | None | Unset, data
            )

        tracking_rules = _parse_tracking_rules(d.pop("trackingRules", UNSET))

        list_tracker_person_lists_response_200_output_lists_item = cls(
            id=id,
            name=name,
        ...
        list_tracker_person_lists_response_200_output_lists_item.additional_properties = d
        return list_tracker_person_lists_response_200_output_lists_item
