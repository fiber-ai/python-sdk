...
T = TypeVar("T", bound="FlightSearchResponse200OutputOtherFlightsItemCarbonEmissionsType0")


@_attrs_define
class FlightSearchResponse200OutputOtherFlightsItemCarbonEmissionsType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        flight_search_response_200_output_other_flights_item_carbon_emissions_type_0 = cls(
            this_flight_kg=this_flight_kg,
            typical_for_route_kg=typical_for_route_kg,
            difference_percent=difference_percent,
        )

        flight_search_response_200_output_other_flights_item_carbon_emissions_type_0.additional_properties = d
        return flight_search_response_200_output_other_flights_item_carbon_emissions_type_0
