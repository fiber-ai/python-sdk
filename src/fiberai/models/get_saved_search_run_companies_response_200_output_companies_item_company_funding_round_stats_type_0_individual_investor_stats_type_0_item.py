...
T = TypeVar("T", bound="GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyFundingRoundStatsType0IndividualInvestorStatsType0Item")



@_attrs_define
class GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyFundingRoundStatsType0IndividualInvestorStatsType0Item:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_saved_search_run_companies_response_200_output_companies_item_company_funding_round_stats_type_0_individual_investor_stats_type_0_item = cls(
        ...
        get_saved_search_run_companies_response_200_output_companies_item_company_funding_round_stats_type_0_individual_investor_stats_type_0_item.additional_properties = d
        return get_saved_search_run_companies_response_200_output_companies_item_company_funding_round_stats_type_0_individual_investor_stats_type_0_item
