...
if TYPE_CHECKING:
  from ..models.poll_batch_contact_enrichment_response_200_output_page_results_item_outputs_type_0_emails_item import PollBatchContactEnrichmentResponse200OutputPageResultsItemOutputsType0EmailsItem
  from ..models.poll_batch_contact_enrichment_response_200_output_page_results_item_outputs_type_0_phone_numbers_item import PollBatchContactEnrichmentResponse200OutputPageResultsItemOutputsType0PhoneNumbersItem
...
class PollBatchContactEnrichmentResponse200OutputPageResultsItemOutputsType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for emails_item_data in (_emails):
            emails_item = PollBatchContactEnrichmentResponse200OutputPageResultsItemOutputsType0EmailsItem.from_dict(emails_item_data)
        ...
        for phone_numbers_item_data in (_phone_numbers):
            phone_numbers_item = PollBatchContactEnrichmentResponse200OutputPageResultsItemOutputsType0PhoneNumbersItem.from_dict(phone_numbers_item_data)
