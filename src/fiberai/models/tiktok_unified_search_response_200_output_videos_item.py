...
T = TypeVar("T", bound="TiktokUnifiedSearchResponse200OutputVideosItem")


@_attrs_define
class TiktokUnifiedSearchResponse200OutputVideosItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        tiktok_unified_search_response_200_output_videos_item = cls(
            id=id,
            caption=caption,
        ...
        tiktok_unified_search_response_200_output_videos_item.additional_properties = d
        return tiktok_unified_search_response_200_output_videos_item
