...
T = TypeVar("T", bound="PollCombinedSearchResponse200OutputDataType1ItemsItemDetailedWorkExperiencesType0ItemCompanyDetailsType0")



@_attrs_define
class PollCombinedSearchResponse200OutputDataType1ItemsItemDetailedWorkExperiencesType0ItemCompanyDetailsType0:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        poll_combined_search_response_200_output_data_type_1_items_item_detailed_work_experiences_type_0_item_company_details_type_0 = cls(
        ...
        poll_combined_search_response_200_output_data_type_1_items_item_detailed_work_experiences_type_0_item_company_details_type_0.additional_properties = d
        return poll_combined_search_response_200_output_data_type_1_items_item_detailed_work_experiences_type_0_item_company_details_type_0
