...
T = TypeVar(
    "T",
    bound="CreateSavedSearchBodySearchParamsType2ProfileSearchParamsKeywordsV2Type0OptionsType0FieldsToSearchOverType0",
)


@_attrs_define
class CreateSavedSearchBodySearchParamsType2ProfileSearchParamsKeywordsV2Type0OptionsType0FieldsToSearchOverType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_saved_search_body_search_params_type_2_profile_search_params_keywords_v2_type_0_options_type_0_fields_to_search_over_type_0 = cls(
            summary=summary,
            headline=headline,
        ...
        create_saved_search_body_search_params_type_2_profile_search_params_keywords_v2_type_0_options_type_0_fields_to_search_over_type_0.additional_properties = d
        return create_saved_search_body_search_params_type_2_profile_search_params_keywords_v2_type_0_options_type_0_fields_to_search_over_type_0
