...
T = TypeVar("T", bound="PeopleSearchBodySearchParamsCurrentJobsType0")
...
class PeopleSearchBodySearchParamsCurrentJobsType0:
    ...
    Attributes:
        ...
        none_of (list[PeopleSearchBodySearchParamsCurrentJobsType0NoneOfType0Item] | None | Unset):
    """

    any_of: list[PeopleSearchBodySearchParamsCurrentJobsType0AnyOfType0Item] | None | Unset = UNSET
    all_of: list[PeopleSearchBodySearchParamsCurrentJobsType0AllOfType0Item] | None | Unset = UNSET
    none_of: list[PeopleSearchBodySearchParamsCurrentJobsType0NoneOfType0Item] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_any_of(
            data: object,
        ) -> list[PeopleSearchBodySearchParamsCurrentJobsType0AnyOfType0Item] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for any_of_type_0_item_data in _any_of_type_0:
                    any_of_type_0_item = PeopleSearchBodySearchParamsCurrentJobsType0AnyOfType0Item.from_dict(
                ...
                pass
            return cast(list[PeopleSearchBodySearchParamsCurrentJobsType0AnyOfType0Item] | None | Unset, data)

        any_of = _parse_any_of(d.pop("anyOf", UNSET))

        def _parse_all_of(
            data: object,
        ) -> list[PeopleSearchBodySearchParamsCurrentJobsType0AllOfType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for all_of_type_0_item_data in _all_of_type_0:
                    all_of_type_0_item = PeopleSearchBodySearchParamsCurrentJobsType0AllOfType0Item.from_dict(
                ...
                pass
            return cast(list[PeopleSearchBodySearchParamsCurrentJobsType0AllOfType0Item] | None | Unset, data)

        all_of = _parse_all_of(d.pop("allOf", UNSET))

        def _parse_none_of(
            data: object,
        ) -> list[PeopleSearchBodySearchParamsCurrentJobsType0NoneOfType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for none_of_type_0_item_data in _none_of_type_0:
                    none_of_type_0_item = PeopleSearchBodySearchParamsCurrentJobsType0NoneOfType0Item.from_dict(
                ...
                pass
            return cast(list[PeopleSearchBodySearchParamsCurrentJobsType0NoneOfType0Item] | None | Unset, data)

        none_of = _parse_none_of(d.pop("noneOf", UNSET))

        people_search_body_search_params_current_jobs_type_0 = cls(
            any_of=any_of,
            all_of=all_of,
            none_of=none_of,
        )

        people_search_body_search_params_current_jobs_type_0.additional_properties = d
        return people_search_body_search_params_current_jobs_type_0
