...
class GetTimeZonesResponse200OutputItem:
    """ 
        Attributes:
            ...
            continent_code (Union[None, Unset, str]): Continent code (e.g., 'NA' for North America)
            continent_name (Union[None, Unset, str]): Continent name (e.g., 'North America')
            country_name (Union[None, Unset, str]): Country name (e.g., 'United States')
            country_code_alpha_2 (Union[None, Unset, str]): ISO country code (e.g., 'US'). This is a 2 letter code.
     """
    ...
    continent_code: Union[None, Unset, str] = UNSET
    continent_name: Union[None, Unset, str] = UNSET
    country_name: Union[None, Unset, str] = UNSET
    country_code_alpha_2: Union[None, Unset, str] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        continent_code: Union[None, Unset, str]
        if isinstance(self.continent_code, Unset):
            continent_code = UNSET
        else:
            continent_code = self.continent_code

        continent_name: Union[None, Unset, str]
        ...
        country_code_alpha_2: Union[None, Unset, str]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_continent_code(data: object) -> Union[None, Unset, str]:
            if data is None:
                return data
        ...
        def _parse_continent_name(data: object) -> Union[None, Unset, str]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_country_code_alpha_2(data: object) -> Union[None, Unset, str]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
