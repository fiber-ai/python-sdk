...
T = TypeVar("T", bound="CombinedSearchBodyCompanyParamsHeadquartersStateNameType0")


@_attrs_define
class CombinedSearchBodyCompanyParamsHeadquartersStateNameType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        combined_search_body_company_params_headquarters_state_name_type_0 = cls(
            any_of=any_of,
            none_of=none_of,
        )

        combined_search_body_company_params_headquarters_state_name_type_0.additional_properties = d
        return combined_search_body_company_params_headquarters_state_name_type_0
