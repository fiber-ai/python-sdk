...
if TYPE_CHECKING:
    from ..models.sync_combined_search_response_200_output_companies_item_investment_stats_type_0_investments_by_stage_type_0_item import (
        SyncCombinedSearchResponse200OutputCompaniesItemInvestmentStatsType0InvestmentsByStageType0Item,
    )
...
class SyncCombinedSearchResponse200OutputCompaniesItemInvestmentStatsType0:
    ...
    Attributes:
        investments_by_stage
            (list[SyncCombinedSearchResponse200OutputCompaniesItemInvestmentStatsType0InvestmentsByStageType0Item] | None |
            Unset):
        ...
        def _parse_investments_by_stage(
            ...
            try:
                ...
                for investments_by_stage_type_0_item_data in _investments_by_stage_type_0:
                    investments_by_stage_type_0_item = SyncCombinedSearchResponse200OutputCompaniesItemInvestmentStatsType0InvestmentsByStageType0Item.from_dict(
