...
T = TypeVar("T", bound="TextToCompanySearchResponse200OutputDataItemFundingRoundStatsType0IndividualInvestorStatsType0Item")



@_attrs_define
class TextToCompanySearchResponse200OutputDataItemFundingRoundStatsType0IndividualInvestorStatsType0Item:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        text_to_company_search_response_200_output_data_item_funding_round_stats_type_0_individual_investor_stats_type_0_item = cls(
        ...
        text_to_company_search_response_200_output_data_item_funding_round_stats_type_0_individual_investor_stats_type_0_item.additional_properties = d
        return text_to_company_search_response_200_output_data_item_funding_round_stats_type_0_individual_investor_stats_type_0_item
