...
class GetTrackerOverviewResponse200OutputCompanyListsItem:
    ...
    id: str
    name: str
    entity_type: GetTrackerOverviewResponse200OutputCompanyListsItemEntityType
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entity_type = GetTrackerOverviewResponse200OutputCompanyListsItemEntityType(d.pop("entityType"))
        ...
        return get_tracker_overview_response_200_output_company_lists_item
