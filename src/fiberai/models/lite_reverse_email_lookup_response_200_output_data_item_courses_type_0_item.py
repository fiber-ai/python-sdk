...
T = TypeVar("T", bound="LiteReverseEmailLookupResponse200OutputDataItemCoursesType0Item")


@_attrs_define
class LiteReverseEmailLookupResponse200OutputDataItemCoursesType0Item:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        lite_reverse_email_lookup_response_200_output_data_item_courses_type_0_item = cls(
            title=title,
            course_number=course_number,
            association=association,
        )

        lite_reverse_email_lookup_response_200_output_data_item_courses_type_0_item.additional_properties = d
        return lite_reverse_email_lookup_response_200_output_data_item_courses_type_0_item
