...
from ..models.get_saved_search_run_companies_response_200_output_companies_item_company_li_category_type_1 import (
    GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyLiCategoryType1,
)
from ..models.get_saved_search_run_companies_response_200_output_companies_item_company_li_category_type_2_type_1 import (
    GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyLiCategoryType2Type1,
)
from ..models.get_saved_search_run_companies_response_200_output_companies_item_company_li_category_type_3_type_1 import (
    GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyLiCategoryType3Type1,
)
from ..models.get_saved_search_run_companies_response_200_output_companies_item_company_standard_industries_type_0_item import (
    GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyStandardIndustriesType0Item,
)
from ..models.get_saved_search_run_companies_response_200_output_companies_item_company_tags_type_0_item import (
    GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyTagsType0Item,
)
...
class GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompany:
    ...
    Attributes:
        ...
        accelerators (list[GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyAcceleratorsType0Item] | None
            | Unset):
        blog_urls (list[str] | None | Unset):
        custom_data (GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyCustomDataType0 | None | Unset):
        domains (list[str] | None | Unset):
        emails (list[str] | None | Unset):
        phone_numbers (list[str] | None | Unset):
        employee_count_consensus
            (GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyEmployeeCountConsensusType0 | None | Unset):
        facebook_urls (list[str] | None | Unset):
        fortune_rankings (list[GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyFortuneRankingsType0Item]
            | None | Unset):
        ...
        li_category (GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyLiCategoryType1 |
            GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyLiCategoryType2Type1 |
            GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyLiCategoryType3Type1 | None | Unset):
        li_job_posts_stats (GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyLiJobPostsStatsType0 | None |
            Unset):
        li_description (None | str | Unset):
        li_follower_count (float | None | Unset):
        li_headline (None | str | Unset):
        li_industries (list[GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyLiIndustriesType0Item] | None
            | Unset):
        li_locations (list[GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyLiLocationsType0Item] | None |
            Unset):
        li_specialties (list[str] | None | Unset):
        location_consensus (GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyLocationConsensusType0 | None
            | Unset):
        locations_stats (GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyLocationsStatsType0 | None |
            Unset):
        ...
        stock_info_consensus (GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyStockInfoConsensusType0 |
            None | Unset):
        tags (list[GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyTagsType0Item] | None | Unset):
        ...
        role_count_matches
            (list[GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyRoleCountMatchesType0Item] | None | Unset):
        num_matching_locations (GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyNumMatchingLocationsType0
            | None | Unset):
        ...
        historical_headcount (GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyHistoricalHeadcountType0 |
            None | Unset):
        ...
        funding_rounds (list[GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyFundingRoundsType0Item] |
            None | Unset):
        num_exits (float | None | Unset):
        investors (list[GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyInvestorsType0Item] | None |
            Unset):
        acquisitions (list[GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyAcquisitionsType0Item] | None
            | Unset):
        best_funding_round (GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyBestFundingRoundType0 | None
            | Unset):
        ...
        employee_trends (list[GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyEmployeeTrendsType0Item] |
            None | Unset):
        logo_url (None | str | Unset):
        similar_companies
            (list[GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanySimilarCompaniesType0Item] | None | Unset):
        full_funding_rounds
            (list[GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyFullFundingRoundsType0Item] | None |
            Unset):
        funding_round_stats (GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyFundingRoundStatsType0 |
            None | Unset):
        investment_stats (GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyInvestmentStatsType0 | None |
            Unset):
        is_investor (bool | None | Unset):
        investor_type (None | str | Unset):
        investor_categories (list[str] | None | Unset):
        technologies_used
            (list[GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyTechnologiesUsedType0Item] | None | Unset):
        platforms (GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyPlatformsType0 | None | Unset):
    """

    linkedin_id: None | str | Unset = UNSET
    accelerator_statuses: list[str] | None | Unset = UNSET
    accelerators: (
        list[GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyAcceleratorsType0Item] | None | Unset
    ) = UNSET
    blog_urls: list[str] | None | Unset = UNSET
    custom_data: GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyCustomDataType0 | None | Unset = UNSET
    ...
    fortune_rankings: (
        list[GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyFortuneRankingsType0Item] | None | Unset
    ) = UNSET
    ...
    li_job_posts_stats: (
        GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyLiJobPostsStatsType0 | None | Unset
    ) = UNSET
    li_description: None | str | Unset = UNSET
    li_follower_count: float | None | Unset = UNSET
    li_headline: None | str | Unset = UNSET
    li_industries: (
        list[GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyLiIndustriesType0Item] | None | Unset
    ) = UNSET
    li_locations: (
        list[GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyLiLocationsType0Item] | None | Unset
    ) = UNSET
    li_specialties: list[str] | None | Unset = UNSET
    location_consensus: (
        GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyLocationConsensusType0 | None | Unset
    ) = UNSET
    locations_stats: (
        GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyLocationsStatsType0 | None | Unset
    ) = UNSET
    ...
    stock_info_consensus: (
        GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyStockInfoConsensusType0 | None | Unset
    ) = UNSET
    tags: list[GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyTagsType0Item] | None | Unset = UNSET
    ...
    num_matching_locations: (
        GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyNumMatchingLocationsType0 | None | Unset
    ) = UNSET
    ...
    historical_headcount: (
        GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyHistoricalHeadcountType0 | None | Unset
    ) = UNSET
    ...
    funding_rounds: (
        list[GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyFundingRoundsType0Item] | None | Unset
    ) = UNSET
    num_exits: float | None | Unset = UNSET
    investors: (
        list[GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyInvestorsType0Item] | None | Unset
    ) = UNSET
    acquisitions: (
        list[GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyAcquisitionsType0Item] | None | Unset
    ) = UNSET
    best_funding_round: (
        GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyBestFundingRoundType0 | None | Unset
    ) = UNSET
    ...
    employee_trends: (
        list[GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyEmployeeTrendsType0Item] | None | Unset
    ) = UNSET
    ...
    full_funding_rounds: (
        list[GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyFullFundingRoundsType0Item] | None | Unset
    ) = UNSET
    funding_round_stats: (
        GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyFundingRoundStatsType0 | None | Unset
    ) = UNSET
    investment_stats: (
        GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyInvestmentStatsType0 | None | Unset
    ) = UNSET
    ...
    platforms: GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyPlatformsType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.custom_data, Unset):
            ...
            self.custom_data, GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyCustomDataType0
        ):
        ...
        if isinstance(self.li_category, Unset):
            ...
            self.li_category, GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyLiCategoryType1
        ):
            li_category = self.li_category.value
        elif isinstance(
            self.li_category, GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyLiCategoryType2Type1
        ):
            li_category = self.li_category.value
        elif isinstance(
            self.li_category, GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyLiCategoryType3Type1
        ):
            li_category = self.li_category.value
        else:
        ...
        if isinstance(self.li_job_posts_stats, Unset):
            ...
            self.li_job_posts_stats, GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyLiJobPostsStatsType0
        ):
        ...
        if isinstance(self.locations_stats, Unset):
            ...
            self.locations_stats, GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyLocationsStatsType0
        ):
        ...
        if isinstance(self.investment_stats, Unset):
            ...
            self.investment_stats, GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyInvestmentStatsType0
        ):
        ...
        if isinstance(self.platforms, Unset):
            platforms = UNSET
        elif isinstance(self.platforms, GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyPlatformsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
            ...
            try:
                ...
                for accelerators_type_0_item_data in _accelerators_type_0:
                    accelerators_type_0_item = (
                        GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyAcceleratorsType0Item.from_dict(
        ...
        def _parse_custom_data(
            data: object,
        ) -> GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyCustomDataType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                custom_data_type_0 = (
                    GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyCustomDataType0.from_dict(data)
                )
                ...
                pass
            return cast(
                GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyCustomDataType0 | None | Unset, data
            )
        ...
        def _parse_employee_count_consensus(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                employee_count_consensus_type_0 = GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyEmployeeCountConsensusType0.from_dict(
                    data
                )
        ...
        def _parse_fortune_rankings(
            ...
            try:
                ...
                for fortune_rankings_type_0_item_data in _fortune_rankings_type_0:
                    fortune_rankings_type_0_item = GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyFortuneRankingsType0Item.from_dict(
        ...
        def _parse_li_category(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                li_category_type_1 = GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyLiCategoryType1(
                    data
                )
            ...
            try:
                ...
                li_category_type_2_type_1 = (
                    GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyLiCategoryType2Type1(data)
                )
            ...
            try:
                ...
                li_category_type_3_type_1 = (
                    GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyLiCategoryType3Type1(data)
                )
        ...
        def _parse_li_job_posts_stats(
            ...
            try:
                ...
                li_job_posts_stats_type_0 = (
                    GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyLiJobPostsStatsType0.from_dict(data)
                )
                ...
                pass
            return cast(
                GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyLiJobPostsStatsType0 | None | Unset, data
            )
            ...
            try:
                ...
                for li_industries_type_0_item_data in _li_industries_type_0:
                    li_industries_type_0_item = (
                        GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyLiIndustriesType0Item.from_dict(
            ...
            try:
                ...
                for li_locations_type_0_item_data in _li_locations_type_0:
                    li_locations_type_0_item = (
                        GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyLiLocationsType0Item.from_dict(
        ...
        def _parse_location_consensus(
            ...
            try:
                ...
                location_consensus_type_0 = (
                    GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyLocationConsensusType0.from_dict(
                        data
                    )
                )
        ...
        def _parse_locations_stats(
            ...
            try:
                ...
                locations_stats_type_0 = (
                    GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyLocationsStatsType0.from_dict(data)
                )
                ...
                pass
            return cast(
                GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyLocationsStatsType0 | None | Unset, data
            )
        ...
        def _parse_stock_info_consensus(
            ...
            try:
                ...
                stock_info_consensus_type_0 = (
                    GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyStockInfoConsensusType0.from_dict(
                        data
                    )
                )
        ...
        def _parse_tags(
            data: object,
        ) -> list[GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyTagsType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for tags_type_0_item_data in _tags_type_0:
                    tags_type_0_item = GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyTagsType0Item(
                ...
                pass
            return cast(
                list[GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyTagsType0Item] | None | Unset, data
            )
        ...
        def _parse_role_count_matches(
            ...
            try:
                ...
                for role_count_matches_type_0_item_data in _role_count_matches_type_0:
                    role_count_matches_type_0_item = GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyRoleCountMatchesType0Item.from_dict(
        ...
        def _parse_num_matching_locations(
            ...
            try:
                ...
                num_matching_locations_type_0 = (
                    GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyNumMatchingLocationsType0.from_dict(
                        data
                    )
                )
        ...
        def _parse_historical_headcount(
            ...
            try:
                ...
                historical_headcount_type_0 = (
                    GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyHistoricalHeadcountType0.from_dict(
                        data
                    )
                )
            ...
            try:
                ...
                for funding_rounds_type_0_item_data in _funding_rounds_type_0:
                    funding_rounds_type_0_item = (
                        GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyFundingRoundsType0Item.from_dict(
            ...
            try:
                ...
                for investors_type_0_item_data in _investors_type_0:
                    investors_type_0_item = (
                        GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyInvestorsType0Item.from_dict(
            ...
            try:
                ...
                for acquisitions_type_0_item_data in _acquisitions_type_0:
                    acquisitions_type_0_item = (
                        GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyAcquisitionsType0Item.from_dict(
        ...
        def _parse_best_funding_round(
            ...
            try:
                ...
                best_funding_round_type_0 = (
                    GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyBestFundingRoundType0.from_dict(data)
                )
        ...
        def _parse_employee_trends(
            ...
            try:
                ...
                for employee_trends_type_0_item_data in _employee_trends_type_0:
                    employee_trends_type_0_item = GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyEmployeeTrendsType0Item.from_dict(
        ...
        def _parse_similar_companies(
            ...
            try:
                ...
                for similar_companies_type_0_item_data in _similar_companies_type_0:
                    similar_companies_type_0_item = GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanySimilarCompaniesType0Item.from_dict(
        ...
        def _parse_full_funding_rounds(
            ...
            try:
                ...
                for full_funding_rounds_type_0_item_data in _full_funding_rounds_type_0:
                    full_funding_rounds_type_0_item = GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyFullFundingRoundsType0Item.from_dict(
        ...
        def _parse_funding_round_stats(
            ...
            try:
                ...
                funding_round_stats_type_0 = (
                    GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyFundingRoundStatsType0.from_dict(
                        data
                    )
                )
        ...
        def _parse_investment_stats(
            ...
            try:
                ...
                investment_stats_type_0 = (
                    GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyInvestmentStatsType0.from_dict(data)
                )
                ...
                pass
            return cast(
                GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyInvestmentStatsType0 | None | Unset, data
            )
        ...
        def _parse_technologies_used(
            ...
            list[GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyTechnologiesUsedType0Item]
            | None
            | Unset
        ):
            if data is None:
            ...
            try:
                ...
                for technologies_used_type_0_item_data in _technologies_used_type_0:
                    technologies_used_type_0_item = GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyTechnologiesUsedType0Item.from_dict(
        ...
        def _parse_platforms(
            data: object,
        ) -> GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyPlatformsType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                platforms_type_0 = (
                    GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyPlatformsType0.from_dict(data)
                )
                ...
                pass
            return cast(
                GetSavedSearchRunCompaniesResponse200OutputCompaniesItemCompanyPlatformsType0 | None | Unset, data
            )
