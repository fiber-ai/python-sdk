...
if TYPE_CHECKING:
    from ..models.sync_combined_search_body_company_params_headquarters_location_type_0_subtract_all_type_0_item_type_0 import (
        SyncCombinedSearchBodyCompanyParamsHeadquartersLocationType0SubtractAllType0ItemType0,
    )
    from ..models.sync_combined_search_body_company_params_headquarters_location_type_0_union_all_type_0_item_type_0 import (
        SyncCombinedSearchBodyCompanyParamsHeadquartersLocationType0UnionAllType0ItemType0,
    )
...
class SyncCombinedSearchBodyCompanyParamsHeadquartersLocationType0:
    """
    Attributes:
        union_all (list[SyncCombinedSearchBodyCompanyParamsHeadquartersLocationType0UnionAllType0ItemType0] | None |
            Unset):
        subtract_all (list[SyncCombinedSearchBodyCompanyParamsHeadquartersLocationType0SubtractAllType0ItemType0] | None
            | Unset):
    """

    union_all: (
        list[SyncCombinedSearchBodyCompanyParamsHeadquartersLocationType0UnionAllType0ItemType0] | None | Unset
    ) = UNSET
    subtract_all: (
        list[SyncCombinedSearchBodyCompanyParamsHeadquartersLocationType0SubtractAllType0ItemType0] | None | Unset
    ) = UNSET
                ...
                for union_all_type_0_item_data in _union_all_type_0:
                    ...
                    def _parse_union_all_type_0_item(
                        ...
                        if not isinstance(data, dict):
                            raise TypeError()
                        union_all_type_0_item_type_0 = SyncCombinedSearchBodyCompanyParamsHeadquartersLocationType0UnionAllType0ItemType0.from_dict(
                            data
                        )
            ...
            try:
                ...
                for subtract_all_type_0_item_data in _subtract_all_type_0:
                    ...
                    def _parse_subtract_all_type_0_item(
                        ...
                        if not isinstance(data, dict):
                            raise TypeError()
                        subtract_all_type_0_item_type_0 = SyncCombinedSearchBodyCompanyParamsHeadquartersLocationType0SubtractAllType0ItemType0.from_dict(
                            data
                        )
