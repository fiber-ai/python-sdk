...
T = TypeVar("T", bound="GetSavedSearchRunProfilesResponse200OutputProfilesItemProfileDetailedEducationType0ItemSchoolDetailsType0")



@_attrs_define
class GetSavedSearchRunProfilesResponse200OutputProfilesItemProfileDetailedEducationType0ItemSchoolDetailsType0:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_saved_search_run_profiles_response_200_output_profiles_item_profile_detailed_education_type_0_item_school_details_type_0 = cls(
        ...
        get_saved_search_run_profiles_response_200_output_profiles_item_profile_detailed_education_type_0_item_school_details_type_0.additional_properties = d
        return get_saved_search_run_profiles_response_200_output_profiles_item_profile_detailed_education_type_0_item_school_details_type_0
