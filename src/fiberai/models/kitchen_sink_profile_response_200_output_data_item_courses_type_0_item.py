...
T = TypeVar("T", bound="KitchenSinkProfileResponse200OutputDataItemCoursesType0Item")



@_attrs_define
class KitchenSinkProfileResponse200OutputDataItemCoursesType0Item:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        kitchen_sink_profile_response_200_output_data_item_courses_type_0_item = cls(
            title=title,
        ...
        kitchen_sink_profile_response_200_output_data_item_courses_type_0_item.additional_properties = d
        return kitchen_sink_profile_response_200_output_data_item_courses_type_0_item
