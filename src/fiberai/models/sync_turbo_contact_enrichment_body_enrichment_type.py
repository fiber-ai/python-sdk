...
T = TypeVar("T", bound="SyncTurboContactEnrichmentBodyEnrichmentType")
...
class SyncTurboContactEnrichmentBodyEnrichmentType:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sync_turbo_contact_enrichment_body_enrichment_type = cls(
            get_work_emails=get_work_emails,
            get_personal_emails=get_personal_emails,
            get_phone_numbers=get_phone_numbers,
        )

        sync_turbo_contact_enrichment_body_enrichment_type.additional_properties = d
        return sync_turbo_contact_enrichment_body_enrichment_type
