...
T = TypeVar("T", bound="AddTrackerCompaniesBodyInitialSignalsType0")


@_attrs_define
class AddTrackerCompaniesBodyInitialSignalsType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        add_tracker_companies_body_initial_signals_type_0 = cls(
            lookback_period_days=lookback_period_days,
        )

        add_tracker_companies_body_initial_signals_type_0.additional_properties = d
        return add_tracker_companies_body_initial_signals_type_0
