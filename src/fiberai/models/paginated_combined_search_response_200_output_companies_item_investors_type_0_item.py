...
T = TypeVar("T", bound="PaginatedCombinedSearchResponse200OutputCompaniesItemInvestorsType0Item")


@_attrs_define
class PaginatedCombinedSearchResponse200OutputCompaniesItemInvestorsType0Item:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        paginated_combined_search_response_200_output_companies_item_investors_type_0_item = cls(
            logo_url=logo_url,
        ...
        paginated_combined_search_response_200_output_companies_item_investors_type_0_item.additional_properties = d
        return paginated_combined_search_response_200_output_companies_item_investors_type_0_item
