...
T = TypeVar("T", bound="ListWebhookEndpointsResponse200OutputEndpointsItem")


@_attrs_define
class ListWebhookEndpointsResponse200OutputEndpointsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_webhook_endpoints_response_200_output_endpoints_item = cls(
        ...
        list_webhook_endpoints_response_200_output_endpoints_item.additional_properties = d
        return list_webhook_endpoints_response_200_output_endpoints_item
