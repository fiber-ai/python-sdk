...
T = TypeVar("T", bound="RefreshTrackerCompanyListResponse200")


@_attrs_define
class RefreshTrackerCompanyListResponse200:
    """
    Attributes:
        output (RefreshTrackerCompanyListResponse200Output):
        charge_info (RefreshTrackerCompanyListResponse200ChargeInfoType0 |
            RefreshTrackerCompanyListResponse200ChargeInfoType1 | RefreshTrackerCompanyListResponse200ChargeInfoType2 |
            RefreshTrackerCompanyListResponse200ChargeInfoType3 | RefreshTrackerCompanyListResponse200ChargeInfoType4):
        warnings (list[RefreshTrackerCompanyListResponse200WarningsType0Item] | None | Unset): Warnings about extraneous
            fields in request
    ...
    warnings: list[RefreshTrackerCompanyListResponse200WarningsType0Item] | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.charge_info, RefreshTrackerCompanyListResponse200ChargeInfoType0):
            charge_info = self.charge_info.to_dict()
        elif isinstance(self.charge_info, RefreshTrackerCompanyListResponse200ChargeInfoType1):
            charge_info = self.charge_info.to_dict()
        elif isinstance(self.charge_info, RefreshTrackerCompanyListResponse200ChargeInfoType2):
            charge_info = self.charge_info.to_dict()
        elif isinstance(self.charge_info, RefreshTrackerCompanyListResponse200ChargeInfoType3):
            charge_info = self.charge_info.to_dict()
        else:
            charge_info = self.charge_info.to_dict()
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        output = RefreshTrackerCompanyListResponse200Output.from_dict(d.pop("output"))
        ...
        def _parse_charge_info(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_0 = RefreshTrackerCompanyListResponse200ChargeInfoType0.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_1 = RefreshTrackerCompanyListResponse200ChargeInfoType1.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_2 = RefreshTrackerCompanyListResponse200ChargeInfoType2.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_3 = RefreshTrackerCompanyListResponse200ChargeInfoType3.from_dict(data)
            ...
            if not isinstance(data, dict):
                raise TypeError()
            charge_info_type_4 = RefreshTrackerCompanyListResponse200ChargeInfoType4.from_dict(data)

            return charge_info_type_4

        charge_info = _parse_charge_info(d.pop("chargeInfo"))

        def _parse_warnings(data: object) -> list[RefreshTrackerCompanyListResponse200WarningsType0Item] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for warnings_type_0_item_data in _warnings_type_0:
                    warnings_type_0_item = RefreshTrackerCompanyListResponse200WarningsType0Item.from_dict(
                ...
                pass
            return cast(list[RefreshTrackerCompanyListResponse200WarningsType0Item] | None | Unset, data)
        ...
        refresh_tracker_company_list_response_200 = cls(
            output=output,
        ...
        return refresh_tracker_company_list_response_200
