...
T = TypeVar("T", bound="TiktokUserFollowingResponse200OutputUsersItem")


@_attrs_define
class TiktokUserFollowingResponse200OutputUsersItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        tiktok_user_following_response_200_output_users_item = cls(
            id=id,
            handle=handle,
        ...
        tiktok_user_following_response_200_output_users_item.additional_properties = d
        return tiktok_user_following_response_200_output_users_item
