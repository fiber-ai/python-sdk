...
T = TypeVar("T", bound="GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemHistoricalHeadcountType0Growth")


@_attrs_define
class GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemHistoricalHeadcountType0Growth:
    """
    Attributes:
        field_1m (GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemHistoricalHeadcountType0Growth1MType0 |
            None | Unset):
        field_2m (GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemHistoricalHeadcountType0Growth2MType0 |
            None | Unset):
        field_3m (GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemHistoricalHeadcountType0Growth3MType0 |
            None | Unset):
        field_6m (GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemHistoricalHeadcountType0Growth6MType0 |
            None | Unset):
        field_12m (GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemHistoricalHeadcountType0Growth12MType0
            | None | Unset):
        field_18m (GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemHistoricalHeadcountType0Growth18MType0
            | None | Unset):
        field_24m (GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemHistoricalHeadcountType0Growth24MType0
            | None | Unset):
        field_36m (GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemHistoricalHeadcountType0Growth36MType0
            | None | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_field_1m(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                field_1m_type_0 = GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemHistoricalHeadcountType0Growth1MType0.from_dict(
                    data
                )
        ...
        def _parse_field_2m(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                field_2m_type_0 = GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemHistoricalHeadcountType0Growth2MType0.from_dict(
                    data
                )
        ...
        def _parse_field_3m(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                field_3m_type_0 = GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemHistoricalHeadcountType0Growth3MType0.from_dict(
                    data
                )
        ...
        def _parse_field_6m(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                field_6m_type_0 = GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemHistoricalHeadcountType0Growth6MType0.from_dict(
                    data
                )
        ...
        def _parse_field_12m(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                field_12m_type_0 = GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemHistoricalHeadcountType0Growth12MType0.from_dict(
                    data
                )
        ...
        def _parse_field_18m(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                field_18m_type_0 = GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemHistoricalHeadcountType0Growth18MType0.from_dict(
                    data
                )
        ...
        def _parse_field_24m(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                field_24m_type_0 = GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemHistoricalHeadcountType0Growth24MType0.from_dict(
                    data
                )
        ...
        def _parse_field_36m(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                field_36m_type_0 = GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemHistoricalHeadcountType0Growth36MType0.from_dict(
                    data
                )
        ...
        get_current_companies_in_saved_search_response_200_output_companies_item_historical_headcount_type_0_growth = (
            cls(
                field_1m=field_1m,
                field_2m=field_2m,
                field_3m=field_3m,
        ...
        get_current_companies_in_saved_search_response_200_output_companies_item_historical_headcount_type_0_growth.additional_properties = d
        return (
            get_current_companies_in_saved_search_response_200_output_companies_item_historical_headcount_type_0_growth
        )
