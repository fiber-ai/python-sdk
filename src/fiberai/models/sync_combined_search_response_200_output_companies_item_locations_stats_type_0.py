...
T = TypeVar("T", bound="SyncCombinedSearchResponse200OutputCompaniesItemLocationsStatsType0")


@_attrs_define
class SyncCombinedSearchResponse200OutputCompaniesItemLocationsStatsType0:
    """
    Attributes:
        usa (float | Unset):
        gbr (float | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sync_combined_search_response_200_output_companies_item_locations_stats_type_0 = cls(
            usa=usa,
            gbr=gbr,
            fra=fra,
            ind=ind,
        ...
        return sync_combined_search_response_200_output_companies_item_locations_stats_type_0
