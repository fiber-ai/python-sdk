...
if TYPE_CHECKING:
  from ..models.text_to_combined_search_response_200_output_data_profiles_item_tenures_type_0_item_date_range import TextToCombinedSearchResponse200OutputDataProfilesItemTenuresType0ItemDateRange





T = TypeVar("T", bound="TextToCombinedSearchResponse200OutputDataProfilesItemTenuresType0Item")



@_attrs_define
class TextToCombinedSearchResponse200OutputDataProfilesItemTenuresType0Item:
    """ 
        Attributes:
            date_range (TextToCombinedSearchResponse200OutputDataProfilesItemTenuresType0ItemDateRange):
            titles (list[str]):
            localities (list[str]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.text_to_combined_search_response_200_output_data_profiles_item_tenures_type_0_item_date_range import TextToCombinedSearchResponse200OutputDataProfilesItemTenuresType0ItemDateRange
        d = dict(src_dict)
        date_range = TextToCombinedSearchResponse200OutputDataProfilesItemTenuresType0ItemDateRange.from_dict(d.pop("date_range"))
        ...
        text_to_combined_search_response_200_output_data_profiles_item_tenures_type_0_item = cls(
            date_range=date_range,
            titles=titles,
            localities=localities,
        ...
        text_to_combined_search_response_200_output_data_profiles_item_tenures_type_0_item.additional_properties = d
        return text_to_combined_search_response_200_output_data_profiles_item_tenures_type_0_item
