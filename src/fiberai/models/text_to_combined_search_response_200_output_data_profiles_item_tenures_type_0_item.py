...
if TYPE_CHECKING:
    from ..models.text_to_combined_search_response_200_output_data_profiles_item_tenures_type_0_item_date_range import (
        TextToCombinedSearchResponse200OutputDataProfilesItemTenuresType0ItemDateRange,
    )
...
class TextToCombinedSearchResponse200OutputDataProfilesItemTenuresType0Item:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        date_range = TextToCombinedSearchResponse200OutputDataProfilesItemTenuresType0ItemDateRange.from_dict(
            d.pop("date_range")
        )
