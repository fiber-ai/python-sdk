...
T = TypeVar("T", bound="PeopleSearchCountBodySearchParamsEducationType0AllOfType0ItemDegreeV2Type0Criteria")


@_attrs_define
class PeopleSearchCountBodySearchParamsEducationType0AllOfType0ItemDegreeV2Type0Criteria:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        people_search_count_body_search_params_education_type_0_all_of_type_0_item_degree_v2_type_0_criteria = cls(
            any_of=any_of,
            none_of=none_of,
        )

        people_search_count_body_search_params_education_type_0_all_of_type_0_item_degree_v2_type_0_criteria.additional_properties = d
        return people_search_count_body_search_params_education_type_0_all_of_type_0_item_degree_v2_type_0_criteria
