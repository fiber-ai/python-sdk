...
T = TypeVar("T", bound="CreateSavedSearchBodySearchParamsType2ProfileSearchParamsEducationType0AnyOfType0ItemSchoolType0NoneOfType0Item")



@_attrs_define
class CreateSavedSearchBodySearchParamsType2ProfileSearchParamsEducationType0AnyOfType0ItemSchoolType0NoneOfType0Item:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_saved_search_body_search_params_type_2_profile_search_params_education_type_0_any_of_type_0_item_school_type_0_none_of_type_0_item = cls(
        ...
        create_saved_search_body_search_params_type_2_profile_search_params_education_type_0_any_of_type_0_item_school_type_0_none_of_type_0_item.additional_properties = d
        return create_saved_search_body_search_params_type_2_profile_search_params_education_type_0_any_of_type_0_item_school_type_0_none_of_type_0_item
