...
T = TypeVar("T", bound="PeopleSearchBodySearchParamsEducationType0AllOfType0ItemSchoolType0NoneOfType0Item")


@_attrs_define
class PeopleSearchBodySearchParamsEducationType0AllOfType0ItemSchoolType0NoneOfType0Item:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        people_search_body_search_params_education_type_0_all_of_type_0_item_school_type_0_none_of_type_0_item = cls(
            linkedin_id=linkedin_id,
            linkedin_url=linkedin_url,
            domain=domain,
        )

        people_search_body_search_params_education_type_0_all_of_type_0_item_school_type_0_none_of_type_0_item.additional_properties = d
        return people_search_body_search_params_education_type_0_all_of_type_0_item_school_type_0_none_of_type_0_item
