...
T = TypeVar("T", bound="CombinedSearchCountBodyProfileParamsYearsOfExperienceType0")


@_attrs_define
class CombinedSearchCountBodyProfileParamsYearsOfExperienceType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        combined_search_count_body_profile_params_years_of_experience_type_0 = cls(
            lower_bound=lower_bound,
            upper_bound=upper_bound,
        )

        combined_search_count_body_profile_params_years_of_experience_type_0.additional_properties = d
        return combined_search_count_body_profile_params_years_of_experience_type_0
