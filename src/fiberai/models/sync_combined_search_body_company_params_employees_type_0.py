...
from ..models.sync_combined_search_body_company_params_employees_type_0_joiner import (
    SyncCombinedSearchBodyCompanyParamsEmployeesType0Joiner,
)

if TYPE_CHECKING:
    from ..models.sync_combined_search_body_company_params_employees_type_0_rules_item import (
        SyncCombinedSearchBodyCompanyParamsEmployeesType0RulesItem,
    )
