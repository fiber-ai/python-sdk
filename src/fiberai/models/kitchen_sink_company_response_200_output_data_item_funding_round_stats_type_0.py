...
if TYPE_CHECKING:
    from ..models.kitchen_sink_company_response_200_output_data_item_funding_round_stats_type_0_individual_investor_stats_type_0_item import (
        KitchenSinkCompanyResponse200OutputDataItemFundingRoundStatsType0IndividualInvestorStatsType0Item,
    )
...
class KitchenSinkCompanyResponse200OutputDataItemFundingRoundStatsType0:
    ...
    Attributes:
        ...
        individual_investor_stats
            (list[KitchenSinkCompanyResponse200OutputDataItemFundingRoundStatsType0IndividualInvestorStatsType0Item] | None
            | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.kitchen_sink_company_response_200_output_data_item_funding_round_stats_type_0_individual_investor_stats_type_0_item import (
            KitchenSinkCompanyResponse200OutputDataItemFundingRoundStatsType0IndividualInvestorStatsType0Item,  # noqa: PLC0415
        )
        ...
        def _parse_individual_investor_stats(
            ...
            try:
                ...
                for individual_investor_stats_type_0_item_data in _individual_investor_stats_type_0:
                    individual_investor_stats_type_0_item = KitchenSinkCompanyResponse200OutputDataItemFundingRoundStatsType0IndividualInvestorStatsType0Item.from_dict(
