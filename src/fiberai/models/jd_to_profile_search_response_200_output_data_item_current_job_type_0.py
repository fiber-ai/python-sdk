...
from ..models.jd_to_profile_search_response_200_output_data_item_current_job_type_0_academic_qualification_type_0_item import (
    JdToProfileSearchResponse200OutputDataItemCurrentJobType0AcademicQualificationType0Item,
)
from ..models.jd_to_profile_search_response_200_output_data_item_current_job_type_0_employment_type_type_0_item import (
    JdToProfileSearchResponse200OutputDataItemCurrentJobType0EmploymentTypeType0Item,
)
from ..models.jd_to_profile_search_response_200_output_data_item_current_job_type_0_job_function_type_0_item import (
    JdToProfileSearchResponse200OutputDataItemCurrentJobType0JobFunctionType0Item,
)
from ..models.jd_to_profile_search_response_200_output_data_item_current_job_type_0_seniority_type_1 import (
    JdToProfileSearchResponse200OutputDataItemCurrentJobType0SeniorityType1,
)
from ..models.jd_to_profile_search_response_200_output_data_item_current_job_type_0_seniority_type_2_type_1 import (
    JdToProfileSearchResponse200OutputDataItemCurrentJobType0SeniorityType2Type1,
)
from ..models.jd_to_profile_search_response_200_output_data_item_current_job_type_0_seniority_type_3_type_1 import (
    JdToProfileSearchResponse200OutputDataItemCurrentJobType0SeniorityType3Type1,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="JdToProfileSearchResponse200OutputDataItemCurrentJobType0")


@_attrs_define
class JdToProfileSearchResponse200OutputDataItemCurrentJobType0:
    """
    Attributes:
        ...
        seniority (JdToProfileSearchResponse200OutputDataItemCurrentJobType0SeniorityType1 |
            JdToProfileSearchResponse200OutputDataItemCurrentJobType0SeniorityType2Type1 |
            JdToProfileSearchResponse200OutputDataItemCurrentJobType0SeniorityType3Type1 | None | Unset):
        job_function (list[JdToProfileSearchResponse200OutputDataItemCurrentJobType0JobFunctionType0Item] | None |
            Unset):
        employment_type (list[JdToProfileSearchResponse200OutputDataItemCurrentJobType0EmploymentTypeType0Item] | None |
            Unset):
        academic_qualification
            (list[JdToProfileSearchResponse200OutputDataItemCurrentJobType0AcademicQualificationType0Item] | None | Unset):
    ...
    job_function: list[JdToProfileSearchResponse200OutputDataItemCurrentJobType0JobFunctionType0Item] | None | Unset = (
        UNSET
    )
    employment_type: (
        list[JdToProfileSearchResponse200OutputDataItemCurrentJobType0EmploymentTypeType0Item] | None | Unset
    ) = UNSET
    academic_qualification: (
        list[JdToProfileSearchResponse200OutputDataItemCurrentJobType0AcademicQualificationType0Item] | None | Unset
    ) = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.seniority, Unset):
            seniority = UNSET
        elif isinstance(self.seniority, JdToProfileSearchResponse200OutputDataItemCurrentJobType0SeniorityType1):
            seniority = self.seniority.value
        elif isinstance(self.seniority, JdToProfileSearchResponse200OutputDataItemCurrentJobType0SeniorityType2Type1):
            seniority = self.seniority.value
        elif isinstance(self.seniority, JdToProfileSearchResponse200OutputDataItemCurrentJobType0SeniorityType3Type1):
            seniority = self.seniority.value
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_seniority(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                seniority_type_1 = JdToProfileSearchResponse200OutputDataItemCurrentJobType0SeniorityType1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                seniority_type_2_type_1 = JdToProfileSearchResponse200OutputDataItemCurrentJobType0SeniorityType2Type1(
                    data
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                seniority_type_3_type_1 = JdToProfileSearchResponse200OutputDataItemCurrentJobType0SeniorityType3Type1(
                    data
                )
        ...
        def _parse_job_function(
            data: object,
        ) -> list[JdToProfileSearchResponse200OutputDataItemCurrentJobType0JobFunctionType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(
                list[JdToProfileSearchResponse200OutputDataItemCurrentJobType0JobFunctionType0Item] | None | Unset, data
            )
        ...
        def _parse_academic_qualification(
            ...
            try:
                ...
                pass
            return cast(
                list[JdToProfileSearchResponse200OutputDataItemCurrentJobType0AcademicQualificationType0Item]
                | None
                | Unset,
                data,
            )
        ...
        jd_to_profile_search_response_200_output_data_item_current_job_type_0 = cls(
        ...
        jd_to_profile_search_response_200_output_data_item_current_job_type_0.additional_properties = d
        return jd_to_profile_search_response_200_output_data_item_current_job_type_0
