...
T = TypeVar("T", bound="TwitterUserFollowingResponse200OutputUsersItem")


@_attrs_define
class TwitterUserFollowingResponse200OutputUsersItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        twitter_user_following_response_200_output_users_item = cls(
            id=id,
            handle=handle,
        ...
        twitter_user_following_response_200_output_users_item.additional_properties = d
        return twitter_user_following_response_200_output_users_item
