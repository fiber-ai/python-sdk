...
T = TypeVar("T", bound="TiktokCommentRepliesResponse200OutputCommentsItemUserType0")


@_attrs_define
class TiktokCommentRepliesResponse200OutputCommentsItemUserType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        tiktok_comment_replies_response_200_output_comments_item_user_type_0 = cls(
            id=id,
            handle=handle,
        ...
        tiktok_comment_replies_response_200_output_comments_item_user_type_0.additional_properties = d
        return tiktok_comment_replies_response_200_output_comments_item_user_type_0
