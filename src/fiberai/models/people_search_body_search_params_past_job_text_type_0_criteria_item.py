...
from ..models.people_search_body_search_params_past_job_text_type_0_criteria_item_field import (
    PeopleSearchBodySearchParamsPastJobTextType0CriteriaItemField,
)
from ..models.people_search_body_search_params_past_job_text_type_0_criteria_item_rule import (
    PeopleSearchBodySearchParamsPastJobTextType0CriteriaItemRule,
)
