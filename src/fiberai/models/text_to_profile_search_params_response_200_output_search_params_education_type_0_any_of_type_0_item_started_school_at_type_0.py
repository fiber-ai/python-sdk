...
from ..models.text_to_profile_search_params_response_200_output_search_params_education_type_0_any_of_type_0_item_started_school_at_type_0_strategy import (
    TextToProfileSearchParamsResponse200OutputSearchParamsEducationType0AnyOfType0ItemStartedSchoolAtType0Strategy,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.text_to_profile_search_params_response_200_output_search_params_education_type_0_any_of_type_0_item_started_school_at_type_0_range_type_0 import (
        TextToProfileSearchParamsResponse200OutputSearchParamsEducationType0AnyOfType0ItemStartedSchoolAtType0RangeType0,
    )


T = TypeVar(
    "T", bound="TextToProfileSearchParamsResponse200OutputSearchParamsEducationType0AnyOfType0ItemStartedSchoolAtType0"
)
        ...
        def _parse_range_(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                range_type_0 = TextToProfileSearchParamsResponse200OutputSearchParamsEducationType0AnyOfType0ItemStartedSchoolAtType0RangeType0.from_dict(
                    data
                )
