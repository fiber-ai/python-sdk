...
T = TypeVar("T", bound="CompanySearchBodySearchParamsJobPostingStatsType0AnyOfType0ItemType1RangeType0Range")



@_attrs_define
class CompanySearchBodySearchParamsJobPostingStatsType0AnyOfType0ItemType1RangeType0Range:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        company_search_body_search_params_job_posting_stats_type_0_any_of_type_0_item_type_1_range_type_0_range = cls(
            lower_bound=lower_bound,
            upper_bound=upper_bound,
        )


        company_search_body_search_params_job_posting_stats_type_0_any_of_type_0_item_type_1_range_type_0_range.additional_properties = d
        return company_search_body_search_params_job_posting_stats_type_0_any_of_type_0_item_type_1_range_type_0_range
