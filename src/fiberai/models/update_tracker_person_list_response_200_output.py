...
if TYPE_CHECKING:
    from ..models.update_tracker_person_list_response_200_output_tracking_rules_type_0_item import (
        UpdateTrackerPersonListResponse200OutputTrackingRulesType0Item,
    )


T = TypeVar("T", bound="UpdateTrackerPersonListResponse200Output")


@_attrs_define
class UpdateTrackerPersonListResponse200Output:
    """
    Attributes:
        ...
        tracking_rules (list[UpdateTrackerPersonListResponse200OutputTrackingRulesType0Item] | None | Unset): Active
    ...
    tracking_rules: list[UpdateTrackerPersonListResponse200OutputTrackingRulesType0Item] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_tracking_rules(
            data: object,
        ) -> list[UpdateTrackerPersonListResponse200OutputTrackingRulesType0Item] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for tracking_rules_type_0_item_data in _tracking_rules_type_0:
                    tracking_rules_type_0_item = (
                        UpdateTrackerPersonListResponse200OutputTrackingRulesType0Item.from_dict(
                ...
                pass
            return cast(list[UpdateTrackerPersonListResponse200OutputTrackingRulesType0Item] | None | Unset, data)

        tracking_rules = _parse_tracking_rules(d.pop("trackingRules", UNSET))

        update_tracker_person_list_response_200_output = cls(
            id=id,
            name=name,
        ...
        update_tracker_person_list_response_200_output.additional_properties = d
        return update_tracker_person_list_response_200_output
