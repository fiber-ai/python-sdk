...
if TYPE_CHECKING:
    from ..models.text_to_combined_search_response_200_output_data_profiles_item_detailed_education_type_0_item_school_details_type_0 import (
        TextToCombinedSearchResponse200OutputDataProfilesItemDetailedEducationType0ItemSchoolDetailsType0,
    )
...
class TextToCombinedSearchResponse200OutputDataProfilesItemDetailedEducationType0Item:
    ...
    Attributes:
        school_details (None |
            TextToCombinedSearchResponse200OutputDataProfilesItemDetailedEducationType0ItemSchoolDetailsType0 | Unset):
    ...
    school_details: (
        None | TextToCombinedSearchResponse200OutputDataProfilesItemDetailedEducationType0ItemSchoolDetailsType0 | Unset
    ) = UNSET
        ...
        def _parse_school_details(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                school_details_type_0 = TextToCombinedSearchResponse200OutputDataProfilesItemDetailedEducationType0ItemSchoolDetailsType0.from_dict(
                    data
                )
