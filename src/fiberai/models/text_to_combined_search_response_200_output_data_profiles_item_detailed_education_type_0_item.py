...
if TYPE_CHECKING:
  from ..models.text_to_combined_search_response_200_output_data_profiles_item_detailed_education_type_0_item_school_details_type_0 import TextToCombinedSearchResponse200OutputDataProfilesItemDetailedEducationType0ItemSchoolDetailsType0





T = TypeVar("T", bound="TextToCombinedSearchResponse200OutputDataProfilesItemDetailedEducationType0Item")



@_attrs_define
class TextToCombinedSearchResponse200OutputDataProfilesItemDetailedEducationType0Item:
    """ 
        Attributes:
            school_details
                (Union['TextToCombinedSearchResponse200OutputDataProfilesItemDetailedEducationType0ItemSchoolDetailsType0',
                None, Unset]):
    ...
    school_details: Union['TextToCombinedSearchResponse200OutputDataProfilesItemDetailedEducationType0ItemSchoolDetailsType0', None, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.school_details, TextToCombinedSearchResponse200OutputDataProfilesItemDetailedEducationType0ItemSchoolDetailsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.text_to_combined_search_response_200_output_data_profiles_item_detailed_education_type_0_item_school_details_type_0 import TextToCombinedSearchResponse200OutputDataProfilesItemDetailedEducationType0ItemSchoolDetailsType0
        d = dict(src_dict)
        def _parse_school_details(data: object) -> Union['TextToCombinedSearchResponse200OutputDataProfilesItemDetailedEducationType0ItemSchoolDetailsType0', None, Unset]:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                school_details_type_0 = TextToCombinedSearchResponse200OutputDataProfilesItemDetailedEducationType0ItemSchoolDetailsType0.from_dict(data)
                ...
                pass
            return cast(Union['TextToCombinedSearchResponse200OutputDataProfilesItemDetailedEducationType0ItemSchoolDetailsType0', None, Unset], data)
        ...
        text_to_combined_search_response_200_output_data_profiles_item_detailed_education_type_0_item = cls(
        ...
        text_to_combined_search_response_200_output_data_profiles_item_detailed_education_type_0_item.additional_properties = d
        return text_to_combined_search_response_200_output_data_profiles_item_detailed_education_type_0_item
