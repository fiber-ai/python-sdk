...
if TYPE_CHECKING:
    from ..models.company_search_response_200_output_data_item_accelerators_type_0_item_founders_type_0_item import (
        CompanySearchResponse200OutputDataItemAcceleratorsType0ItemFoundersType0Item,
    )
...
class CompanySearchResponse200OutputDataItemAcceleratorsType0Item:
    ...
    Attributes:
        ...
        founders (list[CompanySearchResponse200OutputDataItemAcceleratorsType0ItemFoundersType0Item] | None | Unset):
    ...
    founders: list[CompanySearchResponse200OutputDataItemAcceleratorsType0ItemFoundersType0Item] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.company_search_response_200_output_data_item_accelerators_type_0_item_founders_type_0_item import (
            CompanySearchResponse200OutputDataItemAcceleratorsType0ItemFoundersType0Item,  # noqa: PLC0415
        )
        ...
        def _parse_founders(
            data: object,
        ) -> list[CompanySearchResponse200OutputDataItemAcceleratorsType0ItemFoundersType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for founders_type_0_item_data in _founders_type_0:
                    founders_type_0_item = (
                        CompanySearchResponse200OutputDataItemAcceleratorsType0ItemFoundersType0Item.from_dict(
                ...
                pass
            return cast(
                list[CompanySearchResponse200OutputDataItemAcceleratorsType0ItemFoundersType0Item] | None | Unset, data
            )
