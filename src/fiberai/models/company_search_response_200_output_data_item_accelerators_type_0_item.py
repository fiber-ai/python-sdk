...
if TYPE_CHECKING:
  from ..models.company_search_response_200_output_data_item_accelerators_type_0_item_founders_type_0_item import CompanySearchResponse200OutputDataItemAcceleratorsType0ItemFoundersType0Item





T = TypeVar("T", bound="CompanySearchResponse200OutputDataItemAcceleratorsType0Item")



@_attrs_define
class CompanySearchResponse200OutputDataItemAcceleratorsType0Item:
    """ 
        Attributes:
            ...
            founders (Union[None, Unset,
                list['CompanySearchResponse200OutputDataItemAcceleratorsType0ItemFoundersType0Item']]):
    ...
    founders: Union[None, Unset, list['CompanySearchResponse200OutputDataItemAcceleratorsType0ItemFoundersType0Item']] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_founders(data: object) -> Union[None, Unset, list['CompanySearchResponse200OutputDataItemAcceleratorsType0ItemFoundersType0Item']]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for founders_type_0_item_data in (_founders_type_0):
                    founders_type_0_item = CompanySearchResponse200OutputDataItemAcceleratorsType0ItemFoundersType0Item.from_dict(founders_type_0_item_data)
                ...
                pass
            return cast(Union[None, Unset, list['CompanySearchResponse200OutputDataItemAcceleratorsType0ItemFoundersType0Item']], data)
        ...
        company_search_response_200_output_data_item_accelerators_type_0_item = cls(
            id=id,
            slug=slug,
            tags=tags,
            year=year,
        ...
        company_search_response_200_output_data_item_accelerators_type_0_item.additional_properties = d
        return company_search_response_200_output_data_item_accelerators_type_0_item
