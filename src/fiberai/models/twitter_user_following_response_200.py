...
if TYPE_CHECKING:
    from ..models.twitter_user_following_response_200_charge_info_type_0 import (
        TwitterUserFollowingResponse200ChargeInfoType0,
    )
    from ..models.twitter_user_following_response_200_charge_info_type_1 import (
...
T = TypeVar("T", bound="TwitterUserFollowingResponse200")


@_attrs_define
class TwitterUserFollowingResponse200:
    """
    Attributes:
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.twitter_user_following_response_200_charge_info_type_0 import (
            TwitterUserFollowingResponse200ChargeInfoType0,  # noqa: PLC0415
        )
        from ..models.twitter_user_following_response_200_charge_info_type_1 import (
            TwitterUserFollowingResponse200ChargeInfoType1,  # noqa: PLC0415
        )
        from ..models.twitter_user_following_response_200_charge_info_type_2 import (
            TwitterUserFollowingResponse200ChargeInfoType2,  # noqa: PLC0415
        )
        from ..models.twitter_user_following_response_200_charge_info_type_3 import (
            TwitterUserFollowingResponse200ChargeInfoType3,  # noqa: PLC0415
        )

        output = self.output.to_dict()

        charge_info: dict[str, Any]
        if isinstance(self.charge_info, TwitterUserFollowingResponse200ChargeInfoType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.twitter_user_following_response_200_charge_info_type_4 import (
            TwitterUserFollowingResponse200ChargeInfoType4,  # noqa: PLC0415
        )
        from ..models.twitter_user_following_response_200_output import (
            TwitterUserFollowingResponse200Output,  # noqa: PLC0415
        )
        from ..models.twitter_user_following_response_200_warnings_type_0_item import (
            TwitterUserFollowingResponse200WarningsType0Item,  # noqa: PLC0415
        )

        d = dict(src_dict)
        output = TwitterUserFollowingResponse200Output.from_dict(d.pop("output"))
        ...
        def _parse_charge_info(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_0 = TwitterUserFollowingResponse200ChargeInfoType0.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_1 = TwitterUserFollowingResponse200ChargeInfoType1.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_2 = TwitterUserFollowingResponse200ChargeInfoType2.from_dict(data)
        ...
        def _parse_warnings(data: object) -> list[TwitterUserFollowingResponse200WarningsType0Item] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for warnings_type_0_item_data in _warnings_type_0:
                    warnings_type_0_item = TwitterUserFollowingResponse200WarningsType0Item.from_dict(
                ...
                pass
            return cast(list[TwitterUserFollowingResponse200WarningsType0Item] | None | Unset, data)
        ...
        twitter_user_following_response_200 = cls(
            output=output,
        ...
        return twitter_user_following_response_200
