...
T = TypeVar("T", bound="LiteReverseEmailLookupResponse200OutputDataItemLanguagesType0Item")


@_attrs_define
class LiteReverseEmailLookupResponse200OutputDataItemLanguagesType0Item:
    """
    Attributes:
        name (None | str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        lite_reverse_email_lookup_response_200_output_data_item_languages_type_0_item = cls(
            name=name,
            proficiency_id=proficiency_id,
            proficiency_name=proficiency_name,
        )

        lite_reverse_email_lookup_response_200_output_data_item_languages_type_0_item.additional_properties = d
        return lite_reverse_email_lookup_response_200_output_data_item_languages_type_0_item
