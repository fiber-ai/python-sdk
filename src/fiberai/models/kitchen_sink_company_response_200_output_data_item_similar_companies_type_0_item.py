...
T = TypeVar("T", bound="KitchenSinkCompanyResponse200OutputDataItemSimilarCompaniesType0Item")


@_attrs_define
class KitchenSinkCompanyResponse200OutputDataItemSimilarCompaniesType0Item:
    """
    Attributes:
        name (None | str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        kitchen_sink_company_response_200_output_data_item_similar_companies_type_0_item = cls(
            name=name,
        ...
        kitchen_sink_company_response_200_output_data_item_similar_companies_type_0_item.additional_properties = d
        return kitchen_sink_company_response_200_output_data_item_similar_companies_type_0_item
