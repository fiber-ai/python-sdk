...
T = TypeVar("T", bound="QuickCompanyResolveResponse200OutputDataItemCompanyType0LocationConsensusType0")


@_attrs_define
class QuickCompanyResolveResponse200OutputDataItemCompanyType0LocationConsensusType0:
    """
    Attributes:
        ...
        coordinates (None |
            QuickCompanyResolveResponse200OutputDataItemCompanyType0LocationConsensusType0CoordinatesType0 | Unset):
    ...
    coordinates: (
        None | QuickCompanyResolveResponse200OutputDataItemCompanyType0LocationConsensusType0CoordinatesType0 | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_coordinates(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = QuickCompanyResolveResponse200OutputDataItemCompanyType0LocationConsensusType0CoordinatesType0.from_dict(
                    data
                )
        ...
        quick_company_resolve_response_200_output_data_item_company_type_0_location_consensus_type_0 = cls(
        ...
        quick_company_resolve_response_200_output_data_item_company_type_0_location_consensus_type_0.additional_properties = d
        return quick_company_resolve_response_200_output_data_item_company_type_0_location_consensus_type_0
