...
T = TypeVar("T", bound="HotelPropertyResponse200OutputPropertyImagesItem")


@_attrs_define
class HotelPropertyResponse200OutputPropertyImagesItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        hotel_property_response_200_output_property_images_item = cls(
            thumbnail_url=thumbnail_url,
            original_url=original_url,
        )

        hotel_property_response_200_output_property_images_item.additional_properties = d
        return hotel_property_response_200_output_property_images_item
