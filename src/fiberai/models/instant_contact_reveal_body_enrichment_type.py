...
T = TypeVar("T", bound="InstantContactRevealBodyEnrichmentType")


@_attrs_define
class InstantContactRevealBodyEnrichmentType:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        instant_contact_reveal_body_enrichment_type = cls(
            get_work_emails=get_work_emails,
            get_personal_emails=get_personal_emails,
            get_phone_numbers=get_phone_numbers,
        )

        instant_contact_reveal_body_enrichment_type.additional_properties = d
        return instant_contact_reveal_body_enrichment_type
