...
from ..models.text_to_company_search_response_200_output_search_params_accelerators_v2_type_0_any_of_type_0_item_batch_selection_type_0_strategy import TextToCompanySearchResponse200OutputSearchParamsAcceleratorsV2Type0AnyOfType0ItemBatchSelectionType0Strategy
...
T = TypeVar("T", bound="TextToCompanySearchResponse200OutputSearchParamsAcceleratorsV2Type0AnyOfType0ItemBatchSelectionType0")
...
class TextToCompanySearchResponse200OutputSearchParamsAcceleratorsV2Type0AnyOfType0ItemBatchSelectionType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        strategy = TextToCompanySearchResponse200OutputSearchParamsAcceleratorsV2Type0AnyOfType0ItemBatchSelectionType0Strategy(d.pop("strategy"))
