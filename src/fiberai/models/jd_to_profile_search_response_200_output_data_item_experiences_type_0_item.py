...
from ..models.jd_to_profile_search_response_200_output_data_item_experiences_type_0_item_academic_qualification_type_0_item import (
    JdToProfileSearchResponse200OutputDataItemExperiencesType0ItemAcademicQualificationType0Item,
)
from ..models.jd_to_profile_search_response_200_output_data_item_experiences_type_0_item_employment_type_type_0_item import (
    JdToProfileSearchResponse200OutputDataItemExperiencesType0ItemEmploymentTypeType0Item,
)
from ..models.jd_to_profile_search_response_200_output_data_item_experiences_type_0_item_job_function_type_0_item import (
    JdToProfileSearchResponse200OutputDataItemExperiencesType0ItemJobFunctionType0Item,
)
from ..models.jd_to_profile_search_response_200_output_data_item_experiences_type_0_item_seniority_type_1 import (
    JdToProfileSearchResponse200OutputDataItemExperiencesType0ItemSeniorityType1,
)
from ..models.jd_to_profile_search_response_200_output_data_item_experiences_type_0_item_seniority_type_2_type_1 import (
    JdToProfileSearchResponse200OutputDataItemExperiencesType0ItemSeniorityType2Type1,
)
from ..models.jd_to_profile_search_response_200_output_data_item_experiences_type_0_item_seniority_type_3_type_1 import (
    JdToProfileSearchResponse200OutputDataItemExperiencesType0ItemSeniorityType3Type1,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="JdToProfileSearchResponse200OutputDataItemExperiencesType0Item")


@_attrs_define
class JdToProfileSearchResponse200OutputDataItemExperiencesType0Item:
    """
    Attributes:
        ...
        seniority (JdToProfileSearchResponse200OutputDataItemExperiencesType0ItemSeniorityType1 |
            JdToProfileSearchResponse200OutputDataItemExperiencesType0ItemSeniorityType2Type1 |
            JdToProfileSearchResponse200OutputDataItemExperiencesType0ItemSeniorityType3Type1 | None | Unset):
        job_function (list[JdToProfileSearchResponse200OutputDataItemExperiencesType0ItemJobFunctionType0Item] | None |
            Unset):
        employment_type (list[JdToProfileSearchResponse200OutputDataItemExperiencesType0ItemEmploymentTypeType0Item] |
            None | Unset):
        academic_qualification
            (list[JdToProfileSearchResponse200OutputDataItemExperiencesType0ItemAcademicQualificationType0Item] | None |
            Unset):
    ...
    job_function: (
        list[JdToProfileSearchResponse200OutputDataItemExperiencesType0ItemJobFunctionType0Item] | None | Unset
    ) = UNSET
    employment_type: (
        list[JdToProfileSearchResponse200OutputDataItemExperiencesType0ItemEmploymentTypeType0Item] | None | Unset
    ) = UNSET
    academic_qualification: (
        list[JdToProfileSearchResponse200OutputDataItemExperiencesType0ItemAcademicQualificationType0Item]
        | None
        | Unset
    ) = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.seniority, Unset):
            seniority = UNSET
        elif isinstance(self.seniority, JdToProfileSearchResponse200OutputDataItemExperiencesType0ItemSeniorityType1):
            seniority = self.seniority.value
        elif isinstance(
            self.seniority, JdToProfileSearchResponse200OutputDataItemExperiencesType0ItemSeniorityType2Type1
        ):
            seniority = self.seniority.value
        elif isinstance(
            self.seniority, JdToProfileSearchResponse200OutputDataItemExperiencesType0ItemSeniorityType3Type1
        ):
            seniority = self.seniority.value
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_seniority(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                seniority_type_1 = JdToProfileSearchResponse200OutputDataItemExperiencesType0ItemSeniorityType1(data)
            ...
            try:
                ...
                seniority_type_2_type_1 = (
                    JdToProfileSearchResponse200OutputDataItemExperiencesType0ItemSeniorityType2Type1(data)
                )
            ...
            try:
                ...
                seniority_type_3_type_1 = (
                    JdToProfileSearchResponse200OutputDataItemExperiencesType0ItemSeniorityType3Type1(data)
                )
        ...
        def _parse_employment_type(
            ...
            try:
                ...
                pass
            return cast(
                list[JdToProfileSearchResponse200OutputDataItemExperiencesType0ItemEmploymentTypeType0Item]
                | None
                | Unset,
                data,
            )
        ...
        jd_to_profile_search_response_200_output_data_item_experiences_type_0_item = cls(
        ...
        jd_to_profile_search_response_200_output_data_item_experiences_type_0_item.additional_properties = d
        return jd_to_profile_search_response_200_output_data_item_experiences_type_0_item
