...
T = TypeVar("T", bound="StartBatchContactDetailsResponse200")


@_attrs_define
class StartBatchContactDetailsResponse200:
    """
    Attributes:
        output (StartBatchContactDetailsResponse200Output):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.charge_info, StartBatchContactDetailsResponse200ChargeInfoType0):
            charge_info = self.charge_info.to_dict()
        elif isinstance(self.charge_info, StartBatchContactDetailsResponse200ChargeInfoType1):
            charge_info = self.charge_info.to_dict()
        elif isinstance(self.charge_info, StartBatchContactDetailsResponse200ChargeInfoType2):
            charge_info = self.charge_info.to_dict()
        elif isinstance(self.charge_info, StartBatchContactDetailsResponse200ChargeInfoType3):
            charge_info = self.charge_info.to_dict()
        else:
            charge_info = self.charge_info.to_dict()
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        output = StartBatchContactDetailsResponse200Output.from_dict(d.pop("output"))
        ...
        def _parse_charge_info(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_0 = StartBatchContactDetailsResponse200ChargeInfoType0.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_1 = StartBatchContactDetailsResponse200ChargeInfoType1.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_2 = StartBatchContactDetailsResponse200ChargeInfoType2.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                charge_info_type_3 = StartBatchContactDetailsResponse200ChargeInfoType3.from_dict(data)
            ...
            if not isinstance(data, dict):
                raise TypeError()
            charge_info_type_4 = StartBatchContactDetailsResponse200ChargeInfoType4.from_dict(data)
        ...
        def _parse_warnings(data: object) -> list[StartBatchContactDetailsResponse200WarningsType0Item] | None | Unset:
            ...
            try:
                ...
                for warnings_type_0_item_data in _warnings_type_0:
                    warnings_type_0_item = StartBatchContactDetailsResponse200WarningsType0Item.from_dict(
                ...
                pass
            return cast(list[StartBatchContactDetailsResponse200WarningsType0Item] | None | Unset, data)
        ...
        return start_batch_contact_details_response_200
