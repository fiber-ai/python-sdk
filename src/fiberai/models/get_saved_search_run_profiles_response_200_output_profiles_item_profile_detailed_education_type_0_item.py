...
if TYPE_CHECKING:
  from ..models.get_saved_search_run_profiles_response_200_output_profiles_item_profile_detailed_education_type_0_item_school_details_type_0 import GetSavedSearchRunProfilesResponse200OutputProfilesItemProfileDetailedEducationType0ItemSchoolDetailsType0





T = TypeVar("T", bound="GetSavedSearchRunProfilesResponse200OutputProfilesItemProfileDetailedEducationType0Item")



@_attrs_define
class GetSavedSearchRunProfilesResponse200OutputProfilesItemProfileDetailedEducationType0Item:
    """ 
        Attributes:
            school_details (Union['GetSavedSearchRunProfilesResponse200OutputProfilesItemProfileDetailedEducationType0ItemSc
                hoolDetailsType0', None, Unset]):
    ...
    school_details: Union['GetSavedSearchRunProfilesResponse200OutputProfilesItemProfileDetailedEducationType0ItemSchoolDetailsType0', None, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.school_details, GetSavedSearchRunProfilesResponse200OutputProfilesItemProfileDetailedEducationType0ItemSchoolDetailsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.get_saved_search_run_profiles_response_200_output_profiles_item_profile_detailed_education_type_0_item_school_details_type_0 import GetSavedSearchRunProfilesResponse200OutputProfilesItemProfileDetailedEducationType0ItemSchoolDetailsType0
        d = dict(src_dict)
        def _parse_school_details(data: object) -> Union['GetSavedSearchRunProfilesResponse200OutputProfilesItemProfileDetailedEducationType0ItemSchoolDetailsType0', None, Unset]:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                school_details_type_0 = GetSavedSearchRunProfilesResponse200OutputProfilesItemProfileDetailedEducationType0ItemSchoolDetailsType0.from_dict(data)
                ...
                pass
            return cast(Union['GetSavedSearchRunProfilesResponse200OutputProfilesItemProfileDetailedEducationType0ItemSchoolDetailsType0', None, Unset], data)
        ...
        get_saved_search_run_profiles_response_200_output_profiles_item_profile_detailed_education_type_0_item = cls(
        ...
        get_saved_search_run_profiles_response_200_output_profiles_item_profile_detailed_education_type_0_item.additional_properties = d
        return get_saved_search_run_profiles_response_200_output_profiles_item_profile_detailed_education_type_0_item
