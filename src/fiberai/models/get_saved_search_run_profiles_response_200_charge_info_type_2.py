...
from ..models.get_saved_search_run_profiles_response_200_charge_info_type_2_method import (
    GetSavedSearchRunProfilesResponse200ChargeInfoType2Method,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_saved_search_run_profiles_response_200_charge_info_type_2_low_credit_alert_type_0 import (
        GetSavedSearchRunProfilesResponse200ChargeInfoType2LowCreditAlertType0,
    )
...
class GetSavedSearchRunProfilesResponse200ChargeInfoType2:
    ...
    Attributes:
        ...
        message (str):
        low_credit_alert (GetSavedSearchRunProfilesResponse200ChargeInfoType2LowCreditAlertType0 | None | Unset):
    ...
    credits_charged: float
    message: str
    low_credit_alert: GetSavedSearchRunProfilesResponse200ChargeInfoType2LowCreditAlertType0 | None | Unset = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        from ..models.get_saved_search_run_profiles_response_200_charge_info_type_2_low_credit_alert_type_0 import (
            GetSavedSearchRunProfilesResponse200ChargeInfoType2LowCreditAlertType0,  # noqa: PLC0415
        )
        ...
        elif isinstance(self.low_credit_alert, GetSavedSearchRunProfilesResponse200ChargeInfoType2LowCreditAlertType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_low_credit_alert(
            data: object,
        ) -> GetSavedSearchRunProfilesResponse200ChargeInfoType2LowCreditAlertType0 | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                low_credit_alert_type_0 = (
                    GetSavedSearchRunProfilesResponse200ChargeInfoType2LowCreditAlertType0.from_dict(data)
                )

                return low_credit_alert_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(GetSavedSearchRunProfilesResponse200ChargeInfoType2LowCreditAlertType0 | None | Unset, data)
