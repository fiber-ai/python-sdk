...
T = TypeVar("T", bound="QuickPersonResolveResponse200OutputDataItemPersonType0VerificationsType0")


@_attrs_define
class QuickPersonResolveResponse200OutputDataItemPersonType0VerificationsType0:
    """
    Attributes:
        is_verified (bool | None | Unset):
        joined_date (None | str | Unset):
        verification_types
            (list[QuickPersonResolveResponse200OutputDataItemPersonType0VerificationsType0VerificationTypesType0Item] | None
            | Unset):
    """
    ...
    verification_types: (
        list[QuickPersonResolveResponse200OutputDataItemPersonType0VerificationsType0VerificationTypesType0Item]
        | None
        | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_verification_types(
            ...
            try:
                ...
                for verification_types_type_0_item_data in _verification_types_type_0:
                    verification_types_type_0_item = QuickPersonResolveResponse200OutputDataItemPersonType0VerificationsType0VerificationTypesType0Item.from_dict(
        ...
        quick_person_resolve_response_200_output_data_item_person_type_0_verifications_type_0 = cls(
            is_verified=is_verified,
            joined_date=joined_date,
            verification_types=verification_types,
        )

        quick_person_resolve_response_200_output_data_item_person_type_0_verifications_type_0.additional_properties = d
        return quick_person_resolve_response_200_output_data_item_person_type_0_verifications_type_0
