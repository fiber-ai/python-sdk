...
T = TypeVar("T", bound="CompanySearchBodySearchParamsEmployeeTrendsType0ObeysNoneType0ItemCountCriteriaType2Range")



@_attrs_define
class CompanySearchBodySearchParamsEmployeeTrendsType0ObeysNoneType0ItemCountCriteriaType2Range:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        company_search_body_search_params_employee_trends_type_0_obeys_none_type_0_item_count_criteria_type_2_range = cls(
            lower_bound=lower_bound,
            upper_bound=upper_bound,
        )


        company_search_body_search_params_employee_trends_type_0_obeys_none_type_0_item_count_criteria_type_2_range.additional_properties = d
        return company_search_body_search_params_employee_trends_type_0_obeys_none_type_0_item_count_criteria_type_2_range
