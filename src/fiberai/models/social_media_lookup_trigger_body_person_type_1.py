...
from ..models.social_media_lookup_trigger_body_person_type_1_input_type import (
    SocialMediaLookupTriggerBodyPersonType1InputType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="SocialMediaLookupTriggerBodyPersonType1")


@_attrs_define
class SocialMediaLookupTriggerBodyPersonType1:
    """
    Attributes:
        input_type (SocialMediaLookupTriggerBodyPersonType1InputType):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        input_type = SocialMediaLookupTriggerBodyPersonType1InputType(d.pop("inputType"))
        ...
        social_media_lookup_trigger_body_person_type_1 = cls(
            input_type=input_type,
            linkedin_user_id=linkedin_user_id,
            customer_provided_id=customer_provided_id,
        )

        social_media_lookup_trigger_body_person_type_1.additional_properties = d
        return social_media_lookup_trigger_body_person_type_1
