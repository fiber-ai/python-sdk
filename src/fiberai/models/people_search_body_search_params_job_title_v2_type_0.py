...
class PeopleSearchBodySearchParamsJobTitleV2Type0:
    """
    Attributes:
        any_of (list[PeopleSearchBodySearchParamsJobTitleV2Type0AnyOfType0ItemType0 |
            PeopleSearchBodySearchParamsJobTitleV2Type0AnyOfType0ItemType1 |
            PeopleSearchBodySearchParamsJobTitleV2Type0AnyOfType0ItemType2] | None | Unset):
        none_of (list[PeopleSearchBodySearchParamsJobTitleV2Type0NoneOfType0ItemType0 |
            PeopleSearchBodySearchParamsJobTitleV2Type0NoneOfType0ItemType1 |
            PeopleSearchBodySearchParamsJobTitleV2Type0NoneOfType0ItemType2] | None | Unset):
        all_of (list[PeopleSearchBodySearchParamsJobTitleV2Type0AllOfType0ItemType0 |
            PeopleSearchBodySearchParamsJobTitleV2Type0AllOfType0ItemType1 |
            PeopleSearchBodySearchParamsJobTitleV2Type0AllOfType0ItemType2] | None | Unset):
    """
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.any_of, Unset):
            ...
            for any_of_type_0_item_data in self.any_of:
                ...
                if isinstance(any_of_type_0_item_data, PeopleSearchBodySearchParamsJobTitleV2Type0AnyOfType0ItemType0):
                    ...
                    any_of_type_0_item_data, PeopleSearchBodySearchParamsJobTitleV2Type0AnyOfType0ItemType1
                ):
                    any_of_type_0_item = any_of_type_0_item_data.to_dict()
                else:
                    any_of_type_0_item = any_of_type_0_item_data.to_dict()
        ...
        if isinstance(self.none_of, Unset):
            ...
            for none_of_type_0_item_data in self.none_of:
                ...
                if isinstance(
                    none_of_type_0_item_data, PeopleSearchBodySearchParamsJobTitleV2Type0NoneOfType0ItemType0
                ):
                    none_of_type_0_item = none_of_type_0_item_data.to_dict()
                elif isinstance(
                    none_of_type_0_item_data, PeopleSearchBodySearchParamsJobTitleV2Type0NoneOfType0ItemType1
                ):
                    none_of_type_0_item = none_of_type_0_item_data.to_dict()
                else:
                    none_of_type_0_item = none_of_type_0_item_data.to_dict()
        ...
        if isinstance(self.all_of, Unset):
            ...
            for all_of_type_0_item_data in self.all_of:
                ...
                if isinstance(all_of_type_0_item_data, PeopleSearchBodySearchParamsJobTitleV2Type0AllOfType0ItemType0):
                    ...
                    all_of_type_0_item_data, PeopleSearchBodySearchParamsJobTitleV2Type0AllOfType0ItemType1
                ):
                    all_of_type_0_item = all_of_type_0_item_data.to_dict()
                else:
                    all_of_type_0_item = all_of_type_0_item_data.to_dict()
                    ...
                    def _parse_any_of_type_0_item(
                        ...
                        try:
                            ...
                            any_of_type_0_item_type_0 = (
                                PeopleSearchBodySearchParamsJobTitleV2Type0AnyOfType0ItemType0.from_dict(data)
                            )
                        ...
                        try:
                            ...
                            any_of_type_0_item_type_1 = (
                                PeopleSearchBodySearchParamsJobTitleV2Type0AnyOfType0ItemType1.from_dict(data)
                            )
                        ...
                        any_of_type_0_item_type_2 = (
                            PeopleSearchBodySearchParamsJobTitleV2Type0AnyOfType0ItemType2.from_dict(data)
                        )
                    ...
                    def _parse_none_of_type_0_item(
                        ...
                        try:
                            ...
                            none_of_type_0_item_type_0 = (
                                PeopleSearchBodySearchParamsJobTitleV2Type0NoneOfType0ItemType0.from_dict(data)
                            )
                        ...
                        try:
                            ...
                            none_of_type_0_item_type_1 = (
                                PeopleSearchBodySearchParamsJobTitleV2Type0NoneOfType0ItemType1.from_dict(data)
                            )
                        ...
                        none_of_type_0_item_type_2 = (
                            PeopleSearchBodySearchParamsJobTitleV2Type0NoneOfType0ItemType2.from_dict(data)
                        )
                    ...
                    def _parse_all_of_type_0_item(
                        ...
                        try:
                            ...
                            all_of_type_0_item_type_0 = (
                                PeopleSearchBodySearchParamsJobTitleV2Type0AllOfType0ItemType0.from_dict(data)
                            )
                        ...
                        try:
                            ...
                            all_of_type_0_item_type_1 = (
                                PeopleSearchBodySearchParamsJobTitleV2Type0AllOfType0ItemType1.from_dict(data)
                            )
                        ...
                        all_of_type_0_item_type_2 = (
                            PeopleSearchBodySearchParamsJobTitleV2Type0AllOfType0ItemType2.from_dict(data)
                        )
