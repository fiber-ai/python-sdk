...
if TYPE_CHECKING:
    from ..models.text_to_combined_search_response_200_output_profile_search_params_type_0_location_type_0_subtract_all_type_0_item_type_0 import (
        TextToCombinedSearchResponse200OutputProfileSearchParamsType0LocationType0SubtractAllType0ItemType0,
    )
    from ..models.text_to_combined_search_response_200_output_profile_search_params_type_0_location_type_0_union_all_type_0_item_type_0 import (
        TextToCombinedSearchResponse200OutputProfileSearchParamsType0LocationType0UnionAllType0ItemType0,
    )
...
class TextToCombinedSearchResponse200OutputProfileSearchParamsType0LocationType0:
    ...
    Attributes:
        union_all
            (list[TextToCombinedSearchResponse200OutputProfileSearchParamsType0LocationType0UnionAllType0ItemType0] | None |
            Unset):
        subtract_all
                ...
                for union_all_type_0_item_data in _union_all_type_0:
                    ...
                    def _parse_union_all_type_0_item(
                        ...
                        if not isinstance(data, dict):
                            raise TypeError()
                        union_all_type_0_item_type_0 = TextToCombinedSearchResponse200OutputProfileSearchParamsType0LocationType0UnionAllType0ItemType0.from_dict(
                            data
                        )
            ...
            try:
                ...
                for subtract_all_type_0_item_data in _subtract_all_type_0:
                    ...
                    def _parse_subtract_all_type_0_item(
                        ...
                        if not isinstance(data, dict):
                            raise TypeError()
                        subtract_all_type_0_item_type_0 = TextToCombinedSearchResponse200OutputProfileSearchParamsType0LocationType0SubtractAllType0ItemType0.from_dict(
                            data
                        )
