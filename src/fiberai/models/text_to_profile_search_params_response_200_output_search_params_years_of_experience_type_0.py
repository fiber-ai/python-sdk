...
T = TypeVar("T", bound="TextToProfileSearchParamsResponse200OutputSearchParamsYearsOfExperienceType0")



@_attrs_define
class TextToProfileSearchParamsResponse200OutputSearchParamsYearsOfExperienceType0:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        text_to_profile_search_params_response_200_output_search_params_years_of_experience_type_0 = cls(
            lower_bound=lower_bound,
            upper_bound=upper_bound,
        )


        text_to_profile_search_params_response_200_output_search_params_years_of_experience_type_0.additional_properties = d
        return text_to_profile_search_params_response_200_output_search_params_years_of_experience_type_0
