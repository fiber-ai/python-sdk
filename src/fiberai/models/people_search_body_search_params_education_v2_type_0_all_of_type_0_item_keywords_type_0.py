...
T = TypeVar("T", bound="PeopleSearchBodySearchParamsEducationV2Type0AllOfType0ItemKeywordsType0")


@_attrs_define
class PeopleSearchBodySearchParamsEducationV2Type0AllOfType0ItemKeywordsType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        people_search_body_search_params_education_v2_type_0_all_of_type_0_item_keywords_type_0 = cls(
            any_of=any_of,
            none_of=none_of,
        )

        people_search_body_search_params_education_v2_type_0_all_of_type_0_item_keywords_type_0.additional_properties = d
        return people_search_body_search_params_education_v2_type_0_all_of_type_0_item_keywords_type_0
