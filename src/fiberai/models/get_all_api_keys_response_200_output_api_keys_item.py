...
T = TypeVar("T", bound="GetAllApiKeysResponse200OutputApiKeysItem")


@_attrs_define
class GetAllApiKeysResponse200OutputApiKeysItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_all_api_keys_response_200_output_api_keys_item = cls(
            id=id,
            name=name,
            prefix=prefix,
        ...
        get_all_api_keys_response_200_output_api_keys_item.additional_properties = d
        return get_all_api_keys_response_200_output_api_keys_item
