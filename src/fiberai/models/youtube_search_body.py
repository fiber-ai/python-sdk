...
T = TypeVar("T", bound="YoutubeSearchBody")


@_attrs_define
class YoutubeSearchBody:
    """
    Attributes:
        api_key (str): Your Fiber API key
        query (str): The search query string to find YouTube videos (e.g. 'React Hooks tutorial').
        next_page_token (None | str | Unset): Pagination token from a previous response to retrieve the next page of
            search results. Omit for the first page.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        youtube_search_body = cls(
            api_key=api_key,
            query=query,
            next_page_token=next_page_token,
        )

        youtube_search_body.additional_properties = d
        return youtube_search_body
