...
from ..models.create_saved_search_body_search_params_type_0_company_search_params_exact_company_type_0_none_of_type_0_item_source_type_1 import CreateSavedSearchBodySearchParamsType0CompanySearchParamsExactCompanyType0NoneOfType0ItemSourceType1
from ..models.create_saved_search_body_search_params_type_0_company_search_params_exact_company_type_0_none_of_type_0_item_source_type_2_type_1 import CreateSavedSearchBodySearchParamsType0CompanySearchParamsExactCompanyType0NoneOfType0ItemSourceType2Type1
from ..models.create_saved_search_body_search_params_type_0_company_search_params_exact_company_type_0_none_of_type_0_item_source_type_3_type_1 import CreateSavedSearchBodySearchParamsType0CompanySearchParamsExactCompanyType0NoneOfType0ItemSourceType3Type1
from ..types import UNSET, Unset
...
class CreateSavedSearchBodySearchParamsType0CompanySearchParamsExactCompanyType0NoneOfType0Item:
    """ 
        Attributes:
            ...
            source
                (Union[CreateSavedSearchBodySearchParamsType0CompanySearchParamsExactCompanyType0NoneOfType0ItemSourceType1,
    ...
    source: Union[CreateSavedSearchBodySearchParamsType0CompanySearchParamsExactCompanyType0NoneOfType0ItemSourceType1, CreateSavedSearchBodySearchParamsType0CompanySearchParamsExactCompanyType0NoneOfType0ItemSourceType2Type1, CreateSavedSearchBodySearchParamsType0CompanySearchParamsExactCompanyType0NoneOfType0ItemSourceType3Type1, None, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.source, Unset):
            source = UNSET
        elif isinstance(self.source, CreateSavedSearchBodySearchParamsType0CompanySearchParamsExactCompanyType0NoneOfType0ItemSourceType1):
            source = self.source.value
        elif isinstance(self.source, CreateSavedSearchBodySearchParamsType0CompanySearchParamsExactCompanyType0NoneOfType0ItemSourceType2Type1):
            source = self.source.value
        elif isinstance(self.source, CreateSavedSearchBodySearchParamsType0CompanySearchParamsExactCompanyType0NoneOfType0ItemSourceType3Type1):
            source = self.source.value
        else:
            source = self.source
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_source(data: object) -> Union[CreateSavedSearchBodySearchParamsType0CompanySearchParamsExactCompanyType0NoneOfType0ItemSourceType1, CreateSavedSearchBodySearchParamsType0CompanySearchParamsExactCompanyType0NoneOfType0ItemSourceType2Type1, CreateSavedSearchBodySearchParamsType0CompanySearchParamsExactCompanyType0NoneOfType0ItemSourceType3Type1, None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                source_type_1 = CreateSavedSearchBodySearchParamsType0CompanySearchParamsExactCompanyType0NoneOfType0ItemSourceType1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                source_type_2_type_1 = CreateSavedSearchBodySearchParamsType0CompanySearchParamsExactCompanyType0NoneOfType0ItemSourceType2Type1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                source_type_3_type_1 = CreateSavedSearchBodySearchParamsType0CompanySearchParamsExactCompanyType0NoneOfType0ItemSourceType3Type1(data)
        ...
        create_saved_search_body_search_params_type_0_company_search_params_exact_company_type_0_none_of_type_0_item = cls(
            li_org_id=li_org_id,
        ...
        return create_saved_search_body_search_params_type_0_company_search_params_exact_company_type_0_none_of_type_0_item
