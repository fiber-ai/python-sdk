...
T = TypeVar("T", bound="JdToProfileSearchResponse200OutputSearchParamsStealthV2Type1LeftStealthAtType0RangeType0")


@_attrs_define
class JdToProfileSearchResponse200OutputSearchParamsStealthV2Type1LeftStealthAtType0RangeType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        jd_to_profile_search_response_200_output_search_params_stealth_v2_type_1_left_stealth_at_type_0_range_type_0 = (
            cls(
        ...
        jd_to_profile_search_response_200_output_search_params_stealth_v2_type_1_left_stealth_at_type_0_range_type_0.additional_properties = d
        return (
            jd_to_profile_search_response_200_output_search_params_stealth_v2_type_1_left_stealth_at_type_0_range_type_0
        )
