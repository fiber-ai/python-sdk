...
from ..models.combined_search_body_company_params_revenue_usd_type_0_min_type_0_suffix_type_1 import (
    CombinedSearchBodyCompanyParamsRevenueUSDType0MinType0SuffixType1,
)
from ..models.combined_search_body_company_params_revenue_usd_type_0_min_type_0_suffix_type_2_type_1 import (
    CombinedSearchBodyCompanyParamsRevenueUSDType0MinType0SuffixType2Type1,
)
from ..models.combined_search_body_company_params_revenue_usd_type_0_min_type_0_suffix_type_3_type_1 import (
    CombinedSearchBodyCompanyParamsRevenueUSDType0MinType0SuffixType3Type1,
)
...
class CombinedSearchBodyCompanyParamsRevenueUSDType0MinType0:
    ...
    Attributes:
        quantity (float):
        suffix (CombinedSearchBodyCompanyParamsRevenueUSDType0MinType0SuffixType1 |
            CombinedSearchBodyCompanyParamsRevenueUSDType0MinType0SuffixType2Type1 |
