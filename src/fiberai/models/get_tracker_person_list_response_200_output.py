...
if TYPE_CHECKING:
    from ..models.get_tracker_person_list_response_200_output_tracking_rules_type_0_item import (
        GetTrackerPersonListResponse200OutputTrackingRulesType0Item,
    )


T = TypeVar("T", bound="GetTrackerPersonListResponse200Output")


@_attrs_define
class GetTrackerPersonListResponse200Output:
    """
    Attributes:
        ...
        tracking_rules (list[GetTrackerPersonListResponse200OutputTrackingRulesType0Item] | None | Unset): Active
    ...
    tracking_rules: list[GetTrackerPersonListResponse200OutputTrackingRulesType0Item] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_tracking_rules(
            data: object,
        ) -> list[GetTrackerPersonListResponse200OutputTrackingRulesType0Item] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for tracking_rules_type_0_item_data in _tracking_rules_type_0:
                    tracking_rules_type_0_item = GetTrackerPersonListResponse200OutputTrackingRulesType0Item.from_dict(
                ...
                pass
            return cast(list[GetTrackerPersonListResponse200OutputTrackingRulesType0Item] | None | Unset, data)

        tracking_rules = _parse_tracking_rules(d.pop("trackingRules", UNSET))

        get_tracker_person_list_response_200_output = cls(
            id=id,
            name=name,
        ...
        get_tracker_person_list_response_200_output.additional_properties = d
        return get_tracker_person_list_response_200_output
