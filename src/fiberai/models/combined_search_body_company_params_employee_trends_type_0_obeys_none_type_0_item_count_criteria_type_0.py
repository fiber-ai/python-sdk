...
from ..models.combined_search_body_company_params_employee_trends_type_0_obeys_none_type_0_item_count_criteria_type_0_type import (
    CombinedSearchBodyCompanyParamsEmployeeTrendsType0ObeysNoneType0ItemCountCriteriaType0Type,
)

if TYPE_CHECKING:
    from ..models.combined_search_body_company_params_employee_trends_type_0_obeys_none_type_0_item_count_criteria_type_0_change import (
        CombinedSearchBodyCompanyParamsEmployeeTrendsType0ObeysNoneType0ItemCountCriteriaType0Change,
    )
...
class CombinedSearchBodyCompanyParamsEmployeeTrendsType0ObeysNoneType0ItemCountCriteriaType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        change = CombinedSearchBodyCompanyParamsEmployeeTrendsType0ObeysNoneType0ItemCountCriteriaType0Change.from_dict(
            d.pop("change")
        )
