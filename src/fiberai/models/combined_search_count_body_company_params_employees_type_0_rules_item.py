...
T = TypeVar("T", bound="CombinedSearchCountBodyCompanyParamsEmployeesType0RulesItem")


@_attrs_define
class CombinedSearchCountBodyCompanyParamsEmployeesType0RulesItem:
    """
    Attributes:
        employees_to_match (CombinedSearchCountBodyCompanyParamsEmployeesType0RulesItemEmployeesToMatchType0 |
            CombinedSearchCountBodyCompanyParamsEmployeesType0RulesItemEmployeesToMatchType1):
        employee_filters (CombinedSearchCountBodyCompanyParamsEmployeesType0RulesItemEmployeeFiltersType0 | None |
            Unset):
        job_status (CombinedSearchCountBodyCompanyParamsEmployeesType0RulesItemJobStatusType0 |
            CombinedSearchCountBodyCompanyParamsEmployeesType0RulesItemJobStatusType1 |
            CombinedSearchCountBodyCompanyParamsEmployeesType0RulesItemJobStatusType2 | None | Unset):
    """
    ...
    employee_filters: CombinedSearchCountBodyCompanyParamsEmployeesType0RulesItemEmployeeFiltersType0 | None | Unset = (
        UNSET
    )
    job_status: (
        CombinedSearchCountBodyCompanyParamsEmployeesType0RulesItemJobStatusType0
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(
            self.employees_to_match, CombinedSearchCountBodyCompanyParamsEmployeesType0RulesItemEmployeesToMatchType0
        ):
        ...
        if isinstance(self.employee_filters, Unset):
            ...
            self.employee_filters, CombinedSearchCountBodyCompanyParamsEmployeesType0RulesItemEmployeeFiltersType0
        ):
        ...
        if isinstance(self.job_status, Unset):
            job_status = UNSET
        elif isinstance(self.job_status, CombinedSearchCountBodyCompanyParamsEmployeesType0RulesItemJobStatusType0):
            job_status = self.job_status.to_dict()
        elif isinstance(self.job_status, CombinedSearchCountBodyCompanyParamsEmployeesType0RulesItemJobStatusType1):
            job_status = self.job_status.to_dict()
        elif isinstance(self.job_status, CombinedSearchCountBodyCompanyParamsEmployeesType0RulesItemJobStatusType2):
            job_status = self.job_status.to_dict()
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_employees_to_match(
            ...
            try:
                ...
                employees_to_match_type_0 = (
                    CombinedSearchCountBodyCompanyParamsEmployeesType0RulesItemEmployeesToMatchType0.from_dict(data)
                )
            ...
            employees_to_match_type_1 = (
                CombinedSearchCountBodyCompanyParamsEmployeesType0RulesItemEmployeesToMatchType1.from_dict(data)
            )
        ...
        def _parse_employee_filters(
            data: object,
        ) -> CombinedSearchCountBodyCompanyParamsEmployeesType0RulesItemEmployeeFiltersType0 | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                employee_filters_type_0 = (
                    CombinedSearchCountBodyCompanyParamsEmployeesType0RulesItemEmployeeFiltersType0.from_dict(data)
                )
                ...
                pass
            return cast(
                CombinedSearchCountBodyCompanyParamsEmployeesType0RulesItemEmployeeFiltersType0 | None | Unset, data
            )
        ...
        def _parse_job_status(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                job_status_type_0 = CombinedSearchCountBodyCompanyParamsEmployeesType0RulesItemJobStatusType0.from_dict(
                    data
                )
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                job_status_type_1 = CombinedSearchCountBodyCompanyParamsEmployeesType0RulesItemJobStatusType1.from_dict(
                    data
                )
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                job_status_type_2 = CombinedSearchCountBodyCompanyParamsEmployeesType0RulesItemJobStatusType2.from_dict(
                    data
                )
        ...
        combined_search_count_body_company_params_employees_type_0_rules_item = cls(
            employees_to_match=employees_to_match,
            employee_filters=employee_filters,
            job_status=job_status,
        )

        combined_search_count_body_company_params_employees_type_0_rules_item.additional_properties = d
        return combined_search_count_body_company_params_employees_type_0_rules_item
