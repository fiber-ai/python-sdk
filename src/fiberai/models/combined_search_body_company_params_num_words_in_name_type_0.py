...
T = TypeVar("T", bound="CombinedSearchBodyCompanyParamsNumWordsInNameType0")



@_attrs_define
class CombinedSearchBodyCompanyParamsNumWordsInNameType0:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        combined_search_body_company_params_num_words_in_name_type_0 = cls(
            lower_bound=lower_bound,
            upper_bound=upper_bound,
        )


        combined_search_body_company_params_num_words_in_name_type_0.additional_properties = d
        return combined_search_body_company_params_num_words_in_name_type_0
