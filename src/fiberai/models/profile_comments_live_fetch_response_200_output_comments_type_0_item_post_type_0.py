...
class ProfileCommentsLiveFetchResponse200OutputCommentsType0ItemPostType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_author(
            data: object,
        ) -> None | ProfileCommentsLiveFetchResponse200OutputCommentsType0ItemPostType0AuthorType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                author_type_0 = (
                    ProfileCommentsLiveFetchResponse200OutputCommentsType0ItemPostType0AuthorType0.from_dict(data)
                )
                ...
                pass
            return cast(
                None | ProfileCommentsLiveFetchResponse200OutputCommentsType0ItemPostType0AuthorType0 | Unset, data
            )
