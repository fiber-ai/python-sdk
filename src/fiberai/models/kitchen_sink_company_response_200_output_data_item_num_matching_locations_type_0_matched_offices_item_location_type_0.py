...
if TYPE_CHECKING:
  from ..models.kitchen_sink_company_response_200_output_data_item_num_matching_locations_type_0_matched_offices_item_location_type_0_coordinates_type_0 import KitchenSinkCompanyResponse200OutputDataItemNumMatchingLocationsType0MatchedOfficesItemLocationType0CoordinatesType0





T = TypeVar("T", bound="KitchenSinkCompanyResponse200OutputDataItemNumMatchingLocationsType0MatchedOfficesItemLocationType0")



@_attrs_define
class KitchenSinkCompanyResponse200OutputDataItemNumMatchingLocationsType0MatchedOfficesItemLocationType0:
    """ 
        Attributes:
            ...
            coordinates (Union['KitchenSinkCompanyResponse200OutputDataItemNumMatchingLocationsType0MatchedOfficesItemLocati
                onType0CoordinatesType0', None, Unset]):
    ...
    coordinates: Union['KitchenSinkCompanyResponse200OutputDataItemNumMatchingLocationsType0MatchedOfficesItemLocationType0CoordinatesType0', None, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.coordinates, Unset):
            coordinates = UNSET
        elif isinstance(self.coordinates, KitchenSinkCompanyResponse200OutputDataItemNumMatchingLocationsType0MatchedOfficesItemLocationType0CoordinatesType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_coordinates(data: object) -> Union['KitchenSinkCompanyResponse200OutputDataItemNumMatchingLocationsType0MatchedOfficesItemLocationType0CoordinatesType0', None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = KitchenSinkCompanyResponse200OutputDataItemNumMatchingLocationsType0MatchedOfficesItemLocationType0CoordinatesType0.from_dict(data)
                ...
                pass
            return cast(Union['KitchenSinkCompanyResponse200OutputDataItemNumMatchingLocationsType0MatchedOfficesItemLocationType0CoordinatesType0', None, Unset], data)
        ...
        kitchen_sink_company_response_200_output_data_item_num_matching_locations_type_0_matched_offices_item_location_type_0 = cls(
        ...
        kitchen_sink_company_response_200_output_data_item_num_matching_locations_type_0_matched_offices_item_location_type_0.additional_properties = d
        return kitchen_sink_company_response_200_output_data_item_num_matching_locations_type_0_matched_offices_item_location_type_0
