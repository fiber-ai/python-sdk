...
T = TypeVar("T", bound="TextToCompanySearchParamsResponse200OutputSearchParamsHeadquartersStateNameType0")



@_attrs_define
class TextToCompanySearchParamsResponse200OutputSearchParamsHeadquartersStateNameType0:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        text_to_company_search_params_response_200_output_search_params_headquarters_state_name_type_0 = cls(
            any_of=any_of,
            none_of=none_of,
        )


        text_to_company_search_params_response_200_output_search_params_headquarters_state_name_type_0.additional_properties = d
        return text_to_company_search_params_response_200_output_search_params_headquarters_state_name_type_0
