...
class PeopleSearchCountBodySearchParamsKeywordSearchOptionsType0:
    """
    Attributes:
        fields_to_search_over (None | PeopleSearchCountBodySearchParamsKeywordSearchOptionsType0FieldsToSearchOverType0
            | Unset):
    """

    fields_to_search_over: (
        None | PeopleSearchCountBodySearchParamsKeywordSearchOptionsType0FieldsToSearchOverType0 | Unset
    ) = UNSET
        ...
        def _parse_fields_to_search_over(
            ...
            try:
                ...
                fields_to_search_over_type_0 = (
                    PeopleSearchCountBodySearchParamsKeywordSearchOptionsType0FieldsToSearchOverType0.from_dict(data)
                )
                ...
                pass
            return cast(
                None | PeopleSearchCountBodySearchParamsKeywordSearchOptionsType0FieldsToSearchOverType0 | Unset, data
            )
