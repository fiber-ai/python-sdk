...
from ..models.poll_combined_search_response_200_output_data_type_0_type import (
    PollCombinedSearchResponse200OutputDataType0Type,
)

if TYPE_CHECKING:
    from ..models.poll_combined_search_response_200_output_data_type_0_items_item import (
        PollCombinedSearchResponse200OutputDataType0ItemsItem,
    )
