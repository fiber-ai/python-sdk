...
from ..models.flight_search_response_200_output_best_flights_item_flight_type_type_1 import (
    FlightSearchResponse200OutputBestFlightsItemFlightTypeType1,
)
from ..models.flight_search_response_200_output_best_flights_item_flight_type_type_2_type_1 import (
    FlightSearchResponse200OutputBestFlightsItemFlightTypeType2Type1,
)
from ..models.flight_search_response_200_output_best_flights_item_flight_type_type_3_type_1 import (
    FlightSearchResponse200OutputBestFlightsItemFlightTypeType3Type1,
)
...
T = TypeVar("T", bound="FlightSearchResponse200OutputBestFlightsItem")


@_attrs_define
class FlightSearchResponse200OutputBestFlightsItem:
    """
    Attributes:
        segments (list[FlightSearchResponse200OutputBestFlightsItemSegmentsItem]): Flight segments for this itinerary.
        layovers (list[FlightSearchResponse200OutputBestFlightsItemLayoversItem]): Layovers for this itinerary.
        ...
        flight_type (FlightSearchResponse200OutputBestFlightsItemFlightTypeType1 |
            FlightSearchResponse200OutputBestFlightsItemFlightTypeType2Type1 |
            FlightSearchResponse200OutputBestFlightsItemFlightTypeType3Type1 | None | Unset): Trip type for this itinerary.
        ...
        carbon_emissions (FlightSearchResponse200OutputBestFlightsItemCarbonEmissionsType0 | None | Unset): Carbon
    ...
    segments: list[FlightSearchResponse200OutputBestFlightsItemSegmentsItem]
    layovers: list[FlightSearchResponse200OutputBestFlightsItemLayoversItem]
    ...
    carbon_emissions: FlightSearchResponse200OutputBestFlightsItemCarbonEmissionsType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.flight_type, Unset):
            flight_type = UNSET
        elif isinstance(self.flight_type, FlightSearchResponse200OutputBestFlightsItemFlightTypeType1):
            flight_type = self.flight_type.value
        elif isinstance(self.flight_type, FlightSearchResponse200OutputBestFlightsItemFlightTypeType2Type1):
            flight_type = self.flight_type.value
        elif isinstance(self.flight_type, FlightSearchResponse200OutputBestFlightsItemFlightTypeType3Type1):
            flight_type = self.flight_type.value
        else:
        ...
        elif isinstance(self.carbon_emissions, FlightSearchResponse200OutputBestFlightsItemCarbonEmissionsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for segments_item_data in _segments:
            segments_item = FlightSearchResponse200OutputBestFlightsItemSegmentsItem.from_dict(segments_item_data)
        ...
        for layovers_item_data in _layovers:
            layovers_item = FlightSearchResponse200OutputBestFlightsItemLayoversItem.from_dict(layovers_item_data)
        ...
        def _parse_flight_type(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                flight_type_type_1 = FlightSearchResponse200OutputBestFlightsItemFlightTypeType1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                flight_type_type_2_type_1 = FlightSearchResponse200OutputBestFlightsItemFlightTypeType2Type1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                flight_type_type_3_type_1 = FlightSearchResponse200OutputBestFlightsItemFlightTypeType3Type1(data)
        ...
        def _parse_carbon_emissions(
            data: object,
        ) -> FlightSearchResponse200OutputBestFlightsItemCarbonEmissionsType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                carbon_emissions_type_0 = FlightSearchResponse200OutputBestFlightsItemCarbonEmissionsType0.from_dict(
                    data
                )
                ...
                pass
            return cast(FlightSearchResponse200OutputBestFlightsItemCarbonEmissionsType0 | None | Unset, data)
        ...
        flight_search_response_200_output_best_flights_item = cls(
            segments=segments,
            layovers=layovers,
        ...
        flight_search_response_200_output_best_flights_item.additional_properties = d
        return flight_search_response_200_output_best_flights_item
