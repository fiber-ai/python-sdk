...
T = TypeVar("T", bound="UpdateAutoTopupSettingsResponse200ChargeInfoType0LowCreditAlertType0")


@_attrs_define
class UpdateAutoTopupSettingsResponse200ChargeInfoType0LowCreditAlertType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_auto_topup_settings_response_200_charge_info_type_0_low_credit_alert_type_0 = cls(
            get_more_credits_url=get_more_credits_url,
            message=message,
            available_credits=available_credits,
        )

        update_auto_topup_settings_response_200_charge_info_type_0_low_credit_alert_type_0.additional_properties = d
        return update_auto_topup_settings_response_200_charge_info_type_0_low_credit_alert_type_0
