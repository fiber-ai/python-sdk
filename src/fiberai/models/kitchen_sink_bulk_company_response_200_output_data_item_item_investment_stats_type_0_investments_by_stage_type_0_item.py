...
T = TypeVar("T", bound="KitchenSinkBulkCompanyResponse200OutputDataItemItemInvestmentStatsType0InvestmentsByStageType0Item")



@_attrs_define
class KitchenSinkBulkCompanyResponse200OutputDataItemItemInvestmentStatsType0InvestmentsByStageType0Item:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        kitchen_sink_bulk_company_response_200_output_data_item_item_investment_stats_type_0_investments_by_stage_type_0_item = cls(
            stage=stage,
            lead_rate=lead_rate,
        ...
        kitchen_sink_bulk_company_response_200_output_data_item_item_investment_stats_type_0_investments_by_stage_type_0_item.additional_properties = d
        return kitchen_sink_bulk_company_response_200_output_data_item_item_investment_stats_type_0_investments_by_stage_type_0_item
