...
from ..models.sync_combined_search_body_company_params_job_posting_stats_type_0_all_of_type_0_item_type_1_range_type_1_type import SyncCombinedSearchBodyCompanyParamsJobPostingStatsType0AllOfType0ItemType1RangeType1Type
from typing import cast

if TYPE_CHECKING:
  from ..models.sync_combined_search_body_company_params_job_posting_stats_type_0_all_of_type_0_item_type_1_range_type_1_range_in_hundredths import SyncCombinedSearchBodyCompanyParamsJobPostingStatsType0AllOfType0ItemType1RangeType1RangeInHundredths
...
class SyncCombinedSearchBodyCompanyParamsJobPostingStatsType0AllOfType0ItemType1RangeType1:
    ...
    type_: SyncCombinedSearchBodyCompanyParamsJobPostingStatsType0AllOfType0ItemType1RangeType1Type
    range_in_hundredths: 'SyncCombinedSearchBodyCompanyParamsJobPostingStatsType0AllOfType0ItemType1RangeType1RangeInHundredths'
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        range_in_hundredths = SyncCombinedSearchBodyCompanyParamsJobPostingStatsType0AllOfType0ItemType1RangeType1RangeInHundredths.from_dict(d.pop("rangeInHundredths"))
