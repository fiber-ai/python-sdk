...
if TYPE_CHECKING:
  ...
  from ..models.bulk_company_logos_response_200_warnings_type_0_item import BulkCompanyLogosResponse200WarningsType0Item
...
class BulkCompanyLogosResponse200:
    """ 
        Attributes:
            ...
            charge_info (Union['BulkCompanyLogosResponse200ChargeInfoType0', 'BulkCompanyLogosResponse200ChargeInfoType1',
                'BulkCompanyLogosResponse200ChargeInfoType2', 'BulkCompanyLogosResponse200ChargeInfoType3']):
            warnings (Union[None, Unset, list['BulkCompanyLogosResponse200WarningsType0Item']]): Warnings about extraneous
                fields in request
     """

    output: 'BulkCompanyLogosResponse200Output'
    charge_info: Union['BulkCompanyLogosResponse200ChargeInfoType0', 'BulkCompanyLogosResponse200ChargeInfoType1', 'BulkCompanyLogosResponse200ChargeInfoType2', 'BulkCompanyLogosResponse200ChargeInfoType3']
    warnings: Union[None, Unset, list['BulkCompanyLogosResponse200WarningsType0Item']] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_charge_info(data: object) -> Union['BulkCompanyLogosResponse200ChargeInfoType0', 'BulkCompanyLogosResponse200ChargeInfoType1', 'BulkCompanyLogosResponse200ChargeInfoType2', 'BulkCompanyLogosResponse200ChargeInfoType3']:
            try:
        ...
        def _parse_warnings(data: object) -> Union[None, Unset, list['BulkCompanyLogosResponse200WarningsType0Item']]:
            if data is None:
                return data
            ...
            try:
                ...
                for warnings_type_0_item_data in (_warnings_type_0):
                    warnings_type_0_item = BulkCompanyLogosResponse200WarningsType0Item.from_dict(warnings_type_0_item_data)
                ...
                pass
            return cast(Union[None, Unset, list['BulkCompanyLogosResponse200WarningsType0Item']], data)
