...
from ..models.company_search_body_search_params_job_postings_v2_type_0_any_of_type_0_item_posted_at_type_1_window_type_1_method import (
    CompanySearchBodySearchParamsJobPostingsV2Type0AnyOfType0ItemPostedAtType1WindowType1Method,
)
from ..models.company_search_body_search_params_job_postings_v2_type_0_any_of_type_0_item_posted_at_type_1_window_type_1_period import (
    CompanySearchBodySearchParamsJobPostingsV2Type0AnyOfType0ItemPostedAtType1WindowType1Period,
)
...
class CompanySearchBodySearchParamsJobPostingsV2Type0AnyOfType0ItemPostedAtType1WindowType1:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        company_search_body_search_params_job_postings_v2_type_0_any_of_type_0_item_posted_at_type_1_window_type_1 = (
            cls(
                method=method,
                period=period,
