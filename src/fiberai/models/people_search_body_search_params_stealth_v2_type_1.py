...
class PeopleSearchBodySearchParamsStealthV2Type1:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.left_stealth_at, PeopleSearchBodySearchParamsStealthV2Type1LeftStealthAtType1):
            left_stealth_at = self.left_stealth_at.to_dict()
        else:
        ...
        elif isinstance(self.entered_stealth_at, PeopleSearchBodySearchParamsStealthV2Type1EnteredStealthAtType1):
            entered_stealth_at = self.entered_stealth_at.to_dict()
        else:
