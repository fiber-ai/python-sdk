...
if TYPE_CHECKING:
    from ..models.quick_person_resolve_response_200_output_data_item_person_type_0_inferred_location_type_0_coordinates_type_0 import (
        QuickPersonResolveResponse200OutputDataItemPersonType0InferredLocationType0CoordinatesType0,
    )


T = TypeVar("T", bound="QuickPersonResolveResponse200OutputDataItemPersonType0InferredLocationType0")


@_attrs_define
class QuickPersonResolveResponse200OutputDataItemPersonType0InferredLocationType0:
    """
    Attributes:
        ...
        coordinates (None | QuickPersonResolveResponse200OutputDataItemPersonType0InferredLocationType0CoordinatesType0
            | Unset):
    ...
    coordinates: (
        None | QuickPersonResolveResponse200OutputDataItemPersonType0InferredLocationType0CoordinatesType0 | Unset
    ) = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.quick_person_resolve_response_200_output_data_item_person_type_0_inferred_location_type_0_coordinates_type_0 import (
            QuickPersonResolveResponse200OutputDataItemPersonType0InferredLocationType0CoordinatesType0,  # noqa: PLC0415
        )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_coordinates(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = QuickPersonResolveResponse200OutputDataItemPersonType0InferredLocationType0CoordinatesType0.from_dict(
                    data
                )
        ...
        quick_person_resolve_response_200_output_data_item_person_type_0_inferred_location_type_0 = cls(
        ...
        quick_person_resolve_response_200_output_data_item_person_type_0_inferred_location_type_0.additional_properties = d
        return quick_person_resolve_response_200_output_data_item_person_type_0_inferred_location_type_0
