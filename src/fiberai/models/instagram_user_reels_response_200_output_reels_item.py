...
T = TypeVar("T", bound="InstagramUserReelsResponse200OutputReelsItem")


@_attrs_define
class InstagramUserReelsResponse200OutputReelsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        instagram_user_reels_response_200_output_reels_item = cls(
            id=id,
            is_video=is_video,
            shortcode=shortcode,
            caption=caption,
        ...
        instagram_user_reels_response_200_output_reels_item.additional_properties = d
        return instagram_user_reels_response_200_output_reels_item
