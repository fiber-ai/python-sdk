...
T = TypeVar("T", bound="PeopleSearchBodySearchParamsExactProfileType0NoneOfType0Item")



@_attrs_define
class PeopleSearchBodySearchParamsExactProfileType0NoneOfType0Item:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        people_search_body_search_params_exact_profile_type_0_none_of_type_0_item = cls(
            profile_id=profile_id,
            primary_slug=primary_slug,
        )


        people_search_body_search_params_exact_profile_type_0_none_of_type_0_item.additional_properties = d
        return people_search_body_search_params_exact_profile_type_0_none_of_type_0_item
