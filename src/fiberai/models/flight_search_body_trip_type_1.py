...
from ..models.flight_search_body_trip_type_1_flight_type import FlightSearchBodyTripType1FlightType

T = TypeVar("T", bound="FlightSearchBodyTripType1")


@_attrs_define
class FlightSearchBodyTripType1:
    """
    Attributes:
        flight_type (FlightSearchBodyTripType1FlightType):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        flight_type = FlightSearchBodyTripType1FlightType(d.pop("flightType"))
        ...
        flight_search_body_trip_type_1 = cls(
        ...
        flight_search_body_trip_type_1.additional_properties = d
        return flight_search_body_trip_type_1
