...
if TYPE_CHECKING:
    from ..models.paginated_combined_search_response_200_output_companies_item_investment_stats_type_0_investments_by_stage_type_0_item import (
        PaginatedCombinedSearchResponse200OutputCompaniesItemInvestmentStatsType0InvestmentsByStageType0Item,
    )


T = TypeVar("T", bound="PaginatedCombinedSearchResponse200OutputCompaniesItemInvestmentStatsType0")


@_attrs_define
class PaginatedCombinedSearchResponse200OutputCompaniesItemInvestmentStatsType0:
    """
    Attributes:
        investments_by_stage
            (list[PaginatedCombinedSearchResponse200OutputCompaniesItemInvestmentStatsType0InvestmentsByStageType0Item] |
            None | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.paginated_combined_search_response_200_output_companies_item_investment_stats_type_0_investments_by_stage_type_0_item import (
            PaginatedCombinedSearchResponse200OutputCompaniesItemInvestmentStatsType0InvestmentsByStageType0Item,  # noqa: PLC0415
        )
        ...
        def _parse_investments_by_stage(
            ...
            try:
                ...
                for investments_by_stage_type_0_item_data in _investments_by_stage_type_0:
                    investments_by_stage_type_0_item = PaginatedCombinedSearchResponse200OutputCompaniesItemInvestmentStatsType0InvestmentsByStageType0Item.from_dict(
        ...
        paginated_combined_search_response_200_output_companies_item_investment_stats_type_0 = cls(
        ...
        paginated_combined_search_response_200_output_companies_item_investment_stats_type_0.additional_properties = d
        return paginated_combined_search_response_200_output_companies_item_investment_stats_type_0
