...
T = TypeVar("T", bound="TextToCombinedSearchResponse200OutputDataCompaniesItemEmployeeTrendsType0ItemChangesType0Item")


@_attrs_define
class TextToCombinedSearchResponse200OutputDataCompaniesItemEmployeeTrendsType0ItemChangesType0Item:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        text_to_combined_search_response_200_output_data_companies_item_employee_trends_type_0_item_changes_type_0_item = cls(
            count_end=count_end,
        ...
        text_to_combined_search_response_200_output_data_companies_item_employee_trends_type_0_item_changes_type_0_item.additional_properties = d
        return text_to_combined_search_response_200_output_data_companies_item_employee_trends_type_0_item_changes_type_0_item
