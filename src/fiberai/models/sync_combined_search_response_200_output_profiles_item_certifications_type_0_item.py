...
T = TypeVar("T", bound="SyncCombinedSearchResponse200OutputProfilesItemCertificationsType0Item")


@_attrs_define
class SyncCombinedSearchResponse200OutputProfilesItemCertificationsType0Item:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sync_combined_search_response_200_output_profiles_item_certifications_type_0_item = cls(
            title=title,
        ...
        sync_combined_search_response_200_output_profiles_item_certifications_type_0_item.additional_properties = d
        return sync_combined_search_response_200_output_profiles_item_certifications_type_0_item
