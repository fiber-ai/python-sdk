...
T = TypeVar("T", bound="TiktokSearchHashtagBody")


@_attrs_define
class TiktokSearchHashtagBody:
    """
    Attributes:
        api_key (str): Your Fiber API key
        query (str): Hashtag to search for (with or without leading '#', e.g. 'fitness' or '#fitness'). The '#' is
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        tiktok_search_hashtag_body = cls(
            api_key=api_key,
            query=query,
            next_page_token=next_page_token,
        )

        tiktok_search_hashtag_body.additional_properties = d
        return tiktok_search_hashtag_body
