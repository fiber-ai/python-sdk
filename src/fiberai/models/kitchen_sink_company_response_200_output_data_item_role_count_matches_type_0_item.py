        ...
        def _parse_num_matching_employees(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                num_matching_employees_type_0 = KitchenSinkCompanyResponse200OutputDataItemRoleCountMatchesType0ItemNumMatchingEmployeesType0.from_dict(
                    data
                )
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                num_matching_employees_type_1 = KitchenSinkCompanyResponse200OutputDataItemRoleCountMatchesType0ItemNumMatchingEmployeesType1.from_dict(
                    data
                )
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                num_matching_employees_type_2 = KitchenSinkCompanyResponse200OutputDataItemRoleCountMatchesType0ItemNumMatchingEmployeesType2.from_dict(
                    data
                )
            ...
            num_matching_employees_type_3 = (
                KitchenSinkCompanyResponse200OutputDataItemRoleCountMatchesType0ItemNumMatchingEmployeesType3.from_dict(
                    data
                )
            )
