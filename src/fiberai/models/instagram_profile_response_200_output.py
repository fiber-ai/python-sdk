...
T = TypeVar("T", bound="InstagramProfileResponse200Output")


@_attrs_define
class InstagramProfileResponse200Output:
    """
    Attributes:
        ...
        post_count (float | None | Unset): Total number of posts.
        is_verified (bool | None | Unset): Whether the account is verified.
        is_private (bool | None | Unset): Whether the account is private.
        is_business_account (bool | None | Unset): Whether this is a business account.
        business_category (None | str | Unset): Business category (e.g. 'Media/News Company'). Null for personal
            accounts.
    ...
    post_count: float | None | Unset = UNSET
    is_verified: bool | None | Unset = UNSET
    is_private: bool | None | Unset = UNSET
    is_business_account: bool | None | Unset = UNSET
    business_category: None | str | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        post_count: float | None | Unset
        if isinstance(self.post_count, Unset):
            post_count = UNSET
        else:
        ...
        is_business_account: bool | None | Unset
        if isinstance(self.is_business_account, Unset):
            is_business_account = UNSET
        else:
            is_business_account = self.is_business_account

        business_category: None | str | Unset
        if isinstance(self.business_category, Unset):
            business_category = UNSET
        else:
        ...
        if post_count is not UNSET:
            field_dict["postCount"] = post_count
        ...
        if business_category is not UNSET:
            field_dict["businessCategory"] = business_category
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_post_count(data: object) -> float | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        post_count = _parse_post_count(d.pop("postCount", UNSET))
        ...
        def _parse_is_business_account(data: object) -> bool | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        is_business_account = _parse_is_business_account(d.pop("isBusinessAccount", UNSET))

        def _parse_business_category(data: object) -> None | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        business_category = _parse_business_category(d.pop("businessCategory", UNSET))
        ...
        instagram_profile_response_200_output = cls(
            id=id,
            handle=handle,
        ...
        instagram_profile_response_200_output.additional_properties = d
        return instagram_profile_response_200_output
