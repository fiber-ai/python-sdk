...
if TYPE_CHECKING:
    from ..models.text_to_profile_search_response_200_output_data_item_inferred_location_type_0_coordinates_type_0 import (
        TextToProfileSearchResponse200OutputDataItemInferredLocationType0CoordinatesType0,
    )
...
class TextToProfileSearchResponse200OutputDataItemInferredLocationType0:
    ...
    Attributes:
        ...
        coordinates (None | TextToProfileSearchResponse200OutputDataItemInferredLocationType0CoordinatesType0 | Unset):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.coordinates, Unset):
            ...
            self.coordinates, TextToProfileSearchResponse200OutputDataItemInferredLocationType0CoordinatesType0
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_coordinates(
            data: object,
        ) -> None | TextToProfileSearchResponse200OutputDataItemInferredLocationType0CoordinatesType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = (
                    TextToProfileSearchResponse200OutputDataItemInferredLocationType0CoordinatesType0.from_dict(data)
                )
                ...
                pass
            return cast(
                None | TextToProfileSearchResponse200OutputDataItemInferredLocationType0CoordinatesType0 | Unset, data
            )
