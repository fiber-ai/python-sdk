...
T = TypeVar(
    "T",
    bound="CreateSavedSearchBodySearchParamsType0ProfileSearchParamsEducationV2Type0AllOfType0ItemSchoolType0ExactType0",
)


@_attrs_define
class CreateSavedSearchBodySearchParamsType0ProfileSearchParamsEducationV2Type0AllOfType0ItemSchoolType0ExactType0:
    """
    Attributes:
        any_of (list[CreateSavedSearchBodySearchParamsType0ProfileSearchParamsEducationV2Type0AllOfType0ItemSchoolType0E
            xactType0AnyOfType0ItemType0 | CreateSavedSearchBodySearchParamsType0ProfileSearchParamsEducationV2Type0AllOfTyp
            e0ItemSchoolType0ExactType0AnyOfType0ItemType1 | CreateSavedSearchBodySearchParamsType0ProfileSearchParamsEducat
            ionV2Type0AllOfType0ItemSchoolType0ExactType0AnyOfType0ItemType2 | CreateSavedSearchBodySearchParamsType0Profile
            SearchParamsEducationV2Type0AllOfType0ItemSchoolType0ExactType0AnyOfType0ItemType3] | None | Unset):
        none_of (list[CreateSavedSearchBodySearchParamsType0ProfileSearchParamsEducationV2Type0AllOfType0ItemSchoolType0
            ExactType0NoneOfType0ItemType0 | CreateSavedSearchBodySearchParamsType0ProfileSearchParamsEducationV2Type0AllOfT
            ype0ItemSchoolType0ExactType0NoneOfType0ItemType1 | CreateSavedSearchBodySearchParamsType0ProfileSearchParamsEdu
            cationV2Type0AllOfType0ItemSchoolType0ExactType0NoneOfType0ItemType2 | CreateSavedSearchBodySearchParamsType0Pro
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
                    ...
                    def _parse_any_of_type_0_item(
                        ...
                        try:
                            if not isinstance(data, dict):
                                raise TypeError()
                            any_of_type_0_item_type_0 = CreateSavedSearchBodySearchParamsType0ProfileSearchParamsEducationV2Type0AllOfType0ItemSchoolType0ExactType0AnyOfType0ItemType0.from_dict(
                                data
                            )
                        ...
                        try:
                            if not isinstance(data, dict):
                                raise TypeError()
                            any_of_type_0_item_type_1 = CreateSavedSearchBodySearchParamsType0ProfileSearchParamsEducationV2Type0AllOfType0ItemSchoolType0ExactType0AnyOfType0ItemType1.from_dict(
                                data
                            )
                        ...
                        try:
                            if not isinstance(data, dict):
                                raise TypeError()
                            any_of_type_0_item_type_2 = CreateSavedSearchBodySearchParamsType0ProfileSearchParamsEducationV2Type0AllOfType0ItemSchoolType0ExactType0AnyOfType0ItemType2.from_dict(
                                data
                            )
                        ...
                        if not isinstance(data, dict):
                            raise TypeError()
                        any_of_type_0_item_type_3 = CreateSavedSearchBodySearchParamsType0ProfileSearchParamsEducationV2Type0AllOfType0ItemSchoolType0ExactType0AnyOfType0ItemType3.from_dict(
                            data
                        )
                ...
                for none_of_type_0_item_data in _none_of_type_0:
                    ...
                    def _parse_none_of_type_0_item(
                        ...
                        try:
                            if not isinstance(data, dict):
                                raise TypeError()
                            none_of_type_0_item_type_0 = CreateSavedSearchBodySearchParamsType0ProfileSearchParamsEducationV2Type0AllOfType0ItemSchoolType0ExactType0NoneOfType0ItemType0.from_dict(
                                data
                            )
                        ...
                        try:
                            if not isinstance(data, dict):
                                raise TypeError()
                            none_of_type_0_item_type_1 = CreateSavedSearchBodySearchParamsType0ProfileSearchParamsEducationV2Type0AllOfType0ItemSchoolType0ExactType0NoneOfType0ItemType1.from_dict(
                                data
                            )
                        ...
                        try:
                            if not isinstance(data, dict):
                                raise TypeError()
                            none_of_type_0_item_type_2 = CreateSavedSearchBodySearchParamsType0ProfileSearchParamsEducationV2Type0AllOfType0ItemSchoolType0ExactType0NoneOfType0ItemType2.from_dict(
                                data
                            )
                        ...
                        if not isinstance(data, dict):
                            raise TypeError()
                        none_of_type_0_item_type_3 = CreateSavedSearchBodySearchParamsType0ProfileSearchParamsEducationV2Type0AllOfType0ItemSchoolType0ExactType0NoneOfType0ItemType3.from_dict(
                            data
                        )
        ...
        create_saved_search_body_search_params_type_0_profile_search_params_education_v2_type_0_all_of_type_0_item_school_type_0_exact_type_0 = cls(
            any_of=any_of,
            none_of=none_of,
        )

        create_saved_search_body_search_params_type_0_profile_search_params_education_v2_type_0_all_of_type_0_item_school_type_0_exact_type_0.additional_properties = d
        return create_saved_search_body_search_params_type_0_profile_search_params_education_v2_type_0_all_of_type_0_item_school_type_0_exact_type_0
