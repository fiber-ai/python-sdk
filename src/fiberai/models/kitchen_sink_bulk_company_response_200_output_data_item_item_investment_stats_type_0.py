...
if TYPE_CHECKING:
    from ..models.kitchen_sink_bulk_company_response_200_output_data_item_item_investment_stats_type_0_investments_by_stage_type_0_item import (
        KitchenSinkBulkCompanyResponse200OutputDataItemItemInvestmentStatsType0InvestmentsByStageType0Item,
    )
...
class KitchenSinkBulkCompanyResponse200OutputDataItemItemInvestmentStatsType0:
    ...
    Attributes:
        investments_by_stage
            (list[KitchenSinkBulkCompanyResponse200OutputDataItemItemInvestmentStatsType0InvestmentsByStageType0Item] | None
            | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.kitchen_sink_bulk_company_response_200_output_data_item_item_investment_stats_type_0_investments_by_stage_type_0_item import (
            KitchenSinkBulkCompanyResponse200OutputDataItemItemInvestmentStatsType0InvestmentsByStageType0Item,  # noqa: PLC0415
        )
        ...
        def _parse_investments_by_stage(
            ...
            try:
                ...
                for investments_by_stage_type_0_item_data in _investments_by_stage_type_0:
                    investments_by_stage_type_0_item = KitchenSinkBulkCompanyResponse200OutputDataItemItemInvestmentStatsType0InvestmentsByStageType0Item.from_dict(
