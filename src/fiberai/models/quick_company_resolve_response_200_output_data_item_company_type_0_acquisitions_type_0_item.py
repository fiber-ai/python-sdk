...
T = TypeVar("T", bound="QuickCompanyResolveResponse200OutputDataItemCompanyType0AcquisitionsType0Item")


@_attrs_define
class QuickCompanyResolveResponse200OutputDataItemCompanyType0AcquisitionsType0Item:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        quick_company_resolve_response_200_output_data_item_company_type_0_acquisitions_type_0_item = cls(
            price_usd=price_usd,
            acquiree_name=acquiree_name,
            acquisition_date=acquisition_date,
        )

        quick_company_resolve_response_200_output_data_item_company_type_0_acquisitions_type_0_item.additional_properties = d
        return quick_company_resolve_response_200_output_data_item_company_type_0_acquisitions_type_0_item
