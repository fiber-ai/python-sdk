...
from ..models.combined_search_body_company_params_employee_trends_type_0_obeys_any_type_0_item_count_criteria_type_2_type import CombinedSearchBodyCompanyParamsEmployeeTrendsType0ObeysAnyType0ItemCountCriteriaType2Type
from typing import cast

if TYPE_CHECKING:
  from ..models.combined_search_body_company_params_employee_trends_type_0_obeys_any_type_0_item_count_criteria_type_2_range import CombinedSearchBodyCompanyParamsEmployeeTrendsType0ObeysAnyType0ItemCountCriteriaType2Range
...
class CombinedSearchBodyCompanyParamsEmployeeTrendsType0ObeysAnyType0ItemCountCriteriaType2:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        range_ = CombinedSearchBodyCompanyParamsEmployeeTrendsType0ObeysAnyType0ItemCountCriteriaType2Range.from_dict(d.pop("range"))
