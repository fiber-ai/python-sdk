...
class KitchenSinkCompanyResponse200OutputDataItemLiJobPostsStatsType0JobLocationTypeStatsType0:
    """
    Attributes:
        on_site (KitchenSinkCompanyResponse200OutputDataItemLiJobPostsStatsType0JobLocationTypeStatsType0OnSite |
            Unset):
        remote (KitchenSinkCompanyResponse200OutputDataItemLiJobPostsStatsType0JobLocationTypeStatsType0Remote | Unset):
        hybrid (KitchenSinkCompanyResponse200OutputDataItemLiJobPostsStatsType0JobLocationTypeStatsType0Hybrid | Unset):
    """

    on_site: KitchenSinkCompanyResponse200OutputDataItemLiJobPostsStatsType0JobLocationTypeStatsType0OnSite | Unset = (
        UNSET
    )
    remote: KitchenSinkCompanyResponse200OutputDataItemLiJobPostsStatsType0JobLocationTypeStatsType0Remote | Unset = (
        UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_on_site, Unset):
            ...
            on_site = KitchenSinkCompanyResponse200OutputDataItemLiJobPostsStatsType0JobLocationTypeStatsType0OnSite.from_dict(
                _on_site
            )
        ...
        if isinstance(_remote, Unset):
            ...
            remote = KitchenSinkCompanyResponse200OutputDataItemLiJobPostsStatsType0JobLocationTypeStatsType0Remote.from_dict(
                _remote
            )
        ...
        if isinstance(_hybrid, Unset):
            ...
            hybrid = KitchenSinkCompanyResponse200OutputDataItemLiJobPostsStatsType0JobLocationTypeStatsType0Hybrid.from_dict(
                _hybrid
            )

        kitchen_sink_company_response_200_output_data_item_li_job_posts_stats_type_0_job_location_type_stats_type_0 = (
            cls(
                on_site=on_site,
                remote=remote,
                hybrid=hybrid,
