...
T = TypeVar("T", bound="PeopleSearchResponse200OutputDataItemVolunteeringType0Item")


@_attrs_define
class PeopleSearchResponse200OutputDataItemVolunteeringType0Item:
    """
    Attributes:
        role (None | str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        people_search_response_200_output_data_item_volunteering_type_0_item = cls(
            role=role,
        ...
        people_search_response_200_output_data_item_volunteering_type_0_item.additional_properties = d
        return people_search_response_200_output_data_item_volunteering_type_0_item
