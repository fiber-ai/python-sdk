...
T = TypeVar("T", bound="PollCombinedSearchResponse200OutputDataType0ItemsItemLocationsStatsType0")


@_attrs_define
class PollCombinedSearchResponse200OutputDataType0ItemsItemLocationsStatsType0:
    """
    Attributes:
        usa (float | Unset):
        gbr (float | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        poll_combined_search_response_200_output_data_type_0_items_item_locations_stats_type_0 = cls(
            usa=usa,
            gbr=gbr,
            fra=fra,
            ind=ind,
        ...
        return poll_combined_search_response_200_output_data_type_0_items_item_locations_stats_type_0
