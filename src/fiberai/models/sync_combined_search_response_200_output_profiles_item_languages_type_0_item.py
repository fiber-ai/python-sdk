...
T = TypeVar("T", bound="SyncCombinedSearchResponse200OutputProfilesItemLanguagesType0Item")



@_attrs_define
class SyncCombinedSearchResponse200OutputProfilesItemLanguagesType0Item:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sync_combined_search_response_200_output_profiles_item_languages_type_0_item = cls(
            name=name,
        ...
        sync_combined_search_response_200_output_profiles_item_languages_type_0_item.additional_properties = d
        return sync_combined_search_response_200_output_profiles_item_languages_type_0_item
