...
T = TypeVar("T", bound="PeopleSearchResponse200OutputDataItemCertificationsType0Item")


@_attrs_define
class PeopleSearchResponse200OutputDataItemCertificationsType0Item:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        people_search_response_200_output_data_item_certifications_type_0_item = cls(
            title=title,
        ...
        people_search_response_200_output_data_item_certifications_type_0_item.additional_properties = d
        return people_search_response_200_output_data_item_certifications_type_0_item
