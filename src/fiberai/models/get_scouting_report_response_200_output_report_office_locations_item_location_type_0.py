...
if TYPE_CHECKING:
    from ..models.get_scouting_report_response_200_output_report_office_locations_item_location_type_0_coordinates_type_0 import (
        GetScoutingReportResponse200OutputReportOfficeLocationsItemLocationType0CoordinatesType0,
    )


T = TypeVar("T", bound="GetScoutingReportResponse200OutputReportOfficeLocationsItemLocationType0")


@_attrs_define
class GetScoutingReportResponse200OutputReportOfficeLocationsItemLocationType0:
    """
    Attributes:
        ...
        coordinates (GetScoutingReportResponse200OutputReportOfficeLocationsItemLocationType0CoordinatesType0 | None |
            Unset):
    ...
    coordinates: (
        GetScoutingReportResponse200OutputReportOfficeLocationsItemLocationType0CoordinatesType0 | None | Unset
    ) = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.get_scouting_report_response_200_output_report_office_locations_item_location_type_0_coordinates_type_0 import (
            GetScoutingReportResponse200OutputReportOfficeLocationsItemLocationType0CoordinatesType0,  # noqa: PLC0415
        )
        ...
        if isinstance(self.coordinates, Unset):
            ...
            self.coordinates, GetScoutingReportResponse200OutputReportOfficeLocationsItemLocationType0CoordinatesType0
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_coordinates(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = (
                    GetScoutingReportResponse200OutputReportOfficeLocationsItemLocationType0CoordinatesType0.from_dict(
                        data
                    )
                )
        ...
        get_scouting_report_response_200_output_report_office_locations_item_location_type_0 = cls(
        ...
        get_scouting_report_response_200_output_report_office_locations_item_location_type_0.additional_properties = d
        return get_scouting_report_response_200_output_report_office_locations_item_location_type_0
