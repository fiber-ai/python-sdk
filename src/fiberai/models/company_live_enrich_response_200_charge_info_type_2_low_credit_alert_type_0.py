...
T = TypeVar("T", bound="CompanyLiveEnrichResponse200ChargeInfoType2LowCreditAlertType0")


@_attrs_define
class CompanyLiveEnrichResponse200ChargeInfoType2LowCreditAlertType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        company_live_enrich_response_200_charge_info_type_2_low_credit_alert_type_0 = cls(
            get_more_credits_url=get_more_credits_url,
            message=message,
            available_credits=available_credits,
        )

        company_live_enrich_response_200_charge_info_type_2_low_credit_alert_type_0.additional_properties = d
        return company_live_enrich_response_200_charge_info_type_2_low_credit_alert_type_0
