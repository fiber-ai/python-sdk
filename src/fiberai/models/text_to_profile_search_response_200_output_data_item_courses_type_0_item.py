...
T = TypeVar("T", bound="TextToProfileSearchResponse200OutputDataItemCoursesType0Item")



@_attrs_define
class TextToProfileSearchResponse200OutputDataItemCoursesType0Item:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        text_to_profile_search_response_200_output_data_item_courses_type_0_item = cls(
            title=title,
        ...
        text_to_profile_search_response_200_output_data_item_courses_type_0_item.additional_properties = d
        return text_to_profile_search_response_200_output_data_item_courses_type_0_item
