...
from ..models.poll_batch_live_enrich_response_200_output_results_item_profile_type_0_current_job_type_0_academic_qualification_type_0_item import (
    PollBatchLiveEnrichResponse200OutputResultsItemProfileType0CurrentJobType0AcademicQualificationType0Item,
)
from ..models.poll_batch_live_enrich_response_200_output_results_item_profile_type_0_current_job_type_0_employment_type_type_0_item import (
    PollBatchLiveEnrichResponse200OutputResultsItemProfileType0CurrentJobType0EmploymentTypeType0Item,
)
from ..models.poll_batch_live_enrich_response_200_output_results_item_profile_type_0_current_job_type_0_job_function_type_0_item import (
    PollBatchLiveEnrichResponse200OutputResultsItemProfileType0CurrentJobType0JobFunctionType0Item,
)
from ..models.poll_batch_live_enrich_response_200_output_results_item_profile_type_0_current_job_type_0_seniority_type_1 import (
    PollBatchLiveEnrichResponse200OutputResultsItemProfileType0CurrentJobType0SeniorityType1,
)
from ..models.poll_batch_live_enrich_response_200_output_results_item_profile_type_0_current_job_type_0_seniority_type_2_type_1 import (
    PollBatchLiveEnrichResponse200OutputResultsItemProfileType0CurrentJobType0SeniorityType2Type1,
)
from ..models.poll_batch_live_enrich_response_200_output_results_item_profile_type_0_current_job_type_0_seniority_type_3_type_1 import (
    PollBatchLiveEnrichResponse200OutputResultsItemProfileType0CurrentJobType0SeniorityType3Type1,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PollBatchLiveEnrichResponse200OutputResultsItemProfileType0CurrentJobType0")


@_attrs_define
class PollBatchLiveEnrichResponse200OutputResultsItemProfileType0CurrentJobType0:
    """
    Attributes:
        ...
        seniority (None | PollBatchLiveEnrichResponse200OutputResultsItemProfileType0CurrentJobType0SeniorityType1 |
            PollBatchLiveEnrichResponse200OutputResultsItemProfileType0CurrentJobType0SeniorityType2Type1 |
            PollBatchLiveEnrichResponse200OutputResultsItemProfileType0CurrentJobType0SeniorityType3Type1 | Unset):
        job_function
            (list[PollBatchLiveEnrichResponse200OutputResultsItemProfileType0CurrentJobType0JobFunctionType0Item] | None |
            Unset):
        employment_type
            (list[PollBatchLiveEnrichResponse200OutputResultsItemProfileType0CurrentJobType0EmploymentTypeType0Item] | None
            | Unset):
        academic_qualification
            (list[PollBatchLiveEnrichResponse200OutputResultsItemProfileType0CurrentJobType0AcademicQualificationType0Item]
            | None | Unset):
    ...
    job_function: (
        list[PollBatchLiveEnrichResponse200OutputResultsItemProfileType0CurrentJobType0JobFunctionType0Item]
        | None
        | Unset
    ) = UNSET
    employment_type: (
        list[PollBatchLiveEnrichResponse200OutputResultsItemProfileType0CurrentJobType0EmploymentTypeType0Item]
        | None
        | Unset
    ) = UNSET
    academic_qualification: (
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.seniority, Unset):
            ...
            self.seniority, PollBatchLiveEnrichResponse200OutputResultsItemProfileType0CurrentJobType0SeniorityType1
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_seniority(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                seniority_type_1 = (
                    PollBatchLiveEnrichResponse200OutputResultsItemProfileType0CurrentJobType0SeniorityType1(data)
                )
            ...
            try:
                ...
                seniority_type_2_type_1 = (
                    PollBatchLiveEnrichResponse200OutputResultsItemProfileType0CurrentJobType0SeniorityType2Type1(data)
                )
            ...
            try:
                ...
                seniority_type_3_type_1 = (
                    PollBatchLiveEnrichResponse200OutputResultsItemProfileType0CurrentJobType0SeniorityType3Type1(data)
                )
        ...
        def _parse_employment_type(
            ...
            try:
                ...
                for employment_type_type_0_item_data in _employment_type_type_0:
                    employment_type_type_0_item = PollBatchLiveEnrichResponse200OutputResultsItemProfileType0CurrentJobType0EmploymentTypeType0Item(
        ...
        def _parse_academic_qualification(
            ...
            try:
                ...
                for academic_qualification_type_0_item_data in _academic_qualification_type_0:
                    academic_qualification_type_0_item = PollBatchLiveEnrichResponse200OutputResultsItemProfileType0CurrentJobType0AcademicQualificationType0Item(
        ...
        poll_batch_live_enrich_response_200_output_results_item_profile_type_0_current_job_type_0 = cls(
        ...
        poll_batch_live_enrich_response_200_output_results_item_profile_type_0_current_job_type_0.additional_properties = d
        return poll_batch_live_enrich_response_200_output_results_item_profile_type_0_current_job_type_0
