...
from ..models.flight_booking_options_body_trip_type_1_flight_type import FlightBookingOptionsBodyTripType1FlightType

T = TypeVar("T", bound="FlightBookingOptionsBodyTripType1")


@_attrs_define
class FlightBookingOptionsBodyTripType1:
    """
    Attributes:
        flight_type (FlightBookingOptionsBodyTripType1FlightType):
        ...
        return_date (str): ISO date in YYYY-MM-DD format (e.g. '2026-06-10').
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        flight_type = FlightBookingOptionsBodyTripType1FlightType(d.pop("flightType"))
        ...
        return_date = d.pop("returnDate")

        flight_booking_options_body_trip_type_1 = cls(
        ...
        flight_booking_options_body_trip_type_1.additional_properties = d
        return flight_booking_options_body_trip_type_1
