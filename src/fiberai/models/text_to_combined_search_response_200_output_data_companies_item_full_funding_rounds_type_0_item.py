...
if TYPE_CHECKING:
    from ..models.text_to_combined_search_response_200_output_data_companies_item_full_funding_rounds_type_0_item_investors_type_0_item import (
        TextToCombinedSearchResponse200OutputDataCompaniesItemFullFundingRoundsType0ItemInvestorsType0Item,
    )
...
class TextToCombinedSearchResponse200OutputDataCompaniesItemFullFundingRoundsType0Item:
    ...
    Attributes:
        investors
            (list[TextToCombinedSearchResponse200OutputDataCompaniesItemFullFundingRoundsType0ItemInvestorsType0Item] | None
            | Unset):
        ...
        def _parse_investors(
            ...
            try:
                ...
                for investors_type_0_item_data in _investors_type_0:
                    investors_type_0_item = TextToCombinedSearchResponse200OutputDataCompaniesItemFullFundingRoundsType0ItemInvestorsType0Item.from_dict(
