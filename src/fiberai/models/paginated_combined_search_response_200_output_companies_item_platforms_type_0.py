...
T = TypeVar("T", bound="PaginatedCombinedSearchResponse200OutputCompaniesItemPlatformsType0")


@_attrs_define
class PaginatedCombinedSearchResponse200OutputCompaniesItemPlatformsType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        paginated_combined_search_response_200_output_companies_item_platforms_type_0 = cls(
            ecommerce=ecommerce,
            cms=cms,
            crm=crm,
            marketing=marketing,
        ...
        paginated_combined_search_response_200_output_companies_item_platforms_type_0.additional_properties = d
        return paginated_combined_search_response_200_output_companies_item_platforms_type_0
