...
from ..models.profile_live_enrich_response_200_profile_found_and_enriched_profile_detailed_work_experiences_type_0_item_academic_qualification_type_0_item import (
    ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileDetailedWorkExperiencesType0ItemAcademicQualificationType0Item,
)
from ..models.profile_live_enrich_response_200_profile_found_and_enriched_profile_detailed_work_experiences_type_0_item_employment_type_type_0_item import (
    ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileDetailedWorkExperiencesType0ItemEmploymentTypeType0Item,
)
from ..models.profile_live_enrich_response_200_profile_found_and_enriched_profile_detailed_work_experiences_type_0_item_job_function_type_0_item import (
    ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileDetailedWorkExperiencesType0ItemJobFunctionType0Item,
)
from ..models.profile_live_enrich_response_200_profile_found_and_enriched_profile_detailed_work_experiences_type_0_item_seniority_type_1 import (
    ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileDetailedWorkExperiencesType0ItemSeniorityType1,
)
from ..models.profile_live_enrich_response_200_profile_found_and_enriched_profile_detailed_work_experiences_type_0_item_seniority_type_2_type_1 import (
    ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileDetailedWorkExperiencesType0ItemSeniorityType2Type1,
)
from ..models.profile_live_enrich_response_200_profile_found_and_enriched_profile_detailed_work_experiences_type_0_item_seniority_type_3_type_1 import (
    ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileDetailedWorkExperiencesType0ItemSeniorityType3Type1,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.profile_live_enrich_response_200_profile_found_and_enriched_profile_detailed_work_experiences_type_0_item_company_details_type_0 import (
        ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileDetailedWorkExperiencesType0ItemCompanyDetailsType0,
    )
...
class ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileDetailedWorkExperiencesType0Item:
    ...
    Attributes:
        ...
        seniority (None |
            ...
            ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileDetailedWorkExperiencesType0ItemSeniorityType3Type1 |
            Unset):
        job_function (list[ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileDetailedWorkExperiencesType0ItemJob
            FunctionType0Item] | None | Unset):
        employment_type (list[ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileDetailedWorkExperiencesType0Item
            EmploymentTypeType0Item] | None | Unset):
        academic_qualification (list[ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileDetailedWorkExperiencesTy
            pe0ItemAcademicQualificationType0Item] | None | Unset):
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.profile_live_enrich_response_200_profile_found_and_enriched_profile_detailed_work_experiences_type_0_item_company_details_type_0 import (
            ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileDetailedWorkExperiencesType0ItemCompanyDetailsType0,  # noqa: PLC0415
        )
        ...
        def _parse_company_details(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                company_details_type_0 = ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileDetailedWorkExperiencesType0ItemCompanyDetailsType0.from_dict(
                    data
                )
        ...
        def _parse_seniority(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                seniority_type_1 = ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileDetailedWorkExperiencesType0ItemSeniorityType1(
                    data
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                seniority_type_2_type_1 = ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileDetailedWorkExperiencesType0ItemSeniorityType2Type1(
                    data
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                seniority_type_3_type_1 = ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileDetailedWorkExperiencesType0ItemSeniorityType3Type1(
                    data
                )
        ...
        def _parse_job_function(
            ...
            try:
                ...
                for job_function_type_0_item_data in _job_function_type_0:
                    job_function_type_0_item = ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileDetailedWorkExperiencesType0ItemJobFunctionType0Item(
        ...
        def _parse_employment_type(
            ...
            try:
                ...
                for employment_type_type_0_item_data in _employment_type_type_0:
                    employment_type_type_0_item = ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileDetailedWorkExperiencesType0ItemEmploymentTypeType0Item(
        ...
        def _parse_academic_qualification(
            ...
            try:
                ...
                for academic_qualification_type_0_item_data in _academic_qualification_type_0:
                    academic_qualification_type_0_item = ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileDetailedWorkExperiencesType0ItemAcademicQualificationType0Item(
