...
T = TypeVar("T", bound="HotelSearchResponse200OutputPropertiesItemTotalRateType0")


@_attrs_define
class HotelSearchResponse200OutputPropertiesItemTotalRateType0:
    """Total rate summary for the entire requested stay, from check-in through check-out. The all-in amount includes taxes
    and fees when supplied; otherwise `baseCost` is provided.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        hotel_search_response_200_output_properties_item_total_rate_type_0 = cls(
            currency_code=currency_code,
            all_in_cost=all_in_cost,
            base_cost=base_cost,
        )

        hotel_search_response_200_output_properties_item_total_rate_type_0.additional_properties = d
        return hotel_search_response_200_output_properties_item_total_rate_type_0
