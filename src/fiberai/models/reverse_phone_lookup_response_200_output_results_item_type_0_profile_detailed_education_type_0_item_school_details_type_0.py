...
T = TypeVar(
    "T", bound="ReversePhoneLookupResponse200OutputResultsItemType0ProfileDetailedEducationType0ItemSchoolDetailsType0"
)


@_attrs_define
class ReversePhoneLookupResponse200OutputResultsItemType0ProfileDetailedEducationType0ItemSchoolDetailsType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reverse_phone_lookup_response_200_output_results_item_type_0_profile_detailed_education_type_0_item_school_details_type_0 = cls(
        ...
        reverse_phone_lookup_response_200_output_results_item_type_0_profile_detailed_education_type_0_item_school_details_type_0.additional_properties = d
        return reverse_phone_lookup_response_200_output_results_item_type_0_profile_detailed_education_type_0_item_school_details_type_0
