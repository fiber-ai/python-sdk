...
T = TypeVar("T", bound="StandardizeCompanyResponse200Output")


@_attrs_define
class StandardizeCompanyResponse200Output:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        standardize_company_response_200_output = cls(
            linkedin_url=linkedin_url,
            name=name,
            website_url=website_url,
        )

        standardize_company_response_200_output.additional_properties = d
        return standardize_company_response_200_output
