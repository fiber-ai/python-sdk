...
from ..models.text_to_combined_search_response_200_output_data_companies_item_employee_trends_type_0_item_functions_type_1 import (
    TextToCombinedSearchResponse200OutputDataCompaniesItemEmployeeTrendsType0ItemFunctionsType1,
)
from ..models.text_to_combined_search_response_200_output_data_companies_item_employee_trends_type_0_item_functions_type_2_type_1 import (
    TextToCombinedSearchResponse200OutputDataCompaniesItemEmployeeTrendsType0ItemFunctionsType2Type1,
)
from ..models.text_to_combined_search_response_200_output_data_companies_item_employee_trends_type_0_item_functions_type_3_type_1 import (
    TextToCombinedSearchResponse200OutputDataCompaniesItemEmployeeTrendsType0ItemFunctionsType3Type1,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.text_to_combined_search_response_200_output_data_companies_item_employee_trends_type_0_item_changes_type_0_item import (
        TextToCombinedSearchResponse200OutputDataCompaniesItemEmployeeTrendsType0ItemChangesType0Item,
    )
...
class TextToCombinedSearchResponse200OutputDataCompaniesItemEmployeeTrendsType0Item:
    """
    Attributes:
        functions (None | TextToCombinedSearchResponse200OutputDataCompaniesItemEmployeeTrendsType0ItemFunctionsType1 |
            TextToCombinedSearchResponse200OutputDataCompaniesItemEmployeeTrendsType0ItemFunctionsType2Type1 |
        ...
        changes (list[TextToCombinedSearchResponse200OutputDataCompaniesItemEmployeeTrendsType0ItemChangesType0Item] |
            None | Unset):
    """
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.functions, Unset):
            ...
            self.functions, TextToCombinedSearchResponse200OutputDataCompaniesItemEmployeeTrendsType0ItemFunctionsType1
        ):
        ...
        def _parse_functions(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                functions_type_1 = (
                    TextToCombinedSearchResponse200OutputDataCompaniesItemEmployeeTrendsType0ItemFunctionsType1(data)
                )
        ...
        def _parse_changes(
            ...
            try:
                ...
                for changes_type_0_item_data in _changes_type_0:
                    changes_type_0_item = TextToCombinedSearchResponse200OutputDataCompaniesItemEmployeeTrendsType0ItemChangesType0Item.from_dict(
