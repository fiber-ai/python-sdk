...
T = TypeVar("T", bound="CompanySearchBodySearchParamsInvestorsType0AllOfType0Item")



@_attrs_define
class CompanySearchBodySearchParamsInvestorsType0AllOfType0Item:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        company_search_body_search_params_investors_type_0_all_of_type_0_item = cls(
        ...
        company_search_body_search_params_investors_type_0_all_of_type_0_item.additional_properties = d
        return company_search_body_search_params_investors_type_0_all_of_type_0_item
