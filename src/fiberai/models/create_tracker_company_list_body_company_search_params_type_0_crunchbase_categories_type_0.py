...
T = TypeVar("T", bound="CreateTrackerCompanyListBodyCompanySearchParamsType0CrunchbaseCategoriesType0")


@_attrs_define
class CreateTrackerCompanyListBodyCompanySearchParamsType0CrunchbaseCategoriesType0:
    """
    Attributes:
        any_of (list[CreateTrackerCompanyListBodyCompanySearchParamsType0CrunchbaseCategoriesType0AnyOfType0Item] | None
            | Unset):
        all_of (list[CreateTrackerCompanyListBodyCompanySearchParamsType0CrunchbaseCategoriesType0AllOfType0Item] | None
            | Unset):
        none_of (list[CreateTrackerCompanyListBodyCompanySearchParamsType0CrunchbaseCategoriesType0NoneOfType0Item] |
            None | Unset):
    """

    any_of: (
        list[CreateTrackerCompanyListBodyCompanySearchParamsType0CrunchbaseCategoriesType0AnyOfType0Item] | None | Unset
    ) = UNSET
    all_of: (
        list[CreateTrackerCompanyListBodyCompanySearchParamsType0CrunchbaseCategoriesType0AllOfType0Item] | None | Unset
    ) = UNSET
    none_of: (
        list[CreateTrackerCompanyListBodyCompanySearchParamsType0CrunchbaseCategoriesType0NoneOfType0Item]
        | None
        | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_any_of(
            ...
            list[CreateTrackerCompanyListBodyCompanySearchParamsType0CrunchbaseCategoriesType0AnyOfType0Item]
            | None
            | Unset
        ):
            if data is None:
            ...
            try:
                ...
                for any_of_type_0_item_data in _any_of_type_0:
                    any_of_type_0_item = CreateTrackerCompanyListBodyCompanySearchParamsType0CrunchbaseCategoriesType0AnyOfType0Item.from_dict(
        ...
        def _parse_all_of(
            ...
            list[CreateTrackerCompanyListBodyCompanySearchParamsType0CrunchbaseCategoriesType0AllOfType0Item]
            | None
            | Unset
        ):
            if data is None:
            ...
            try:
                ...
                for all_of_type_0_item_data in _all_of_type_0:
                    all_of_type_0_item = CreateTrackerCompanyListBodyCompanySearchParamsType0CrunchbaseCategoriesType0AllOfType0Item.from_dict(
        ...
        def _parse_none_of(
            ...
            try:
                ...
                for none_of_type_0_item_data in _none_of_type_0:
                    none_of_type_0_item = CreateTrackerCompanyListBodyCompanySearchParamsType0CrunchbaseCategoriesType0NoneOfType0Item.from_dict(
        ...
        create_tracker_company_list_body_company_search_params_type_0_crunchbase_categories_type_0 = cls(
            any_of=any_of,
            all_of=all_of,
            none_of=none_of,
        )

        create_tracker_company_list_body_company_search_params_type_0_crunchbase_categories_type_0.additional_properties = d
        return create_tracker_company_list_body_company_search_params_type_0_crunchbase_categories_type_0
