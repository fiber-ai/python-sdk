...
T = TypeVar("T", bound="CompanySearchBodySearchParamsEmployeeTrendsType0ObeysAnyType0ItemCountCriteriaType1Change")



@_attrs_define
class CompanySearchBodySearchParamsEmployeeTrendsType0ObeysAnyType0ItemCountCriteriaType1Change:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        company_search_body_search_params_employee_trends_type_0_obeys_any_type_0_item_count_criteria_type_1_change = cls(
            lower_bound=lower_bound,
            upper_bound=upper_bound,
        )


        company_search_body_search_params_employee_trends_type_0_obeys_any_type_0_item_count_criteria_type_1_change.additional_properties = d
        return company_search_body_search_params_employee_trends_type_0_obeys_any_type_0_item_count_criteria_type_1_change
