...
from ..models.kitchen_sink_bulk_profile_response_200_output_data_item_item_experiences_type_0_item_academic_qualification_type_0_item import (
    KitchenSinkBulkProfileResponse200OutputDataItemItemExperiencesType0ItemAcademicQualificationType0Item,
)
from ..models.kitchen_sink_bulk_profile_response_200_output_data_item_item_experiences_type_0_item_employment_type_type_0_item import (
    KitchenSinkBulkProfileResponse200OutputDataItemItemExperiencesType0ItemEmploymentTypeType0Item,
)
from ..models.kitchen_sink_bulk_profile_response_200_output_data_item_item_experiences_type_0_item_job_function_type_0_item import (
    KitchenSinkBulkProfileResponse200OutputDataItemItemExperiencesType0ItemJobFunctionType0Item,
)
from ..models.kitchen_sink_bulk_profile_response_200_output_data_item_item_experiences_type_0_item_seniority_type_1 import (
    KitchenSinkBulkProfileResponse200OutputDataItemItemExperiencesType0ItemSeniorityType1,
)
from ..models.kitchen_sink_bulk_profile_response_200_output_data_item_item_experiences_type_0_item_seniority_type_2_type_1 import (
    KitchenSinkBulkProfileResponse200OutputDataItemItemExperiencesType0ItemSeniorityType2Type1,
)
from ..models.kitchen_sink_bulk_profile_response_200_output_data_item_item_experiences_type_0_item_seniority_type_3_type_1 import (
    KitchenSinkBulkProfileResponse200OutputDataItemItemExperiencesType0ItemSeniorityType3Type1,
)
...
class KitchenSinkBulkProfileResponse200OutputDataItemItemExperiencesType0Item:
    ...
    Attributes:
        ...
        seniority (KitchenSinkBulkProfileResponse200OutputDataItemItemExperiencesType0ItemSeniorityType1 |
            KitchenSinkBulkProfileResponse200OutputDataItemItemExperiencesType0ItemSeniorityType2Type1 |
            KitchenSinkBulkProfileResponse200OutputDataItemItemExperiencesType0ItemSeniorityType3Type1 | None | Unset):
        job_function (list[KitchenSinkBulkProfileResponse200OutputDataItemItemExperiencesType0ItemJobFunctionType0Item]
            | None | Unset):
        employment_type
            (list[KitchenSinkBulkProfileResponse200OutputDataItemItemExperiencesType0ItemEmploymentTypeType0Item] | None |
            Unset):
    ...
    job_function: (
        list[KitchenSinkBulkProfileResponse200OutputDataItemItemExperiencesType0ItemJobFunctionType0Item] | None | Unset
    ) = UNSET
    employment_type: (
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.seniority, Unset):
            ...
            self.seniority, KitchenSinkBulkProfileResponse200OutputDataItemItemExperiencesType0ItemSeniorityType1
        ):
            seniority = self.seniority.value
        elif isinstance(
            self.seniority, KitchenSinkBulkProfileResponse200OutputDataItemItemExperiencesType0ItemSeniorityType2Type1
        ):
            seniority = self.seniority.value
        elif isinstance(
            self.seniority, KitchenSinkBulkProfileResponse200OutputDataItemItemExperiencesType0ItemSeniorityType3Type1
        ):
            seniority = self.seniority.value
        else:
        ...
        def _parse_seniority(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                seniority_type_1 = (
                    KitchenSinkBulkProfileResponse200OutputDataItemItemExperiencesType0ItemSeniorityType1(data)
                )
            ...
            try:
                ...
                seniority_type_2_type_1 = (
                    KitchenSinkBulkProfileResponse200OutputDataItemItemExperiencesType0ItemSeniorityType2Type1(data)
                )
            ...
            try:
                ...
                seniority_type_3_type_1 = (
                    KitchenSinkBulkProfileResponse200OutputDataItemItemExperiencesType0ItemSeniorityType3Type1(data)
                )
        ...
        def _parse_academic_qualification(
            ...
            try:
                ...
                for academic_qualification_type_0_item_data in _academic_qualification_type_0:
                    academic_qualification_type_0_item = KitchenSinkBulkProfileResponse200OutputDataItemItemExperiencesType0ItemAcademicQualificationType0Item(
