...
T = TypeVar("T", bound="CombinedSearchCountBodyProfileParamsLocationType0")
...
class CombinedSearchCountBodyProfileParamsLocationType0:
    ...
    Attributes:
        union_all (list[CombinedSearchCountBodyProfileParamsLocationType0UnionAllType0ItemType0 |
            CombinedSearchCountBodyProfileParamsLocationType0UnionAllType0ItemType1 |
            CombinedSearchCountBodyProfileParamsLocationType0UnionAllType0ItemType2 |
            CombinedSearchCountBodyProfileParamsLocationType0UnionAllType0ItemType3] | None | Unset):
        subtract_all (list[CombinedSearchCountBodyProfileParamsLocationType0SubtractAllType0ItemType0 |
            CombinedSearchCountBodyProfileParamsLocationType0SubtractAllType0ItemType1 |
            CombinedSearchCountBodyProfileParamsLocationType0SubtractAllType0ItemType2 |
            CombinedSearchCountBodyProfileParamsLocationType0SubtractAllType0ItemType3] | None | Unset):
    """
        ...
        if isinstance(self.union_all, Unset):
            ...
            for union_all_type_0_item_data in self.union_all:
                ...
                if isinstance(
                    ...
                    union_all_type_0_item_data, CombinedSearchCountBodyProfileParamsLocationType0UnionAllType0ItemType2
                ):
                    union_all_type_0_item = union_all_type_0_item_data.to_dict()
                else:
                    union_all_type_0_item = union_all_type_0_item_data.to_dict()
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
                ...
                for union_all_type_0_item_data in _union_all_type_0:
                    ...
                    def _parse_union_all_type_0_item(
                        ...
                        union_all_type_0_item_type_3 = (
                            CombinedSearchCountBodyProfileParamsLocationType0UnionAllType0ItemType3.from_dict(data)
                        )
                    ...
                    def _parse_subtract_all_type_0_item(
                        ...
                        try:
                            ...
                            subtract_all_type_0_item_type_2 = (
                                CombinedSearchCountBodyProfileParamsLocationType0SubtractAllType0ItemType2.from_dict(
                                    data
                                )
                            )
                        ...
                        subtract_all_type_0_item_type_3 = (
                            CombinedSearchCountBodyProfileParamsLocationType0SubtractAllType0ItemType3.from_dict(data)
                        )
        ...
        combined_search_count_body_profile_params_location_type_0 = cls(
            union_all=union_all,
            subtract_all=subtract_all,
        )

        combined_search_count_body_profile_params_location_type_0.additional_properties = d
        return combined_search_count_body_profile_params_location_type_0
