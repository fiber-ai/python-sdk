...
from ..models.profile_live_enrich_response_200_profile_found_and_enriched_profile_current_job_type_0_academic_qualification_type_0_item import (
    ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileCurrentJobType0AcademicQualificationType0Item,
)
from ..models.profile_live_enrich_response_200_profile_found_and_enriched_profile_current_job_type_0_employment_type_type_0_item import (
    ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileCurrentJobType0EmploymentTypeType0Item,
)
from ..models.profile_live_enrich_response_200_profile_found_and_enriched_profile_current_job_type_0_job_function_type_0_item import (
    ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileCurrentJobType0JobFunctionType0Item,
)
from ..models.profile_live_enrich_response_200_profile_found_and_enriched_profile_current_job_type_0_seniority_type_1 import (
    ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileCurrentJobType0SeniorityType1,
)
from ..models.profile_live_enrich_response_200_profile_found_and_enriched_profile_current_job_type_0_seniority_type_2_type_1 import (
    ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileCurrentJobType0SeniorityType2Type1,
)
from ..models.profile_live_enrich_response_200_profile_found_and_enriched_profile_current_job_type_0_seniority_type_3_type_1 import (
    ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileCurrentJobType0SeniorityType3Type1,
)
...
class ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileCurrentJobType0:
    ...
    Attributes:
        ...
        seniority (None | ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileCurrentJobType0SeniorityType1 |
            ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileCurrentJobType0SeniorityType2Type1 |
            ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileCurrentJobType0SeniorityType3Type1 | Unset):
        job_function
            (list[ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileCurrentJobType0JobFunctionType0Item] | None |
            Unset):
        employment_type
            (list[ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileCurrentJobType0EmploymentTypeType0Item] | None |
            Unset):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.seniority, Unset):
            ...
            self.seniority, ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileCurrentJobType0SeniorityType1
        ):
            seniority = self.seniority.value
        elif isinstance(
            self.seniority, ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileCurrentJobType0SeniorityType2Type1
        ):
            seniority = self.seniority.value
        elif isinstance(
            self.seniority, ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileCurrentJobType0SeniorityType3Type1
        ):
            seniority = self.seniority.value
        else:
        ...
        def _parse_seniority(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                seniority_type_1 = (
                    ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileCurrentJobType0SeniorityType1(data)
                )
            ...
            try:
                ...
                seniority_type_2_type_1 = (
                    ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileCurrentJobType0SeniorityType2Type1(data)
                )
            ...
            try:
                ...
                seniority_type_3_type_1 = (
                    ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileCurrentJobType0SeniorityType3Type1(data)
                )
        ...
        def _parse_employment_type(
            ...
            try:
                ...
                for employment_type_type_0_item_data in _employment_type_type_0:
                    employment_type_type_0_item = ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileCurrentJobType0EmploymentTypeType0Item(
        ...
        def _parse_academic_qualification(
            ...
            try:
                ...
                for academic_qualification_type_0_item_data in _academic_qualification_type_0:
                    academic_qualification_type_0_item = ProfileLiveEnrichResponse200ProfileFoundAndEnrichedProfileCurrentJobType0AcademicQualificationType0Item(
