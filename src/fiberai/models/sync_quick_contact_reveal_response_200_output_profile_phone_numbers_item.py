...
@_attrs_define
class SyncQuickContactRevealResponse200OutputProfilePhoneNumbersItem:
    """
    Attributes:
        number (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sync_quick_contact_reveal_response_200_output_profile_phone_numbers_item.additional_properties = d
        return sync_quick_contact_reveal_response_200_output_profile_phone_numbers_item
