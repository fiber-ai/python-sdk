...
T = TypeVar(
    "T",
    bound="PaginatedCombinedSearchBodyProfileConfigType0SearchParamsKeywordSearchOptionsType0FieldsToSearchOverType0",
)


@_attrs_define
class PaginatedCombinedSearchBodyProfileConfigType0SearchParamsKeywordSearchOptionsType0FieldsToSearchOverType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        paginated_combined_search_body_profile_config_type_0_search_params_keyword_search_options_type_0_fields_to_search_over_type_0 = cls(
            summary=summary,
            headline=headline,
        ...
        paginated_combined_search_body_profile_config_type_0_search_params_keyword_search_options_type_0_fields_to_search_over_type_0.additional_properties = d
        return paginated_combined_search_body_profile_config_type_0_search_params_keyword_search_options_type_0_fields_to_search_over_type_0
