...
if TYPE_CHECKING:
    from ..models.reverse_phone_lookup_response_200_output_results_item_type_0_profile_detailed_education_type_0_item_school_details_type_0 import (
        ReversePhoneLookupResponse200OutputResultsItemType0ProfileDetailedEducationType0ItemSchoolDetailsType0,
    )


T = TypeVar("T", bound="ReversePhoneLookupResponse200OutputResultsItemType0ProfileDetailedEducationType0Item")


@_attrs_define
class ReversePhoneLookupResponse200OutputResultsItemType0ProfileDetailedEducationType0Item:
    """
    Attributes:
        school_details (None |
            ReversePhoneLookupResponse200OutputResultsItemType0ProfileDetailedEducationType0ItemSchoolDetailsType0 | Unset):
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.reverse_phone_lookup_response_200_output_results_item_type_0_profile_detailed_education_type_0_item_school_details_type_0 import (
            ReversePhoneLookupResponse200OutputResultsItemType0ProfileDetailedEducationType0ItemSchoolDetailsType0,  # noqa: PLC0415
        )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_school_details(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                school_details_type_0 = ReversePhoneLookupResponse200OutputResultsItemType0ProfileDetailedEducationType0ItemSchoolDetailsType0.from_dict(
                    data
                )
        ...
        reverse_phone_lookup_response_200_output_results_item_type_0_profile_detailed_education_type_0_item = cls(
        ...
        reverse_phone_lookup_response_200_output_results_item_type_0_profile_detailed_education_type_0_item.additional_properties = d
        return reverse_phone_lookup_response_200_output_results_item_type_0_profile_detailed_education_type_0_item
