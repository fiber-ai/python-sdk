...
T = TypeVar("T", bound="CompanyDescriptionChanged")


@_attrs_define
class CompanyDescriptionChanged:
    """
    Attributes:
        type_ (Literal['company_description_changed']):
        ...
        keywords (list[str] | None | Unset): Only alert if new description contains one of these keywords. Omit for any
            change.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        type_ = cast(Literal["company_description_changed"], d.pop("type"))
        if type_ != "company_description_changed":
            raise ValueError(f"type must match const 'company_description_changed', got '{type_}'")
        ...
        company_description_changed = cls(
            type_=type_,
        ...
        company_description_changed.additional_properties = d
        return company_description_changed
