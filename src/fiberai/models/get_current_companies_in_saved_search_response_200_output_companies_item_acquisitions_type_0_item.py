...
T = TypeVar("T", bound="GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemAcquisitionsType0Item")



@_attrs_define
class GetCurrentCompaniesInSavedSearchResponse200OutputCompaniesItemAcquisitionsType0Item:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_current_companies_in_saved_search_response_200_output_companies_item_acquisitions_type_0_item = cls(
            price_usd=price_usd,
        ...
        get_current_companies_in_saved_search_response_200_output_companies_item_acquisitions_type_0_item.additional_properties = d
        return get_current_companies_in_saved_search_response_200_output_companies_item_acquisitions_type_0_item
