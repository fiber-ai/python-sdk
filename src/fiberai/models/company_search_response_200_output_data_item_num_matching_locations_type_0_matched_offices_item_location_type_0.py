...
if TYPE_CHECKING:
    from ..models.company_search_response_200_output_data_item_num_matching_locations_type_0_matched_offices_item_location_type_0_coordinates_type_0 import (
        CompanySearchResponse200OutputDataItemNumMatchingLocationsType0MatchedOfficesItemLocationType0CoordinatesType0,
    )
...
class CompanySearchResponse200OutputDataItemNumMatchingLocationsType0MatchedOfficesItemLocationType0:
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.company_search_response_200_output_data_item_num_matching_locations_type_0_matched_offices_item_location_type_0_coordinates_type_0 import (
            CompanySearchResponse200OutputDataItemNumMatchingLocationsType0MatchedOfficesItemLocationType0CoordinatesType0,  # noqa: PLC0415
        )
        ...
        def _parse_coordinates(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = CompanySearchResponse200OutputDataItemNumMatchingLocationsType0MatchedOfficesItemLocationType0CoordinatesType0.from_dict(
                    data
                )
