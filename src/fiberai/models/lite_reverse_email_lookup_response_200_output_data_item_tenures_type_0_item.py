...
if TYPE_CHECKING:
    from ..models.lite_reverse_email_lookup_response_200_output_data_item_tenures_type_0_item_date_range import (
        LiteReverseEmailLookupResponse200OutputDataItemTenuresType0ItemDateRange,
    )


T = TypeVar("T", bound="LiteReverseEmailLookupResponse200OutputDataItemTenuresType0Item")


@_attrs_define
class LiteReverseEmailLookupResponse200OutputDataItemTenuresType0Item:
    """
    Attributes:
        date_range (LiteReverseEmailLookupResponse200OutputDataItemTenuresType0ItemDateRange):
        titles (list[str]):
        localities (list[str]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.lite_reverse_email_lookup_response_200_output_data_item_tenures_type_0_item_date_range import (
            LiteReverseEmailLookupResponse200OutputDataItemTenuresType0ItemDateRange,  # noqa: PLC0415
        )

        d = dict(src_dict)
        date_range = LiteReverseEmailLookupResponse200OutputDataItemTenuresType0ItemDateRange.from_dict(
            d.pop("date_range")
        )
        ...
        lite_reverse_email_lookup_response_200_output_data_item_tenures_type_0_item = cls(
            date_range=date_range,
            titles=titles,
            localities=localities,
        ...
        lite_reverse_email_lookup_response_200_output_data_item_tenures_type_0_item.additional_properties = d
        return lite_reverse_email_lookup_response_200_output_data_item_tenures_type_0_item
