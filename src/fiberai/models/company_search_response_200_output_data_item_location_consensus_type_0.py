...
if TYPE_CHECKING:
  from ..models.company_search_response_200_output_data_item_location_consensus_type_0_coordinates_type_0 import CompanySearchResponse200OutputDataItemLocationConsensusType0CoordinatesType0
...
class CompanySearchResponse200OutputDataItemLocationConsensusType0:
    """ 
        Attributes:
            ...
            coordinates (Union['CompanySearchResponse200OutputDataItemLocationConsensusType0CoordinatesType0', None,
                Unset]):
    ...
    coordinates: Union['CompanySearchResponse200OutputDataItemLocationConsensusType0CoordinatesType0', None, Unset] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_coordinates(data: object) -> Union['CompanySearchResponse200OutputDataItemLocationConsensusType0CoordinatesType0', None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                coordinates_type_0 = CompanySearchResponse200OutputDataItemLocationConsensusType0CoordinatesType0.from_dict(data)
                ...
                pass
            return cast(Union['CompanySearchResponse200OutputDataItemLocationConsensusType0CoordinatesType0', None, Unset], data)
