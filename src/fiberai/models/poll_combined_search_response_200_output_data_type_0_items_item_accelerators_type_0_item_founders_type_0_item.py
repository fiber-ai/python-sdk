...
T = TypeVar("T", bound="PollCombinedSearchResponse200OutputDataType0ItemsItemAcceleratorsType0ItemFoundersType0Item")



@_attrs_define
class PollCombinedSearchResponse200OutputDataType0ItemsItemAcceleratorsType0ItemFoundersType0Item:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        poll_combined_search_response_200_output_data_type_0_items_item_accelerators_type_0_item_founders_type_0_item = cls(
            full_name=full_name,
            bio=bio,
            job_title=job_title,
            is_active=is_active,
        ...
        poll_combined_search_response_200_output_data_type_0_items_item_accelerators_type_0_item_founders_type_0_item.additional_properties = d
        return poll_combined_search_response_200_output_data_type_0_items_item_accelerators_type_0_item_founders_type_0_item
