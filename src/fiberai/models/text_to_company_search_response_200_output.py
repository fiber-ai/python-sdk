...
if TYPE_CHECKING:
    from ..models.text_to_company_search_response_200_output_data_item import (
        TextToCompanySearchResponse200OutputDataItem,
    )
    from ..models.text_to_company_search_response_200_output_search_params import (
        TextToCompanySearchResponse200OutputSearchParams,
    )
