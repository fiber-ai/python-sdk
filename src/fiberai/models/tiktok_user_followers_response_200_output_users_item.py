...
T = TypeVar("T", bound="TiktokUserFollowersResponse200OutputUsersItem")


@_attrs_define
class TiktokUserFollowersResponse200OutputUsersItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        tiktok_user_followers_response_200_output_users_item = cls(
            id=id,
            handle=handle,
        ...
        tiktok_user_followers_response_200_output_users_item.additional_properties = d
        return tiktok_user_followers_response_200_output_users_item
