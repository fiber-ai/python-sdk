...
from ..models.paginated_combined_search_response_200_output_profiles_item_experiences_type_0_item_academic_qualification_type_0_item import (
    PaginatedCombinedSearchResponse200OutputProfilesItemExperiencesType0ItemAcademicQualificationType0Item,
)
from ..models.paginated_combined_search_response_200_output_profiles_item_experiences_type_0_item_employment_type_type_0_item import (
    PaginatedCombinedSearchResponse200OutputProfilesItemExperiencesType0ItemEmploymentTypeType0Item,
)
from ..models.paginated_combined_search_response_200_output_profiles_item_experiences_type_0_item_job_function_type_0_item import (
    PaginatedCombinedSearchResponse200OutputProfilesItemExperiencesType0ItemJobFunctionType0Item,
)
from ..models.paginated_combined_search_response_200_output_profiles_item_experiences_type_0_item_seniority_type_1 import (
    PaginatedCombinedSearchResponse200OutputProfilesItemExperiencesType0ItemSeniorityType1,
)
from ..models.paginated_combined_search_response_200_output_profiles_item_experiences_type_0_item_seniority_type_2_type_1 import (
    PaginatedCombinedSearchResponse200OutputProfilesItemExperiencesType0ItemSeniorityType2Type1,
)
from ..models.paginated_combined_search_response_200_output_profiles_item_experiences_type_0_item_seniority_type_3_type_1 import (
    PaginatedCombinedSearchResponse200OutputProfilesItemExperiencesType0ItemSeniorityType3Type1,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PaginatedCombinedSearchResponse200OutputProfilesItemExperiencesType0Item")


@_attrs_define
class PaginatedCombinedSearchResponse200OutputProfilesItemExperiencesType0Item:
    """
    Attributes:
        ...
        seniority (None | PaginatedCombinedSearchResponse200OutputProfilesItemExperiencesType0ItemSeniorityType1 |
            PaginatedCombinedSearchResponse200OutputProfilesItemExperiencesType0ItemSeniorityType2Type1 |
            PaginatedCombinedSearchResponse200OutputProfilesItemExperiencesType0ItemSeniorityType3Type1 | Unset):
        job_function (list[PaginatedCombinedSearchResponse200OutputProfilesItemExperiencesType0ItemJobFunctionType0Item]
            | None | Unset):
        employment_type
            (list[PaginatedCombinedSearchResponse200OutputProfilesItemExperiencesType0ItemEmploymentTypeType0Item] | None |
            Unset):
        academic_qualification
            (list[PaginatedCombinedSearchResponse200OutputProfilesItemExperiencesType0ItemAcademicQualificationType0Item] |
            None | Unset):
    ...
    job_function: (
        list[PaginatedCombinedSearchResponse200OutputProfilesItemExperiencesType0ItemJobFunctionType0Item]
        | None
        | Unset
    ) = UNSET
    employment_type: (
        list[PaginatedCombinedSearchResponse200OutputProfilesItemExperiencesType0ItemEmploymentTypeType0Item]
        | None
        | Unset
    ) = UNSET
    academic_qualification: (
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.seniority, Unset):
            ...
            self.seniority, PaginatedCombinedSearchResponse200OutputProfilesItemExperiencesType0ItemSeniorityType1
        ):
            seniority = self.seniority.value
        elif isinstance(
            self.seniority, PaginatedCombinedSearchResponse200OutputProfilesItemExperiencesType0ItemSeniorityType2Type1
        ):
            seniority = self.seniority.value
        elif isinstance(
            self.seniority, PaginatedCombinedSearchResponse200OutputProfilesItemExperiencesType0ItemSeniorityType3Type1
        ):
            seniority = self.seniority.value
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_seniority(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                seniority_type_1 = (
                    PaginatedCombinedSearchResponse200OutputProfilesItemExperiencesType0ItemSeniorityType1(data)
                )
            ...
            try:
                ...
                seniority_type_2_type_1 = (
                    PaginatedCombinedSearchResponse200OutputProfilesItemExperiencesType0ItemSeniorityType2Type1(data)
                )
            ...
            try:
                ...
                seniority_type_3_type_1 = (
                    PaginatedCombinedSearchResponse200OutputProfilesItemExperiencesType0ItemSeniorityType3Type1(data)
                )
        ...
        def _parse_academic_qualification(
            ...
            try:
                ...
                for academic_qualification_type_0_item_data in _academic_qualification_type_0:
                    academic_qualification_type_0_item = PaginatedCombinedSearchResponse200OutputProfilesItemExperiencesType0ItemAcademicQualificationType0Item(
        ...
        paginated_combined_search_response_200_output_profiles_item_experiences_type_0_item = cls(
        ...
        paginated_combined_search_response_200_output_profiles_item_experiences_type_0_item.additional_properties = d
        return paginated_combined_search_response_200_output_profiles_item_experiences_type_0_item
