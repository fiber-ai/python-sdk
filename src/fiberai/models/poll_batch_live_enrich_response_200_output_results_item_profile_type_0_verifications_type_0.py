...
T = TypeVar("T", bound="PollBatchLiveEnrichResponse200OutputResultsItemProfileType0VerificationsType0")


@_attrs_define
class PollBatchLiveEnrichResponse200OutputResultsItemProfileType0VerificationsType0:
    """
    Attributes:
        is_verified (bool | None | Unset):
        joined_date (None | str | Unset):
        verification_types
            (list[PollBatchLiveEnrichResponse200OutputResultsItemProfileType0VerificationsType0VerificationTypesType0Item] |
            None | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_verification_types(
            ...
            try:
                ...
                for verification_types_type_0_item_data in _verification_types_type_0:
                    verification_types_type_0_item = PollBatchLiveEnrichResponse200OutputResultsItemProfileType0VerificationsType0VerificationTypesType0Item.from_dict(
        ...
        poll_batch_live_enrich_response_200_output_results_item_profile_type_0_verifications_type_0 = cls(
            is_verified=is_verified,
            joined_date=joined_date,
            verification_types=verification_types,
        )

        poll_batch_live_enrich_response_200_output_results_item_profile_type_0_verifications_type_0.additional_properties = d
        return poll_batch_live_enrich_response_200_output_results_item_profile_type_0_verifications_type_0
