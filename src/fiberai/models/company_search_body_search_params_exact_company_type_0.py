...
class CompanySearchBodySearchParamsExactCompanyType0:
    """
    Attributes:
        any_of (list[CompanySearchBodySearchParamsExactCompanyType0AnyOfType0Item] | None | Unset):
        none_of (list[CompanySearchBodySearchParamsExactCompanyType0NoneOfType0Item] | None | Unset):
    """

    any_of: list[CompanySearchBodySearchParamsExactCompanyType0AnyOfType0Item] | None | Unset = UNSET
    none_of: list[CompanySearchBodySearchParamsExactCompanyType0NoneOfType0Item] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_any_of(
            data: object,
        ) -> list[CompanySearchBodySearchParamsExactCompanyType0AnyOfType0Item] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for any_of_type_0_item_data in _any_of_type_0:
                    any_of_type_0_item = CompanySearchBodySearchParamsExactCompanyType0AnyOfType0Item.from_dict(
                ...
                pass
            return cast(list[CompanySearchBodySearchParamsExactCompanyType0AnyOfType0Item] | None | Unset, data)

        any_of = _parse_any_of(d.pop("anyOf", UNSET))

        def _parse_none_of(
            data: object,
        ) -> list[CompanySearchBodySearchParamsExactCompanyType0NoneOfType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for none_of_type_0_item_data in _none_of_type_0:
                    none_of_type_0_item = CompanySearchBodySearchParamsExactCompanyType0NoneOfType0Item.from_dict(
                ...
                pass
            return cast(list[CompanySearchBodySearchParamsExactCompanyType0NoneOfType0Item] | None | Unset, data)
