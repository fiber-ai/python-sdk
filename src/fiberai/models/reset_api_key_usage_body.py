...
from ..models.reset_api_key_usage_body_target import ResetApiKeyUsageBodyTarget
from ..types import UNSET, Unset

T = TypeVar("T", bound="ResetApiKeyUsageBody")


@_attrs_define
class ResetApiKeyUsageBody:
    """
    Attributes:
        api_key (str): Your Fiber API key
        target (ResetApiKeyUsageBodyTarget | Unset): Which key to act on. SELF acts on the key that authenticates this
            request. OTHER acts on a different key in your organization, supplied in targetApiKey. Default:
            ResetApiKeyUsageBodyTarget.SELF.
    ...
    api_key: str
    target: ResetApiKeyUsageBodyTarget | Unset = ResetApiKeyUsageBodyTarget.SELF
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        target: ResetApiKeyUsageBodyTarget | Unset
        if isinstance(_target, Unset):
            target = UNSET
        else:
            target = ResetApiKeyUsageBodyTarget(_target)
        ...
        reset_api_key_usage_body = cls(
            api_key=api_key,
            target=target,
            target_api_key=target_api_key,
        )

        reset_api_key_usage_body.additional_properties = d
        return reset_api_key_usage_body
