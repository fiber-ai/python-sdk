...
T = TypeVar("T", bound="InstagramUserReelsBody")


@_attrs_define
class InstagramUserReelsBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        instagram_user_reels_body = cls(
            api_key=api_key,
            handle=handle,
            next_page_token=next_page_token,
        )

        instagram_user_reels_body.additional_properties = d
        return instagram_user_reels_body
