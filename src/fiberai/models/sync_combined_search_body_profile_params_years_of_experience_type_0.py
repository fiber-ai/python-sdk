...
T = TypeVar("T", bound="SyncCombinedSearchBodyProfileParamsYearsOfExperienceType0")


@_attrs_define
class SyncCombinedSearchBodyProfileParamsYearsOfExperienceType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sync_combined_search_body_profile_params_years_of_experience_type_0 = cls(
            lower_bound=lower_bound,
            upper_bound=upper_bound,
        )

        sync_combined_search_body_profile_params_years_of_experience_type_0.additional_properties = d
        return sync_combined_search_body_profile_params_years_of_experience_type_0
