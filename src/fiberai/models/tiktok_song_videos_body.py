...
T = TypeVar("T", bound="TiktokSongVideosBody")


@_attrs_define
class TiktokSongVideosBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        tiktok_song_videos_body = cls(
            api_key=api_key,
            song_url=song_url,
            next_page_token=next_page_token,
        )

        tiktok_song_videos_body.additional_properties = d
        return tiktok_song_videos_body
