...
if TYPE_CHECKING:
    from ..models.company_search_response_200_output_data_item_full_funding_rounds_type_0_item_investors_type_0_item import (
        CompanySearchResponse200OutputDataItemFullFundingRoundsType0ItemInvestorsType0Item,
    )
...
class CompanySearchResponse200OutputDataItemFullFundingRoundsType0Item:
    """
    Attributes:
        investors (list[CompanySearchResponse200OutputDataItemFullFundingRoundsType0ItemInvestorsType0Item] | None |
            Unset):
    ...
    investors: (
        list[CompanySearchResponse200OutputDataItemFullFundingRoundsType0ItemInvestorsType0Item] | None | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.company_search_response_200_output_data_item_full_funding_rounds_type_0_item_investors_type_0_item import (
            CompanySearchResponse200OutputDataItemFullFundingRoundsType0ItemInvestorsType0Item,  # noqa: PLC0415
        )
            ...
            try:
                ...
                for investors_type_0_item_data in _investors_type_0:
                    investors_type_0_item = (
                        CompanySearchResponse200OutputDataItemFullFundingRoundsType0ItemInvestorsType0Item.from_dict(
