...
T = TypeVar("T", bound="CombinedSearchBodyCompanyParamsJobPostingStatsType0AnyOfType0ItemType0Count")


@_attrs_define
class CombinedSearchBodyCompanyParamsJobPostingStatsType0AnyOfType0ItemType0Count:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        combined_search_body_company_params_job_posting_stats_type_0_any_of_type_0_item_type_0_count = cls(
            lower_bound=lower_bound,
            upper_bound=upper_bound,
        )

        combined_search_body_company_params_job_posting_stats_type_0_any_of_type_0_item_type_0_count.additional_properties = d
        return combined_search_body_company_params_job_posting_stats_type_0_any_of_type_0_item_type_0_count
